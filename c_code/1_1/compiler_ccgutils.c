...
static NIM_CONST TY194031 TMP8877 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP8878, "sons", 4);
extern NIM_CONST TY161497 Cpu_161496;
STRING_LITERAL(TMP8888, "getUniqueType", 13);
STRING_LITERAL(TMP8891, "\"", 1);
STRING_LITERAL(TMP8893, "len(a) == L string modified while iterating over it", 51);
STRING_LITERAL(TMP8894, "N", 1);
STRING_LITERAL(TMP8895, "HEX", 3);
STRING_LITERAL(TMP8898, "c\"", 2);
STRING_LITERAL(TMP8903, "\\00\"", 4);
...
static N_INLINE(NI, len_194097)(Tnode193813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP8877[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP8878));
	...
	{
		{
			...
			res_457087 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8879 = addInt(res_457087, ((NI) 1));
					res_457087 = (NI)(TMP8879);
				} LA5: ;
			}
		} LA2: ;
	}
	...
	{
		{
			...
			res_457095 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP8880 = addInt(res_457095, ((NI) 1));
					res_457095 = (NI)(TMP8880);
				} LA15: ;
			}
		}
	}
...
N_NIMCALL(NI64, hashstring_457146)(NimStringDesc* s) {
		...
		b = IL64(0);
		{
			...
			res_457235 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8882 = addInt(res_457235, ((NI) 1));
					res_457235 = (NI)(TMP8882);
				} LA7: ;
			}
		}
	...
	LA3: ;
	{
		...
		a = ((NI32) 0);
		{
			...
			TMP8883 = subInt((s ? s->Sup.len : 0), ((NI) 1));
			HEX3Atmp_457241 = (NI)(TMP8883);
			nimln(1598, "system.nim");
			res_457244 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP8884 = addInt(res_457244, ((NI) 1));
					res_457244 = (NI)(TMP8884);
				} LA11: ;
			}
		}
	...
	nimfr("initTypeTables", "ccgutils.nim")
	{
		...
		res_457430 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP8885 = addInt(res_457430, ((NI) 1));
				res_457430 = (NI)(TMP8885);
			} LA3: ;
		}
	}
	popFrame();
	...
	inittypetables_457285();
	{
		...
		res_457464 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP8886 = addInt(res_457464, ((NI) 1));
				res_457464 = (NI)(TMP8886);
			} LA3: ;
		}
	}
	popFrame();
	...
	LA5: ;
	{
		...
		res_457637 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA14: ;
				nimln(1614, "system.nim");
				TMP8887 = addInt(res_457637, ((NI) 1));
				res_457637 = (NI)(TMP8887);
			} LA9: ;
		}
	}
...
{	result = 0;
	...
	case ((NU8) 58):
	{
		...
		internalerror_167218(((NimStringDesc*) &TMP8888));
	}
	break;
	case ((NU8) 13):
	{
			...
			LA46: ;
			{
				...
				res_457785 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA55: ;
						nimln(1614, "system.nim");
						TMP8889 = addInt(res_457785, ((NI) 1));
						res_457785 = (NI)(TMP8889);
					} LA50: ;
				}
			}
		...
		if (!LOC4) goto LA6;
		{
			...
			res_457851 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA13: ;
					nimln(1614, "system.nim");
					TMP8890 = addInt(res_457851, ((NI) 1));
					res_457851 = (NI)(TMP8890);
				} LA10: ;
			}
		}
	}
...
N_NIMCALL(NimStringDesc*, makesinglelinecstring_457870)(NimStringDesc* s) {
	...
	result = copyString(((NimStringDesc*) &TMP8891));
	{
		NIM_CHAR c_457874;
		NI i_457878;
		NI L_457880;
...
appendString(result, LOC4);
				...
				TMP8892 = addInt(i_457878, ((NI) 1));
				i_457878 = (NI)(TMP8892);
				nimln(3107, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L_457880))) goto LA7;
					failedassertimpl_88817(((NimStringDesc*) &TMP8893));
				}
				LA7: ;
			} LA3: ;
		}
...
N_NIMCALL(NimStringDesc*, mangle_457896)(NimStringDesc* name) {
	...
	case 48 ... 57:
	{
		...
		if ((NU)(((NI) 0)) > (NU)(name->Sup.len)) raiseIndexError();
		LOC3 = rawNewString(2);
appendString(LOC3, ((NimStringDesc*) &TMP8894));
...
appendString(LOC5, ((NimStringDesc*) &TMP8895));
appendString(LOC5, LOC6);
	...
	}
	{
		...
		TMP8896 = subInt((name ? name->Sup.len : 0), ((NI) 1));
		HEX3Atmp_457929 = (NI)(TMP8896);
		nimln(1598, "system.nim");
		res_457932 = ((NI) 1);
		{
			nimln(1599, "system.nim");
...
appendString(LOC15, ((NimStringDesc*) &TMP8895));
...
appendString(result, LOC15);
				...
				nimln(1619, "system.nim");
				TMP8897 = addInt(res_457932, ((NI) 1));
				res_457932 = (NI)(TMP8897);
			} LA9: ;
		}
	}
	popFrame();
...
N_NIMCALL(Ropeobj163009*, makellvmstring_457951)(NimStringDesc* s) {
	...
	res = copyString(((NimStringDesc*) &TMP8898));
	{
		NI i_457969;
		NI HEX3Atmp_457982;
		NI TMP8899;
		...
		res_457985 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(201, "ccgutils.nim");
				{
					...
					NI TMP8901;
					Ropeobj163009* LOC8;
					TMP8900 = addInt(i_457969, ((NI) 1));
					TMP8901 = modInt((NI)(TMP8900), ((NI) 64));
					if (!(((NI) ((NI)(TMP8901))) == ((NI) 0))) goto LA6;
...
appendString(res, LOC10);
				...
				nimln(1614, "system.nim");
				TMP8902 = addInt(res_457985, ((NI) 1));
				res_457985 = (NI)(TMP8902);
			} LA3: ;
		}
	}
	nimln(209, "ccgutils.nim");
	res = resizeString(res, 4);
appendString(res, ((NimStringDesc*) &TMP8903));
