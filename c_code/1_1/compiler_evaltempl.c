...
static NIM_CONST TY194031 TMP7603 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7604, "sym", 3);
static NIM_CONST TY194031 TMP7605 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7606, "sons", 4);
STRING_LITERAL(TMP7609, "compiler/evaltempl.nim", 22);
NIM_CONST TY149210 TMP7608 = {((NimStringDesc*) &TMP7609),
((NI) 39)}
;
...
N_NIMCALL(void, evaltemplateaux_386039)(Tnode193813* templ, Tnode193813* actual, Templctx386019* c, Tnode193813* result) {
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP7603[(*templ).kind/8] &(1<<((*templ).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7604));
		...
		nimln(31, "evaltempl.nim");
		{
			...
			nimln(32, "evaltempl.nim");
			{
				...
				if (((TMP7605[(*actual).kind/8] &(1<<((*actual).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7606));
						...
						y_386083 = 0;
						{
							...
							res_386146 = ((NI) 0);
							{
								...
								while (1) {
									...
									i_386142 = res_386146;
									nimln(1537, "ast.nim");
									if (((TMP7605[(*x).kind/8] &(1<<((*x).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7606));
									...
									TMP7607 = addInt(res_386146, ((NI) 1));
									res_386146 = (NI)(TMP7607);
								} LA20: ;
							}
						}
					}
	...
	default:
	{
		...
		res = copynode_386027((&(*c)), templ, actual);
		{
			...
			TMP7610 = subInt(LOC50, ((NI) 1));
			HEX3Atmp_386150 = (NI)(TMP7610);
			nimln(1598, "system.nim");
			res_386153 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					if (((TMP7605[(*templ).kind/8] &(1<<((*templ).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7606));
					...
					TMP7611 = addInt(res_386153, ((NI) 1));
					res_386153 = (NI)(TMP7611);
				} LA52: ;
			}
		}
...
N_NIMCALL(Tnode193813*, evaltemplateargs_386184)(Tnode193813* n, Tsym193843* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_167134((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7612));
	}
	LA5: ;
	...
	result = newnodei_195351(((NU8) 152), (*n).info);
	{
		...
		TMP7613 = subInt(f, ((NI) 1));
		HEX3Atmp_386234 = (NI)(TMP7613);
		nimln(1598, "system.nim");
		res_386237 = ((NI) 1);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA12: ;
				{
					if (((TMP7605[(*(*(*s).typ).n).kind/8] &(1<<((*(*(*s).typ).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7606));
					if ((NU)(i_386204) >= (NU)((*(*(*s).typ).n).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (!(((TMP7603[(*(*(*(*s).typ).n).kindU.S6.sons->data[i_386204]).kind/8] &(1<<((*(*(*(*s).typ).n).kindU.S6.sons->data[i_386204]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7604));
				...
				nimln(70, "evaltempl.nim");
				{
					...
					localerror_167155((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7612));
				}
				LA19: ;
				nimln(72, "evaltempl.nim");
				addson_195819(result, arg);
				nimln(1614, "system.nim");
				TMP7614 = addInt(res_386237, ((NI) 1));
				res_386237 = (NI)(TMP7614);
			} LA9: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode193813*, evaltemplate_386260)(Tnode193813* n, Tsym193843* tmpl, Tsym193843* gensymowner) {
	...
	TMP7615 = addInt(evaltemplatecounter_386256, ((NI) 1));
	evaltemplatecounter_386256 = (NI)(TMP7615);
	nimln(79, "evaltempl.nim");
	{
		if (!(((NI) 100) < evaltemplatecounter_386256)) goto LA3;
		nimln(80, "evaltempl.nim");
		globalerror_167134((*n).info, ((NU16) 183), ((NimStringDesc*) &TMP7612));
	...
	nimln(91, "evaltempl.nim");
	{
		...
		nimln(94, "evaltempl.nim");
		{
			...
			if (((TMP7605[(*result).kind/8] &(1<<((*result).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7606));
	...
	LA8: ;
	{
		...
		LA20: ;
		{
			...
			TMP7616 = subInt(LOC23, ((NI) 1));
			HEX3Atmp_386322 = (NI)(TMP7616);
			nimln(1598, "system.nim");
			res_386325 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					if (((TMP7605[(*body).kind/8] &(1<<((*body).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7606));
					...
					nimln(1614, "system.nim");
					TMP7617 = addInt(res_386325, ((NI) 1));
					res_386325 = (NI)(TMP7617);
				} LA25: ;
			}
		}
	}
	...
	TMP7618 = subInt(evaltemplatecounter_386256, ((NI) 1));
	evaltemplatecounter_386256 = (NI)(TMP7618);
	popFrame();
	return result;
}
