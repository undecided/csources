...
STRING_LITERAL(TMP3344, "end", 3);
STRING_LITERAL(TMP3345, "#end", 4);
static NIM_CONST TY77659 TMP3348 = {
...
STRING_LITERAL(TMP3354, "\\x", 2);
STRING_LITERAL(TMP3356, "\\\\", 2);
STRING_LITERAL(TMP3358, "\\\'", 2);
STRING_LITERAL(TMP3360, "\\\"", 2);
STRING_LITERAL(TMP3364, "}", 1);
STRING_LITERAL(TMP3372, "$", 1);
STRING_LITERAL(TMP3374, "\\n\"", 3);
STRING_LITERAL(TMP3375, "subschar", 8);
STRING_LITERAL(TMP3376, "metachar", 8);
STRING_LITERAL(TMP3377, "emit", 4);
STRING_LITERAL(TMP3378, "result.add", 10);
STRING_LITERAL(TMP3379, "conc", 4);
STRING_LITERAL(TMP3380, " & ", 3);
STRING_LITERAL(TMP3381, "tostring", 8);
...
N_NIMCALL(void, newline_220047)(Ttmplparser220020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_180665((*p).outp, ((NimStringDesc*) &TMP3330));
	}
	LA4: ;
	...
	i = d;
	{
		...
		while (1) {
			...
			case 91:
			{
				...
				TMP3333 = addInt((*p).bracket, ((NI) 1));
				(*p).bracket = (NI)(TMP3333);
			}
			break;
			case 93:
			{
...
N_NIMCALL(void, parseline_220149)(Ttmplparser220020* p) {
	...
	LA7: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP3341));
		{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_167155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3344));
			}
			LA20: ;
			...
			llstreamwrite_180665((*p).outp, ((NimStringDesc*) &TMP3345));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
		...
		case ((NU16) 26):
		{
			...
			TMP3347 = subInt((*p).indent, ((NI) 2));
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3347), ((NI) 0), ((NI) 2147483647))));
		...
		case ((NU16) 62):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				NI TMP3349;
				LOC37 = 0;
				LOC37 = contains_101373((*p).x, TMP3348);
				if (!!(LOC37)) goto LA38;
				nimln(106, "filter_tmpl.nim");
				TMP3349 = addInt((*p).indent, ((NI) 2));
				(*p).indent = (NI)(TMP3349);
			}
			LA38: ;
		}
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3350), ((NI) 0), ((NI) 2147483647))));
			llstreamwrite_180665((*p).outp, LOC45);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_180665((*p).outp, ((NimStringDesc*) &TMP3351));
		}
		break;
		case ((NU8) 0):
		{
			...
			TMP3353 = addInt((*p).emitpar, ((NI) 1));
			(*p).emitpar = (NI)(TMP3353);
		}
		break;
		}
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_167155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3364));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_167155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3372));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_180665((*p).outp, ((NimStringDesc*) &TMP3374));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream180204*, filtertmpl_220009)(Tllstream180204* stdin_220011, NimStringDesc* filename, Tnode193813* call) {
	...
	p.outp = llstreamopen_180220(((NimStringDesc*) &TMP3341));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_220011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_219020(call, ((NimStringDesc*) &TMP3375), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_219020(call, ((NimStringDesc*) &TMP3376), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_219029(call, ((NimStringDesc*) &TMP3377), ((NI) 3), ((NimStringDesc*) &TMP3378));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_219029(call, ((NimStringDesc*) &TMP3379), ((NI) 4), ((NimStringDesc*) &TMP3380));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_219029(call, ((NimStringDesc*) &TMP3381), ((NI) 5), ((NimStringDesc*) &TMP3372));
	...
	p.x = rawNewString(((NI) 120));
	{
		...
		while (1) {
			...
			TMP3382 = addInt(p.info.line, ((NI16) 1));
			if (TMP3382 < -32768 || TMP3382 > 32767) raiseOverflow();
			p.info.line = (NI16)(TMP3382);
