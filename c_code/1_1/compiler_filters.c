...
static NIM_CONST TY194031 TMP3311 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3312, "sons", 4);
static NIM_CONST TY194031 TMP3313 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3314, "ident", 5);
static NIM_CONST TY194031 TMP3316 = {
...
STRING_LITERAL(TMP3321, "false", 5);
STRING_LITERAL(TMP3322, "startswith", 10);
STRING_LITERAL(TMP3323, "", 0);
STRING_LITERAL(TMP3324, "leading", 7);
STRING_LITERAL(TMP3325, "trailing", 8);
STRING_LITERAL(TMP3326, "sub", 3);
STRING_LITERAL(TMP3327, "by", 2);
...
{	result = 0;
	...
	LA3: ;
	{
		...
		TMP3310 = subInt(LOC6, ((NI) 1));
		HEX3Atmp_219115 = (NI)(TMP3310);
			...
			while (1) {
				...
				nimln(31, "filters.nim");
				{
					...
					nimln(32, "filters.nim");
					{
						if (((TMP3311[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3312));
						if ((NU)(i_219086) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP3311[(*(*n).kindU.S6.sons->data[i_219086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_219086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3312));
					...
					nimln(33, "filters.nim");
					{
						...
						if (((TMP3311[(*(*n).kindU.S6.sons->data[i_219086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_219086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3312));
						if ((NU)(((NI) 0)) >= (NU)((*(*n).kindU.S6.sons->data[i_219086]).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP3313[(*(*(*n).kindU.S6.sons->data[i_219086]).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*(*n).kindU.S6.sons->data[i_219086]).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3314));
						LOC19 = 0;
				...
				TMP3315 = addInt(res_219118, ((NI) 1));
				res_219118 = (NI)(TMP3315);
			} LA8: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(NIM_CHAR, chararg_219020)(Tnode193813* n, NimStringDesc* name, NI pos, NIM_CHAR default_219025) {
	...
	LA3: ;
	{
		...
		if (!(((TMP3316[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3317));
...
N_NIMCALL(NIM_BOOL, boolarg_219038)(Tnode193813* n, NimStringDesc* name, NI pos, NIM_BOOL default_219043) {
	...
	LA3: ;
	{
		...
		LOC6 = ((*x).kind == ((NU8) 2));
		if (!(LOC6)) goto LA7;
		if (!(((TMP3313[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3314));
		LOC6 = identeq_169484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3320));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		if (!(LOC11)) goto LA12;
		if (!(((TMP3313[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3314));
		LOC11 = identeq_169484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3321));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream180204*, filterstrip_219012)(Tllstream180204* stdin_219014, NimStringDesc* filename, Tnode193813* call) {
	...
	pattern = strarg_219029(call, ((NimStringDesc*) &TMP3322), ((NI) 1), ((NimStringDesc*) &TMP3323));
	nimln(59, "filters.nim");
	leading = boolarg_219038(call, ((NimStringDesc*) &TMP3324), ((NI) 2), NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_219038(call, ((NimStringDesc*) &TMP3325), ((NI) 3), NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_180220(((NimStringDesc*) &TMP3323));
...
N_NIMCALL(Tllstream180204*, filterreplace_219004)(Tllstream180204* stdin_219006, NimStringDesc* filename, Tnode193813* call) {
	...
	sub = strarg_219029(call, ((NimStringDesc*) &TMP3326), ((NI) 1), ((NimStringDesc*) &TMP3323));
	...
	by = strarg_219029(call, ((NimStringDesc*) &TMP3327), ((NI) 2), ((NimStringDesc*) &TMP3323));
