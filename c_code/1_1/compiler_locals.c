...
STRING_LITERAL(TMP8072, "stdlib", 6);
STRING_LITERAL(TMP8073, "system", 6);
STRING_LITERAL(TMP8074, "locals", 6);
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit)(void) {
	...
	nimln(42, "locals.nim");
	registerplugin_409124(((NimStringDesc*) &TMP8072), ((NimStringDesc*) &TMP8073), ((NimStringDesc*) &TMP8074), semlocals_410020);
	popFrame();
}
