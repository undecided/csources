...
N_NIMCALL(Ropeobj163009*, makecstring_165449)(NimStringDesc* s) {
	...
	res = rawNewString(((NI)chckRange((NI)(TMP1171), ((NI) 0), ((NI) 2147483647))));
	nimln(501, "msgs.nim");
...
N_NIMCALL(void, suggestwriteln_166069)(NimStringDesc* s) {
	...
	nimln(591, "msgs.nim");
	{
		...
		{
			nimln(593, "msgs.nim");
			writelnhook_166060.ClEnv? writelnhook_166060.ClPrc(s, writelnhook_166060.ClEnv):((TMP1195)(writelnhook_166060.ClPrc))(s);
		}
		LA5: ;
	}
	LA3: ;
...
N_NIMCALL(void, suggestquit_166125)(void) {
	...
	nimln(2266, "system.nim");
	LOC1 = 0;
	LOC1 = (*e_166129).Sup.message; (*e_166129).Sup.message = copyStringRC1(((NimStringDesc*) &TMP1197));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(599, "msgs.nim");
...
N_NIMCALL(void, popinfocontext_166211)(void) {
	...
	nimln(619, "msgs.nim");
	TMP1198 = subInt((msgcontext_166053 ? msgcontext_166053->Sup.len : 0), ((NI) 1));
	msgcontext_166053 = (TY166036*) setLengthSeq(&(msgcontext_166053)->Sup, sizeof(Tlineinfo165338), ((NI)chckRange((NI)(TMP1198), ((NI) 0), ((NI) 2147483647))));
	popFrame();
}
...
N_NIMCALL(void, msgwriteln_166536)(NimStringDesc* s) {
	...
	nimln(690, "msgs.nim");
	{
		...
		nimln(691, "msgs.nim");
		writelnhook_166060.ClEnv? writelnhook_166060.ClPrc(s, writelnhook_166060.ClEnv):((TMP1206)(writelnhook_166060.ClPrc))(s);
	}
	goto LA1;
	LA3: ;
	{
...
appendString(LOC22, ((NimStringDesc*) &TMP1235));
	...
	nimln(722, "msgs.nim");
	{
		...
		if (!LOC25) goto LA27;
		nimln(723, "msgs.nim");
		TMP1236 = addInt(gerrorcounter_166015, ((NI) 1));
		gerrorcounter_166015 = (NI)(TMP1236);
		nimln(724, "msgs.nim");
...
N_NIMCALL(void, writecontext_166800)(Tlineinfo165338 lastinfo) {
	...
	info = lastinfo;
	{
		...
		HEX3Atmp_166828 = 0;
		nimln(737, "msgs.nim");
		TMP1237 = subInt((msgcontext_166053 ? msgcontext_166053->Sup.len : 0), ((NI) 1));
		...
		res_166831 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(738, "msgs.nim");
				{
					...
					nimln(741, "msgs.nim");
					if ((NU)(i_166824) >= (NU)(msgcontext_166053->Sup.len)) raiseIndexError();
					TMP1239 = addInt(msgcontext_166053->data[i_166824].col, ((NI16) 1));
...
{	frmt = 0;
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		nimln(759, "msgs.nim");
		TMP1243 = addInt(gwarncounter_166017, ((NI) 1));
		gwarncounter_166017 = (NI)(TMP1243);
	}
	break;
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		nimln(764, "msgs.nim");
		TMP1245 = addInt(ghintcounter_166016, ((NI) 1));
		ghintcounter_166016 = (NI)(TMP1245);
	}
	break;
	}
	nimln(765, "msgs.nim");
...
N_NIMCALL(void, limessage_166997)(Tlineinfo165338 info, NU16 msg, NimStringDesc* arg, NU8 eh) {
	...
	case ((NU16) 230) ... ((NU16) 260):
	{
		...
		frmt = copyString(((NimStringDesc*) &TMP1248));
		nimln(802, "msgs.nim");
		TMP1252 = addInt(gwarncounter_166017, ((NI) 1));
		gwarncounter_166017 = (NI)(TMP1252);
	}
	break;
	case ((NU16) 261) ... ((NU16) 277):
	{
		...
		frmt = copyString(((NimStringDesc*) &TMP1249));
		nimln(806, "msgs.nim");
		TMP1253 = addInt(ghintcounter_166016, ((NI) 1));
		ghintcounter_166016 = (NI)(TMP1253);
	}
	break;
	}
	nimln(810, "msgs.nim");
