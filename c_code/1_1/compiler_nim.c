...
N_NIMCALL(void, handlecmdline_530607)(void);
...
STRING_LITERAL(TMP10778, "", 0);
STRING_LITERAL(TMP10780, "nim.cfg", 7);
STRING_LITERAL(TMP10781, "-", 1);
STRING_LITERAL(TMP10782, "stdinfile", 9);
STRING_LITERAL(TMP10783, "js", 2);
STRING_LITERAL(TMP10784, " ", 1);
STRING_LITERAL(TMP10785, "exe", 3);
...
N_NIMCALL(void, handlecmdline_530607)(void) {
	...
	nimln(36, "nim.nim");
	{
		...
		nimln(37, "nim.nim");
		writecommandlineusage_178020();
	}
	goto LA1;
	LA4: ;
	{
		nimln(40, "nim.nim");
		processcmdline_524209(((NU8) 0), ((NimStringDesc*) &TMP10778));
		nimln(41, "nim.nim");
		{
			TSafePoint TMP10779;
			TY119789 p;
			NimStringDesc* LOC15;
			NimStringDesc* LOC16;
			if (!!(((gprojectname_156234) && (gprojectname_156234)->Sup.len == 0))) goto LA9;
			nimln(42, "nim.nim");
			pushSafePoint(&TMP10779);
			TMP10779.status = setjmp(TMP10779.context);
			if (TMP10779.status == 0) {
				nimln(43, "nim.nim");
				asgnRefNoCycle((void**) (&gprojectfull_156236), canonicalizepath_156374(gprojectname_156234));
				popSafePoint();
			}
			else {
				popSafePoint();
				...
				if (isObj(getCurrentException()->Sup.m_type, (&NTI3433))) {
					...
					nimln(45, "nim.nim");
					LOC14 = 0;
					LOC14 = gprojectfull_156236; gprojectfull_156236 = copyStringRC1(gprojectname_156234);
					if (LOC14) nimGCunrefNoCycle(LOC14);
					popCurrentException();
				}
			}
			if (TMP10779.status != 0) reraiseException();
			memset((void*)(&p), 0, sizeof(p));
			nimln(46, "nim.nim");
			chckNil((void*)(&p));
			memset((void*)(&p), 0, sizeof(p));
			nossplitFile(gprojectfull_156236, (&p));
			nimln(47, "nim.nim");
			LOC15 = 0;
			LOC15 = gprojectpath_156235; gprojectpath_156235 = copyStringRC1(p.Field0);
			if (LOC15) nimGCunrefNoCycle(LOC15);
			nimln(48, "nim.nim");
			LOC16 = 0;
			LOC16 = gprojectname_156234; gprojectname_156234 = copyStringRC1(p.Field1);
		...
		{
			nimln(50, "nim.nim");
			asgnRefNoCycle((void**) (&gprojectpath_156235), nosgetCurrentDir());
		}
		LA7: ;
		nimln(51, "nim.nim");
		loadconfigs_188807(((NimStringDesc*) &TMP10780));
		nimln(54, "nim.nim");
		initvars_172876();
		nimln(55, "nim.nim");
		processcmdline_524209(((NU8) 1), ((NimStringDesc*) &TMP10778));
		nimln(56, "nim.nim");
		maincommand_527628();
		nimln(57, "nim.nim");
		{
		...
		nimln(59, "nim.nim");
		{
			if (!(gerrorcounter_166015 == ((NI) 0))) goto LA25;
			nimln(63, "nim.nim");
			{
				if (!((gglobaloptions_156128 &(1<<((((NU8) 13))&31)))!=0)) goto LA29;
				nimln(64, "nim.nim");
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_156234, ((NimStringDesc*) &TMP10781))) goto LA33;
					nimln(65, "nim.nim");
					LOC35 = 0;
					LOC35 = gprojectfull_156236; gprojectfull_156236 = copyStringRC1(((NimStringDesc*) &TMP10782));
				...
				nimln(66, "nim.nim");
				{
					...
					NimStringDesc* LOC49;
					NimStringDesc* LOC50;
					if (!(gcmd_156130 == ((NU8) 4))) goto LA38;
					ex = 0;
					nimln(68, "nim.nim");
					{
						NimStringDesc* LOC44;
						if (!(((NI) 0) < (outfile_156134 ? outfile_156134->Sup.len : 0))) goto LA42;
						nimln(69, "nim.nim");
						LOC44 = 0;
						LOC44 = prependcurdir_530401(outfile_156134);
					...
					LA42: ;
					{
						...
						nimln(72, "nim.nim");
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_156236, ((NimStringDesc*) &TMP10783));
						LOC47 = 0;
						LOC47 = prependcurdir_530401(LOC46);
						LOC48 = 0;
						LOC48 = completecfilepath_172912(LOC47, NIM_TRUE);
					...
					LOC49 = 0;
					LOC50 = 0;
					LOC50 = findnodejs_529009();
					LOC49 = rawNewString(LOC50->Sup.len + ex->Sup.len + arguments_179721->Sup.len + 2);
appendString(LOC49, LOC50);
appendString(LOC49, ((NimStringDesc*) &TMP10784));
appendString(LOC49, ex);
appendChar(LOC49, 32);
appendString(LOC49, arguments_179721);
					execexternalprogram_172985(LOC49, ((NimStringDesc*) &TMP10778));
				}
				goto LA36;
				LA38: ;
				{
					...
					nimln(76, "nim.nim");
					{
						if (!(((NI) 0) < (outfile_156134 ? outfile_156134->Sup.len : 0))) goto LA54;
						nimln(78, "nim.nim");
						binpath = prependcurdir_530401(outfile_156134);
					}
					goto LA52;
					LA54: ;
					{
						...
						nimln(81, "nim.nim");
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_156236, ((NimStringDesc*) &TMP10785));
						binpath = prependcurdir_530401(LOC57);
					}
					LA52: ;
					nimln(82, "nim.nim");
					...
					nimln(83, "nim.nim");
					LOC58 = 0;
					LOC58 = rawNewString(ex->Sup.len + arguments_179721->Sup.len + 1);
appendString(LOC58, ex);
appendChar(LOC58, 32);
appendString(LOC58, arguments_179721);
					execexternalprogram_172985(LOC58, ((NimStringDesc*) &TMP10778));
				}
				LA36: ;
			}
			LA29: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit)(void) {
	...
	initdefines_170254();
	nimln(94, "nim.nim");
	handlecmdline_530607();
	nimln(95, "nim.nim");
	msgquit_166107(((NI8) ((((NI) 0) < gerrorcounter_166015))));
	popFrame();
}
