...
N_NIMCALL(void, fillbuffer_181097)(Tbaselexer181024* L) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP2113)]))), ((NI)chckRange((NI)(TMP2114), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
		...
		s = (NI)(TMP2120);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP2124), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, openbaselexer_181035)(Tbaselexer181024* L, Tllstream180204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_6001(((NI)chckRange((NI)(TMP2141), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC5));
...
N_NIMCALL(NI, getcolnumber_181059)(Tbaselexer181024* L, NI pos) {
	...
	if ((NI)(TMP2143) == (-2147483647 -1)) raiseOverflow();
