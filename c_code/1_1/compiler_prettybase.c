...
N_NIMCALL(void, TMP4249)(void* p, NI op);
...
STRING_LITERAL(TMP4251, ".nimfix", 7);
STRING_LITERAL(TMP4254, "\015\012", 2);
...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP4272, "discard ", 8);
STRING_LITERAL(TMP4274, "\"", 1);
...
N_NIMCALL(void, loadfile_251041)(Tlineinfo165338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		TMP4250 = addInt(i, ((NI32) 1));
		gsourcefiles_251036 = (TY251019*) setLengthSeq(&(gsourcefiles_251036)->Sup, sizeof(Tsourcefile251008), ((NI)chckRange((NI32)(TMP4250), ((NI) 0), ((NI) 2147483647))));
	}
	LA3: ;
	nimln(27, "prettybase.nim");
	{
		...
		path = tofullpath_166276(info.fileindex);
		...
		gsourcefiles_251036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP4251));
		{
		...
		LOC16 = 0;
		LOC16 = newfilestream_141773(path, ((NU8) 0));
		LOC17 = 0;
		LOC17 = &LOC16->Sup;
		...
		pos = lex.bufpos;
		{
			...
			while (1) {
				...
				case 13:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_251036->Sup.len)) raiseIndexError();
					LOC21 = 0;
					LOC21 = gsourcefiles_251036->data[i].newline; gsourcefiles_251036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4254));
				...
				case 0:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_251036->Sup.len)) raiseIndexError();
					LOC23 = 0;
					LOC23 = gsourcefiles_251036->data[i].newline; gsourcefiles_251036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4255));
...
N_NIMCALL(NI, identlen_251147)(NimStringDesc* line, NI start) {
	...
	result = 0;
	{
		...
		while (1) {
			...
			NI TMP4259;
			LOC3 = 0;
			TMP4257 = addInt(start, result);
			LOC3 = ((NI)(TMP4257) < (line ? line->Sup.len : 0));
			if (!(LOC3)) goto LA4;
			TMP4258 = addInt(start, result);
			if ((NU)((NI)(TMP4258)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC3 = (((NU8)(line->data[(NI)(TMP4258)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4258)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4258)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4258)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4258)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4258)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4258)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4258)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4258)])) == ((NU8)(95)));
			LA4: ;
			if (!LOC3) goto LA2;
			nimln(57, "prettybase.nim");
			TMP4259 = addInt(result, ((NI) 1));
			result = (NI)(TMP4259);
		} LA2: ;
	}
	popFrame();
...
{	nimln(64, "prettybase.nim");
	...
	TMP4260 = subInt(info.line, ((NI16) 1));
	if (TMP4260 < -32768 || TMP4260 > 32767) raiseOverflow();
	if ((NU)((NI16)(TMP4260)) >= (NU)(gsourcefiles_251036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_251036->data[info.fileindex].lines->data[(NI16)(TMP4260)];
	...
	LA3: ;
	{
		...
		while (1) {
			...
			LOC7 = (((NI) 0) < first);
			if (!(LOC7)) goto LA8;
			TMP4261 = subInt(first, ((NI) 1));
			if ((NU)((NI)(TMP4261)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC7 = (((NU8)(line->data[(NI)(TMP4261)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4261)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4261)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4261)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4261)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4261)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4261)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4261)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4261)])) == ((NU8)(95)));
			LA8: ;
			if (!LOC7) goto LA6;
	...
	TMP4264 = addInt(first, LOC17);
	TMP4265 = subInt((NI)(TMP4264), ((NI) 1));
	last = (NI)(TMP4265);
	nimln(75, "prettybase.nim");
	{
		...
		LOC25 = 0;
		TMP4266 = subInt(first, ((NI) 1));
		LOC26 = 0;
		LOC26 = copyStrLast(line, ((NI) 0), (NI)(TMP4266));
		TMP4267 = addInt(last, ((NI) 1));
		LOC27 = 0;
		LOC27 = copyStr(line, (NI)(TMP4267));
...
appendString(LOC25, LOC27);
		...
		if ((NU)((NI16)(TMP4268)) >= (NU)(gsourcefiles_251036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) (&gsourcefiles_251036->data[info.fileindex].lines->data[(NI16)(TMP4268)]), x);
...
N_NIMCALL(void, replacecomment_251286)(Tlineinfo165338 info) {
	...
	line = gsourcefiles_251036->data[info.fileindex].lines->data[(NI16)(TMP4269)];
	...
	LOC6 = 0;
	LOC6 = copyStrLast(line, ((NI) 0), (NI)(TMP4271));
	TMP4273 = addInt(first, ((NI) 1));
	LOC7 = 0;
	LOC7 = copyStr(line, (NI)(TMP4273));
	LOC8 = 0;
	LOC8 = nsuEscape(LOC7, ((NimStringDesc*) &TMP4274), ((NimStringDesc*) &TMP4274));
...
appendString(LOC5, LOC8);
	...
	if ((NU)((NI16)(TMP4275)) >= (NU)(gsourcefiles_251036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	asgnRefNoCycle((void**) (&gsourcefiles_251036->data[info.fileindex].lines->data[(NI16)(TMP4275)]), x);
...
static TNimNode* TMP4248[6];
static TNimNode TMP4204[7];
...
TMP4248[0] = &TMP4204[1];
TMP4204[1].kind = 1;
TMP4204[1].offset = offsetof(Tsourcefile251008, lines);
TMP4204[1].typ = (&NTI13606);
TMP4204[1].name = "lines";
TMP4248[1] = &TMP4204[2];
TMP4204[2].kind = 1;
TMP4204[2].offset = offsetof(Tsourcefile251008, dirty);
TMP4204[2].typ = (&NTI138);
TMP4204[2].name = "dirty";
TMP4248[2] = &TMP4204[3];
TMP4204[3].kind = 1;
TMP4204[3].offset = offsetof(Tsourcefile251008, isnimfixfile);
TMP4204[3].typ = (&NTI138);
TMP4204[3].name = "isNimfixFile";
TMP4248[3] = &TMP4204[4];
TMP4204[4].kind = 1;
TMP4204[4].offset = offsetof(Tsourcefile251008, fullpath);
TMP4204[4].typ = (&NTI149);
TMP4204[4].name = "fullpath";
TMP4248[4] = &TMP4204[5];
TMP4204[5].kind = 1;
TMP4204[5].offset = offsetof(Tsourcefile251008, newline);
TMP4204[5].typ = (&NTI149);
TMP4204[5].name = "newline";
TMP4248[5] = &TMP4204[6];
TMP4204[6].kind = 1;
TMP4204[6].offset = offsetof(Tsourcefile251008, fileidx);
TMP4204[6].typ = (&NTI114);
TMP4204[6].name = "fileIdx";
TMP4204[0].len = 6; TMP4204[0].kind = 2; TMP4204[0].sons = &TMP4248[0];
NTI251008.node = &TMP4204[0];
NTI251019.size = sizeof(TY251019*);
NTI251019.kind = 24;
NTI251019.base = (&NTI251008);
NTI251019.flags = 2;
NTI251019.marker = TMP4249;
}
