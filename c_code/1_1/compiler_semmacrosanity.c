...
static NIM_CONST TY194031 TMP7970 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7971, "sons", 4);
STRING_LITERAL(TMP7974, "ithField", 8);
STRING_LITERAL(TMP7978, "ithField(record case branch)", 28);
static NIM_CONST TY194031 TMP7980 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7981, "sym", 3);
STRING_LITERAL(TMP7982, "invalid field at index ", 23);
STRING_LITERAL(TMP7985, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP7987, "[] must have some form of array type", 36);
STRING_LITERAL(TMP7989, "{} must have the set type", 25);
STRING_LITERAL(TMP7990, "float literal must have some float type", 39);
STRING_LITERAL(TMP7991, "integer literal must have some int type", 39);
STRING_LITERAL(TMP7992, "string literal must be of some string type", 42);
STRING_LITERAL(TMP7993, "nil literal must be of some pointer type", 40);
...
{	result = 0;
	...
	{
		{
			...
			TMP7969 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_405095 = (NI)(TMP7969);
			...
			res_405098 = ((NI) 0);
			{
				...
				while (1) {
					...
					if (((TMP7970[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7971));
					if ((NU)(i_405029) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
					TMP7972 = subInt(field, i_405029);
					result = ithfield_405012((*n).kindU.S6.sons->data[i_405029], (NI)(TMP7972));
					...
					TMP7973 = addInt(res_405098, ((NI) 1));
					res_405098 = (NI)(TMP7973);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_167199((*n).info, ((NimStringDesc*) &TMP7974));
		}
		LA13: ;
		nimln(24, "semmacrosanity.nim");
		if (((TMP7970[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7971));
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		TMP7975 = subInt(field, ((NI) 1));
		result = ithfield_405012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7975));
		...
		LA17: ;
		{
			...
			TMP7976 = subInt(LOC20, ((NI) 1));
			HEX3Atmp_405103 = (NI)(TMP7976);
			nimln(1598, "system.nim");
			res_405106 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_405012(LOC24, (NI)(TMP7977));
					...
					default:
					{
						...
						internalerror_167199((*n).info, ((NimStringDesc*) &TMP7978));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7979 = addInt(res_405106, ((NI) 1));
					res_405106 = (NI)(TMP7979);
				} LA22: ;
			}
		}
	}
	...
	case ((NU8) 3):
	{
		nimln(33, "semmacrosanity.nim");
		{
			...
			if (!(((TMP7980[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7981));
...
appendString(LOC14, ((NimStringDesc*) &TMP7982));
appendString(LOC14, LOC15);
						...
						TMP7983 = addInt(res_405313, ((NI) 1));
						res_405313 = (NI)(TMP7983);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, ((NimStringDesc*) &TMP7982));
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP7984 = addInt(res_405321, ((NI) 1));
						res_405321 = (NI)(TMP7984);
					} LA23: ;
				}
			}
		}
		...
		LA35: ;
		{
			...
			globalerror_167145((*n).info, ((NimStringDesc*) &TMP7985));
		}
		LA2: ;
	}
	break;
				...
				m_405253 = 0;
				{
					...
					res_405333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP7986 = addInt(res_405333, ((NI) 1));
							res_405333 = (NI)(TMP7986);
						} LA47: ;
					}
				}
			}
				...
				m_405265 = 0;
				{
					...
					res_405344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP7988 = addInt(res_405344, ((NI) 1));
							res_405344 = (NI)(TMP7988);
						} LA59: ;
					}
				}
			}
	...
	case ((NU8) 16) ... ((NU8) 19):
	{
		...
		LA65: ;
		{
			...
			globalerror_167145((*n).info, ((NimStringDesc*) &TMP7990));
		}
		LA63: ;
	}
	break;
