...
STRING_LITERAL(TMP7459, "", 0);
STRING_LITERAL(TMP7460, "\015\012", 2);
STRING_LITERAL(TMP7464, "void", 4);
STRING_LITERAL(TMP7466, "none", 4);
STRING_LITERAL(TMP7467, "bool", 4);
STRING_LITERAL(TMP7468, "char", 4);
STRING_LITERAL(TMP7469, "nil", 3);
STRING_LITERAL(TMP7470, "expr", 4);
STRING_LITERAL(TMP7471, "stmt", 4);
STRING_LITERAL(TMP7472, "void", 4);
STRING_LITERAL(TMP7473, "array", 5);
STRING_LITERAL(TMP7474, "typeDesc", 8);
STRING_LITERAL(TMP7475, "typeDesc", 8);
STRING_LITERAL(TMP7477, "distinct", 8);
STRING_LITERAL(TMP7478, "tuple", 5);
STRING_LITERAL(TMP7479, "set", 3);
STRING_LITERAL(TMP7480, "ptr", 3);
STRING_LITERAL(TMP7481, "ref", 3);
STRING_LITERAL(TMP7482, "var", 3);
STRING_LITERAL(TMP7483, "seq", 3);
STRING_LITERAL(TMP7484, "proc", 4);
STRING_LITERAL(TMP7485, "openArray", 9);
STRING_LITERAL(TMP7486, "range", 5);
static NIM_CONST TY194031 TMP7487 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7488, "sons", 4);
STRING_LITERAL(TMP7489, "pointer", 7);
STRING_LITERAL(TMP7490, "string", 6);
STRING_LITERAL(TMP7491, "cstring", 7);
STRING_LITERAL(TMP7492, "int", 3);
STRING_LITERAL(TMP7493, "int8", 4);
STRING_LITERAL(TMP7494, "int16", 5);
STRING_LITERAL(TMP7495, "int32", 5);
STRING_LITERAL(TMP7496, "int64", 5);
STRING_LITERAL(TMP7497, "float", 5);
STRING_LITERAL(TMP7498, "float32", 7);
STRING_LITERAL(TMP7499, "float64", 7);
STRING_LITERAL(TMP7500, "float128", 8);
STRING_LITERAL(TMP7501, "uint", 4);
STRING_LITERAL(TMP7502, "uint8", 5);
STRING_LITERAL(TMP7503, "uint16", 6);
STRING_LITERAL(TMP7504, "uint32", 6);
STRING_LITERAL(TMP7505, "uint64", 6);
STRING_LITERAL(TMP7506, "bignum", 6);
STRING_LITERAL(TMP7507, "const", 5);
STRING_LITERAL(TMP7508, "mutable", 7);
STRING_LITERAL(TMP7509, "varargs", 7);
STRING_LITERAL(TMP7510, "iter", 4);
STRING_LITERAL(TMP7511, "error", 5);
STRING_LITERAL(TMP7512, "builtinTypeClass", 16);
STRING_LITERAL(TMP7513, "concept", 7);
STRING_LITERAL(TMP7514, "compositeTypeClass", 18);
STRING_LITERAL(TMP7515, "and", 3);
STRING_LITERAL(TMP7516, "or", 2);
STRING_LITERAL(TMP7517, "not", 3);
STRING_LITERAL(TMP7518, "anything", 8);
STRING_LITERAL(TMP7519, "static", 6);
...
N_NIMCALL(NimStringDesc*, readoutput_383009)(Processobj146402* p) {
	...
	result = 0;
	nimln(13, "vmdeps.nim");
	result = copyString(((NimStringDesc*) &TMP7459));
	nimln(14, "vmdeps.nim");
...
appendString(result, ((NimStringDesc*) &TMP7460));
		} LA2: ;
	}
	nimln(18, "vmdeps.nim");
	TMP7461 = subInt((result ? result->Sup.len : 0), ((NI) 2));
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7461), ((NI) 0), ((NI) 2147483647))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
...
N_NIMCALL(NimStringDesc*, opgorge_383027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	result = 0;
	nimln(22, "vmdeps.nim");
	pushSafePoint(&TMP7462);
	TMP7462.status = setjmp(TMP7462.context);
	if (TMP7462.status == 0) {
		Processobj146402* p;
		TY146637 LOC2;
		nimln(23, "vmdeps.nim");
		memset((void*)LOC2, 0, sizeof(LOC2));
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP7459), LOC2, 0, NIM_NIL, 4);
		nimln(24, "vmdeps.nim");
		{
	...
	if (TMP7462.status != 0) reraiseException();
	popFrame();
	return result;
}
		...
		res_383133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_383126 = atomictypex_383066(((NimStringDesc*) &TMP7464), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7465 = addInt(res_383133, ((NI) 1));
				res_383133 = (NI)(TMP7465);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode193813*, maptypetoast_383080)(Ttype193849* t, Tlineinfo165338 info, NIM_BOOL allowrecursion) {
	...
	{
		nimln(66, "vmdeps.nim");
		result = atomictypex_383066(((NimStringDesc*) &TMP7466), t, info);
	}
	break;
	case ((NU8) 1):
	{
	...
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_383066(((NimStringDesc*) &TMP7473), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_383066(((NimStringDesc*) &TMP7474), t, info);
		...
		{
			nimln(84, "vmdeps.nim");
			result = atomictypex_383066(((NimStringDesc*) &TMP7475), t, info);
		}
		LA13: ;
	}
	break;
		...
		result = newnodeit_195807(((NU8) 42), info, t);
		{
			...
			res_383246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7476 = addInt(res_383246, ((NI) 1));
					res_383246 = (NI)(TMP7476);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 13):
	{
		nimln(92, "vmdeps.nim");
		{
			...
			nimln(93, "vmdeps.nim");
			result = maptypetobracket_383088(((NimStringDesc*) &TMP7477), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_383066(((NimStringDesc*) &TMP7486), t, info);
		add_194164(result, LOC61);
		nimln(121, "vmdeps.nim");
		if (((TMP7487[(*(*t).n).kind/8] &(1<<((*(*t).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7488));
	...
	case ((NU8) 26):
	{
		...
		result = atomictypex_383066(((NimStringDesc*) &TMP7489), t, info);
	}
	break;
	case ((NU8) 28):
	{
	...
	case ((NU8) 46):
	{
		...
		result = maptypetobracket_383088(((NimStringDesc*) &TMP7507), t, info);
	}
	break;
	case ((NU8) 47):
	{
	...
	case ((NU8) 50):
	{
		...
		result = atomictypex_383066(((NimStringDesc*) &TMP7511), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 58):
	{
		...
		result = atomictypex_383066(((NimStringDesc*) &TMP7518), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_383066(((NimStringDesc*) &TMP7519), t, info);
