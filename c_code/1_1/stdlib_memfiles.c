...
STRING_LITERAL(TMP3716, "newFileSize == -1 or not (mode == fmRead) ", 42);
...
N_NIMCALL(void*, mapmem_234220)(Memfile234208* m, NU8 mode, NI mappedsize, NI offset) {
	...
	LA8: ;
	result = Dl_107428((*m).maphandle, LOC1, ((NI32) ((NI)((NU32)(offset) >> (NU32)(((NI) 32))))), ((NI32)chckRange((NI)(((NI64) (offset)) & IL64(4294967295)), ((NI32) (-2147483647 -1)), ((NI32) 2147483647))), ((NI32) (LOC7)), NIM_NIL);
...
N_NIMCALL(Memfile234208, open_234607)(NimStringDesc* filename, NU8 mode, NI mappedsize, NI offset, NI newfilesize) {
	...
	nimln(96, "memfiles.nim");
	{
		...
		LA4: ;
		if (!!(LOC3)) goto LA5;
		failedassertimpl_88817(((NimStringDesc*) &TMP3716));
	}
	LA5: ;
	...
	LA92: ;
	result.mem = Dl_107428(result.maphandle, LOC85, ((NI32) ((NI)((NU32)(offset) >> (NU32)(((NI) 32))))), ((NI32)chckRange((NI)(((NI64) (offset)) & IL64(4294967295)), ((NI32) (-2147483647 -1)), ((NI32) 2147483647))), ((NI32) (LOC91)), NIM_NIL);
	...
	LA114: ;
	{
		...
		nimln(169, "memfiles.nim");
		{
			...
			result.size = ((NI)chckRange64(((filesize <= ((NI64) (mappedsize))) ? filesize : ((NI64) (mappedsize))), ((NI) (-2147483647 -1)), ((NI) 2147483647)));
		}
		goto LA128;
		LA130: ;
		{
			nimln(170, "memfiles.nim");
			result.size = ((NI)chckRange64(filesize, ((NI) (-2147483647 -1)), ((NI) 2147483647)));
		}
		LA128: ;
	}
	LA112: ;
...
static TNimNode* TMP3890[4];
static TNimNode TMP3714[5];
...
TMP3890[0] = &TMP3714[1];
TMP3714[1].kind = 1;
TMP3714[1].offset = offsetof(Memfile234208, mem);
TMP3714[1].typ = (&NTI153);
TMP3714[1].name = "mem";
TMP3890[1] = &TMP3714[2];
TMP3714[2].kind = 1;
TMP3714[2].offset = offsetof(Memfile234208, size);
TMP3714[2].typ = (&NTI108);
TMP3714[2].name = "size";
TMP3890[2] = &TMP3714[3];
TMP3714[3].kind = 1;
TMP3714[3].offset = offsetof(Memfile234208, fhandle);
TMP3714[3].typ = (&NTI108);
TMP3714[3].name = "fHandle";
TMP3890[3] = &TMP3714[4];
TMP3714[4].kind = 1;
TMP3714[4].offset = offsetof(Memfile234208, maphandle);
TMP3714[4].typ = (&NTI108);
TMP3714[4].name = "mapHandle";
TMP3714[0].len = 4; TMP3714[0].kind = 2; TMP3714[0].sons = &TMP3890[0];
NTI234208.node = &TMP3714[0];
}
