...
N_NIMCALL(void, gethostbyaddr_513434)(NimStringDesc* ip, Hostent511612* Result);
...
N_NIMCALL(void, setsockoptint_514441)(NI socket, NI level, NI optname, NI optval);
N_NIMCALL(void, setblocking_514458)(NI s, NIM_BOOL blocking);
...
N_NIMCALL(void, createfdset_514635)(Tfdset106864* fd, TY514639* s, NI* m);
...
N_NIMCALL(void, prunesocketset_514838)(TY514639** s, Tfdset106864* fd);
...
N_NIMCALL(NI, selectwrite_514925)(TY514639** writefds, NI timeout);
N_NIMCALL(void, TMP10646)(void* p, NI op);
STRING_LITERAL(TMP10593, "ws2_32.dll", 10);
STRING_LITERAL(TMP10594, "ws2_32.dll", 10);
STRING_LITERAL(TMP10598, "Service not found.", 18);
STRING_LITERAL(TMP10605, "len(a) == L seq modified while iterating over it", 48);
NI osinvalidsocket_511651;
static void* TMP10592;
TY511662 Dl_511661;
...
TNimType NTI514639; /* seq[SocketHandle] */
...
N_NIMCALL(void, getservbyname_513027)(NimStringDesc* name, NimStringDesc* proto, Servent511610* Result) {
	...
	nimln(246, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = (*e_513216).Sup.Sup.message; (*e_513216).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10598));
...
N_NIMCALL(void, getservbyport_513233)(NU16 port, NimStringDesc* proto, Servent511610* Result) {
	...
	s = Dl_106998(((int) (((NI)(NU)(NU16)(((NI16)chckRange(port, ((NI16) -32768), ((NI16) 32767))))))), proto->data);
	nimln(262, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_513416).Sup.Sup.message; (*e_513416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10598));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		nimln(262, "rawsockets.nim");
...
N_NIMCALL(NI, getsockoptint_514421)(NI socket, NI level, NI optname) {
	...
	nimln(338, "rawsockets.nim");
	{
		...
		nimln(338, "rawsockets.nim");
		LOC3 = 0;
		LOC3 = Dl_107075(socket, ((int) (level)), ((int) (optname)), ((void*) ((&res))), (&size));
...
N_NIMCALL(void, setsockoptint_514441)(NI socket, NI level, NI optname, NI optval) {
	...
	nimln(347, "rawsockets.nim");
	{
		...
		nimln(347, "rawsockets.nim");
		LOC3 = 0;
		LOC3 = Dl_107086(socket, ((int) (level)), ((int) (optname)), ((void*) ((&value))), ((unsigned int) 4));
		if (!(LOC3 < ((NI32) 0))) goto LA4;
...
N_NIMCALL(Timeval106866, timevalfrommilliseconds_514618)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		TMP10599 = divInt(timeout, ((NI) 1000));
		seconds = (NI)(TMP10599);
		nimln(371, "rawsockets.nim");
		result.tvsec = ((NI32) (seconds));
		nimln(372, "rawsockets.nim");
		TMP10600 = mulInt(seconds, ((NI) 1000));
		TMP10601 = subInt(timeout, (NI)(TMP10600));
		TMP10602 = mulInt((NI)(TMP10601), ((NI) 1000));
		result.tvusec = ((NI32) ((NI)(TMP10602)));
	}
	LA3: ;
	popFrame();
	return result;
	...
	Fdzero_107225(fd);
	{
		...
		L_514822 = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP10604 = addInt(i_514820, ((NI) 1));
				i_514820 = (NI)(TMP10604);
				nimln(3089, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L_514822))) goto LA6;
					failedassertimpl_88817(((NimStringDesc*) &TMP10605));
				}
				LA6: ;
			} LA3: ;
		}
...
N_NIMCALL(void, prunesocketset_514838)(TY514639** s, Tfdset106864* fd) {
	...
	L = ((*s) ? (*s)->Sup.len : 0);
	{
		...
		while (1) {
			...
			nimln(384, "rawsockets.nim");
			{
				...
				if ((NU)(i) >= (NU)((*s)->Sup.len)) raiseIndexError();
				TMP10606 = subInt(L, ((NI) 1));
				if ((NU)((NI)(TMP10606)) >= (NU)((*s)->Sup.len)) raiseIndexError();
				(*s)->data[i] = (*s)->data[(NI)(TMP10606)];
				nimln(386, "rawsockets.nim");
				TMP10607 = subInt(L, ((NI) 1));
				L = (NI)(TMP10607);
			}
			goto LA3;
			LA6: ;
	...
	(*s) = (TY514639*) setLengthSeq(&((*s))->Sup, sizeof(NI), ((NI)chckRange(L, ((NI) 0), ((NI) 2147483647))));
	popFrame();
}
...
N_NIMCALL(NI, select_514896)(TY514639** readfds, NI timeout) {
	...
	createfdset_514635((&rd), (*readfds), (&m));
	nimln(405, "rawsockets.nim");
	{
		...
		TMP10609 = addInt(m, ((NI) 1));
		LOC5 = 0;
		LOC5 = Dl_107125(((int) ((NI)(TMP10609))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP10610 = addInt(m, ((NI) 1));
		LOC7 = 0;
		LOC7 = Dl_107125(((int) ((NI)(TMP10610))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_514925)(TY514639** writefds, NI timeout) {
	...
	createfdset_514635((&wr), (*writefds), (&m));
	nimln(427, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = Dl_107125(((int) ((NI)(TMP10611))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = Dl_107125(((int) ((NI)(TMP10612))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
NIM_EXTERNC N_NOINLINE(void, stdlib_rawsocketsInit)(void) {
	...
	nimln(436, "rawsockets.nim");
	{
		...
		NI32 LOC6;
		LOC3 = 0;
		LOC3 = Dl_107235(((NI16) 257), (&wsa_514954));
		if (!!((LOC3 == ((NI32) 0)))) goto LA4;
		LOC6 = 0;
		LOC6 = oslasterror_115454();
		raiseoserror_115430(LOC6);
...
NTI514639.size = sizeof(TY514639*);
NTI514639.kind = 24;
NTI514639.base = (&NTI108);
NTI514639.flags = 2;
NTI514639.marker = TMP10646;
if (!((TMP10592 = nimLoadLibrary((NimStringDesc*) &TMP10593))
)) nimLoadLibraryError((NimStringDesc*) &TMP10594);
	Dl_511661 = (TY511662) nimGetProcAddr(TMP10592, "ioctlsocket");
}
