...
N_NIMCALL(Timeval106866, timevalfrommilliseconds_514618)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		result.tvusec = ((NI32) ((NI)(TMP10604)));
	}
	LA3: ;
	popFrame();
	return result;
...
N_NIMCALL(NI, select_514896)(TY514639** readfds, NI timeout) {
	...
	nimln(405, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = Dl_107125(((int) ((NI)(TMP10611))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = Dl_107125(((int) ((NI)(TMP10612))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_514925)(TY514639** writefds, NI timeout) {
	...
	nimln(427, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = Dl_107125(((int) ((NI)(TMP10613))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = Dl_107125(((int) ((NI)(TMP10614))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
