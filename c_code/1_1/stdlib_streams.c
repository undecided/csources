...
N_NIMCALL(NI, fsreaddata_141741)(Streamobj141027* s, void* buffer, NI buflen);
N_NIMCALL(NI, readbuffer_13515)(FILE* f, void* buffer, NI len);
N_NIMCALL(void, fswritedata_141750)(Streamobj141027* s, void* buffer, NI buflen);
N_NIMCALL(NI, writebuffer_13537)(FILE* f, void* buffer, NI len);
N_NIMCALL(Filestreamobj141692*, newfilestream_141758)(FILE* f);
...
{	nimln(226, "streams.nim");
	...
	nimln(229, "streams.nim");
	{
		...
		(*s).data = setLengthStr((*s).data, ((NI)chckRange((NI)(TMP560), ((NI) 0), ((NI) 2147483647))));
	}
	LA7: ;
...
N_NIMCALL(NI, fsreaddata_141741)(Streamobj141027* s, void* buffer, NI buflen) {
	...
	if (s) chckObj((*s).Sup.m_type, (&NTI141692));
	result = readbuffer_13515((*((Filestreamobj141692*) (s))).f, buffer, ((NI)chckRange(buflen, ((NI) 0), ((NI) 2147483647))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, fswritedata_141750)(Streamobj141027* s, void* buffer, NI buflen) {
	...
	nimln(271, "streams.nim");
	{
		...
		if (s) chckObj((*s).Sup.m_type, (&NTI141692));
		LOC3 = 0;
		LOC3 = writebuffer_13537((*((Filestreamobj141692*) (s))).f, buffer, ((NI)chckRange(buflen, ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(Filestreamobj141692*, newfilestream_141758)(FILE* f) {
	...
	(*result).Sup.readdataimpl = fsreaddata_141741;
	nimln(283, "streams.nim");
	(*result).Sup.writedataimpl = fswritedata_141750;
