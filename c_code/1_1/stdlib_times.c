...
N_NIMCALL(NF, ntepochTime)(void) {
	...
	subsecs = (NI64)(TMP195);
	nimln(473, "times.nim");
	result = ((NF)(((double) (((NI)chckRange64(secs, ((NI) (-2147483647 -1)), ((NI) 2147483647)))))) + (NF)(((NF)(((double) (((NI) (subsecs))))) * (NF)(9.9999999999999995e-08))));
	popFrame();
	return result;
}
...
appendString((*buf), LOC123);
	...
	LA20: ;
	{
		...
		nimln(639, "times.nim");
		{
			...
			LOC138 = 0;
			LOC138 = nsuRepeatChar(48, ((NI)chckRange((NI)(TMP258), ((NI) 0), ((NI) 2147483647))));
...
appendString((*buf), fyear);
	...
	LA21: ;
	{
		...
		nimln(645, "times.nim");
		{
			...
			LOC153 = 0;
			LOC153 = nsuRepeatChar(48, ((NI)chckRange((NI)(TMP261), ((NI) 0), ((NI) 2147483647))));
...
appendString((*buf), fyear);
	...
	LA22: ;
	{
		...
		nimln(651, "times.nim");
		{
			...
			LOC168 = 0;
			LOC168 = nsuRepeatChar(48, ((NI)chckRange((NI)(TMP264), ((NI) 0), ((NI) 2147483647))));
...
appendString((*buf), fyear);
	...
	LA23: ;
	{
		...
		nimln(657, "times.nim");
		{
			...
			LOC183 = 0;
			LOC183 = nsuRepeatChar(48, ((NI)chckRange((NI)(TMP267), ((NI) 0), ((NI) 2147483647))));
...
appendString((*buf), LOC187);
		nimln(666, "times.nim");
		{
			...
			atindex = (NI)(TMP273);
			nimln(668, "times.nim");
			insert_89801(buf, ((NimStringDesc*) &TMP245), ((NI)chckRange(atindex, ((NI) 0), ((NI) 2147483647))));
		}
		LA190: ;
	}
	goto LA30;
