...
N_NIMCALL(void, TMP10579)(void* p, NI op);
...
STRING_LITERAL(TMP10569, "$1 -> $2;$n", 11);
static NIM_CONST TY194031 TMP10571 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP10572, "sons", 4);
STRING_LITERAL(TMP10576, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP10577, "", 0);
STRING_LITERAL(TMP10578, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_509028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_164635(&gdotgraph_509023, ((NimStringDesc*) &TMP10569), LOC1, 2);
	popFrame();
}
	...
	{
		{
			...
			TMP10570 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_509081 = (NI)(TMP10570);
			...
			res_509084 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP10573 = addInt(res_509084, ((NI) 1));
					res_509084 = (NI)(TMP10573);
				} LA5: ;
			}
		}
	}
	...
	{
		{
			...
			TMP10574 = subInt(LOC9, ((NI) 1));
			HEX3Atmp_509089 = (NI)(TMP10574);
			nimln(1598, "system.nim");
			res_509092 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP10575 = addInt(res_509092, ((NI) 1));
					res_509092 = (NI)(TMP10575);
				} LA11: ;
			}
		}
	}
...
N_NIMCALL(void, generatedot_509009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP10577));
	LOC1[0] = rope_163320(LOC3);
	LOC1[1] = gdotgraph_509023;
	LOC4 = 0;
	LOC4 = HEX25_164235(((NimStringDesc*) &TMP10576), LOC1, 2);
	nimln(47, "depends.nim");
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP10578));
...
static TNimNode TMP10567[1];
NTI509016.size = sizeof(Tgen509016);
NTI509016.kind = 17;
NTI509016.base = (&NTI244005);
TMP10567[0].kind = 1;
TMP10567[0].offset = offsetof(Tgen509016, module);
TMP10567[0].typ = (&NTI193811);
TMP10567[0].name = "module";
NTI509016.node = &TMP10567[0];
NTI509018.size = sizeof(Tgen509016*);
NTI509018.kind = 22;
NTI509018.base = (&NTI509016);
NTI509018.marker = TMP10579;
}
