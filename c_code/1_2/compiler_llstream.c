...
N_NIMCALL(Tllstream180204*, llstreamopen_180276)(void);
N_NIMCALL(Tllstream180204*, llstreamopenstdin_180293)(void);
N_NIMCALL(void, llstreamclose_180310)(Tllstream180204* s);
N_NIMCALL(NIM_BOOL, readlinefromstdin_180319)(NimStringDesc* prompt, NimStringDesc** line);
N_NIMCALL(void, write_13457)(FILE* f, NimStringDesc* s);
N_NIMCALL(NIM_BOOL, readline_13481)(FILE* f, NimStringDesc** line);
N_NIMCALL(NIM_BOOL, endswith_180404)(NimStringDesc* x, TY77659 s);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
N_NOINLINE(void, raiseIndexError)(void);
N_NIMCALL(NIM_BOOL, endswithopr_180450)(NimStringDesc* x);
static N_INLINE(NIM_BOOL, continueline_180460)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NI, counttriples_180483)(NimStringDesc* s);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, llreadfromstdin_180528)(Tllstream180204* s, void* buf, NI buflen);
...
N_NIMCALL(NI, llstreamread_180584)(Tllstream180204* s, void* buf, NI buflen);
...
N_NIMCALL(void, llstreamwrite_180718)(Tllstream180204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_180739)(Tllstream180204* s);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI start);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI first);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP2076, "", 0);
STRING_LITERAL(TMP2077, "\015\012", 2);
NIM_CONST TY77659 Linecontinuationoprs_180443 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY77659 Additionallinecontinuationoprs_180445 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77659 TMP2080 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77659 TMP2081 = {
0x00, 0x00, 0x00, 0x00, 0x7A, 0xBC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2087, ">>> ", 4);
STRING_LITERAL(TMP2088, "... ", 4);
...
N_NIMCALL(Tllstream180204*, llstreamopenstdin_180293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2076));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_180319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13457(stdout, ((NimStringDesc*) &TMP2077));
...
N_NIMCALL(NIM_BOOL, endswith_180404)(NimStringDesc* x, TY77659 s) {
	...
	TMP2078 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2078);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_180450)(NimStringDesc* x) {
	...
	result = endswith_180404(x, TMP2080);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_180460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_180404(line, TMP2081);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(97, "llstream.nim");
			{
				...
				if (!(LOC6)) goto LA7;
				TMP2082 = addInt(i, ((NI) 1));
				if ((NU)((NI)(TMP2082)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC6 = ((NU8)(s->data[(NI)(TMP2082)]) == (NU8)(34));
				LA7: ;
				LOC5 = LOC6;
				if (!(LOC5)) goto LA8;
				TMP2083 = addInt(i, ((NI) 2));
				if ((NU)((NI)(TMP2083)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC5 = ((NU8)(s->data[(NI)(TMP2083)]) == (NU8)(34));
				LA8: ;
				if (!LOC5) goto LA9;
				nimln(98, "llstream.nim");
				TMP2084 = addInt(result, ((NI) 1));
				result = (NI)(TMP2084);
				nimln(99, "llstream.nim");
				TMP2085 = addInt(i, ((NI) 2));
				i = (NI)(TMP2085);
			}
			LA9: ;
			nimln(100, "llstream.nim");
			TMP2086 = addInt(i, ((NI) 1));
			i = (NI)(TMP2086);
		} LA2: ;
	}
	popFrame();
...
N_NIMCALL(NI, llreadfromstdin_180528)(Tllstream180204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2076));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	triples = ((NI) 0);
	{
		...
		while (1) {
			...
			LOC4 = 0;
			{
				...
				LOC4 = copyString(((NimStringDesc*) &TMP2087));
			}
			goto LA5;
			LA7: ;
			{
				LOC4 = copyString(((NimStringDesc*) &TMP2088));
			}
			LA5: ;
			LOC10 = 0;
			LOC10 = readlinefromstdin_180319(LOC4, (&line));
			if (!LOC10) goto LA3;
...
appendString((*s).s, ((NimStringDesc*) &TMP2077));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_180483(line);
			TMP2089 = addInt(triples, LOC11);
			triples = (NI)(TMP2089);
			nimln(111, "llstream.nim");
			{
				NIM_BOOL LOC14;
				LOC14 = 0;
				LOC14 = continueline_180460(line, (((NI) ((NI)(triples & ((NI) 1)))) == ((NI) 1)));
				if (!!(LOC14)) goto LA15;
				goto LA2;
			}
			LA15: ;
	...
	TMP2090 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2090);
	nimln(113, "llstream.nim");
	TMP2091 = subInt(((*s).s ? (*s).s->Sup.len : 0), (*s).rd);
	result = ((buflen <= (NI)(TMP2091)) ? buflen : (NI)(TMP2091));
...
N_NIMCALL(NI, llstreamread_180584)(Tllstream180204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		TMP2093 = subInt(((*s).s ? (*s).s->Sup.len : 0), (*s).rd);
		result = ((buflen <= (NI)(TMP2093)) ? buflen : (NI)(TMP2093));
		nimln(124, "llstream.nim");
		{
			...
			TMP2094 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2094)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2094)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(126, "llstream.nim");
			TMP2095 = addInt((*s).rd, result);
			(*s).rd = (NI)(TMP2095);
		}
		LA5: ;
	}
	...
	case ((NU8) 3):
	{
		...
		result = llreadfromstdin_180528(s, buf, buflen);
	}
	break;
	}
	popFrame();
...
appendString((*s).s, data);
		...
		TMP2100 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2100);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_180686)(Tllstream180204* s, NimStringDesc* data) {
	...
	llstreamwrite_180665(s, data);
	nimln(168, "llstream.nim");
	llstreamwrite_180665(s, ((NimStringDesc*) &TMP2077));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_180718)(Tllstream180204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2102 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2102), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2103 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2103)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2103)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2104 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2104);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2105 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2105), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2106 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2106)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13515((*s).f, ((void*) ((&result->data[(NI)(TMP2106)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2107 = addInt(i, bytes);
				i = (NI)(TMP2107);
			} LA10: ;
		}
...
static TNimNode* TMP2071[6];
static TNimNode* TMP2072[4];
NI TMP2074;
static char* NIM_CONST TMP2073[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2069[12];
NTI180204.size = sizeof(Tllstream180204);
NTI180204.kind = 17;
NTI180204.base = (&NTI3411);
TMP2071[0] = &TMP2069[1];
NTI180202.size = sizeof(NU8);
NTI180202.kind = 14;
NTI180202.base = 0;
NTI180202.flags = 3;
for (TMP2074 = 0; TMP2074 < 4; TMP2074++) {
TMP2069[TMP2074+2].kind = 1;
TMP2069[TMP2074+2].offset = TMP2074;
TMP2069[TMP2074+2].name = TMP2073[TMP2074];
TMP2072[TMP2074] = &TMP2069[TMP2074+2];
}
TMP2069[6].len = 4; TMP2069[6].kind = 2; TMP2069[6].sons = &TMP2072[0];
NTI180202.node = &TMP2069[6];
TMP2069[1].kind = 1;
TMP2069[1].offset = offsetof(Tllstream180204, kind);
TMP2069[1].typ = (&NTI180202);
TMP2069[1].name = "kind";
TMP2071[1] = &TMP2069[7];
TMP2069[7].kind = 1;
TMP2069[7].offset = offsetof(Tllstream180204, f);
TMP2069[7].typ = (&NTI13004);
TMP2069[7].name = "f";
TMP2071[2] = &TMP2069[8];
TMP2069[8].kind = 1;
TMP2069[8].offset = offsetof(Tllstream180204, s);
TMP2069[8].typ = (&NTI149);
TMP2069[8].name = "s";
TMP2071[3] = &TMP2069[9];
TMP2069[9].kind = 1;
TMP2069[9].offset = offsetof(Tllstream180204, rd);
TMP2069[9].typ = (&NTI108);
TMP2069[9].name = "rd";
TMP2071[4] = &TMP2069[10];
TMP2069[10].kind = 1;
TMP2069[10].offset = offsetof(Tllstream180204, wr);
TMP2069[10].typ = (&NTI108);
TMP2069[10].name = "wr";
TMP2071[5] = &TMP2069[11];
TMP2069[11].kind = 1;
TMP2069[11].offset = offsetof(Tllstream180204, lineoffset);
TMP2069[11].typ = (&NTI108);
TMP2069[11].name = "lineOffset";
TMP2069[0].len = 6; TMP2069[0].kind = 2; TMP2069[0].sons = &TMP2071[0];
NTI180204.node = &TMP2069[0];
NTI180206.size = sizeof(Tllstream180204*);
NTI180206.kind = 22;
NTI180206.base = (&NTI180204);
NTI180206.marker = TMP2075;
}
