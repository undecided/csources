...
N_NIMCALL(void, setintlittype_241776)(Tnode193813* result);
...
N_NIMCALL(Tsym193843*, getsyssym_241054)(NimStringDesc* name) {
	...
	nimln(42, "magicsys.nim");
	{
		...
		result = newsym_194655(((NU8) 0), LOC6, systemmodule_241019, (*systemmodule_241019).info);
...
{	result = 0;
	...
	result = newsym_194655(((NU8) 0), id, systemmodule_241019, (*systemmodule_241019).info);
...
N_NIMCALL(Ttype193849*, getintlittype_241660)(Tnode193813* literal) {
	...
	nimln(109, "magicsys.nim");
	{
		...
		result = inttypecache_241297[(((NI) (value)))- -5];
		nimln(111, "magicsys.nim");
		{
			...
			if (((NI) (value)) < -5 || ((NI) (value)) > 64) raiseIndexError();
			asgnRefNoCycle((void**) (&inttypecache_241297[(((NI) (value)))- -5]), result);
		}
		LA9: ;
	}
	goto LA1;
