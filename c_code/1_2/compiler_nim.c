...
STRING_LITERAL(TMP10777, "", 0);
STRING_LITERAL(TMP10779, "nim.cfg", 7);
STRING_LITERAL(TMP10780, "-", 1);
STRING_LITERAL(TMP10781, "stdinfile", 9);
STRING_LITERAL(TMP10782, "js", 2);
STRING_LITERAL(TMP10783, " ", 1);
STRING_LITERAL(TMP10784, "exe", 3);
...
N_NIMCALL(void, handlecmdline_530607)(void) {
	...
	{
		nimln(40, "nim.nim");
		processcmdline_524209(((NU8) 0), ((NimStringDesc*) &TMP10777));
		nimln(41, "nim.nim");
		{
			TSafePoint TMP10778;
			TY119789 p;
			...
			nimln(42, "nim.nim");
			pushSafePoint(&TMP10778);
			TMP10778.status = setjmp(TMP10778.context);
			if (TMP10778.status == 0) {
				nimln(43, "nim.nim");
			...
			if (TMP10778.status != 0) reraiseException();
		...
		LA7: ;
		nimln(51, "nim.nim");
		loadconfigs_188807(((NimStringDesc*) &TMP10779));
		nimln(54, "nim.nim");
		initvars_172876();
		nimln(55, "nim.nim");
		processcmdline_524209(((NU8) 1), ((NimStringDesc*) &TMP10777));
		nimln(56, "nim.nim");
		maincommand_527628();
		nimln(57, "nim.nim");
		{
		...
		nimln(59, "nim.nim");
		{
			...
			nimln(63, "nim.nim");
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_156234, ((NimStringDesc*) &TMP10780))) goto LA33;
					nimln(65, "nim.nim");
					LOC35 = 0;
					LOC35 = gprojectfull_156236; gprojectfull_156236 = copyStringRC1(((NimStringDesc*) &TMP10781));
				...
				nimln(66, "nim.nim");
				{
					...
					LA42: ;
					{
						...
						nimln(72, "nim.nim");
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_156236, ((NimStringDesc*) &TMP10782));
						LOC47 = 0;
...
appendString(LOC49, ((NimStringDesc*) &TMP10783));
appendString(LOC49, ex);
appendChar(LOC49, 32);
appendString(LOC49, arguments_179721);
					execexternalprogram_172985(LOC49, ((NimStringDesc*) &TMP10777));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						...
						nimln(81, "nim.nim");
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_156236, ((NimStringDesc*) &TMP10784));
...
appendString(LOC58, arguments_179721);
					execexternalprogram_172985(LOC58, ((NimStringDesc*) &TMP10777));
				}
				LA36: ;
			}
			LA29: ;
