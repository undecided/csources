...
N_NIMCALL(void, fillbuffer_181097)(Tbaselexer181024* L);
...
N_NIMCALL(NI, fillbaselexer_181827)(Tbaselexer181024* L, NI pos);
N_NIMCALL(NI, handlecr_181066)(Tbaselexer181024* L, NI pos);
N_NIMCALL(NI, handlelf_181074)(Tbaselexer181024* L, NI pos);
N_NIMCALL(void, skiputf8bom_182416)(Tbaselexer181024* L);
...
N_NIMCALL(NimStringDesc*, getcurrentline_181052)(Tbaselexer181024* L, NIM_BOOL marker);
...
NIM_CONST TY77659 Newlines_181018 = {
...
STRING_LITERAL(TMP2147, "\015\012", 2);
STRING_LITERAL(TMP2148, "^\015\012", 3);
...
N_NIMCALL(void, fillbuffer_181097)(Tbaselexer181024* L) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		failedassertimpl_88817(((NimStringDesc*) &TMP2110));
	}
	LA3: ;
	...
	nimln(84, "nimlexbase.nim");
	{
		...
		failedassertimpl_88817(((NimStringDesc*) &TMP2113));
	}
	LA7: ;
	...
	LOC13 = 0;
	LOC13 = llstreamread_180584((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP2117));
		...
		s = (NI)(TMP2121);
		{
			...
			while (1) {
				nimln(98, "nimlexbase.nim");
				{
					...
					failedassertimpl_88817(((NimStringDesc*) &TMP2122));
				}
				LA23: ;
				{
				...
				LA31: ;
				{
					...
					nimln(110, "nimlexbase.nim");
					{
						...
						failedassertimpl_88817(((NimStringDesc*) &TMP2127));
					}
					LA37: ;
					...
					LOC39 = 0;
					LOC39 = llstreamread_180584((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP2128));
...
N_NIMCALL(NI, handlecr_181066)(Tbaselexer181024* L, NI pos) {
	...
	nimln(133, "nimlexbase.nim");
	{
		...
		result = fillbaselexer_181827(L, result);
	}
	LA7: ;
	popFrame();
	return result;
...
N_NIMCALL(NI, handlelf_181074)(Tbaselexer181024* L, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		failedassertimpl_88817(((NimStringDesc*) &TMP2137));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_181035)(Tbaselexer181024* L, Tllstream180204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		failedassertimpl_88817(((NimStringDesc*) &TMP2141));
	}
	LA3: ;
...
appendString(result, ((NimStringDesc*) &TMP2147));
	nimln(168, "nimlexbase.nim");
	{
		...
		LOC7 = 0;
		LOC8 = 0;
		LOC8 = getcolnumber_181059(L, (*L).bufpos);
		LOC9 = 0;
...
TMP2483[0] = &TMP2069[1];
TMP2069[1].kind = 1;
TMP2069[1].offset = offsetof(Tbaselexer181024, bufpos);
TMP2069[1].typ = (&NTI108);
TMP2069[1].name = "bufpos";
TMP2483[1] = &TMP2069[2];
TMP2069[2].kind = 1;
TMP2069[2].offset = offsetof(Tbaselexer181024, buf);
TMP2069[2].typ = (&NTI151);
TMP2069[2].name = "buf";
TMP2483[2] = &TMP2069[3];
TMP2069[3].kind = 1;
TMP2069[3].offset = offsetof(Tbaselexer181024, buflen);
TMP2069[3].typ = (&NTI108);
TMP2069[3].name = "bufLen";
TMP2483[3] = &TMP2069[4];
TMP2069[4].kind = 1;
TMP2069[4].offset = offsetof(Tbaselexer181024, stream);
TMP2069[4].typ = (&NTI180206);
TMP2069[4].name = "stream";
TMP2483[4] = &TMP2069[5];
TMP2069[5].kind = 1;
TMP2069[5].offset = offsetof(Tbaselexer181024, linenumber);
TMP2069[5].typ = (&NTI108);
TMP2069[5].name = "lineNumber";
TMP2483[5] = &TMP2069[6];
TMP2069[6].kind = 1;
TMP2069[6].offset = offsetof(Tbaselexer181024, sentinel);
TMP2069[6].typ = (&NTI108);
TMP2069[6].name = "sentinel";
TMP2483[6] = &TMP2069[7];
TMP2069[7].kind = 1;
TMP2069[7].offset = offsetof(Tbaselexer181024, linestart);
TMP2069[7].typ = (&NTI108);
TMP2069[7].name = "lineStart";
TMP2069[0].len = 7; TMP2069[0].kind = 2; TMP2069[0].sons = &TMP2483[0];
NTI181024.node = &TMP2069[0];
}
