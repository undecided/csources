...
N_NIMCALL(void, libcandidates_157409)(NimStringDesc* s, TY13606** dest) {
	...
	ri = nsuFindChar(s, 41, ((NI)chckRange((NI)(TMP686), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
static TNimNode* TMP2582[22];
NI TMP2584;
static char* NIM_CONST TMP2583[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP3947[30];
NI TMP3949;
static char* NIM_CONST TMP3948[30] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optIdeDebug", 
"optIdeTerse"};
static TNimNode* TMP3965[20];
NI TMP3967;
static char* NIM_CONST TMP3966[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
NTI156014.base = 0;
NTI156014.flags = 3;
for (TMP2584 = 0; TMP2584 < 22; TMP2584++) {
TMP470[TMP2584+0].kind = 1;
TMP470[TMP2584+0].offset = TMP2584;
TMP470[TMP2584+0].name = TMP2583[TMP2584];
TMP2582[TMP2584] = &TMP470[TMP2584+0];
}
TMP470[22].len = 22; TMP470[22].kind = 2; TMP470[22].sons = &TMP2582[0];
...
NTI156018.base = 0;
NTI156018.flags = 3;
for (TMP3949 = 0; TMP3949 < 30; TMP3949++) {
TMP470[TMP3949+24].kind = 1;
TMP470[TMP3949+24].offset = TMP3949;
TMP470[TMP3949+24].name = TMP3948[TMP3949];
TMP3947[TMP3949] = &TMP470[TMP3949+24];
}
TMP470[54].len = 30; TMP470[54].kind = 2; TMP470[54].sons = &TMP3947[0];
NTI156018.node = &TMP470[54];
NTI156022.size = sizeof(NU8);
NTI156022.kind = 14;
NTI156022.base = 0;
NTI156022.flags = 3;
for (TMP3967 = 0; TMP3967 < 20; TMP3967++) {
TMP470[TMP3967+55].kind = 1;
TMP470[TMP3967+55].offset = TMP3967;
TMP470[TMP3967+55].name = TMP3966[TMP3967];
TMP3965[TMP3967] = &TMP470[TMP3967+55];
}
TMP470[75].len = 20; TMP470[75].kind = 2; TMP470[75].sons = &TMP3965[0];
