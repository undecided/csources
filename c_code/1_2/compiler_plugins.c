...
N_NIMCALL(void, TMP8066)(void* p, NI op);
...
static TNimNode* TMP8065[5];
static TNimNode TMP8063[6];
NTI409019.size = sizeof(PluginHEX3Aobjecttype409019);
NTI409019.kind = 18;
NTI409019.base = 0;
TMP8065[0] = &TMP8063[1];
TMP8063[1].kind = 1;
TMP8063[1].offset = offsetof(PluginHEX3Aobjecttype409019, fn);
TMP8063[1].typ = (&NTI169019);
TMP8063[1].name = "fn";
TMP8065[1] = &TMP8063[2];
TMP8063[2].kind = 1;
TMP8063[2].offset = offsetof(PluginHEX3Aobjecttype409019, module);
TMP8063[2].typ = (&NTI169019);
TMP8063[2].name = "module";
TMP8065[2] = &TMP8063[3];
TMP8063[3].kind = 1;
TMP8063[3].offset = offsetof(PluginHEX3Aobjecttype409019, package);
TMP8063[3].typ = (&NTI169019);
TMP8063[3].name = "package";
TMP8065[3] = &TMP8063[4];
...
NTI409013.flags = 3;
TMP8063[4].kind = 1;
TMP8063[4].offset = offsetof(PluginHEX3Aobjecttype409019, t);
TMP8063[4].typ = (&NTI409013);
TMP8063[4].name = "t";
TMP8065[4] = &TMP8063[5];
TMP8063[5].kind = 1;
TMP8063[5].offset = offsetof(PluginHEX3Aobjecttype409019, next);
TMP8063[5].typ = (&NTI409015);
TMP8063[5].name = "next";
TMP8063[0].len = 5; TMP8063[0].kind = 2; TMP8063[0].sons = &TMP8065[0];
NTI409019.node = &TMP8063[0];
NTI409015.size = sizeof(PluginHEX3Aobjecttype409019*);
NTI409015.kind = 22;
NTI409015.base = (&NTI409019);
NTI409015.marker = TMP8066;
}
