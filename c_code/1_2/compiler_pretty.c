...
STRING_LITERAL(TMP4731, "pretty.strip", 12);
STRING_LITERAL(TMP4732, "on", 2);
STRING_LITERAL(TMP4733, ".pretty.nim", 11);
STRING_LITERAL(TMP4736, "len(a) == L seq modified while iterating over it", 48);
static NIM_CONST TY77659 TMP4739 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4741, "int", 3);
STRING_LITERAL(TMP4742, "uint", 4);
STRING_LITERAL(TMP4743, "cint", 4);
STRING_LITERAL(TMP4744, "cuint", 5);
STRING_LITERAL(TMP4745, "clong", 5);
STRING_LITERAL(TMP4746, "cstring", 7);
STRING_LITERAL(TMP4747, "string", 6);
STRING_LITERAL(TMP4748, "char", 4);
STRING_LITERAL(TMP4749, "byte", 4);
STRING_LITERAL(TMP4750, "bool", 4);
STRING_LITERAL(TMP4751, "openArray", 9);
STRING_LITERAL(TMP4752, "seq", 3);
STRING_LITERAL(TMP4753, "array", 5);
STRING_LITERAL(TMP4754, "void", 4);
STRING_LITERAL(TMP4755, "pointer", 7);
STRING_LITERAL(TMP4756, "float", 5);
STRING_LITERAL(TMP4757, "csize", 5);
STRING_LITERAL(TMP4758, "cdouble", 7);
STRING_LITERAL(TMP4759, "cchar", 5);
STRING_LITERAL(TMP4760, "cschar", 6);
STRING_LITERAL(TMP4761, "cshort", 6);
STRING_LITERAL(TMP4762, "cu", 2);
STRING_LITERAL(TMP4763, "nil", 3);
STRING_LITERAL(TMP4764, "expr", 4);
STRING_LITERAL(TMP4765, "stmt", 4);
STRING_LITERAL(TMP4766, "typedesc", 8);
STRING_LITERAL(TMP4767, "auto", 4);
STRING_LITERAL(TMP4768, "any", 3);
STRING_LITERAL(TMP4769, "range", 5);
STRING_LITERAL(TMP4770, "openarray", 9);
STRING_LITERAL(TMP4771, "varargs", 7);
STRING_LITERAL(TMP4772, "set", 3);
STRING_LITERAL(TMP4773, "cfloat", 6);
NIM_CONST TY273154 TMP4740 = {((NimStringDesc*) &TMP4741),
...
N_NIMCALL(void, overwritefiles_273030)(void) {
	...
	nimln(26, "pretty.nim");
	LOC1 = 0;
	LOC1 = getconfigvar_156334(((NimStringDesc*) &TMP4731));
	LOC2 = 0;
	LOC2 = nsuNormalize(LOC1);
	dostrip = eqStrings(LOC2, ((NimStringDesc*) &TMP4732));
	{
		NI i_273043;
		NI HEX3Atmp_273070;
		NI res_273073;
			...
			while (1) {
				...
				nimln(28, "pretty.nim");
				{
					...
					LA18: ;
					{
						nimln(31, "pretty.nim");
						if ((NU)(i_273043) >= (NU)(gsourcefiles_251036->Sup.len)) raiseIndexError();
						newfile = noschangeFileExt(gsourcefiles_251036->data[i_273043].fullpath, ((NimStringDesc*) &TMP4733));
					}
					LA16: ;
					nimln(32, "pretty.nim");
				...
				TMP4737 = addInt(res_273073, ((NI) 1));
				res_273073 = (NI)(TMP4737);
			} LA5: ;
		}
	}
	popFrame();
...
{	result = 0;
	nimln(52, "pretty.nim");
	allupper = allcharsinset_100459(s, TMP4739);
	nimln(53, "pretty.nim");
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
	...
	case ((NU8) 4):
	{
		nimln(59, "pretty.nim");
		{
			NIM_BOOL LOC10;
			LOC10 = 0;
			LOC10 = HEX3DHEX7E_273101(s, TMP4740, 33);
			if (!LOC10) goto LA11;
			nimln(65, "pretty.nim");
		...
		while (1) {
			...
			nimln(78, "pretty.nim");
			{
				...
				nimln(79, "pretty.nim");
				{
					...
					LOC37 = (((NI) 0) < i);
					if (!(LOC37)) goto LA38;
					TMP4775 = subInt(i, ((NI) 1));
					if ((NU)((NI)(TMP4775)) > (NU)(s->Sup.len)) raiseIndexError();
					LOC37 = (((NU8)(s->data[(NI)(TMP4775)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI)(TMP4775)])) <= ((NU8)(90)));
					LA38: ;
					if (!LOC37) goto LA39;
					nimln(81, "pretty.nim");
...
{	nimln(94, "pretty.nim");
	...
	TMP4779 = subInt(info.line, ((NI16) 1));
	if (TMP4779 < -32768 || TMP4779 > 32767) raiseOverflow();
	if ((NU)((NI16)(TMP4779)) >= (NU)(gsourcefiles_251036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_251036->data[info.fileindex].lines->data[(NI16)(TMP4779)];
	nimln(97, "pretty.nim");
	...
	LA3: ;
	{
		...
		while (1) {
			...
			LOC7 = (((NI) 0) < first);
			if (!(LOC7)) goto LA8;
			TMP4780 = subInt(first, ((NI) 1));
			if ((NU)((NI)(TMP4780)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC7 = (((NU8)(line->data[(NI)(TMP4780)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4780)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4780)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4780)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4780)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4780)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4780)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4780)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4780)])) == ((NU8)(95)));
			LA8: ;
			if (!LOC7) goto LA6;
	...
	TMP4783 = addInt(first, LOC17);
	TMP4784 = subInt((NI)(TMP4783), ((NI) 1));
	last = (NI)(TMP4784);
	nimln(105, "pretty.nim");
	{
		...
		LOC23 = 0;
		TMP4785 = subInt(first, ((NI) 1));
		LOC24 = 0;
		LOC24 = copyStrLast(line, ((NI) 0), (NI)(TMP4785));
		TMP4786 = addInt(last, ((NI) 1));
		LOC25 = 0;
		LOC25 = copyStr(line, (NI)(TMP4786));
...
appendString(LOC23, LOC25);
		...
		if ((NU)((NI16)(TMP4787)) >= (NU)(gsourcefiles_251036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) (&gsourcefiles_251036->data[info.fileindex].lines->data[(NI16)(TMP4787)]), x);
