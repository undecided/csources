...
N_NIMCALL(void, loadfile_251041)(Tlineinfo165338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		if (TMP4250 < (-2147483647 -1) || TMP4250 > 2147483647) raiseOverflow();
		gsourcefiles_251036 = (TY251019*) setLengthSeq(&(gsourcefiles_251036)->Sup, sizeof(Tsourcefile251008), ((NI)chckRange((NI32)(TMP4250), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA3: ;
