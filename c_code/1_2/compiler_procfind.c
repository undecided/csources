...
static NIM_CONST TY194031 TMP4493 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4494, "sons", 4);
STRING_LITERAL(TMP4495, "equalGenericParams", 18);
static NIM_CONST TY194031 TMP4496 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4497, "sym", 3);
NIM_CONST NU8 flags_262203 = 30;
STRING_LITERAL(TMP4499, "public implementation \'$1\' has non-public forward declaration i"
"n $2", 67);
	...
	LA5: ;
	{
		...
		res_262090 = ((NI) 0);
		{
			...
			while (1) {
				...
				{
					if (((TMP4493[(*proca).kind/8] &(1<<((*proca).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4494));
					...
					internalerror_167199((*proca).info, ((NimStringDesc*) &TMP4495));
				...
				{
					if (((TMP4493[(*procb).kind/8] &(1<<((*procb).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4494));
					...
					internalerror_167199((*procb).info, ((NimStringDesc*) &TMP4495));
				...
				if (((TMP4493[(*proca).kind/8] &(1<<((*proca).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4494));
				if ((NU)(i_262026) >= (NU)((*proca).kindU.S6.sons->Sup.len)) raiseIndexError();
				if (!(((TMP4496[(*(*proca).kindU.S6.sons->data[i_262026]).kind/8] &(1<<((*(*proca).kindU.S6.sons->data[i_262026]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4497));
				a = (*(*proca).kindU.S6.sons->data[i_262026]).kindU.S4.sym;
				nimln(26, "procfind.nim");
				if (((TMP4493[(*procb).kind/8] &(1<<((*procb).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4494));
				if ((NU)(i_262026) >= (NU)((*procb).kindU.S6.sons->Sup.len)) raiseIndexError();
				if (!(((TMP4496[(*(*procb).kindU.S6.sons->data[i_262026]).kind/8] &(1<<((*(*procb).kindU.S6.sons->data[i_262026]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4497));
				...
				TMP4498 = addInt(res_262090, ((NI) 1));
				res_262090 = (NI)(TMP4498);
			} LA10: ;
		}
	}
		...
		if (!LOC3) goto LA4;
		{
			...
			while (1) {
				...
				nimln(44, "procfind.nim");
				{
					...
					if (((TMP4493[(*(*result).ast).kind/8] &(1<<((*(*result).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4494));
					...
					if (((TMP4493[(*(*fn).ast).kind/8] &(1<<((*(*fn).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4494));
			...
			nimln(74, "procfind.nim");
			{
				...
				case ((NU8) 1):
				{
					nimln(77, "procfind.nim");
					{
						...
						message = nsuFormatOpenArray(((NimStringDesc*) &TMP4499), LOC17, 2);
