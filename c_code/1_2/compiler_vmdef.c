...
N_NIMCALL(void, TMP4154)(void* p, NI op);
N_NIMCALL(void, TMP4157)(void* p, NI op);
...
N_NIMCALL(Tctx246048*, newctx_246281)(Tsym193843* module) {
	...
	LOC3 = 0;
	LOC3 = (*LOC1).errorflag; (*LOC1).errorflag = copyStringRC1(((NimStringDesc*) &TMP4174));
...
static TNimNode* TMP4153[18];
static TNimNode* TMP4155[4];
static TNimNode* TMP4156[2];
static TNimNode* TMP4159[2];
static TNimNode* TMP4160[9];
NI TMP4162;
static char* NIM_CONST TMP4161[9] = {
"slotEmpty", 
"slotFixedVar", 
"slotFixedLet", 
"slotTempUnknown", 
...
"slotTempComplex", 
"slotTempPerm"};
static TNimNode* TMP4164[5];
NI TMP4166;
static char* NIM_CONST TMP4165[5] = {
"emRepl", 
"emConst", 
"emOptimize", 
"emStaticExpr", 
"emStaticStmt"};
static TNimNode* TMP4167[3];
NI TMP4169;
static char* NIM_CONST TMP4168[3] = {
"allowCast", 
"allowFFI", 
"allowInfiniteLoops"};
static TNimNode* TMP4170[2];
static TNimNode* TMP4171[2];
static TNimNode* TMP7259[157];
NI TMP7261;
static char* NIM_CONST TMP7260[157] = {
"opcEof", 
"opcRet", 
"opcYldYoid", 
"opcYldVal", 
...
NTI246253.flags = 2;
NTI246253.marker = TMP4154;
TMP4151[1].kind = 1;
TMP4151[1].offset = offsetof(Tctx246048, code);
TMP4151[1].typ = (&NTI246253);
TMP4151[1].name = "code";
TMP4153[1] = &TMP4151[2];
TMP4151[2].kind = 1;
TMP4151[2].offset = offsetof(Tctx246048, debug);
TMP4151[2].typ = (&NTI166033);
TMP4151[2].name = "debug";
TMP4153[2] = &TMP4151[3];
TMP4151[3].kind = 1;
TMP4151[3].offset = offsetof(Tctx246048, globals);
TMP4151[3].typ = (&NTI193805);
TMP4151[3].name = "globals";
TMP4153[3] = &TMP4151[4];
TMP4151[4].kind = 1;
TMP4151[4].offset = offsetof(Tctx246048, constants);
TMP4151[4].typ = (&NTI193805);
TMP4151[4].name = "constants";
TMP4153[4] = &TMP4151[5];
TMP4151[5].kind = 1;
TMP4151[5].offset = offsetof(Tctx246048, types);
TMP4151[5].typ = (&NTI193845);
TMP4151[5].name = "types";
TMP4153[5] = &TMP4151[6];
TMP4151[6].kind = 1;
TMP4151[6].offset = offsetof(Tctx246048, currentexceptiona);
TMP4151[6].typ = (&NTI193805);
TMP4151[6].name = "currentExceptionA";
TMP4153[6] = &TMP4151[7];
TMP4151[7].kind = 1;
TMP4151[7].offset = offsetof(Tctx246048, currentexceptionb);
TMP4151[7].typ = (&NTI193805);
TMP4151[7].name = "currentExceptionB";
TMP4153[7] = &TMP4151[8];
TMP4151[8].kind = 1;
TMP4151[8].offset = offsetof(Tctx246048, exceptioninstr);
TMP4151[8].typ = (&NTI108);
TMP4151[8].name = "exceptionInstr";
TMP4153[8] = &TMP4151[9];
NTI246232.size = sizeof(PprocHEX3Aobjecttype246232);
NTI246232.kind = 18;
NTI246232.base = 0;
NTI246232.flags = 2;
TMP4155[0] = &TMP4151[11];
NTI246030.size = sizeof(Tblock246030);
NTI246030.kind = 18;
NTI246030.base = 0;
NTI246030.flags = 2;
TMP4156[0] = &TMP4151[13];
TMP4151[13].kind = 1;
TMP4151[13].offset = offsetof(Tblock246030, label);
TMP4151[13].typ = (&NTI193811);
TMP4151[13].name = "label";
TMP4156[1] = &TMP4151[14];
NTI246213.size = sizeof(TY246213*);
NTI246213.kind = 24;
NTI246213.base = (&NTI108);
NTI246213.flags = 2;
NTI246213.marker = TMP4157;
TMP4151[14].kind = 1;
TMP4151[14].offset = offsetof(Tblock246030, fixups);
TMP4151[14].typ = (&NTI246213);
TMP4151[14].name = "fixups";
TMP4151[12].len = 2; TMP4151[12].kind = 2; TMP4151[12].sons = &TMP4156[0];
NTI246030.node = &TMP4151[12];
NTI246233.size = sizeof(TY246233*);
NTI246233.kind = 24;
NTI246233.base = (&NTI246030);
NTI246233.flags = 2;
NTI246233.marker = TMP4158;
TMP4151[11].kind = 1;
TMP4151[11].offset = offsetof(PprocHEX3Aobjecttype246232, blocks);
TMP4151[11].typ = (&NTI246233);
TMP4151[11].name = "blocks";
TMP4155[1] = &TMP4151[15];
TMP4151[15].kind = 1;
TMP4151[15].offset = offsetof(PprocHEX3Aobjecttype246232, sym);
TMP4151[15].typ = (&NTI193811);
TMP4151[15].name = "sym";
TMP4155[2] = &TMP4151[16];
NTI246239.size = sizeof(TY246239);
NTI246239.kind = 18;
NTI246239.base = 0;
NTI246239.flags = 3;
TMP4159[0] = &TMP4151[18];
TMP4151[18].kind = 1;
TMP4151[18].offset = offsetof(TY246239, Field0);
TMP4151[18].typ = (&NTI138);
TMP4151[18].name = "Field0";
TMP4159[1] = &TMP4151[19];
NTI246038.size = sizeof(NU8);
NTI246038.kind = 14;
NTI246038.base = 0;
NTI246038.flags = 3;
for (TMP4162 = 0; TMP4162 < 9; TMP4162++) {
TMP4151[TMP4162+20].kind = 1;
TMP4151[TMP4162+20].offset = TMP4162;
TMP4151[TMP4162+20].name = TMP4161[TMP4162];
TMP4160[TMP4162] = &TMP4151[TMP4162+20];
}
TMP4151[29].len = 9; TMP4151[29].kind = 2; TMP4151[29].sons = &TMP4160[0];
NTI246038.node = &TMP4151[29];
TMP4151[19].kind = 1;
TMP4151[19].offset = offsetof(TY246239, Field1);
TMP4151[19].typ = (&NTI246038);
TMP4151[19].name = "Field1";
TMP4151[17].len = 2; TMP4151[17].kind = 2; TMP4151[17].sons = &TMP4159[0];
NTI246239.node = &TMP4151[17];
NTI246236.size = sizeof(TY246236);
NTI246236.kind = 16;
NTI246236.base = (&NTI246239);
NTI246236.flags = 3;
TMP4151[16].kind = 1;
TMP4151[16].offset = offsetof(PprocHEX3Aobjecttype246232, slots);
TMP4151[16].typ = (&NTI246236);
TMP4151[16].name = "slots";
TMP4155[3] = &TMP4151[30];
TMP4151[30].kind = 1;
TMP4151[30].offset = offsetof(PprocHEX3Aobjecttype246232, maxslots);
TMP4151[30].typ = (&NTI108);
TMP4151[30].name = "maxSlots";
TMP4151[10].len = 4; TMP4151[10].kind = 2; TMP4151[10].sons = &TMP4155[0];
NTI246232.node = &TMP4151[10];
NTI246040.size = sizeof(PprocHEX3Aobjecttype246232*);
NTI246040.kind = 22;
NTI246040.base = (&NTI246232);
NTI246040.flags = 2;
NTI246040.marker = TMP4163;
TMP4151[9].kind = 1;
TMP4151[9].offset = offsetof(Tctx246048, prc);
TMP4151[9].typ = (&NTI246040);
TMP4151[9].name = "prc";
TMP4153[9] = &TMP4151[31];
TMP4151[31].kind = 1;
TMP4151[31].offset = offsetof(Tctx246048, module);
TMP4151[31].typ = (&NTI193811);
TMP4151[31].name = "module";
TMP4153[10] = &TMP4151[32];
TMP4151[32].kind = 1;
TMP4151[32].offset = offsetof(Tctx246048, callsite);
TMP4151[32].typ = (&NTI193805);
TMP4151[32].name = "callsite";
TMP4153[11] = &TMP4151[33];
NTI246032.size = sizeof(NU8);
NTI246032.kind = 14;
NTI246032.base = 0;
NTI246032.flags = 3;
for (TMP4166 = 0; TMP4166 < 5; TMP4166++) {
TMP4151[TMP4166+34].kind = 1;
TMP4151[TMP4166+34].offset = TMP4166;
TMP4151[TMP4166+34].name = TMP4165[TMP4166];
TMP4164[TMP4166] = &TMP4151[TMP4166+34];
}
TMP4151[39].len = 5; TMP4151[39].kind = 2; TMP4151[39].sons = &TMP4164[0];
NTI246032.node = &TMP4151[39];
TMP4151[33].kind = 1;
TMP4151[33].offset = offsetof(Tctx246048, mode);
TMP4151[33].typ = (&NTI246032);
TMP4151[33].name = "mode";
TMP4153[12] = &TMP4151[40];
NTI246034.size = sizeof(NU8);
NTI246034.kind = 14;
NTI246034.base = 0;
NTI246034.flags = 3;
for (TMP4169 = 0; TMP4169 < 3; TMP4169++) {
TMP4151[TMP4169+41].kind = 1;
TMP4151[TMP4169+41].offset = TMP4169;
TMP4151[TMP4169+41].name = TMP4168[TMP4169];
TMP4167[TMP4169] = &TMP4151[TMP4169+41];
}
TMP4151[44].len = 3; TMP4151[44].kind = 2; TMP4151[44].sons = &TMP4167[0];
NTI246034.node = &TMP4151[44];
NTI246036.size = sizeof(NU8);
NTI246036.kind = 19;
NTI246036.base = (&NTI246034);
NTI246036.flags = 3;
TMP4151[45].len = 0; TMP4151[45].kind = 0;
NTI246036.node = &TMP4151[45];
TMP4151[40].kind = 1;
TMP4151[40].offset = offsetof(Tctx246048, features);
TMP4151[40].typ = (&NTI246036);
TMP4151[40].name = "features";
TMP4153[13] = &TMP4151[46];
TMP4151[46].kind = 1;
TMP4151[46].offset = offsetof(Tctx246048, traceactive);
TMP4151[46].typ = (&NTI138);
TMP4151[46].name = "traceActive";
TMP4153[14] = &TMP4151[47];
TMP4151[47].kind = 1;
TMP4151[47].offset = offsetof(Tctx246048, loopiterations);
TMP4151[47].typ = (&NTI108);
TMP4151[47].name = "loopIterations";
TMP4153[15] = &TMP4151[48];
TMP4151[48].kind = 1;
TMP4151[48].offset = offsetof(Tctx246048, comesfromheuristic);
TMP4151[48].typ = (&NTI165338);
TMP4151[48].name = "comesFromHeuristic";
TMP4153[16] = &TMP4151[49];
NTI246273.size = sizeof(TY246273);
NTI246273.kind = 18;
NTI246273.base = 0;
TMP4170[0] = &TMP4151[51];
TMP4151[51].kind = 1;
TMP4151[51].offset = offsetof(TY246273, Field0);
TMP4151[51].typ = (&NTI149);
TMP4151[51].name = "Field0";
TMP4170[1] = &TMP4151[52];
NTI246044.size = sizeof(TY188578);
NTI246044.kind = 18;
NTI246044.base = 0;
NTI246044.flags = 2;
TMP4171[0] = &TMP4151[54];
TMP4151[54].kind = 1;
TMP4151[54].offset = offsetof(TY188578, Field0);
TMP4151[54].typ = (&NTI153);
TMP4151[54].name = "Field0";
TMP4171[1] = &TMP4151[55];
TMP4151[55].kind = 1;
TMP4151[55].offset = offsetof(TY188578, Field1);
TMP4151[55].typ = (&NTI188580);
TMP4151[55].name = "Field1";
TMP4151[53].len = 2; TMP4151[53].kind = 2; TMP4151[53].sons = &TMP4171[0];
NTI246044.node = &TMP4151[53];
TMP4151[52].kind = 1;
TMP4151[52].offset = offsetof(TY246273, Field1);
TMP4151[52].typ = (&NTI246044);
TMP4151[52].name = "Field1";
TMP4151[50].len = 2; TMP4151[50].kind = 2; TMP4151[50].sons = &TMP4170[0];
NTI246273.node = &TMP4151[50];
NTI246272.size = sizeof(TY246272*);
NTI246272.kind = 24;
NTI246272.base = (&NTI246273);
NTI246272.marker = TMP4172;
TMP4151[49].kind = 1;
TMP4151[49].offset = offsetof(Tctx246048, callbacks);
TMP4151[49].typ = (&NTI246272);
TMP4151[49].name = "callbacks";
TMP4153[17] = &TMP4151[56];
TMP4151[56].kind = 1;
TMP4151[56].offset = offsetof(Tctx246048, errorflag);
TMP4151[56].typ = (&NTI149);
TMP4151[56].name = "errorFlag";
TMP4151[0].len = 18; TMP4151[0].kind = 2; TMP4151[0].sons = &TMP4153[0];
NTI246048.node = &TMP4151[0];
NTI246046.size = sizeof(Tctx246048*);
NTI246046.kind = 22;
NTI246046.base = (&NTI246048);
NTI246046.marker = TMP4173;
NTI246028.size = sizeof(NU8);
NTI246028.kind = 14;
NTI246028.base = 0;
NTI246028.flags = 3;
for (TMP7261 = 0; TMP7261 < 157; TMP7261++) {
TMP4151[TMP7261+57].kind = 1;
TMP4151[TMP7261+57].offset = TMP7261;
TMP4151[TMP7261+57].name = TMP7260[TMP7261];
TMP7259[TMP7261] = &TMP4151[TMP7261+57];
}
TMP4151[214].len = 157; TMP4151[214].kind = 2; TMP4151[214].sons = &TMP7259[0];
NTI246028.node = &TMP4151[214];
}
