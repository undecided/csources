...
N_NIMCALL(void, intsetenlarge_190614)(Intset190056* t) {
	...
	n = (Ttrunkseq190054*) newSeq((&NTI190054), ((NI)chckRange((NI)(TMP2512), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_190642;
		NI res_190670;
		i_190642 = 0;
...
N_NIMCALL(NIM_BOOL, contains_190829)(Intset190056* s, NI key) {
	...
	t = intsetget_190218(s, (NI)((NU64)(key) >> (NU64)(((NI) 9))));
...
N_NIMCALL(void, incl_190856)(Intset190056* s, NI key) {
	...
	t = intsetput_190689(s, (NI)((NU64)(key) >> (NU64)(((NI) 9))));
...
N_NIMCALL(void, assign_190946)(Intset190056* dest, Intset190056* src) {
	...
	unsureAsgnRef((void**) (&(*dest).data), (Ttrunkseq190054*) newSeq((&NTI190054), ((NI)chckRange(((*src).data ? (*src).data->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807))))));
			...
			while (1) {
				...
				i_191331 = ((NI) 0);
				{
					...
					while (1) {
						...
						NI j_191335;
						NI TMP2524;
						if (!(i_191331 <= ((NI) 7))) goto LA5;
						nimln(171, "intsets.nim");
						if ((NU)(i_191331) > (NU)(7)) raiseIndexError();
						...
						j_191335 = ((NI) 0);
						{
							...
							while (1) {
								...
								nimln(176, "intsets.nim");
								{
									...
									key_191323 = (NI)((NI)((NU64)((*r_191329).key) << (NU64)(((NI) 9))) | (NI)((NU64)((NI)((NU64)(i_191331) << (NU64)(((NI) 6)))) + (NU64)(j_191335)));
...
appendString(result, LOC16);
								...
								w_191333 = (NI)((NU64)(w_191333) >> (NU64)(((NI) 1)));
							} LA7: ;
						}
