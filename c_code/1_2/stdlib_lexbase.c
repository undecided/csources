...
N_NIMCALL(void, fillbuffer_249102)(Baselexer249024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4212)]))), ((NI)chckRange((NI)(TMP4213), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
		...
		s = (NI)(TMP4219);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4223), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, open_249040)(Baselexer249024* L, Streamobj141027* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4241), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_249064)(Baselexer249024* L, NI pos) {
	...
	if ((NI)(TMP4243) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
