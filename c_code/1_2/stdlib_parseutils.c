...
N_NIMCALL(NI, nimParseBiggestFloat)(NimStringDesc* s, NF* number, NI start);
STRING_LITERAL(TMP294, "overflow", 8);
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = rawparseint_96114(s, (&res), start);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln(228, "parseutils.nim");
	{
		...
		e_96255 = (Overflowerror3443*) newObj((&NTI23401), sizeof(Overflowerror3443));
		(*e_96255).Sup.Sup.Sup.m_type = (&NTI3443);
		nimln(2266, "system.nim");
		LOC9 = 0;
		LOC9 = (*e_96255).Sup.Sup.message; (*e_96255).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP294));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		nimln(230, "parseutils.nim");
		raiseException((Exception*)e_96255, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
