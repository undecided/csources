...
N_NIMCALL(NIM_BOOL, bitsetin_240077)(Tbitset240012* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP4071)] & ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4072)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_240061)(Tbitset240012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4074)] = (NI8)((*x)->data[(NI64)(TMP4075)] | ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4076))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_240069)(Tbitset240012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4077)] = (NI8)((*x)->data[(NI64)(TMP4078)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4079))))))))));
	popFrame();
}
