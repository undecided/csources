...
N_NIMCALL(void, doend_187191)(Tlexer182185* L, Ttoken182181* tok) {
	...
	condstack_187186 = (TY187169*) setLengthSeq(&(condstack_187186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((condstack_187186 ? (condstack_187186->Sup.len-1) : -1), ((NI) 0), ((NI) 2147483647))));
	popFrame();
}
...
N_NIMCALL(void, parsedirective_187342)(Tlexer182185* L, Ttoken182181* tok) {
	...
	case ((NU16) 31):
	{
		...
		condstack_187186 = (TY187169*) setLengthSeq(&(condstack_187186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((NI)(TMP2485), ((NI) 0), ((NI) 2147483647))));
