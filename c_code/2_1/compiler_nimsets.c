...
static NIM_CONST TY192031 TMP4087 = {
			...
			while (1) {
				...
				nimln(38, "nimsets.nim");
				{
					...
					nimln(39, "nimsets.nim");
					{
						...
						if (((TMP4087[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
						if ((NU)(i_241121) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4087[(*(*s).kindU.S6.sons->data[i_241121]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241121]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
				...
				TMP4089 = addInt(res_241141, ((NI) 1));
				res_241141 = (NI)(TMP4089);
			} LA8: ;
		}
	}
...
{	result = 0;
	nimln(63, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4090));
			...
			while (1) {
				...
				nimln(67, "nimsets.nim");
				{
					...
					nimln(68, "nimsets.nim");
					{
						...
						if (((TMP4087[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
						if ((NU)(i_241233) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4087[(*(*s).kindU.S6.sons->data[i_241233]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241233]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
				...
				LA9: ;
				nimln(1614, "system.nim");
				TMP4092 = addInt(res_241258, ((NI) 1));
				res_241258 = (NI)(TMP4092);
			} LA8: ;
		}
	}
		...
		res_241328 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(82, "nimsets.nim");
				{
					...
					if (((TMP4087[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
					if ((NU)(i_241296) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4087[(*(*s).kindU.S6.sons->data[i_241296]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241296]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4097 = addInt(res_241328, ((NI) 1));
				res_241328 = (NI)(TMP4097);
			} LA5: ;
		}
	}
	popFrame();
		...
		while (1) {
			...
			nimln(102, "nimsets.nim");
			{
				...
				nimln(109, "nimsets.nim");
				{
					...
					LOC21 = 0;
					LOC21 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4102), elemtype);
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4103), elemtype);
					addson_193819(n, LOC23);
					nimln(115, "nimsets.nim");
					TMP4104 = addInt64(b, first);
					LOC24 = 0;
					LOC24 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4104), elemtype);
	...
	tobitset_241004(a, (&x));
	{
		...
		res_241573 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4106 = addInt(res_241573, ((NI) 1));
				res_241573 = (NI)(TMP4106);
			} LA3: ;
		}
	}
		...
		res_241636 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(155, "nimsets.nim");
				{
					...
					if (((TMP4087[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
					if ((NU)(i_241608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4087[(*(*s).kindU.S6.sons->data[i_241608]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241608]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4088));
				...
				LA5: ;
				nimln(1614, "system.nim");
				TMP4112 = addInt(res_241636, ((NI) 1));
				res_241636 = (NI)(TMP4112);
			} LA4: ;
		}
	}
	popFrame();
...
{	result = 0;
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4113));
	...
	LA3: ;
	{
		...
		res_241695 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA11: ;
				nimln(1614, "system.nim");
				TMP4115 = addInt(res_241695, ((NI) 1));
				res_241695 = (NI)(TMP4115);
			} LA8: ;
		}
	}
