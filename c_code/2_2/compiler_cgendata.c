...
N_NIMCALL(void, TMP8936)(void* p, NI op);
N_NIMCALL(void, TMP8937)(void* p, NI op);
...
static N_INLINE(Ropeobj161009**, s_457184)(Tcproc457034* p, NU8 s) {
	...
	TMP8938 = subInt(((*p).blocks ? (*p).blocks->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP8938)) >= (NU)((*p).blocks->Sup.len)) raiseIndexError();
	result = &(*p).blocks->data[(NI)(TMP8938)].sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP8930[29];
static TNimNode* TMP8931[17];
static TNimNode* TMP8932[7];
static TNimNode TMP8928[56];
NTI457038.size = sizeof(Tcgen457038);
NTI457038.kind = 17;
NTI457038.base = (&NTI242005);
TMP8930[0] = &TMP8928[1];
TMP8928[1].kind = 1;
TMP8928[1].offset = offsetof(Tcgen457038, module);
TMP8928[1].typ = (&NTI191811);
TMP8928[1].name = "module";
TMP8930[1] = &TMP8928[2];
TMP8928[2].kind = 1;
TMP8928[2].offset = offsetof(Tcgen457038, filename);
TMP8928[2].typ = (&NTI149);
TMP8928[2].name = "filename";
TMP8930[2] = &TMP8928[3];
...
NTI457022.flags = 2;
TMP8928[3].kind = 1;
TMP8928[3].offset = offsetof(Tcgen457038, s);
TMP8928[3].typ = (&NTI457022);
TMP8928[3].name = "s";
TMP8930[3] = &TMP8928[4];
TMP8928[4].kind = 1;
TMP8928[4].offset = offsetof(Tcgen457038, preventstacktrace);
TMP8928[4].typ = (&NTI138);
TMP8928[4].name = "preventStackTrace";
TMP8930[4] = &TMP8928[5];
TMP8928[5].kind = 1;
TMP8928[5].offset = offsetof(Tcgen457038, usesthreadvars);
TMP8928[5].typ = (&NTI138);
TMP8928[5].name = "usesThreadVars";
TMP8930[5] = &TMP8928[6];
TMP8928[6].kind = 1;
TMP8928[6].offset = offsetof(Tcgen457038, framedeclared);
TMP8928[6].typ = (&NTI138);
TMP8928[6].name = "frameDeclared";
TMP8930[6] = &TMP8928[7];
TMP8928[7].kind = 1;
TMP8928[7].offset = offsetof(Tcgen457038, isheaderfile);
TMP8928[7].typ = (&NTI138);
TMP8928[7].name = "isHeaderFile";
TMP8930[7] = &TMP8928[8];
TMP8928[8].kind = 1;
TMP8928[8].offset = offsetof(Tcgen457038, includesstringh);
TMP8928[8].typ = (&NTI138);
TMP8928[8].name = "includesStringh";
TMP8930[8] = &TMP8928[9];
TMP8928[9].kind = 1;
TMP8928[9].offset = offsetof(Tcgen457038, objhaskidsvalid);
TMP8928[9].typ = (&NTI138);
TMP8928[9].name = "objHasKidsValid";
TMP8930[9] = &TMP8928[10];
TMP8928[10].kind = 1;
TMP8928[10].offset = offsetof(Tcgen457038, cfilename);
TMP8928[10].typ = (&NTI149);
TMP8928[10].name = "cfilename";
TMP8930[10] = &TMP8928[11];
TMP8928[11].kind = 1;
TMP8928[11].offset = offsetof(Tcgen457038, typecache);
TMP8928[11].typ = (&NTI191861);
TMP8928[11].name = "typeCache";
TMP8930[11] = &TMP8928[12];
TMP8928[12].kind = 1;
TMP8928[12].offset = offsetof(Tcgen457038, forwtypecache);
TMP8928[12].typ = (&NTI191861);
TMP8928[12].name = "forwTypeCache";
TMP8930[12] = &TMP8928[13];
TMP8928[13].kind = 1;
TMP8928[13].offset = offsetof(Tcgen457038, declaredthings);
TMP8928[13].typ = (&NTI188056);
TMP8928[13].name = "declaredThings";
TMP8930[13] = &TMP8928[14];
TMP8928[14].kind = 1;
TMP8928[14].offset = offsetof(Tcgen457038, declaredprotos);
TMP8928[14].typ = (&NTI188056);
TMP8928[14].name = "declaredProtos";
TMP8930[14] = &TMP8928[15];
TMP8928[15].kind = 1;
TMP8928[15].offset = offsetof(Tcgen457038, headerfiles);
TMP8928[15].typ = (&NTI130028);
TMP8928[15].name = "headerFiles";
TMP8930[15] = &TMP8928[16];
TMP8928[16].kind = 1;
TMP8928[16].offset = offsetof(Tcgen457038, typeinfomarker);
TMP8928[16].typ = (&NTI188056);
TMP8928[16].name = "typeInfoMarker";
TMP8930[16] = &TMP8928[17];
NTI457034.size = sizeof(Tcproc457034);
NTI457034.kind = 18;
NTI457034.base = 0;
TMP8931[0] = &TMP8928[19];
TMP8928[19].kind = 1;
TMP8928[19].offset = offsetof(Tcproc457034, prc);
TMP8928[19].typ = (&NTI191811);
TMP8928[19].name = "prc";
TMP8931[1] = &TMP8928[20];
TMP8928[20].kind = 1;
TMP8928[20].offset = offsetof(Tcproc457034, beforeretneeded);
TMP8928[20].typ = (&NTI138);
TMP8928[20].name = "beforeRetNeeded";
TMP8931[2] = &TMP8928[21];
TMP8928[21].kind = 1;
TMP8928[21].offset = offsetof(Tcproc457034, threadvaraccessed);
TMP8928[21].typ = (&NTI138);
TMP8928[21].name = "threadVarAccessed";
TMP8931[3] = &TMP8928[22];
TMP8928[22].kind = 1;
TMP8928[22].offset = offsetof(Tcproc457034, lastlineinfo);
TMP8928[22].typ = (&NTI163338);
TMP8928[22].name = "lastLineInfo";
TMP8931[4] = &TMP8928[23];
TMP8928[23].kind = 1;
TMP8928[23].offset = offsetof(Tcproc457034, nestedtrystmts);
TMP8928[23].typ = (&NTI191807);
TMP8928[23].name = "nestedTryStmts";
TMP8931[5] = &TMP8928[24];
TMP8928[24].kind = 1;
TMP8928[24].offset = offsetof(Tcproc457034, inexceptblock);
TMP8928[24].typ = (&NTI108);
TMP8928[24].name = "inExceptBlock";
TMP8931[6] = &TMP8928[25];
TMP8928[25].kind = 1;
TMP8928[25].offset = offsetof(Tcproc457034, finallysafepoints);
TMP8928[25].typ = (&NTI161599);
TMP8928[25].name = "finallySafePoints";
TMP8931[7] = &TMP8928[26];
TMP8928[26].kind = 1;
TMP8928[26].offset = offsetof(Tcproc457034, labels);
TMP8928[26].typ = (&NTI3407);
TMP8928[26].name = "labels";
TMP8931[8] = &TMP8928[27];
NTI457032.size = sizeof(Tblock457032);
NTI457032.kind = 18;
NTI457032.base = 0;
NTI457032.flags = 2;
TMP8932[0] = &TMP8928[29];
TMP8928[29].kind = 1;
TMP8928[29].offset = offsetof(Tblock457032, id);
TMP8928[29].typ = (&NTI108);
TMP8928[29].name = "id";
TMP8932[1] = &TMP8928[30];
TMP8928[30].kind = 1;
TMP8928[30].offset = offsetof(Tblock457032, label);
TMP8928[30].typ = (&NTI161007);
TMP8928[30].name = "label";
TMP8932[2] = &TMP8928[31];
NTI457026.size = sizeof(Tcprocsections457026);
NTI457026.kind = 16;
NTI457026.base = (&NTI161007);
NTI457026.flags = 2;
TMP8928[31].kind = 1;
TMP8928[31].offset = offsetof(Tblock457032, sections);
TMP8928[31].typ = (&NTI457026);
TMP8928[31].name = "sections";
TMP8932[3] = &TMP8928[32];
TMP8928[32].kind = 1;
TMP8928[32].offset = offsetof(Tblock457032, isloop);
TMP8928[32].typ = (&NTI138);
TMP8928[32].name = "isLoop";
TMP8932[4] = &TMP8928[33];
TMP8928[33].kind = 1;
TMP8928[33].offset = offsetof(Tblock457032, nestedtrystmts);
TMP8928[33].typ = (&NTI112);
TMP8928[33].name = "nestedTryStmts";
TMP8932[5] = &TMP8928[34];
TMP8928[34].kind = 1;
TMP8928[34].offset = offsetof(Tblock457032, nestedexceptstmts);
TMP8928[34].typ = (&NTI112);
TMP8928[34].name = "nestedExceptStmts";
TMP8932[6] = &TMP8928[35];
TMP8928[35].kind = 1;
TMP8928[35].offset = offsetof(Tblock457032, framelen);
TMP8928[35].typ = (&NTI112);
TMP8928[35].name = "frameLen";
TMP8928[28].len = 7; TMP8928[28].kind = 2; TMP8928[28].sons = &TMP8932[0];
NTI457032.node = &TMP8928[28];
NTI457106.size = sizeof(TY457106*);
NTI457106.kind = 24;
NTI457106.base = (&NTI457032);
NTI457106.flags = 2;
NTI457106.marker = TMP8933;
TMP8928[27].kind = 1;
TMP8928[27].offset = offsetof(Tcproc457034, blocks);
TMP8928[27].typ = (&NTI457106);
TMP8928[27].name = "blocks";
TMP8931[9] = &TMP8928[36];
TMP8928[36].kind = 1;
TMP8928[36].offset = offsetof(Tcproc457034, breakidx);
TMP8928[36].typ = (&NTI108);
TMP8928[36].name = "breakIdx";
TMP8931[10] = &TMP8928[37];
TMP8928[37].kind = 1;
TMP8928[37].offset = offsetof(Tcproc457034, options);
TMP8928[37].typ = (&NTI154121);
TMP8928[37].name = "options";
TMP8931[11] = &TMP8928[38];
TMP8928[38].kind = 1;
TMP8928[38].offset = offsetof(Tcproc457034, maxframelen);
TMP8928[38].typ = (&NTI108);
TMP8928[38].name = "maxFrameLen";
TMP8931[12] = &TMP8928[39];
TMP8928[39].kind = 1;
TMP8928[39].offset = offsetof(Tcproc457034, module);
TMP8928[39].typ = (&NTI457028);
TMP8928[39].name = "module";
TMP8931[13] = &TMP8928[40];
TMP8928[40].kind = 1;
TMP8928[40].offset = offsetof(Tcproc457034, withinloop);
TMP8928[40].typ = (&NTI108);
TMP8928[40].name = "withinLoop";
TMP8931[14] = &TMP8928[41];
TMP8928[41].kind = 1;
TMP8928[41].offset = offsetof(Tcproc457034, splitdecls);
TMP8928[41].typ = (&NTI108);
TMP8928[41].name = "splitDecls";
TMP8931[15] = &TMP8928[42];
TMP8928[42].kind = 1;
TMP8928[42].offset = offsetof(Tcproc457034, gcframeid);
TMP8928[42].typ = (&NTI3407);
TMP8928[42].name = "gcFrameId";
TMP8931[16] = &TMP8928[43];
TMP8928[43].kind = 1;
TMP8928[43].offset = offsetof(Tcproc457034, gcframetype);
TMP8928[43].typ = (&NTI161007);
TMP8928[43].name = "gcFrameType";
TMP8928[18].len = 17; TMP8928[18].kind = 2; TMP8928[18].sons = &TMP8931[0];
NTI457034.node = &TMP8928[18];
NTI457030.size = sizeof(Tcproc457034*);
NTI457030.kind = 22;
NTI457030.base = (&NTI457034);
NTI457030.marker = TMP8934;
TMP8928[17].kind = 1;
TMP8928[17].offset = offsetof(Tcgen457038, initproc);
TMP8928[17].typ = (&NTI457030);
TMP8928[17].name = "initProc";
TMP8930[17] = &TMP8928[44];
TMP8928[44].kind = 1;
TMP8928[44].offset = offsetof(Tcgen457038, postinitproc);
TMP8928[44].typ = (&NTI457030);
TMP8928[44].name = "postInitProc";
TMP8930[18] = &TMP8928[45];
TMP8928[45].kind = 1;
TMP8928[45].offset = offsetof(Tcgen457038, preinitproc);
TMP8928[45].typ = (&NTI457030);
TMP8928[45].name = "preInitProc";
TMP8930[19] = &TMP8928[46];
TMP8928[46].kind = 1;
TMP8928[46].offset = offsetof(Tcgen457038, typestack);
TMP8928[46].typ = (&NTI191845);
TMP8928[46].name = "typeStack";
TMP8930[20] = &TMP8928[47];
TMP8928[47].kind = 1;
TMP8928[47].offset = offsetof(Tcgen457038, datacache);
TMP8928[47].typ = (&NTI191873);
TMP8928[47].name = "dataCache";
TMP8930[21] = &TMP8928[48];
TMP8928[48].kind = 1;
TMP8928[48].offset = offsetof(Tcgen457038, forwardedprocs);
TMP8928[48].typ = (&NTI191815);
TMP8928[48].name = "forwardedProcs";
TMP8930[22] = &TMP8928[49];
TMP8928[49].kind = 1;
TMP8928[49].offset = offsetof(Tcgen457038, typenodes);
TMP8928[49].typ = (&NTI108);
TMP8928[49].name = "typeNodes";
TMP8930[23] = &TMP8928[50];
TMP8928[50].kind = 1;
TMP8928[50].offset = offsetof(Tcgen457038, nimtypes);
TMP8928[50].typ = (&NTI108);
TMP8928[50].name = "nimTypes";
TMP8930[24] = &TMP8928[51];
TMP8928[51].kind = 1;
TMP8928[51].offset = offsetof(Tcgen457038, typenodesname);
TMP8928[51].typ = (&NTI161007);
TMP8928[51].name = "typeNodesName";
TMP8930[25] = &TMP8928[52];
TMP8928[52].kind = 1;
TMP8928[52].offset = offsetof(Tcgen457038, nimtypesname);
TMP8928[52].typ = (&NTI161007);
TMP8928[52].name = "nimTypesName";
TMP8930[26] = &TMP8928[53];
TMP8928[53].kind = 1;
TMP8928[53].offset = offsetof(Tcgen457038, labels);
TMP8928[53].typ = (&NTI3407);
TMP8928[53].name = "labels";
TMP8930[27] = &TMP8928[54];
NTI457143.size = sizeof(TY457143);
NTI457143.kind = 16;
NTI457143.base = (&NTI161007);
NTI457143.flags = 2;
TMP8928[54].kind = 1;
TMP8928[54].offset = offsetof(Tcgen457038, extensionloaders);
TMP8928[54].typ = (&NTI457143);
TMP8928[54].name = "extensionLoaders";
TMP8930[28] = &TMP8928[55];
TMP8928[55].kind = 1;
TMP8928[55].offset = offsetof(Tcgen457038, injectstmt);
TMP8928[55].typ = (&NTI161007);
TMP8928[55].name = "injectStmt";
TMP8928[0].len = 29; TMP8928[0].kind = 2; TMP8928[0].sons = &TMP8930[0];
NTI457038.node = &TMP8928[0];
NTI457028.size = sizeof(Tcgen457038*);
NTI457028.kind = 22;
NTI457028.base = (&NTI457038);
NTI457028.marker = TMP8936;
NTI457155.size = sizeof(TY457155*);
NTI457155.kind = 24;
NTI457155.base = (&NTI457028);
NTI457155.marker = TMP8937;
}
