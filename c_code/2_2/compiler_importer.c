...
static NIM_CONST TY192031 TMP4320 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4321, "strVal", 6);
...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4324, "ident", 5);
static NIM_CONST TY192031 TMP4325 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4326, "sym", 3);
static NIM_CONST TY192031 TMP4327 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4328, "sons", 4);
STRING_LITERAL(TMP4329, "as", 2);
STRING_LITERAL(TMP4330, " ", 1);
STRING_LITERAL(TMP4331, ".", 1);
STRING_LITERAL(TMP4332, "/", 1);
STRING_LITERAL(TMP4333, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP4335, "rawImportSymbol", 15);
STRING_LITERAL(TMP4337, "tab", 3);
STRING_LITERAL(TMP4338, "importSymbol: 2", 15);
STRING_LITERAL(TMP4339, "importSymbol: 3", 15);
STRING_LITERAL(TMP4340, "importAllSymbols: ", 18);
STRING_LITERAL(TMP4341, "a.kind == nkSym ", 16);
STRING_LITERAL(TMP4343, "\'export except\' not implemented", 31);
STRING_LITERAL(TMP4346, "module alias must be an identifier", 34);
STRING_LITERAL(TMP4347, "A module cannot import itself", 29);
...
{	result = 0;
	...
	case ((NU8) 22):
	{
		...
		if (!(((TMP4320[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4321));
		result = nosunixToNativePath((*n).kindU.S3.strval, ((NimStringDesc*) &TMP4322));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 30):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			NU8 LOC12;
			LOC7 = 0;
			if (((TMP4327[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4328));
			if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
			LOC7 = ((*(*n).kindU.S6.sons->data[((NI) 0)]).kind == ((NU8) 2));
			if (!(LOC7)) goto LA8;
			if (((TMP4327[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4328));
			if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP4323[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4324));
			LOC9 = 0;
			LOC9 = getident_167463(((NimStringDesc*) &TMP4329));
		...
		result = nsuReplaceStr(LOC13, ((NimStringDesc*) &TMP4330), ((NimStringDesc*) &TMP4322));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC15, ((NimStringDesc*) &TMP4331), ((NimStringDesc*) &TMP4332));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC19 = 0;
		LOC19 = nsuFormatSingleElem(((NimStringDesc*) &TMP4333), LOC18);
...
static N_INLINE(NIM_BOOL, haspattern_196785)(Tsym191843* s) {
	...
	if (!(LOC1)) goto LA2;
	if (((TMP4327[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4328));
	...
	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			if (!LOC17) goto LA19;
			{
				...
				TMP4334 = subInt(LOC22, ((NI) 1));
				HEX3Atmp_252213 = (NI)(TMP4334);
				...
				res_252216 = ((NI) 0);
				{
					...
					while (1) {
						...
						if (((TMP4327[(*(*etyp).n).kind/8] &(1<<((*(*etyp).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4328));
						if ((NU)(j_252157) >= (NU)((*(*etyp).n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP4325[(*(*(*etyp).n).kindU.S6.sons->data[j_252157]).kind/8] &(1<<((*(*(*etyp).n).kindU.S6.sons->data[j_252157]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4326));
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_252157]).kindU.S4.sym;
						nimln(76, "importer.nim");
						{
							if (!!(((*e).kind == ((NU8) 20)))) goto LA27;
							nimln(77, "importer.nim");
							internalerror_165199((*s).info, ((NimStringDesc*) &TMP4335));
						}
						LA27: ;
						...
						TMP4336 = addInt(res_252216, ((NI) 1));
						res_252216 = (NI)(TMP4336);
					} LA24: ;
				}
			}
		}
...
N_NIMCALL(void, importsymbol_252241)(Tcontext245023* c, Tnode191813* n, Tsym191843* frommod) {
	...
	if (!(((64 &(1<<(((*frommod).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4337));
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_165199((*n).info, ((NimStringDesc*) &TMP4338));
		}
		LA12: ;
			...
			e = initidentiter_199147((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				...
				while (1) {
					...
					nimln(111, "importer.nim");
					{
						...
						internalerror_165199((*n).info, ((NimStringDesc*) &TMP4339));
					}
					LA19: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP4340));
				...
				res_252633 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(137, "importer.nim");
						{
							...
							failedassertimpl_87017(((NimStringDesc*) &TMP4341));
						}
						LA13: ;
						nimln(138, "importer.nim");
						if (!(((TMP4325[(*a_252415).kind/8] &(1<<((*a_252415).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4326));
						...
						TMP4342 = addInt(res_252633, ((NI) 1));
						res_252633 = (NI)(TMP4342);
					} LA10: ;
				}
			}
		}
	...
	{
		{
			...
			TMP4344 = subInt(LOC28, ((NI) 1));
			HEX3Atmp_252637 = (NI)(TMP4344);
			nimln(1598, "system.nim");
			res_252640 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4345 = addInt(res_252640, ((NI) 1));
					res_252640 = (NI)(TMP4345);
				} LA30: ;
			}
		}
	}
...
N_NIMCALL(Tsym191843*, importmoduleas_252671)(Tnode191813* n, Tsym191843* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_165155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4346));
	}
	goto LA1;
	LA9: ;
	{
		...
		if (((TMP4327[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4328));
		if ((NU)(((NI) 1)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP4323[(*(*n).kindU.S6.sons->data[((NI) 1)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 1)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4324));
...
N_NIMCALL(Tsym191843*, myimportmodule_252708)(Tcontext245023* c, Tnode191813* n) {
	...
	nimln(160, "importer.nim");
	{
		...
		nimln(162, "importer.nim");
		{
			...
			localerror_165155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4347));
		}
		LA8: ;
...
N_NIMCALL(Tnode191813*, evalimport_252004)(Tcontext245023* c, Tnode191813* n) {
	...
	memset((void*)(&emptyset), 0, sizeof(emptyset));
	{
		...
		TMP4348 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_252768 = (NI)(TMP4348);
		nimln(1598, "system.nim");
		res_252771 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP4349 = addInt(res_252771, ((NI) 1));
				res_252771 = (NI)(TMP4349);
			} LA4: ;
		}
	}
	popFrame();
		...
		adddecl_250607(c, m);
		{
			...
			res_252838 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP4351 = addInt(res_252838, ((NI) 1));
					res_252838 = (NI)(TMP4351);
				} LA8: ;
			}
		}
	}
...
N_NIMCALL(Tnode191813*, evalimportexcept_252857)(Tcontext245023* c, Tnode191813* n) {
	...
	nimln(193, "importer.nim");
	{
		...
		initintset_188927((&exceptset));
		{
			...
			LOC6 = 0;
			LOC6 = sonslen_194403(n);
			TMP4352 = subInt(LOC6, ((NI) 1));
			HEX3Atmp_252895 = (NI)(TMP4352);
			nimln(1598, "system.nim");
			res_252898 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4353 = addInt(res_252898, ((NI) 1));
					res_252898 = (NI)(TMP4353);
				} LA8: ;
			}
		}
