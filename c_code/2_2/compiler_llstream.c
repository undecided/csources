...
N_NIMCALL(Tllstream179204*, llstreamopen_179276)(void);
...
N_NIMCALL(NIM_BOOL, endswith_179404)(NimStringDesc* x, TY77659 s);
...
N_NIMCALL(void, llstreamwrite_179718)(Tllstream179204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_179739)(Tllstream179204* s);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI start);
N_NIMCALL(NimStringDesc*, copyStr)(NimStringDesc* s, NI first);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
N_NIMCALL(NimStringDesc*, mnewString)(NI len);
STRING_LITERAL(TMP2090, "", 0);
STRING_LITERAL(TMP2091, "\012", 1);
NIM_CONST TY77659 Linecontinuationoprs_179443 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY77659 Additionallinecontinuationoprs_179445 = {
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77659 TMP2095 = {
...
N_NIMCALL(Tllstream179204*, llstreamopenstdin_179293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2090));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_179319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13457(stdout, ((NimStringDesc*) &TMP2091));
...
N_NIMCALL(NIM_BOOL, endswith_179404)(NimStringDesc* x, TY77659 s) {
	...
	TMP2092 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2092);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_179450)(NimStringDesc* x) {
	...
	result = endswith_179404(x, TMP2094);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_179460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_179404(line, TMP2095);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(97, "llstream.nim");
			{
				...
				LOC6 = ((NU8)(s->data[(NI)(TMP2096)]) == (NU8)(34));
				LA7: ;
				LOC5 = LOC6;
				if (!(LOC5)) goto LA8;
				TMP2097 = addInt(i, ((NI) 2));
				if ((NU)((NI)(TMP2097)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC5 = ((NU8)(s->data[(NI)(TMP2097)]) == (NU8)(34));
				LA8: ;
				if (!LOC5) goto LA9;
				nimln(98, "llstream.nim");
				TMP2098 = addInt(result, ((NI) 1));
				result = (NI)(TMP2098);
				nimln(99, "llstream.nim");
				TMP2099 = addInt(i, ((NI) 2));
				i = (NI)(TMP2099);
			}
			LA9: ;
			nimln(100, "llstream.nim");
			TMP2100 = addInt(i, ((NI) 1));
			i = (NI)(TMP2100);
		} LA2: ;
	}
	popFrame();
...
N_NIMCALL(NI, llreadfromstdin_179528)(Tllstream179204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2090));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	triples = ((NI) 0);
	{
		...
		while (1) {
			...
			LA7: ;
			{
				LOC4 = copyString(((NimStringDesc*) &TMP2102));
			}
			LA5: ;
			LOC10 = 0;
...
appendString((*s).s, ((NimStringDesc*) &TMP2091));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_179483(line);
			TMP2103 = addInt(triples, LOC11);
			triples = (NI)(TMP2103);
	...
	TMP2104 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2104);
...
N_NIMCALL(NI, llstreamread_179584)(Tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		TMP2107 = subInt(((*s).s ? (*s).s->Sup.len : 0), (*s).rd);
		result = ((buflen <= (NI)(TMP2107)) ? buflen : (NI)(TMP2107));
		nimln(124, "llstream.nim");
		{
			...
			TMP2108 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2108)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2108)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(126, "llstream.nim");
			TMP2109 = addInt((*s).rd, result);
			(*s).rd = (NI)(TMP2109);
		}
		LA5: ;
	}
...
appendString((*s).s, data);
		...
		TMP2114 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2114);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_179686)(Tllstream179204* s, NimStringDesc* data) {
	...
	llstreamwrite_179665(s, ((NimStringDesc*) &TMP2091));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_179718)(Tllstream179204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2116 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2116), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2117 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2117)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2117)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2118 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2118);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2119 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2119), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2120 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2120)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13515((*s).f, ((void*) ((&result->data[(NI)(TMP2120)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2121 = addInt(i, bytes);
				i = (NI)(TMP2121);
			} LA10: ;
		}
...
static TNimNode* TMP2085[6];
static TNimNode* TMP2086[4];
NI TMP2088;
static char* NIM_CONST TMP2087[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2083[12];
...
NTI179202.base = 0;
NTI179202.flags = 3;
for (TMP2088 = 0; TMP2088 < 4; TMP2088++) {
TMP2083[TMP2088+2].kind = 1;
TMP2083[TMP2088+2].offset = TMP2088;
TMP2083[TMP2088+2].name = TMP2087[TMP2088];
TMP2086[TMP2088] = &TMP2083[TMP2088+2];
}
TMP2083[6].len = 4; TMP2083[6].kind = 2; TMP2083[6].sons = &TMP2086[0];
NTI179202.node = &TMP2083[6];
TMP2083[1].kind = 1;
TMP2083[1].offset = offsetof(Tllstream179204, kind);
TMP2083[1].typ = (&NTI179202);
TMP2083[1].name = "kind";
TMP2085[1] = &TMP2083[7];
TMP2083[7].kind = 1;
TMP2083[7].offset = offsetof(Tllstream179204, f);
TMP2083[7].typ = (&NTI13004);
TMP2083[7].name = "f";
TMP2085[2] = &TMP2083[8];
TMP2083[8].kind = 1;
TMP2083[8].offset = offsetof(Tllstream179204, s);
TMP2083[8].typ = (&NTI149);
TMP2083[8].name = "s";
TMP2085[3] = &TMP2083[9];
TMP2083[9].kind = 1;
TMP2083[9].offset = offsetof(Tllstream179204, rd);
TMP2083[9].typ = (&NTI108);
TMP2083[9].name = "rd";
TMP2085[4] = &TMP2083[10];
TMP2083[10].kind = 1;
TMP2083[10].offset = offsetof(Tllstream179204, wr);
TMP2083[10].typ = (&NTI108);
TMP2083[10].name = "wr";
TMP2085[5] = &TMP2083[11];
TMP2083[11].kind = 1;
TMP2083[11].offset = offsetof(Tllstream179204, lineoffset);
TMP2083[11].typ = (&NTI108);
TMP2083[11].name = "lineOffset";
TMP2083[0].len = 6; TMP2083[0].kind = 2; TMP2083[0].sons = &TMP2085[0];
NTI179204.node = &TMP2083[0];
NTI179206.size = sizeof(Tllstream179204*);
NTI179206.kind = 22;
NTI179206.base = (&NTI179204);
NTI179206.marker = TMP2089;
}
