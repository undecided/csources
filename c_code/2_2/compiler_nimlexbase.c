...
NIM_CONST TY77659 Newlines_180018 = {
...
N_NIMCALL(void, fillbuffer_180097)(Tbaselexer180024* L) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP2126)]))), ((NI)chckRange((NI)(TMP2127), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
		...
		s = (NI)(TMP2133);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP2137), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, openbaselexer_180035)(Tbaselexer180024* L, Tllstream179204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_6001(((NI)chckRange((NI)(TMP2154), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC5));
...
N_NIMCALL(NI, getcolnumber_180059)(Tbaselexer180024* L, NI pos) {
	...
	if ((NI)(TMP2156) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
