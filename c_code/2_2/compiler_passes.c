	...
	nimfr("processImplicits", "passes.nim")
	{
		...
		L_243646 = (implicits ? implicits->Sup.len : 0);
		{
			...
			while (1) {
				...
				importstmt = newnodei_194351(nodekind, gcmdlineinfo_164921);
				nimln(158, "passes.nim");
				str = newstrnode_193643(((NU8) 20), module_243637);
	...
	LA3: ;
	{
		...
		n = loadinitsection_235077(rd);
		{
			...
			res_243779 = ((NI) 0);
			{
				...
				while (1) {
					NI TMP4137;
					if (!(res_243779 <= HEX3Atmp_243776)) goto LA45;
					nimln(1600, "system.nim");
					i_243766 = res_243779;
					nimln(207, "passes.nim");
					...
					nimln(1614, "system.nim");
					TMP4137 = addInt(res_243779, ((NI) 1));
					res_243779 = (NI)(TMP4137);
				} LA45: ;
			}
		}
