...
N_NIMCALL(void, loadfile_250041)(Tlineinfo164338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		if (TMP4271 < (-2147483647 -1) || TMP4271 > 2147483647) raiseOverflow();
		gsourcefiles_250036 = (TY250019*) setLengthSeq(&(gsourcefiles_250036)->Sup, sizeof(Tsourcefile250008), ((NI)chckRange((NI32)(TMP4271), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA3: ;
