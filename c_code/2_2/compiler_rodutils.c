...
N_NIMCALL(void, hexchar_198091)(NIM_CHAR c, NI* xi) {
	...
	case 65 ... 70:
	{
		...
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2711))));
	}
	break;
	default:
	{
...
N_NIMCALL(void, encodevintaux_198269)(NI x, NimStringDesc** result) {
	...
	nimln(71, "rodutils.nim");
	{
		...
		if ((NI)(TMP2724) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_198277 = ((NI64)-((NI)(TMP2724)));
		nimln(74, "rodutils.nim");
...
N_NIMCALL(NI, decodevint_198351)(NCSTRING s, NI* pos) {
	...
	nimln(103, "rodutils.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP2728));
	}
	LA3: ;
	...
	result = (NI)((NU64)((NI)(TMP2746)) - (NU64)(((NI) 5)));
