...
N_NIMCALL(NIM_BOOL, treesequivalent_244112)(Tnode192813* a, Tnode192813* b);
static N_INLINE(NIM_BOOL, eqStrings)(NimStringDesc* a, NimStringDesc* b);
N_NIMCALL(NIM_BOOL, sametypeornil_227108)(Ttype192849* a, Ttype192849* b, NU8 flags);
N_NIMCALL(NI, nodetablerawget_244211)(Tnodetable192873 t, NI k, Tnode192813* key);
static N_INLINE(NI, nexttry_200256)(NI h, NI maxhash);
N_NIMCALL(NI, mulInt)(NI a, NI b);
N_NIMCALL(NI, nodetableget_244244)(Tnodetable192873 t, Tnode192813* key);
N_NIMCALL(void, nodetablerawinsert_244259)(Tnodepairseq192871** data, NI k, Tnode192813* key, NI val);
	...
	{
		{
			...
			res_244093 = ((NI) 0);
			{
				...
				while (1) {
					NI LOC33;
					NI TMP4159;
					if (!(res_244093 <= HEX3Atmp_244090)) goto LA32;
					...
					TMP4159 = addInt(res_244093, ((NI) 1));
					res_244093 = (NI)(TMP4159);
				} LA32: ;
			}
		}
	}
			...
			nimln(50, "treetab.nim");
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_244192 = ((NI) 0);
					{
						...
						while (1) {
							NI TMP4161;
							if (!(res_244192 <= HEX3Atmp_244189)) goto LA28;
							nimln(1600, "system.nim");
							i_244185 = res_244192;
							nimln(52, "treetab.nim");
							{
								...
								if ((NU)(i_244185) >= (NU)((*a).kindU.S6.sons->Sup.len)) raiseIndexError();
								if (((TMP4157[(*b).kind/8] &(1<<((*b).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4158));
								if ((NU)(i_244185) >= (NU)((*b).kindU.S6.sons->Sup.len)) raiseIndexError();
								LOC31 = 0;
								LOC31 = treesequivalent_244112((*a).kindU.S6.sons->data[i_244185], (*b).kindU.S6.sons->data[i_244185]);
								if (!!(LOC31)) goto LA32;
								goto BeforeRet;
							}
							LA32: ;
							nimln(1614, "system.nim");
							TMP4161 = addInt(res_244192, ((NI) 1));
							res_244192 = (NI)(TMP4161);
						} LA28: ;
					}
				}
	...
	h = (NI)(k & (t.data ? (t.data->Sup.len-1) : -1));
	{
		...
		while (1) {
			...
			nimln(59, "treetab.nim");
			{
				...
				if (!(LOC5)) goto LA6;
				if ((NU)(h) >= (NU)(t.data->Sup.len)) raiseIndexError();
				LOC5 = treesequivalent_244112(t.data->data[h].key, key);
				LA6: ;
				if (!LOC5) goto LA7;
...
N_NIMCALL(NI, nodetableget_244244)(Tnodetable192873 t, Tnode192813* key) {
	...
	index = nodetablerawget_244211(t, LOC1, key);
...
N_NIMCALL(void, nodetablerawinsert_244259)(Tnodepairseq192871** data, NI k, Tnode192813* key, NI val) {
	...
	nimln(73, "treetab.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP4164));
	}
	LA5: ;
...
N_NIMCALL(void, nodetableput_244415)(Tnodetable192873* t, Tnode192813* key, NI val) {
	...
	index = nodetablerawget_244211((*t), k, key);
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			n = (Tnodepairseq192871*) newSeq((&NTI192871), ((NI)chckRange((NI)(TMP4166), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_244639;
				NI HEX3Atmp_244676;
				NI res_244679;
				...
				res_244679 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(89, "treetab.nim");
						{
							...
							if ((NU)(i_244639) >= (NU)((*t).data->Sup.len)) raiseIndexError();
							if ((NU)(i_244639) >= (NU)((*t).data->Sup.len)) raiseIndexError();
							nodetablerawinsert_244259((&n), (*t).data->data[i_244639].h, (*t).data->data[i_244639].key, (*t).data->data[i_244639].val);
						}
						LA20: ;
						nimln(1614, "system.nim");
		...
		nodetablerawinsert_244259((&(*t).data), k, key, val);
...
N_NIMCALL(NI, nodetabletestorset_244698)(Tnodetable192873* t, Tnode192813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq192871*) newSeq((&NTI192871), ((NI)chckRange((NI)(TMP4169), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_244839;
				NI HEX3Atmp_244876;
				NI res_244879;
				...
				res_244879 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(106, "treetab.nim");
						{
							...
							if ((NU)(i_244839) >= (NU)((*t).data->Sup.len)) raiseIndexError();
							if ((NU)(i_244839) >= (NU)((*t).data->Sup.len)) raiseIndexError();
							nodetablerawinsert_244259((&n), (*t).data->data[i_244839].h, (*t).data->data[i_244839].key, (*t).data->data[i_244839].val);
						}
						LA20: ;
						nimln(1614, "system.nim");
