...
STRING_LITERAL(TMP7485, "", 0);
STRING_LITERAL(TMP7486, "\012", 1);
STRING_LITERAL(TMP7490, "void", 4);
STRING_LITERAL(TMP7492, "none", 4);
STRING_LITERAL(TMP7493, "bool", 4);
STRING_LITERAL(TMP7494, "char", 4);
STRING_LITERAL(TMP7495, "nil", 3);
STRING_LITERAL(TMP7496, "expr", 4);
STRING_LITERAL(TMP7497, "stmt", 4);
STRING_LITERAL(TMP7498, "void", 4);
STRING_LITERAL(TMP7499, "array", 5);
STRING_LITERAL(TMP7500, "typeDesc", 8);
STRING_LITERAL(TMP7501, "typeDesc", 8);
STRING_LITERAL(TMP7503, "distinct", 8);
STRING_LITERAL(TMP7504, "tuple", 5);
STRING_LITERAL(TMP7505, "set", 3);
STRING_LITERAL(TMP7506, "ptr", 3);
STRING_LITERAL(TMP7507, "ref", 3);
STRING_LITERAL(TMP7508, "var", 3);
STRING_LITERAL(TMP7509, "seq", 3);
STRING_LITERAL(TMP7510, "proc", 4);
STRING_LITERAL(TMP7511, "openArray", 9);
STRING_LITERAL(TMP7512, "range", 5);
static NIM_CONST TY192031 TMP7513 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7514, "sons", 4);
STRING_LITERAL(TMP7515, "pointer", 7);
STRING_LITERAL(TMP7516, "string", 6);
STRING_LITERAL(TMP7517, "cstring", 7);
STRING_LITERAL(TMP7518, "int", 3);
STRING_LITERAL(TMP7519, "int8", 4);
STRING_LITERAL(TMP7520, "int16", 5);
STRING_LITERAL(TMP7521, "int32", 5);
STRING_LITERAL(TMP7522, "int64", 5);
STRING_LITERAL(TMP7523, "float", 5);
STRING_LITERAL(TMP7524, "float32", 7);
STRING_LITERAL(TMP7525, "float64", 7);
STRING_LITERAL(TMP7526, "float128", 8);
STRING_LITERAL(TMP7527, "uint", 4);
STRING_LITERAL(TMP7528, "uint8", 5);
STRING_LITERAL(TMP7529, "uint16", 6);
STRING_LITERAL(TMP7530, "uint32", 6);
STRING_LITERAL(TMP7531, "uint64", 6);
STRING_LITERAL(TMP7532, "bignum", 6);
STRING_LITERAL(TMP7533, "const", 5);
STRING_LITERAL(TMP7534, "mutable", 7);
STRING_LITERAL(TMP7535, "varargs", 7);
STRING_LITERAL(TMP7536, "iter", 4);
STRING_LITERAL(TMP7537, "error", 5);
STRING_LITERAL(TMP7538, "builtinTypeClass", 16);
STRING_LITERAL(TMP7539, "concept", 7);
STRING_LITERAL(TMP7540, "compositeTypeClass", 18);
STRING_LITERAL(TMP7541, "and", 3);
STRING_LITERAL(TMP7542, "or", 2);
STRING_LITERAL(TMP7543, "not", 3);
STRING_LITERAL(TMP7544, "anything", 8);
STRING_LITERAL(TMP7545, "static", 6);
...
N_NIMCALL(NimStringDesc*, readoutput_381009)(Processobj144405* p) {
	...
	result = 0;
	nimln(13, "vmdeps.nim");
	result = copyString(((NimStringDesc*) &TMP7485));
	nimln(14, "vmdeps.nim");
...
appendString(result, ((NimStringDesc*) &TMP7486));
		} LA2: ;
	}
	nimln(18, "vmdeps.nim");
	TMP7487 = subInt((result ? result->Sup.len : 0), ((NI) 1));
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7487), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
...
N_NIMCALL(NimStringDesc*, opgorge_381027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	if (TMP7488.status == 0) {
		...
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP7485), LOC2, 0, NIM_NIL, 4);
		nimln(24, "vmdeps.nim");
		{
...
N_NIMCALL(NimStringDesc*, opslurp_381040)(NimStringDesc* file, Tlineinfo163338 info, Tsym191843* module) {
	...
	result = 0;
	nimln(32, "vmdeps.nim");
	pushSafePoint(&TMP7489);
	TMP7489.status = setjmp(TMP7489.context);
	if (TMP7489.status == 0) {
	...
	if (TMP7489.status != 0) reraiseException();
	popFrame();
	return result;
}
		...
		res_381133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP7490), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7491 = addInt(res_381133, ((NI) 1));
				res_381133 = (NI)(TMP7491);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP7499), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP7500), t, info);
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		{
			...
			res_381246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7502 = addInt(res_381246, ((NI) 1));
					res_381246 = (NI)(TMP7502);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 27):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7511), t, info);
	}
	break;
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP7512), t, info);
		add_192164(result, LOC61);
		nimln(121, "vmdeps.nim");
		if (((TMP7513[(*(*t).n).kind/8] &(1<<((*(*t).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7514));
	...
	case ((NU8) 45):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7532), t, info);
	}
	break;
	case ((NU8) 46):
	{
	...
	case ((NU8) 50):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7537), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 57):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7543), t, info);
	}
	break;
	case ((NU8) 58):
	{
		nimln(154, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7544), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP7545), t, info);
