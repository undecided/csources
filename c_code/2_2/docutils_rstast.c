...
43}
;
STRING_LITERAL(TMP5022, "\012", 1);
STRING_LITERAL(TMP5024, "", 0);
STRING_LITERAL(TMP5026, "\012\012", 2);
STRING_LITERAL(TMP5029, "* ", 2);
STRING_LITERAL(TMP5032, "(#) ", 4);
STRING_LITERAL(TMP5035, "  ", 2);
STRING_LITERAL(TMP5042, "| ", 2);
STRING_LITERAL(TMP5045, "`", 1);
STRING_LITERAL(TMP5046, "`_", 2);
STRING_LITERAL(TMP5047, " <", 2);
STRING_LITERAL(TMP5048, ">`_", 3);
STRING_LITERAL(TMP5049, "`:", 2);
STRING_LITERAL(TMP5050, "`:sub:", 6);
STRING_LITERAL(TMP5051, "`:sup:", 6);
STRING_LITERAL(TMP5052, "`:idx:", 6);
STRING_LITERAL(TMP5053, "*", 1);
STRING_LITERAL(TMP5054, "**", 2);
STRING_LITERAL(TMP5055, "***", 3);
STRING_LITERAL(TMP5057, "``", 2);
STRING_LITERAL(TMP5059, "\\", 1);
STRING_LITERAL(TMP5060, "\\\\", 2);
STRING_LITERAL(TMP5061, ".. index::\012", 11);
STRING_LITERAL(TMP5064, ".. contents::", 13);
STRING_LITERAL(TMP5065, "Error: cannot render: ", 22);
STRING_LITERAL(TMP5068, "kind", 4);
STRING_LITERAL(TMP5069, "level", 5);
STRING_LITERAL(TMP5070, "text", 4);
STRING_LITERAL(TMP5072, "sons", 4);
...
N_NIMCALL(Trstnode297011*, lastson_297147)(Trstnode297011* n) {
	...
	result = 0;
	nimln(87, "rstast.nim");
	TMP5019 = subInt(((*n).sons ? (*n).sons->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP5019)) >= (NU)((*n).sons->Sup.len)) raiseIndexError();
	result = (*n).sons->data[(NI)(TMP5019)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_297224)(Trendercontext297208* d, Trstnode297011* n, NimStringDesc** result) {
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		LOC2 = 0;
		LOC2 = len_297084(n);
		TMP5020 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_297245 = (NI)(TMP5020);
		...
		res_297248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5021 = addInt(res_297248, ((NI) 1));
				res_297248 = (NI)(TMP5021);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		TMP5023 = subInt(((*result) ? (*result)->Sup.len : 0), oldlen);
		headlinelen = (NI)(TMP5023);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP5024));
		nimln(134, "rstast.nim");
		renderrstsons_297224(d, n, (&headline));
		nimln(136, "rstast.nim");
		if ((NU)((*n).level) > (NU)(8)) raiseIndexError();
		TMP5025 = subInt((headline ? headline->Sup.len : 0), (*d).indent);
		lvl = nsuRepeatChar(lvltochar_297274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5025), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
		...
		TMP5027 = subInt(((NI) 78), (*d).indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5027), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP5024));
...
appendString((*result), ((NimStringDesc*) &TMP5035));
	...
	case ((NU8) 14):
	{
		...
		TMP5037 = addInt((tmp ? tmp->Sup.len : 0), ((NI) 3));
		L = (((NI)(TMP5037) >= ((NI) 30)) ? (NI)(TMP5037) : ((NI) 30));
		nimln(193, "rstast.nim");
		TMP5038 = addInt((*d).indent, L);
		(*d).indent = (NI)(TMP5038);
...
appendString((*result), tmp);
		...
		TMP5039 = subInt(L, (tmp ? tmp->Sup.len : 0));
		TMP5040 = subInt((NI)(TMP5039), ((NI) 2));
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5040), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ((NimStringDesc*) &TMP5042));
	...
	case ((NU8) 28):
	{
		...
		TMP5043 = addInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5043);
		nimln(211, "rstast.nim");
		renderrstsons_297224(d, n, result);
		nimln(212, "rstast.nim");
		TMP5044 = subInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5044);
	}
	break;
	case ((NU8) 39):
...
appendString((*result), ((NimStringDesc*) &TMP5055));
	...
	case ((NU8) 61):
	{
		...
		TMP5056 = addInt((*d).verbatim, ((NI) 1));
...
appendString((*result), ((NimStringDesc*) &TMP5057));
		...
		TMP5058 = subInt((*d).verbatim, ((NI) 1));
		(*d).verbatim = (NI)(TMP5058);
	}
	break;
	case ((NU8) 63):
	{
...
appendString((*result), (*n).text);
	...
	case ((NU8) 64):
	{
		nimln(266, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			LOC48 = eqStrings((*n).text, ((NimStringDesc*) &TMP5059));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP5065));
...
N_NIMCALL(Jsonnodeobj290726*, renderrsttojsonnode_297483)(Trstnode297011* node) {
	...
	LOC1[0].Field0 = copyString(((NimStringDesc*) &TMP5068));
	nimln(293, "rstast.nim");
	LOC1[0].Field1 = HEX25_291130(reprEnum((*node).kind, (&NTI297005)));
	LOC1[1].Field0 = copyString(((NimStringDesc*) &TMP5069));
	...
	nimln(296, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5070), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5072), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
static TNimNode* TMP5013[4];
static TNimNode* TMP5014[65];
NI TMP5016;
static char* NIM_CONST TMP5015[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI297005.base = 0;
NTI297005.flags = 3;
for (TMP5016 = 0; TMP5016 < 65; TMP5016++) {
TMP4812[TMP5016+2].kind = 1;
TMP4812[TMP5016+2].offset = TMP5016;
TMP4812[TMP5016+2].name = TMP5015[TMP5016];
TMP5014[TMP5016] = &TMP4812[TMP5016+2];
}
TMP4812[67].len = 65; TMP4812[67].kind = 2; TMP4812[67].sons = &TMP5014[0];
NTI297005.node = &TMP4812[67];
TMP4812[1].kind = 1;
TMP4812[1].offset = offsetof(Trstnode297011, kind);
TMP4812[1].typ = (&NTI297005);
TMP4812[1].name = "kind";
TMP5013[1] = &TMP4812[68];
TMP4812[68].kind = 1;
TMP4812[68].offset = offsetof(Trstnode297011, text);
TMP4812[68].typ = (&NTI149);
TMP4812[68].name = "text";
TMP5013[2] = &TMP4812[69];
TMP4812[69].kind = 1;
TMP4812[69].offset = offsetof(Trstnode297011, level);
TMP4812[69].typ = (&NTI108);
TMP4812[69].name = "level";
TMP5013[3] = &TMP4812[70];
NTI297009.size = sizeof(Trstnodeseq297009*);
NTI297009.kind = 24;
NTI297009.base = (&NTI297007);
NTI297009.flags = 2;
NTI297009.marker = TMP5017;
TMP4812[70].kind = 1;
TMP4812[70].offset = offsetof(Trstnode297011, sons);
TMP4812[70].typ = (&NTI297009);
TMP4812[70].name = "sons";
TMP4812[0].len = 4; TMP4812[0].kind = 2; TMP4812[0].sons = &TMP5013[0];
NTI297011.node = &TMP4812[0];
NTI297007.size = sizeof(Trstnode297011*);
NTI297007.kind = 22;
NTI297007.base = (&NTI297011);
NTI297007.flags = 2;
NTI297007.marker = TMP5018;
}
