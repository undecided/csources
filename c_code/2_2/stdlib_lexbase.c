...
N_NIMCALL(void, fillbuffer_248102)(Baselexer248024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4233)]))), ((NI)chckRange((NI)(TMP4234), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
		...
		s = (NI)(TMP4240);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4244), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, open_248040)(Baselexer248024* L, Streamobj138027* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4262), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_248064)(Baselexer248024* L, NI pos) {
	...
	if ((NI)(TMP4264) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
