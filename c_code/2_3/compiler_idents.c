	...
	result = ((NI) 1);
	{
		...
		while (1) {
			...
			nimln(43, "idents.nim");
			{
				...
				LA18: ;
				if (!LOC17) goto LA19;
				TMP1305 = addInt(((NI) (((NU8)(aa)))), ((NI) 32));
				aa = ((NIM_CHAR) (((NI)chckRange((NI)(TMP1305), ((NI) 0), ((NI) 255)))));
			}
			LA19: ;
			nimln(44, "idents.nim");
			{
				...
				LA24: ;
				if (!LOC23) goto LA25;
				TMP1306 = addInt(((NI) (((NU8)(bb)))), ((NI) 32));
				bb = ((NIM_CHAR) (((NI)chckRange((NI)(TMP1306), ((NI) 0), ((NI) 255)))));
			}
			LA25: ;
			nimln(45, "idents.nim");
...
N_NIMCALL(NI, cmpexact_167187)(NCSTRING a, NCSTRING b, NI blen) {
	...
	result = ((NI) 1);
	{
		...
		while (1) {
			...
			bb = b[j];
			nimln(59, "idents.nim");
			TMP1310 = subInt(((NI) (((NU8)(aa)))), ((NI) (((NU8)(bb)))));
			result = (NI)(TMP1310);
			nimln(60, "idents.nim");
			{
				NIM_BOOL LOC5;
		...
		while (1) {
			...
			LA6: ;
			{
				...
				nimln(82, "idents.nim");
				{
					...
					LA19: ;
					if (!!(LOC18)) goto LA20;
					failedassertimpl_87017(((NimStringDesc*) &TMP1313));
				}
				LA20: ;
				nimln(83, "idents.nim");
				id = (*result).Sup.id;
