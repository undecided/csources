...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77659 TMP2097 = {
...
N_NIMCALL(Tllstream178204*, llstreamopenstdin_178293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2092));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_178319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13457(stdout, ((NimStringDesc*) &TMP2093));
...
N_NIMCALL(NIM_BOOL, endswith_178404)(NimStringDesc* x, TY77659 s) {
	...
	TMP2094 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2094);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_178450)(NimStringDesc* x) {
	...
	result = endswith_178404(x, TMP2096);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_178460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_178404(line, TMP2097);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(97, "llstream.nim");
			{
				...
				LOC6 = ((NU8)(s->data[(NI)(TMP2098)]) == (NU8)(34));
				LA7: ;
				LOC5 = LOC6;
				if (!(LOC5)) goto LA8;
				TMP2099 = addInt(i, ((NI) 2));
				if ((NU)((NI)(TMP2099)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC5 = ((NU8)(s->data[(NI)(TMP2099)]) == (NU8)(34));
				LA8: ;
				if (!LOC5) goto LA9;
				nimln(98, "llstream.nim");
				TMP2100 = addInt(result, ((NI) 1));
				result = (NI)(TMP2100);
				nimln(99, "llstream.nim");
				TMP2101 = addInt(i, ((NI) 2));
				i = (NI)(TMP2101);
			}
			LA9: ;
			nimln(100, "llstream.nim");
			TMP2102 = addInt(i, ((NI) 1));
			i = (NI)(TMP2102);
		} LA2: ;
	}
	popFrame();
...
N_NIMCALL(NI, llreadfromstdin_178528)(Tllstream178204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2092));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	triples = ((NI) 0);
	{
		...
		while (1) {
			...
			LA7: ;
			{
				LOC4 = copyString(((NimStringDesc*) &TMP2104));
			}
			LA5: ;
			LOC10 = 0;
...
appendString((*s).s, ((NimStringDesc*) &TMP2093));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_178483(line);
			TMP2105 = addInt(triples, LOC11);
			triples = (NI)(TMP2105);
	...
	TMP2106 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2106);
...
N_NIMCALL(NI, llstreamread_178584)(Tllstream178204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		TMP2109 = subInt(((*s).s ? (*s).s->Sup.len : 0), (*s).rd);
		result = ((buflen <= (NI)(TMP2109)) ? buflen : (NI)(TMP2109));
		nimln(124, "llstream.nim");
		{
			...
			TMP2110 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2110)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2110)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(126, "llstream.nim");
			TMP2111 = addInt((*s).rd, result);
			(*s).rd = (NI)(TMP2111);
		}
		LA5: ;
	}
...
appendString((*s).s, data);
		...
		TMP2116 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2116);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_178686)(Tllstream178204* s, NimStringDesc* data) {
	...
	llstreamwrite_178665(s, ((NimStringDesc*) &TMP2093));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_178718)(Tllstream178204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2118 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2118), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2119 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2119)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2119)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2120 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2120);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2121 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2121), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2122 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2122)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13515((*s).f, ((void*) ((&result->data[(NI)(TMP2122)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2123 = addInt(i, bytes);
				i = (NI)(TMP2123);
			} LA10: ;
		}
...
static TNimNode* TMP2088[4];
NI TMP2090;
static char* NIM_CONST TMP2089[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2085[12];
...
NTI178202.base = 0;
NTI178202.flags = 3;
for (TMP2090 = 0; TMP2090 < 4; TMP2090++) {
TMP2085[TMP2090+2].kind = 1;
TMP2085[TMP2090+2].offset = TMP2090;
TMP2085[TMP2090+2].name = TMP2089[TMP2090];
TMP2088[TMP2090] = &TMP2085[TMP2090+2];
}
TMP2085[6].len = 4; TMP2085[6].kind = 2; TMP2085[6].sons = &TMP2088[0];
NTI178202.node = &TMP2085[6];
TMP2085[1].kind = 1;
TMP2085[1].offset = offsetof(Tllstream178204, kind);
TMP2085[1].typ = (&NTI178202);
TMP2085[1].name = "kind";
TMP2087[1] = &TMP2085[7];
TMP2085[7].kind = 1;
TMP2085[7].offset = offsetof(Tllstream178204, f);
TMP2085[7].typ = (&NTI13004);
TMP2085[7].name = "f";
TMP2087[2] = &TMP2085[8];
TMP2085[8].kind = 1;
TMP2085[8].offset = offsetof(Tllstream178204, s);
TMP2085[8].typ = (&NTI149);
TMP2085[8].name = "s";
TMP2087[3] = &TMP2085[9];
TMP2085[9].kind = 1;
TMP2085[9].offset = offsetof(Tllstream178204, rd);
TMP2085[9].typ = (&NTI108);
TMP2085[9].name = "rd";
TMP2087[4] = &TMP2085[10];
TMP2085[10].kind = 1;
TMP2085[10].offset = offsetof(Tllstream178204, wr);
TMP2085[10].typ = (&NTI108);
TMP2085[10].name = "wr";
TMP2087[5] = &TMP2085[11];
TMP2085[11].kind = 1;
TMP2085[11].offset = offsetof(Tllstream178204, lineoffset);
TMP2085[11].typ = (&NTI108);
TMP2085[11].name = "lineOffset";
TMP2085[0].len = 6; TMP2085[0].kind = 2; TMP2085[0].sons = &TMP2087[0];
NTI178204.node = &TMP2085[0];
NTI178206.size = sizeof(Tllstream178204*);
NTI178206.kind = 22;
NTI178206.base = (&NTI178204);
NTI178206.marker = TMP2091;
}
