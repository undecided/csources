...
N_NIMCALL(void, fillbuffer_179097)(Tbaselexer179024* L) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP2128)]))), ((NI)chckRange((NI)(TMP2129), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
		...
		s = (NI)(TMP2135);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP2139), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(NI, handlelf_179074)(Tbaselexer179024* L, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP2151));
	}
	LA3: ;
...
N_NIMCALL(void, openbaselexer_179035)(Tbaselexer179024* L, Tllstream178204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP2155));
	}
	LA3: ;
	...
	LOC5 = 0;
	LOC5 = alloc_6001(((NI)chckRange((NI)(TMP2156), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC5));
...
N_NIMCALL(NI, getcolnumber_179059)(Tbaselexer179024* L, NI pos) {
	...
	if ((NI)(TMP2158) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
