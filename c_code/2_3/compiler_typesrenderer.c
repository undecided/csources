...
appendString(LOC25, LOC27);
	...
	case ((NU8) 147):
	{
		...
		nimln(58, "typesrenderer.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP6634));
		}
		LA41: ;
...
appendString(result, LOC47);
	...
	case ((NU8) 35):
	{
		...
		nimln(63, "typesrenderer.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP6637));
		}
		LA54: ;
...
{	nimln(89, "typesrenderer.nim");
	...
	case ((NU8) 35):
	{
		...
		nimln(95, "typesrenderer.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP6647));
		}
		LA11: ;
			...
			res_341630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(103, "typesrenderer.nim");
					{
						...
						LA37: ;
						if (!!(LOC35)) goto LA39;
						failedassertimpl_87017(((NimStringDesc*) &TMP6650));
					}
					LA39: ;
