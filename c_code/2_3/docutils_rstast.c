...
43}
;
STRING_LITERAL(TMP5021, "\012", 1);
STRING_LITERAL(TMP5023, "", 0);
STRING_LITERAL(TMP5025, "\012\012", 2);
STRING_LITERAL(TMP5028, "* ", 2);
STRING_LITERAL(TMP5031, "(#) ", 4);
STRING_LITERAL(TMP5034, "  ", 2);
STRING_LITERAL(TMP5041, "| ", 2);
STRING_LITERAL(TMP5044, "`", 1);
STRING_LITERAL(TMP5045, "`_", 2);
STRING_LITERAL(TMP5046, " <", 2);
STRING_LITERAL(TMP5047, ">`_", 3);
STRING_LITERAL(TMP5048, "`:", 2);
STRING_LITERAL(TMP5049, "`:sub:", 6);
STRING_LITERAL(TMP5050, "`:sup:", 6);
STRING_LITERAL(TMP5051, "`:idx:", 6);
STRING_LITERAL(TMP5052, "*", 1);
STRING_LITERAL(TMP5053, "**", 2);
STRING_LITERAL(TMP5054, "***", 3);
STRING_LITERAL(TMP5056, "``", 2);
STRING_LITERAL(TMP5058, "\\", 1);
STRING_LITERAL(TMP5059, "\\\\", 2);
STRING_LITERAL(TMP5060, ".. index::\012", 11);
STRING_LITERAL(TMP5063, ".. contents::", 13);
STRING_LITERAL(TMP5064, "Error: cannot render: ", 22);
STRING_LITERAL(TMP5067, "kind", 4);
STRING_LITERAL(TMP5068, "level", 5);
STRING_LITERAL(TMP5069, "text", 4);
STRING_LITERAL(TMP5071, "sons", 4);
...
N_NIMCALL(Trstnode297011*, lastson_297147)(Trstnode297011* n) {
	...
	result = 0;
	nimln(87, "rstast.nim");
	TMP5018 = subInt(((*n).sons ? (*n).sons->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP5018)) >= (NU)((*n).sons->Sup.len)) raiseIndexError();
	result = (*n).sons->data[(NI)(TMP5018)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_297224)(Trendercontext297208* d, Trstnode297011* n, NimStringDesc** result) {
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		LOC2 = 0;
		LOC2 = len_297084(n);
		TMP5019 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_297245 = (NI)(TMP5019);
		...
		res_297248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5020 = addInt(res_297248, ((NI) 1));
				res_297248 = (NI)(TMP5020);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		TMP5022 = subInt(((*result) ? (*result)->Sup.len : 0), oldlen);
		headlinelen = (NI)(TMP5022);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP5023));
		nimln(134, "rstast.nim");
		renderrstsons_297224(d, n, (&headline));
		nimln(136, "rstast.nim");
		if ((NU)((*n).level) > (NU)(8)) raiseIndexError();
		TMP5024 = subInt((headline ? headline->Sup.len : 0), (*d).indent);
		lvl = nsuRepeatChar(lvltochar_297274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5024), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
		...
		TMP5026 = subInt(((NI) 78), (*d).indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5026), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP5023));
...
appendString((*result), ((NimStringDesc*) &TMP5034));
	...
	case ((NU8) 14):
	{
		...
		TMP5036 = addInt((tmp ? tmp->Sup.len : 0), ((NI) 3));
		L = (((NI)(TMP5036) >= ((NI) 30)) ? (NI)(TMP5036) : ((NI) 30));
		nimln(193, "rstast.nim");
		TMP5037 = addInt((*d).indent, L);
		(*d).indent = (NI)(TMP5037);
...
appendString((*result), tmp);
		...
		TMP5038 = subInt(L, (tmp ? tmp->Sup.len : 0));
		TMP5039 = subInt((NI)(TMP5038), ((NI) 2));
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5039), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ((NimStringDesc*) &TMP5041));
	...
	case ((NU8) 28):
	{
		...
		TMP5042 = addInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5042);
		nimln(211, "rstast.nim");
		renderrstsons_297224(d, n, result);
		nimln(212, "rstast.nim");
		TMP5043 = subInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5043);
	}
	break;
	case ((NU8) 39):
...
appendString((*result), ((NimStringDesc*) &TMP5054));
	...
	case ((NU8) 61):
	{
		...
		TMP5055 = addInt((*d).verbatim, ((NI) 1));
...
appendString((*result), ((NimStringDesc*) &TMP5056));
		...
		TMP5057 = subInt((*d).verbatim, ((NI) 1));
		(*d).verbatim = (NI)(TMP5057);
	}
	break;
	case ((NU8) 63):
	{
...
appendString((*result), (*n).text);
	...
	case ((NU8) 64):
	{
		nimln(266, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			LOC48 = eqStrings((*n).text, ((NimStringDesc*) &TMP5058));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP5064));
...
N_NIMCALL(Jsonnodeobj290726*, renderrsttojsonnode_297483)(Trstnode297011* node) {
	...
	LOC1[0].Field0 = copyString(((NimStringDesc*) &TMP5067));
	nimln(293, "rstast.nim");
	LOC1[0].Field1 = HEX25_291130(reprEnum((*node).kind, (&NTI297005)));
	LOC1[1].Field0 = copyString(((NimStringDesc*) &TMP5068));
	...
	nimln(296, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5069), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5071), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
static TNimNode* TMP5012[4];
static TNimNode* TMP5013[65];
NI TMP5015;
static char* NIM_CONST TMP5014[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI297005.base = 0;
NTI297005.flags = 3;
for (TMP5015 = 0; TMP5015 < 65; TMP5015++) {
TMP4811[TMP5015+2].kind = 1;
TMP4811[TMP5015+2].offset = TMP5015;
TMP4811[TMP5015+2].name = TMP5014[TMP5015];
TMP5013[TMP5015] = &TMP4811[TMP5015+2];
}
TMP4811[67].len = 65; TMP4811[67].kind = 2; TMP4811[67].sons = &TMP5013[0];
NTI297005.node = &TMP4811[67];
TMP4811[1].kind = 1;
TMP4811[1].offset = offsetof(Trstnode297011, kind);
TMP4811[1].typ = (&NTI297005);
TMP4811[1].name = "kind";
TMP5012[1] = &TMP4811[68];
TMP4811[68].kind = 1;
TMP4811[68].offset = offsetof(Trstnode297011, text);
TMP4811[68].typ = (&NTI149);
TMP4811[68].name = "text";
TMP5012[2] = &TMP4811[69];
TMP4811[69].kind = 1;
TMP4811[69].offset = offsetof(Trstnode297011, level);
TMP4811[69].typ = (&NTI108);
TMP4811[69].name = "level";
TMP5012[3] = &TMP4811[70];
NTI297009.size = sizeof(Trstnodeseq297009*);
NTI297009.kind = 24;
NTI297009.base = (&NTI297007);
NTI297009.flags = 2;
NTI297009.marker = TMP5016;
TMP4811[70].kind = 1;
TMP4811[70].offset = offsetof(Trstnode297011, sons);
TMP4811[70].typ = (&NTI297009);
TMP4811[70].name = "sons";
TMP4811[0].len = 4; TMP4811[0].kind = 2; TMP4811[0].sons = &TMP5012[0];
NTI297011.node = &TMP4811[0];
NTI297007.size = sizeof(Trstnode297011*);
NTI297007.kind = 22;
NTI297007.base = (&NTI297011);
NTI297007.flags = 2;
NTI297007.marker = TMP5017;
}
