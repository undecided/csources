...
N_NIMCALL(void, fillbuffer_247102)(Baselexer247024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4235)]))), ((NI)chckRange((NI)(TMP4236), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
		...
		s = (NI)(TMP4242);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4246), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, open_247040)(Baselexer247024* L, Streamobj138027* input, NI buflen) {
	...
	nimln(145, "lexbase.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP4263));
	}
	LA7: ;
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4264), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_247064)(Baselexer247024* L, NI pos) {
	...
	if ((NI)(TMP4266) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
