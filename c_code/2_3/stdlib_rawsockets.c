...
N_NIMCALL(void, gethostbyaddr_512433)(NimStringDesc* ip, Hostent510612* Result);
...
N_NIMCALL(void, setsockoptint_513431)(int socket, NI level, NI optname, NI optval);
N_NIMCALL(void, setblocking_513445)(int s, NIM_BOOL blocking);
...
N_NIMCALL(void, createfdset_513643)(fd_set* fd, TY513647* s, NI* m);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(void, failedassertimpl_87017)(NimStringDesc* msg);
N_NIMCALL(void, prunesocketset_513846)(TY513647** s, fd_set* fd);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(NI, select_513913)(TY513647** readfds, NI timeout);
N_NIMCALL(NI, selectwrite_513970)(TY513647** writefds, NI timeout);
...
TNimType NTI513647; /* seq[SocketHandle] */
...
N_NIMCALL(struct timeval, timevalfrommilliseconds_513628)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		result.tv_usec = ((NI) (((NI32)chckRange((NI)(TMP10621), ((NI32) (-2147483647 -1)), ((NI32) 2147483647)))));
	}
	LA3: ;
	popFrame();
	return result;
...
N_NIMCALL(void, prunesocketset_513846)(TY513647** s, fd_set* fd) {
	...
	(*s) = (TY513647*) setLengthSeq(&((*s))->Sup, sizeof(int), ((NI)chckRange(L, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	popFrame();
}
...
N_NIMCALL(NI, select_513913)(TY513647** readfds, NI timeout) {
	...
	createfdset_513643((&rd), (*readfds), (&m));
	nimln(405, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI)(TMP10627), ((int) (-2147483647 -1)), ((int) 2147483647))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI)(TMP10628), ((int) (-2147483647 -1)), ((int) 2147483647))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_513970)(TY513647** writefds, NI timeout) {
	...
	createfdset_513643((&wr), (*writefds), (&m));
	nimln(427, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI)(TMP10629), ((int) (-2147483647 -1)), ((int) 2147483647))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI)(TMP10630), ((int) (-2147483647 -1)), ((int) 2147483647))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
NTI513647.size = sizeof(TY513647*);
NTI513647.kind = 24;
NTI513647.base = (&NTI5811);
NTI513647.flags = 2;
NTI513647.marker = TMP10664;
}
