...
static N_INLINE(NIM_BOOL, mustrehash_153303)(NI length, NI counter) {
	...
	nimln(114, "sets.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP659));
	}
	LA3: ;
	nimln(115, "sets.nim");
	LOC5 = 0;
	TMP660 = mulInt(length, ((NI) 2));
	TMP661 = mulInt(counter, ((NI) 3));
	LOC5 = ((NI)(TMP660) < (NI)(TMP661));
	if (LOC5) goto LA6;
	TMP662 = subInt(length, counter);
	LOC5 = ((NI)(TMP662) < ((NI) 4));
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, rightsize_153407)(NI count) {
	...
	TMP664 = divInt(((NI) ((NI)(TMP663))), ((NI) 2));
	TMP665 = addInt(((NI) ((NI)(TMP664))), ((NI) 4));
	result = nextpoweroftwo_150531(((NI) ((NI)(TMP665))));
	popFrame();
	return result;
}
...
static N_INLINE(NI, nexttry_153420)(NI h, NI maxhash) {
	...
	result = 0;
	nimln(127, "sets.nim");
	TMP666 = addInt(h, ((NI) 1));
	result = (NI)((NI)(TMP666) & maxhash);
	popFrame();
	return result;
}
