...
static N_INLINE(NI, rightsize_156407)(NI count) {
	...
	TMP742 = divInt(((NI) ((NI)(TMP741))), ((NI) 2));
	TMP743 = addInt(((NI) ((NI)(TMP742))), ((NI) 4));
	result = nextpoweroftwo_149531(((NI) ((NI)(TMP743))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_163672)(Table163376* t) {
	...
	n = (Keyvaluepairseq163379*) newSeq((&NTI163379), ((NI)chckRange((NI)(TMP1213), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, enlarge_313185)(Table312052* t) {
	...
	n = (Keyvaluepairseq312055*) newSeq((&NTI312055), ((NI)chckRange((NI)(TMP5915), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
...
N_NIMCALL(void, enlarge_316109)(Table313409* t) {
	...
	n = (Keyvaluepairseq313412*) newSeq((&NTI313412), ((NI)chckRange((NI)(TMP6002), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
...
N_NIMCALL(void, enlarge_383198)(Table382650* t) {
	...
	n = (Keyvaluepairseq382653*) newSeq((&NTI382653), ((NI)chckRange((NI)(TMP7589), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
