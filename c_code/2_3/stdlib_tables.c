...
N_NIMCALL(void, enlarge_313185)(Table312052* t) {
	...
	n = (Keyvaluepairseq312055*) newSeq((&NTI312055), ((NI)chckRange((NI)(TMP5913), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
...
N_NIMCALL(void, enlarge_316109)(Table313409* t) {
	...
	n = (Keyvaluepairseq313412*) newSeq((&NTI313412), ((NI)chckRange((NI)(TMP6000), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
...
N_NIMCALL(void, enlarge_383198)(Table382650* t) {
	...
	n = (Keyvaluepairseq382653*) newSeq((&NTI382653), ((NI)chckRange((NI)(TMP7587), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
