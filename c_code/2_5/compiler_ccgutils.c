...
static NIM_CONST TY192031 TMP8899 = {
	...
	{
		{
			...
			res_455087 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8901 = addInt(res_455087, ((NI) 1));
					res_455087 = (NI)(TMP8901);
				} LA5: ;
			}
		} LA2: ;
	}
	...
	{
		{
			...
			res_455095 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP8902 = addInt(res_455095, ((NI) 1));
					res_455095 = (NI)(TMP8902);
				} LA15: ;
			}
		}
	}
		...
		b = IL64(0);
		{
			...
			res_455235 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8904 = addInt(res_455235, ((NI) 1));
					res_455235 = (NI)(TMP8904);
				} LA7: ;
			}
		}
		...
		a = ((NI32) 0);
		{
			...
			res_455244 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP8906 = addInt(res_455244, ((NI) 1));
					res_455244 = (NI)(TMP8906);
				} LA11: ;
			}
		}
	...
	nimfr("initTypeTables", "ccgutils.nim")
	{
		...
		res_455430 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP8907 = addInt(res_455430, ((NI) 1));
				res_455430 = (NI)(TMP8907);
			} LA3: ;
		}
	}
	popFrame();
	...
	inittypetables_455285();
	{
		...
		res_455464 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP8908 = addInt(res_455464, ((NI) 1));
				res_455464 = (NI)(TMP8908);
			} LA3: ;
		}
	}
	popFrame();
	...
	LA5: ;
	{
		...
		res_455637 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA14: ;
				nimln(1614, "system.nim");
				TMP8909 = addInt(res_455637, ((NI) 1));
				res_455637 = (NI)(TMP8909);
			} LA9: ;
		}
	}
...
{	result = 0;
	...
	case ((NU8) 58):
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP8910));
	}
	break;
	case ((NU8) 13):
	{
			...
			LA46: ;
			{
				...
				res_455785 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA55: ;
						nimln(1614, "system.nim");
						TMP8911 = addInt(res_455785, ((NI) 1));
						res_455785 = (NI)(TMP8911);
					} LA50: ;
				}
			}
		...
		if (!LOC4) goto LA6;
		{
			...
			res_455851 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA13: ;
					nimln(1614, "system.nim");
					TMP8912 = addInt(res_455851, ((NI) 1));
					res_455851 = (NI)(TMP8912);
				} LA10: ;
			}
		}
	}
...
appendString(result, LOC15);
				...
				nimln(1619, "system.nim");
				TMP8919 = addInt(res_455932, ((NI) 1));
				res_455932 = (NI)(TMP8919);
			} LA9: ;
		}
	}
	popFrame();
...
appendString(res, LOC10);
				...
				nimln(1614, "system.nim");
				TMP8924 = addInt(res_455985, ((NI) 1));
				res_455985 = (NI)(TMP8924);
			} LA3: ;
		}
	}
