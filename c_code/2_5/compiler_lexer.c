...
static NIM_CONST TY77859 TMP2301 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x7E, 0x00, 0x00, 0x01, 0x7E, 0x00, 0x00, 0x01,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77859 TMP2302 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x0C, 0x00, 0x00, 0x00, 0x0C, 0x80, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77859 TMP2305 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
static NIM_CONST TY77859 TMP2417 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xEC, 0x00, 0xF4,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
...
N_NIMCALL(void, lexmessagepos_181507)(Tlexer181185* L, NU16 msg, NI pos, NimStringDesc* arg) {
	...
	info = newlineinfo_163867((*L).fileidx, (*L).Sup.linenumber, (NI)(TMP2292));
	nimln(230, "lexer.nim");
	dispmessage_181463((&(*L)), info, msg, arg);
	popFrame();
}
...
N_NIMCALL(void, handlehexchar_182360)(Tlexer181185* L, NI* xi) {
	...
	case 65 ... 70:
	{
		...
		(*xi) = (NI)((NI)((NU32)((*xi)) << (NU32)(((NI) 4))) | ((NI) ((NI)(TMP2369))));
		nimln(467, "lexer.nim");
	...
	result = mnewString(((NI)chckRange(len, ((NI) 0), ((NI) 2147483647))));
	{
		...
		res_182683 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP2388 = addInt(res_182683, ((NI) 1));
				res_182683 = (NI)(TMP2388);
			} LA3: ;
		}
	}
	popFrame();
...
{	nimln(682, "lexer.nim");
	...
	nimln(685, "lexer.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2422));
	}
	LA3: ;
	nimln(686, "lexer.nim");
	{
	...
	LA8: ;
	{
		...
		case 42:
		{
			nimln(802, "lexer.nim");
			{
				...
				endoperator_183086(L, tok, (NI)(TMP2447), h);
			}
			goto LA13;
			LA17: ;
			{
