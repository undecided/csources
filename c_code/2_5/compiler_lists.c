...
N_NIMCALL(void, append_130053)(Tlinkedlist130028* list, Tlistentry130022* entry) {
	...
	nimln(37, "lists.nim");
	{
		...
		nimln(38, "lists.nim");
		{
			...
			failedassertimpl_87217(((NimStringDesc*) &TMP467));
		}
		LA7: ;
		nimln(39, "lists.nim");
...
N_NIMCALL(void, insertbefore_130430)(Tlinkedlist130028* list, Tlistentry130022* pos, Tlistentry130022* entry) {
	...
	nimln(75, "lists.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP473));
	}
	LA3: ;
	nimln(76, "lists.nim");
	{
...
TMP464[4].len = 3; TMP464[4].kind = 2; TMP464[4].sons = &TMP4208[0];
