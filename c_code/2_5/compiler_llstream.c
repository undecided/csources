...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77859 TMP2097 = {
...
N_NIMCALL(NI, llstreamread_178584)(Tllstream178204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(124, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2110)]))), ((NI)chckRange(result, ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, llstreamwrite_178718)(Tllstream178204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2118), ((NI) 0), ((NI) 2147483647))));
			nimln(189, "llstream.nim");
			TMP2119 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2119)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2119)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) 2147483647))));
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2121), ((NI) 0), ((NI) 2147483647))));
