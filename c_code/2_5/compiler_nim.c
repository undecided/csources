...
N_NIMCALL(void, handlecmdline_529607)(void) {
	...
	{
		nimln(40, "nim.nim");
		processcmdline_523209(((NU8) 0), ((NimStringDesc*) &TMP10794));
		nimln(41, "nim.nim");
		{
			TSafePoint TMP10795;
			TY119589 p;
		...
		LA7: ;
		nimln(51, "nim.nim");
		loadconfigs_187809(((NimStringDesc*) &TMP10796));
		nimln(54, "nim.nim");
		initvars_171876();
		nimln(55, "nim.nim");
		processcmdline_523209(((NU8) 1), ((NimStringDesc*) &TMP10794));
		nimln(56, "nim.nim");
		maincommand_526628();
		nimln(57, "nim.nim");
		{
		...
		nimln(59, "nim.nim");
		{
			...
			nimln(63, "nim.nim");
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_155234, ((NimStringDesc*) &TMP10797))) goto LA33;
					nimln(65, "nim.nim");
					LOC35 = 0;
					LOC35 = gprojectfull_155236; gprojectfull_155236 = copyStringRC1(((NimStringDesc*) &TMP10798));
				...
				nimln(66, "nim.nim");
				{
					...
					LA42: ;
					{
						...
						nimln(72, "nim.nim");
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_155236, ((NimStringDesc*) &TMP10799));
						LOC47 = 0;
...
appendString(LOC49, arguments_178721);
					execexternalprogram_171985(LOC49, ((NimStringDesc*) &TMP10794));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						...
						nimln(81, "nim.nim");
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_155236, ((NimStringDesc*) &TMP10794));
...
appendString(LOC58, arguments_178721);
					execexternalprogram_171985(LOC58, ((NimStringDesc*) &TMP10794));
				}
				LA36: ;
			}
			LA29: ;
