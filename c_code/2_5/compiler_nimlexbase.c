...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP2124, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP2127, "0 <= toCopy ", 12);
STRING_LITERAL(TMP2136, "s < L.bufLen ", 13);
STRING_LITERAL(TMP2141, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP2147, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP2149, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP2151, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP2155, "0 < bufLen ", 11);
STRING_LITERAL(TMP2159, "", 0);
STRING_LITERAL(TMP2161, "\012", 1);
STRING_LITERAL(TMP2162, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_179097)(Tbaselexer179024* L) {
	...
	TMP2125 = subInt((*L).buflen, (*L).sentinel);
	TMP2126 = subInt((NI)(TMP2125), ((NI) 1));
	tocopy = (NI)(TMP2126);
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		TMP2129 = mulInt(tocopy, ((NI) 1));
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP2128)]))), ((NI)chckRange((NI)(TMP2129), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
	...
	nimln(88, "nimlexbase.nim");
	nimln(89, "nimlexbase.nim");
	TMP2130 = addInt((*L).sentinel, ((NI) 1));
	TMP2131 = mulInt((NI)(TMP2130), ((NI) 1));
	LOC13 = 0;
	LOC13 = llstreamread_178584((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP2131));
	TMP2132 = divInt(LOC13, ((NI) 1));
	charsread = (NI)(TMP2132);
	nimln(90, "nimlexbase.nim");
	TMP2133 = addInt(tocopy, charsread);
	s = (NI)(TMP2133);
	nimln(91, "nimlexbase.nim");
	{
		NI TMP2134;
		TMP2134 = addInt((*L).sentinel, ((NI) 1));
		if (!(charsread < (NI)(TMP2134))) goto LA16;
		...
		s = (NI)(TMP2135);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					TMP2138 = mulInt((*L).buflen, ((NI) 2));
					(*L).buflen = (NI)(TMP2138);
					nimln(109, "nimlexbase.nim");
					TMP2139 = mulInt((*L).buflen, ((NI) 1));
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP2139), ((NI) 0), ((NI) 2147483647))));
					(*L).buf = ((NCSTRING) (LOC34));
					nimln(110, "nimlexbase.nim");
					{
						NI TMP2140;
						TMP2140 = subInt((*L).buflen, oldbuflen);
						if (!!(((NI)(TMP2140) == oldbuflen))) goto LA37;
					...
					nimln(111, "nimlexbase.nim");
					nimln(112, "nimlexbase.nim");
					TMP2142 = mulInt(oldbuflen, ((NI) 1));
					LOC39 = 0;
					LOC39 = llstreamread_178584((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP2142));
					TMP2143 = divInt(LOC39, ((NI) 1));
					charsread = (NI)(TMP2143);
					nimln(113, "nimlexbase.nim");
					{
						...
						TMP2145 = addInt(oldbuflen, charsread);
...
N_NIMCALL(NI, handlelf_179074)(Tbaselexer179024* L, NI pos) {
	...
	nimln(137, "nimlexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2151));
	}
	LA3: ;
	nimln(138, "nimlexbase.nim");
	TMP2152 = addInt((*L).linenumber, ((NI) 1));
	(*L).linenumber = (NI)(TMP2152);
...
N_NIMCALL(void, skiputf8bom_180416)(Tbaselexer179024* L) {
	...
	nimln(142, "nimlexbase.nim");
	{
		...
		TMP2153 = addInt((*L).bufpos, ((NI) 3));
		(*L).bufpos = (NI)(TMP2153);
		nimln(144, "nimlexbase.nim");
		TMP2154 = addInt((*L).linestart, ((NI) 3));
		(*L).linestart = (NI)(TMP2154);
	}
	LA7: ;
	popFrame();
}
...
N_NIMCALL(void, openbaselexer_179035)(Tbaselexer179024* L, Tllstream178204* inputstream, NI buflen) {
	...
	nimln(147, "nimlexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2155));
	}
	LA3: ;
	...
	TMP2156 = mulInt(buflen, ((NI) 1));
	LOC5 = 0;
	LOC5 = alloc_6001(((NI)chckRange((NI)(TMP2156), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC5));
	nimln(151, "nimlexbase.nim");
	TMP2157 = subInt(buflen, ((NI) 1));
	(*L).sentinel = (NI)(TMP2157);
...
N_NIMCALL(NI, getcolnumber_179059)(Tbaselexer179024* L, NI pos) {
	...
	TMP2158 = subInt(pos, (*L).linestart);
	if ((NI)(TMP2158) == (-2147483647 -1)) raiseOverflow();
	result = ((NI)(TMP2158) > 0? ((NI)(TMP2158)) : -((NI)(TMP2158)));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_179052)(Tbaselexer179024* L, NIM_BOOL marker) {
	...
	i = (*L).linestart;
	{
		...
		while (1) {
			...
			TMP2160 = addInt(i, ((NI) 1));
			i = (NI)(TMP2160);
		} LA2: ;
	}
	nimln(167, "nimlexbase.nim");
	result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP2161));
...
appendString(LOC7, ((NimStringDesc*) &TMP2162));
...
static TNimNode* TMP2497[7];
static TNimNode TMP2083[8];
NTI179024.size = sizeof(Tbaselexer179024);
NTI179024.kind = 17;
NTI179024.base = (&NTI3411);
TMP2497[0] = &TMP2083[1];
TMP2083[1].kind = 1;
TMP2083[1].offset = offsetof(Tbaselexer179024, bufpos);
TMP2083[1].typ = (&NTI108);
TMP2083[1].name = "bufpos";
TMP2497[1] = &TMP2083[2];
TMP2083[2].kind = 1;
TMP2083[2].offset = offsetof(Tbaselexer179024, buf);
TMP2083[2].typ = (&NTI151);
TMP2083[2].name = "buf";
TMP2497[2] = &TMP2083[3];
TMP2083[3].kind = 1;
TMP2083[3].offset = offsetof(Tbaselexer179024, buflen);
TMP2083[3].typ = (&NTI108);
TMP2083[3].name = "bufLen";
TMP2497[3] = &TMP2083[4];
TMP2083[4].kind = 1;
TMP2083[4].offset = offsetof(Tbaselexer179024, stream);
TMP2083[4].typ = (&NTI178206);
TMP2083[4].name = "stream";
TMP2497[4] = &TMP2083[5];
TMP2083[5].kind = 1;
TMP2083[5].offset = offsetof(Tbaselexer179024, linenumber);
TMP2083[5].typ = (&NTI108);
TMP2083[5].name = "lineNumber";
TMP2497[5] = &TMP2083[6];
TMP2083[6].kind = 1;
TMP2083[6].offset = offsetof(Tbaselexer179024, sentinel);
TMP2083[6].typ = (&NTI108);
TMP2083[6].name = "sentinel";
TMP2497[6] = &TMP2083[7];
TMP2083[7].kind = 1;
TMP2083[7].offset = offsetof(Tbaselexer179024, linestart);
TMP2083[7].typ = (&NTI108);
TMP2083[7].name = "lineStart";
TMP2083[0].len = 7; TMP2083[0].kind = 2; TMP2083[0].sons = &TMP2497[0];
NTI179024.node = &TMP2083[0];
}
