...
STRING_LITERAL(TMP3405, "standard", 8);
STRING_LITERAL(TMP3406, "strongspaces", 12);
STRING_LITERAL(TMP3407, "braces", 6);
STRING_LITERAL(TMP3408, "endx", 4);
NIM_CONST TY219020 parsernames_219019 = {((NimStringDesc*) &TMP3405),
((NimStringDesc*) &TMP3406),
((NimStringDesc*) &TMP3407),
((NimStringDesc*) &TMP3408)}
;
STRING_LITERAL(TMP3409, "none", 4);
STRING_LITERAL(TMP3410, "stdtmpl", 7);
STRING_LITERAL(TMP3411, "replace", 7);
STRING_LITERAL(TMP3412, "strip", 5);
NIM_CONST TY219026 filternames_219025 = {((NimStringDesc*) &TMP3409),
((NimStringDesc*) &TMP3410),
((NimStringDesc*) &TMP3411),
((NimStringDesc*) &TMP3412)}
;
STRING_LITERAL(TMP3417, "parser to implement", 19);
...
static NIM_CONST TY192031 TMP3428 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3429, "ident", 5);
STRING_LITERAL(TMP3430, "|", 1);
...
N_NIMCALL(Tnode191813*, parseall_219063)(Tparsers219035* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP3417));
...
N_NIMCALL(NIM_BOOL, containsshebang_219132)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		if ((NU)((NI)(TMP3418)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI)(TMP3418)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
...
N_NIMCALL(Tnode191813*, parsepipe_219170)(NimStringDesc* filename, Tllstream178204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			if ((NU)((NI)(TMP3421)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI)(TMP3421)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
			nimln(99, "syntaxes.nim");
			TMP3422 = addInt(i, ((NI) 2));
			i = (NI)(TMP3422);
			{
...
{	result = 0;
	{
		...
		res_219429 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP3424 = addInt(res_219429, ((NI) 1));
				res_219429 = (NI)(TMP3424);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_219629 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP3425 = addInt(res_219629, ((NI) 1));
				res_219629 = (NI)(TMP3425);
			} LA3: ;
		}
	}
...
N_NIMCALL(Tident167021*, getcallee_219647)(Tnode191813* n) {
	...
	nimln(120, "syntaxes.nim");
	{
		...
		if (((TMP3426[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3427));
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3428[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3429));
	...
	LA5: ;
	{
		...
		if (!(((TMP3428[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3429));
...
{	result = 0;
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3428[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3429));
		LOC7 = identeq_167484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP3430));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_219772;
			...
			res_219798 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA16: ;
					nimln(1614, "system.nim");
					TMP3431 = addInt(res_219798, ((NI) 1));
					res_219798 = (NI)(TMP3431);
				} LA15: ;
			}
		}
	}
...
static TNimNode* TMP3413[2];
static TNimNode* TMP3414[4];
NI TMP3416;
static char* NIM_CONST TMP3415[4] = {
"skinStandard", 
"skinStrongSpaces", 
"skinBraces", 
"skinEndX"};
...
NTI219007.base = 0;
NTI219007.flags = 3;
for (TMP3416 = 0; TMP3416 < 4; TMP3416++) {
TMP2934[TMP3416+2].kind = 1;
TMP2934[TMP3416+2].offset = TMP3416;
TMP2934[TMP3416+2].name = TMP3415[TMP3416];
TMP3414[TMP3416] = &TMP2934[TMP3416+2];
}
TMP2934[6].len = 4; TMP2934[6].kind = 2; TMP2934[6].sons = &TMP3414[0];
NTI219007.node = &TMP2934[6];
TMP2934[1].kind = 1;
TMP2934[1].offset = offsetof(Tparsers219035, skin);
TMP2934[1].typ = (&NTI219007);
TMP2934[1].name = "skin";
TMP3413[1] = &TMP2934[7];
TMP2934[7].kind = 1;
TMP2934[7].offset = offsetof(Tparsers219035, parser);
TMP2934[7].typ = (&NTI207205);
TMP2934[7].name = "parser";
TMP2934[0].len = 2; TMP2934[0].kind = 2; TMP2934[0].sons = &TMP3413[0];
NTI219035.node = &TMP2934[0];
}
