	...
	{
		{
			...
			res_243092 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4160 = addInt(res_243092, ((NI) 1));
					res_243092 = (NI)(TMP4160);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_243191 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4162 = addInt(res_243191, ((NI) 1));
							res_243191 = (NI)(TMP4162);
						} LA28: ;
					}
				}
...
N_NIMCALL(NI, nodetabletestorset_243698)(Tnodetable191873* t, Tnode191813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq191871*) newSeq((&NTI191871), ((NI)chckRange((NI)(TMP4170), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_243839;
				NI HEX3Atmp_243876;
				NI res_243879;
