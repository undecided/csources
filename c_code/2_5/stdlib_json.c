...
static NIM_CONST TY77859 TMP4907 = {
...
N_NIMCALL(NimStringDesc*, errormsg_289647)(Jsonparser289013* my) {
	...
	nimln(188, "json.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4863));
	}
	LA3: ;
	nimln(189, "json.nim");
...
{	result = 0;
	...
	nimln(778, "json.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4943));
	}
	LA7: ;
	nimln(779, "json.nim");
...
N_NIMCALL(void, add_293418)(Jsonnodeobj290726* obj, NimStringDesc* key, Jsonnodeobj290726* val) {
	...
	nimln(799, "json.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4946));
	}
	LA3: ;
	nimln(800, "json.nim");
