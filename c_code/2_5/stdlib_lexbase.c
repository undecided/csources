...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4231, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP4234, "0 <= toCopy ", 12);
STRING_LITERAL(TMP4243, "s < L.bufLen ", 13);
STRING_LITERAL(TMP4248, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP4254, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP4256, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP4258, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP4262, "0 < bufLen ", 11);
STRING_LITERAL(TMP4263, "not (input == nil) ", 19);
STRING_LITERAL(TMP4267, "", 0);
STRING_LITERAL(TMP4269, "\012", 1);
STRING_LITERAL(TMP4270, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_247102)(Baselexer247024* L) {
	...
	TMP4232 = subInt((*L).buflen, (*L).sentinel);
	TMP4233 = subInt((NI)(TMP4232), ((NI) 1));
	tocopy = (NI)(TMP4233);
	...
	nimln(82, "lexbase.nim");
	{
		...
		TMP4236 = mulInt(tocopy, ((NI) 1));
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4235)]))), ((NI)chckRange((NI)(TMP4236), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
	...
	nimln(85, "lexbase.nim");
	nimln(86, "lexbase.nim");
	TMP4237 = addInt((*L).sentinel, ((NI) 1));
	TMP4238 = mulInt((NI)(TMP4237), ((NI) 1));
	LOC13 = 0;
	LOC13 = readdata_138174((*L).input, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP4238));
	TMP4239 = divInt(LOC13, ((NI) 1));
	charsread = (NI)(TMP4239);
	nimln(87, "lexbase.nim");
	TMP4240 = addInt(tocopy, charsread);
	s = (NI)(TMP4240);
	nimln(88, "lexbase.nim");
	{
		NI TMP4241;
		TMP4241 = addInt((*L).sentinel, ((NI) 1));
		if (!(charsread < (NI)(TMP4241))) goto LA16;
		...
		s = (NI)(TMP4242);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					TMP4245 = mulInt((*L).buflen, ((NI) 2));
					(*L).buflen = (NI)(TMP4245);
					nimln(106, "lexbase.nim");
					TMP4246 = mulInt((*L).buflen, ((NI) 1));
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4246), ((NI) 0), ((NI) 2147483647))));
					(*L).buf = ((NCSTRING) (LOC34));
					nimln(107, "lexbase.nim");
					{
						NI TMP4247;
						TMP4247 = subInt((*L).buflen, oldbuflen);
						if (!!(((NI)(TMP4247) == oldbuflen))) goto LA37;
					...
					nimln(108, "lexbase.nim");
					nimln(109, "lexbase.nim");
					TMP4249 = mulInt(oldbuflen, ((NI) 1));
					LOC39 = 0;
					LOC39 = readdata_138174((*L).input, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP4249));
					TMP4250 = divInt(LOC39, ((NI) 1));
					charsread = (NI)(TMP4250);
					nimln(110, "lexbase.nim");
					{
						...
						TMP4252 = addInt(oldbuflen, charsread);
...
N_NIMCALL(NI, fillbaselexer_247827)(Baselexer247024* L, NI pos) {
	...
	nimln(117, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4254));
	}
	LA3: ;
...
N_NIMCALL(NI, handlelf_247079)(Baselexer247024* L, NI pos) {
	...
	nimln(134, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4258));
	}
	LA3: ;
	nimln(135, "lexbase.nim");
	TMP4259 = addInt((*L).linenumber, ((NI) 1));
	(*L).linenumber = (NI)(TMP4259);
...
N_NIMCALL(void, skiputf8bom_248416)(Baselexer247024* L) {
	...
	nimln(139, "lexbase.nim");
	{
		...
		TMP4260 = addInt((*L).bufpos, ((NI) 3));
		(*L).bufpos = (NI)(TMP4260);
		nimln(141, "lexbase.nim");
		TMP4261 = addInt((*L).linestart, ((NI) 3));
		(*L).linestart = (NI)(TMP4261);
	}
	LA7: ;
	popFrame();
}
...
N_NIMCALL(void, open_247040)(Baselexer247024* L, Streamobj138027* input, NI buflen) {
	...
	nimln(145, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4263));
	}
	LA7: ;
	...
	TMP4264 = mulInt(buflen, ((NI) 1));
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4264), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC9));
	nimln(150, "lexbase.nim");
	TMP4265 = subInt(buflen, ((NI) 1));
	(*L).sentinel = (NI)(TMP4265);
...
N_NIMCALL(NI, getcolnumber_247064)(Baselexer247024* L, NI pos) {
	...
	TMP4266 = subInt(pos, (*L).linestart);
	if ((NI)(TMP4266) == (-2147483647 -1)) raiseOverflow();
	result = ((NI)(TMP4266) > 0? ((NI)(TMP4266)) : -((NI)(TMP4266)));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_247057)(Baselexer247024* L, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP4267));
	...
	i = (*L).linestart;
	{
		...
		while (1) {
			...
			TMP4268 = addInt(i, ((NI) 1));
			i = (NI)(TMP4268);
		} LA2: ;
	}
	nimln(166, "lexbase.nim");
	result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP4269));
...
static TNimNode* TMP4275[8];
static TNimNode TMP4229[9];
NTI247024.size = sizeof(Baselexer247024);
NTI247024.kind = 17;
NTI247024.base = (&NTI3411);
TMP4275[0] = &TMP4229[1];
TMP4229[1].kind = 1;
TMP4229[1].offset = offsetof(Baselexer247024, bufpos);
TMP4229[1].typ = (&NTI108);
TMP4229[1].name = "bufpos";
TMP4275[1] = &TMP4229[2];
TMP4229[2].kind = 1;
TMP4229[2].offset = offsetof(Baselexer247024, buf);
TMP4229[2].typ = (&NTI151);
TMP4229[2].name = "buf";
TMP4275[2] = &TMP4229[3];
TMP4229[3].kind = 1;
TMP4229[3].offset = offsetof(Baselexer247024, buflen);
TMP4229[3].typ = (&NTI108);
TMP4229[3].name = "bufLen";
TMP4275[3] = &TMP4229[4];
TMP4229[4].kind = 1;
TMP4229[4].offset = offsetof(Baselexer247024, input);
TMP4229[4].typ = (&NTI138025);
TMP4229[4].name = "input";
TMP4275[4] = &TMP4229[5];
TMP4229[5].kind = 1;
TMP4229[5].offset = offsetof(Baselexer247024, linenumber);
TMP4229[5].typ = (&NTI108);
TMP4229[5].name = "lineNumber";
TMP4275[5] = &TMP4229[6];
TMP4229[6].kind = 1;
TMP4229[6].offset = offsetof(Baselexer247024, sentinel);
TMP4229[6].typ = (&NTI108);
TMP4229[6].name = "sentinel";
TMP4275[6] = &TMP4229[7];
TMP4229[7].kind = 1;
TMP4229[7].offset = offsetof(Baselexer247024, linestart);
TMP4229[7].typ = (&NTI108);
TMP4229[7].name = "lineStart";
TMP4275[7] = &TMP4229[8];
TMP4229[8].kind = 1;
TMP4229[8].offset = offsetof(Baselexer247024, fileopened);
TMP4229[8].typ = (&NTI138);
TMP4229[8].name = "fileOpened";
TMP4229[0].len = 8; TMP4229[0].kind = 2; TMP4229[0].sons = &TMP4275[0];
NTI247024.node = &TMP4229[0];
}
