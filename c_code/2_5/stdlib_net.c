...
N_NIMCALL(Socketimpl514407*, newsocket_514708)(int fd, NIM_BOOL isbuff) {
	...
	nimln(123, "net.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP10649));
	}
	LA3: ;
	nimln(124, "net.nim");
...
N_NIMCALL(void, acceptaddr_515813)(Socketimpl514407* server, Socketimpl514407** client, NimStringDesc** address, NU8 flags) {
	...
	nimln(369, "net.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP10657));
	}
	LA3: ;
...
{	result = 0;
	...
	nimln(680, "net.nim");
	{
		if (!(size <= ((NI) 0))) goto LA3;
		{
			...
			failedassertimpl_87217(((NimStringDesc*) &TMP10658));
		}
		LA7: ;
	}
	LA3: ;
		...
		read = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(644, "net.nim");
				{
					...
					failedassertimpl_87217(((NimStringDesc*) &TMP10672));
				}
				LA39: ;
				nimln(645, "net.nim");
				if (!(((2 &(1<<(((*socket).isbuffered)&7)))!=0))) raiseFieldError(((NimStringDesc*) &TMP10668));
