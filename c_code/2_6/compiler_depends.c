...
STRING_LITERAL(TMP10595, "$1 -> $2;$n", 11);
static NIM_CONST TY192031 TMP10597 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP10598, "sons", 4);
STRING_LITERAL(TMP10602, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP10603, "", 0);
STRING_LITERAL(TMP10604, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_507028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_162635(&gdotgraph_507023, ((NimStringDesc*) &TMP10595), LOC1, 2);
	popFrame();
}
	...
	{
		{
			...
			TMP10596 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_507081 = (NI)(TMP10596);
			...
			res_507084 = ((NI) 0);
			{
				...
				while (1) {
					...
					if (((TMP10597[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10598));
					...
					TMP10599 = addInt(res_507084, ((NI) 1));
					res_507084 = (NI)(TMP10599);
				} LA5: ;
			}
		}
	}
	...
	{
		{
			...
			TMP10600 = subInt(LOC9, ((NI) 1));
			HEX3Atmp_507089 = (NI)(TMP10600);
			nimln(1598, "system.nim");
			res_507092 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP10601 = addInt(res_507092, ((NI) 1));
					res_507092 = (NI)(TMP10601);
				} LA11: ;
			}
		}
	}
...
N_NIMCALL(void, generatedot_507009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP10603));
	LOC1[0] = rope_161320(LOC3);
	LOC1[1] = gdotgraph_507023;
	LOC4 = 0;
	LOC4 = HEX25_162235(((NimStringDesc*) &TMP10602), LOC1, 2);
	nimln(47, "depends.nim");
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP10604));
...
static TNimNode TMP10593[1];
NTI507016.size = sizeof(Tgen507016);
NTI507016.kind = 17;
NTI507016.base = (&NTI242005);
TMP10593[0].kind = 1;
TMP10593[0].offset = offsetof(Tgen507016, module);
TMP10593[0].typ = (&NTI191811);
TMP10593[0].name = "module";
NTI507016.node = &TMP10593[0];
NTI507018.size = sizeof(Tgen507016*);
NTI507018.kind = 22;
NTI507018.base = (&NTI507016);
NTI507018.marker = TMP10605;
}
