...
STRING_LITERAL(TMP8098, "stdlib", 6);
STRING_LITERAL(TMP8099, "system", 6);
STRING_LITERAL(TMP8100, "locals", 6);
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit)(void) {
	...
	nimln(42, "locals.nim");
	registerplugin_407124(((NimStringDesc*) &TMP8098), ((NimStringDesc*) &TMP8099), ((NimStringDesc*) &TMP8100), semlocals_408020);
	popFrame();
}
