...
static N_INLINE(Ropeobj161009**, s_457184)(Tcproc457034* p, NU8 s) {
	...
	TMP8937 = subInt(((*p).blocks ? (*p).blocks->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP8937)) >= (NU)((*p).blocks->Sup.len)) raiseIndexError();
	result = &(*p).blocks->data[(NI)(TMP8937)].sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP8929[29];
static TNimNode* TMP8930[17];
static TNimNode* TMP8931[7];
static TNimNode TMP8927[56];
NTI457038.size = sizeof(Tcgen457038);
NTI457038.kind = 17;
NTI457038.base = (&NTI242005);
TMP8929[0] = &TMP8927[1];
TMP8927[1].kind = 1;
TMP8927[1].offset = offsetof(Tcgen457038, module);
TMP8927[1].typ = (&NTI191811);
TMP8927[1].name = "module";
TMP8929[1] = &TMP8927[2];
TMP8927[2].kind = 1;
TMP8927[2].offset = offsetof(Tcgen457038, filename);
TMP8927[2].typ = (&NTI149);
TMP8927[2].name = "filename";
TMP8929[2] = &TMP8927[3];
...
NTI457022.flags = 2;
TMP8927[3].kind = 1;
TMP8927[3].offset = offsetof(Tcgen457038, s);
TMP8927[3].typ = (&NTI457022);
TMP8927[3].name = "s";
TMP8929[3] = &TMP8927[4];
TMP8927[4].kind = 1;
TMP8927[4].offset = offsetof(Tcgen457038, preventstacktrace);
TMP8927[4].typ = (&NTI138);
TMP8927[4].name = "preventStackTrace";
TMP8929[4] = &TMP8927[5];
TMP8927[5].kind = 1;
TMP8927[5].offset = offsetof(Tcgen457038, usesthreadvars);
TMP8927[5].typ = (&NTI138);
TMP8927[5].name = "usesThreadVars";
TMP8929[5] = &TMP8927[6];
TMP8927[6].kind = 1;
TMP8927[6].offset = offsetof(Tcgen457038, framedeclared);
TMP8927[6].typ = (&NTI138);
TMP8927[6].name = "frameDeclared";
TMP8929[6] = &TMP8927[7];
TMP8927[7].kind = 1;
TMP8927[7].offset = offsetof(Tcgen457038, isheaderfile);
TMP8927[7].typ = (&NTI138);
TMP8927[7].name = "isHeaderFile";
TMP8929[7] = &TMP8927[8];
TMP8927[8].kind = 1;
TMP8927[8].offset = offsetof(Tcgen457038, includesstringh);
TMP8927[8].typ = (&NTI138);
TMP8927[8].name = "includesStringh";
TMP8929[8] = &TMP8927[9];
TMP8927[9].kind = 1;
TMP8927[9].offset = offsetof(Tcgen457038, objhaskidsvalid);
TMP8927[9].typ = (&NTI138);
TMP8927[9].name = "objHasKidsValid";
TMP8929[9] = &TMP8927[10];
TMP8927[10].kind = 1;
TMP8927[10].offset = offsetof(Tcgen457038, cfilename);
TMP8927[10].typ = (&NTI149);
TMP8927[10].name = "cfilename";
TMP8929[10] = &TMP8927[11];
TMP8927[11].kind = 1;
TMP8927[11].offset = offsetof(Tcgen457038, typecache);
TMP8927[11].typ = (&NTI191861);
TMP8927[11].name = "typeCache";
TMP8929[11] = &TMP8927[12];
TMP8927[12].kind = 1;
TMP8927[12].offset = offsetof(Tcgen457038, forwtypecache);
TMP8927[12].typ = (&NTI191861);
TMP8927[12].name = "forwTypeCache";
TMP8929[12] = &TMP8927[13];
TMP8927[13].kind = 1;
TMP8927[13].offset = offsetof(Tcgen457038, declaredthings);
TMP8927[13].typ = (&NTI188056);
TMP8927[13].name = "declaredThings";
TMP8929[13] = &TMP8927[14];
TMP8927[14].kind = 1;
TMP8927[14].offset = offsetof(Tcgen457038, declaredprotos);
TMP8927[14].typ = (&NTI188056);
TMP8927[14].name = "declaredProtos";
TMP8929[14] = &TMP8927[15];
TMP8927[15].kind = 1;
TMP8927[15].offset = offsetof(Tcgen457038, headerfiles);
TMP8927[15].typ = (&NTI130028);
TMP8927[15].name = "headerFiles";
TMP8929[15] = &TMP8927[16];
TMP8927[16].kind = 1;
TMP8927[16].offset = offsetof(Tcgen457038, typeinfomarker);
TMP8927[16].typ = (&NTI188056);
TMP8927[16].name = "typeInfoMarker";
TMP8929[16] = &TMP8927[17];
NTI457034.size = sizeof(Tcproc457034);
NTI457034.kind = 18;
NTI457034.base = 0;
TMP8930[0] = &TMP8927[19];
TMP8927[19].kind = 1;
TMP8927[19].offset = offsetof(Tcproc457034, prc);
TMP8927[19].typ = (&NTI191811);
TMP8927[19].name = "prc";
TMP8930[1] = &TMP8927[20];
TMP8927[20].kind = 1;
TMP8927[20].offset = offsetof(Tcproc457034, beforeretneeded);
TMP8927[20].typ = (&NTI138);
TMP8927[20].name = "beforeRetNeeded";
TMP8930[2] = &TMP8927[21];
TMP8927[21].kind = 1;
TMP8927[21].offset = offsetof(Tcproc457034, threadvaraccessed);
TMP8927[21].typ = (&NTI138);
TMP8927[21].name = "threadVarAccessed";
TMP8930[3] = &TMP8927[22];
TMP8927[22].kind = 1;
TMP8927[22].offset = offsetof(Tcproc457034, lastlineinfo);
TMP8927[22].typ = (&NTI163338);
TMP8927[22].name = "lastLineInfo";
TMP8930[4] = &TMP8927[23];
TMP8927[23].kind = 1;
TMP8927[23].offset = offsetof(Tcproc457034, nestedtrystmts);
TMP8927[23].typ = (&NTI191807);
TMP8927[23].name = "nestedTryStmts";
TMP8930[5] = &TMP8927[24];
TMP8927[24].kind = 1;
TMP8927[24].offset = offsetof(Tcproc457034, inexceptblock);
TMP8927[24].typ = (&NTI108);
TMP8927[24].name = "inExceptBlock";
TMP8930[6] = &TMP8927[25];
TMP8927[25].kind = 1;
TMP8927[25].offset = offsetof(Tcproc457034, finallysafepoints);
TMP8927[25].typ = (&NTI161599);
TMP8927[25].name = "finallySafePoints";
TMP8930[7] = &TMP8927[26];
TMP8927[26].kind = 1;
TMP8927[26].offset = offsetof(Tcproc457034, labels);
TMP8927[26].typ = (&NTI3407);
TMP8927[26].name = "labels";
TMP8930[8] = &TMP8927[27];
NTI457032.size = sizeof(Tblock457032);
NTI457032.kind = 18;
NTI457032.base = 0;
NTI457032.flags = 2;
TMP8931[0] = &TMP8927[29];
TMP8927[29].kind = 1;
TMP8927[29].offset = offsetof(Tblock457032, id);
TMP8927[29].typ = (&NTI108);
TMP8927[29].name = "id";
TMP8931[1] = &TMP8927[30];
TMP8927[30].kind = 1;
TMP8927[30].offset = offsetof(Tblock457032, label);
TMP8927[30].typ = (&NTI161007);
TMP8927[30].name = "label";
TMP8931[2] = &TMP8927[31];
NTI457026.size = sizeof(Tcprocsections457026);
NTI457026.kind = 16;
NTI457026.base = (&NTI161007);
NTI457026.flags = 2;
TMP8927[31].kind = 1;
TMP8927[31].offset = offsetof(Tblock457032, sections);
TMP8927[31].typ = (&NTI457026);
TMP8927[31].name = "sections";
TMP8931[3] = &TMP8927[32];
TMP8927[32].kind = 1;
TMP8927[32].offset = offsetof(Tblock457032, isloop);
TMP8927[32].typ = (&NTI138);
TMP8927[32].name = "isLoop";
TMP8931[4] = &TMP8927[33];
TMP8927[33].kind = 1;
TMP8927[33].offset = offsetof(Tblock457032, nestedtrystmts);
TMP8927[33].typ = (&NTI112);
TMP8927[33].name = "nestedTryStmts";
TMP8931[5] = &TMP8927[34];
TMP8927[34].kind = 1;
TMP8927[34].offset = offsetof(Tblock457032, nestedexceptstmts);
TMP8927[34].typ = (&NTI112);
TMP8927[34].name = "nestedExceptStmts";
TMP8931[6] = &TMP8927[35];
TMP8927[35].kind = 1;
TMP8927[35].offset = offsetof(Tblock457032, framelen);
TMP8927[35].typ = (&NTI112);
TMP8927[35].name = "frameLen";
TMP8927[28].len = 7; TMP8927[28].kind = 2; TMP8927[28].sons = &TMP8931[0];
NTI457032.node = &TMP8927[28];
NTI457106.size = sizeof(TY457106*);
NTI457106.kind = 24;
NTI457106.base = (&NTI457032);
NTI457106.flags = 2;
NTI457106.marker = TMP8932;
TMP8927[27].kind = 1;
TMP8927[27].offset = offsetof(Tcproc457034, blocks);
TMP8927[27].typ = (&NTI457106);
TMP8927[27].name = "blocks";
TMP8930[9] = &TMP8927[36];
TMP8927[36].kind = 1;
TMP8927[36].offset = offsetof(Tcproc457034, breakidx);
TMP8927[36].typ = (&NTI108);
TMP8927[36].name = "breakIdx";
TMP8930[10] = &TMP8927[37];
TMP8927[37].kind = 1;
TMP8927[37].offset = offsetof(Tcproc457034, options);
TMP8927[37].typ = (&NTI154121);
TMP8927[37].name = "options";
TMP8930[11] = &TMP8927[38];
TMP8927[38].kind = 1;
TMP8927[38].offset = offsetof(Tcproc457034, maxframelen);
TMP8927[38].typ = (&NTI108);
TMP8927[38].name = "maxFrameLen";
TMP8930[12] = &TMP8927[39];
TMP8927[39].kind = 1;
TMP8927[39].offset = offsetof(Tcproc457034, module);
TMP8927[39].typ = (&NTI457028);
TMP8927[39].name = "module";
TMP8930[13] = &TMP8927[40];
TMP8927[40].kind = 1;
TMP8927[40].offset = offsetof(Tcproc457034, withinloop);
TMP8927[40].typ = (&NTI108);
TMP8927[40].name = "withinLoop";
TMP8930[14] = &TMP8927[41];
TMP8927[41].kind = 1;
TMP8927[41].offset = offsetof(Tcproc457034, splitdecls);
TMP8927[41].typ = (&NTI108);
TMP8927[41].name = "splitDecls";
TMP8930[15] = &TMP8927[42];
TMP8927[42].kind = 1;
TMP8927[42].offset = offsetof(Tcproc457034, gcframeid);
TMP8927[42].typ = (&NTI3407);
TMP8927[42].name = "gcFrameId";
TMP8930[16] = &TMP8927[43];
TMP8927[43].kind = 1;
TMP8927[43].offset = offsetof(Tcproc457034, gcframetype);
TMP8927[43].typ = (&NTI161007);
TMP8927[43].name = "gcFrameType";
TMP8927[18].len = 17; TMP8927[18].kind = 2; TMP8927[18].sons = &TMP8930[0];
NTI457034.node = &TMP8927[18];
NTI457030.size = sizeof(Tcproc457034*);
NTI457030.kind = 22;
NTI457030.base = (&NTI457034);
NTI457030.marker = TMP8933;
TMP8927[17].kind = 1;
TMP8927[17].offset = offsetof(Tcgen457038, initproc);
TMP8927[17].typ = (&NTI457030);
TMP8927[17].name = "initProc";
TMP8929[17] = &TMP8927[44];
TMP8927[44].kind = 1;
TMP8927[44].offset = offsetof(Tcgen457038, postinitproc);
TMP8927[44].typ = (&NTI457030);
TMP8927[44].name = "postInitProc";
TMP8929[18] = &TMP8927[45];
TMP8927[45].kind = 1;
TMP8927[45].offset = offsetof(Tcgen457038, preinitproc);
TMP8927[45].typ = (&NTI457030);
TMP8927[45].name = "preInitProc";
TMP8929[19] = &TMP8927[46];
TMP8927[46].kind = 1;
TMP8927[46].offset = offsetof(Tcgen457038, typestack);
TMP8927[46].typ = (&NTI191845);
TMP8927[46].name = "typeStack";
TMP8929[20] = &TMP8927[47];
TMP8927[47].kind = 1;
TMP8927[47].offset = offsetof(Tcgen457038, datacache);
TMP8927[47].typ = (&NTI191873);
TMP8927[47].name = "dataCache";
TMP8929[21] = &TMP8927[48];
TMP8927[48].kind = 1;
TMP8927[48].offset = offsetof(Tcgen457038, forwardedprocs);
TMP8927[48].typ = (&NTI191815);
TMP8927[48].name = "forwardedProcs";
TMP8929[22] = &TMP8927[49];
TMP8927[49].kind = 1;
TMP8927[49].offset = offsetof(Tcgen457038, typenodes);
TMP8927[49].typ = (&NTI108);
TMP8927[49].name = "typeNodes";
TMP8929[23] = &TMP8927[50];
TMP8927[50].kind = 1;
TMP8927[50].offset = offsetof(Tcgen457038, nimtypes);
TMP8927[50].typ = (&NTI108);
TMP8927[50].name = "nimTypes";
TMP8929[24] = &TMP8927[51];
TMP8927[51].kind = 1;
TMP8927[51].offset = offsetof(Tcgen457038, typenodesname);
TMP8927[51].typ = (&NTI161007);
TMP8927[51].name = "typeNodesName";
TMP8929[25] = &TMP8927[52];
TMP8927[52].kind = 1;
TMP8927[52].offset = offsetof(Tcgen457038, nimtypesname);
TMP8927[52].typ = (&NTI161007);
TMP8927[52].name = "nimTypesName";
TMP8929[26] = &TMP8927[53];
TMP8927[53].kind = 1;
TMP8927[53].offset = offsetof(Tcgen457038, labels);
TMP8927[53].typ = (&NTI3407);
TMP8927[53].name = "labels";
TMP8929[27] = &TMP8927[54];
NTI457143.size = sizeof(TY457143);
NTI457143.kind = 16;
NTI457143.base = (&NTI161007);
NTI457143.flags = 2;
TMP8927[54].kind = 1;
TMP8927[54].offset = offsetof(Tcgen457038, extensionloaders);
TMP8927[54].typ = (&NTI457143);
TMP8927[54].name = "extensionLoaders";
TMP8929[28] = &TMP8927[55];
TMP8927[55].kind = 1;
TMP8927[55].offset = offsetof(Tcgen457038, injectstmt);
TMP8927[55].typ = (&NTI161007);
TMP8927[55].name = "injectStmt";
TMP8927[0].len = 29; TMP8927[0].kind = 2; TMP8927[0].sons = &TMP8929[0];
NTI457038.node = &TMP8927[0];
NTI457028.size = sizeof(Tcgen457038*);
NTI457028.kind = 22;
NTI457028.base = (&NTI457038);
NTI457028.marker = TMP8935;
NTI457155.size = sizeof(TY457155*);
NTI457155.kind = 24;
NTI457155.base = (&NTI457028);
NTI457155.marker = TMP8936;
}
