...
N_NIMCALL(struct timeval, timevalfrommilliseconds_512628)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		result.tv_usec = ((NI) (((NI32) ((NI)(TMP10623)))));
	}
	LA3: ;
	popFrame();
	return result;
...
N_NIMCALL(NI, select_512913)(TY512649** readfds, NI timeout) {
	...
	nimln(405, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int) ((NI)(TMP10629))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int) ((NI)(TMP10630))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_512972)(TY512649** writefds, NI timeout) {
	...
	nimln(427, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int) ((NI)(TMP10631))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int) ((NI)(TMP10632))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
