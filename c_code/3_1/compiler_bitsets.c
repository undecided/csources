...
N_NIMCALL(NIM_BOOL, bitsetin_239077)(Tbitset239012* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP4057)] & ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4058)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_239061)(Tbitset239012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4060)] = (NI8)((*x)->data[(NI64)(TMP4061)] | ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4062))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_239069)(Tbitset239012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4063)] = (NI8)((*x)->data[(NI64)(TMP4064)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4065))))))))));
	popFrame();
}
	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_239265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4067 = addInt(res_239265, ((NI) 1));
				res_239265 = (NI)(TMP4067);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_239306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4068 = addInt(res_239306, ((NI) 1));
				res_239306 = (NI)(TMP4068);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_239347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4069 = addInt(res_239347, ((NI) 1));
				res_239347 = (NI)(TMP4069);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_239388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4070 = addInt(res_239388, ((NI) 1));
				res_239388 = (NI)(TMP4070);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_239429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4071 = addInt(res_239429, ((NI) 1));
				res_239429 = (NI)(TMP4071);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_239470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4072 = addInt(res_239470, ((NI) 1));
				res_239470 = (NI)(TMP4072);
			} LA3: ;
		}
	}
