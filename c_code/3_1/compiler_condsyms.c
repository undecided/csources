...
N_NIMCALL(void, definesymbol_168013)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_168004, symbol, ((NimStringDesc*) &TMP1308));
	popFrame();
}
...
N_NIMCALL(void, undefsymbol_168022)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_168004, symbol, ((NimStringDesc*) &TMP1309));
	popFrame();
}
			...
			res_168233 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(44, "strtabs.nim");
					{
						...
						{
							NI TMP1334;
							if (!!(eqStrings(val_168215, ((NimStringDesc*) &TMP1309)))) goto LA11;
					...
					TMP1335 = addInt(res_168233, ((NI) 1));
					res_168233 = (NI)(TMP1335);
				} LA4: ;
			}
		}
	}
...
N_NIMCALL(void, initdefines_168254)(void) {
	...
	definesymbol_168013(((NimStringDesc*) &TMP1336));
	nimln(78, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1337));
	nimln(79, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1338));
	nimln(80, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1339));
	nimln(81, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1340));
	nimln(82, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1341));
	nimln(83, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1342));
	nimln(84, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1343));
	nimln(85, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1344));
	nimln(86, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1345));
	nimln(87, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1346));
	nimln(88, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1347));
	nimln(89, "condsyms.nim");
	definesymbol_168013(((NimStringDesc*) &TMP1348));
