...
N_NIMCALL(NI32, strcrc32_168045)(NimStringDesc* s) {
	...
	result = ((NI32) -1);
	{
		...
		res_168521 = ((NI) 0);
		{
			...
			while (1) {
				NI TMP1356;
				if (!(res_168521 <= HEX3Atmp_168518)) goto LA3;
				nimln(1600, "system.nim");
				i_168516 = res_168521;
				nimln(86, "crc.nim");
				if ((NU)(i_168516) > (NU)(s->Sup.len)) raiseIndexError();
				result = updatecrc32_168031(s->data[i_168516], result);
				nimln(1614, "system.nim");
				TMP1356 = addInt(res_168521, ((NI) 1));
				res_168521 = (NI)(TMP1356);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = c;
	{
		...
		res_168560 = ((NI) 0);
		{
			...
			while (1) {
				...
				i_168555 = res_168560;
				nimln(90, "crc.nim");
				if ((NU)(i_168555) > (NU)(s->Sup.len)) raiseIndexError();
				result = updatecrc32_168031(s->data[i_168555], result);
				nimln(1619, "system.nim");
				TMP1358 = addInt(res_168560, ((NI) 1));
				res_168560 = (NI)(TMP1358);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(NI32, crcfrombuf_168038)(void* buf, NI length) {
	...
	result = ((NI32) -1);
	{
		...
		res_168612 = ((NI) 0);
		{
			...
			while (1) {
				NI TMP1360;
				if (!(res_168612 <= HEX3Atmp_168609)) goto LA3;
				nimln(1600, "system.nim");
				i_168606 = res_168612;
				nimln(99, "crc.nim");
				if ((NU)(i_168606) > (NU)(10000000)) raiseIndexError();
				result = updatecrc32_168024(p[(i_168606)- 0], result);
				nimln(1614, "system.nim");
				TMP1360 = addInt(res_168612, ((NI) 1));
				res_168612 = (NI)(TMP1360);
			} LA3: ;
		}
	}
	popFrame();
			...
			readbytes = readbuffer_13715(bin, buf, ((NI) 8000));
			{
				...
				res_168662 = ((NI) 0);
				{
					...
					while (1) {
						...
						i_168654 = res_168662;
						nimln(113, "crc.nim");
						if ((NU)(i_168654) > (NU)(10000000)) raiseIndexError();
						result = updatecrc32_168024(p[(i_168654)- 0], result);
						nimln(1614, "system.nim");
						TMP1362 = addInt(res_168662, ((NI) 1));
						res_168662 = (NI)(TMP1362);
					} LA10: ;
				}
			}
			nimln(114, "crc.nim");
