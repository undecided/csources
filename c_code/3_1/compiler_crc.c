	...
	result = ((NI32) -1);
	{
		...
		res_168521 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1355 = addInt(res_168521, ((NI) 1));
				res_168521 = (NI)(TMP1355);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = c;
	{
		...
		res_168560 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1357 = addInt(res_168560, ((NI) 1));
				res_168560 = (NI)(TMP1357);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = ((NI32) -1);
	{
		...
		res_168612 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP1359 = addInt(res_168612, ((NI) 1));
				res_168612 = (NI)(TMP1359);
			} LA3: ;
		}
	}
	popFrame();
			...
			readbytes = readbuffer_13715(bin, buf, ((NI) 8000));
			{
				...
				res_168662 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1614, "system.nim");
						TMP1361 = addInt(res_168662, ((NI) 1));
						res_168662 = (NI)(TMP1361);
					} LA10: ;
				}
			}
			nimln(114, "crc.nim");
