	...
	result = ((NI32) -1);
	{
		...
		res_169521 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1355 = addInt(res_169521, ((NI) 1));
				res_169521 = (NI)(TMP1355);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = c;
	{
		...
		res_169560 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1357 = addInt(res_169560, ((NI) 1));
				res_169560 = (NI)(TMP1357);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = ((NI32) -1);
	{
		...
		res_169612 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP1359 = addInt(res_169612, ((NI) 1));
				res_169612 = (NI)(TMP1359);
			} LA3: ;
		}
	}
	popFrame();
			...
			readbytes = readbuffer_13715(bin, buf, ((NI) 8000));
			{
				...
				res_169662 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1614, "system.nim");
						TMP1361 = addInt(res_169662, ((NI) 1));
						res_169662 = (NI)(TMP1361);
					} LA10: ;
				}
			}
			nimln(114, "crc.nim");
