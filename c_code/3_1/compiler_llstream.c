...
N_NIMCALL(NI, llstreamread_177584)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(124, "llstream.nim");
		{
			...
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2098)]))), ((NI)chckRange(result, ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, llstreamwrite_177718)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2106), ((NI) 0), ((NI) 2147483647))));
			nimln(189, "llstream.nim");
			TMP2107 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2107)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2107)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) 2147483647))));
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2109), ((NI) 0), ((NI) 2147483647))));
