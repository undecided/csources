...
static NIM_CONST TY191031 TMP4050 = {
...
N_NIMCALL(Tsym190843*, getsyssym_238054)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_238019).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4024));
	LOC1 = 0;
...
{	result = 0;
	...
	nimln(66, "magicsys.nim");
	{
		...
		case ((NU8) 31):
		{
			...
			result = systypefromname_238213(((NimStringDesc*) &TMP4025));
		}
		break;
		case ((NU8) 32):
		{
			nimln(69, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4026));
		}
		break;
		case ((NU8) 33):
		{
			nimln(70, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4027));
		}
		break;
		case ((NU8) 34):
		{
			nimln(71, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4028));
		}
		break;
		case ((NU8) 35):
		{
			nimln(72, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4029));
		}
		break;
		case ((NU8) 40):
		{
			nimln(73, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4030));
		}
		break;
		case ((NU8) 41):
		{
			nimln(74, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4031));
		}
		break;
		case ((NU8) 42):
		{
	...
	initstrtable_194007((&compilerprocs_238064));
	{
		...
		res_238627 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4048 = addInt(res_238627, ((NI) 1));
				res_238627 = (NI)(TMP4048);
			} LA3: ;
		}
	}
	{
		...
		res_238633 = ((NI) -5);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP4049 = addInt(res_238633, ((NI) 1));
				res_238633 = (NI)(TMP4049);
			} LA6: ;
		}
	}
	popFrame();
...
N_NIMCALL(Ttype190849*, getintlittype_238660)(Tnode190813* literal) {
	...
	nimln(109, "magicsys.nim");
	{
		...
		result = inttypecache_238297[(((NI)chckRange64(value, ((NI) (-2147483647 -1)), ((NI) 2147483647))))- -5];
		nimln(111, "magicsys.nim");
		{
			...
			if (((NI)chckRange64(value, ((NI) (-2147483647 -1)), ((NI) 2147483647))) < -5 || ((NI)chckRange64(value, ((NI) (-2147483647 -1)), ((NI) 2147483647))) > 64) raiseIndexError();
			asgnRefNoCycle((void**) (&inttypecache_238297[(((NI)chckRange64(value, ((NI) (-2147483647 -1)), ((NI) 2147483647))))- -5]), result);
		}
		LA9: ;
	}
	goto LA1;
...
N_NIMCALL(void, setintlittype_238774)(Tnode190813* result) {
	...
	default:
	{
		...
		internalerror_164199((*result).info, ((NimStringDesc*) &TMP4052));
	}
	break;
	}
	popFrame();
