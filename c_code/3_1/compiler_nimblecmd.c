...
N_NIMCALL(NI, versionsplitpos_172023)(NimStringDesc* s) {
	...
	TMP1796 = subInt((s ? s->Sup.len : 0), ((NI) 2));
	result = (NI)(TMP1796);
	{
...
N_NIMCALL(void, addpackage_172126)(Stringtableobj134012* packages, NimStringDesc* p) {
	...
	TMP1803 = subInt(x, ((NI) 1));
	name = copyStrLast(p, ((NI) 0), (NI)(TMP1803));
	nimln(49, "nimblecmd.nim");
	{
		...
		TMP1804 = addInt(x, ((NI) 1));
		version = copyStr(p, (NI)(TMP1804));
				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							if (!(LOC15)) goto LA16;
							LOC15 = !(eqStrings(y_172213, ((NimStringDesc*) &TMP1806)));
							LA16: ;
							if (!LOC15) goto LA17;
							...
							nimln(1305, "os.nim");
							{
								...
								nimln(1307, "os.nim");
								{
									...
									TMP1807 = addInt(k_172217, ((NI) 1));
									if (TMP1807 < 0 || TMP1807 > 3) raiseOverflow();
									k_172217 = (NU8)(TMP1807);
								}
								LA29: ;
								nimln(1302, "os.nim");
								...
								nimln(69, "nimblecmd.nim");
								{
									...
									if (!(LOC33)) goto LA34;
									LOC33 = nsuEndsWith(path_172195, ((NimStringDesc*) &TMP1812));
									LA34: ;
									if (!LOC33) goto LA35;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC49) goto LA50;
								TMP1813 = addInt(k_172217, ((NI) 1));
								if (TMP1813 < 0 || TMP1813 > 3) raiseOverflow();
								k_172217 = (NU8)(TMP1813);
							}
							LA50: ;
							nimln(1302, "os.nim");
							kind_172194 = k_172217;
							...
							nimln(69, "nimblecmd.nim");
							{
								...
								if (!(LOC54)) goto LA55;
								LOC54 = nsuEndsWith(path_172195, ((NimStringDesc*) &TMP1812));
								LA55: ;
								if (!LOC54) goto LA56;
								nimln(70, "nimblecmd.nim");
								result = NIM_TRUE;
					...
					while (1) {
						{
							...
							nimln(1299, "os.nim");
							{
								...
								if (!(LOC21)) goto LA22;
								LOC21 = !(eqStrings(y_172228, ((NimStringDesc*) &TMP1806)));
								LA22: ;
								if (!LOC21) goto LA23;
								...
								nimln(1313, "os.nim");
								{
									...
									if (!LOC54) goto LA55;
									TMP1815 = addInt(k_172232, ((NI) 1));
									if (TMP1815 < 0 || TMP1815 > 3) raiseOverflow();
									k_172232 = (NU8)(TMP1815);
								}
								LA55: ;
								nimln(1302, "os.nim");
								kind_172218 = k_172232;
...
N_NIMCALL(void, addpathrec_172266)(NimStringDesc* dir, Tlineinfo162338 info) {
	...
	TMP1816 = subInt((dir ? dir->Sup.len : 0), ((NI) 1));
	pos = (NI)(TMP1816);
				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							if (!(LOC19)) goto LA20;
							LOC19 = !(eqStrings(y_172312, ((NimStringDesc*) &TMP1806)));
							LA20: ;
							if (!LOC19) goto LA21;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC53) goto LA54;
								TMP1819 = addInt(k_172316, ((NI) 1));
								if (TMP1819 < 0 || TMP1819 > 3) raiseOverflow();
								k_172316 = (NU8)(TMP1819);
							}
							LA54: ;
							nimln(1302, "os.nim");
							k_172292 = k_172316;
				...
				res_172330 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(44, "strtabs.nim");
						{
							...
							{
								if (!eqStrings(val_172324, ((NimStringDesc*) &TMP1798))) goto LA74;
...
appendString(LOC77, val_172324);
						...
						TMP1820 = addInt(res_172330, ((NI) 1));
						res_172330 = (NI)(TMP1820);
					} LA67: ;
				}
			}
		}
