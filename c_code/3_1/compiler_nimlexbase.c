...
N_NIMCALL(void, fillbuffer_178097)(Tbaselexer178024* L) {
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP2116)]))), ((NI)chckRange((NI)(TMP2117), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
		...
		s = (NI)(TMP2123);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP2127), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, openbaselexer_178035)(Tbaselexer178024* L, Tllstream177204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_6001(((NI)chckRange((NI)(TMP2144), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC5));
...
N_NIMCALL(NI, getcolnumber_178059)(Tbaselexer178024* L, NI pos) {
	...
	if ((NI)(TMP2146) == (-2147483647 -1)) raiseOverflow();
