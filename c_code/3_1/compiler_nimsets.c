...
STRING_LITERAL(TMP4073, "inSet", 5);
static NIM_CONST TY192031 TMP4075 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4076, "sons", 4);
STRING_LITERAL(TMP4078, "SomeInSet", 9);
STRING_LITERAL(TMP4101, "SetHasRange", 11);
...
{	result = 0;
	nimln(34, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4073));
	...
	LA3: ;
	{
		...
		TMP4074 = subInt(LOC6, ((NI) 1));
		HEX3Atmp_241138 = (NI)(TMP4074);
		...
		res_241141 = ((NI) 0);
		{
			...
			while (1) {
				...
				{
					if (((TMP4075[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
					...
					nimln(39, "nimsets.nim");
					{
						...
						if (((TMP4075[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
						if ((NU)(i_241121) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4075[(*(*s).kindU.S6.sons->data[i_241121]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241121]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
				...
				TMP4077 = addInt(res_241141, ((NI) 1));
				res_241141 = (NI)(TMP4077);
			} LA8: ;
		}
	}
...
N_NIMCALL(NIM_BOOL, overlap_241012)(Tnode191813* a, Tnode191813* b) {
	...
	nimln(48, "nimsets.nim");
	{
		...
		nimln(49, "nimsets.nim");
		{
			...
			LOC9 = 0;
			if (((TMP4075[(*a).kind/8] &(1<<((*a).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
			if ((NU)(((NI) 0)) >= (NU)((*a).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (((TMP4075[(*b).kind/8] &(1<<((*b).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
			...
			while (1) {
				...
				nimln(67, "nimsets.nim");
				{
					...
					nimln(68, "nimsets.nim");
					{
						...
						if (((TMP4075[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
						if ((NU)(i_241233) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4075[(*(*s).kindU.S6.sons->data[i_241233]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241233]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
				...
				LA9: ;
				nimln(1614, "system.nim");
				TMP4080 = addInt(res_241258, ((NI) 1));
				res_241258 = (NI)(TMP4080);
			} LA8: ;
		}
	}
...
N_NIMCALL(void, tobitset_241004)(Tnode191813* s, Tbitset240012** b) {
	...
	bitsetinit_240021(b, ((NI)chckRange64(LOC1, ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	{
		...
		TMP4081 = subInt(LOC3, ((NI) 1));
		HEX3Atmp_241325 = (NI)(TMP4081);
		nimln(1598, "system.nim");
		res_241328 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(82, "nimsets.nim");
				{
					...
					if (((TMP4075[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
					if ((NU)(i_241296) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4075[(*(*s).kindU.S6.sons->data[i_241296]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241296]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
					...
					j = getordvalue_221178((*(*s).kindU.S6.sons->data[i_241296]).kindU.S6.sons->data[((NI) 0)]);
					{
						...
						while (1) {
							...
							TMP4082 = subInt64(j, first);
							bitsetincl_240061(b, (NI64)(TMP4082));
							nimln(86, "nimsets.nim");
							TMP4083 = addInt64(j, ((NI) 1));
							j = (NI64)(TMP4083);
						} LA11: ;
					}
				}
				...
				LA8: ;
				{
					...
					TMP4084 = subInt64(LOC14, first);
					bitsetincl_240061(b, (NI64)(TMP4084));
				}
				LA6: ;
				nimln(1614, "system.nim");
				TMP4085 = addInt(res_241328, ((NI) 1));
				res_241328 = (NI)(TMP4085);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, totreeset_241353)(Tbitset240012* s, Ttype191849* settype, Tlineinfo163338 info) {
	...
	e = IL64(0);
	{
		...
		while (1) {
			NI TMP4086;
			NI64 TMP4093;
			TMP4086 = mulInt((s ? s->Sup.len : 0), ((NI) 8));
			if (!(e < ((NI64) ((NI)(TMP4086))))) goto LA2;
			nimln(102, "nimsets.nim");
			{
				...
				b = e;
				{
					...
					while (1) {
						...
						nimln(107, "nimsets.nim");
						{
							...
							NIM_BOOL LOC14;
							LOC12 = 0;
							TMP4088 = mulInt((s ? s->Sup.len : 0), ((NI) 8));
							LOC12 = (((NI64) ((NI)(TMP4088))) <= b);
							if (LOC12) goto LA13;
							LOC14 = 0;
				...
				nimln(109, "nimsets.nim");
				{
					...
					TMP4090 = addInt64(a, first);
					LOC21 = 0;
					LOC21 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4090), elemtype);
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4091), elemtype);
					addson_193819(n, LOC23);
					nimln(115, "nimsets.nim");
					TMP4092 = addInt64(b, first);
					LOC24 = 0;
					LOC24 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4092), elemtype);
	...
	tobitset_241004(a, (&x));
	{
		...
		res_241573 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4094 = addInt(res_241573, ((NI) 1));
				res_241573 = (NI)(TMP4094);
			} LA3: ;
		}
	}
...
N_NIMCALL(NI64, cardset_241089)(Tnode191813* s) {
	...
	result = IL64(0);
	{
		...
		TMP4095 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_241633 = (NI)(TMP4095);
		nimln(1598, "system.nim");
		res_241636 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(155, "nimsets.nim");
				{
					...
					if (((TMP4075[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
					if ((NU)(i_241608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4075[(*(*s).kindU.S6.sons->data[i_241608]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241608]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
					...
					TMP4097 = subInt64((NI64)(TMP4096), LOC10);
					TMP4098 = addInt64((NI64)(TMP4097), IL64(1));
					result = (NI64)(TMP4098);
				}
				goto LA5;
				LA7: ;
				{
					...
					TMP4099 = addInt64(result, ((NI) 1));
					result = (NI64)(TMP4099);
				}
				LA5: ;
				nimln(1614, "system.nim");
				TMP4100 = addInt(res_241636, ((NI) 1));
				res_241636 = (NI)(TMP4100);
			} LA4: ;
		}
	}
	popFrame();
...
{	result = 0;
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4101));
	...
	LA3: ;
	{
		...
		LOC6 = 0;
		LOC6 = sonslen_194403(s);
		TMP4102 = subInt(LOC6, ((NI) 1));
		HEX3Atmp_241692 = (NI)(TMP4102);
		nimln(1598, "system.nim");
		res_241695 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA11: ;
				nimln(1614, "system.nim");
				TMP4103 = addInt(res_241695, ((NI) 1));
				res_241695 = (NI)(TMP4103);
			} LA8: ;
		}
	}
