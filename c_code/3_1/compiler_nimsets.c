	...
	bitsetinit_239021(b, ((NI)chckRange64(LOC1, ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	{
		...
		res_240328 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4085 = addInt(res_240328, ((NI) 1));
				res_240328 = (NI)(TMP4085);
			} LA5: ;
		}
	}
	popFrame();
		...
		while (1) {
			...
			nimln(102, "nimsets.nim");
			{
				...
				nimln(109, "nimsets.nim");
				{
					...
					LOC21 = 0;
					LOC21 = newinttypenode_191620(((NU8) 6), (NI64)(TMP4090), elemtype);
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = newinttypenode_191620(((NU8) 6), (NI64)(TMP4091), elemtype);
					addson_192819(n, LOC23);
					nimln(115, "nimsets.nim");
					TMP4092 = addInt64(b, first);
					LOC24 = 0;
					LOC24 = newinttypenode_191620(((NU8) 6), (NI64)(TMP4092), elemtype);
	...
	tobitset_240004(a, (&x));
	{
		...
		res_240573 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4094 = addInt(res_240573, ((NI) 1));
				res_240573 = (NI)(TMP4094);
			} LA3: ;
		}
	}
		...
		res_240636 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(155, "nimsets.nim");
				{
					...
					if (((TMP4075[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
					if ((NU)(i_240608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4075[(*(*s).kindU.S6.sons->data[i_240608]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_240608]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4076));
				...
				LA5: ;
				nimln(1614, "system.nim");
				TMP4100 = addInt(res_240636, ((NI) 1));
				res_240636 = (NI)(TMP4100);
			} LA4: ;
		}
	}
	popFrame();
	...
	LA3: ;
	{
		...
		res_240695 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA11: ;
				nimln(1614, "system.nim");
				TMP4103 = addInt(res_240695, ((NI) 1));
				res_240695 = (NI)(TMP4103);
			} LA8: ;
		}
	}
