...
N_NIMCALL(void, TMP8080)(void* p, NI op);
...
static TNimNode* TMP8079[5];
static TNimNode TMP8077[6];
NTI406019.size = sizeof(PluginHEX3Aobjecttype406019);
NTI406019.kind = 18;
NTI406019.base = 0;
TMP8079[0] = &TMP8077[1];
TMP8077[1].kind = 1;
TMP8077[1].offset = offsetof(PluginHEX3Aobjecttype406019, fn);
TMP8077[1].typ = (&NTI166019);
TMP8077[1].name = "fn";
TMP8079[1] = &TMP8077[2];
TMP8077[2].kind = 1;
TMP8077[2].offset = offsetof(PluginHEX3Aobjecttype406019, module);
TMP8077[2].typ = (&NTI166019);
TMP8077[2].name = "module";
TMP8079[2] = &TMP8077[3];
TMP8077[3].kind = 1;
TMP8077[3].offset = offsetof(PluginHEX3Aobjecttype406019, package);
TMP8077[3].typ = (&NTI166019);
TMP8077[3].name = "package";
TMP8079[3] = &TMP8077[4];
...
NTI406013.flags = 3;
TMP8077[4].kind = 1;
TMP8077[4].offset = offsetof(PluginHEX3Aobjecttype406019, t);
TMP8077[4].typ = (&NTI406013);
TMP8077[4].name = "t";
TMP8079[4] = &TMP8077[5];
TMP8077[5].kind = 1;
TMP8077[5].offset = offsetof(PluginHEX3Aobjecttype406019, next);
TMP8077[5].typ = (&NTI406015);
TMP8077[5].name = "next";
TMP8077[0].len = 5; TMP8077[0].kind = 2; TMP8077[0].sons = &TMP8079[0];
NTI406019.node = &TMP8077[0];
NTI406015.size = sizeof(PluginHEX3Aobjecttype406019*);
NTI406015.kind = 22;
NTI406015.base = (&NTI406019);
NTI406015.marker = TMP8080;
}
