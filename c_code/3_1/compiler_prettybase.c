...
STRING_LITERAL(TMP4261, ".nimfix", 7);
STRING_LITERAL(TMP4263, "\015\012", 2);
...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP4281, "discard ", 8);
STRING_LITERAL(TMP4283, "\"", 1);
...
N_NIMCALL(void, loadfile_248041)(Tlineinfo162338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		TMP4260 = addInt(i, ((NI32) 1));
		gsourcefiles_248036 = (TY248019*) setLengthSeq(&(gsourcefiles_248036)->Sup, sizeof(Tsourcefile248008), ((NI)chckRange((NI32)(TMP4260), ((NI) 0), ((NI) 2147483647))));
	}
	LA3: ;
	nimln(27, "prettybase.nim");
	{
		...
		gsourcefiles_248036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP4261));
		{
		...
		pos = lex.bufpos;
		{
			...
			while (1) {
				...
				case 13:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_248036->Sup.len)) raiseIndexError();
					LOC21 = 0;
					LOC21 = gsourcefiles_248036->data[i].newline; gsourcefiles_248036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4263));
				...
				case 0:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_248036->Sup.len)) raiseIndexError();
					LOC23 = 0;
					LOC23 = gsourcefiles_248036->data[i].newline; gsourcefiles_248036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4264));
...
N_NIMCALL(NI, identlen_248147)(NimStringDesc* line, NI start) {
	...
	result = 0;
	{
		...
		while (1) {
			...
			LOC3 = ((NI)(TMP4266) < (line ? line->Sup.len : 0));
			if (!(LOC3)) goto LA4;
			TMP4267 = addInt(start, result);
			if ((NU)((NI)(TMP4267)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC3 = (((NU8)(line->data[(NI)(TMP4267)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4267)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4267)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4267)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4267)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4267)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4267)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4267)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4267)])) == ((NU8)(95)));
			LA4: ;
			if (!LOC3) goto LA2;
			nimln(57, "prettybase.nim");
			TMP4268 = addInt(result, ((NI) 1));
			result = (NI)(TMP4268);
		} LA2: ;
	}
	popFrame();
...
{	nimln(64, "prettybase.nim");
	...
	if ((NU)((NI16)(TMP4269)) >= (NU)(gsourcefiles_248036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_248036->data[info.fileindex].lines->data[(NI16)(TMP4269)];
	...
	LA3: ;
	{
		...
		while (1) {
			...
			if ((NU)((NI)(TMP4270)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC7 = (((NU8)(line->data[(NI)(TMP4270)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4270)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4270)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4270)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4270)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4270)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4270)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4270)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4270)])) == ((NU8)(95)));
			LA8: ;
			if (!LOC7) goto LA6;
	...
	TMP4273 = addInt(first, LOC17);
	TMP4274 = subInt((NI)(TMP4273), ((NI) 1));
	last = (NI)(TMP4274);
	nimln(75, "prettybase.nim");
	{
		...
		LOC26 = 0;
		LOC26 = copyStrLast(line, ((NI) 0), (NI)(TMP4275));
		TMP4276 = addInt(last, ((NI) 1));
		LOC27 = 0;
		LOC27 = copyStr(line, (NI)(TMP4276));
...
appendString(LOC25, LOC27);
		...
		asgnRefNoCycle((void**) (&gsourcefiles_248036->data[info.fileindex].lines->data[(NI16)(TMP4277)]), x);
...
N_NIMCALL(void, replacecomment_248286)(Tlineinfo162338 info) {
	...
	LOC6 = 0;
	LOC6 = copyStrLast(line, ((NI) 0), (NI)(TMP4280));
	TMP4282 = addInt(first, ((NI) 1));
	LOC7 = 0;
	LOC7 = copyStr(line, (NI)(TMP4282));
	LOC8 = 0;
	LOC8 = nsuEscape(LOC7, ((NimStringDesc*) &TMP4283), ((NimStringDesc*) &TMP4283));
	LOC5 = rawNewString(LOC6->Sup.len + LOC8->Sup.len + 8);
appendString(LOC5, LOC6);
appendString(LOC5, ((NimStringDesc*) &TMP4281));
...
static TNimNode* TMP4258[6];
static TNimNode TMP4214[7];
...
TMP4258[0] = &TMP4214[1];
TMP4214[1].kind = 1;
TMP4214[1].offset = offsetof(Tsourcefile248008, lines);
TMP4214[1].typ = (&NTI13806);
TMP4214[1].name = "lines";
TMP4258[1] = &TMP4214[2];
TMP4214[2].kind = 1;
TMP4214[2].offset = offsetof(Tsourcefile248008, dirty);
TMP4214[2].typ = (&NTI138);
TMP4214[2].name = "dirty";
TMP4258[2] = &TMP4214[3];
TMP4214[3].kind = 1;
TMP4214[3].offset = offsetof(Tsourcefile248008, isnimfixfile);
TMP4214[3].typ = (&NTI138);
TMP4214[3].name = "isNimfixFile";
TMP4258[3] = &TMP4214[4];
TMP4214[4].kind = 1;
TMP4214[4].offset = offsetof(Tsourcefile248008, fullpath);
TMP4214[4].typ = (&NTI149);
TMP4214[4].name = "fullpath";
TMP4258[4] = &TMP4214[5];
TMP4214[5].kind = 1;
TMP4214[5].offset = offsetof(Tsourcefile248008, newline);
TMP4214[5].typ = (&NTI149);
TMP4214[5].name = "newline";
TMP4258[5] = &TMP4214[6];
TMP4214[6].kind = 1;
TMP4214[6].offset = offsetof(Tsourcefile248008, fileidx);
TMP4214[6].typ = (&NTI114);
TMP4214[6].name = "fileIdx";
TMP4214[0].len = 6; TMP4214[0].kind = 2; TMP4214[0].sons = &TMP4258[0];
NTI248008.node = &TMP4214[0];
NTI248019.size = sizeof(TY248019*);
NTI248019.kind = 24;
NTI248019.base = (&NTI248008);
NTI248019.flags = 2;
NTI248019.marker = TMP4259;
}
