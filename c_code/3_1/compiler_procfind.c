...
static NIM_CONST TY191031 TMP4501 = {
...
static NIM_CONST TY191031 TMP4504 = {
		...
		res_259090 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(19, "procfind.nim");
				{
					...
					internalerror_164199((*proca).info, ((NimStringDesc*) &TMP4503));
				...
				nimln(22, "procfind.nim");
				{
					...
					internalerror_164199((*procb).info, ((NimStringDesc*) &TMP4503));
				...
				if (((TMP4501[(*proca).kind/8] &(1<<((*proca).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4502));
				if ((NU)(i_259026) >= (NU)((*proca).kindU.S6.sons->Sup.len)) raiseIndexError();
				if (!(((TMP4504[(*(*proca).kindU.S6.sons->data[i_259026]).kind/8] &(1<<((*(*proca).kindU.S6.sons->data[i_259026]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4505));
				a = (*(*proca).kindU.S6.sons->data[i_259026]).kindU.S4.sym;
				nimln(26, "procfind.nim");
				if (((TMP4501[(*procb).kind/8] &(1<<((*procb).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4502));
				if ((NU)(i_259026) >= (NU)((*procb).kindU.S6.sons->Sup.len)) raiseIndexError();
				if (!(((TMP4504[(*(*procb).kindU.S6.sons->data[i_259026]).kind/8] &(1<<((*(*procb).kindU.S6.sons->data[i_259026]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4505));
				...
				TMP4506 = addInt(res_259090, ((NI) 1));
				res_259090 = (NI)(TMP4506);
			} LA10: ;
		}
	}
