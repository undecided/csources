...
static NIM_CONST TY191031 TMP3427 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3428, "sons", 4);
static NIM_CONST TY191031 TMP3432 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3433, "sym", 3);
static NIM_CONST TY191031 TMP3434 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3435, "ident", 5);
static NIM_CONST TY191031 TMP3436 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3437, "intVal", 6);
static NIM_CONST TY191031 TMP3438 = {
0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3439, "floatVal", 8);
static NIM_CONST TY191031 TMP3440 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3441, "strVal", 6);
STRING_LITERAL(TMP3446, "getOpSym", 8);
...
{	result = 0;
	{
		...
		TMP3426 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_219050 = (NI)(TMP3426);
		...
		res_219053 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(17, "trees.nim");
				{
					if (((TMP3427[(*father).kind/8] &(1<<((*father).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3428));
				...
				TMP3429 = addInt(res_219053, ((NI) 1));
				res_219053 = (NI)(TMP3429);
			} LA4: ;
		}
	}
	nimln(19, "trees.nim");
...
{	result = 0;
	...
	nimln(28, "trees.nim");
	{
		if (!!(((*n).kind >= ((NU8) 1) && (*n).kind <= ((NU8) 23)))) goto LA12;
		{
			...
			TMP3430 = subInt(LOC15, ((NI) 1));
			HEX3Atmp_219116 = (NI)(TMP3430);
			nimln(1598, "system.nim");
			res_219119 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					LA21: ;
					nimln(1614, "system.nim");
					TMP3431 = addInt(res_219119, ((NI) 1));
					res_219119 = (NI)(TMP3431);
				} LA17: ;
			}
		}
	}
		...
		default:
		{
			nimln(54, "trees.nim");
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					TMP3442 = subInt(LOC26, ((NI) 1));
					HEX3Atmp_219226 = (NI)(TMP3442);
					nimln(1598, "system.nim");
					res_219229 = ((NI) 0);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP3443 = addInt(res_219229, ((NI) 1));
							res_219229 = (NI)(TMP3443);
						} LA28: ;
					}
				}
				nimln(57, "trees.nim");
		...
		default:
		{
			nimln(78, "trees.nim");
			{
				...
				if (!(LOC33 == LOC34)) goto LA35;
				{
					...
					TMP3444 = subInt(LOC38, ((NI) 1));
					HEX3Atmp_219336 = (NI)(TMP3444);
					nimln(1598, "system.nim");
					res_219339 = ((NI) 0);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							LA44: ;
							nimln(1614, "system.nim");
							TMP3445 = addInt(res_219339, ((NI) 1));
							res_219339 = (NI)(TMP3445);
						} LA40: ;
					}
				}
				nimln(81, "trees.nim");
...
N_NIMCALL(Tsym190843*, getprocsym_219358)(Tnode190813* call) {
	...
	result = 0;
	nimln(84, "trees.nim");
	if (((TMP3427[(*call).kind/8] &(1<<((*call).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3428));
	if ((NU)(((NI) 0)) >= (NU)((*call).kindU.S6.sons->Sup.len)) raiseIndexError();
	if (!(((TMP3432[(*(*call).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*call).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3433));
...
N_NIMCALL(Tsym190843*, getopsym_219370)(Tnode190813* op) {
	...
	LA3: ;
	{
		nimln(90, "trees.nim");
		{
			...
			internalerror_164199((*op).info, ((NimStringDesc*) &TMP3446));
		}
		goto LA6;
		LA9: ;
		{
			nimln(91, "trees.nim");
			if (((TMP3427[(*op).kind/8] &(1<<((*op).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3428));
			if ((NU)(((NI) 0)) >= (NU)((*op).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!((*(*op).kindU.S6.sons->data[((NI) 0)]).kind == ((NU8) 3))) goto LA12;
			if (((TMP3427[(*op).kind/8] &(1<<((*op).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3428));
			if ((NU)(((NI) 0)) >= (NU)((*op).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP3432[(*(*op).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*op).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3433));
...
N_NIMCALL(Tsym190843*, treetosym_219417)(Tnode190813* t) {
	...
	result = 0;
	nimln(103, "trees.nim");
	if (!(((TMP3432[(*t).kind/8] &(1<<((*t).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3433));
		...
		Ttype190849* LOC15;
		{
			...
			res_219507 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP3447 = addInt(res_219507, ((NI) 1));
					res_219507 = (NI)(TMP3447);
				} LA7: ;
			}
		}
		nimln(122, "trees.nim");
...
N_NIMCALL(void, flattentreeaux_219526)(Tnode190813* d, Tnode190813* a, NU16 op) {
	...
	nimln(126, "trees.nim");
	{
		...
		if (!(LOC3 == op)) goto LA4;
		{
			...
			TMP3448 = subInt(LOC7, ((NI) 1));
			HEX3Atmp_219555 = (NI)(TMP3448);
			nimln(1598, "system.nim");
			res_219558 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP3449 = addInt(res_219558, ((NI) 1));
					res_219558 = (NI)(TMP3449);
				} LA9: ;
			}
		}
	}
...
N_NIMCALL(Tnode190813*, flattentree_219577)(Tnode190813* root, NU16 op) {
	...
	nimln(134, "trees.nim");
	{
		...
		if (!(LOC3 == op)) goto LA4;
		nimln(136, "trees.nim");
		if (((TMP3427[(*root).kind/8] &(1<<((*root).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3428));
...
static N_INLINE(NIM_BOOL, isrange_219612)(Tnode190813* n) {
	...
	nimln(145, "trees.nim");
	{
		...
		nimln(146, "trees.nim");
		{
			...
			if (!(((TMP3434[(*LOC11).kind/8] &(1<<((*LOC11).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3435));
			...
			if (!(((TMP3432[(*LOC17).kind/8] &(1<<((*LOC17).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3433));
...
N_NIMCALL(NU16, whichpragma_219673)(Tnode190813* n) {
	...
	nimln(153, "trees.nim");
	{
		...
		if (!(((TMP3434[(*key).kind/8] &(1<<((*key).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3435));
			...
			x_219717 = 0;
			{
				...
				res_219738 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1619, "system.nim");
						TMP3450 = addInt(res_219738, ((NI) 1));
						res_219738 = (NI)(TMP3450);
					} LA9: ;
				}
			}
		}
...
N_NIMCALL(Tnode190813*, extractrange_219771)(NU8 k, Tnode190813* n, NI a, NI b) {
	...
	nimln(169, "trees.nim");
	TMP3451 = subInt(b, a);
	TMP3452 = addInt((NI)(TMP3451), ((NI) 1));
	result = newnodei_192407(k, (*n).info, (NI)(TMP3452));
	{
		NI i_219788;
		NI HEX3Atmp_219792;
		NI TMP3453;
		...
		res_219795 = ((NI) 0);
		{
			...
			while (1) {
				...
				if (((TMP3427[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3428));
				TMP3454 = addInt(i_219788, a);
				if ((NU)((NI)(TMP3454)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
				asgnRefNoCycle((void**) (&(*result).kindU.S6.sons->data[i_219788]), (*n).kindU.S6.sons->data[(NI)(TMP3454)]);
				nimln(1619, "system.nim");
				TMP3455 = addInt(res_219795, ((NI) 1));
				res_219795 = (NI)(TMP3455);
			} LA3: ;
		}
	}
	popFrame();
