...
static NIM_CONST TY191031 TMP6607 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6608, "sons", 4);
static NIM_CONST TY191031 TMP6610 = {
...
static NIM_CONST TY191031 TMP6613 = {
	...
	{
		{
			...
			res_337205 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP6609 = addInt(res_337205, ((NI) 1));
					res_337205 = (NI)(TMP6609);
				} LA5: ;
			}
		}
	}
...
appendString(result, LOC47);
					nimln(1619, "system.nim");
					TMP6624 = addInt(res_339205, ((NI) 1));
					res_339205 = (NI)(TMP6624);
				} LA46: ;
			}
		}
...
appendString(result, LOC66);
					nimln(1619, "system.nim");
					TMP6628 = addInt(res_339213, ((NI) 1));
					res_339213 = (NI)(TMP6628);
				} LA60: ;
			}
		}
	}
...
appendString(result, LOC72);
					nimln(1619, "system.nim");
					TMP6630 = addInt(res_339221, ((NI) 1));
					res_339221 = (NI)(TMP6630);
				} LA71: ;
			}
		}
...
appendString(result, LOC88);
					nimln(1619, "system.nim");
					TMP6632 = addInt(res_339229, ((NI) 1));
					res_339229 = (NI)(TMP6632);
				} LA87: ;
			}
		}
...
{	nimln(89, "typesrenderer.nim");
	...
	{
		{
			...
			res_339622 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6633 = addInt(res_339622, ((NI) 1));
					res_339622 = (NI)(TMP6633);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 35):
	{
		...
		nimln(97, "typesrenderer.nim");
		{
			...
			LOC18 = 0;
			LOC18 = HEX5BHEX5D_191244(n, (NI)(TMP6636));
			...
			LOC21 = 0;
			LOC21 = HEX5BHEX5D_191244(n, (NI)(TMP6637));
			typ = (*LOC21).typ;
		...
		LA19: ;
		{
			...
			res_339630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6639 = addInt(res_339630, ((NI) 1));
					res_339630 = (NI)(TMP6639);
				} LA32: ;
			}
		}
	}
