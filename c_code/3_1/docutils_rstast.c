	...
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		res_296248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5007 = addInt(res_296248, ((NI) 1));
				res_296248 = (NI)(TMP5007);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		lvl = nsuRepeatChar(lvltochar_296274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5011), ((NI) 0), ((NI) 2147483647))));
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5013), ((NI) 0), ((NI) 2147483647))));
...
appendString((*result), tmp);
		...
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5026), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(Jsonnodeobj289726*, renderrsttojsonnode_296483)(Trstnode296011* node) {
	...
	nimln(296, "rstast.nim");
	{
		...
		add_292418(result, ((NimStringDesc*) &TMP5056), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_292418(result, ((NimStringDesc*) &TMP5058), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
NTI296005.node = &TMP4798[67];
TMP4798[1].kind = 1;
TMP4798[1].offset = offsetof(Trstnode296011, kind);
TMP4798[1].typ = (&NTI296005);
TMP4798[1].name = "kind";
TMP4999[1] = &TMP4798[68];
TMP4798[68].kind = 1;
TMP4798[68].offset = offsetof(Trstnode296011, text);
TMP4798[68].typ = (&NTI149);
TMP4798[68].name = "text";
TMP4999[2] = &TMP4798[69];
TMP4798[69].kind = 1;
TMP4798[69].offset = offsetof(Trstnode296011, level);
...
NTI296009.flags = 2;
NTI296009.marker = TMP5003;
TMP4798[70].kind = 1;
TMP4798[70].offset = offsetof(Trstnode296011, sons);
TMP4798[70].typ = (&NTI296009);
TMP4798[70].name = "sons";
TMP4798[0].len = 4; TMP4798[0].kind = 2; TMP4798[0].sons = &TMP4999[0];
NTI296011.node = &TMP4798[0];
NTI296007.size = sizeof(Trstnode296011*);
NTI296007.kind = 22;
NTI296007.base = (&NTI296011);
NTI296007.flags = 2;
NTI296007.marker = TMP5004;
}
