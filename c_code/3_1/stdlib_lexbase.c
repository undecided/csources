...
N_NIMCALL(void, fillbuffer_246102)(Baselexer246024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4222)]))), ((NI)chckRange((NI)(TMP4223), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
		...
		s = (NI)(TMP4229);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4233), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, open_246040)(Baselexer246024* L, Streamobj138027* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4251), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_246064)(Baselexer246024* L, NI pos) {
	...
	if ((NI)(TMP4253) == (-2147483647 -1)) raiseOverflow();
