...
N_NIMCALL(void, fillbuffer_246102)(Baselexer246024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4221)]))), ((NI)chckRange((NI)(TMP4222), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
		...
		s = (NI)(TMP4228);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4232), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, open_246040)(Baselexer246024* L, Streamobj138027* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4250), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_246064)(Baselexer246024* L, NI pos) {
	...
	if ((NI)(TMP4252) == (-2147483647 -1)) raiseOverflow();
...
TMP4261[0] = &TMP4215[1];
TMP4215[1].kind = 1;
TMP4215[1].offset = offsetof(Baselexer246024, bufpos);
TMP4215[1].typ = (&NTI108);
TMP4215[1].name = "bufpos";
TMP4261[1] = &TMP4215[2];
TMP4215[2].kind = 1;
TMP4215[2].offset = offsetof(Baselexer246024, buf);
TMP4215[2].typ = (&NTI151);
TMP4215[2].name = "buf";
TMP4261[2] = &TMP4215[3];
TMP4215[3].kind = 1;
TMP4215[3].offset = offsetof(Baselexer246024, buflen);
TMP4215[3].typ = (&NTI108);
TMP4215[3].name = "bufLen";
TMP4261[3] = &TMP4215[4];
TMP4215[4].kind = 1;
TMP4215[4].offset = offsetof(Baselexer246024, input);
TMP4215[4].typ = (&NTI138025);
TMP4215[4].name = "input";
TMP4261[4] = &TMP4215[5];
TMP4215[5].kind = 1;
TMP4215[5].offset = offsetof(Baselexer246024, linenumber);
TMP4215[5].typ = (&NTI108);
TMP4215[5].name = "lineNumber";
TMP4261[5] = &TMP4215[6];
TMP4215[6].kind = 1;
TMP4215[6].offset = offsetof(Baselexer246024, sentinel);
TMP4215[6].typ = (&NTI108);
TMP4215[6].name = "sentinel";
TMP4261[6] = &TMP4215[7];
TMP4215[7].kind = 1;
TMP4215[7].offset = offsetof(Baselexer246024, linestart);
TMP4215[7].typ = (&NTI108);
TMP4215[7].name = "lineStart";
TMP4261[7] = &TMP4215[8];
TMP4215[8].kind = 1;
TMP4215[8].offset = offsetof(Baselexer246024, fileopened);
TMP4215[8].typ = (&NTI138);
TMP4215[8].name = "fileOpened";
TMP4215[0].len = 8; TMP4215[0].kind = 2; TMP4215[0].sons = &TMP4261[0];
NTI246024.node = &TMP4215[0];
}
