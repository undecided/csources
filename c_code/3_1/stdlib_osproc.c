...
N_NIMCALL(NCSTRING*, envtocstringarray_144806)(Stringtableobj134012* t) {
	...
	TMP609 = mulInt((NI)(TMP608), ((NI) 4));
	LOC2 = 0;
	LOC2 = alloc0_6017(((NI)chckRange((NI)(TMP609), ((NI) 0), ((NI) 2147483647))));
...
appendString(LOC11, val_144813);
						...
						LOC12 = 0;
						LOC12 = alloc_6001(((NI)chckRange((NI)(TMP611), ((NI) 0), ((NI) 2147483647))));
						result[(i)- 0] = ((NCSTRING) (LOC12));
						nimln(584, "osproc.nim");
						if ((NU)(i) > (NU)(100000000)) raiseIndexError();
						if ((NU)(((NI) 0)) > (NU)(x->Sup.len)) raiseIndexError();
						TMP612 = addInt((x ? x->Sup.len : 0), ((NI) 1));
						memcpy(((void*) (result[(i)- 0])), ((void*) ((&x->data[((NI) 0)]))), ((NI)chckRange((NI)(TMP612), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(NCSTRING*, envtocstringarray_144854)(void) {
	...
	TMP620 = mulInt((NI)(TMP619), ((NI) 4));
	LOC5 = 0;
	LOC5 = alloc0_6017(((NI)chckRange((NI)(TMP620), ((NI) 0), ((NI) 2147483647))));
...
appendString(LOC10, val_144872);
					...
					LOC11 = 0;
					LOC11 = alloc_6001(((NI)chckRange((NI)(TMP623), ((NI) 0), ((NI) 2147483647))));
					result[(i)- 0] = ((NCSTRING) (LOC11));
					nimln(595, "osproc.nim");
					if ((NU)(i) > (NU)(100000000)) raiseIndexError();
					if ((NU)(((NI) 0)) > (NU)(x->Sup.len)) raiseIndexError();
					TMP624 = addInt((x ? x->Sup.len : 0), ((NI) 1));
					memcpy(((void*) (result[(i)- 0])), ((void*) ((&x->data[((NI) 0)]))), ((NI)chckRange((NI)(TMP624), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(NI, select_144608)(TY144201** readfds, NI timeout) {
	...
	nimln(945, "osproc.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int) ((NI)(TMP648))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int) ((NI)(TMP649))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
