...
appendChar(LOC9, 32);
					...
					TMP1825 = addInt(res_175052, ((NI) 1));
					res_175052 = (NI)(TMP1825);
				} LA8: ;
			}
		}
	}
...
N_NIMCALL(void, handleshortoption_175291)(Optparser175011* p) {
	...
	nimln(87, "parseopt.nim");
	{
		...
		i = parseword_175204((*p).cmd, i, (&(*p).val), TMP1835);
	}
	LA5: ;
...
{	nimln(98, "parseopt.nim");
	...
	case 45:
	{
		...
		nimln(111, "parseopt.nim");
		{
			...
			i = parseword_175204((*p).cmd, i, (&(*p).key), TMP1839);
			{
			...
			nimln(116, "parseopt.nim");
			{
				...
				(*p).pos = parseword_175204((*p).cmd, i, (&(*p).val), TMP1835);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p).pos = parseword_175204((*p).cmd, i, (&(*p).key), TMP1835);
	}
	break;
	}
	}BeforeRet: ;
...
TMP1819[1].kind = 1;
TMP1819[1].offset = offsetof(Optparser175011, cmd);
TMP1819[1].typ = (&NTI149);
TMP1819[1].name = "cmd";
TMP10620[1] = &TMP1819[2];
TMP1819[2].kind = 1;
TMP1819[2].offset = offsetof(Optparser175011, pos);
TMP1819[2].typ = (&NTI108);
TMP1819[2].name = "pos";
TMP10620[2] = &TMP1819[3];
TMP1819[3].kind = 1;
TMP1819[3].offset = offsetof(Optparser175011, inshortstate);
...
NTI175009.node = &TMP1819[9];
TMP1819[4].kind = 1;
TMP1819[4].offset = offsetof(Optparser175011, kind);
TMP1819[4].typ = (&NTI175009);
TMP1819[4].name = "kind";
TMP10620[4] = &TMP1819[10];
TMP1819[10].kind = 1;
TMP1819[10].offset = offsetof(Optparser175011, key);
TMP1819[10].typ = (&NTI149);
TMP1819[10].name = "key";
TMP10620[5] = &TMP1819[11];
TMP1819[11].kind = 1;
TMP1819[11].offset = offsetof(Optparser175011, val);
TMP1819[11].typ = (&NTI149);
TMP1819[11].name = "val";
TMP1819[0].len = 6; TMP1819[0].kind = 2; TMP1819[0].sons = &TMP10620[0];
NTI175011.node = &TMP1819[0];
}
