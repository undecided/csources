...
typedef struct Servent508613 Servent508613;
typedef struct TY13806 TY13806;
typedef struct Hostent508615 Hostent508615;
...
struct  Servent508613  {
NimStringDesc* name;
TY13806* aliases;
NU16 port;
NimStringDesc* proto;
};
struct  Hostent508615  {
NimStringDesc* name;
TY13806* aliases;
NU8 addrtype;
NI length;
...
N_NIMCALL(void, getservbyname_510027)(NimStringDesc* name, NimStringDesc* proto, Servent508613* Result);
N_NIMCALL(NimStringDesc*, copyStringRC1)(NimStringDesc* src);
static N_INLINE(void, nimGCunrefNoCycle)(void* p);
N_NIMCALL(void, unsureAsgnRef)(void** dest, void* src);
N_NIMCALL(TY13806*, cstringarraytoseq_14043)(NCSTRING* a);
N_NIMCALL(void, getservbyport_510233)(NU16 port, NimStringDesc* proto, Servent508613* Result);
static N_INLINE(NI, chckRange)(NI i, NI a, NI b);
N_NOINLINE(void, raiseRangeError)(NI64 val);
N_NIMCALL(void, gethostbyaddr_510434)(NimStringDesc* ip, Hostent508615* Result);
N_NIMCALL(void, gethostbyname_510824)(NimStringDesc* name, Hostent508615* Result);
...
N_NIMCALL(void, setsockoptint_511433)(int socket, NI level, NI optname, NI optval);
N_NIMCALL(void, setblocking_511450)(int s, NIM_BOOL blocking);
...
N_NIMCALL(void, createfdset_511645)(fd_set* fd, TY511649* s, NI* m);
N_NOINLINE(void, raiseIndexError)(void);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(void, failedassertimpl_87217)(NimStringDesc* msg);
N_NIMCALL(void, prunesocketset_511846)(TY511649** s, fd_set* fd);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(NI, select_511913)(TY511649** readfds, NI timeout);
N_NIMCALL(NI, selectwrite_511972)(TY511649** writefds, NI timeout);
N_NIMCALL(void, TMP10654)(void* p, NI op);
STRING_LITERAL(TMP10606, "Service not found.", 18);
STRING_LITERAL(TMP10607, "unknown h_addrtype", 18);
STRING_LITERAL(TMP10613, "len(a) == L seq modified while iterating over it", 48);
...
TNimType NTI511649; /* seq[SocketHandle] */
...
N_NIMCALL(void, getservbyname_510027)(NimStringDesc* name, NimStringDesc* proto, Servent508613* Result) {
	...
	nimln(246, "rawsockets.nim");
	{
		...
		e_510216 = 0;
		nimln(2265, "system.nim");
		e_510216 = (Oserror3433*) newObj((&NTI117012), sizeof(Oserror3433));
		(*e_510216).Sup.Sup.Sup.m_type = (&NTI3433);
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_510216).Sup.Sup.message; (*e_510216).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10606));
...
N_NIMCALL(void, getservbyport_510233)(NU16 port, NimStringDesc* proto, Servent508613* Result) {
	...
	nimln(262, "rawsockets.nim");
	{
		...
		e_510416 = 0;
		nimln(2265, "system.nim");
		e_510416 = (Oserror3433*) newObj((&NTI117012), sizeof(Oserror3433));
		(*e_510416).Sup.Sup.Sup.m_type = (&NTI3433);
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_510416).Sup.Sup.message; (*e_510416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10606));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		nimln(262, "rawsockets.nim");
...
N_NIMCALL(void, gethostbyaddr_510434)(NimStringDesc* ip, Hostent508615* Result) {
	...
	nimln(280, "rawsockets.nim");
	{
		...
		e_510617 = 0;
		nimln(2265, "system.nim");
		e_510617 = (Oserror3433*) newObj((&NTI117012), sizeof(Oserror3433));
	...
	LA11: ;
	{
		...
		e_510803 = 0;
		nimln(2265, "system.nim");
		e_510803 = (Oserror3433*) newObj((&NTI117012), sizeof(Oserror3433));
		(*e_510803).Sup.Sup.Sup.m_type = (&NTI3433);
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_510803).Sup.Sup.message; (*e_510803).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10607));
...
N_NIMCALL(void, gethostbyname_510824)(NimStringDesc* name, Hostent508615* Result) {
	...
	LA11: ;
	{
		...
		e_511203 = 0;
		nimln(2265, "system.nim");
		e_511203 = (Oserror3433*) newObj((&NTI117012), sizeof(Oserror3433));
		(*e_511203).Sup.Sup.Sup.m_type = (&NTI3433);
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_511203).Sup.Sup.message; (*e_511203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10607));
		if (LOC14) nimGCunrefNoCycle(LOC14);
...
N_NIMCALL(struct timeval, timevalfrommilliseconds_511628)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		TMP10608 = divInt(timeout, ((NI) 1000));
		seconds = (NI)(TMP10608);
		nimln(371, "rawsockets.nim");
		result.tv_sec = ((NI) (((NI32) (seconds))));
		nimln(372, "rawsockets.nim");
		TMP10609 = mulInt(seconds, ((NI) 1000));
		TMP10610 = subInt(timeout, (NI)(TMP10609));
		TMP10611 = mulInt((NI)(TMP10610), ((NI) 1000));
		result.tv_usec = ((NI) (((NI32) ((NI)(TMP10611)))));
	}
	LA3: ;
	popFrame();
	return result;
	...
	FD_ZERO(fd);
	{
		...
		L_511830 = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP10612 = addInt(i_511828, ((NI) 1));
				i_511828 = (NI)(TMP10612);
				nimln(3089, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L_511830))) goto LA6;
					failedassertimpl_87217(((NimStringDesc*) &TMP10613));
				}
				LA6: ;
			} LA3: ;
		}
...
N_NIMCALL(void, prunesocketset_511846)(TY511649** s, fd_set* fd) {
	...
	L = ((*s) ? (*s)->Sup.len : 0);
	{
		...
		while (1) {
			...
			nimln(384, "rawsockets.nim");
			{
				...
				if ((NU)(i) >= (NU)((*s)->Sup.len)) raiseIndexError();
				TMP10614 = subInt(L, ((NI) 1));
				if ((NU)((NI)(TMP10614)) >= (NU)((*s)->Sup.len)) raiseIndexError();
				(*s)->data[i] = (*s)->data[(NI)(TMP10614)];
				nimln(386, "rawsockets.nim");
				TMP10615 = subInt(L, ((NI) 1));
				L = (NI)(TMP10615);
			}
			goto LA3;
			LA6: ;
	...
	(*s) = (TY511649*) setLengthSeq(&((*s))->Sup, sizeof(int), ((NI)chckRange(L, ((NI) 0), ((NI) 2147483647))));
	popFrame();
}
...
N_NIMCALL(NI, select_511913)(TY511649** readfds, NI timeout) {
	...
	nimln(405, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int) ((NI)(TMP10617))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int) ((NI)(TMP10618))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_511972)(TY511649** writefds, NI timeout) {
	...
	createfdset_511645((&wr), (*writefds), (&m));
	nimln(427, "rawsockets.nim");
	{
		...
		TMP10619 = addInt(m, ((NI) 1));
		LOC5 = 0;
		LOC5 = select(((int) ((NI)(TMP10619))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		TMP10620 = addInt(m, ((NI) 1));
		LOC7 = 0;
		LOC7 = select(((int) ((NI)(TMP10620))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
NTI511649.size = sizeof(TY511649*);
NTI511649.kind = 24;
NTI511649.base = (&NTI5811);
NTI511649.flags = 2;
NTI511649.marker = TMP10654;
}
