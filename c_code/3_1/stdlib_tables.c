...
static N_INLINE(NI, rightsize_155407)(NI count) {
	...
	result = nextpoweroftwo_148531(((NI)chckRange((NI)(TMP729), ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_162672)(Table162376* t) {
	...
	n = (Keyvaluepairseq162379*) newSeq((&NTI162379), ((NI)chckRange((NI)(TMP1199), ((NI) 0), ((NI) 2147483647))));
	...
	n = LOC1;
	{
		...
		res_162781 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1202 = addInt(res_162781, ((NI) 1));
				res_162781 = (NI)(TMP1202);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_312185)(Table311052* t) {
	...
	n = (Keyvaluepairseq311055*) newSeq((&NTI311055), ((NI)chckRange((NI)(TMP5901), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_312294 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5904 = addInt(res_312294, ((NI) 1));
				res_312294 = (NI)(TMP5904);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_315109)(Table312409* t) {
	...
	n = (Keyvaluepairseq312412*) newSeq((&NTI312412), ((NI)chckRange((NI)(TMP5988), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_315227 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5991 = addInt(res_315227, ((NI) 1));
				res_315227 = (NI)(TMP5991);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_382198)(Table381650* t) {
	...
	n = (Keyvaluepairseq381653*) newSeq((&NTI381653), ((NI)chckRange((NI)(TMP7575), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_382307 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7580 = addInt(res_382307, ((NI) 1));
				res_382307 = (NI)(TMP7580);
			} LA4: ;
		}
	}
	popFrame();
...
TMP1181[0] = &TMP721[5];
TMP721[5].kind = 1;
TMP721[5].offset = offsetof(Table162376, data);
TMP721[5].typ = (&NTI162379);
TMP721[5].name = "data";
TMP1181[1] = &TMP721[6];
TMP721[6].kind = 1;
TMP721[6].offset = offsetof(Table162376, counter);
TMP721[6].typ = (&NTI108);
TMP721[6].name = "counter";
TMP721[4].len = 2; TMP721[4].kind = 2; TMP721[4].sons = &TMP1181[0];
NTI162376.node = &TMP721[4];
...
TMP5986[0] = &TMP721[12];
TMP721[12].kind = 1;
TMP721[12].offset = offsetof(Keyvaluepair312415, Field0);
TMP721[12].typ = (&NTI131021);
TMP721[12].name = "Field0";
TMP5986[1] = &TMP721[13];
TMP721[13].kind = 1;
TMP721[13].offset = offsetof(Keyvaluepair312415, Field1);
TMP721[13].typ = (&NTI312396);
TMP721[13].name = "Field1";
TMP5986[2] = &TMP721[14];
TMP721[14].kind = 1;
TMP721[14].offset = offsetof(Keyvaluepair312415, Field2);
TMP721[14].typ = (&NTI312897);
TMP721[14].name = "Field2";
TMP721[11].len = 3; TMP721[11].kind = 2; TMP721[11].sons = &TMP5986[0];
NTI312415.node = &TMP721[11];
NTI312412.size = sizeof(Keyvaluepairseq312412*);
NTI312412.kind = 24;
NTI312412.base = (&NTI312415);
NTI312412.flags = 2;
NTI312412.marker = TMP5987;
...
TMP6251[0] = &TMP721[16];
TMP721[16].kind = 1;
TMP721[16].offset = offsetof(Table311052, data);
TMP721[16].typ = (&NTI311055);
TMP721[16].name = "data";
TMP6251[1] = &TMP721[17];
TMP721[17].kind = 1;
TMP721[17].offset = offsetof(Table311052, counter);
TMP721[17].typ = (&NTI108);
TMP721[17].name = "counter";
TMP721[15].len = 2; TMP721[15].kind = 2; TMP721[15].sons = &TMP6251[0];
NTI311052.node = &TMP721[15];
