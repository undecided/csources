...
N_NIMCALL(void, TMP8925)(void* p, NI op);
...
static N_INLINE(Ropeobj160009**, s_456184)(Tcproc456034* p, NU8 s) {
	...
	TMP8926 = subInt(((*p).blocks ? (*p).blocks->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP8926)) >= (NU)((*p).blocks->Sup.len)) raiseIndexError();
	result = &(*p).blocks->data[(NI)(TMP8926)].sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP8918[29];
static TNimNode* TMP8919[17];
static TNimNode* TMP8920[7];
static TNimNode TMP8916[56];
NTI456038.size = sizeof(Tcgen456038);
NTI456038.kind = 17;
NTI456038.base = (&NTI241005);
TMP8918[0] = &TMP8916[1];
TMP8916[1].kind = 1;
TMP8916[1].offset = offsetof(Tcgen456038, module);
TMP8916[1].typ = (&NTI190811);
TMP8916[1].name = "module";
TMP8918[1] = &TMP8916[2];
TMP8916[2].kind = 1;
TMP8916[2].offset = offsetof(Tcgen456038, filename);
TMP8916[2].typ = (&NTI149);
TMP8916[2].name = "filename";
TMP8918[2] = &TMP8916[3];
...
NTI456022.flags = 2;
TMP8916[3].kind = 1;
TMP8916[3].offset = offsetof(Tcgen456038, s);
TMP8916[3].typ = (&NTI456022);
TMP8916[3].name = "s";
TMP8918[3] = &TMP8916[4];
TMP8916[4].kind = 1;
TMP8916[4].offset = offsetof(Tcgen456038, preventstacktrace);
TMP8916[4].typ = (&NTI138);
TMP8916[4].name = "preventStackTrace";
TMP8918[4] = &TMP8916[5];
TMP8916[5].kind = 1;
TMP8916[5].offset = offsetof(Tcgen456038, usesthreadvars);
TMP8916[5].typ = (&NTI138);
TMP8916[5].name = "usesThreadVars";
TMP8918[5] = &TMP8916[6];
TMP8916[6].kind = 1;
TMP8916[6].offset = offsetof(Tcgen456038, framedeclared);
TMP8916[6].typ = (&NTI138);
TMP8916[6].name = "frameDeclared";
TMP8918[6] = &TMP8916[7];
TMP8916[7].kind = 1;
TMP8916[7].offset = offsetof(Tcgen456038, isheaderfile);
TMP8916[7].typ = (&NTI138);
TMP8916[7].name = "isHeaderFile";
TMP8918[7] = &TMP8916[8];
TMP8916[8].kind = 1;
TMP8916[8].offset = offsetof(Tcgen456038, includesstringh);
TMP8916[8].typ = (&NTI138);
TMP8916[8].name = "includesStringh";
TMP8918[8] = &TMP8916[9];
TMP8916[9].kind = 1;
TMP8916[9].offset = offsetof(Tcgen456038, objhaskidsvalid);
TMP8916[9].typ = (&NTI138);
TMP8916[9].name = "objHasKidsValid";
TMP8918[9] = &TMP8916[10];
TMP8916[10].kind = 1;
TMP8916[10].offset = offsetof(Tcgen456038, cfilename);
TMP8916[10].typ = (&NTI149);
TMP8916[10].name = "cfilename";
TMP8918[10] = &TMP8916[11];
TMP8916[11].kind = 1;
TMP8916[11].offset = offsetof(Tcgen456038, typecache);
TMP8916[11].typ = (&NTI190861);
TMP8916[11].name = "typeCache";
TMP8918[11] = &TMP8916[12];
TMP8916[12].kind = 1;
TMP8916[12].offset = offsetof(Tcgen456038, forwtypecache);
TMP8916[12].typ = (&NTI190861);
TMP8916[12].name = "forwTypeCache";
TMP8918[12] = &TMP8916[13];
TMP8916[13].kind = 1;
TMP8916[13].offset = offsetof(Tcgen456038, declaredthings);
TMP8916[13].typ = (&NTI187056);
TMP8916[13].name = "declaredThings";
TMP8918[13] = &TMP8916[14];
TMP8916[14].kind = 1;
TMP8916[14].offset = offsetof(Tcgen456038, declaredprotos);
TMP8916[14].typ = (&NTI187056);
TMP8916[14].name = "declaredProtos";
TMP8918[14] = &TMP8916[15];
TMP8916[15].kind = 1;
TMP8916[15].offset = offsetof(Tcgen456038, headerfiles);
TMP8916[15].typ = (&NTI130028);
TMP8916[15].name = "headerFiles";
TMP8918[15] = &TMP8916[16];
TMP8916[16].kind = 1;
TMP8916[16].offset = offsetof(Tcgen456038, typeinfomarker);
TMP8916[16].typ = (&NTI187056);
TMP8916[16].name = "typeInfoMarker";
TMP8918[16] = &TMP8916[17];
NTI456034.size = sizeof(Tcproc456034);
NTI456034.kind = 18;
NTI456034.base = 0;
TMP8919[0] = &TMP8916[19];
TMP8916[19].kind = 1;
TMP8916[19].offset = offsetof(Tcproc456034, prc);
TMP8916[19].typ = (&NTI190811);
TMP8916[19].name = "prc";
TMP8919[1] = &TMP8916[20];
TMP8916[20].kind = 1;
TMP8916[20].offset = offsetof(Tcproc456034, beforeretneeded);
TMP8916[20].typ = (&NTI138);
TMP8916[20].name = "beforeRetNeeded";
TMP8919[2] = &TMP8916[21];
TMP8916[21].kind = 1;
TMP8916[21].offset = offsetof(Tcproc456034, threadvaraccessed);
TMP8916[21].typ = (&NTI138);
TMP8916[21].name = "threadVarAccessed";
TMP8919[3] = &TMP8916[22];
TMP8916[22].kind = 1;
TMP8916[22].offset = offsetof(Tcproc456034, lastlineinfo);
TMP8916[22].typ = (&NTI162338);
TMP8916[22].name = "lastLineInfo";
TMP8919[4] = &TMP8916[23];
TMP8916[23].kind = 1;
TMP8916[23].offset = offsetof(Tcproc456034, nestedtrystmts);
TMP8916[23].typ = (&NTI190807);
TMP8916[23].name = "nestedTryStmts";
TMP8919[5] = &TMP8916[24];
TMP8916[24].kind = 1;
TMP8916[24].offset = offsetof(Tcproc456034, inexceptblock);
TMP8916[24].typ = (&NTI108);
TMP8916[24].name = "inExceptBlock";
TMP8919[6] = &TMP8916[25];
TMP8916[25].kind = 1;
TMP8916[25].offset = offsetof(Tcproc456034, finallysafepoints);
TMP8916[25].typ = (&NTI160599);
TMP8916[25].name = "finallySafePoints";
TMP8919[7] = &TMP8916[26];
TMP8916[26].kind = 1;
TMP8916[26].offset = offsetof(Tcproc456034, labels);
TMP8916[26].typ = (&NTI3407);
TMP8916[26].name = "labels";
TMP8919[8] = &TMP8916[27];
NTI456032.size = sizeof(Tblock456032);
NTI456032.kind = 18;
NTI456032.base = 0;
NTI456032.flags = 2;
TMP8920[0] = &TMP8916[29];
TMP8916[29].kind = 1;
TMP8916[29].offset = offsetof(Tblock456032, id);
TMP8916[29].typ = (&NTI108);
TMP8916[29].name = "id";
TMP8920[1] = &TMP8916[30];
TMP8916[30].kind = 1;
TMP8916[30].offset = offsetof(Tblock456032, label);
TMP8916[30].typ = (&NTI160007);
TMP8916[30].name = "label";
TMP8920[2] = &TMP8916[31];
NTI456026.size = sizeof(Tcprocsections456026);
NTI456026.kind = 16;
NTI456026.base = (&NTI160007);
NTI456026.flags = 2;
TMP8916[31].kind = 1;
TMP8916[31].offset = offsetof(Tblock456032, sections);
TMP8916[31].typ = (&NTI456026);
TMP8916[31].name = "sections";
TMP8920[3] = &TMP8916[32];
TMP8916[32].kind = 1;
TMP8916[32].offset = offsetof(Tblock456032, isloop);
TMP8916[32].typ = (&NTI138);
TMP8916[32].name = "isLoop";
TMP8920[4] = &TMP8916[33];
TMP8916[33].kind = 1;
TMP8916[33].offset = offsetof(Tblock456032, nestedtrystmts);
TMP8916[33].typ = (&NTI112);
TMP8916[33].name = "nestedTryStmts";
TMP8920[5] = &TMP8916[34];
TMP8916[34].kind = 1;
TMP8916[34].offset = offsetof(Tblock456032, nestedexceptstmts);
TMP8916[34].typ = (&NTI112);
TMP8916[34].name = "nestedExceptStmts";
TMP8920[6] = &TMP8916[35];
TMP8916[35].kind = 1;
TMP8916[35].offset = offsetof(Tblock456032, framelen);
TMP8916[35].typ = (&NTI112);
TMP8916[35].name = "frameLen";
TMP8916[28].len = 7; TMP8916[28].kind = 2; TMP8916[28].sons = &TMP8920[0];
NTI456032.node = &TMP8916[28];
NTI456106.size = sizeof(TY456106*);
NTI456106.kind = 24;
NTI456106.base = (&NTI456032);
NTI456106.flags = 2;
NTI456106.marker = TMP8921;
TMP8916[27].kind = 1;
TMP8916[27].offset = offsetof(Tcproc456034, blocks);
TMP8916[27].typ = (&NTI456106);
TMP8916[27].name = "blocks";
TMP8919[9] = &TMP8916[36];
TMP8916[36].kind = 1;
TMP8916[36].offset = offsetof(Tcproc456034, breakidx);
TMP8916[36].typ = (&NTI108);
TMP8916[36].name = "breakIdx";
TMP8919[10] = &TMP8916[37];
TMP8916[37].kind = 1;
TMP8916[37].offset = offsetof(Tcproc456034, options);
TMP8916[37].typ = (&NTI153121);
TMP8916[37].name = "options";
TMP8919[11] = &TMP8916[38];
TMP8916[38].kind = 1;
TMP8916[38].offset = offsetof(Tcproc456034, maxframelen);
TMP8916[38].typ = (&NTI108);
TMP8916[38].name = "maxFrameLen";
TMP8919[12] = &TMP8916[39];
TMP8916[39].kind = 1;
TMP8916[39].offset = offsetof(Tcproc456034, module);
TMP8916[39].typ = (&NTI456028);
TMP8916[39].name = "module";
TMP8919[13] = &TMP8916[40];
TMP8916[40].kind = 1;
TMP8916[40].offset = offsetof(Tcproc456034, withinloop);
TMP8916[40].typ = (&NTI108);
TMP8916[40].name = "withinLoop";
TMP8919[14] = &TMP8916[41];
TMP8916[41].kind = 1;
TMP8916[41].offset = offsetof(Tcproc456034, splitdecls);
TMP8916[41].typ = (&NTI108);
TMP8916[41].name = "splitDecls";
TMP8919[15] = &TMP8916[42];
TMP8916[42].kind = 1;
TMP8916[42].offset = offsetof(Tcproc456034, gcframeid);
TMP8916[42].typ = (&NTI3407);
TMP8916[42].name = "gcFrameId";
TMP8919[16] = &TMP8916[43];
TMP8916[43].kind = 1;
TMP8916[43].offset = offsetof(Tcproc456034, gcframetype);
TMP8916[43].typ = (&NTI160007);
TMP8916[43].name = "gcFrameType";
TMP8916[18].len = 17; TMP8916[18].kind = 2; TMP8916[18].sons = &TMP8919[0];
NTI456034.node = &TMP8916[18];
NTI456030.size = sizeof(Tcproc456034*);
NTI456030.kind = 22;
NTI456030.base = (&NTI456034);
NTI456030.marker = TMP8922;
TMP8916[17].kind = 1;
TMP8916[17].offset = offsetof(Tcgen456038, initproc);
TMP8916[17].typ = (&NTI456030);
TMP8916[17].name = "initProc";
TMP8918[17] = &TMP8916[44];
TMP8916[44].kind = 1;
TMP8916[44].offset = offsetof(Tcgen456038, postinitproc);
TMP8916[44].typ = (&NTI456030);
TMP8916[44].name = "postInitProc";
TMP8918[18] = &TMP8916[45];
TMP8916[45].kind = 1;
TMP8916[45].offset = offsetof(Tcgen456038, preinitproc);
TMP8916[45].typ = (&NTI456030);
TMP8916[45].name = "preInitProc";
TMP8918[19] = &TMP8916[46];
TMP8916[46].kind = 1;
TMP8916[46].offset = offsetof(Tcgen456038, typestack);
TMP8916[46].typ = (&NTI190845);
TMP8916[46].name = "typeStack";
TMP8918[20] = &TMP8916[47];
TMP8916[47].kind = 1;
TMP8916[47].offset = offsetof(Tcgen456038, datacache);
TMP8916[47].typ = (&NTI190873);
TMP8916[47].name = "dataCache";
TMP8918[21] = &TMP8916[48];
TMP8916[48].kind = 1;
TMP8916[48].offset = offsetof(Tcgen456038, forwardedprocs);
TMP8916[48].typ = (&NTI190815);
TMP8916[48].name = "forwardedProcs";
TMP8918[22] = &TMP8916[49];
TMP8916[49].kind = 1;
TMP8916[49].offset = offsetof(Tcgen456038, typenodes);
TMP8916[49].typ = (&NTI108);
TMP8916[49].name = "typeNodes";
TMP8918[23] = &TMP8916[50];
TMP8916[50].kind = 1;
TMP8916[50].offset = offsetof(Tcgen456038, nimtypes);
TMP8916[50].typ = (&NTI108);
TMP8916[50].name = "nimTypes";
TMP8918[24] = &TMP8916[51];
TMP8916[51].kind = 1;
TMP8916[51].offset = offsetof(Tcgen456038, typenodesname);
TMP8916[51].typ = (&NTI160007);
TMP8916[51].name = "typeNodesName";
TMP8918[25] = &TMP8916[52];
TMP8916[52].kind = 1;
TMP8916[52].offset = offsetof(Tcgen456038, nimtypesname);
TMP8916[52].typ = (&NTI160007);
TMP8916[52].name = "nimTypesName";
TMP8918[26] = &TMP8916[53];
TMP8916[53].kind = 1;
TMP8916[53].offset = offsetof(Tcgen456038, labels);
TMP8916[53].typ = (&NTI3407);
TMP8916[53].name = "labels";
TMP8918[27] = &TMP8916[54];
NTI456143.size = sizeof(TY456143);
NTI456143.kind = 16;
NTI456143.base = (&NTI160007);
NTI456143.flags = 2;
TMP8916[54].kind = 1;
TMP8916[54].offset = offsetof(Tcgen456038, extensionloaders);
TMP8916[54].typ = (&NTI456143);
TMP8916[54].name = "extensionLoaders";
TMP8918[28] = &TMP8916[55];
TMP8916[55].kind = 1;
TMP8916[55].offset = offsetof(Tcgen456038, injectstmt);
TMP8916[55].typ = (&NTI160007);
TMP8916[55].name = "injectStmt";
TMP8916[0].len = 29; TMP8916[0].kind = 2; TMP8916[0].sons = &TMP8918[0];
NTI456038.node = &TMP8916[0];
NTI456028.size = sizeof(Tcgen456038*);
NTI456028.kind = 22;
NTI456028.base = (&NTI456038);
NTI456028.marker = TMP8924;
NTI456155.size = sizeof(TY456155*);
NTI456155.kind = 24;
NTI456155.base = (&NTI456028);
NTI456155.marker = TMP8925;
}
