	...
	result = ((NI32) -1);
	{
		...
		res_169519 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1355 = addInt(res_169519, ((NI) 1));
				res_169519 = (NI)(TMP1355);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = c;
	{
		...
		res_169558 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1357 = addInt(res_169558, ((NI) 1));
				res_169558 = (NI)(TMP1357);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = ((NI32) -1);
	{
		...
		res_169610 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP1359 = addInt(res_169610, ((NI) 1));
				res_169610 = (NI)(TMP1359);
			} LA3: ;
		}
	}
	popFrame();
			...
			readbytes = readbuffer_13715(bin, buf, ((NI) 8000));
			{
				...
				res_169660 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1614, "system.nim");
						TMP1361 = addInt(res_169660, ((NI) 1));
						res_169660 = (NI)(TMP1361);
					} LA10: ;
				}
			}
			nimln(114, "crc.nim");
