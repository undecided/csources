...
static NIM_CONST TY191031 TMP7615 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7616, "sym", 3);
static NIM_CONST TY191031 TMP7617 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7618, "sons", 4);
STRING_LITERAL(TMP7621, "compiler/evaltempl.nim", 22);
NIM_CONST TY146211 TMP7620 = {((NimStringDesc*) &TMP7621),
((NI) 39)}
;
STRING_LITERAL(TMP7624, "", 0);
...
static N_INLINE(NI, len_191097)(Tnode190813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP7617[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
...
N_NIMCALL(void, evaltemplateaux_383039)(Tnode190813* templ, Tnode190813* actual, Templctx383019* c, Tnode190813* result) {
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP7615[(*templ).kind/8] &(1<<((*templ).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7616));
		...
		nimln(31, "evaltempl.nim");
		{
			...
			nimln(32, "evaltempl.nim");
			{
				...
				if (((TMP7617[(*actual).kind/8] &(1<<((*actual).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
						...
						y_383083 = 0;
						{
							...
							res_383146 = ((NI) 0);
							{
								...
								while (1) {
									...
									i_383142 = res_383146;
									nimln(1537, "ast.nim");
									if (((TMP7617[(*x).kind/8] &(1<<((*x).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
									...
									TMP7619 = addInt(res_383146, ((NI) 1));
									res_383146 = (NI)(TMP7619);
								} LA20: ;
							}
						}
					}
	...
	default:
	{
		...
		res = copynode_383027((&(*c)), templ, actual);
		{
			...
			TMP7622 = subInt(LOC50, ((NI) 1));
			HEX3Atmp_383150 = (NI)(TMP7622);
			nimln(1598, "system.nim");
			res_383153 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					if (((TMP7617[(*templ).kind/8] &(1<<((*templ).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
					...
					TMP7623 = addInt(res_383153, ((NI) 1));
					res_383153 = (NI)(TMP7623);
				} LA52: ;
			}
		}
...
N_NIMCALL(Tnode190813*, evaltemplateargs_383184)(Tnode190813* n, Tsym190843* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_164134((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7624));
	}
	LA5: ;
	...
	result = newnodei_192351(((NU8) 152), (*n).info);
	{
		...
		TMP7625 = subInt(f, ((NI) 1));
		HEX3Atmp_383234 = (NI)(TMP7625);
		nimln(1598, "system.nim");
		res_383237 = ((NI) 1);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA12: ;
				{
					if (((TMP7617[(*(*(*s).typ).n).kind/8] &(1<<((*(*(*s).typ).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
					if ((NU)(i_383204) >= (NU)((*(*(*s).typ).n).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (!(((TMP7615[(*(*(*(*s).typ).n).kindU.S6.sons->data[i_383204]).kind/8] &(1<<((*(*(*(*s).typ).n).kindU.S6.sons->data[i_383204]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7616));
				...
				nimln(70, "evaltempl.nim");
				{
					...
					localerror_164155((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7624));
				}
				LA19: ;
				nimln(72, "evaltempl.nim");
				addson_192819(result, arg);
				nimln(1614, "system.nim");
				TMP7626 = addInt(res_383237, ((NI) 1));
				res_383237 = (NI)(TMP7626);
			} LA9: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode190813*, evaltemplate_383260)(Tnode190813* n, Tsym190843* tmpl, Tsym190843* gensymowner) {
	...
	TMP7627 = addInt(evaltemplatecounter_383256, ((NI) 1));
	evaltemplatecounter_383256 = (NI)(TMP7627);
	nimln(79, "evaltempl.nim");
	{
		if (!(((NI) 100) < evaltemplatecounter_383256)) goto LA3;
		nimln(80, "evaltempl.nim");
		globalerror_164134((*n).info, ((NU16) 183), ((NimStringDesc*) &TMP7624));
	...
	nimln(91, "evaltempl.nim");
	{
		...
		nimln(94, "evaltempl.nim");
		{
			...
			if (((TMP7617[(*result).kind/8] &(1<<((*result).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
	...
	LA8: ;
	{
		...
		LA20: ;
		{
			...
			TMP7628 = subInt(LOC23, ((NI) 1));
			HEX3Atmp_383322 = (NI)(TMP7628);
			nimln(1598, "system.nim");
			res_383325 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					if (((TMP7617[(*body).kind/8] &(1<<((*body).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7618));
					...
					nimln(1614, "system.nim");
					TMP7629 = addInt(res_383325, ((NI) 1));
					res_383325 = (NI)(TMP7629);
				} LA25: ;
			}
		}
	}
	...
	TMP7630 = subInt(evaltemplatecounter_383256, ((NI) 1));
	evaltemplatecounter_383256 = (NI)(TMP7630);
	popFrame();
	return result;
}
