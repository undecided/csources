...
N_NIMCALL(void, parseline_217149)(Ttmplparser217020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 26):
		{
			...
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3356), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3359), ((NI) 0), ((NI) IL64(9223372036854775807)))));
