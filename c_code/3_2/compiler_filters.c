...
static NIM_CONST TY191031 TMP3319 = {
...
static NIM_CONST TY191031 TMP3324 = {
			...
			while (1) {
				...
				nimln(31, "filters.nim");
				{
					...
					nimln(32, "filters.nim");
					{
						if (((TMP3319[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3320));
						if ((NU)(i_216086) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP3319[(*(*n).kindU.S6.sons->data[i_216086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_216086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3320));
					...
					nimln(33, "filters.nim");
					{
						...
						if (((TMP3319[(*(*n).kindU.S6.sons->data[i_216086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_216086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3320));
						if ((NU)(((NI) 0)) >= (NU)((*(*n).kindU.S6.sons->data[i_216086]).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP3321[(*(*(*n).kindU.S6.sons->data[i_216086]).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*(*n).kindU.S6.sons->data[i_216086]).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3322));
						LOC19 = 0;
				...
				TMP3323 = addInt(res_216118, ((NI) 1));
				res_216118 = (NI)(TMP3323);
			} LA8: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(NIM_BOOL, boolarg_216038)(Tnode190813* n, NimStringDesc* name, NI pos, NIM_BOOL default_216043) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_166484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3328));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		if (!(LOC11)) goto LA12;
		if (!(((TMP3321[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3322));
		LOC11 = identeq_166484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3329));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream177204*, filterstrip_216012)(Tllstream177204* stdin_216014, NimStringDesc* filename, Tnode190813* call) {
	...
	pattern = strarg_216029(call, ((NimStringDesc*) &TMP3330), ((NI) 1), ((NimStringDesc*) &TMP3331));
	nimln(59, "filters.nim");
	leading = boolarg_216038(call, ((NimStringDesc*) &TMP3332), ((NI) 2), NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_216038(call, ((NimStringDesc*) &TMP3333), ((NI) 3), NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_177220(((NimStringDesc*) &TMP3331));
...
N_NIMCALL(Tllstream177204*, filterreplace_216004)(Tllstream177204* stdin_216006, NimStringDesc* filename, Tnode190813* call) {
	...
	sub = strarg_216029(call, ((NimStringDesc*) &TMP3334), ((NI) 1), ((NimStringDesc*) &TMP3331));
	...
	by = strarg_216029(call, ((NimStringDesc*) &TMP3335), ((NI) 2), ((NimStringDesc*) &TMP3331));
