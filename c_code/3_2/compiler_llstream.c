...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77859 TMP2084 = {
...
N_NIMCALL(Tllstream177204*, llstreamopenstdin_177293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2079));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_177319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13657(stdout, ((NimStringDesc*) &TMP2080));
...
N_NIMCALL(NIM_BOOL, endswith_177404)(NimStringDesc* x, TY77859 s) {
	...
	TMP2081 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2081);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_177450)(NimStringDesc* x) {
	...
	result = endswith_177404(x, TMP2083);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_177460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_177404(line, TMP2084);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(97, "llstream.nim");
			{
				...
				if (!(LOC6)) goto LA7;
				TMP2085 = addInt(i, ((NI) 1));
				if ((NU)((NI)(TMP2085)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC6 = ((NU8)(s->data[(NI)(TMP2085)]) == (NU8)(34));
				LA7: ;
				LOC5 = LOC6;
				if (!(LOC5)) goto LA8;
				TMP2086 = addInt(i, ((NI) 2));
				if ((NU)((NI)(TMP2086)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC5 = ((NU8)(s->data[(NI)(TMP2086)]) == (NU8)(34));
				LA8: ;
				if (!LOC5) goto LA9;
				nimln(98, "llstream.nim");
				TMP2087 = addInt(result, ((NI) 1));
				result = (NI)(TMP2087);
				nimln(99, "llstream.nim");
				TMP2088 = addInt(i, ((NI) 2));
				i = (NI)(TMP2088);
			}
			LA9: ;
...
N_NIMCALL(NI, llreadfromstdin_177528)(Tllstream177204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2079));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	triples = ((NI) 0);
	{
		...
		while (1) {
			...
			LA7: ;
			{
				LOC4 = copyString(((NimStringDesc*) &TMP2091));
			}
			LA5: ;
			LOC10 = 0;
...
appendString((*s).s, ((NimStringDesc*) &TMP2080));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_177483(line);
			TMP2092 = addInt(triples, LOC11);
			triples = (NI)(TMP2092);
	...
	TMP2093 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2093);
...
N_NIMCALL(NI, llstreamread_177584)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		TMP2096 = subInt(((*s).s ? (*s).s->Sup.len : 0), (*s).rd);
		result = ((buflen <= (NI)(TMP2096)) ? buflen : (NI)(TMP2096));
		nimln(124, "llstream.nim");
		{
			...
			TMP2097 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2097)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2097)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(126, "llstream.nim");
			TMP2098 = addInt((*s).rd, result);
			(*s).rd = (NI)(TMP2098);
		}
		LA5: ;
	}
...
appendString((*s).s, data);
		...
		TMP2103 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2103);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_177686)(Tllstream177204* s, NimStringDesc* data) {
	...
	llstreamwrite_177665(s, ((NimStringDesc*) &TMP2080));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_177718)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2105 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2105), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2106 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2106)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2106)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2107 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2107);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2108 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2108), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2109 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2109)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13715((*s).f, ((void*) ((&result->data[(NI)(TMP2109)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2110 = addInt(i, bytes);
				i = (NI)(TMP2110);
			} LA10: ;
		}
...
static TNimNode* TMP2074[6];
static TNimNode* TMP2075[4];
NI TMP2077;
static char* NIM_CONST TMP2076[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2072[12];
...
NTI177202.base = 0;
NTI177202.flags = 3;
for (TMP2077 = 0; TMP2077 < 4; TMP2077++) {
TMP2072[TMP2077+2].kind = 1;
TMP2072[TMP2077+2].offset = TMP2077;
TMP2072[TMP2077+2].name = TMP2076[TMP2077];
TMP2075[TMP2077] = &TMP2072[TMP2077+2];
}
TMP2072[6].len = 4; TMP2072[6].kind = 2; TMP2072[6].sons = &TMP2075[0];
NTI177202.node = &TMP2072[6];
TMP2072[1].kind = 1;
TMP2072[1].offset = offsetof(Tllstream177204, kind);
TMP2072[1].typ = (&NTI177202);
TMP2072[1].name = "kind";
TMP2074[1] = &TMP2072[7];
TMP2072[7].kind = 1;
TMP2072[7].offset = offsetof(Tllstream177204, f);
TMP2072[7].typ = (&NTI13204);
TMP2072[7].name = "f";
TMP2074[2] = &TMP2072[8];
TMP2072[8].kind = 1;
TMP2072[8].offset = offsetof(Tllstream177204, s);
TMP2072[8].typ = (&NTI149);
TMP2072[8].name = "s";
TMP2074[3] = &TMP2072[9];
TMP2072[9].kind = 1;
TMP2072[9].offset = offsetof(Tllstream177204, rd);
TMP2072[9].typ = (&NTI108);
TMP2072[9].name = "rd";
TMP2074[4] = &TMP2072[10];
TMP2072[10].kind = 1;
TMP2072[10].offset = offsetof(Tllstream177204, wr);
TMP2072[10].typ = (&NTI108);
TMP2072[10].name = "wr";
TMP2074[5] = &TMP2072[11];
TMP2072[11].kind = 1;
TMP2072[11].offset = offsetof(Tllstream177204, lineoffset);
TMP2072[11].typ = (&NTI108);
TMP2072[11].name = "lineOffset";
TMP2072[0].len = 6; TMP2072[0].kind = 2; TMP2072[0].sons = &TMP2074[0];
NTI177204.node = &TMP2072[0];
NTI177206.size = sizeof(Tllstream177204*);
NTI177206.kind = 22;
NTI177206.base = (&NTI177204);
NTI177206.marker = TMP2078;
}
