...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77859 TMP2085 = {
...
N_NIMCALL(Tllstream177204*, llstreamopenstdin_177293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2080));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_177319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13657(stdout, ((NimStringDesc*) &TMP2081));
...
N_NIMCALL(NIM_BOOL, endswith_177404)(NimStringDesc* x, TY77859 s) {
	...
	TMP2082 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2082);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_177450)(NimStringDesc* x) {
	...
	result = endswith_177404(x, TMP2084);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_177460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_177404(line, TMP2085);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(97, "llstream.nim");
			{
				...
				LOC6 = ((NU8)(s->data[(NI)(TMP2086)]) == (NU8)(34));
				LA7: ;
				LOC5 = LOC6;
				if (!(LOC5)) goto LA8;
				TMP2087 = addInt(i, ((NI) 2));
				if ((NU)((NI)(TMP2087)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC5 = ((NU8)(s->data[(NI)(TMP2087)]) == (NU8)(34));
				LA8: ;
				if (!LOC5) goto LA9;
				nimln(98, "llstream.nim");
				TMP2088 = addInt(result, ((NI) 1));
				result = (NI)(TMP2088);
				nimln(99, "llstream.nim");
				TMP2089 = addInt(i, ((NI) 2));
				i = (NI)(TMP2089);
			}
			LA9: ;
...
N_NIMCALL(NI, llreadfromstdin_177528)(Tllstream177204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2080));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	triples = ((NI) 0);
	{
		...
		while (1) {
			...
			LA7: ;
			{
				LOC4 = copyString(((NimStringDesc*) &TMP2092));
			}
			LA5: ;
			LOC10 = 0;
...
appendString((*s).s, ((NimStringDesc*) &TMP2081));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_177483(line);
			TMP2093 = addInt(triples, LOC11);
			triples = (NI)(TMP2093);
	...
	TMP2094 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2094);
...
N_NIMCALL(NI, llstreamread_177584)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		TMP2097 = subInt(((*s).s ? (*s).s->Sup.len : 0), (*s).rd);
		result = ((buflen <= (NI)(TMP2097)) ? buflen : (NI)(TMP2097));
		nimln(124, "llstream.nim");
		{
			...
			TMP2098 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2098)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2098)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*s).s, data);
		...
		TMP2104 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2104);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_177686)(Tllstream177204* s, NimStringDesc* data) {
	...
	llstreamwrite_177665(s, ((NimStringDesc*) &TMP2081));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_177718)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2106 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2106), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2107 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2107)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2107)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2108 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2108);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2109 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2109), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2110 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2110)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13715((*s).f, ((void*) ((&result->data[(NI)(TMP2110)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2111 = addInt(i, bytes);
				i = (NI)(TMP2111);
			} LA10: ;
		}
...
static TNimNode* TMP2075[6];
static TNimNode* TMP2076[4];
NI TMP2078;
static char* NIM_CONST TMP2077[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2073[12];
...
NTI177202.base = 0;
NTI177202.flags = 3;
for (TMP2078 = 0; TMP2078 < 4; TMP2078++) {
TMP2073[TMP2078+2].kind = 1;
TMP2073[TMP2078+2].offset = TMP2078;
TMP2073[TMP2078+2].name = TMP2077[TMP2078];
TMP2076[TMP2078] = &TMP2073[TMP2078+2];
}
TMP2073[6].len = 4; TMP2073[6].kind = 2; TMP2073[6].sons = &TMP2076[0];
NTI177202.node = &TMP2073[6];
TMP2073[1].kind = 1;
TMP2073[1].offset = offsetof(Tllstream177204, kind);
TMP2073[1].typ = (&NTI177202);
TMP2073[1].name = "kind";
TMP2075[1] = &TMP2073[7];
TMP2073[7].kind = 1;
TMP2073[7].offset = offsetof(Tllstream177204, f);
TMP2073[7].typ = (&NTI13204);
TMP2073[7].name = "f";
TMP2075[2] = &TMP2073[8];
TMP2073[8].kind = 1;
TMP2073[8].offset = offsetof(Tllstream177204, s);
TMP2073[8].typ = (&NTI149);
TMP2073[8].name = "s";
TMP2075[3] = &TMP2073[9];
TMP2073[9].kind = 1;
TMP2073[9].offset = offsetof(Tllstream177204, rd);
TMP2073[9].typ = (&NTI108);
TMP2073[9].name = "rd";
TMP2075[4] = &TMP2073[10];
TMP2073[10].kind = 1;
TMP2073[10].offset = offsetof(Tllstream177204, wr);
TMP2073[10].typ = (&NTI108);
TMP2073[10].name = "wr";
TMP2075[5] = &TMP2073[11];
TMP2073[11].kind = 1;
TMP2073[11].offset = offsetof(Tllstream177204, lineoffset);
TMP2073[11].typ = (&NTI108);
TMP2073[11].name = "lineOffset";
TMP2073[0].len = 6; TMP2073[0].kind = 2; TMP2073[0].sons = &TMP2075[0];
NTI177204.node = &TMP2073[0];
NTI177206.size = sizeof(Tllstream177204*);
NTI177206.kind = 22;
NTI177206.base = (&NTI177204);
NTI177206.marker = TMP2079;
}
