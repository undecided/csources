...
STRING_LITERAL(TMP2470, "@if", 3);
STRING_LITERAL(TMP2471, "@", 1);
STRING_LITERAL(TMP2474, "@end", 4);
STRING_LITERAL(TMP2476, "putenv", 6);
STRING_LITERAL(TMP2477, "prependenv", 10);
STRING_LITERAL(TMP2478, "appendenv", 9);
STRING_LITERAL(TMP2479, "-", 1);
STRING_LITERAL(TMP2480, "--", 2);
STRING_LITERAL(TMP2481, "", 0);
STRING_LITERAL(TMP2482, "\']\'", 3);
STRING_LITERAL(TMP2483, "%=", 2);
STRING_LITERAL(TMP2484, "&", 1);
STRING_LITERAL(TMP2490, "config", 6);
STRING_LITERAL(TMP2491, "etc", 3);
STRING_LITERAL(TMP2492, "/etc/", 5);
STRING_LITERAL(TMP2493, "/usr", 4);
STRING_LITERAL(TMP2494, "/usr/lib/nim", 12);
STRING_LITERAL(TMP2495, "/usr/local", 10);
STRING_LITERAL(TMP2496, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP2497, "lib", 3);
STRING_LITERAL(TMP2501, "nimcfg", 6);
STRING_LITERAL(TMP2502, "nim.cfg", 7);
STRING_LITERAL(TMP2503, "nimrod.cfg", 10);
...
N_NIMCALL(void, doend_185191)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(61, "nimconf.nim");
	{
		...
		lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2470));
	}
	LA3: ;
	...
	nestedifs = ((NI) 0);
	{
		...
		while (1) {
			nimln(85, "nimconf.nim");
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2471));
				LA6: ;
				if (!LOC5) goto LA7;
				...
				case ((NU16) 22):
				{
					...
					nimln(102, "nimconf.nim");
					{
						...
						TMP2473 = subInt(nestedifs, ((NI) 1));
						nestedifs = (NI)(TMP2473);
					}
					LA32: ;
				}
				break;
...
N_NIMCALL(void, parsedirective_185342)(Tlexer180185* L, Ttoken180181* tok) {
	...
	case ((NU16) 31):
	{
		...
		TMP2475 = addInt((condstack_185186 ? condstack_185186->Sup.len : 0), ((NI) 1));
		condstack_185186 = (TY185169*) setLengthSeq(&(condstack_185186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((NI)(TMP2475), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2476))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2477))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2478))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_185377)(Tlexer180185* L, Ttoken180181* tok) {
	...
	ppgettok_185009(L, tok);
	{
		...
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2471));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_185439)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(159, "nimconf.nim");
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_166463(((NimStringDesc*) &TMP2479));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_166463(((NimStringDesc*) &TMP2480));
	...
	val = copyString(((NimStringDesc*) &TMP2481));
	{
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			...
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2482));
		}
		LA17: ;
	...
	LOC22 = 0;
	LOC22 = getident_166463(((NimStringDesc*) &TMP2483));
...
appendString(val, LOC33);
		...
		conftok_185377(L, tok);
		{
			...
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_166463(((NimStringDesc*) &TMP2484));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_185594)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP2490));
	...
	nimln(225, "nimconf.nim");
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP2491));
...
appendString(LOC13, ((NimStringDesc*) &TMP2492));
...
N_NIMCALL(void, loadconfigs_185809)(NimStringDesc* cfg) {
	...
	nimln(230, "nimconf.nim");
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP2493))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2494));
		...
		LA7: ;
		{
			...
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP2495))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2496));
		...
		LA11: ;
		{
			...
			asgnRefNoCycle((void**) (&libpath_153233), nosjoinPath(prefix, ((NimStringDesc*) &TMP2497)));
		}
		LA5: ;
	}
	LA3: ;
			...
			{
				{
					...
					HEX3Atmp_186055 = 0;
					nimln(643, "os.nim");
					TMP2498 = subInt((pd ? pd->Sup.len : 0), ((NI) 2));
					HEX3Atmp_186055 = (NI)(TMP2498);
					...
					res_186057 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(645, "os.nim");
							{
								...
								LOC60 = (i_186053 == ((NI) 0));
								if (LOC60) goto LA61;
								TMP2499 = subInt(i_186053, ((NI) 1));
								if ((NU)((NI)(TMP2499)) > (NU)(pd->Sup.len)) raiseIndexError();
								LOC60 = !((((NU8)(pd->data[(NI)(TMP2499)])) == ((NU8)(47)) || ((NU8)(pd->data[(NI)(TMP2499)])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
							...
							TMP2500 = addInt(res_186057, ((NI) 1));
							res_186057 = (NI)(TMP2500);
						} LA55: ;
					}
				}
				nimln(649, "os.nim");
	...
	nimln(250, "nimconf.nim");
	{
		...
		nimln(253, "nimconf.nim");
		{
			...
			nimln(258, "nimconf.nim");
			{
				...
				projectconfig = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP2503));
