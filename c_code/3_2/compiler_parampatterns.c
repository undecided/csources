...
static NIM_CONST TY192031 TMP4678 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4679, "strVal", 6);
static NIM_CONST TY192031 TMP4680 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4681, "sons", 4);
static NIM_CONST TY192031 TMP4682 = {
...
STRING_LITERAL(TMP4699, "parampatterns.nim", 17);
NIM_CONST TY147011 TMP4698 = {((NimStringDesc*) &TMP4699),
((NI) 100)}
;
NIM_CONST TY147011 TMP4701 = {((NimStringDesc*) &TMP4699),
((NI) 107)}
;
STRING_LITERAL(TMP4703, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP4705, "parameter pattern too complex", 29);
static NIM_CONST TY192031 TMP4706 = {
			...
			LA67: ;
			{
				...
				res_269644 = ((NI) 0);
				{
					...
					while (1) {
						...
						i_269423 = ((NU8)chckRange(res_269644, ((NU8) 0), ((NU8) 25)));
						...
						TMP4700 = addInt(res_269644, ((NI) 1));
						res_269644 = (NI)(TMP4700);
					} LA72: ;
				}
			}
			nimln(854, "msgs.nim");
			...
			LA81: ;
			{
				...
				res_269652 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1600, "system.nim");
						i_269623 = ((NU8)chckRange(res_269652, ((NU8) 0), ((NU8) 158)));
						...
						LA90: ;
						nimln(1619, "system.nim");
						TMP4702 = addInt(res_269652, ((NI) 1));
						res_269652 = (NI)(TMP4702);
					} LA86: ;
				}
			}
...
N_NIMCALL(Tnode191813*, semnodekindconstraints_269679)(Tnode191813* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		if (!(((NI) 2) <= LOC7)) goto LA8;
		{
			...
			LOC11 = 0;
			LOC11 = len_192097(p);
			HEX3Atmp_269839 = subInt(LOC11, 1);
			nimln(1598, "system.nim");
			res_269842 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					NI TMP4704;
					if (!(res_269842 <= HEX3Atmp_269839)) goto LA13;
					nimln(1600, "system.nim");
					i_269831 = res_269842;
					nimln(126, "parampatterns.nim");
					if (((TMP4680[(*p).kind/8] &(1<<((*p).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4681));
					if ((NU)(i_269831) >= (NU)((*p).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (!(((TMP4678[(*result).kind/8] &(1<<((*result).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4679));
					compileconstraints_269113((*p).kindU.S6.sons->data[i_269831], (&(*result).kindU.S3.strval));
					nimln(1619, "system.nim");
					TMP4704 = addInt(res_269842, ((NI) 1));
					res_269842 = (NI)(TMP4704);
				} LA13: ;
			}
		}
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_165199((*p).info, ((NimStringDesc*) &TMP4705));
		}
		LA16: ;
	}
	goto LA5;
...
{	result = 0;
	...
	case ((NU8) 32):
	{
		...
		LA2: ;
		{
			...
			LOC17 = 0;
			LOC17 = len_192097(n);
			HEX3Atmp_270007 = subInt(LOC17, 1);
			nimln(1598, "system.nim");
			res_270010 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					if (((TMP4680[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4681));
					if ((NU)(i_269927) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP4708 = addInt(res_270010, ((NI) 1));
					res_270010 = (NI)(TMP4708);
				} LA19: ;
			}
		}
	}
	...
	default:
	{
		...
		result = ((NU8) 2);
		{
			...
			LOC32 = 0;
			LOC32 = len_192097(n);
			HEX3Atmp_270015 = subInt(LOC32, 1);
			nimln(1598, "system.nim");
			res_270018 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					if (((TMP4680[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4681));
					if ((NU)(i_269976) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
					...
					LA35: ;
					nimln(1619, "system.nim");
					TMP4709 = addInt(res_270018, ((NI) 1));
					res_270018 = (NI)(TMP4709);
				} LA34: ;
			}
		}
	}
