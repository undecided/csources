...
static NIM_CONST TY191031 TMP4678 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4679, "strVal", 6);
static NIM_CONST TY191031 TMP4680 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4681, "sons", 4);
...
STRING_LITERAL(TMP4687, "atom", 4);
STRING_LITERAL(TMP4688, "lit", 3);
STRING_LITERAL(TMP4689, "sym", 3);
STRING_LITERAL(TMP4690, "ident", 5);
STRING_LITERAL(TMP4691, "call", 4);
STRING_LITERAL(TMP4692, "alias", 5);
STRING_LITERAL(TMP4693, "noalias", 7);
STRING_LITERAL(TMP4694, "lvalue", 6);
STRING_LITERAL(TMP4695, "local", 5);
STRING_LITERAL(TMP4696, "sideeffect", 10);
STRING_LITERAL(TMP4697, "nosideeffect", 12);
STRING_LITERAL(TMP4699, "compiler/parampatterns.nim", 26);
NIM_CONST TY146211 TMP4698 = {((NimStringDesc*) &TMP4699),
((NI) 100)}
;
NIM_CONST TY146211 TMP4701 = {((NimStringDesc*) &TMP4699),
((NI) 107)}
;
STRING_LITERAL(TMP4703, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP4705, "parameter pattern too complex", 29);
static NIM_CONST TY191031 TMP4706 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4707, "sym", 3);
...
N_NIMCALL(NU8, whichalias_268080)(Tsym190843* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		if (!(((TMP4678[(*(*p).constraint).kind/8] &(1<<((*(*p).constraint).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4679));
...
static N_INLINE(NI, len_191097)(Tnode190813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP4680[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4681));
...
{	nimln(57, "parampatterns.nim");
	...
	case ((NU8) 32):
	{
		...
		if (((TMP4680[(*p).kind/8] &(1<<((*p).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4681));
		if ((NU)(((NI) 0)) >= (NU)((*p).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP4682[(*(*p).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*p).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4683));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).s, ((NimStringDesc*) &TMP4684));
				if (LOC13) goto LA14;
			...
			LA15: ;
			{
				...
				LOC18 = 0;
				LOC18 = eqStrings((*op).s, ((NimStringDesc*) &TMP4685));
				if (LOC18) goto LA19;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).s, ((NimStringDesc*) &TMP4686));
			if (LOC27) goto LA28;
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4697))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4689))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP4694))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP4696))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4690))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4693))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4687))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4688))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4691))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4692))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP4695))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
			...
			LA67: ;
			{
				...
				res_268644 = ((NI) 0);
				{
					...
					while (1) {
						...
						TMP4700 = addInt(res_268644, ((NI) 1));
						res_268644 = (NI)(TMP4700);
					} LA72: ;
				}
			}
			nimln(854, "msgs.nim");
			...
			LA81: ;
			{
				...
				res_268652 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA90: ;
						nimln(1619, "system.nim");
						TMP4702 = addInt(res_268652, ((NI) 1));
						res_268652 = (NI)(TMP4702);
					} LA86: ;
				}
			}
...
N_NIMCALL(Tnode190813*, semnodekindconstraints_268679)(Tnode190813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4703));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_192351(((NU8) 20), (*p).info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP4678[(*result).kind/8] &(1<<((*result).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4679));
	...
	nimln(124, "parampatterns.nim");
	{
		...
		if (!(((NI) 2) <= LOC7)) goto LA8;
		{
			...
			res_268842 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4704 = addInt(res_268842, ((NI) 1));
					res_268842 = (NI)(TMP4704);
				} LA13: ;
			}
		}
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_164199((*p).info, ((NimStringDesc*) &TMP4705));
		}
		LA16: ;
	}
	goto LA5;
...
{	result = 0;
	...
	case ((NU8) 32):
	{
		...
		nimln(142, "parampatterns.nim");
		{
			...
			LOC4 = ((*op).kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			if (!(((TMP4706[(*op).kind/8] &(1<<((*op).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4707));
		...
		LA2: ;
		{
			...
			res_269010 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP4708 = addInt(res_269010, ((NI) 1));
					res_269010 = (NI)(TMP4708);
				} LA19: ;
			}
		}
	}
		...
		result = ((NU8) 2);
		{
			...
			res_269018 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA35: ;
					nimln(1619, "system.nim");
					TMP4709 = addInt(res_269018, ((NI) 1));
					res_269018 = (NI)(TMP4709);
				} LA34: ;
			}
		}
	}
...
N_NIMCALL(NU8, isassignable_269056)(Tsym190843* owner, Tnode190813* n) {
	...
	case ((NU8) 3):
	{
		...
		{
			if (!(((TMP4706[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4707));
	...
	case ((NU8) 45):
	{
		...
		nimln(204, "parampatterns.nim");
		{
			...
			if (!(((TMP4706[(*(*n).kindU.S6.sons->data[((NI) 1)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 1)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4707));
...
N_NIMCALL(NIM_BOOL, matchnodekinds_269284)(Tnode190813* p, Tnode190813* n) {
	...
	if (!(((TMP4678[(*p).kind/8] &(1<<((*p).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4679));
	...
	pc = ((NI) 1);
	{
		...
		while (1) {
			...
			case ((NU8) 2):
			{
				...
				LOC5 = stack[((NI)(TMP4711))- 0];
				if (LOC5) goto LA6;
				TMP4712 = subInt(sp, ((NI) 2));
				if ((NU)((NI)(TMP4712)) > (NU)(64)) raiseIndexError();
				LOC5 = stack[((NI)(TMP4712))- 0];
				LA6: ;
				stack[((NI)(TMP4710))- 0] = LOC5;
			...
			case ((NU8) 3):
			{
				...
				LOC8 = stack[((NI)(TMP4715))- 0];
				if (!(LOC8)) goto LA9;
				TMP4716 = subInt(sp, ((NI) 2));
				if ((NU)((NI)(TMP4716)) > (NU)(64)) raiseIndexError();
				LOC8 = stack[((NI)(TMP4716))- 0];
				LA9: ;
				stack[((NI)(TMP4714))- 0] = LOC8;
			...
			case ((NU8) 4):
			{
				...
				stack[((NI)(TMP4718))- 0] = !(stack[((NI)(TMP4719))- 0]);
			}
			break;
			case ((NU8) 5):
			{
			...
			case ((NU8) 10):
			{
				...
				TMP4725 = addInt(pc, ((NI) 1));
				if ((NU)((NI)(TMP4725)) > (NU)(code->Sup.len)) raiseIndexError();
				kind = ((NU8)chckRange(((NU8)(code->data[(NI)(TMP4725)])), ((NU8) 0), ((NU8) 25)));
				nimln(243, "parampatterns.nim");
				if ((NU)(sp) > (NU)(64)) raiseIndexError();
			...
			case ((NU8) 11):
			{
				...
				if ((NU)((NI)(TMP4728)) > (NU)(code->Sup.len)) raiseIndexError();
				kind = ((NU8)chckRange(((NU8)(code->data[(NI)(TMP4728)])), ((NU8) 0), ((NU8) 158)));
				nimln(243, "parampatterns.nim");
				if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	TMP4736 = subInt(sp, ((NI) 1));
	if ((NU)((NI)(TMP4736)) > (NU)(64)) raiseIndexError();
	result = stack[((NI)(TMP4736))- 0];
	popFrame();
	return result;
}
