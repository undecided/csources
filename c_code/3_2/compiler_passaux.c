...
STRING_LITERAL(TMP10574, "logpass: context is not nil", 27);
...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP10577, "sons", 4);
static NIM_CONST TY191031 TMP10579 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP10580, "sym", 3);
...
N_NIMCALL(Tnode190813*, verboseprocess_505023)(Tpasscontext241005* context, Tnode190813* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		internalerror_164218(((NimStringDesc*) &TMP10574));
	}
	LA3: ;
...
{	result = 0;
	...
	{
		{
			...
			res_505137 = ((NI) 0);
			{
				...
				while (1) {
					...
					i_505105 = res_505137;
					nimln(37, "passaux.nim");
					if (((TMP10576[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10577));
					if ((NU)(i_505105) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
					LOC12 = 0;
					LOC12 = cleanup_505066(c, (*n).kindU.S6.sons->data[i_505105]);
					nimln(1614, "system.nim");
					TMP10578 = addInt(res_505137, ((NI) 1));
					res_505137 = (NI)(TMP10578);
				} LA11: ;
			}
		}
	}
	...
	case ((NU8) 80):
	{
		nimln(39, "passaux.nim");
		{
			...
			if (((TMP10576[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10577));
			if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP10579[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP10580));
			...
			nimln(41, "passaux.nim");
			{
				...
				if (((TMP10576[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10577));
