...
STRING_LITERAL(TMP2510, "counter < length ", 17);
STRING_LITERAL(TMP2516, "not (data[h] == desc) ", 22);
STRING_LITERAL(TMP2517, "data[h] == nil ", 15);
STRING_LITERAL(TMP2528, "t.data[h] == nil ", 17);
STRING_LITERAL(TMP2529, "dest.data[h] == nil ", 20);
...
static N_INLINE(NIM_BOOL, mustrehash_187073)(NI length, NI counter) {
	...
	nimln(48, "intsets.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2510));
	}
	LA3: ;
	nimln(49, "intsets.nim");
	LOC5 = 0;
	TMP2511 = mulInt(length, ((NI) 2));
	TMP2512 = mulInt(counter, ((NI) 3));
	LOC5 = ((NI)(TMP2511) < (NI)(TMP2512));
	if (LOC5) goto LA6;
	TMP2513 = subInt(length, counter);
	LOC5 = ((NI)(TMP2513) < ((NI) 4));
	LA6: ;
	result = LOC5;
	popFrame();
	return result;
...
static N_INLINE(NI, nexttry_187207)(NI h, NI maxhash) {
	...
	TMP2514 = mulInt(((NI) 5), h);
	TMP2515 = addInt((NI)(TMP2514), ((NI) 1));
	result = (NI)((NI)(TMP2515) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, intsetrawinsert_187249)(Intset187056* t, Ttrunkseq187054** data, Ttrunk187052* desc) {
	...
	nimln(67, "intsets.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2517));
	}
	LA9: ;
...
N_NIMCALL(void, intsetenlarge_187614)(Intset187056* t) {
	...
	TMP2519 = mulInt((NI)(TMP2518), ((NI) 2));
	TMP2520 = subInt((NI)(TMP2519), ((NI) 1));
	(*t).max = (NI)(TMP2520);
	nimln(74, "intsets.nim");
	TMP2521 = addInt((*t).max, ((NI) 1));
	n = (Ttrunkseq187054*) newSeq((&NTI187054), ((NI)chckRange((NI)(TMP2521), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_187642;
		NI res_187670;
		i_187642 = 0;
		...
		res_187670 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP2525 = addInt(res_187670, ((NI) 1));
				res_187670 = (NI)(TMP2525);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(85, "intsets.nim");
	{
		...
		LOC9 = 0;
		LOC9 = mustrehash_187073((NI)(TMP2526), (*t).counter);
		if (!LOC9) goto LA10;
		intsetenlarge_187614(t);
	}
	LA10: ;
	nimln(86, "intsets.nim");
	TMP2527 = addInt((*t).counter, ((NI) 1));
	(*t).counter = (NI)(TMP2527);
	...
	it = (*src).head;
	{
		...
		while (1) {
			...
			nimln(153, "intsets.nim");
			{
				...
				failedassertimpl_87217(((NimStringDesc*) &TMP2529));
			}
			LA7: ;
			n = 0;
...
N_NIMCALL(NimStringDesc*, HEX24_188318)(Intset187056* s) {
	...
	result = copyString(((NimStringDesc*) &TMP2530));
	{
		NI key_188323;
...
appendString(result, ((NimStringDesc*) &TMP2531));
									}
									LA14: ;
...
static TNimNode* TMP2522[3];
static TNimNode* TMP4197[4];
static TNimNode TMP2508[9];
NTI187052.size = sizeof(Ttrunk187052);
NTI187052.kind = 18;
NTI187052.base = 0;
TMP2522[0] = &TMP2508[1];
TMP2508[1].kind = 1;
TMP2508[1].offset = offsetof(Ttrunk187052, next);
TMP2508[1].typ = (&NTI187050);
TMP2508[1].name = "next";
TMP2522[1] = &TMP2508[2];
TMP2508[2].kind = 1;
TMP2508[2].offset = offsetof(Ttrunk187052, key);
TMP2508[2].typ = (&NTI108);
TMP2508[2].name = "key";
TMP2522[2] = &TMP2508[3];
TMP2508[3].kind = 1;
TMP2508[3].offset = offsetof(Ttrunk187052, bits);
TMP2508[3].typ = (&NTI28020);
TMP2508[3].name = "bits";
TMP2508[0].len = 3; TMP2508[0].kind = 2; TMP2508[0].sons = &TMP2522[0];
NTI187052.node = &TMP2508[0];
NTI187050.size = sizeof(Ttrunk187052*);
NTI187050.kind = 22;
NTI187050.base = (&NTI187052);
NTI187050.marker = TMP2523;
NTI187054.size = sizeof(Ttrunkseq187054*);
NTI187054.kind = 24;
NTI187054.base = (&NTI187050);
NTI187054.flags = 2;
NTI187054.marker = TMP2524;
...
TMP4197[0] = &TMP2508[5];
TMP2508[5].kind = 1;
TMP2508[5].offset = offsetof(Intset187056, counter);
TMP2508[5].typ = (&NTI108);
TMP2508[5].name = "counter";
TMP4197[1] = &TMP2508[6];
TMP2508[6].kind = 1;
TMP2508[6].offset = offsetof(Intset187056, max);
TMP2508[6].typ = (&NTI108);
TMP2508[6].name = "max";
TMP4197[2] = &TMP2508[7];
TMP2508[7].kind = 1;
TMP2508[7].offset = offsetof(Intset187056, head);
TMP2508[7].typ = (&NTI187050);
TMP2508[7].name = "head";
TMP4197[3] = &TMP2508[8];
TMP2508[8].kind = 1;
TMP2508[8].offset = offsetof(Intset187056, data);
TMP2508[8].typ = (&NTI187054);
TMP2508[8].name = "data";
TMP2508[4].len = 4; TMP2508[4].kind = 2; TMP2508[4].sons = &TMP4197[0];
NTI187056.node = &TMP2508[4];
}
