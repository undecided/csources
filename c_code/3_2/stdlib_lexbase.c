...
NIM_CONST TY77859 Newlines_246018 = {
0x00, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4218, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP4221, "0 <= toCopy ", 12);
STRING_LITERAL(TMP4230, "s < L.bufLen ", 13);
STRING_LITERAL(TMP4235, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP4241, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP4243, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP4245, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP4249, "0 < bufLen ", 11);
STRING_LITERAL(TMP4250, "not (input == nil) ", 19);
STRING_LITERAL(TMP4254, "", 0);
STRING_LITERAL(TMP4256, "\012", 1);
STRING_LITERAL(TMP4257, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_246102)(Baselexer246024* L) {
	...
	nimln(79, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4218));
	}
	LA3: ;
	nimln(80, "lexbase.nim");
	TMP4219 = subInt((*L).buflen, (*L).sentinel);
	TMP4220 = subInt((NI)(TMP4219), ((NI) 1));
	tocopy = (NI)(TMP4220);
	...
	nimln(82, "lexbase.nim");
	{
		...
		TMP4222 = addInt((*L).sentinel, ((NI) 1));
		TMP4223 = mulInt(tocopy, ((NI) 1));
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4222)]))), ((NI)chckRange((NI)(TMP4223), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
	...
	nimln(85, "lexbase.nim");
	nimln(86, "lexbase.nim");
	TMP4224 = addInt((*L).sentinel, ((NI) 1));
	TMP4225 = mulInt((NI)(TMP4224), ((NI) 1));
	LOC13 = 0;
	LOC13 = readdata_138174((*L).input, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP4225));
	TMP4226 = divInt(LOC13, ((NI) 1));
	charsread = (NI)(TMP4226);
	nimln(87, "lexbase.nim");
	TMP4227 = addInt(tocopy, charsread);
	s = (NI)(TMP4227);
	nimln(88, "lexbase.nim");
	{
		NI TMP4228;
		TMP4228 = addInt((*L).sentinel, ((NI) 1));
		if (!(charsread < (NI)(TMP4228))) goto LA16;
		...
		s = (NI)(TMP4229);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					TMP4232 = mulInt((*L).buflen, ((NI) 2));
					(*L).buflen = (NI)(TMP4232);
					nimln(106, "lexbase.nim");
					TMP4233 = mulInt((*L).buflen, ((NI) 1));
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4233), ((NI) 0), ((NI) IL64(9223372036854775807)))));
					(*L).buf = ((NCSTRING) (LOC34));
					nimln(107, "lexbase.nim");
					{
						NI TMP4234;
						TMP4234 = subInt((*L).buflen, oldbuflen);
						if (!!(((NI)(TMP4234) == oldbuflen))) goto LA37;
						failedassertimpl_87217(((NimStringDesc*) &TMP4235));
					}
					LA37: ;
					...
					nimln(108, "lexbase.nim");
					nimln(109, "lexbase.nim");
					TMP4236 = mulInt(oldbuflen, ((NI) 1));
					LOC39 = 0;
					LOC39 = readdata_138174((*L).input, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP4236));
					TMP4237 = divInt(LOC39, ((NI) 1));
					...
					nimln(110, "lexbase.nim");
					{
						...
						TMP4239 = addInt(oldbuflen, charsread);
						(*L).sentinel = (NI)(TMP4239);
						nimln(113, "lexbase.nim");
						goto LA19;
					}
					LA42: ;
					nimln(114, "lexbase.nim");
					TMP4240 = subInt((*L).buflen, ((NI) 1));
					s = (NI)(TMP4240);
				}
				LA29: ;
			}
...
N_NIMCALL(NI, fillbaselexer_246827)(Baselexer246024* L, NI pos) {
	...
	nimln(117, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4241));
	}
	LA3: ;
...
N_NIMCALL(NI, handlecr_246071)(Baselexer246024* L, NI pos) {
	...
	nimln(127, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4243));
	}
	LA3: ;
	nimln(128, "lexbase.nim");
	TMP4244 = addInt((*L).linenumber, ((NI) 1));
	(*L).linenumber = (NI)(TMP4244);
...
N_NIMCALL(NI, handlelf_246079)(Baselexer246024* L, NI pos) {
	...
	nimln(134, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4245));
	}
	LA3: ;
	nimln(135, "lexbase.nim");
	TMP4246 = addInt((*L).linenumber, ((NI) 1));
	(*L).linenumber = (NI)(TMP4246);
...
N_NIMCALL(void, skiputf8bom_247416)(Baselexer246024* L) {
	...
	nimln(139, "lexbase.nim");
	{
		...
		TMP4247 = addInt((*L).bufpos, ((NI) 3));
		(*L).bufpos = (NI)(TMP4247);
		nimln(141, "lexbase.nim");
		TMP4248 = addInt((*L).linestart, ((NI) 3));
		(*L).linestart = (NI)(TMP4248);
	}
	LA7: ;
	popFrame();
}
...
N_NIMCALL(void, open_246040)(Baselexer246024* L, Streamobj138027* input, NI buflen) {
	...
	nimln(145, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4250));
	}
	LA7: ;
	...
	TMP4251 = mulInt(buflen, ((NI) 1));
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4251), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC9));
	nimln(150, "lexbase.nim");
	TMP4252 = subInt(buflen, ((NI) 1));
	(*L).sentinel = (NI)(TMP4252);
...
N_NIMCALL(NI, getcolnumber_246064)(Baselexer246024* L, NI pos) {
	...
	TMP4253 = subInt(pos, (*L).linestart);
	if ((NI)(TMP4253) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = ((NI)(TMP4253) > 0? ((NI)(TMP4253)) : -((NI)(TMP4253)));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_246057)(Baselexer246024* L, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP4254));
	...
	i = (*L).linestart;
	{
		...
		while (1) {
			...
			TMP4255 = addInt(i, ((NI) 1));
			i = (NI)(TMP4255);
		} LA2: ;
	}
	nimln(166, "lexbase.nim");
	result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP4256));
...
appendString(LOC7, ((NimStringDesc*) &TMP4257));
...
static TNimNode* TMP4262[8];
static TNimNode TMP4216[9];
NTI246024.size = sizeof(Baselexer246024);
NTI246024.kind = 17;
NTI246024.base = (&NTI3411);
TMP4262[0] = &TMP4216[1];
TMP4216[1].kind = 1;
TMP4216[1].offset = offsetof(Baselexer246024, bufpos);
TMP4216[1].typ = (&NTI108);
TMP4216[1].name = "bufpos";
TMP4262[1] = &TMP4216[2];
TMP4216[2].kind = 1;
TMP4216[2].offset = offsetof(Baselexer246024, buf);
TMP4216[2].typ = (&NTI151);
TMP4216[2].name = "buf";
TMP4262[2] = &TMP4216[3];
TMP4216[3].kind = 1;
TMP4216[3].offset = offsetof(Baselexer246024, buflen);
TMP4216[3].typ = (&NTI108);
TMP4216[3].name = "bufLen";
TMP4262[3] = &TMP4216[4];
TMP4216[4].kind = 1;
TMP4216[4].offset = offsetof(Baselexer246024, input);
TMP4216[4].typ = (&NTI138025);
TMP4216[4].name = "input";
TMP4262[4] = &TMP4216[5];
TMP4216[5].kind = 1;
TMP4216[5].offset = offsetof(Baselexer246024, linenumber);
TMP4216[5].typ = (&NTI108);
TMP4216[5].name = "lineNumber";
TMP4262[5] = &TMP4216[6];
TMP4216[6].kind = 1;
TMP4216[6].offset = offsetof(Baselexer246024, sentinel);
TMP4216[6].typ = (&NTI108);
TMP4216[6].name = "sentinel";
TMP4262[6] = &TMP4216[7];
TMP4216[7].kind = 1;
TMP4216[7].offset = offsetof(Baselexer246024, linestart);
TMP4216[7].typ = (&NTI108);
TMP4216[7].name = "lineStart";
TMP4262[7] = &TMP4216[8];
TMP4216[8].kind = 1;
TMP4216[8].offset = offsetof(Baselexer246024, fileopened);
TMP4216[8].typ = (&NTI138);
TMP4216[8].name = "fileOpened";
TMP4216[0].len = 8; TMP4216[0].kind = 2; TMP4216[0].sons = &TMP4262[0];
NTI246024.node = &TMP4216[0];
}
