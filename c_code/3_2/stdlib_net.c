...
{	nimln(879, "net.nim");
	...
	nimln(885, "net.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_518018).Sup.Sup.message; (*e_518018).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10641));
...
{	result = 0;
	...
	LA4: ;
	nimln(596, "net.nim");
	fds = (TY511647*) newSeq((&NTI511647), 1);
	LOC6[0] = (*readfd).fd;
	fds->data[0] = LOC6[0];
	nimln(597, "net.nim");
...
{	nimln(794, "net.nim");
	...
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		...
		while (1) {
			...
			nimln(799, "net.nim");
			LOC3 = 0;
			LOC3 = waitfor_516818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10654));
			nimln(800, "net.nim");
			...
			nimln(803, "net.nim");
			{
				...
				nimln(804, "net.nim");
				LOC20 = 0;
				LOC20 = waitfor_516818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10654));
				nimln(805, "net.nim");
