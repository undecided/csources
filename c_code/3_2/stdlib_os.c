...
static N_INLINE(NimStringDesc*, pop_123871)(TY13806** s) {
	...
	(*s) = (TY13806*) setLengthSeq(&((*s))->Sup, sizeof(NimStringDesc*), ((NI)chckRange(L, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	popFrame();
	return result;
}
...
N_NIMCALL(NI, paramcount_126030)(void) {
	...
	if (TMP1822 < (-2147483647 -1) || TMP1822 > 2147483647) raiseOverflow();
