...
STRING_LITERAL(TMP585, "echoExecCmd::", 13);
STRING_LITERAL(TMP586, "0 < n ", 6);
static NIM_CONST TY143809 TMP592 = {NIM_NIL,NIM_NIL};
...
NIM_CONST TY146211 TMP651 = {((NimStringDesc*) &TMP607),
((NI) -1)}
;
...
N_NIMCALL(NI, echoexeccmd_143629)(NimStringDesc* command) {
	...
	printf("%s\012", ((NimStringDesc*) &TMP585)? (((NimStringDesc*) &TMP585))->data:"nil");
		...
		getenvvarsc_122404();
		{
			...
			res_144892 = ((NI) 0);
			{
				...
				while (1) {
					...
					key_144858 = copyStrLast(environment_122209->data[i_144888], ((NI) 0), (NI)(TMP616));
					nimln(1213, "os.nim");
					if ((NU)(i_144888) >= (NU)(environment_122209->Sup.len)) raiseIndexError();
					TMP617 = addInt(p_144896, ((NI) 1));
					val_144859 = copyStr(environment_122209->data[i_144888], (NI)(TMP617));
		...
		getenvvarsc_122404();
		{
			...
			res_144913 = ((NI) 0);
			{
				...
				while (1) {
					...
					key_144871 = copyStrLast(environment_122209->data[i_144909], ((NI) 0), (NI)(TMP622));
					nimln(1213, "os.nim");
					if ((NU)(i_144909) >= (NU)(environment_122209->Sup.len)) raiseIndexError();
					TMP623 = addInt(p_144917, ((NI) 1));
					val_144872 = copyStr(environment_122209->data[i_144909], (NI)(TMP623));
...
TMP537[0].len = 8; TMP537[0].kind = 2; TMP537[0].sons = &TMP587[0];
