...
N_NIMCALL(void, TMP4066)(void* p, NI op);
...
STRING_LITERAL(TMP4059, "0 <= elem ", 10);
...
N_NIMCALL(NIM_BOOL, bitsetin_240077)(Tbitset240012* x, NI64 e) {
	...
	TMP4057 = divInt64(e, IL64(8));
	if ((NU)((NI64)(TMP4057)) >= (NU)(x->Sup.len)) raiseIndexError();
	TMP4058 = modInt64(e, IL64(8));
	result = !(((NI8)(x->data[(NI64)(TMP4057)] & ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4058)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_240061)(Tbitset240012** x, NI64 elem) {
	...
	nimln(38, "bitsets.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4059));
	}
	LA3: ;
	nimln(39, "bitsets.nim");
	TMP4060 = divInt64(elem, IL64(8));
	if ((NU)((NI64)(TMP4060)) >= (NU)((*x)->Sup.len)) raiseIndexError();
	TMP4061 = divInt64(elem, IL64(8));
	if ((NU)((NI64)(TMP4061)) >= (NU)((*x)->Sup.len)) raiseIndexError();
	nimln(40, "bitsets.nim");
	TMP4062 = modInt64(elem, IL64(8));
	(*x)->data[(NI64)(TMP4060)] = (NI8)((*x)->data[(NI64)(TMP4061)] | ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4062))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_240069)(Tbitset240012** x, NI64 elem) {
	...
	TMP4063 = divInt64(elem, IL64(8));
	if ((NU)((NI64)(TMP4063)) >= (NU)((*x)->Sup.len)) raiseIndexError();
	TMP4064 = divInt64(elem, IL64(8));
	if ((NU)((NI64)(TMP4064)) >= (NU)((*x)->Sup.len)) raiseIndexError();
	nimln(44, "bitsets.nim");
	TMP4065 = modInt64(elem, IL64(8));
	(*x)->data[(NI64)(TMP4063)] = (NI8)((*x)->data[(NI64)(TMP4064)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4065))))))))));
	popFrame();
}
	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_240265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4067 = addInt(res_240265, ((NI) 1));
				res_240265 = (NI)(TMP4067);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_240306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4068 = addInt(res_240306, ((NI) 1));
				res_240306 = (NI)(TMP4068);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_240347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4069 = addInt(res_240347, ((NI) 1));
				res_240347 = (NI)(TMP4069);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_240388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4070 = addInt(res_240388, ((NI) 1));
				res_240388 = (NI)(TMP4070);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_240429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4071 = addInt(res_240429, ((NI) 1));
				res_240429 = (NI)(TMP4071);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_240470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4072 = addInt(res_240470, ((NI) 1));
				res_240470 = (NI)(TMP4072);
			} LA3: ;
		}
	}
