...
static NIM_CONST TY191031 TMP7018 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7019, "sons", 4);
static NIM_CONST TY191031 TMP7020 = {
	...
	nimln(19, "cgmeth.nim");
	{
		...
		LA13: ;
		{
			...
			nimln(29, "cgmeth.nim");
			{
				...
				nimln(30, "cgmeth.nim");
				internalerror_164199((*n).info, ((NimStringDesc*) &TMP7017));
			}
			LA24: ;
		}
		goto LA11;
	...
	asgnRefNoCycle((void**) (&(*(*result).kindU.S6.sons->data[((NI) 0)]).kindU.S4.sym), disp);
	{
		...
		res_355223 = ((NI) 1);
		{
			...
			while (1) {
				...
				TMP7024 = addInt(res_355223, ((NI) 1));
				res_355223 = (NI)(TMP7024);
			} LA9: ;
		}
	}
	popFrame();
	...
	LA14: ;
	{
		...
		res_355341 = ((NI) 1);
		{
			...
			while (1) {
				...
				LA29: ;
				nimln(1614, "system.nim");
				TMP7028 = addInt(res_355341, ((NI) 1));
				res_355341 = (NI)(TMP7028);
			} LA19: ;
		}
	}
	nimln(73, "cgmeth.nim");
...
{	nimln(135, "cgmeth.nim");
	L = (gmethods_355262 ? gmethods_355262->Sup.len : 0);
	{
		...
		res_355832 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP7032 = addInt(res_355832, ((NI) 1));
				res_355832 = (NI)(TMP7032);
			} LA3: ;
		}
	}
	...
	nimln(146, "cgmeth.nim");
	{
		...
		internalerror_164199((*s).info, ((NimStringDesc*) &TMP7033));
	}
	LA14: ;
	}BeforeRet: ;
	popFrame();
		...
		if (!((*t).kind == ((NU8) 17))) goto LA3;
		{
			...
			res_355886 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP7034 = addInt(res_355886, ((NI) 1));
					res_355886 = (NI)(TMP7034);
				} LA7: ;
			}
		}
	}
...
{	result = 0;
	{
		...
		res_355938 = ((NI) 1);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7036 = addInt(res_355938, ((NI) 1));
				res_355938 = (NI)(TMP7036);
			} LA4: ;
		}
	}
	}BeforeRet: ;
					...
					while (1) {
						...
						j = i_355984;
						{
							...
							while (1) {
								...
								LOC14 = 0;
								LOC14 = cmpsignatures_355905((*a)->data[(NI)(TMP7041)], v, relevantcols);
						...
						nimln(1614, "system.nim");
						TMP7044 = addInt(res_355994, ((NI) 1));
						res_355994 = (NI)(TMP7044);
					} LA11: ;
				}
			}
...
N_NIMCALL(Tsym190843*, gendispatcher_356031)(Tsymseq190815* methods, Intset187056* relevantcols) {
	...
	ands = getsyssym_238054(((NimStringDesc*) &TMP7045));
	nimln(192, "cgmeth.nim");
	iss = getsyssym_238054(((NimStringDesc*) &TMP7046));
	{
		NI meth_356057;
		NI HEX3Atmp_356168;
		NI res_356171;
		...
		res_356171 = ((NI) 0);
		{
			...
			while (1) {
					...
					res_356155 = ((NI) 1);
					{
						...
						while (1) {
							...
							nimln(197, "cgmeth.nim");
							{
								...
								if (!(((TMP7020[(*(*(*(*base).typ).n).kindU.S6.sons->data[col_356072]).kind/8] &(1<<((*(*(*(*base).typ).n).kindU.S6.sons->data[col_356072]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7021));
								LOC15 = 0;
							...
							LA11: ;
							nimln(1614, "system.nim");
							TMP7048 = addInt(res_356155, ((NI) 1));
							res_356155 = (NI)(TMP7048);
						} LA7: ;
					}
				}
				...
				addson_192819(call, LOC24);
				{
					...
					res_356163 = ((NI) 1);
					{
						...
						while (1) {
							...
							if (!(((TMP7020[(*(*(*(*base).typ).n).kindU.S6.sons->data[col_356108]).kind/8] &(1<<((*(*(*(*base).typ).n).kindU.S6.sons->data[col_356108]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7021));
							LOC28 = 0;
							...
							nimln(1614, "system.nim");
							TMP7050 = addInt(res_356163, ((NI) 1));
							res_356163 = (NI)(TMP7050);
						} LA27: ;
					}
				}
				ret = 0;
				...
				LA36: ;
				nimln(1614, "system.nim");
				TMP7051 = addInt(res_356171, ((NI) 1));
				res_356171 = (NI)(TMP7051);
			} LA4: ;
		}
	}
...
N_NIMCALL(Tnode190813*, generatemethoddispatchers_356208)(void) {
	...
	result = newnode_191401(((NU8) 115));
	{
		...
		TMP7052 = subInt((gmethods_355262 ? gmethods_355262->Sup.len : 0), ((NI) 1));
		HEX3Atmp_356258 = (NI)(TMP7052);
		nimln(1598, "system.nim");
		res_356261 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				initintset_187927((&relevantcols));
				{
					...
					res_356254 = ((NI) 1);
					{
						...
						while (1) {
							...
							LA11: ;
							nimln(1614, "system.nim");
							TMP7054 = addInt(res_356254, ((NI) 1));
							res_356254 = (NI)(TMP7054);
						} LA7: ;
					}
				}
				...
				nimln(1614, "system.nim");
				TMP7055 = addInt(res_356261, ((NI) 1));
				res_356261 = (NI)(TMP7055);
			} LA3: ;
		}
	}
	popFrame();
