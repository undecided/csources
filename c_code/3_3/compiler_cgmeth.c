...
N_NIMCALL(void, TMP7028)(void* p, NI op);
...
STRING_LITERAL(TMP7017, "cgmeth.genConv", 14);
STRING_LITERAL(TMP7018, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP7019, "cgmeth.genConv: no downcast allowed", 35);
static NIM_CONST TY191031 TMP7020 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7021, "sons", 4);
static NIM_CONST TY191031 TMP7022 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7023, "sym", 3);
STRING_LITERAL(TMP7024, "contains(disp.flags, sfDispatcher) ", 35);
STRING_LITERAL(TMP7032, "method has lock level $1, but another method has $2", 51);
STRING_LITERAL(TMP7035, "no method dispatcher found", 26);
STRING_LITERAL(TMP7047, "and", 3);
STRING_LITERAL(TMP7048, "of", 2);
	...
	nimln(19, "cgmeth.nim");
	{
		...
		nimln(22, "cgmeth.nim");
		{
			...
			nimln(25, "cgmeth.nim");
			{
				...
				internalerror_164199((*n).info, ((NimStringDesc*) &TMP7018));
			}
			LA17: ;
		}
		goto LA11;
		LA13: ;
		{
			...
			nimln(29, "cgmeth.nim");
			{
				...
				nimln(30, "cgmeth.nim");
				internalerror_164199((*n).info, ((NimStringDesc*) &TMP7019));
			}
			LA24: ;
		}
		goto LA11;
...
N_NIMCALL(Tnode190813*, methodcall_355054)(Tnode190813* n) {
	...
	result = n;
	nimln(39, "cgmeth.nim");
	if (((TMP7020[(*result).kind/8] &(1<<((*result).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
	if ((NU)(((NI) 0)) >= (NU)((*result).kindU.S6.sons->Sup.len)) raiseIndexError();
	if (!(((TMP7022[(*(*result).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*result).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
	LOC1 = 0;
	LOC1 = lastson_193431((*(*(*result).kindU.S6.sons->data[((NI) 0)]).kindU.S4.sym).ast);
	if (!(((TMP7022[(*LOC1).kind/8] &(1<<((*LOC1).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
	disp = (*LOC1).kindU.S4.sym;
	nimln(40, "cgmeth.nim");
	{
		if (!!((((*disp).flags &(1<<((((NU8) 25))&31)))!=0))) goto LA4;
		failedassertimpl_87217(((NimStringDesc*) &TMP7024));
	}
	LA4: ;
	nimln(41, "cgmeth.nim");
	if (((TMP7020[(*result).kind/8] &(1<<((*result).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
	...
	asgnRefNoCycle((void**) (&(*(*result).kindU.S6.sons->data[((NI) 0)]).kindU.S4.sym), disp);
	{
		...
		TMP7025 = subInt(LOC7, ((NI) 1));
		HEX3Atmp_355220 = (NI)(TMP7025);
		...
		res_355223 = ((NI) 1);
		{
			...
			while (1) {
				...
				TMP7026 = addInt(res_355223, ((NI) 1));
				res_355223 = (NI)(TMP7026);
			} LA9: ;
		}
	}
	popFrame();
...
{	result = 0;
	...
	LA14: ;
	{
		...
		TMP7029 = subInt(LOC17, ((NI) 1));
		HEX3Atmp_355338 = (NI)(TMP7029);
		nimln(1598, "system.nim");
		res_355341 = ((NI) 1);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA29: ;
				nimln(1614, "system.nim");
				TMP7030 = addInt(res_355341, ((NI) 1));
				res_355341 = (NI)(TMP7030);
			} LA19: ;
		}
	}
	nimln(73, "cgmeth.nim");
...
static N_INLINE(NI, len_191097)(Tnode190813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP7020[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
...
N_NIMCALL(void, attachdispatcher_355366)(Tsym190843* s, Tnode190813* dispatcher) {
	...
	TMP7031 = subInt(LOC1, ((NI) 1));
	L = (NI)(TMP7031);
	nimln(77, "cgmeth.nim");
	if (((TMP7020[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
	...
	nimln(78, "cgmeth.nim");
	{
		...
		LOC4 = ((*x).kind == ((NU8) 3));
		if (!(LOC4)) goto LA5;
		if (!(((TMP7022[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
...
{	result = 0;
	...
	nimln(92, "cgmeth.nim");
	if (((TMP7020[(*(*disp).ast).kind/8] &(1<<((*(*disp).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
	...
	nimln(94, "cgmeth.nim");
	{
		...
		nimln(95, "cgmeth.nim");
		{
			...
			if (!(((TMP7022[(*(*(*disp).ast).kindU.S6.sons->data[((NI) 7)]).kind/8] &(1<<((*(*(*disp).ast).kindU.S6.sons->data[((NI) 7)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
			if (((TMP7020[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
			if ((NU)(((NI) 7)) >= (NU)((*(*s).ast).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP7022[(*(*(*s).ast).kindU.S6.sons->data[((NI) 7)]).kind/8] &(1<<((*(*(*s).ast).kindU.S6.sons->data[((NI) 7)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
...
N_NIMCALL(void, fixupdispatcher_355482)(Tsym190843* meth, Tsym190843* disp) {
	...
	nimln(113, "cgmeth.nim");
	{
		...
		if (((TMP7020[(*(*disp).ast).kind/8] &(1<<((*(*disp).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
		if ((NU)(((NI) 7)) >= (NU)((*(*disp).ast).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (((TMP7020[(*(*meth).ast).kind/8] &(1<<((*(*meth).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
	...
	LA13: ;
	{
		...
		LOC21 = 0;
		LOC21 = nsuFormatOpenArray(((NimStringDesc*) &TMP7032), LOC20, 2);
...
{	nimln(135, "cgmeth.nim");
	L = (gmethods_355262 ? gmethods_355262->Sup.len : 0);
	{
		...
		TMP7033 = subInt(L, ((NI) 1));
		HEX3Atmp_355829 = (NI)(TMP7033);
		nimln(1598, "system.nim");
		res_355832 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP7034 = addInt(res_355832, ((NI) 1));
				res_355832 = (NI)(TMP7034);
			} LA3: ;
		}
	}
	...
	nimln(146, "cgmeth.nim");
	{
		...
		internalerror_164199((*s).info, ((NimStringDesc*) &TMP7035));
	}
	LA14: ;
	}BeforeRet: ;
	popFrame();
		...
		if (!((*t).kind == ((NU8) 17))) goto LA3;
		{
			...
			res_355886 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP7036 = addInt(res_355886, ((NI) 1));
					res_355886 = (NI)(TMP7036);
				} LA7: ;
			}
		}
	}
...
{	result = 0;
	{
		...
		TMP7037 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_355935 = (NI)(TMP7037);
		nimln(1598, "system.nim");
		res_355938 = ((NI) 1);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7038 = addInt(res_355938, ((NI) 1));
				res_355938 = (NI)(TMP7038);
			} LA4: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(void, sortbucket_355957)(Tsymseq190815** a, Intset187056* relevantcols) {
	...
	h = ((NI) 1);
	{
		...
		while (1) {
			...
			TMP7039 = mulInt(((NI) 3), h);
			TMP7040 = addInt((NI)(TMP7039), ((NI) 1));
			h = (NI)(TMP7040);
	...
	} LA1: ;
	{
		...
		while (1) {
			...
			h = (NI)(TMP7041);
			{
				...
				TMP7042 = subInt(n, ((NI) 1));
				HEX3Atmp_355991 = (NI)(TMP7042);
				nimln(1598, "system.nim");
				res_355994 = h;
				{
					nimln(1599, "system.nim");
					while (1) {
						...
						j = i_355984;
						{
							...
							while (1) {
								...
								NI TMP7045;
								TMP7043 = subInt(j, h);
								if ((NU)((NI)(TMP7043)) >= (NU)((*a)->Sup.len)) raiseIndexError();
								LOC14 = 0;
								LOC14 = cmpsignatures_355905((*a)->data[(NI)(TMP7043)], v, relevantcols);
								if (!(((NI) 0) <= LOC14)) goto LA13;
								nimln(180, "cgmeth.nim");
								if ((NU)(j) >= (NU)((*a)->Sup.len)) raiseIndexError();
								TMP7044 = subInt(j, h);
								if ((NU)((NI)(TMP7044)) >= (NU)((*a)->Sup.len)) raiseIndexError();
								asgnRefNoCycle((void**) (&(*a)->data[j]), (*a)->data[(NI)(TMP7044)]);
						...
						nimln(1614, "system.nim");
						TMP7046 = addInt(res_355994, ((NI) 1));
						res_355994 = (NI)(TMP7046);
					} LA11: ;
				}
			}
...
N_NIMCALL(Tsym190843*, gendispatcher_356031)(Tsymseq190815* methods, Intset187056* relevantcols) {
	...
	ands = getsyssym_238054(((NimStringDesc*) &TMP7047));
	nimln(192, "cgmeth.nim");
	iss = getsyssym_238054(((NimStringDesc*) &TMP7048));
	{
		NI meth_356057;
		NI HEX3Atmp_356168;
		NI res_356171;
		...
		res_356171 = ((NI) 0);
		{
			...
			while (1) {
					...
					res_356155 = ((NI) 1);
					{
						...
						while (1) {
							...
							nimln(197, "cgmeth.nim");
							{
								...
								if (((TMP7020[(*(*(*base).typ).n).kind/8] &(1<<((*(*(*base).typ).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
								if ((NU)(col_356072) >= (NU)((*(*(*base).typ).n).kindU.S6.sons->Sup.len)) raiseIndexError();
								if (!(((TMP7022[(*(*(*(*base).typ).n).kindU.S6.sons->data[col_356072]).kind/8] &(1<<((*(*(*(*base).typ).n).kindU.S6.sons->data[col_356072]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
								LOC15 = 0;
							...
							LA11: ;
							nimln(1614, "system.nim");
							TMP7050 = addInt(res_356155, ((NI) 1));
							res_356155 = (NI)(TMP7050);
						} LA7: ;
					}
				}
				...
				addson_192819(call, LOC24);
				{
					...
					TMP7051 = subInt(paramlen, ((NI) 1));
					HEX3Atmp_356160 = (NI)(TMP7051);
					nimln(1598, "system.nim");
					res_356163 = ((NI) 1);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							if (!(((TMP7022[(*(*(*(*base).typ).n).kindU.S6.sons->data[col_356108]).kind/8] &(1<<((*(*(*(*base).typ).n).kindU.S6.sons->data[col_356108]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
							LOC28 = 0;
							...
							nimln(1614, "system.nim");
							TMP7052 = addInt(res_356163, ((NI) 1));
							res_356163 = (NI)(TMP7052);
						} LA27: ;
					}
				}
				ret = 0;
				nimln(216, "cgmeth.nim");
				{
					...
					if (((TMP7020[(*(*base).ast).kind/8] &(1<<((*(*base).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
					if ((NU)(((NI) 7)) >= (NU)((*(*base).ast).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (!(((TMP7022[(*(*(*base).ast).kindU.S6.sons->data[((NI) 7)]).kind/8] &(1<<((*(*(*base).ast).kindU.S6.sons->data[((NI) 7)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7023));
					LOC34 = 0;
				...
				LA36: ;
				nimln(1614, "system.nim");
				TMP7053 = addInt(res_356171, ((NI) 1));
				res_356171 = (NI)(TMP7053);
			} LA4: ;
		}
	}
	nimln(231, "cgmeth.nim");
	if (((TMP7020[(*(*result).ast).kind/8] &(1<<((*(*result).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7021));
...
N_NIMCALL(Tnode190813*, generatemethoddispatchers_356208)(void) {
	...
	result = newnode_191401(((NU8) 115));
	{
		...
		TMP7054 = subInt((gmethods_355262 ? gmethods_355262->Sup.len : 0), ((NI) 1));
		HEX3Atmp_356258 = (NI)(TMP7054);
		nimln(1598, "system.nim");
		res_356261 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				initintset_187927((&relevantcols));
				{
					...
					TMP7055 = subInt(LOC5, ((NI) 1));
					HEX3Atmp_356251 = (NI)(TMP7055);
					nimln(1598, "system.nim");
					res_356254 = ((NI) 1);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							LA11: ;
							nimln(1614, "system.nim");
							TMP7056 = addInt(res_356254, ((NI) 1));
							res_356254 = (NI)(TMP7056);
						} LA7: ;
					}
				}
				...
				nimln(1614, "system.nim");
				TMP7057 = addInt(res_356261, ((NI) 1));
				res_356261 = (NI)(TMP7057);
			} LA3: ;
		}
	}
	popFrame();
...
static TNimNode* TMP7027[2];
static TNimNode TMP7015[3];
...
TMP7027[0] = &TMP7015[1];
TMP7015[1].kind = 1;
TMP7015[1].offset = offsetof(TY355243, Field0);
TMP7015[1].typ = (&NTI190815);
TMP7015[1].name = "Field0";
TMP7027[1] = &TMP7015[2];
TMP7015[2].kind = 1;
TMP7015[2].offset = offsetof(TY355243, Field1);
TMP7015[2].typ = (&NTI190811);
TMP7015[2].name = "Field1";
TMP7015[0].len = 2; TMP7015[0].kind = 2; TMP7015[0].sons = &TMP7027[0];
NTI355243.node = &TMP7015[0];
NTI355242.size = sizeof(TY355242*);
NTI355242.kind = 24;
NTI355242.base = (&NTI355243);
NTI355242.flags = 2;
NTI355242.marker = TMP7028;
}
