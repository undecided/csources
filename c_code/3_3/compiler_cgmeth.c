...
N_NIMCALL(void, TMP7027)(void* p, NI op);
...
STRING_LITERAL(TMP7016, "cgmeth.genConv", 14);
STRING_LITERAL(TMP7017, "cgmeth.genConv: no upcast allowed", 33);
STRING_LITERAL(TMP7018, "cgmeth.genConv: no downcast allowed", 35);
static NIM_CONST TY191031 TMP7019 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7020, "sons", 4);
static NIM_CONST TY191031 TMP7021 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7022, "sym", 3);
STRING_LITERAL(TMP7023, "contains(disp.flags, sfDispatcher) ", 35);
STRING_LITERAL(TMP7031, "method has lock level $1, but another method has $2", 51);
STRING_LITERAL(TMP7034, "no method dispatcher found", 26);
STRING_LITERAL(TMP7046, "and", 3);
STRING_LITERAL(TMP7047, "of", 2);
...
N_NIMCALL(Tnode190813*, methodcall_355054)(Tnode190813* n) {
	...
	result = n;
	nimln(39, "cgmeth.nim");
	if (((TMP7019[(*result).kind/8] &(1<<((*result).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
	if ((NU)(((NI) 0)) >= (NU)((*result).kindU.S6.sons->Sup.len)) raiseIndexError();
	if (!(((TMP7021[(*(*result).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*result).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
	LOC1 = 0;
	LOC1 = lastson_193431((*(*(*result).kindU.S6.sons->data[((NI) 0)]).kindU.S4.sym).ast);
	if (!(((TMP7021[(*LOC1).kind/8] &(1<<((*LOC1).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
	disp = (*LOC1).kindU.S4.sym;
	nimln(40, "cgmeth.nim");
	{
		if (!!((((*disp).flags &(1<<((((NU8) 25))&31)))!=0))) goto LA4;
		failedassertimpl_87217(((NimStringDesc*) &TMP7023));
	}
	LA4: ;
	nimln(41, "cgmeth.nim");
	if (((TMP7019[(*result).kind/8] &(1<<((*result).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
	...
	asgnRefNoCycle((void**) (&(*(*result).kindU.S6.sons->data[((NI) 0)]).kindU.S4.sym), disp);
	{
		...
		TMP7024 = subInt(LOC7, ((NI) 1));
		HEX3Atmp_355220 = (NI)(TMP7024);
		...
		res_355223 = ((NI) 1);
		{
			...
			while (1) {
				...
				TMP7025 = addInt(res_355223, ((NI) 1));
				res_355223 = (NI)(TMP7025);
			} LA9: ;
		}
	}
	popFrame();
...
{	result = 0;
	...
	LA14: ;
	{
		...
		TMP7028 = subInt(LOC17, ((NI) 1));
		HEX3Atmp_355338 = (NI)(TMP7028);
		nimln(1598, "system.nim");
		res_355341 = ((NI) 1);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA29: ;
				nimln(1614, "system.nim");
				TMP7029 = addInt(res_355341, ((NI) 1));
				res_355341 = (NI)(TMP7029);
			} LA19: ;
		}
	}
	nimln(73, "cgmeth.nim");
...
static N_INLINE(NI, len_191097)(Tnode190813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP7019[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
...
N_NIMCALL(void, attachdispatcher_355366)(Tsym190843* s, Tnode190813* dispatcher) {
	...
	TMP7030 = subInt(LOC1, ((NI) 1));
	L = (NI)(TMP7030);
	nimln(77, "cgmeth.nim");
	if (((TMP7019[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
	...
	nimln(78, "cgmeth.nim");
	{
		...
		LOC4 = ((*x).kind == ((NU8) 3));
		if (!(LOC4)) goto LA5;
		if (!(((TMP7021[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
...
{	result = 0;
	...
	nimln(92, "cgmeth.nim");
	if (((TMP7019[(*(*disp).ast).kind/8] &(1<<((*(*disp).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
	...
	nimln(94, "cgmeth.nim");
	{
		...
		nimln(95, "cgmeth.nim");
		{
			...
			if (!(((TMP7021[(*(*(*disp).ast).kindU.S6.sons->data[((NI) 7)]).kind/8] &(1<<((*(*(*disp).ast).kindU.S6.sons->data[((NI) 7)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
			if (((TMP7019[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
			if ((NU)(((NI) 7)) >= (NU)((*(*s).ast).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP7021[(*(*(*s).ast).kindU.S6.sons->data[((NI) 7)]).kind/8] &(1<<((*(*(*s).ast).kindU.S6.sons->data[((NI) 7)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
...
N_NIMCALL(void, fixupdispatcher_355482)(Tsym190843* meth, Tsym190843* disp) {
	...
	nimln(113, "cgmeth.nim");
	{
		...
		if (((TMP7019[(*(*disp).ast).kind/8] &(1<<((*(*disp).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
		if ((NU)(((NI) 7)) >= (NU)((*(*disp).ast).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (((TMP7019[(*(*meth).ast).kind/8] &(1<<((*(*meth).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
	...
	LA13: ;
	{
		...
		LOC21 = 0;
		LOC21 = nsuFormatOpenArray(((NimStringDesc*) &TMP7031), LOC20, 2);
...
{	nimln(135, "cgmeth.nim");
	L = (gmethods_355262 ? gmethods_355262->Sup.len : 0);
	{
		...
		TMP7032 = subInt(L, ((NI) 1));
		HEX3Atmp_355829 = (NI)(TMP7032);
		nimln(1598, "system.nim");
		res_355832 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP7033 = addInt(res_355832, ((NI) 1));
				res_355832 = (NI)(TMP7033);
			} LA3: ;
		}
	}
	...
	nimln(146, "cgmeth.nim");
	{
		...
		internalerror_164199((*s).info, ((NimStringDesc*) &TMP7034));
	}
	LA14: ;
	}BeforeRet: ;
	popFrame();
		...
		if (!((*t).kind == ((NU8) 17))) goto LA3;
		{
			...
			res_355886 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP7035 = addInt(res_355886, ((NI) 1));
					res_355886 = (NI)(TMP7035);
				} LA7: ;
			}
		}
	}
...
{	result = 0;
	{
		...
		TMP7036 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_355935 = (NI)(TMP7036);
		nimln(1598, "system.nim");
		res_355938 = ((NI) 1);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7037 = addInt(res_355938, ((NI) 1));
				res_355938 = (NI)(TMP7037);
			} LA4: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(void, sortbucket_355957)(Tsymseq190815** a, Intset187056* relevantcols) {
	...
	h = ((NI) 1);
	{
		...
		while (1) {
			...
			TMP7038 = mulInt(((NI) 3), h);
			TMP7039 = addInt((NI)(TMP7038), ((NI) 1));
			h = (NI)(TMP7039);
	...
	} LA1: ;
	{
		...
		while (1) {
			...
			h = (NI)(TMP7040);
			{
				...
				TMP7041 = subInt(n, ((NI) 1));
				HEX3Atmp_355991 = (NI)(TMP7041);
				nimln(1598, "system.nim");
				res_355994 = h;
				{
					nimln(1599, "system.nim");
					while (1) {
						...
						j = i_355984;
						{
							...
							while (1) {
								...
								LOC14 = 0;
								LOC14 = cmpsignatures_355905((*a)->data[(NI)(TMP7042)], v, relevantcols);
								...
								asgnRefNoCycle((void**) (&(*a)->data[j]), (*a)->data[(NI)(TMP7043)]);
						...
						nimln(1614, "system.nim");
						TMP7045 = addInt(res_355994, ((NI) 1));
						res_355994 = (NI)(TMP7045);
					} LA11: ;
				}
			}
...
N_NIMCALL(Tsym190843*, gendispatcher_356031)(Tsymseq190815* methods, Intset187056* relevantcols) {
	...
	ands = getsyssym_238054(((NimStringDesc*) &TMP7046));
	nimln(192, "cgmeth.nim");
	iss = getsyssym_238054(((NimStringDesc*) &TMP7047));
	{
		NI meth_356057;
		NI HEX3Atmp_356168;
		NI res_356171;
		...
		res_356171 = ((NI) 0);
		{
			...
			while (1) {
					...
					res_356155 = ((NI) 1);
					{
						...
						while (1) {
							...
							nimln(197, "cgmeth.nim");
							{
								...
								if (((TMP7019[(*(*(*base).typ).n).kind/8] &(1<<((*(*(*base).typ).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
								if ((NU)(col_356072) >= (NU)((*(*(*base).typ).n).kindU.S6.sons->Sup.len)) raiseIndexError();
								if (!(((TMP7021[(*(*(*(*base).typ).n).kindU.S6.sons->data[col_356072]).kind/8] &(1<<((*(*(*(*base).typ).n).kindU.S6.sons->data[col_356072]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
								LOC15 = 0;
							...
							LA11: ;
							nimln(1614, "system.nim");
							TMP7049 = addInt(res_356155, ((NI) 1));
							res_356155 = (NI)(TMP7049);
						} LA7: ;
					}
				}
				...
				addson_192819(call, LOC24);
				{
					...
					TMP7050 = subInt(paramlen, ((NI) 1));
					HEX3Atmp_356160 = (NI)(TMP7050);
					nimln(1598, "system.nim");
					res_356163 = ((NI) 1);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							if (!(((TMP7021[(*(*(*(*base).typ).n).kindU.S6.sons->data[col_356108]).kind/8] &(1<<((*(*(*(*base).typ).n).kindU.S6.sons->data[col_356108]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
							LOC28 = 0;
							...
							nimln(1614, "system.nim");
							TMP7051 = addInt(res_356163, ((NI) 1));
							res_356163 = (NI)(TMP7051);
						} LA27: ;
					}
				}
				ret = 0;
				nimln(216, "cgmeth.nim");
				{
					...
					if (((TMP7019[(*(*base).ast).kind/8] &(1<<((*(*base).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
					if ((NU)(((NI) 7)) >= (NU)((*(*base).ast).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (!(((TMP7021[(*(*(*base).ast).kindU.S6.sons->data[((NI) 7)]).kind/8] &(1<<((*(*(*base).ast).kindU.S6.sons->data[((NI) 7)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7022));
					LOC34 = 0;
				...
				LA36: ;
				nimln(1614, "system.nim");
				TMP7052 = addInt(res_356171, ((NI) 1));
				res_356171 = (NI)(TMP7052);
			} LA4: ;
		}
	}
	nimln(231, "cgmeth.nim");
	if (((TMP7019[(*(*result).ast).kind/8] &(1<<((*(*result).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7020));
...
N_NIMCALL(Tnode190813*, generatemethoddispatchers_356208)(void) {
	...
	result = newnode_191401(((NU8) 115));
	{
		...
		TMP7053 = subInt((gmethods_355262 ? gmethods_355262->Sup.len : 0), ((NI) 1));
		HEX3Atmp_356258 = (NI)(TMP7053);
		nimln(1598, "system.nim");
		res_356261 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				initintset_187927((&relevantcols));
				{
					...
					TMP7054 = subInt(LOC5, ((NI) 1));
					HEX3Atmp_356251 = (NI)(TMP7054);
					nimln(1598, "system.nim");
					res_356254 = ((NI) 1);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							LA11: ;
							nimln(1614, "system.nim");
							TMP7055 = addInt(res_356254, ((NI) 1));
							res_356254 = (NI)(TMP7055);
						} LA7: ;
					}
				}
				...
				nimln(1614, "system.nim");
				TMP7056 = addInt(res_356261, ((NI) 1));
				res_356261 = (NI)(TMP7056);
			} LA3: ;
		}
	}
	popFrame();
...
TMP7026[0] = &TMP7014[1];
TMP7014[1].kind = 1;
TMP7014[1].offset = offsetof(TY355243, Field0);
TMP7014[1].typ = (&NTI190815);
TMP7014[1].name = "Field0";
TMP7026[1] = &TMP7014[2];
TMP7014[2].kind = 1;
TMP7014[2].offset = offsetof(TY355243, Field1);
TMP7014[2].typ = (&NTI190811);
TMP7014[2].name = "Field1";
TMP7014[0].len = 2; TMP7014[0].kind = 2; TMP7014[0].sons = &TMP7026[0];
NTI355243.node = &TMP7014[0];
NTI355242.size = sizeof(TY355242*);
NTI355242.kind = 24;
NTI355242.base = (&NTI355243);
NTI355242.flags = 2;
NTI355242.marker = TMP7027;
}
