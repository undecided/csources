...
NIM_CONST TY163302 TMP1864 = {((NimStringDesc*) &TMP1865),
...
NIM_CONST TY163297 TMP1884 = {((NimStringDesc*) &TMP1885),
...
extern TY13806* cincludes_170474;
extern TY13806* clibs_170492;
extern TY13806* clinkedlibs_170510;
extern NimStringDesc* headerfile_154136;
extern TY13806* implicitimports_154276;
extern TY13806* implicitincludes_154294;
...
extern TY13806* commandargs_154257;
...
N_NIMCALL(void, writeversioninfo_176107)(NU8 pass) {
	...
	nimln(78, "commands.nim");
	{
		...
		msgwriteln_164536(((NimStringDesc*) &TMP1851));
		nimln(87, "commands.nim");
		msgwriteln_164536(((NimStringDesc*) &TMP1852));
...
N_NIMCALL(void, invalidcmdlineoption_176230)(NU8 pass, NimStringDesc* switch_176233, Tlineinfo163338 info) {
	...
	{
		if (!eqStrings(switch_176233, ((NimStringDesc*) &TMP1855))) goto LA3;
		localerror_165155(info, ((NU16) 44), ((NimStringDesc*) &TMP1853));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, splitswitch_176241)(NimStringDesc* switch_176243, NimStringDesc** cmd, NimStringDesc** arg, NU8 pass, Tlineinfo163338 info) {
	...
	LA19: ;
	{
		...
		unsureAsgnRef((void**) (&(*arg)), copyStr(switch_176243, (NI)(TMP1860)));
	}
	goto LA17;
	LA22: ;
	{
...
N_NIMCALL(void, processspecificnote_176397)(NimStringDesc* arg, NU16 state, NU8 pass, Tlineinfo163338 info, NimStringDesc* orig) {
	...
	nimln(155, "commands.nim");
	{
		...
		x = findstr_172344(TMP1864, 17, id);
...
appendString(LOC28, id);
	...
	LA21: ;
	{
		...
		x = findstr_172344(TMP1884, 31, id);
...
N_NIMCALL(void, trackdirty_177004)(NimStringDesc* arg, Tlineinfo163338 info) {
	...
	nimln(247, "commands.nim");
	{
		...
		localerror_165155(info, ((NU16) 23), ((NimStringDesc*) &TMP1976));
	}
	LA3: ;
	line = 0;
	column = 0;
...
N_NIMCALL(void, track_177030)(NimStringDesc* arg, Tlineinfo163338 info) {
	...
	nimln(263, "commands.nim");
	{
		...
		localerror_165155(info, ((NU16) 23), ((NimStringDesc*) &TMP1977));
	}
	LA3: ;
	line = 0;
	column = 0;
...
break;
	...
	LA22: ;
	{
		...
		LA139: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2044));
		}
		goto LA146;
		LA140: ;
		{
		...
		LA142: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2045));
		}
		goto LA146;
		LA143: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2046));
		}
		goto LA146;
		LA144: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2047));
		}
		goto LA146;
		LA145: ;
		{
	...
	LA30: ;
	{
		...
		LA163: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2049));
		}
		goto LA167;
		LA164: ;
		{
			...
			undefsymbol_168022(((NimStringDesc*) &TMP2049));
		}
		goto LA167;
		LA165: ;
		{
...
appendString(LOC172, arg);
	...
	LA31: ;
	{
		...
		nimln(393, "commands.nim");
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP1941));
		}
		goto LA174;
		LA176: ;
		{
			nimln(394, "commands.nim");
			undefsymbol_168022(((NimStringDesc*) &TMP1941));
		}
		LA174: ;
	}
	goto LA92;
	...
	LA50: ;
	{
		...
		LA209: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2057));
	...
	LA53: ;
	{
		...
		nimln(460, "commands.nim");
		{
			...
			cincludes_170474 = (TY13806*) incrSeq(&(cincludes_170474)->Sup, sizeof(NimStringDesc*));
			LOC236 = 0;
	...
	LA54: ;
	{
		...
		nimln(463, "commands.nim");
		{
			...
			clibs_170492 = (TY13806*) incrSeq(&(clibs_170492)->Sup, sizeof(NimStringDesc*));
			LOC243 = 0;
	...
	LA55: ;
	{
		...
		nimln(466, "commands.nim");
		{
			...
			clinkedlibs_170510 = (TY13806*) incrSeq(&(clinkedlibs_170510)->Sup, sizeof(NimStringDesc*));
			LOC250 = 0;
	...
	LA58: ;
	{
		...
		nimln(474, "commands.nim");
		{
			...
			implicitimports_154276 = (TY13806*) incrSeq(&(implicitimports_154276)->Sup, sizeof(NimStringDesc*));
			LOC259 = 0;
	...
	LA59: ;
	{
		...
		nimln(477, "commands.nim");
		{
			...
			implicitincludes_154294 = (TY13806*) incrSeq(&(implicitincludes_154294)->Sup, sizeof(NimStringDesc*));
			LOC265 = 0;
...
N_NIMCALL(NIM_BOOL, processargument_177738)(NU8 pass, Optparser175011* p, NI* argscount) {
	...
	LA3: ;
	{
		nimln(613, "commands.nim");
		{
			...
			commandargs_154257 = (TY13806*) incrSeq(&(commandargs_154257)->Sup, sizeof(NimStringDesc*));
			LOC11 = 0;
		...
		nimln(614, "commands.nim");
		{
			...
			asgnRefNoCycle((void**) (&gprojectname_154234), nosunixToNativePath((*p).key, ((NimStringDesc*) &TMP1856)));
...
NIM_EXTERNC N_NOINLINE(void, compiler_commandsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = arguments_177721; arguments_177721 = copyStringRC1(((NimStringDesc*) &TMP1856));
