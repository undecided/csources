...
N_NIMCALL(void, TMP10593)(void* p, NI op);
...
STRING_LITERAL(TMP10583, "$1 -> $2;$n", 11);
static NIM_CONST TY191031 TMP10585 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP10586, "sons", 4);
STRING_LITERAL(TMP10590, "digraph $1 {$n$2}$n", 19);
STRING_LITERAL(TMP10591, "", 0);
STRING_LITERAL(TMP10592, "dot", 3);
...
N_NIMCALL(void, adddependencyaux_506028)(NimStringDesc* importing, NimStringDesc* imported) {
	...
	addf_161635(&gdotgraph_506023, ((NimStringDesc*) &TMP10583), LOC1, 2);
	popFrame();
}
	...
	{
		{
			...
			TMP10584 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_506081 = (NI)(TMP10584);
			...
			res_506084 = ((NI) 0);
			{
				...
				while (1) {
					...
					if (((TMP10585[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10586));
					...
					TMP10587 = addInt(res_506084, ((NI) 1));
					res_506084 = (NI)(TMP10587);
				} LA5: ;
			}
		}
	}
	...
	{
		{
			...
			TMP10588 = subInt(LOC9, ((NI) 1));
			HEX3Atmp_506089 = (NI)(TMP10588);
			nimln(1598, "system.nim");
			res_506092 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP10589 = addInt(res_506092, ((NI) 1));
					res_506092 = (NI)(TMP10589);
				} LA11: ;
			}
		}
	}
...
N_NIMCALL(void, generatedot_506009)(NimStringDesc* project) {
	...
	LOC3 = 0;
	LOC3 = noschangeFileExt(LOC2, ((NimStringDesc*) &TMP10591));
	LOC1[0] = rope_160320(LOC3);
	LOC1[1] = gdotgraph_506023;
	LOC4 = 0;
	LOC4 = HEX25_161235(((NimStringDesc*) &TMP10590), LOC1, 2);
	nimln(47, "depends.nim");
	LOC5 = 0;
	LOC5 = noschangeFileExt(project, ((NimStringDesc*) &TMP10592));
...
static TNimNode TMP10581[1];
NTI506016.size = sizeof(Tgen506016);
NTI506016.kind = 17;
NTI506016.base = (&NTI241005);
TMP10581[0].kind = 1;
TMP10581[0].offset = offsetof(Tgen506016, module);
TMP10581[0].typ = (&NTI190811);
TMP10581[0].name = "module";
NTI506016.node = &TMP10581[0];
NTI506018.size = sizeof(Tgen506016*);
NTI506018.kind = 22;
NTI506018.base = (&NTI506016);
NTI506018.marker = TMP10593;
}
