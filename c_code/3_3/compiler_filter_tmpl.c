...
N_NIMCALL(void, newline_217047)(Ttmplparser217020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3338));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_217149)(Ttmplparser217020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_164155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3352));
			}
			LA20: ;
			...
			llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3353));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3359));
		}
		break;
		case ((NU8) 0):
		{
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_164155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3372));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_164155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3380));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3382));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream177204*, filtertmpl_217009)(Tllstream177204* stdin_217011, NimStringDesc* filename, Tnode190813* call) {
	...
	p.outp = llstreamopen_177220(((NimStringDesc*) &TMP3349));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_217011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_216020(call, ((NimStringDesc*) &TMP3383), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_216020(call, ((NimStringDesc*) &TMP3384), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_216029(call, ((NimStringDesc*) &TMP3385), ((NI) 3), ((NimStringDesc*) &TMP3386));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_216029(call, ((NimStringDesc*) &TMP3387), ((NI) 4), ((NimStringDesc*) &TMP3388));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_216029(call, ((NimStringDesc*) &TMP3389), ((NI) 5), ((NimStringDesc*) &TMP3380));
