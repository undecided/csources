...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP3338, "\012", 1);
STRING_LITERAL(TMP3349, "", 0);
STRING_LITERAL(TMP3352, "end", 3);
STRING_LITERAL(TMP3353, "#end", 4);
static NIM_CONST TY77859 TMP3356 = {
...
STRING_LITERAL(TMP3362, "\\x", 2);
STRING_LITERAL(TMP3364, "\\\\", 2);
STRING_LITERAL(TMP3366, "\\\'", 2);
STRING_LITERAL(TMP3368, "\\\"", 2);
STRING_LITERAL(TMP3372, "}", 1);
STRING_LITERAL(TMP3380, "$", 1);
STRING_LITERAL(TMP3382, "\\n\"", 3);
STRING_LITERAL(TMP3383, "subschar", 8);
STRING_LITERAL(TMP3384, "metachar", 8);
STRING_LITERAL(TMP3385, "emit", 4);
STRING_LITERAL(TMP3386, "result.add", 10);
STRING_LITERAL(TMP3387, "conc", 4);
STRING_LITERAL(TMP3388, " & ", 3);
STRING_LITERAL(TMP3389, "tostring", 8);
...
N_NIMCALL(void, newline_218047)(Ttmplparser218020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3338));
	}
	LA4: ;
	...
	i = d;
	{
		...
		while (1) {
			...
			case 91:
			{
				...
				TMP3341 = addInt((*p).bracket, ((NI) 1));
				(*p).bracket = (NI)(TMP3341);
			}
			break;
			case 93:
			{
...
N_NIMCALL(void, parseline_218149)(Ttmplparser218020* p) {
	...
	LA7: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP3349));
		{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_165155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3352));
			}
			LA20: ;
			...
			llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3353));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
		...
		case ((NU16) 26):
		{
			...
			TMP3355 = subInt((*p).indent, ((NI) 2));
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3355), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU16) 62):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				NI TMP3357;
				LOC37 = 0;
				LOC37 = contains_99373((*p).x, TMP3356);
				if (!!(LOC37)) goto LA38;
				nimln(106, "filter_tmpl.nim");
				TMP3357 = addInt((*p).indent, ((NI) 2));
				(*p).indent = (NI)(TMP3357);
			}
			LA38: ;
		}
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3358), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			llstreamwrite_178665((*p).outp, LOC45);
			nimln(124, "filter_tmpl.nim");
			llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3359));
		}
		break;
		case ((NU8) 0):
		{
			...
			TMP3361 = addInt((*p).emitpar, ((NI) 1));
			(*p).emitpar = (NI)(TMP3361);
		}
		break;
		}
		...
		(*p).state = ((NU8) 1);
		{
			...
			while (1) {
				...
				case 128 ... 255:
				{
					...
					llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3362));
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_165155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3372));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_165155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3380));
							}
							LA80: ;
						}
						break;
...
N_NIMCALL(Tllstream178204*, filtertmpl_218009)(Tllstream178204* stdin_218011, NimStringDesc* filename, Tnode191813* call) {
	...
	p.outp = llstreamopen_178220(((NimStringDesc*) &TMP3349));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_218011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_217020(call, ((NimStringDesc*) &TMP3383), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_217020(call, ((NimStringDesc*) &TMP3384), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_217029(call, ((NimStringDesc*) &TMP3385), ((NI) 3), ((NimStringDesc*) &TMP3386));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_217029(call, ((NimStringDesc*) &TMP3387), ((NI) 4), ((NimStringDesc*) &TMP3388));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_217029(call, ((NimStringDesc*) &TMP3389), ((NI) 5), ((NimStringDesc*) &TMP3380));
	...
	p.x = rawNewString(((NI) 120));
	{
		...
		while (1) {
			...
			TMP3390 = addInt(p.info.line, ((NI16) 1));
			if (TMP3390 < -32768 || TMP3390 > 32767) raiseOverflow();
			p.info.line = (NI16)(TMP3390);
