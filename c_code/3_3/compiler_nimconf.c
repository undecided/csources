...
N_NIMCALL(NIM_BOOL, parseatom_185048)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(26, "nimconf.nim");
	{
		...
		LA7: ;
		{
			...
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2465));
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(void, doend_185191)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(61, "nimconf.nim");
	{
		...
		lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2468));
	}
	LA3: ;
	nimln(62, "nimconf.nim");
	ppgettok_185009(L, tok);
	nimln(63, "nimconf.nim");
	condstack_185186 = (TY185169*) setLengthSeq(&(condstack_185186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((condstack_185186 ? (condstack_185186->Sup.len-1) : -1), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	popFrame();
}
	...
	nestedifs = ((NI) 0);
	{
		...
		while (1) {
			...
			LA7: ;
			{
				...
				lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2472));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_185342)(Tlexer180185* L, Ttoken180181* tok) {
	...
	case ((NU16) 31):
	{
		...
		TMP2473 = addInt((condstack_185186 ? condstack_185186->Sup.len : 0), ((NI) 1));
		condstack_185186 = (TY185169*) setLengthSeq(&(condstack_185186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((NI)(TMP2473), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, parseassignment_185439)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(159, "nimconf.nim");
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_166463(((NimStringDesc*) &TMP2477));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_166463(((NimStringDesc*) &TMP2478));
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			...
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2480));
		}
		LA17: ;
	...
	LOC22 = 0;
	LOC22 = getident_166463(((NimStringDesc*) &TMP2481));
...
appendString(val, LOC33);
		...
		conftok_185377(L, tok);
		{
			...
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_166463(((NimStringDesc*) &TMP2482));
...
N_NIMCALL(void, loadconfigs_185809)(NimStringDesc* cfg) {
	...
	nimln(230, "nimconf.nim");
	{
		...
		nimln(234, "nimconf.nim");
		{
			...
			LOC9 = 0;
			LOC9 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2492));
		...
		LA7: ;
		{
			...
			LOC13 = 0;
			LOC13 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2494));
		...
		LA11: ;
		{
			...
			asgnRefNoCycle((void**) (&libpath_153233), nosjoinPath(prefix, ((NimStringDesc*) &TMP2495)));
		}
		LA5: ;
	}
	LA3: ;
			...
			{
				{
					...
					res_186057 = ((NI) 0);
					{
						...
						while (1) {
							...
							TMP2498 = addInt(res_186057, ((NI) 1));
							res_186057 = (NI)(TMP2498);
						} LA55: ;
					}
				}
				nimln(649, "os.nim");
	...
	nimln(250, "nimconf.nim");
	{
		...
		nimln(253, "nimconf.nim");
		{
			...
			projectconfig = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP2499));
