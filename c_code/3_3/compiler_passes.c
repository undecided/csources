...
static NIM_CONST TY191031 TMP4105 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4106, "sons", 4);
STRING_LITERAL(TMP4122, "len(a) == L seq modified while iterating over it", 48);
STRING_LITERAL(TMP4123, "-", 1);
STRING_LITERAL(TMP4124, "stdinfile", 9);
...
N_NIMCALL(NIM_BOOL, astneeded_241093)(Tsym190843* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP4105[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4106));
...
N_NIMCALL(void, registerpass_241190)(Tpass241017* p) {
	...
	nimln(97, "passes.nim");
	TMP4107 = addInt(gpasseslen_241176, ((NI) 1));
	gpasseslen_241176 = (NI)(TMP4107);
	popFrame();
}
...
N_NIMCALL(void, openpasses_241293)(Tpasscontext241005** a, Tsym190843* module) {
	nimfr("openPasses", "passes.nim")
	{
		...
		TMP4109 = subInt(gpasseslen_241176, ((NI) 1));
		HEX3Atmp_241319 = (NI)(TMP4109);
		...
		res_241322 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4110 = addInt(res_241322, ((NI) 1));
				res_241322 = (NI)(TMP4110);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, openpassescached_241342)(Tpasscontext241005** a, Tsym190843* module, Trodreader233030* rd) {
	nimfr("openPassesCached", "passes.nim")
	{
		...
		TMP4111 = subInt(gpasseslen_241176, ((NI) 1));
		HEX3Atmp_241381 = (NI)(TMP4111);
		nimln(1598, "system.nim");
		res_241384 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA4: ;
				nimln(1614, "system.nim");
				TMP4112 = addInt(res_241384, ((NI) 1));
				res_241384 = (NI)(TMP4112);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, closepasses_241404)(Tpasscontext241005** a) {
	...
	m = NIM_NIL;
	{
		...
		TMP4113 = subInt(gpasseslen_241176, ((NI) 1));
		HEX3Atmp_241431 = (NI)(TMP4113);
		nimln(1598, "system.nim");
		res_241434 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4114 = addInt(res_241434, ((NI) 1));
				res_241434 = (NI)(TMP4114);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	...
	m = n;
	{
		...
		TMP4115 = subInt(gpasseslen_241176, ((NI) 1));
		HEX3Atmp_241490 = (NI)(TMP4115);
		nimln(1598, "system.nim");
		res_241493 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4116 = addInt(res_241493, ((NI) 1));
				res_241493 = (NI)(TMP4116);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, processtoplevelstmtcached_241513)(Tnode190813* n, Tpasscontext241005** a) {
	...
	m = n;
	{
		...
		TMP4117 = subInt(gpasseslen_241176, ((NI) 1));
		HEX3Atmp_241540 = (NI)(TMP4117);
		nimln(1598, "system.nim");
		res_241543 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4118 = addInt(res_241543, ((NI) 1));
				res_241543 = (NI)(TMP4118);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, closepassescached_241563)(Tpasscontext241005** a) {
	...
	m = NIM_NIL;
	{
		...
		TMP4119 = subInt(gpasseslen_241176, ((NI) 1));
		HEX3Atmp_241597 = (NI)(TMP4119);
		nimln(1598, "system.nim");
		res_241600 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4120 = addInt(res_241600, ((NI) 1));
				res_241600 = (NI)(TMP4120);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("processImplicits", "passes.nim")
	{
		...
		L_241646 = (implicits ? implicits->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP4121 = addInt(i_241644, ((NI) 1));
				i_241644 = (NI)(TMP4121);
				nimln(3089, "system.nim");
				{
					if (!!(((implicits ? implicits->Sup.len : 0) == L_241646))) goto LA11;
					failedassertimpl_87217(((NimStringDesc*) &TMP4122));
				}
				LA11: ;
			} LA3: ;
		}
...
{	memset((void*)(&p), 0, sizeof(p));
	...
	nimln(169, "passes.nim");
	{
		...
		nimln(171, "passes.nim");
		{
			...
			{
				NimStringDesc* LOC13;
				if (!eqStrings((*(*module).name).s, ((NimStringDesc*) &TMP4123))) goto LA11;
				nimln(174, "passes.nim");
				LOC13 = 0;
				LOC13 = (*(*module).name).s; (*(*module).name).s = copyStringRC1(((NimStringDesc*) &TMP4124));
	...
	LA3: ;
	{
		...
		n = loadinitsection_233077(rd);
		{
			...
			TMP4125 = subInt(LOC43, ((NI) 1));
			HEX3Atmp_241776 = (NI)(TMP4125);
			nimln(1598, "system.nim");
			res_241779 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					i_241766 = res_241779;
					nimln(207, "passes.nim");
					if (((TMP4105[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4106));
					...
					nimln(1614, "system.nim");
					TMP4126 = addInt(res_241779, ((NI) 1));
					res_241779 = (NI)(TMP4126);
				} LA45: ;
			}
		}
...
static TNimNode* TMP6319[2];
static TNimNode TMP4021[4];
NTI241005.size = sizeof(Tpasscontext241005);
NTI241005.kind = 17;
NTI241005.base = (&NTI3411);
NTI241005.flags = 1;
TMP4021[0].kind = 1;
TMP4021[0].offset = offsetof(Tpasscontext241005, fromcache);
TMP4021[0].typ = (&NTI138);
TMP4021[0].name = "fromCache";
NTI241005.node = &TMP4021[0];
...
TMP6319[0] = &TMP4021[2];
TMP4021[2].kind = 1;
TMP4021[2].offset = offsetof(Tpassdata241019, Field0);
TMP4021[2].typ = (&NTI190805);
TMP4021[2].name = "Field0";
TMP6319[1] = &TMP4021[3];
TMP4021[3].kind = 1;
TMP4021[3].offset = offsetof(Tpassdata241019, Field1);
TMP4021[3].typ = (&NTI190805);
TMP4021[3].name = "Field1";
TMP4021[1].len = 2; TMP4021[1].kind = 2; TMP4021[1].sons = &TMP6319[0];
NTI241019.node = &TMP4021[1];
}
