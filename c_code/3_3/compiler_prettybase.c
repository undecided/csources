...
N_NIMCALL(void, loadfile_248041)(Tlineinfo162338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		if (TMP4260 < (-2147483647 -1) || TMP4260 > 2147483647) raiseOverflow();
		gsourcefiles_248036 = (TY248019*) setLengthSeq(&(gsourcefiles_248036)->Sup, sizeof(Tsourcefile248008), ((NI)chckRange((NI32)(TMP4260), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA3: ;
