...
appendString((*result), LOC6);
				...
				TMP2693 = addInt(res_198072, ((NI) 1));
				res_198072 = (NI)(TMP2693);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = copyString(((NimStringDesc*) &TMP2699));
	{
		...
		while (1) {
			...
			case 92:
			{
				...
				hexchar_198091(s[(NI)(TMP2701)], (&xi));
				nimln(50, "rodutils.nim");
				TMP2702 = subInt(i, ((NI) 1));
				hexchar_198091(s[(NI)(TMP2702)], (&xi));
...
N_NIMCALL(void, encodevbiggestintaux_198230)(NI64 x, NimStringDesc** result) {
	...
	TMP2704 = modInt64(v_198238, IL64(190));
	rem_198240 = (NI64)(TMP2704);
	...
	LA3: ;
	{
		...
		TMP2706 = divInt64(v_198238, IL64(190));
		v_198238 = (NI64)(TMP2706);
	}
	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_198242) > (NU)(((NimStringDesc*) &TMP2707)->Sup.len)) raiseIndexError();
		d_198236 = ((NimStringDesc*) &TMP2707)->data[idx_198242];
	}
	goto LA6;
	LA8: ;
	{
		...
		TMP2708 = subInt(idx_198242, ((NI) 62));
		TMP2709 = addInt((NI)(TMP2708), ((NI) 128));
		d_198236 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2709), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_198269)(NI x, NimStringDesc** result) {
	...
	v_198277 = x;
	nimln(70, "rodutils.nim");
	TMP2710 = modInt(v_198277, ((NI) 190));
	rem_198279 = (NI)(TMP2710);
	nimln(71, "rodutils.nim");
	{
		NI TMP2711;
	...
	LA3: ;
	{
		NI TMP2712;
		nimln(76, "rodutils.nim");
		TMP2712 = divInt(v_198277, ((NI) 190));
		v_198277 = (NI)(TMP2712);
	}
	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_198281) > (NU)(((NimStringDesc*) &TMP2707)->Sup.len)) raiseIndexError();
		d_198275 = ((NimStringDesc*) &TMP2707)->data[idx_198281];
	}
	goto LA6;
	LA8: ;
	{
		...
		NI TMP2714;
		nimln(79, "rodutils.nim");
		TMP2713 = subInt(idx_198281, ((NI) 62));
		TMP2714 = addInt((NI)(TMP2713), ((NI) 128));
		d_198275 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2714), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
	...
	result = ((NI) 0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2718 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 48));
			...
			case 97 ... 122:
			{
				...
				TMP2721 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 97));
			...
			case 65 ... 90:
			{
				...
				TMP2725 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 65));
			...
			case 128 ... 255:
			{
				...
				TMP2729 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 128));
			...
			TMP2732 = addInt(i_198358, ((NI) 1));
			i_198358 = (NI)(TMP2732);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2733 = mulInt(result, sign_198360);
	...
	result = IL64(0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2736 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 48));
			...
			case 97 ... 122:
			{
				...
				TMP2739 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 97));
			...
			case 65 ... 90:
			{
				...
				TMP2743 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 65));
			...
			case 128 ... 255:
			{
				...
				TMP2747 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 128));
			...
			nimln(115, "rodutils.nim");
			TMP2750 = addInt(i_198519, ((NI) 1));
			i_198519 = (NI)(TMP2750);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2751 = mulInt64(result, ((NI64) (sign_198521)));
