...
N_NIMCALL(void, hexchar_197091)(NIM_CHAR c, NI* xi) {
	...
	case 48 ... 57:
	{
		...
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2696))));
	}
	break;
	case 97 ... 102:
	{
		...
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2698))));
	}
	break;
	case 65 ... 70:
	{
		...
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2700))));
	}
	break;
	default:
	{
...
N_NIMCALL(void, encodevintaux_197269)(NI x, NimStringDesc** result) {
	...
	nimln(71, "rodutils.nim");
	{
		...
		if ((NI)(TMP2713) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_197277 = ((NI64)-((NI)(TMP2713)));
		nimln(74, "rodutils.nim");
...
N_NIMCALL(NI, decodevint_197351)(NCSTRING s, NI* pos) {
	...
	result = (NI)((NU64)((NI)(TMP2735)) - (NU64)(((NI) 5)));
