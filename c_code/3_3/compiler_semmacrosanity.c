...
static NIM_CONST TY191031 TMP7984 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7985, "sons", 4);
STRING_LITERAL(TMP7988, "ithField", 8);
STRING_LITERAL(TMP7992, "ithField(record case branch)", 28);
static NIM_CONST TY191031 TMP7994 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7995, "sym", 3);
STRING_LITERAL(TMP7996, "invalid field at index ", 23);
STRING_LITERAL(TMP7999, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP8001, "[] must have some form of array type", 36);
STRING_LITERAL(TMP8003, "{} must have the set type", 25);
STRING_LITERAL(TMP8004, "float literal must have some float type", 39);
STRING_LITERAL(TMP8005, "integer literal must have some int type", 39);
STRING_LITERAL(TMP8006, "string literal must be of some string type", 42);
STRING_LITERAL(TMP8007, "nil literal must be of some pointer type", 40);
...
{	result = 0;
	...
	{
		{
			...
			TMP7983 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_402095 = (NI)(TMP7983);
			...
			res_402098 = ((NI) 0);
			{
				...
				while (1) {
					...
					if (((TMP7984[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7985));
					if ((NU)(i_402029) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
					TMP7986 = subInt(field, i_402029);
					result = ithfield_402012((*n).kindU.S6.sons->data[i_402029], (NI)(TMP7986));
					...
					TMP7987 = addInt(res_402098, ((NI) 1));
					res_402098 = (NI)(TMP7987);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_164199((*n).info, ((NimStringDesc*) &TMP7988));
		}
		LA13: ;
		...
		result = ithfield_402012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7989));
		...
		LA17: ;
		{
			...
			TMP7990 = subInt(LOC20, ((NI) 1));
			HEX3Atmp_402103 = (NI)(TMP7990);
			nimln(1598, "system.nim");
			res_402106 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						TMP7991 = subInt(field, ((NI) 1));
						result = ithfield_402012(LOC24, (NI)(TMP7991));
					...
					default:
					{
						...
						internalerror_164199((*n).info, ((NimStringDesc*) &TMP7992));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7993 = addInt(res_402106, ((NI) 1));
					res_402106 = (NI)(TMP7993);
				} LA22: ;
			}
		}
	}
...
appendString(LOC14, ((NimStringDesc*) &TMP7996));
appendString(LOC14, LOC15);
						...
						TMP7997 = addInt(res_402313, ((NI) 1));
						res_402313 = (NI)(TMP7997);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, ((NimStringDesc*) &TMP7996));
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP7998 = addInt(res_402321, ((NI) 1));
						res_402321 = (NI)(TMP7998);
					} LA23: ;
				}
			}
		}
				...
				m_402253 = 0;
				{
					...
					res_402333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8000 = addInt(res_402333, ((NI) 1));
							res_402333 = (NI)(TMP8000);
						} LA47: ;
					}
				}
			}
				...
				m_402265 = 0;
				{
					...
					res_402344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8002 = addInt(res_402344, ((NI) 1));
							res_402344 = (NI)(TMP8002);
						} LA59: ;
					}
				}
			}
	...
	case ((NU8) 23):
	{
		...
		LA83: ;
		{
			...
			globalerror_164145((*n).info, ((NimStringDesc*) &TMP8007));
		}
		LA81: ;
	}
	break;
