...
STRING_LITERAL(TMP3391, "standard", 8);
STRING_LITERAL(TMP3392, "strongspaces", 12);
STRING_LITERAL(TMP3393, "braces", 6);
STRING_LITERAL(TMP3394, "endx", 4);
NIM_CONST TY219020 parsernames_219019 = {((NimStringDesc*) &TMP3391),
((NimStringDesc*) &TMP3392),
((NimStringDesc*) &TMP3393),
((NimStringDesc*) &TMP3394)}
;
STRING_LITERAL(TMP3395, "none", 4);
STRING_LITERAL(TMP3396, "stdtmpl", 7);
STRING_LITERAL(TMP3397, "replace", 7);
STRING_LITERAL(TMP3398, "strip", 5);
NIM_CONST TY219026 filternames_219025 = {((NimStringDesc*) &TMP3395),
((NimStringDesc*) &TMP3396),
((NimStringDesc*) &TMP3397),
((NimStringDesc*) &TMP3398)}
;
STRING_LITERAL(TMP3403, "parser to implement", 19);
static NIM_CONST TY192031 TMP3412 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3413, "sons", 4);
static NIM_CONST TY192031 TMP3414 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3415, "ident", 5);
...
N_NIMCALL(Tnode191813*, parseall_219063)(Tparsers219035* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP3403));
...
N_NIMCALL(NIM_BOOL, containsshebang_219132)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		if (!(LOC3)) goto LA4;
		TMP3404 = addInt(i, ((NI) 1));
		if ((NU)((NI)(TMP3404)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI)(TMP3404)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(84, "syntaxes.nim");
		TMP3405 = addInt(i, ((NI) 2));
		j = (NI)(TMP3405);
		{
...
N_NIMCALL(Tnode191813*, parsepipe_219170)(NimStringDesc* filename, Tllstream178204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			if (!(LOC14)) goto LA15;
			TMP3407 = addInt(i, ((NI) 1));
			if ((NU)((NI)(TMP3407)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI)(TMP3407)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
			nimln(99, "syntaxes.nim");
			TMP3408 = addInt(i, ((NI) 2));
			i = (NI)(TMP3408);
			{
...
{	result = 0;
	{
		...
		res_219429 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP3410 = addInt(res_219429, ((NI) 1));
				res_219429 = (NI)(TMP3410);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_219629 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP3411 = addInt(res_219629, ((NI) 1));
				res_219629 = (NI)(TMP3411);
			} LA3: ;
		}
	}
...
N_NIMCALL(Tident167021*, getcallee_219647)(Tnode191813* n) {
	...
	nimln(120, "syntaxes.nim");
	{
		...
		if (!(LOC3)) goto LA4;
		if (((TMP3412[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3413));
		...
		if (((TMP3412[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3413));
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3414[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3415));
...
{	result = 0;
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3414[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3415));
		LOC7 = identeq_167484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP3416));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_219772;
			...
			res_219798 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA16: ;
					nimln(1614, "system.nim");
					TMP3417 = addInt(res_219798, ((NI) 1));
					res_219798 = (NI)(TMP3417);
				} LA15: ;
			}
		}
	}
...
static TNimNode* TMP3400[4];
NI TMP3402;
static char* NIM_CONST TMP3401[4] = {
"skinStandard", 
"skinStrongSpaces", 
"skinBraces", 
"skinEndX"};
static TNimNode TMP2920[8];
...
NTI219007.base = 0;
NTI219007.flags = 3;
for (TMP3402 = 0; TMP3402 < 4; TMP3402++) {
TMP2920[TMP3402+2].kind = 1;
TMP2920[TMP3402+2].offset = TMP3402;
TMP2920[TMP3402+2].name = TMP3401[TMP3402];
TMP3400[TMP3402] = &TMP2920[TMP3402+2];
}
TMP2920[6].len = 4; TMP2920[6].kind = 2; TMP2920[6].sons = &TMP3400[0];
NTI219007.node = &TMP2920[6];
TMP2920[1].kind = 1;
TMP2920[1].offset = offsetof(Tparsers219035, skin);
TMP2920[1].typ = (&NTI219007);
TMP2920[1].name = "skin";
TMP3399[1] = &TMP2920[7];
TMP2920[7].kind = 1;
TMP2920[7].offset = offsetof(Tparsers219035, parser);
TMP2920[7].typ = (&NTI207205);
TMP2920[7].name = "parser";
TMP2920[0].len = 2; TMP2920[0].kind = 2; TMP2920[0].sons = &TMP3399[0];
NTI219035.node = &TMP2920[0];
}
