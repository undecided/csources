...
N_NIMCALL(void, intsetenlarge_188614)(Intset188056* t) {
	...
	n = (Ttrunkseq188054*) newSeq((&NTI188054), ((NI)chckRange((NI)(TMP2519), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_188642;
		NI res_188670;
		i_188642 = 0;
		...
		res_188670 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP2523 = addInt(res_188670, ((NI) 1));
				res_188670 = (NI)(TMP2523);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(85, "intsets.nim");
	{
		...
		LOC9 = 0;
		LOC9 = mustrehash_188073((NI)(TMP2524), (*t).counter);
		if (!LOC9) goto LA10;
...
TMP2520[0] = &TMP2506[1];
TMP2506[1].kind = 1;
TMP2506[1].offset = offsetof(Ttrunk188052, next);
TMP2506[1].typ = (&NTI188050);
TMP2506[1].name = "next";
TMP2520[1] = &TMP2506[2];
TMP2506[2].kind = 1;
TMP2506[2].offset = offsetof(Ttrunk188052, key);
TMP2506[2].typ = (&NTI108);
TMP2506[2].name = "key";
TMP2520[2] = &TMP2506[3];
TMP2506[3].kind = 1;
TMP2506[3].offset = offsetof(Ttrunk188052, bits);
TMP2506[3].typ = (&NTI28020);
TMP2506[3].name = "bits";
TMP2506[0].len = 3; TMP2506[0].kind = 2; TMP2506[0].sons = &TMP2520[0];
NTI188052.node = &TMP2506[0];
NTI188050.size = sizeof(Ttrunk188052*);
NTI188050.kind = 22;
NTI188050.base = (&NTI188052);
NTI188050.marker = TMP2521;
NTI188054.size = sizeof(Ttrunkseq188054*);
NTI188054.kind = 24;
NTI188054.base = (&NTI188050);
NTI188054.flags = 2;
NTI188054.marker = TMP2522;
...
TMP4195[0] = &TMP2506[5];
TMP2506[5].kind = 1;
TMP2506[5].offset = offsetof(Intset188056, counter);
TMP2506[5].typ = (&NTI108);
TMP2506[5].name = "counter";
TMP4195[1] = &TMP2506[6];
TMP2506[6].kind = 1;
TMP2506[6].offset = offsetof(Intset188056, max);
TMP2506[6].typ = (&NTI108);
TMP2506[6].name = "max";
TMP4195[2] = &TMP2506[7];
TMP2506[7].kind = 1;
TMP2506[7].offset = offsetof(Intset188056, head);
TMP2506[7].typ = (&NTI188050);
TMP2506[7].name = "head";
TMP4195[3] = &TMP2506[8];
TMP2506[8].kind = 1;
TMP2506[8].offset = offsetof(Intset188056, data);
TMP2506[8].typ = (&NTI188054);
TMP2506[8].name = "data";
TMP2506[4].len = 4; TMP2506[4].kind = 2; TMP2506[4].sons = &TMP4195[0];
NTI188056.node = &TMP2506[4];
}
