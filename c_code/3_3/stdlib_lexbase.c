...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4219, "L.sentinel < L.bufLen ", 22);
STRING_LITERAL(TMP4222, "0 <= toCopy ", 12);
STRING_LITERAL(TMP4231, "s < L.bufLen ", 13);
STRING_LITERAL(TMP4236, "L.bufLen - oldBufLen == oldBufLen ", 34);
STRING_LITERAL(TMP4242, "pos <= L.sentinel ", 18);
STRING_LITERAL(TMP4244, "L.buf[pos] == \'\\x0D\' ", 21);
STRING_LITERAL(TMP4246, "L.buf[pos] == \'\\x0A\' ", 21);
STRING_LITERAL(TMP4250, "0 < bufLen ", 11);
STRING_LITERAL(TMP4251, "not (input == nil) ", 19);
STRING_LITERAL(TMP4255, "", 0);
STRING_LITERAL(TMP4257, "\012", 1);
STRING_LITERAL(TMP4258, "^\012", 2);
...
N_NIMCALL(void, fillbuffer_246102)(Baselexer246024* L) {
	...
	nimln(79, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4219));
	}
	LA3: ;
	nimln(80, "lexbase.nim");
	TMP4220 = subInt((*L).buflen, (*L).sentinel);
	TMP4221 = subInt((NI)(TMP4220), ((NI) 1));
	tocopy = (NI)(TMP4221);
	...
	nimln(82, "lexbase.nim");
	{
		...
		TMP4224 = mulInt(tocopy, ((NI) 1));
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4223)]))), ((NI)chckRange((NI)(TMP4224), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
	...
	nimln(85, "lexbase.nim");
	nimln(86, "lexbase.nim");
	TMP4225 = addInt((*L).sentinel, ((NI) 1));
	TMP4226 = mulInt((NI)(TMP4225), ((NI) 1));
	LOC13 = 0;
	LOC13 = readdata_138174((*L).input, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP4226));
	TMP4227 = divInt(LOC13, ((NI) 1));
	charsread = (NI)(TMP4227);
	nimln(87, "lexbase.nim");
	TMP4228 = addInt(tocopy, charsread);
	s = (NI)(TMP4228);
	nimln(88, "lexbase.nim");
	{
		NI TMP4229;
		TMP4229 = addInt((*L).sentinel, ((NI) 1));
		if (!(charsread < (NI)(TMP4229))) goto LA16;
		...
		s = (NI)(TMP4230);
		{
			...
			while (1) {
				nimln(95, "lexbase.nim");
				{
					...
					failedassertimpl_87217(((NimStringDesc*) &TMP4231));
				}
				LA23: ;
				{
				...
				LA31: ;
				{
					...
					TMP4233 = mulInt((*L).buflen, ((NI) 2));
					(*L).buflen = (NI)(TMP4233);
					nimln(106, "lexbase.nim");
					TMP4234 = mulInt((*L).buflen, ((NI) 1));
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4234), ((NI) 0), ((NI) IL64(9223372036854775807)))));
					(*L).buf = ((NCSTRING) (LOC34));
					nimln(107, "lexbase.nim");
					{
						NI TMP4235;
						TMP4235 = subInt((*L).buflen, oldbuflen);
						if (!!(((NI)(TMP4235) == oldbuflen))) goto LA37;
					...
					nimln(108, "lexbase.nim");
					nimln(109, "lexbase.nim");
					TMP4237 = mulInt(oldbuflen, ((NI) 1));
					LOC39 = 0;
					LOC39 = readdata_138174((*L).input, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP4237));
					TMP4238 = divInt(LOC39, ((NI) 1));
					...
					nimln(110, "lexbase.nim");
					{
						...
						TMP4240 = addInt(oldbuflen, charsread);
						(*L).sentinel = (NI)(TMP4240);
						nimln(113, "lexbase.nim");
						goto LA19;
					}
					LA42: ;
					nimln(114, "lexbase.nim");
					TMP4241 = subInt((*L).buflen, ((NI) 1));
					s = (NI)(TMP4241);
				}
				LA29: ;
			}
...
N_NIMCALL(NI, handlelf_246079)(Baselexer246024* L, NI pos) {
	...
	nimln(134, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4246));
	}
	LA3: ;
	nimln(135, "lexbase.nim");
	TMP4247 = addInt((*L).linenumber, ((NI) 1));
	(*L).linenumber = (NI)(TMP4247);
...
N_NIMCALL(void, skiputf8bom_247416)(Baselexer246024* L) {
	...
	nimln(139, "lexbase.nim");
	{
		...
		TMP4248 = addInt((*L).bufpos, ((NI) 3));
		(*L).bufpos = (NI)(TMP4248);
		nimln(141, "lexbase.nim");
		TMP4249 = addInt((*L).linestart, ((NI) 3));
		(*L).linestart = (NI)(TMP4249);
	}
	LA7: ;
	popFrame();
}
...
N_NIMCALL(void, open_246040)(Baselexer246024* L, Streamobj138027* input, NI buflen) {
	...
	TMP4252 = mulInt(buflen, ((NI) 1));
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4252), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC9));
	nimln(150, "lexbase.nim");
	TMP4253 = subInt(buflen, ((NI) 1));
	(*L).sentinel = (NI)(TMP4253);
...
N_NIMCALL(NI, getcolnumber_246064)(Baselexer246024* L, NI pos) {
	...
	TMP4254 = subInt(pos, (*L).linestart);
	if ((NI)(TMP4254) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
	result = ((NI)(TMP4254) > 0? ((NI)(TMP4254)) : -((NI)(TMP4254)));
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, getcurrentline_246057)(Baselexer246024* L, NIM_BOOL marker) {
	...
	result = copyString(((NimStringDesc*) &TMP4255));
	...
	i = (*L).linestart;
	{
		...
		while (1) {
			...
			TMP4256 = addInt(i, ((NI) 1));
			i = (NI)(TMP4256);
		} LA2: ;
	}
	nimln(166, "lexbase.nim");
	result = resizeString(result, 1);
appendString(result, ((NimStringDesc*) &TMP4257));
...
appendString(LOC7, ((NimStringDesc*) &TMP4258));
...
static TNimNode* TMP4263[8];
static TNimNode TMP4217[9];
NTI246024.size = sizeof(Baselexer246024);
NTI246024.kind = 17;
NTI246024.base = (&NTI3411);
TMP4263[0] = &TMP4217[1];
TMP4217[1].kind = 1;
TMP4217[1].offset = offsetof(Baselexer246024, bufpos);
TMP4217[1].typ = (&NTI108);
TMP4217[1].name = "bufpos";
TMP4263[1] = &TMP4217[2];
TMP4217[2].kind = 1;
TMP4217[2].offset = offsetof(Baselexer246024, buf);
TMP4217[2].typ = (&NTI151);
TMP4217[2].name = "buf";
TMP4263[2] = &TMP4217[3];
TMP4217[3].kind = 1;
TMP4217[3].offset = offsetof(Baselexer246024, buflen);
TMP4217[3].typ = (&NTI108);
TMP4217[3].name = "bufLen";
TMP4263[3] = &TMP4217[4];
TMP4217[4].kind = 1;
TMP4217[4].offset = offsetof(Baselexer246024, input);
TMP4217[4].typ = (&NTI138025);
TMP4217[4].name = "input";
TMP4263[4] = &TMP4217[5];
TMP4217[5].kind = 1;
TMP4217[5].offset = offsetof(Baselexer246024, linenumber);
TMP4217[5].typ = (&NTI108);
TMP4217[5].name = "lineNumber";
TMP4263[5] = &TMP4217[6];
TMP4217[6].kind = 1;
TMP4217[6].offset = offsetof(Baselexer246024, sentinel);
TMP4217[6].typ = (&NTI108);
TMP4217[6].name = "sentinel";
TMP4263[6] = &TMP4217[7];
TMP4217[7].kind = 1;
TMP4217[7].offset = offsetof(Baselexer246024, linestart);
TMP4217[7].typ = (&NTI108);
TMP4217[7].name = "lineStart";
TMP4263[7] = &TMP4217[8];
TMP4217[8].kind = 1;
TMP4217[8].offset = offsetof(Baselexer246024, fileopened);
TMP4217[8].typ = (&NTI138);
TMP4217[8].name = "fileOpened";
TMP4217[0].len = 8; TMP4217[0].kind = 2; TMP4217[0].sons = &TMP4263[0];
NTI246024.node = &TMP4217[0];
}
