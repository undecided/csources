...
{	nimln(226, "streams.nim");
	...
	nimln(229, "streams.nim");
	{
		...
		(*s).data = setLengthStr((*s).data, ((NI)chckRange((NI)(TMP550), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA7: ;
...
N_NIMCALL(NI, fsreaddata_138742)(Streamobj138027* s, void* buffer, NI buflen) {
	...
	if (s) chckObj((*s).Sup.m_type, (&NTI138692));
	result = readbuffer_13715((*((Filestreamobj138692*) (s))).f, buffer, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, fswritedata_138751)(Streamobj138027* s, void* buffer, NI buflen) {
	...
	nimln(271, "streams.nim");
	{
		...
		if (s) chckObj((*s).Sup.m_type, (&NTI138692));
		LOC3 = 0;
		LOC3 = writebuffer_13737((*((Filestreamobj138692*) (s))).f, buffer, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
