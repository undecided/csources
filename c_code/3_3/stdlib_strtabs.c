...
N_NIMCALL(void, TMP514)(void* p, NI op);
...
STRING_LITERAL(TMP488, "counter < length ", 17);
STRING_LITERAL(TMP494, "", 0);
STRING_LITERAL(TMP496, "key does not exist: ", 20);
STRING_LITERAL(TMP502, "format string: key not found: ", 30);
NIM_CONST TY77859 Patternchars_134825 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0xFE, 0xFF, 0xFF, 0x07,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP531, "{:}", 3);
STRING_LITERAL(TMP532, "{", 1);
STRING_LITERAL(TMP533, ", ", 2);
STRING_LITERAL(TMP534, ": ", 2);
STRING_LITERAL(TMP536, "}", 1);
...
N_NIMCALL(NIM_BOOL, mustrehash_134200)(NI length, NI counter) {
	...
	nimln(90, "strtabs.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP488));
	}
	LA3: ;
	nimln(91, "strtabs.nim");
	LOC5 = 0;
	TMP489 = mulInt(length, ((NI) 2));
	TMP490 = mulInt(counter, ((NI) 3));
	LOC5 = ((NI)(TMP489) < (NI)(TMP490));
	if (LOC5) goto LA6;
	TMP491 = subInt(length, counter);
	LOC5 = ((NI)(TMP491) < ((NI) 4));
	LA6: ;
	result = LOC5;
	popFrame();
...
static N_INLINE(NI, nexttry_134407)(NI h, NI maxhash) {
	...
	TMP492 = mulInt(((NI) 5), h);
	TMP493 = addInt((NI)(TMP492), ((NI) 1));
	result = (NI)((NI)(TMP493) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(NimStringDesc*, nstGet)(Stringtableobj134012* t, NimStringDesc* key) {
	...
	LA3: ;
	{
		...
		result = copyString(((NimStringDesc*) &TMP494));
	}
	LA1: ;
	popFrame();
	return result;
...
appendString(LOC6, ((NimStringDesc*) &TMP496));
...
N_NIMCALL(void, enlarge_134510)(Stringtableobj134012* t) {
	...
	TMP497 = mulInt(((*t).data ? (*t).data->Sup.len : 0), ((NI) 2));
	n = (Keyvaluepairseq134010*) newSeq((&NTI134010), ((NI)chckRange((NI)(TMP497), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_134544;
		NI HEX3Atmp_134558;
		NI res_134561;
		...
		res_134561 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP500 = addInt(res_134561, ((NI) 1));
				res_134561 = (NI)(TMP500);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, raiseformatexception_134610)(NimStringDesc* s) {
	...
	e = (Valueerror3449*) newObj((&NTI23001), sizeof(Valueerror3449));
	(*e).Sup.Sup.m_type = (&NTI3449);
	nimln(151, "strtabs.nim");
	LOC1 = 0;
	LOC1 = rawNewString(s->Sup.len + 30);
appendString(LOC1, ((NimStringDesc*) &TMP502));
appendString(LOC1, s);
...
N_NIMCALL(void, clear_134702)(Stringtableobj134012* s, NU8 mode) {
	...
	(*s).data = (Keyvaluepairseq134010*) setLengthSeq(&((*s).data)->Sup, sizeof(TY103553), ((NI) 64));
	popFrame();
}
...
N_NIMCALL(Stringtableobj134012*, nstnewStringTableWithPairs)(NimStringDesc** keyvaluepairs, NI keyvaluepairsLen0, NU8 mode) {
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			TMP515 = addInt(i, ((NI) 1));
			if ((NU)((NI)(TMP515)) >= (NU)(keyvaluepairsLen0)) raiseIndexError();
			nstPut(result, keyvaluepairs[i], keyvaluepairs[(NI)(TMP515)]);
			nimln(188, "strtabs.nim");
			TMP516 = addInt(i, ((NI) 2));
			i = (NI)(TMP516);
		} LA2: ;
	}
	popFrame();
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(208, "strtabs.nim");
			{
				...
				TMP518 = addInt(i, ((NI) 1));
				if ((NU)((NI)(TMP518)) > (NU)(f->Sup.len)) raiseIndexError();
				switch (((NU8)(f->data[(NI)(TMP518)]))) {
				case 36:
				{
					NI TMP519;
				...
				case 123:
				{
					...
					j = (NI)(TMP520);
					{
						...
						while (1) {
							...
							LA12: ;
							if (!LOC11) goto LA10;
							TMP521 = addInt(j, ((NI) 1));
							j = (NI)(TMP521);
						} LA10: ;
					}
					nimln(216, "strtabs.nim");
					TMP522 = addInt(i, ((NI) 2));
					TMP523 = subInt(j, ((NI) 1));
					LOC13 = 0;
					LOC13 = copyStrLast(f, (NI)(TMP522), (NI)(TMP523));
					LOC14 = 0;
...
appendString(result, LOC14);
				...
				case 95:
				{
					...
					TMP528 = subInt(j, ((NI) 1));
					LOC20 = 0;
					LOC20 = copyStrLast(f, (NI)(TMP527), (NI)(TMP528));
					LOC21 = 0;
...
N_NIMCALL(NimStringDesc*, nstDollar)(Stringtableobj134012* t) {
	...
	nimln(232, "strtabs.nim");
	{
		...
		result = copyString(((NimStringDesc*) &TMP531));
	}
	goto LA1;
	LA4: ;
	{
...
appendString(result, ((NimStringDesc*) &TMP533));
							}
							LA17: ;
...
appendString(result, val_134917);
						...
						TMP535 = addInt(res_134926, ((NI) 1));
						res_134926 = (NI)(TMP535);
					} LA10: ;
				}
			}
		}
...
NI TMP513;
static char* NIM_CONST TMP512[3] = {
"modeCaseSensitive", 
"modeCaseInsensitive", 
"modeStyleInsensitive"};
static TNimNode TMP474[8];
NTI134010.size = sizeof(Keyvaluepairseq134010*);
NTI134010.kind = 24;
NTI134010.base = (&NTI103553);
NTI134010.flags = 2;
NTI134010.marker = TMP499;
NTI134012.size = sizeof(Stringtableobj134012);
NTI134012.kind = 17;
NTI134012.base = (&NTI3411);
TMP510[0] = &TMP474[1];
TMP474[1].kind = 1;
TMP474[1].offset = offsetof(Stringtableobj134012, counter);
TMP474[1].typ = (&NTI108);
TMP474[1].name = "counter";
TMP510[1] = &TMP474[2];
TMP474[2].kind = 1;
TMP474[2].offset = offsetof(Stringtableobj134012, data);
TMP474[2].typ = (&NTI134010);
TMP474[2].name = "data";
TMP510[2] = &TMP474[3];
...
NTI134006.base = 0;
NTI134006.flags = 3;
for (TMP513 = 0; TMP513 < 3; TMP513++) {
TMP474[TMP513+4].kind = 1;
TMP474[TMP513+4].offset = TMP513;
TMP474[TMP513+4].name = TMP512[TMP513];
TMP511[TMP513] = &TMP474[TMP513+4];
}
TMP474[7].len = 3; TMP474[7].kind = 2; TMP474[7].sons = &TMP511[0];
NTI134006.node = &TMP474[7];
TMP474[3].kind = 1;
TMP474[3].offset = offsetof(Stringtableobj134012, mode);
TMP474[3].typ = (&NTI134006);
TMP474[3].name = "mode";
TMP474[0].len = 3; TMP474[0].kind = 2; TMP474[0].sons = &TMP510[0];
NTI134012.node = &TMP474[0];
NTI134014.size = sizeof(Stringtableobj134012*);
NTI134014.kind = 22;
NTI134014.base = (&NTI134012);
NTI134014.marker = TMP514;
}
