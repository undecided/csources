...
static NIM_CONST TY192031 TMP7903 = {
...
static NIM_CONST TY192031 TMP7910 = {
...
{	result = 0;
	...
	{
		{
			...
			res_400241 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7905 = addInt(res_400241, ((NI) 1));
					res_400241 = (NI)(TMP7905);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		nimln(29, "aliases.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP7906));
		}
		LA13: ;
			...
			res_400249 = ((NI) 1);
			{
				...
				while (1) {
					...
					default:
					{
						...
						internalerror_165218(((NimStringDesc*) &TMP7908));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7909 = addInt(res_400249, ((NI) 1));
					res_400249 = (NI)(TMP7909);
				} LA22: ;
			}
		}
	}
	...
	default:
	{
		...
		internalerror_165199((*n).info, ((NimStringDesc*) &TMP7912));
	}
	break;
	}
	}BeforeRet: ;
	...
	{
		{
			...
			res_400343 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA31: ;
					nimln(1614, "system.nim");
					TMP7914 = addInt(res_400343, ((NI) 1));
					res_400343 = (NI)(TMP7914);
				} LA28: ;
			}
		}
	}
