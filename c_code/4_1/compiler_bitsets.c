...
N_NIMCALL(NIM_BOOL, bitsetin_239077)(Tbitset239012* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP4064)] & ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4065)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_239061)(Tbitset239012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4067)] = (NI8)((*x)->data[(NI64)(TMP4068)] | ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4069))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_239069)(Tbitset239012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4070)] = (NI8)((*x)->data[(NI64)(TMP4071)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4072))))))))));
	popFrame();
}
	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_239265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4074 = addInt(res_239265, ((NI) 1));
				res_239265 = (NI)(TMP4074);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_239306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4075 = addInt(res_239306, ((NI) 1));
				res_239306 = (NI)(TMP4075);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_239347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4076 = addInt(res_239347, ((NI) 1));
				res_239347 = (NI)(TMP4076);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_239388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4077 = addInt(res_239388, ((NI) 1));
				res_239388 = (NI)(TMP4077);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_239429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4078 = addInt(res_239429, ((NI) 1));
				res_239429 = (NI)(TMP4078);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_239470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4079 = addInt(res_239470, ((NI) 1));
				res_239470 = (NI)(TMP4079);
			} LA3: ;
		}
	}
