...
static N_INLINE(NI, getid_189404)(void) {
	...
	nimln(31, "idgen.nim");
	TMP2542 = addInt(gfrontendid_189012, ((NI) 1));
...
static N_INLINE(NI, backendid_189422)(void) {
	...
	nimln(35, "idgen.nim");
	TMP2543 = addInt(gbackendid_189013, ((NI) 1));
	gbackendid_189013 = (NI)(TMP2543);
	popFrame();
	return result;
}
...
static N_INLINE(void, setid_189440)(NI id) {
	...
	gfrontendid_189012 = ((gfrontendid_189012 >= (NI)(TMP2544)) ? gfrontendid_189012 : (NI)(TMP2544));
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_189462)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_154001(((NimStringDesc*) &TMP2549), NIM_TRUE);
	popFrame();
	return result;
}
