...
STRING_LITERAL(TMP4080, "inSet", 5);
static NIM_CONST TY192031 TMP4082 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4083, "sons", 4);
STRING_LITERAL(TMP4085, "SomeInSet", 9);
STRING_LITERAL(TMP4108, "SetHasRange", 11);
...
{	result = 0;
	nimln(34, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4080));
	...
	LA3: ;
	{
		...
		TMP4081 = subInt(LOC6, ((NI) 1));
		HEX3Atmp_241138 = (NI)(TMP4081);
		...
		res_241141 = ((NI) 0);
		{
			...
			while (1) {
				...
				{
					if (((TMP4082[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
					...
					nimln(39, "nimsets.nim");
					{
						...
						if (((TMP4082[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
						if ((NU)(i_241121) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4082[(*(*s).kindU.S6.sons->data[i_241121]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241121]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
				...
				TMP4084 = addInt(res_241141, ((NI) 1));
				res_241141 = (NI)(TMP4084);
			} LA8: ;
		}
	}
...
N_NIMCALL(NIM_BOOL, overlap_241012)(Tnode191813* a, Tnode191813* b) {
	...
	nimln(48, "nimsets.nim");
	{
		...
		nimln(49, "nimsets.nim");
		{
			...
			LOC9 = 0;
			if (((TMP4082[(*a).kind/8] &(1<<((*a).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
			if ((NU)(((NI) 0)) >= (NU)((*a).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (((TMP4082[(*b).kind/8] &(1<<((*b).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
...
{	result = 0;
	nimln(63, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4085));
			...
			while (1) {
				...
				nimln(67, "nimsets.nim");
				{
					...
					nimln(68, "nimsets.nim");
					{
						...
						if (((TMP4082[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
						if ((NU)(i_241233) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4082[(*(*s).kindU.S6.sons->data[i_241233]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241233]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
				...
				LA9: ;
				nimln(1614, "system.nim");
				TMP4087 = addInt(res_241258, ((NI) 1));
				res_241258 = (NI)(TMP4087);
			} LA8: ;
		}
	}
...
N_NIMCALL(void, tobitset_241004)(Tnode191813* s, Tbitset240012** b) {
	...
	bitsetinit_240021(b, ((NI)chckRange64(LOC1, ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	{
		...
		TMP4088 = subInt(LOC3, ((NI) 1));
		HEX3Atmp_241325 = (NI)(TMP4088);
		nimln(1598, "system.nim");
		res_241328 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(82, "nimsets.nim");
				{
					...
					if (((TMP4082[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
					if ((NU)(i_241296) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4082[(*(*s).kindU.S6.sons->data[i_241296]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241296]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
				...
				LA8: ;
				{
					...
					TMP4091 = subInt64(LOC14, first);
					bitsetincl_240061(b, (NI64)(TMP4091));
				}
				LA6: ;
				nimln(1614, "system.nim");
				TMP4092 = addInt(res_241328, ((NI) 1));
				res_241328 = (NI)(TMP4092);
			} LA5: ;
		}
	}
	popFrame();
		...
		while (1) {
			...
			nimln(102, "nimsets.nim");
			{
				...
				nimln(109, "nimsets.nim");
				{
					...
					LOC21 = 0;
					LOC21 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4097), elemtype);
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4098), elemtype);
					addson_193819(n, LOC23);
					nimln(115, "nimsets.nim");
					TMP4099 = addInt64(b, first);
					LOC24 = 0;
					LOC24 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4099), elemtype);
	...
	tobitset_241004(a, (&x));
	{
		...
		res_241573 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4101 = addInt(res_241573, ((NI) 1));
				res_241573 = (NI)(TMP4101);
			} LA3: ;
		}
	}
...
N_NIMCALL(NI64, cardset_241089)(Tnode191813* s) {
	...
	result = IL64(0);
	{
		...
		TMP4102 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_241633 = (NI)(TMP4102);
		nimln(1598, "system.nim");
		res_241636 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(155, "nimsets.nim");
				{
					...
					if (((TMP4082[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
					if ((NU)(i_241608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4082[(*(*s).kindU.S6.sons->data[i_241608]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241608]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
					...
					TMP4104 = subInt64((NI64)(TMP4103), LOC10);
					TMP4105 = addInt64((NI64)(TMP4104), IL64(1));
					result = (NI64)(TMP4105);
				}
				goto LA5;
				LA7: ;
				{
					...
					TMP4106 = addInt64(result, ((NI) 1));
					result = (NI64)(TMP4106);
				}
				LA5: ;
				nimln(1614, "system.nim");
				TMP4107 = addInt(res_241636, ((NI) 1));
				res_241636 = (NI)(TMP4107);
			} LA4: ;
		}
	}
	popFrame();
...
{	result = 0;
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4108));
	...
	LA3: ;
	{
		...
		LOC6 = 0;
		LOC6 = sonslen_194403(s);
		TMP4109 = subInt(LOC6, ((NI) 1));
		HEX3Atmp_241692 = (NI)(TMP4109);
		nimln(1598, "system.nim");
		res_241695 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA11: ;
				nimln(1614, "system.nim");
				TMP4110 = addInt(res_241695, ((NI) 1));
				res_241695 = (NI)(TMP4110);
			} LA8: ;
		}
	}
