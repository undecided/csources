...
STRING_LITERAL(TMP10780, "nodejs", 6);
STRING_LITERAL(TMP10781, "node", 4);
...
N_NIMCALL(NimStringDesc*, findnodejs_526009)(void) {
	...
	result = 0;
	nimln(4, "nodejs.nim");
	result = findexe_127616(((NimStringDesc*) &TMP10780));
	nimln(5, "nodejs.nim");
	{
		if (!((result) && (result)->Sup.len == 0)) goto LA3;
		nimln(6, "nodejs.nim");
		result = findexe_127616(((NimStringDesc*) &TMP10781));
	}
	LA3: ;
	popFrame();
	return result;
