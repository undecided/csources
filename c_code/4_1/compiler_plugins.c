...
N_NIMCALL(void, TMP8077)(void* p, NI op);
...
static TNimNode* TMP8076[5];
static TNimNode TMP8074[6];
NTI406019.size = sizeof(PluginHEX3Aobjecttype406019);
NTI406019.kind = 18;
NTI406019.base = 0;
TMP8076[0] = &TMP8074[1];
TMP8074[1].kind = 1;
TMP8074[1].offset = offsetof(PluginHEX3Aobjecttype406019, fn);
TMP8074[1].typ = (&NTI166019);
TMP8074[1].name = "fn";
TMP8076[1] = &TMP8074[2];
TMP8074[2].kind = 1;
TMP8074[2].offset = offsetof(PluginHEX3Aobjecttype406019, module);
TMP8074[2].typ = (&NTI166019);
TMP8074[2].name = "module";
TMP8076[2] = &TMP8074[3];
TMP8074[3].kind = 1;
TMP8074[3].offset = offsetof(PluginHEX3Aobjecttype406019, package);
TMP8074[3].typ = (&NTI166019);
TMP8074[3].name = "package";
TMP8076[3] = &TMP8074[4];
...
NTI406013.flags = 3;
TMP8074[4].kind = 1;
TMP8074[4].offset = offsetof(PluginHEX3Aobjecttype406019, t);
TMP8074[4].typ = (&NTI406013);
TMP8074[4].name = "t";
TMP8076[4] = &TMP8074[5];
TMP8074[5].kind = 1;
TMP8074[5].offset = offsetof(PluginHEX3Aobjecttype406019, next);
TMP8074[5].typ = (&NTI406015);
TMP8074[5].name = "next";
TMP8074[0].len = 5; TMP8074[0].kind = 2; TMP8074[0].sons = &TMP8076[0];
NTI406019.node = &TMP8074[0];
NTI406015.size = sizeof(PluginHEX3Aobjecttype406019*);
NTI406015.kind = 22;
NTI406015.base = (&NTI406019);
NTI406015.marker = TMP8077;
}
