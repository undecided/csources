...
static NIM_CONST TY192031 TMP7981 = {
...
static NIM_CONST TY192031 TMP7991 = {
...
{	result = 0;
	...
	{
		{
			...
			res_403098 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7983 = subInt(field, i_403029);
					result = ithfield_403012((*n).kindU.S6.sons->data[i_403029], (NI)(TMP7983));
					...
					TMP7984 = addInt(res_403098, ((NI) 1));
					res_403098 = (NI)(TMP7984);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_165199((*n).info, ((NimStringDesc*) &TMP7985));
		}
		LA13: ;
		...
		result = ithfield_403012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7986));
			...
			res_403106 = ((NI) 1);
			{
				...
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_403012(LOC24, (NI)(TMP7988));
					...
					default:
					{
						...
						internalerror_165199((*n).info, ((NimStringDesc*) &TMP7989));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7990 = addInt(res_403106, ((NI) 1));
					res_403106 = (NI)(TMP7990);
				} LA22: ;
			}
		}
	}
...
appendString(LOC14, LOC15);
						...
						TMP7994 = addInt(res_403313, ((NI) 1));
						res_403313 = (NI)(TMP7994);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP7995 = addInt(res_403321, ((NI) 1));
						res_403321 = (NI)(TMP7995);
					} LA23: ;
				}
			}
		}
				...
				m_403253 = 0;
				{
					...
					res_403333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP7997 = addInt(res_403333, ((NI) 1));
							res_403333 = (NI)(TMP7997);
						} LA47: ;
					}
				}
			}
				...
				m_403265 = 0;
				{
					...
					res_403344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP7999 = addInt(res_403344, ((NI) 1));
							res_403344 = (NI)(TMP7999);
						} LA59: ;
					}
				}
			}
