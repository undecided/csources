...
NIM_CONST TY219020 parsernames_219019 = {((NimStringDesc*) &TMP3398),
...
NIM_CONST TY219026 filternames_219025 = {((NimStringDesc*) &TMP3402),
...
static NIM_CONST TY192031 TMP3421 = {
...
{	result = 0;
	{
		...
		res_219429 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP3417 = addInt(res_219429, ((NI) 1));
				res_219429 = (NI)(TMP3417);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_219629 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP3418 = addInt(res_219629, ((NI) 1));
				res_219629 = (NI)(TMP3418);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3421[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3422));
		LOC7 = identeq_167484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP3423));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_219772;
			...
			res_219798 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA16: ;
					nimln(1614, "system.nim");
					TMP3424 = addInt(res_219798, ((NI) 1));
					res_219798 = (NI)(TMP3424);
				} LA15: ;
			}
		}
	}
...
NTI219007.node = &TMP2927[6];
TMP2927[1].kind = 1;
TMP2927[1].offset = offsetof(Tparsers219035, skin);
TMP2927[1].typ = (&NTI219007);
TMP2927[1].name = "skin";
TMP3406[1] = &TMP2927[7];
TMP2927[7].kind = 1;
TMP2927[7].offset = offsetof(Tparsers219035, parser);
TMP2927[7].typ = (&NTI207205);
TMP2927[7].name = "parser";
TMP2927[0].len = 2; TMP2927[0].kind = 2; TMP2927[0].sons = &TMP3406[0];
NTI219035.node = &TMP2927[0];
}
