...
N_NIMCALL(Socketimpl513407*, newsocket_513708)(int fd, NIM_BOOL isbuff) {
	...
	nimln(123, "net.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP10637));
	}
	LA3: ;
	nimln(124, "net.nim");
...
{	nimln(879, "net.nim");
	...
	nimln(885, "net.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_518220).Sup.Sup.message; (*e_518220).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10642));
		...
		read = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(644, "net.nim");
				{
					...
					failedassertimpl_87017(((NimStringDesc*) &TMP10660));
				}
				LA39: ;
				nimln(645, "net.nim");
				if (!(((2 &(1<<(((*socket).isbuffered)&7)))!=0))) raiseFieldError(((NimStringDesc*) &TMP10656));
