...
N_NIMCALL(void, enlarge_312185)(Table311052* t) {
	...
	n = (Keyvaluepairseq311055*) newSeq((&NTI311055), ((NI)chckRange((NI)(TMP5910), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_312294 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5913 = addInt(res_312294, ((NI) 1));
				res_312294 = (NI)(TMP5913);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_315109)(Table312409* t) {
	...
	n = (Keyvaluepairseq312412*) newSeq((&NTI312412), ((NI)chckRange((NI)(TMP5997), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_315227 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP6000 = addInt(res_315227, ((NI) 1));
				res_315227 = (NI)(TMP6000);
			} LA4: ;
		}
	}
	popFrame();
...
TMP733[15].len = 2; TMP733[15].kind = 2; TMP733[15].sons = &TMP6252[0];
...
TMP733[18].len = 3; TMP733[18].kind = 2; TMP733[18].sons = &TMP7577[0];
