...
N_NIMCALL(void, TMP4073)(void* p, NI op);
...
STRING_LITERAL(TMP4066, "0 <= elem ", 10);
...
N_NIMCALL(NIM_BOOL, bitsetin_240077)(Tbitset240012* x, NI64 e) {
	...
	TMP4064 = divInt64(e, IL64(8));
	if ((NU)((NI64)(TMP4064)) >= (NU)(x->Sup.len)) raiseIndexError();
	TMP4065 = modInt64(e, IL64(8));
	result = !(((NI8)(x->data[(NI64)(TMP4064)] & ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4065)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_240061)(Tbitset240012** x, NI64 elem) {
	...
	nimln(38, "bitsets.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP4066));
	}
	LA3: ;
	nimln(39, "bitsets.nim");
	TMP4067 = divInt64(elem, IL64(8));
	...
	TMP4069 = modInt64(elem, IL64(8));
	(*x)->data[(NI64)(TMP4067)] = (NI8)((*x)->data[(NI64)(TMP4068)] | ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4069))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_240069)(Tbitset240012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4070)] = (NI8)((*x)->data[(NI64)(TMP4071)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4072))))))))));
	popFrame();
}
	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_240265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4074 = addInt(res_240265, ((NI) 1));
				res_240265 = (NI)(TMP4074);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_240306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4075 = addInt(res_240306, ((NI) 1));
				res_240306 = (NI)(TMP4075);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_240347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4076 = addInt(res_240347, ((NI) 1));
				res_240347 = (NI)(TMP4076);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_240388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4077 = addInt(res_240388, ((NI) 1));
				res_240388 = (NI)(TMP4077);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_240429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4078 = addInt(res_240429, ((NI) 1));
				res_240429 = (NI)(TMP4078);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_240470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4079 = addInt(res_240470, ((NI) 1));
				res_240470 = (NI)(TMP4079);
			} LA3: ;
		}
	}
