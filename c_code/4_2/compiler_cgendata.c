...
TMP8915[0] = &TMP8913[1];
TMP8913[1].kind = 1;
TMP8913[1].offset = offsetof(Tcgen457038, module);
TMP8913[1].typ = (&NTI191811);
TMP8913[1].name = "module";
TMP8915[1] = &TMP8913[2];
TMP8913[2].kind = 1;
TMP8913[2].offset = offsetof(Tcgen457038, filename);
...
NTI457022.flags = 2;
TMP8913[3].kind = 1;
TMP8913[3].offset = offsetof(Tcgen457038, s);
TMP8913[3].typ = (&NTI457022);
TMP8913[3].name = "s";
TMP8915[3] = &TMP8913[4];
TMP8913[4].kind = 1;
TMP8913[4].offset = offsetof(Tcgen457038, preventstacktrace);
TMP8913[4].typ = (&NTI138);
TMP8913[4].name = "preventStackTrace";
TMP8915[4] = &TMP8913[5];
TMP8913[5].kind = 1;
TMP8913[5].offset = offsetof(Tcgen457038, usesthreadvars);
TMP8913[5].typ = (&NTI138);
TMP8913[5].name = "usesThreadVars";
TMP8915[5] = &TMP8913[6];
TMP8913[6].kind = 1;
TMP8913[6].offset = offsetof(Tcgen457038, framedeclared);
TMP8913[6].typ = (&NTI138);
TMP8913[6].name = "frameDeclared";
TMP8915[6] = &TMP8913[7];
TMP8913[7].kind = 1;
TMP8913[7].offset = offsetof(Tcgen457038, isheaderfile);
TMP8913[7].typ = (&NTI138);
TMP8913[7].name = "isHeaderFile";
TMP8915[7] = &TMP8913[8];
TMP8913[8].kind = 1;
TMP8913[8].offset = offsetof(Tcgen457038, includesstringh);
TMP8913[8].typ = (&NTI138);
TMP8913[8].name = "includesStringh";
TMP8915[8] = &TMP8913[9];
TMP8913[9].kind = 1;
TMP8913[9].offset = offsetof(Tcgen457038, objhaskidsvalid);
TMP8913[9].typ = (&NTI138);
TMP8913[9].name = "objHasKidsValid";
TMP8915[9] = &TMP8913[10];
TMP8913[10].kind = 1;
TMP8913[10].offset = offsetof(Tcgen457038, cfilename);
TMP8913[10].typ = (&NTI149);
TMP8913[10].name = "cfilename";
TMP8915[10] = &TMP8913[11];
TMP8913[11].kind = 1;
TMP8913[11].offset = offsetof(Tcgen457038, typecache);
TMP8913[11].typ = (&NTI191861);
TMP8913[11].name = "typeCache";
TMP8915[11] = &TMP8913[12];
TMP8913[12].kind = 1;
TMP8913[12].offset = offsetof(Tcgen457038, forwtypecache);
TMP8913[12].typ = (&NTI191861);
TMP8913[12].name = "forwTypeCache";
TMP8915[12] = &TMP8913[13];
TMP8913[13].kind = 1;
TMP8913[13].offset = offsetof(Tcgen457038, declaredthings);
TMP8913[13].typ = (&NTI188056);
TMP8913[13].name = "declaredThings";
TMP8915[13] = &TMP8913[14];
TMP8913[14].kind = 1;
TMP8913[14].offset = offsetof(Tcgen457038, declaredprotos);
TMP8913[14].typ = (&NTI188056);
TMP8913[14].name = "declaredProtos";
TMP8915[14] = &TMP8913[15];
TMP8913[15].kind = 1;
TMP8913[15].offset = offsetof(Tcgen457038, headerfiles);
TMP8913[15].typ = (&NTI130028);
TMP8913[15].name = "headerFiles";
TMP8915[15] = &TMP8913[16];
TMP8913[16].kind = 1;
TMP8913[16].offset = offsetof(Tcgen457038, typeinfomarker);
TMP8913[16].typ = (&NTI188056);
...
TMP8913[19].kind = 1;
TMP8913[19].offset = offsetof(Tcproc457034, prc);
TMP8913[19].typ = (&NTI191811);
TMP8913[19].name = "prc";
TMP8916[1] = &TMP8913[20];
TMP8913[20].kind = 1;
TMP8913[20].offset = offsetof(Tcproc457034, beforeretneeded);
TMP8913[20].typ = (&NTI138);
TMP8913[20].name = "beforeRetNeeded";
TMP8916[2] = &TMP8913[21];
TMP8913[21].kind = 1;
TMP8913[21].offset = offsetof(Tcproc457034, threadvaraccessed);
TMP8913[21].typ = (&NTI138);
TMP8913[21].name = "threadVarAccessed";
TMP8916[3] = &TMP8913[22];
TMP8913[22].kind = 1;
TMP8913[22].offset = offsetof(Tcproc457034, lastlineinfo);
TMP8913[22].typ = (&NTI163338);
TMP8913[22].name = "lastLineInfo";
TMP8916[4] = &TMP8913[23];
TMP8913[23].kind = 1;
TMP8913[23].offset = offsetof(Tcproc457034, nestedtrystmts);
TMP8913[23].typ = (&NTI191807);
TMP8913[23].name = "nestedTryStmts";
TMP8916[5] = &TMP8913[24];
TMP8913[24].kind = 1;
TMP8913[24].offset = offsetof(Tcproc457034, inexceptblock);
TMP8913[24].typ = (&NTI108);
TMP8913[24].name = "inExceptBlock";
TMP8916[6] = &TMP8913[25];
TMP8913[25].kind = 1;
TMP8913[25].offset = offsetof(Tcproc457034, finallysafepoints);
TMP8913[25].typ = (&NTI161599);
TMP8913[25].name = "finallySafePoints";
TMP8916[7] = &TMP8913[26];
TMP8913[26].kind = 1;
TMP8913[26].offset = offsetof(Tcproc457034, labels);
...
TMP8913[29].kind = 1;
TMP8913[29].offset = offsetof(Tblock457032, id);
TMP8913[29].typ = (&NTI108);
TMP8913[29].name = "id";
TMP8917[1] = &TMP8913[30];
TMP8913[30].kind = 1;
TMP8913[30].offset = offsetof(Tblock457032, label);
TMP8913[30].typ = (&NTI161007);
...
NTI457026.flags = 2;
TMP8913[31].kind = 1;
TMP8913[31].offset = offsetof(Tblock457032, sections);
TMP8913[31].typ = (&NTI457026);
TMP8913[31].name = "sections";
TMP8917[3] = &TMP8913[32];
TMP8913[32].kind = 1;
TMP8913[32].offset = offsetof(Tblock457032, isloop);
TMP8913[32].typ = (&NTI138);
TMP8913[32].name = "isLoop";
TMP8917[4] = &TMP8913[33];
TMP8913[33].kind = 1;
TMP8913[33].offset = offsetof(Tblock457032, nestedtrystmts);
TMP8913[33].typ = (&NTI112);
TMP8913[33].name = "nestedTryStmts";
TMP8917[5] = &TMP8913[34];
TMP8913[34].kind = 1;
TMP8913[34].offset = offsetof(Tblock457032, nestedexceptstmts);
TMP8913[34].typ = (&NTI112);
TMP8913[34].name = "nestedExceptStmts";
TMP8917[6] = &TMP8913[35];
TMP8913[35].kind = 1;
TMP8913[35].offset = offsetof(Tblock457032, framelen);
TMP8913[35].typ = (&NTI112);
TMP8913[35].name = "frameLen";
TMP8913[28].len = 7; TMP8913[28].kind = 2; TMP8913[28].sons = &TMP8917[0];
NTI457032.node = &TMP8913[28];
NTI457106.size = sizeof(TY457106*);
NTI457106.kind = 24;
NTI457106.base = (&NTI457032);
NTI457106.flags = 2;
NTI457106.marker = TMP8918;
TMP8913[27].kind = 1;
TMP8913[27].offset = offsetof(Tcproc457034, blocks);
TMP8913[27].typ = (&NTI457106);
TMP8913[27].name = "blocks";
TMP8916[9] = &TMP8913[36];
TMP8913[36].kind = 1;
TMP8913[36].offset = offsetof(Tcproc457034, breakidx);
TMP8913[36].typ = (&NTI108);
TMP8913[36].name = "breakIdx";
TMP8916[10] = &TMP8913[37];
TMP8913[37].kind = 1;
TMP8913[37].offset = offsetof(Tcproc457034, options);
TMP8913[37].typ = (&NTI154121);
TMP8913[37].name = "options";
TMP8916[11] = &TMP8913[38];
TMP8913[38].kind = 1;
TMP8913[38].offset = offsetof(Tcproc457034, maxframelen);
TMP8913[38].typ = (&NTI108);
TMP8913[38].name = "maxFrameLen";
TMP8916[12] = &TMP8913[39];
TMP8913[39].kind = 1;
TMP8913[39].offset = offsetof(Tcproc457034, module);
TMP8913[39].typ = (&NTI457028);
TMP8913[39].name = "module";
TMP8916[13] = &TMP8913[40];
TMP8913[40].kind = 1;
TMP8913[40].offset = offsetof(Tcproc457034, withinloop);
TMP8913[40].typ = (&NTI108);
TMP8913[40].name = "withinLoop";
TMP8916[14] = &TMP8913[41];
TMP8913[41].kind = 1;
TMP8913[41].offset = offsetof(Tcproc457034, splitdecls);
TMP8913[41].typ = (&NTI108);
TMP8913[41].name = "splitDecls";
TMP8916[15] = &TMP8913[42];
TMP8913[42].kind = 1;
TMP8913[42].offset = offsetof(Tcproc457034, gcframeid);
TMP8913[42].typ = (&NTI3407);
TMP8913[42].name = "gcFrameId";
TMP8916[16] = &TMP8913[43];
TMP8913[43].kind = 1;
TMP8913[43].offset = offsetof(Tcproc457034, gcframetype);
TMP8913[43].typ = (&NTI161007);
TMP8913[43].name = "gcFrameType";
TMP8913[18].len = 17; TMP8913[18].kind = 2; TMP8913[18].sons = &TMP8916[0];
NTI457034.node = &TMP8913[18];
NTI457030.size = sizeof(Tcproc457034*);
NTI457030.kind = 22;
NTI457030.base = (&NTI457034);
NTI457030.marker = TMP8919;
TMP8913[17].kind = 1;
TMP8913[17].offset = offsetof(Tcgen457038, initproc);
TMP8913[17].typ = (&NTI457030);
TMP8913[17].name = "initProc";
TMP8915[17] = &TMP8913[44];
TMP8913[44].kind = 1;
TMP8913[44].offset = offsetof(Tcgen457038, postinitproc);
TMP8913[44].typ = (&NTI457030);
TMP8913[44].name = "postInitProc";
TMP8915[18] = &TMP8913[45];
TMP8913[45].kind = 1;
TMP8913[45].offset = offsetof(Tcgen457038, preinitproc);
TMP8913[45].typ = (&NTI457030);
TMP8913[45].name = "preInitProc";
TMP8915[19] = &TMP8913[46];
TMP8913[46].kind = 1;
TMP8913[46].offset = offsetof(Tcgen457038, typestack);
TMP8913[46].typ = (&NTI191845);
TMP8913[46].name = "typeStack";
TMP8915[20] = &TMP8913[47];
TMP8913[47].kind = 1;
TMP8913[47].offset = offsetof(Tcgen457038, datacache);
TMP8913[47].typ = (&NTI191873);
TMP8913[47].name = "dataCache";
TMP8915[21] = &TMP8913[48];
TMP8913[48].kind = 1;
TMP8913[48].offset = offsetof(Tcgen457038, forwardedprocs);
TMP8913[48].typ = (&NTI191815);
TMP8913[48].name = "forwardedProcs";
TMP8915[22] = &TMP8913[49];
TMP8913[49].kind = 1;
TMP8913[49].offset = offsetof(Tcgen457038, typenodes);
TMP8913[49].typ = (&NTI108);
TMP8913[49].name = "typeNodes";
TMP8915[23] = &TMP8913[50];
TMP8913[50].kind = 1;
TMP8913[50].offset = offsetof(Tcgen457038, nimtypes);
TMP8913[50].typ = (&NTI108);
TMP8913[50].name = "nimTypes";
TMP8915[24] = &TMP8913[51];
TMP8913[51].kind = 1;
TMP8913[51].offset = offsetof(Tcgen457038, typenodesname);
TMP8913[51].typ = (&NTI161007);
TMP8913[51].name = "typeNodesName";
TMP8915[25] = &TMP8913[52];
TMP8913[52].kind = 1;
TMP8913[52].offset = offsetof(Tcgen457038, nimtypesname);
TMP8913[52].typ = (&NTI161007);
TMP8913[52].name = "nimTypesName";
TMP8915[26] = &TMP8913[53];
TMP8913[53].kind = 1;
TMP8913[53].offset = offsetof(Tcgen457038, labels);
