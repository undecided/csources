...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP3345, "\012", 1);
STRING_LITERAL(TMP3356, "", 0);
STRING_LITERAL(TMP3359, "end", 3);
STRING_LITERAL(TMP3360, "#end", 4);
static NIM_CONST TY77659 TMP3363 = {
...
STRING_LITERAL(TMP3369, "\\x", 2);
STRING_LITERAL(TMP3371, "\\\\", 2);
STRING_LITERAL(TMP3373, "\\\'", 2);
STRING_LITERAL(TMP3375, "\\\"", 2);
STRING_LITERAL(TMP3379, "}", 1);
STRING_LITERAL(TMP3387, "$", 1);
STRING_LITERAL(TMP3389, "\\n\"", 3);
STRING_LITERAL(TMP3390, "subschar", 8);
STRING_LITERAL(TMP3391, "metachar", 8);
STRING_LITERAL(TMP3392, "emit", 4);
STRING_LITERAL(TMP3393, "result.add", 10);
STRING_LITERAL(TMP3394, "conc", 4);
STRING_LITERAL(TMP3395, " & ", 3);
STRING_LITERAL(TMP3396, "tostring", 8);
...
N_NIMCALL(void, newline_218047)(Ttmplparser218020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3345));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_218149)(Ttmplparser218020* p) {
	...
	LA7: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP3356));
		{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_165155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3359));
			}
			LA20: ;
			...
			llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3360));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
		...
		case ((NU16) 26):
		{
			...
			TMP3362 = subInt((*p).indent, ((NI) 2));
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3362), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU16) 62):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				NI TMP3364;
				LOC37 = 0;
				LOC37 = contains_99373((*p).x, TMP3363);
				if (!!(LOC37)) goto LA38;
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3365), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU8) 0):
		{
			...
			TMP3368 = addInt((*p).emitpar, ((NI) 1));
			(*p).emitpar = (NI)(TMP3368);
		}
		break;
		}
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_165155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3379));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_165155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3387));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3389));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream178204*, filtertmpl_218009)(Tllstream178204* stdin_218011, NimStringDesc* filename, Tnode191813* call) {
	...
	p.outp = llstreamopen_178220(((NimStringDesc*) &TMP3356));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_218011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_217020(call, ((NimStringDesc*) &TMP3390), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_217020(call, ((NimStringDesc*) &TMP3391), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_217029(call, ((NimStringDesc*) &TMP3392), ((NI) 3), ((NimStringDesc*) &TMP3393));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_217029(call, ((NimStringDesc*) &TMP3394), ((NI) 4), ((NimStringDesc*) &TMP3395));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_217029(call, ((NimStringDesc*) &TMP3396), ((NI) 5), ((NimStringDesc*) &TMP3387));
	...
	p.x = rawNewString(((NI) 120));
	{
		...
		while (1) {
			...
			TMP3397 = addInt(p.info.line, ((NI16) 1));
			if (TMP3397 < -32768 || TMP3397 > 32767) raiseOverflow();
			p.info.line = (NI16)(TMP3397);
