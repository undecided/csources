...
{	result = 0;
	...
	asgnRefNoCycle((void**) (&(*result).s), mnewString(((NI)chckRange(length, ((NI) 0), ((NI) IL64(9223372036854775807))))));
	{
		...
		res_167438 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1315 = addInt(res_167438, ((NI) 1));
				res_167438 = (NI)(TMP1315);
			} LA24: ;
		}
	}
	nimln(90, "idents.nim");
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(93, "idents.nim");
		TMP1316 = addInt(wordcounter_167244, ((NI) 1));
		wordcounter_167244 = (NI)(TMP1316);
		nimln(94, "idents.nim");
		if (wordcounter_167244 == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
...
NIM_EXTERNC N_NOINLINE(void, compiler_identsInit)(void) {
	...
	asgnRefNoCycle((void**) (&idanon_167495), getident_167463(((NimStringDesc*) &TMP1317)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) (&iddelegator_167550), getident_167463(((NimStringDesc*) &TMP1318)));
	popFrame();
}
...
NTI167015.flags = 1;
TMP1299[0].kind = 1;
TMP1299[0].offset = offsetof(Tidobj167015, id);
TMP1299[0].typ = (&NTI108);
TMP1299[0].name = "id";
NTI167015.node = &TMP1299[0];
...
TMP1312[0] = &TMP1299[2];
TMP1299[2].kind = 1;
TMP1299[2].offset = offsetof(Tident167021, s);
TMP1299[2].typ = (&NTI149);
TMP1299[2].name = "s";
TMP1312[1] = &TMP1299[3];
TMP1299[3].kind = 1;
TMP1299[3].offset = offsetof(Tident167021, next);
TMP1299[3].typ = (&NTI167019);
TMP1299[3].name = "next";
TMP1312[2] = &TMP1299[4];
TMP1299[4].kind = 1;
TMP1299[4].offset = offsetof(Tident167021, h);
TMP1299[4].typ = (&NTI131021);
TMP1299[4].name = "h";
TMP1299[1].len = 3; TMP1299[1].kind = 2; TMP1299[1].sons = &TMP1312[0];
NTI167021.node = &TMP1299[1];
NTI167019.size = sizeof(Tident167021*);
NTI167019.kind = 22;
NTI167019.base = (&NTI167021);
NTI167019.flags = 2;
NTI167019.marker = TMP1313;
NTI167017.size = sizeof(Tidobj167015*);
NTI167017.kind = 22;
NTI167017.base = (&NTI167015);
NTI167017.marker = TMP2636;
}
