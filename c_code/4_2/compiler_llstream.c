...
N_NIMCALL(NIM_BOOL, endswithopr_178450)(NimStringDesc* x) {
	...
	result = endswith_178404(x, TMP2089);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_178460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_178404(line, TMP2090);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_178686)(Tllstream178204* s, NimStringDesc* data) {
	...
	llstreamwrite_178665(s, ((NimStringDesc*) &TMP2086));
	popFrame();
}
...
NTI178202.node = &TMP2078[6];
TMP2078[1].kind = 1;
TMP2078[1].offset = offsetof(Tllstream178204, kind);
TMP2078[1].typ = (&NTI178202);
TMP2078[1].name = "kind";
TMP2080[1] = &TMP2078[7];
TMP2078[7].kind = 1;
TMP2078[7].offset = offsetof(Tllstream178204, f);
TMP2078[7].typ = (&NTI13004);
TMP2078[7].name = "f";
TMP2080[2] = &TMP2078[8];
TMP2078[8].kind = 1;
TMP2078[8].offset = offsetof(Tllstream178204, s);
TMP2078[8].typ = (&NTI149);
TMP2078[8].name = "s";
TMP2080[3] = &TMP2078[9];
TMP2078[9].kind = 1;
TMP2078[9].offset = offsetof(Tllstream178204, rd);
TMP2078[9].typ = (&NTI108);
TMP2078[9].name = "rd";
TMP2080[4] = &TMP2078[10];
TMP2078[10].kind = 1;
TMP2078[10].offset = offsetof(Tllstream178204, wr);
TMP2078[10].typ = (&NTI108);
TMP2078[10].name = "wr";
TMP2080[5] = &TMP2078[11];
TMP2078[11].kind = 1;
TMP2078[11].offset = offsetof(Tllstream178204, lineoffset);
TMP2078[11].typ = (&NTI108);
TMP2078[11].name = "lineOffset";
TMP2078[0].len = 6; TMP2078[0].kind = 2; TMP2078[0].sons = &TMP2080[0];
NTI178204.node = &TMP2078[0];
NTI178206.size = sizeof(Tllstream178204*);
NTI178206.kind = 22;
NTI178206.base = (&NTI178204);
NTI178206.marker = TMP2084;
}
