...
N_NIMCALL(Tllstream177204*, llstreamopenstdin_177293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2085));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_177319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13457(stdout, ((NimStringDesc*) &TMP2086));
...
N_NIMCALL(NIM_BOOL, endswith_177404)(NimStringDesc* x, TY77659 s) {
	...
	TMP2087 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2087);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_177450)(NimStringDesc* x) {
	...
	result = endswith_177404(x, TMP2089);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_177460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_177404(line, TMP2090);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(NI, llreadfromstdin_177528)(Tllstream177204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2085));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
appendString((*s).s, ((NimStringDesc*) &TMP2086));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_177483(line);
			TMP2098 = addInt(triples, LOC11);
			triples = (NI)(TMP2098);
	...
	TMP2099 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2099);
...
N_NIMCALL(NI, llstreamread_177584)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(124, "llstream.nim");
		{
			...
			TMP2103 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2103)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2103)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*s).s, data);
		...
		TMP2109 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2109);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_177686)(Tllstream177204* s, NimStringDesc* data) {
	...
	llstreamwrite_177665(s, ((NimStringDesc*) &TMP2086));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_177718)(Tllstream177204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2111 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2111), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2112 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2112)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2112)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2113 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2113);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2114 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2114), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2115 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2115)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13515((*s).f, ((void*) ((&result->data[(NI)(TMP2115)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2116 = addInt(i, bytes);
				i = (NI)(TMP2116);
			} LA10: ;
		}
...
static TNimNode* TMP2080[6];
static TNimNode* TMP2081[4];
NI TMP2083;
static char* NIM_CONST TMP2082[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2078[12];
...
NTI177202.base = 0;
NTI177202.flags = 3;
for (TMP2083 = 0; TMP2083 < 4; TMP2083++) {
TMP2078[TMP2083+2].kind = 1;
TMP2078[TMP2083+2].offset = TMP2083;
TMP2078[TMP2083+2].name = TMP2082[TMP2083];
TMP2081[TMP2083] = &TMP2078[TMP2083+2];
}
TMP2078[6].len = 4; TMP2078[6].kind = 2; TMP2078[6].sons = &TMP2081[0];
NTI177202.node = &TMP2078[6];
TMP2078[1].kind = 1;
TMP2078[1].offset = offsetof(Tllstream177204, kind);
TMP2078[1].typ = (&NTI177202);
TMP2078[1].name = "kind";
TMP2080[1] = &TMP2078[7];
TMP2078[7].kind = 1;
TMP2078[7].offset = offsetof(Tllstream177204, f);
TMP2078[7].typ = (&NTI13004);
TMP2078[7].name = "f";
TMP2080[2] = &TMP2078[8];
TMP2078[8].kind = 1;
TMP2078[8].offset = offsetof(Tllstream177204, s);
TMP2078[8].typ = (&NTI149);
TMP2078[8].name = "s";
TMP2080[3] = &TMP2078[9];
TMP2078[9].kind = 1;
TMP2078[9].offset = offsetof(Tllstream177204, rd);
TMP2078[9].typ = (&NTI108);
TMP2078[9].name = "rd";
TMP2080[4] = &TMP2078[10];
TMP2078[10].kind = 1;
TMP2078[10].offset = offsetof(Tllstream177204, wr);
TMP2078[10].typ = (&NTI108);
TMP2078[10].name = "wr";
TMP2080[5] = &TMP2078[11];
TMP2078[11].kind = 1;
TMP2078[11].offset = offsetof(Tllstream177204, lineoffset);
TMP2078[11].typ = (&NTI108);
TMP2078[11].name = "lineOffset";
TMP2078[0].len = 6; TMP2078[0].kind = 2; TMP2078[0].sons = &TMP2080[0];
NTI177204.node = &TMP2078[0];
NTI177206.size = sizeof(Tllstream177204*);
NTI177206.kind = 22;
NTI177206.base = (&NTI177204);
NTI177206.marker = TMP2084;
}
