...
N_NIMCALL(void, fillbuffer_179097)(Tbaselexer179024* L) {
	...
	nimln(82, "nimlexbase.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP2117));
	}
	LA3: ;
	...
	nimln(85, "nimlexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP2121)]))), ((NI)chckRange((NI)(TMP2122), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA11: ;
	...
	LOC13 = 0;
	LOC13 = llstreamread_178584((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP2124));
		...
		s = (NI)(TMP2128);
		{
			...
			while (1) {
				nimln(98, "nimlexbase.nim");
				{
					...
					failedassertimpl_87017(((NimStringDesc*) &TMP2129));
				}
				LA23: ;
				{
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP2132), ((NI) 0), ((NI) IL64(9223372036854775807)))));
					...
					LOC39 = 0;
					LOC39 = llstreamread_178584((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP2135));
...
N_NIMCALL(void, openbaselexer_179035)(Tbaselexer179024* L, Tllstream178204* inputstream, NI buflen) {
	...
	LOC5 = 0;
	LOC5 = alloc_6001(((NI)chckRange((NI)(TMP2149), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	(*L).buf = ((NCSTRING) (LOC5));
...
N_NIMCALL(NI, getcolnumber_179059)(Tbaselexer179024* L, NI pos) {
	...
	if ((NI)(TMP2151) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
...
TMP2490[0] = &TMP2076[1];
TMP2076[1].kind = 1;
TMP2076[1].offset = offsetof(Tbaselexer179024, bufpos);
TMP2076[1].typ = (&NTI108);
TMP2076[1].name = "bufpos";
TMP2490[1] = &TMP2076[2];
TMP2076[2].kind = 1;
TMP2076[2].offset = offsetof(Tbaselexer179024, buf);
TMP2076[2].typ = (&NTI151);
TMP2076[2].name = "buf";
TMP2490[2] = &TMP2076[3];
TMP2076[3].kind = 1;
TMP2076[3].offset = offsetof(Tbaselexer179024, buflen);
TMP2076[3].typ = (&NTI108);
TMP2076[3].name = "bufLen";
TMP2490[3] = &TMP2076[4];
TMP2076[4].kind = 1;
TMP2076[4].offset = offsetof(Tbaselexer179024, stream);
TMP2076[4].typ = (&NTI178206);
TMP2076[4].name = "stream";
TMP2490[4] = &TMP2076[5];
TMP2076[5].kind = 1;
TMP2076[5].offset = offsetof(Tbaselexer179024, linenumber);
TMP2076[5].typ = (&NTI108);
TMP2076[5].name = "lineNumber";
TMP2490[5] = &TMP2076[6];
TMP2076[6].kind = 1;
TMP2076[6].offset = offsetof(Tbaselexer179024, sentinel);
TMP2076[6].typ = (&NTI108);
TMP2076[6].name = "sentinel";
TMP2490[6] = &TMP2076[7];
TMP2076[7].kind = 1;
TMP2076[7].offset = offsetof(Tbaselexer179024, linestart);
TMP2076[7].typ = (&NTI108);
TMP2076[7].name = "lineStart";
TMP2076[0].len = 7; TMP2076[0].kind = 2; TMP2076[0].sons = &TMP2490[0];
NTI179024.node = &TMP2076[0];
}
