	...
	bitsetinit_240021(b, ((NI) (LOC1)));
	{
		...
		res_241329 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4092 = addInt(res_241329, ((NI) 1));
				res_241329 = (NI)(TMP4092);
			} LA5: ;
		}
	}
	popFrame();
		...
		while (1) {
			...
			nimln(102, "nimsets.nim");
			{
				...
				nimln(109, "nimsets.nim");
				{
					...
					LOC21 = 0;
					LOC21 = newinttypenode_192619(((NU8) 6), (NI64)(TMP4097), elemtype);
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = newinttypenode_192619(((NU8) 6), (NI64)(TMP4098), elemtype);
					addson_193819(n, LOC23);
					nimln(115, "nimsets.nim");
					TMP4099 = addInt64(b, first);
					LOC24 = 0;
					LOC24 = newinttypenode_192619(((NU8) 6), (NI64)(TMP4099), elemtype);
	...
	tobitset_241004(a, (&x));
	{
		...
		res_241574 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4101 = addInt(res_241574, ((NI) 1));
				res_241574 = (NI)(TMP4101);
			} LA3: ;
		}
	}
		...
		res_241637 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(155, "nimsets.nim");
				{
					...
					if (((TMP4082[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
					if ((NU)(i_241609) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4082[(*(*s).kindU.S6.sons->data[i_241609]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241609]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4083));
				...
				LA5: ;
				nimln(1614, "system.nim");
				TMP4107 = addInt(res_241637, ((NI) 1));
				res_241637 = (NI)(TMP4107);
			} LA4: ;
		}
	}
	popFrame();
	...
	LA3: ;
	{
		...
		res_241696 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA11: ;
				nimln(1614, "system.nim");
				TMP4110 = addInt(res_241696, ((NI) 1));
				res_241696 = (NI)(TMP4110);
			} LA8: ;
		}
	}
