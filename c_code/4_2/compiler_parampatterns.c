...
static NIM_CONST TY191031 TMP4685 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4686, "strVal", 6);
static NIM_CONST TY191031 TMP4687 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4688, "sons", 4);
...
STRING_LITERAL(TMP4694, "atom", 4);
STRING_LITERAL(TMP4695, "lit", 3);
STRING_LITERAL(TMP4696, "sym", 3);
STRING_LITERAL(TMP4697, "ident", 5);
STRING_LITERAL(TMP4698, "call", 4);
STRING_LITERAL(TMP4699, "alias", 5);
STRING_LITERAL(TMP4700, "noalias", 7);
STRING_LITERAL(TMP4701, "lvalue", 6);
STRING_LITERAL(TMP4702, "local", 5);
STRING_LITERAL(TMP4703, "sideeffect", 10);
STRING_LITERAL(TMP4704, "nosideeffect", 12);
STRING_LITERAL(TMP4706, "compiler/parampatterns.nim", 26);
NIM_CONST TY146211 TMP4705 = {((NimStringDesc*) &TMP4706),
((NI) 100)}
;
NIM_CONST TY146211 TMP4708 = {((NimStringDesc*) &TMP4706),
((NI) 107)}
;
STRING_LITERAL(TMP4710, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP4712, "parameter pattern too complex", 29);
static NIM_CONST TY191031 TMP4713 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4714, "sym", 3);
...
N_NIMCALL(NU8, whichalias_268080)(Tsym190843* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		if (!(((TMP4685[(*(*p).constraint).kind/8] &(1<<((*(*p).constraint).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4686));
...
static N_INLINE(NI, len_191097)(Tnode190813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP4687[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4688));
...
{	nimln(57, "parampatterns.nim");
	...
	case ((NU8) 32):
	{
		...
		if (((TMP4687[(*p).kind/8] &(1<<((*p).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4688));
		if ((NU)(((NI) 0)) >= (NU)((*p).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP4689[(*(*p).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*p).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4690));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).s, ((NimStringDesc*) &TMP4691));
				if (LOC13) goto LA14;
			...
			LA15: ;
			{
				...
				LOC18 = 0;
				LOC18 = eqStrings((*op).s, ((NimStringDesc*) &TMP4692));
				if (LOC18) goto LA19;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).s, ((NimStringDesc*) &TMP4693));
			if (LOC27) goto LA28;
	...
	case ((NU8) 2):
	{
		...
		case 2: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4704))) goto LA50;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4696))) goto LA42;
if (eqStrings(spec, ((NimStringDesc*) &TMP4701))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP4703))) goto LA49;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4697))) goto LA43;
break;
		case 10: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4700))) goto LA46;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4694))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4695))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4698))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4699))) goto LA45;
if (eqStrings(spec, ((NimStringDesc*) &TMP4702))) goto LA48;
break;
		}
		goto LA51;
		LA40: ;
			...
			LA67: ;
			{
				...
				res_268644 = ((NI) 0);
				{
					...
					while (1) {
						...
						TMP4707 = addInt(res_268644, ((NI) 1));
						res_268644 = (NI)(TMP4707);
					} LA72: ;
				}
			}
			nimln(854, "msgs.nim");
			...
			LA81: ;
			{
				...
				res_268652 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA90: ;
						nimln(1619, "system.nim");
						TMP4709 = addInt(res_268652, ((NI) 1));
						res_268652 = (NI)(TMP4709);
					} LA86: ;
				}
			}
...
N_NIMCALL(Tnode190813*, semnodekindconstraints_268679)(Tnode190813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP4710));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_192351(((NU8) 20), (*p).info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP4685[(*result).kind/8] &(1<<((*result).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4686));
	...
	nimln(124, "parampatterns.nim");
	{
		...
		if (!(((NI) 2) <= LOC7)) goto LA8;
		{
			...
			res_268842 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4711 = addInt(res_268842, ((NI) 1));
					res_268842 = (NI)(TMP4711);
				} LA13: ;
			}
		}
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_164199((*p).info, ((NimStringDesc*) &TMP4712));
		}
		LA16: ;
	}
	goto LA5;
...
{	result = 0;
	...
	case ((NU8) 32):
	{
		...
		nimln(142, "parampatterns.nim");
		{
			...
			LOC4 = ((*op).kind == ((NU8) 3));
			if (!(LOC4)) goto LA5;
			if (!(((TMP4713[(*op).kind/8] &(1<<((*op).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4714));
		...
		LA2: ;
		{
			...
			res_269010 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP4715 = addInt(res_269010, ((NI) 1));
					res_269010 = (NI)(TMP4715);
				} LA19: ;
			}
		}
	}
		...
		result = ((NU8) 2);
		{
			...
			res_269018 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA35: ;
					nimln(1619, "system.nim");
					TMP4716 = addInt(res_269018, ((NI) 1));
					res_269018 = (NI)(TMP4716);
				} LA34: ;
			}
		}
	}
...
N_NIMCALL(NU8, isassignable_269056)(Tsym190843* owner, Tnode190813* n) {
	...
	case ((NU8) 3):
	{
		...
		{
			if (!(((TMP4713[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4714));
	...
	case ((NU8) 45):
	{
		...
		nimln(204, "parampatterns.nim");
		{
			...
			if (!(((TMP4713[(*(*n).kindU.S6.sons->data[((NI) 1)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 1)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4714));
...
N_NIMCALL(NIM_BOOL, matchnodekinds_269284)(Tnode190813* p, Tnode190813* n) {
	...
	pc = ((NI) 1);
	{
		...
		while (1) {
			...
			case ((NU8) 4):
			{
				...
				stack[((NI)(TMP4725))- 0] = !(stack[((NI)(TMP4726))- 0]);
			}
			break;
			case ((NU8) 5):
			{
			...
			case ((NU8) 10):
			{
				...
				if ((NU)((NI)(TMP4732)) > (NU)(code->Sup.len)) raiseIndexError();
				kind = ((NU8)chckRange(((NU8)(code->data[(NI)(TMP4732)])), ((NU8) 0), ((NU8) 25)));
				nimln(243, "parampatterns.nim");
				if ((NU)(sp) > (NU)(64)) raiseIndexError();
			...
			case ((NU8) 11):
			{
				...
				kind = ((NU8)chckRange(((NU8)(code->data[(NI)(TMP4735)])), ((NU8) 0), ((NU8) 158)));
				nimln(243, "parampatterns.nim");
				if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	TMP4743 = subInt(sp, ((NI) 1));
	if ((NU)((NI)(TMP4743)) > (NU)(64)) raiseIndexError();
	result = stack[((NI)(TMP4743))- 0];
	popFrame();
	return result;
}
