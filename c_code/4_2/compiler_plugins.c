...
TMP8076[0] = &TMP8074[1];
TMP8074[1].kind = 1;
TMP8074[1].offset = offsetof(PluginHEX3Aobjecttype407019, fn);
TMP8074[1].typ = (&NTI167019);
TMP8074[1].name = "fn";
TMP8076[1] = &TMP8074[2];
TMP8074[2].kind = 1;
TMP8074[2].offset = offsetof(PluginHEX3Aobjecttype407019, module);
TMP8074[2].typ = (&NTI167019);
TMP8074[2].name = "module";
TMP8076[2] = &TMP8074[3];
TMP8074[3].kind = 1;
TMP8074[3].offset = offsetof(PluginHEX3Aobjecttype407019, package);
TMP8074[3].typ = (&NTI167019);
...
NTI407013.flags = 3;
TMP8074[4].kind = 1;
TMP8074[4].offset = offsetof(PluginHEX3Aobjecttype407019, t);
TMP8074[4].typ = (&NTI407013);
TMP8074[4].name = "t";
TMP8076[4] = &TMP8074[5];
TMP8074[5].kind = 1;
TMP8074[5].offset = offsetof(PluginHEX3Aobjecttype407019, next);
TMP8074[5].typ = (&NTI407015);
TMP8074[5].name = "next";
TMP8074[0].len = 5; TMP8074[0].kind = 2; TMP8074[0].sons = &TMP8076[0];
NTI407019.node = &TMP8074[0];
NTI407015.size = sizeof(PluginHEX3Aobjecttype407019*);
NTI407015.kind = 22;
NTI407015.base = (&NTI407019);
NTI407015.marker = TMP8077;
}
