...
STRING_LITERAL(TMP4746, "pretty.strip", 12);
STRING_LITERAL(TMP4747, "on", 2);
STRING_LITERAL(TMP4748, ".pretty.nim", 11);
STRING_LITERAL(TMP4751, "len(a) == L seq modified while iterating over it", 48);
static NIM_CONST TY77659 TMP4754 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x03,
0xFE, 0xFF, 0xFF, 0x87, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4756, "int", 3);
STRING_LITERAL(TMP4757, "uint", 4);
STRING_LITERAL(TMP4758, "cint", 4);
STRING_LITERAL(TMP4759, "cuint", 5);
STRING_LITERAL(TMP4760, "clong", 5);
STRING_LITERAL(TMP4761, "cstring", 7);
STRING_LITERAL(TMP4762, "string", 6);
STRING_LITERAL(TMP4763, "char", 4);
STRING_LITERAL(TMP4764, "byte", 4);
STRING_LITERAL(TMP4765, "bool", 4);
STRING_LITERAL(TMP4766, "openArray", 9);
STRING_LITERAL(TMP4767, "seq", 3);
STRING_LITERAL(TMP4768, "array", 5);
STRING_LITERAL(TMP4769, "void", 4);
STRING_LITERAL(TMP4770, "pointer", 7);
STRING_LITERAL(TMP4771, "float", 5);
STRING_LITERAL(TMP4772, "csize", 5);
STRING_LITERAL(TMP4773, "cdouble", 7);
STRING_LITERAL(TMP4774, "cchar", 5);
STRING_LITERAL(TMP4775, "cschar", 6);
STRING_LITERAL(TMP4776, "cshort", 6);
STRING_LITERAL(TMP4777, "cu", 2);
STRING_LITERAL(TMP4778, "nil", 3);
STRING_LITERAL(TMP4779, "expr", 4);
STRING_LITERAL(TMP4780, "stmt", 4);
STRING_LITERAL(TMP4781, "typedesc", 8);
STRING_LITERAL(TMP4782, "auto", 4);
STRING_LITERAL(TMP4783, "any", 3);
STRING_LITERAL(TMP4784, "range", 5);
STRING_LITERAL(TMP4785, "openarray", 9);
STRING_LITERAL(TMP4786, "varargs", 7);
STRING_LITERAL(TMP4787, "set", 3);
STRING_LITERAL(TMP4788, "cfloat", 6);
NIM_CONST TY270154 TMP4755 = {((NimStringDesc*) &TMP4756),
...
N_NIMCALL(void, overwritefiles_270030)(void) {
	...
	nimln(26, "pretty.nim");
	LOC1 = 0;
	LOC1 = getconfigvar_153334(((NimStringDesc*) &TMP4746));
	LOC2 = 0;
	LOC2 = nsuNormalize(LOC1);
	dostrip = eqStrings(LOC2, ((NimStringDesc*) &TMP4747));
	{
		NI i_270043;
		NI HEX3Atmp_270070;
		NI res_270073;
			...
			while (1) {
				...
				nimln(28, "pretty.nim");
				{
					...
					LA18: ;
					{
						nimln(31, "pretty.nim");
						if ((NU)(i_270043) >= (NU)(gsourcefiles_248036->Sup.len)) raiseIndexError();
						newfile = noschangeFileExt(gsourcefiles_248036->data[i_270043].fullpath, ((NimStringDesc*) &TMP4748));
					}
					LA16: ;
					nimln(32, "pretty.nim");
					pushSafePoint(&TMP4749);
					TMP4749.status = _setjmp(TMP4749.context);
					if (TMP4749.status == 0) {
						FILE* f;
						nimln(33, "pretty.nim");
				...
				TMP4752 = addInt(res_270073, ((NI) 1));
				res_270073 = (NI)(TMP4752);
			} LA5: ;
		}
	}
	popFrame();
...
{	result = 0;
	nimln(52, "pretty.nim");
	allupper = allcharsinset_98459(s, TMP4754);
	nimln(53, "pretty.nim");
	{
		NIM_BOOL LOC3;
		LOC3 = 0;
	...
	case ((NU8) 4):
	{
		nimln(59, "pretty.nim");
		{
			NIM_BOOL LOC10;
			LOC10 = 0;
			LOC10 = HEX3DHEX7E_270101(s, TMP4755, 33);
			if (!LOC10) goto LA11;
			nimln(65, "pretty.nim");
		...
		while (1) {
			...
			nimln(78, "pretty.nim");
			{
				...
				nimln(79, "pretty.nim");
				{
					...
					LOC37 = (((NI) 0) < i);
					if (!(LOC37)) goto LA38;
					TMP4790 = subInt(i, ((NI) 1));
					if ((NU)((NI)(TMP4790)) > (NU)(s->Sup.len)) raiseIndexError();
					LOC37 = (((NU8)(s->data[(NI)(TMP4790)])) >= ((NU8)(65)) && ((NU8)(s->data[(NI)(TMP4790)])) <= ((NU8)(90)));
					LA38: ;
					if (!LOC37) goto LA39;
					nimln(81, "pretty.nim");
...
{	nimln(94, "pretty.nim");
	...
	TMP4794 = subInt(info.line, ((NI16) 1));
	if (TMP4794 < -32768 || TMP4794 > 32767) raiseOverflow();
	if ((NU)((NI16)(TMP4794)) >= (NU)(gsourcefiles_248036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_248036->data[info.fileindex].lines->data[(NI16)(TMP4794)];
	nimln(97, "pretty.nim");
	...
	LA3: ;
	{
		...
		while (1) {
			...
			if ((NU)((NI)(TMP4795)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC7 = (((NU8)(line->data[(NI)(TMP4795)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4795)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4795)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4795)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4795)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4795)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4795)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4795)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4795)])) == ((NU8)(95)));
			LA8: ;
			if (!LOC7) goto LA6;
	...
	TMP4798 = addInt(first, LOC17);
	TMP4799 = subInt((NI)(TMP4798), ((NI) 1));
	last = (NI)(TMP4799);
	nimln(105, "pretty.nim");
	{
		...
		LOC24 = 0;
		LOC24 = copyStrLast(line, ((NI) 0), (NI)(TMP4800));
		TMP4801 = addInt(last, ((NI) 1));
		LOC25 = 0;
		LOC25 = copyStr(line, (NI)(TMP4801));
...
appendString(LOC23, LOC25);
		...
		if ((NU)(info.fileindex) >= (NU)(gsourcefiles_248036->Sup.len)) raiseIndexError();
		TMP4802 = subInt(info.line, ((NI16) 1));
		if (TMP4802 < -32768 || TMP4802 > 32767) raiseOverflow();
		if ((NU)((NI16)(TMP4802)) >= (NU)(gsourcefiles_248036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) (&gsourcefiles_248036->data[info.fileindex].lines->data[(NI16)(TMP4802)]), x);
