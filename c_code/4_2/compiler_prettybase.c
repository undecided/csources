...
N_NIMCALL(void, loadfile_249041)(Tlineinfo163338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		gsourcefiles_249036 = (TY249019*) setLengthSeq(&(gsourcefiles_249036)->Sup, sizeof(Tsourcefile249008), ((NI)chckRange((NI32)(TMP4266), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA3: ;
	nimln(27, "prettybase.nim");
	{
		...
		gsourcefiles_249036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP4267));
		{
		...
		pos = lex.bufpos;
		{
			...
			while (1) {
				...
				case 13:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
					LOC21 = 0;
					LOC21 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4269));
				...
				case 0:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
					LOC23 = 0;
					LOC23 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4270));
...
{	nimln(64, "prettybase.nim");
	...
	if ((NU)((NI16)(TMP4275)) >= (NU)(gsourcefiles_249036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(TMP4275)];
...
N_NIMCALL(void, replacecomment_249286)(Tlineinfo163338 info) {
	...
	line = gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(TMP4284)];
