...
appendString((*result), LOC6);
				...
				TMP2700 = addInt(res_198072, ((NI) 1));
				res_198072 = (NI)(TMP2700);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = copyString(((NimStringDesc*) &TMP2706));
	{
		...
		while (1) {
			...
			case 92:
			{
				...
				hexchar_198091(s[(NI)(TMP2708)], (&xi));
...
N_NIMCALL(void, encodevbiggestintaux_198230)(NI64 x, NimStringDesc** result) {
	...
	TMP2711 = modInt64(v_198238, IL64(190));
	rem_198240 = (NI64)(TMP2711);
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_198242) > (NU)(((NimStringDesc*) &TMP2714)->Sup.len)) raiseIndexError();
		d_198236 = ((NimStringDesc*) &TMP2714)->data[idx_198242];
	}
	goto LA6;
	LA8: ;
	{
		...
		TMP2715 = subInt(idx_198242, ((NI) 62));
		TMP2716 = addInt((NI)(TMP2715), ((NI) 128));
		d_198236 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2716), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_198269)(NI x, NimStringDesc** result) {
	...
	v_198277 = x;
	nimln(70, "rodutils.nim");
	TMP2717 = modInt(v_198277, ((NI) 190));
	rem_198279 = (NI)(TMP2717);
	nimln(71, "rodutils.nim");
	{
		NI TMP2718;
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_198281) > (NU)(((NimStringDesc*) &TMP2714)->Sup.len)) raiseIndexError();
		d_198275 = ((NimStringDesc*) &TMP2714)->data[idx_198281];
	}
	goto LA6;
	LA8: ;
	{
		...
		NI TMP2721;
		nimln(79, "rodutils.nim");
		TMP2720 = subInt(idx_198281, ((NI) 62));
		TMP2721 = addInt((NI)(TMP2720), ((NI) 128));
		d_198275 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2721), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
	...
	result = ((NI) 0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2725 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 48));
			...
			case 97 ... 122:
			{
				...
				TMP2728 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 97));
			...
			case 65 ... 90:
			{
				...
				TMP2732 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 65));
			...
			case 128 ... 255:
			{
				...
				TMP2736 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 128));
			...
			TMP2739 = addInt(i_198358, ((NI) 1));
			i_198358 = (NI)(TMP2739);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2740 = mulInt(result, sign_198360);
	...
	result = IL64(0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2743 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 48));
			...
			case 97 ... 122:
			{
				...
				TMP2746 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 97));
			...
			case 65 ... 90:
			{
				...
				TMP2750 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 65));
			...
			case 128 ... 255:
			{
				...
				TMP2754 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 128));
			...
			nimln(115, "rodutils.nim");
			TMP2757 = addInt(i_198519, ((NI) 1));
			i_198519 = (NI)(TMP2757);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2758 = mulInt64(result, ((NI64) (sign_198521)));
