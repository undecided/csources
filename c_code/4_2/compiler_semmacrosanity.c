...
static NIM_CONST TY191031 TMP7981 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7982, "sons", 4);
STRING_LITERAL(TMP7985, "ithField", 8);
STRING_LITERAL(TMP7989, "ithField(record case branch)", 28);
static NIM_CONST TY191031 TMP7991 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7992, "sym", 3);
STRING_LITERAL(TMP7993, "invalid field at index ", 23);
STRING_LITERAL(TMP7996, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP7998, "[] must have some form of array type", 36);
STRING_LITERAL(TMP8000, "{} must have the set type", 25);
STRING_LITERAL(TMP8001, "float literal must have some float type", 39);
STRING_LITERAL(TMP8002, "integer literal must have some int type", 39);
STRING_LITERAL(TMP8003, "string literal must be of some string type", 42);
STRING_LITERAL(TMP8004, "nil literal must be of some pointer type", 40);
...
{	result = 0;
	...
	{
		{
			...
			TMP7980 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_402095 = (NI)(TMP7980);
			...
			res_402098 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7983 = subInt(field, i_402029);
					result = ithfield_402012((*n).kindU.S6.sons->data[i_402029], (NI)(TMP7983));
					...
					TMP7984 = addInt(res_402098, ((NI) 1));
					res_402098 = (NI)(TMP7984);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_164199((*n).info, ((NimStringDesc*) &TMP7985));
		}
		LA13: ;
		...
		result = ithfield_402012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7986));
		...
		LA17: ;
		{
			...
			TMP7987 = subInt(LOC20, ((NI) 1));
			HEX3Atmp_402103 = (NI)(TMP7987);
			nimln(1598, "system.nim");
			res_402106 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_402012(LOC24, (NI)(TMP7988));
					...
					default:
					{
						...
						internalerror_164199((*n).info, ((NimStringDesc*) &TMP7989));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7990 = addInt(res_402106, ((NI) 1));
					res_402106 = (NI)(TMP7990);
				} LA22: ;
			}
		}
	}
	...
	case ((NU8) 3):
	{
		nimln(33, "semmacrosanity.nim");
		{
			...
			if (!(((TMP7991[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7992));
...
appendString(LOC14, ((NimStringDesc*) &TMP7993));
appendString(LOC14, LOC15);
						...
						TMP7994 = addInt(res_402313, ((NI) 1));
						res_402313 = (NI)(TMP7994);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, ((NimStringDesc*) &TMP7993));
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP7995 = addInt(res_402321, ((NI) 1));
						res_402321 = (NI)(TMP7995);
					} LA23: ;
				}
			}
		}
		...
		LA35: ;
		{
			...
			globalerror_164145((*n).info, ((NimStringDesc*) &TMP7996));
		}
		LA2: ;
	}
	break;
				...
				m_402253 = 0;
				{
					...
					res_402333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP7997 = addInt(res_402333, ((NI) 1));
							res_402333 = (NI)(TMP7997);
						} LA47: ;
					}
				}
			}
				...
				m_402265 = 0;
				{
					...
					res_402344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP7999 = addInt(res_402344, ((NI) 1));
							res_402344 = (NI)(TMP7999);
						} LA59: ;
					}
				}
			}
