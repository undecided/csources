...
STRING_LITERAL(TMP3398, "standard", 8);
STRING_LITERAL(TMP3399, "strongspaces", 12);
STRING_LITERAL(TMP3400, "braces", 6);
STRING_LITERAL(TMP3401, "endx", 4);
NIM_CONST TY218020 parsernames_218019 = {((NimStringDesc*) &TMP3398),
((NimStringDesc*) &TMP3399),
((NimStringDesc*) &TMP3400),
((NimStringDesc*) &TMP3401)}
;
STRING_LITERAL(TMP3402, "none", 4);
STRING_LITERAL(TMP3403, "stdtmpl", 7);
STRING_LITERAL(TMP3404, "replace", 7);
STRING_LITERAL(TMP3405, "strip", 5);
NIM_CONST TY218026 filternames_218025 = {((NimStringDesc*) &TMP3402),
((NimStringDesc*) &TMP3403),
((NimStringDesc*) &TMP3404),
((NimStringDesc*) &TMP3405)}
;
STRING_LITERAL(TMP3410, "parser to implement", 19);
static NIM_CONST TY191031 TMP3419 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3420, "sons", 4);
static NIM_CONST TY191031 TMP3421 = {
...
N_NIMCALL(Tnode190813*, parseall_218063)(Tparsers218035* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_164218(((NimStringDesc*) &TMP3410));
...
N_NIMCALL(NIM_BOOL, containsshebang_218132)(NimStringDesc* s, NI i) {
	...
	nimln(83, "syntaxes.nim");
	{
		...
		if ((NU)((NI)(TMP3411)) > (NU)(s->Sup.len)) raiseIndexError();
		LOC3 = ((NU8)(s->data[(NI)(TMP3411)]) == (NU8)(33));
		LA4: ;
		if (!LOC3) goto LA5;
		nimln(84, "syntaxes.nim");
		TMP3412 = addInt(i, ((NI) 2));
		j = (NI)(TMP3412);
		{
...
N_NIMCALL(Tnode190813*, parsepipe_218170)(NimStringDesc* filename, Tllstream177204* inputstream) {
	...
	nimln(91, "syntaxes.nim");
	{
		...
		nimln(98, "syntaxes.nim");
		{
			...
			if ((NU)((NI)(TMP3414)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC14 = ((NU8)(line->data[(NI)(TMP3414)]) == (NU8)(33));
			LA15: ;
			if (!LOC14) goto LA16;
...
{	result = 0;
	{
		...
		res_218429 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP3417 = addInt(res_218429, ((NI) 1));
				res_218429 = (NI)(TMP3417);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_218629 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP3418 = addInt(res_218629, ((NI) 1));
				res_218629 = (NI)(TMP3418);
			} LA3: ;
		}
	}
...
N_NIMCALL(Tident166021*, getcallee_218647)(Tnode190813* n) {
	...
	nimln(120, "syntaxes.nim");
	{
		...
		if (((TMP3419[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3420));
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3421[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3422));
...
{	result = 0;
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3421[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3422));
		LOC7 = identeq_166484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP3423));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_218772;
			...
			res_218798 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA16: ;
					nimln(1614, "system.nim");
					TMP3424 = addInt(res_218798, ((NI) 1));
					res_218798 = (NI)(TMP3424);
				} LA15: ;
			}
		}
	}
...
static TNimNode* TMP3406[2];
static TNimNode* TMP3407[4];
NI TMP3409;
static char* NIM_CONST TMP3408[4] = {
"skinStandard", 
"skinStrongSpaces", 
"skinBraces", 
"skinEndX"};
...
NTI218007.base = 0;
NTI218007.flags = 3;
for (TMP3409 = 0; TMP3409 < 4; TMP3409++) {
TMP2927[TMP3409+2].kind = 1;
TMP2927[TMP3409+2].offset = TMP3409;
TMP2927[TMP3409+2].name = TMP3408[TMP3409];
TMP3407[TMP3409] = &TMP2927[TMP3409+2];
}
TMP2927[6].len = 4; TMP2927[6].kind = 2; TMP2927[6].sons = &TMP3407[0];
NTI218007.node = &TMP2927[6];
TMP2927[1].kind = 1;
TMP2927[1].offset = offsetof(Tparsers218035, skin);
TMP2927[1].typ = (&NTI218007);
TMP2927[1].name = "skin";
TMP3406[1] = &TMP2927[7];
TMP2927[7].kind = 1;
TMP2927[7].offset = offsetof(Tparsers218035, parser);
TMP2927[7].typ = (&NTI206205);
TMP2927[7].name = "parser";
TMP2927[0].len = 2; TMP2927[0].kind = 2; TMP2927[0].sons = &TMP3406[0];
NTI218035.node = &TMP2927[0];
}
