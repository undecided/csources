	...
	{
		{
			...
			res_242093 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4155 = addInt(res_242093, ((NI) 1));
					res_242093 = (NI)(TMP4155);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_242192 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4157 = addInt(res_242192, ((NI) 1));
							res_242192 = (NI)(TMP4157);
						} LA28: ;
					}
				}
...
N_NIMCALL(void, nodetableput_242415)(Tnodetable190873* t, Tnode190813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			n = (Tnodepairseq190871*) newSeq((&NTI190871), ((NI)chckRange((NI)(TMP4162), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_242639;
				NI HEX3Atmp_242676;
				NI res_242679;
