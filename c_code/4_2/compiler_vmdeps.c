...
STRING_LITERAL(TMP7470, "", 0);
STRING_LITERAL(TMP7471, "\012", 1);
STRING_LITERAL(TMP7475, "void", 4);
STRING_LITERAL(TMP7477, "none", 4);
STRING_LITERAL(TMP7478, "bool", 4);
STRING_LITERAL(TMP7479, "char", 4);
STRING_LITERAL(TMP7480, "nil", 3);
STRING_LITERAL(TMP7481, "expr", 4);
STRING_LITERAL(TMP7482, "stmt", 4);
STRING_LITERAL(TMP7483, "void", 4);
STRING_LITERAL(TMP7484, "array", 5);
STRING_LITERAL(TMP7485, "typeDesc", 8);
STRING_LITERAL(TMP7486, "typeDesc", 8);
STRING_LITERAL(TMP7488, "distinct", 8);
STRING_LITERAL(TMP7489, "tuple", 5);
STRING_LITERAL(TMP7490, "set", 3);
STRING_LITERAL(TMP7491, "ptr", 3);
STRING_LITERAL(TMP7492, "ref", 3);
STRING_LITERAL(TMP7493, "var", 3);
STRING_LITERAL(TMP7494, "seq", 3);
STRING_LITERAL(TMP7495, "proc", 4);
STRING_LITERAL(TMP7496, "openArray", 9);
STRING_LITERAL(TMP7497, "range", 5);
static NIM_CONST TY192031 TMP7498 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7499, "sons", 4);
STRING_LITERAL(TMP7500, "pointer", 7);
STRING_LITERAL(TMP7501, "string", 6);
STRING_LITERAL(TMP7502, "cstring", 7);
STRING_LITERAL(TMP7503, "int", 3);
STRING_LITERAL(TMP7504, "int8", 4);
STRING_LITERAL(TMP7505, "int16", 5);
STRING_LITERAL(TMP7506, "int32", 5);
STRING_LITERAL(TMP7507, "int64", 5);
STRING_LITERAL(TMP7508, "float", 5);
STRING_LITERAL(TMP7509, "float32", 7);
STRING_LITERAL(TMP7510, "float64", 7);
STRING_LITERAL(TMP7511, "float128", 8);
STRING_LITERAL(TMP7512, "uint", 4);
STRING_LITERAL(TMP7513, "uint8", 5);
STRING_LITERAL(TMP7514, "uint16", 6);
STRING_LITERAL(TMP7515, "uint32", 6);
STRING_LITERAL(TMP7516, "uint64", 6);
STRING_LITERAL(TMP7517, "bignum", 6);
STRING_LITERAL(TMP7518, "const", 5);
STRING_LITERAL(TMP7519, "mutable", 7);
STRING_LITERAL(TMP7520, "varargs", 7);
STRING_LITERAL(TMP7521, "iter", 4);
STRING_LITERAL(TMP7522, "error", 5);
STRING_LITERAL(TMP7523, "builtinTypeClass", 16);
STRING_LITERAL(TMP7524, "concept", 7);
STRING_LITERAL(TMP7525, "compositeTypeClass", 18);
STRING_LITERAL(TMP7526, "and", 3);
STRING_LITERAL(TMP7527, "or", 2);
STRING_LITERAL(TMP7528, "not", 3);
STRING_LITERAL(TMP7529, "anything", 8);
STRING_LITERAL(TMP7530, "static", 6);
...
N_NIMCALL(NimStringDesc*, readoutput_381009)(Processobj143402* p) {
	...
	result = 0;
	nimln(13, "vmdeps.nim");
	result = copyString(((NimStringDesc*) &TMP7470));
	nimln(14, "vmdeps.nim");
...
appendString(result, ((NimStringDesc*) &TMP7471));
		} LA2: ;
	}
	nimln(18, "vmdeps.nim");
	TMP7472 = subInt((result ? result->Sup.len : 0), ((NI) 1));
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7472), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
...
N_NIMCALL(NimStringDesc*, opgorge_381027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	TMP7473.status = _setjmp(TMP7473.context);
	if (TMP7473.status == 0) {
		Processobj143402* p;
		TY143637 LOC2;
		nimln(23, "vmdeps.nim");
		memset((void*)LOC2, 0, sizeof(LOC2));
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP7470), LOC2, 0, NIM_NIL, 4);
		nimln(24, "vmdeps.nim");
		{
...
N_NIMCALL(NimStringDesc*, opslurp_381040)(NimStringDesc* file, Tlineinfo163338 info, Tsym191843* module) {
	...
	result = 0;
	nimln(32, "vmdeps.nim");
	pushSafePoint(&TMP7474);
	TMP7474.status = _setjmp(TMP7474.context);
	if (TMP7474.status == 0) {
	...
	if (TMP7474.status != 0) reraiseException();
	popFrame();
	return result;
}
		...
		res_381133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP7475), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7476 = addInt(res_381133, ((NI) 1));
				res_381133 = (NI)(TMP7476);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	{
		nimln(71, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7482), t, info);
	}
	break;
	case ((NU8) 3):
	{
		nimln(72, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7483), t, info);
	}
	break;
	case ((NU8) 4):
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP7484), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP7485), t, info);
		...
		{
			nimln(84, "vmdeps.nim");
			result = atomictypex_381066(((NimStringDesc*) &TMP7486), t, info);
		}
		LA13: ;
	}
	break;
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		{
			...
			res_381246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7487 = addInt(res_381246, ((NI) 1));
					res_381246 = (NI)(TMP7487);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 25):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7495), t, info);
	}
	break;
	case ((NU8) 27):
	{
		nimln(117, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7496), t, info);
	}
	break;
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP7497), t, info);
		add_192164(result, LOC61);
		nimln(121, "vmdeps.nim");
		if (((TMP7498[(*(*t).n).kind/8] &(1<<((*(*t).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7499));
	...
	case ((NU8) 48):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7520), t, info);
	}
	break;
	case ((NU8) 49):
	{
	...
	case ((NU8) 56):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7527), t, info);
	}
	break;
	case ((NU8) 57):
	{
		nimln(153, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7528), t, info);
	}
	break;
	case ((NU8) 58):
	{
	...
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP7530), t, info);
