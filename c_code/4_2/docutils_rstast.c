...
43}
;
STRING_LITERAL(TMP5015, "\012", 1);
STRING_LITERAL(TMP5017, "", 0);
STRING_LITERAL(TMP5019, "\012\012", 2);
STRING_LITERAL(TMP5022, "* ", 2);
STRING_LITERAL(TMP5025, "(#) ", 4);
STRING_LITERAL(TMP5028, "  ", 2);
STRING_LITERAL(TMP5035, "| ", 2);
STRING_LITERAL(TMP5038, "`", 1);
STRING_LITERAL(TMP5039, "`_", 2);
STRING_LITERAL(TMP5040, " <", 2);
STRING_LITERAL(TMP5041, ">`_", 3);
STRING_LITERAL(TMP5042, "`:", 2);
STRING_LITERAL(TMP5043, "`:sub:", 6);
STRING_LITERAL(TMP5044, "`:sup:", 6);
STRING_LITERAL(TMP5045, "`:idx:", 6);
STRING_LITERAL(TMP5046, "*", 1);
STRING_LITERAL(TMP5047, "**", 2);
STRING_LITERAL(TMP5048, "***", 3);
STRING_LITERAL(TMP5050, "``", 2);
STRING_LITERAL(TMP5052, "\\", 1);
STRING_LITERAL(TMP5053, "\\\\", 2);
STRING_LITERAL(TMP5054, ".. index::\012", 11);
STRING_LITERAL(TMP5057, ".. contents::", 13);
STRING_LITERAL(TMP5058, "Error: cannot render: ", 22);
STRING_LITERAL(TMP5061, "kind", 4);
STRING_LITERAL(TMP5062, "level", 5);
STRING_LITERAL(TMP5063, "text", 4);
STRING_LITERAL(TMP5065, "sons", 4);
...
N_NIMCALL(Trstnode296011*, lastson_296147)(Trstnode296011* n) {
	...
	result = 0;
	nimln(87, "rstast.nim");
	TMP5012 = subInt(((*n).sons ? (*n).sons->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP5012)) >= (NU)((*n).sons->Sup.len)) raiseIndexError();
	result = (*n).sons->data[(NI)(TMP5012)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_296224)(Trendercontext296208* d, Trstnode296011* n, NimStringDesc** result) {
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		LOC2 = 0;
		LOC2 = len_296084(n);
		TMP5013 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_296245 = (NI)(TMP5013);
		...
		res_296248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5014 = addInt(res_296248, ((NI) 1));
				res_296248 = (NI)(TMP5014);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		TMP5016 = subInt(((*result) ? (*result)->Sup.len : 0), oldlen);
		headlinelen = (NI)(TMP5016);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP5017));
		nimln(134, "rstast.nim");
		renderrstsons_296224(d, n, (&headline));
		nimln(136, "rstast.nim");
		if ((NU)((*n).level) > (NU)(8)) raiseIndexError();
		TMP5018 = subInt((headline ? headline->Sup.len : 0), (*d).indent);
		lvl = nsuRepeatChar(lvltochar_296274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5018), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
		...
		TMP5020 = subInt(((NI) 78), (*d).indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5020), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP5017));
...
appendString((*result), ((NimStringDesc*) &TMP5028));
	...
	case ((NU8) 14):
	{
		...
		TMP5030 = addInt((tmp ? tmp->Sup.len : 0), ((NI) 3));
		L = (((NI)(TMP5030) >= ((NI) 30)) ? (NI)(TMP5030) : ((NI) 30));
		nimln(193, "rstast.nim");
		TMP5031 = addInt((*d).indent, L);
		(*d).indent = (NI)(TMP5031);
...
appendString((*result), tmp);
		...
		TMP5032 = subInt(L, (tmp ? tmp->Sup.len : 0));
		TMP5033 = subInt((NI)(TMP5032), ((NI) 2));
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5033), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ((NimStringDesc*) &TMP5035));
	...
	case ((NU8) 28):
	{
		...
		TMP5036 = addInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5036);
		nimln(211, "rstast.nim");
		renderrstsons_296224(d, n, result);
		nimln(212, "rstast.nim");
		TMP5037 = subInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5037);
	}
	break;
	case ((NU8) 39):
...
appendString((*result), ((NimStringDesc*) &TMP5048));
	...
	case ((NU8) 61):
	{
		...
		TMP5049 = addInt((*d).verbatim, ((NI) 1));
...
appendString((*result), ((NimStringDesc*) &TMP5050));
		...
		TMP5051 = subInt((*d).verbatim, ((NI) 1));
...
appendString((*result), (*n).text);
	...
	case ((NU8) 64):
	{
		nimln(266, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			LOC48 = eqStrings((*n).text, ((NimStringDesc*) &TMP5052));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP5058));
...
N_NIMCALL(Jsonnodeobj289726*, renderrsttojsonnode_296483)(Trstnode296011* node) {
	...
	LOC1[0].Field0 = copyString(((NimStringDesc*) &TMP5061));
	nimln(293, "rstast.nim");
	LOC1[0].Field1 = HEX25_290130(reprEnum((*node).kind, (&NTI296005)));
	LOC1[1].Field0 = copyString(((NimStringDesc*) &TMP5062));
	...
	nimln(296, "rstast.nim");
	{
		...
		add_292418(result, ((NimStringDesc*) &TMP5063), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_292418(result, ((NimStringDesc*) &TMP5065), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
static TNimNode* TMP5006[4];
static TNimNode* TMP5007[65];
NI TMP5009;
static char* NIM_CONST TMP5008[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI296005.base = 0;
NTI296005.flags = 3;
for (TMP5009 = 0; TMP5009 < 65; TMP5009++) {
TMP4805[TMP5009+2].kind = 1;
TMP4805[TMP5009+2].offset = TMP5009;
TMP4805[TMP5009+2].name = TMP5008[TMP5009];
TMP5007[TMP5009] = &TMP4805[TMP5009+2];
}
TMP4805[67].len = 65; TMP4805[67].kind = 2; TMP4805[67].sons = &TMP5007[0];
NTI296005.node = &TMP4805[67];
TMP4805[1].kind = 1;
TMP4805[1].offset = offsetof(Trstnode296011, kind);
TMP4805[1].typ = (&NTI296005);
TMP4805[1].name = "kind";
TMP5006[1] = &TMP4805[68];
TMP4805[68].kind = 1;
TMP4805[68].offset = offsetof(Trstnode296011, text);
TMP4805[68].typ = (&NTI149);
TMP4805[68].name = "text";
TMP5006[2] = &TMP4805[69];
TMP4805[69].kind = 1;
TMP4805[69].offset = offsetof(Trstnode296011, level);
TMP4805[69].typ = (&NTI108);
TMP4805[69].name = "level";
TMP5006[3] = &TMP4805[70];
NTI296009.size = sizeof(Trstnodeseq296009*);
NTI296009.kind = 24;
NTI296009.base = (&NTI296007);
NTI296009.flags = 2;
NTI296009.marker = TMP5010;
TMP4805[70].kind = 1;
TMP4805[70].offset = offsetof(Trstnode296011, sons);
TMP4805[70].typ = (&NTI296009);
TMP4805[70].name = "sons";
TMP4805[0].len = 4; TMP4805[0].kind = 2; TMP4805[0].sons = &TMP5006[0];
NTI296011.node = &TMP4805[0];
NTI296007.size = sizeof(Trstnode296011*);
NTI296007.kind = 22;
NTI296007.base = (&NTI296011);
NTI296007.flags = 2;
NTI296007.marker = TMP5011;
}
