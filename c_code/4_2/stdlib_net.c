...
N_NIMCALL(NI32, getsocketerror_515001)(Socketimpl514407* socket) {
	...
	nimln(258, "net.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_515008).Sup.Sup.message; (*e_515008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10639));
...
{	nimln(879, "net.nim");
	...
	nimln(885, "net.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_519219).Sup.Sup.message; (*e_519219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10640));
...
appendString(LOC26, ((NimStringDesc*) &TMP10650));
		...
		selret = select_517207(socket, (NI)(TMP10652));
		nimln(700, "net.nim");
		{
			NI32 LOC31;
...
{	nimln(794, "net.nim");
	...
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		...
		while (1) {
			...
			nimln(799, "net.nim");
			LOC3 = 0;
			LOC3 = waitfor_517818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10653));
			nimln(800, "net.nim");
			...
			nimln(803, "net.nim");
			{
				...
				nimln(804, "net.nim");
				LOC20 = 0;
				LOC20 = waitfor_517818(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10653));
				nimln(805, "net.nim");
...
TMP10599[1].kind = 1;
TMP10599[1].offset = offsetof(Socketimpl514407, fd);
TMP10599[1].typ = (&NTI5811);
TMP10599[1].name = "fd";
TMP10627[1] = &TMP10599[2];
TMP10599[2].kind = 3;
TMP10599[2].offset = offsetof(Socketimpl514407, isbuffered);
TMP10599[2].typ = (&NTI138);
TMP10599[2].name = "isBuffered";
TMP10599[2].sons = &NimDT_514407_isbuffered[0];
TMP10599[2].len = 2;
