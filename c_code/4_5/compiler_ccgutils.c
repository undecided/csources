...
static NIM_CONST TY192031 TMP8886 = {
	...
	{
		{
			...
			res_455087 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8888 = addInt(res_455087, ((NI) 1));
					res_455087 = (NI)(TMP8888);
				} LA5: ;
			}
		} LA2: ;
	}
	...
	{
		{
			...
			res_455095 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP8889 = addInt(res_455095, ((NI) 1));
					res_455095 = (NI)(TMP8889);
				} LA15: ;
			}
		}
	}
		...
		b = IL64(0);
		{
			...
			res_455235 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8891 = addInt(res_455235, ((NI) 1));
					res_455235 = (NI)(TMP8891);
				} LA7: ;
			}
		}
		...
		a = ((NI32) 0);
		{
			...
			res_455244 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP8893 = addInt(res_455244, ((NI) 1));
					res_455244 = (NI)(TMP8893);
				} LA11: ;
			}
		}
	...
	nimfr("initTypeTables", "ccgutils.nim")
	{
		...
		res_455430 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP8894 = addInt(res_455430, ((NI) 1));
				res_455430 = (NI)(TMP8894);
			} LA3: ;
		}
	}
	popFrame();
	...
	inittypetables_455285();
	{
		...
		res_455464 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP8895 = addInt(res_455464, ((NI) 1));
				res_455464 = (NI)(TMP8895);
			} LA3: ;
		}
	}
	popFrame();
	...
	LA5: ;
	{
		...
		res_455637 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA14: ;
				nimln(1614, "system.nim");
				TMP8896 = addInt(res_455637, ((NI) 1));
				res_455637 = (NI)(TMP8896);
			} LA9: ;
		}
	}
...
{	result = 0;
	...
	case ((NU8) 58):
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP8897));
	}
	break;
	case ((NU8) 13):
	{
			...
			LA46: ;
			{
				...
				res_455785 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA55: ;
						nimln(1614, "system.nim");
						TMP8898 = addInt(res_455785, ((NI) 1));
						res_455785 = (NI)(TMP8898);
					} LA50: ;
				}
			}
		...
		if (!LOC4) goto LA6;
		{
			...
			res_455851 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA13: ;
					nimln(1614, "system.nim");
					TMP8899 = addInt(res_455851, ((NI) 1));
					res_455851 = (NI)(TMP8899);
				} LA10: ;
			}
		}
	}
...
appendString(result, LOC4);
				...
				TMP8901 = addInt(i_455878, ((NI) 1));
				i_455878 = (NI)(TMP8901);
				nimln(3107, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L_455880))) goto LA7;
					failedassertimpl_87217(((NimStringDesc*) &TMP8902));
				}
				LA7: ;
			} LA3: ;
		}
...
appendString(result, LOC15);
				...
				nimln(1619, "system.nim");
				TMP8906 = addInt(res_455932, ((NI) 1));
				res_455932 = (NI)(TMP8906);
			} LA9: ;
		}
	}
	popFrame();
...
appendString(res, LOC10);
				...
				nimln(1614, "system.nim");
				TMP8911 = addInt(res_455985, ((NI) 1));
				res_455985 = (NI)(TMP8911);
			} LA3: ;
		}
	}
