...
STRING_LITERAL(TMP2549, "nimrod.gid", 10);
STRING_LITERAL(TMP2550, "\012", 1);
...
static N_INLINE(NI, getid_190404)(void) {
	...
	nimln(31, "idgen.nim");
	TMP2542 = addInt(gfrontendid_190012, ((NI) 1));
	gfrontendid_190012 = (NI)(TMP2542);
	popFrame();
	return result;
}
...
static N_INLINE(NI, backendid_190422)(void) {
	...
	nimln(35, "idgen.nim");
	TMP2543 = addInt(gbackendid_190013, ((NI) 1));
	gbackendid_190013 = (NI)(TMP2543);
	popFrame();
	return result;
}
...
static N_INLINE(void, setid_190440)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP2544 = addInt(id, ((NI) 1));
	gfrontendid_190012 = ((gfrontendid_190012 >= (NI)(TMP2544)) ? gfrontendid_190012 : (NI)(TMP2544));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_190453)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	TMP2545 = divInt(gfrontendid_190012, idrange);
	TMP2546 = addInt((NI)(TMP2545), ((NI) 1));
	TMP2547 = mulInt((NI)(TMP2546), idrange);
	TMP2548 = addInt((NI)(TMP2547), ((NI) 1));
...
N_NIMCALL(NimStringDesc*, togid_190462)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_155001(((NimStringDesc*) &TMP2549), NIM_TRUE);
	popFrame();
	return result;
}
...
static N_INLINE(void, writeln_155205)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	nimln(213, "sysio.nim");
	write_13457(f, ((NimStringDesc*) &TMP2550));
	popFrame();
}
