...
STRING_LITERAL(TMP8083, "stdlib", 6);
STRING_LITERAL(TMP8084, "system", 6);
STRING_LITERAL(TMP8085, "locals", 6);
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit)(void) {
	...
	nimln(42, "locals.nim");
	registerplugin_406124(((NimStringDesc*) &TMP8083), ((NimStringDesc*) &TMP8084), ((NimStringDesc*) &TMP8085), semlocals_407020);
	popFrame();
}
