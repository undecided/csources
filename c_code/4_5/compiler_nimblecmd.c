			...
			if (!!((d_173208 == NIM_NIL))) goto LA4;
			{
				...
				while (1) {
					...
					nimln(1299, "os.nim");
					{
						...
						NU8 k_173216;
						LOC14 = 0;
						LOC14 = !(eqStrings(y_173212, ((NimStringDesc*) &TMP1814)));
						if (!(LOC14)) goto LA15;
						LOC14 = !(eqStrings(y_173212, ((NimStringDesc*) &TMP1815)));
						LA15: ;
						if (!LOC14) goto LA16;
						...
						nimln(1313, "os.nim");
						{
							...
							if (!LOC30) goto LA31;
							TMP1816 = addInt(k_173216, ((NI) 1));
							if (TMP1816 < 0 || TMP1816 > 3) raiseOverflow();
							k_173216 = (NU8)(TMP1816);
						}
						LA31: ;
						nimln(1302, "os.nim");
						...
						nimln(69, "nimblecmd.nim");
						{
							...
							if (!(LOC35)) goto LA36;
							LOC35 = nsuEndsWith(path_173195, ((NimStringDesc*) &TMP1821));
							LA36: ;
							if (!LOC35) goto LA37;
				...
				if (!!((d_173222 == NIM_NIL))) goto LA10;
				{
					...
					while (1) {
						...
						nimln(1299, "os.nim");
						{
							...
							NU8 k_173230;
							LOC20 = 0;
							LOC20 = !(eqStrings(y_173226, ((NimStringDesc*) &TMP1814)));
							if (!(LOC20)) goto LA21;
							LOC20 = !(eqStrings(y_173226, ((NimStringDesc*) &TMP1815)));
							LA21: ;
							if (!LOC20) goto LA22;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC36) goto LA37;
								TMP1822 = addInt(k_173230, ((NI) 1));
								if (TMP1822 < 0 || TMP1822 > 3) raiseOverflow();
								k_173230 = (NU8)(TMP1822);
							}
							LA37: ;
							nimln(1302, "os.nim");
			...
			if (!!((d_173299 == NIM_NIL))) goto LA8;
			{
				...
				while (1) {
					...
					nimln(1299, "os.nim");
					{
						...
						NU8 k_173307;
						LOC18 = 0;
						LOC18 = !(eqStrings(y_173303, ((NimStringDesc*) &TMP1814)));
						if (!(LOC18)) goto LA19;
						LOC18 = !(eqStrings(y_173303, ((NimStringDesc*) &TMP1815)));
						LA19: ;
						if (!LOC18) goto LA20;
						...
						nimln(1313, "os.nim");
						{
							...
							if (!LOC34) goto LA35;
							TMP1825 = addInt(k_173307, ((NI) 1));
							if (TMP1825 < 0 || TMP1825 > 3) raiseOverflow();
							k_173307 = (NU8)(TMP1825);
						}
						LA35: ;
						nimln(1302, "os.nim");
						k_173284 = k_173307;
				...
				res_173321 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(44, "strtabs.nim");
						{
							...
							{
								if (!eqStrings(val_173315, ((NimStringDesc*) &TMP1807))) goto LA55;
...
appendString(LOC58, val_173315);
						...
						TMP1826 = addInt(res_173321, ((NI) 1));
						res_173321 = (NI)(TMP1826);
					} LA48: ;
				}
			}
		}
