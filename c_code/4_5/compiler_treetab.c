	...
	{
		{
			...
			res_243092 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4154 = addInt(res_243092, ((NI) 1));
					res_243092 = (NI)(TMP4154);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_243191 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4156 = addInt(res_243191, ((NI) 1));
							res_243191 = (NI)(TMP4156);
						} LA28: ;
					}
				}
...
N_NIMCALL(void, nodetablerawinsert_243258)(Tnodepairseq191871** data, NI k, Tnode191813* key, NI val) {
	...
	nimln(73, "treetab.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4159));
	}
	LA5: ;
...
N_NIMCALL(void, nodetableput_243415)(Tnodetable191873* t, Tnode191813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			n = (Tnodepairseq191871*) newSeq((&NTI191871), ((NI)chckRange((NI)(TMP4161), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_243639;
				NI HEX3Atmp_243676;
				NI res_243679;
				...
				res_243679 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA20: ;
						nimln(1614, "system.nim");
						TMP4162 = addInt(res_243679, ((NI) 1));
						res_243679 = (NI)(TMP4162);
					} LA17: ;
				}
			}
...
N_NIMCALL(NI, nodetabletestorset_243698)(Tnodetable191873* t, Tnode191813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq191871*) newSeq((&NTI191871), ((NI)chckRange((NI)(TMP4164), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_243839;
				NI HEX3Atmp_243876;
				NI res_243879;
				...
				res_243879 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA20: ;
						nimln(1614, "system.nim");
						TMP4165 = addInt(res_243879, ((NI) 1));
						res_243879 = (NI)(TMP4165);
					} LA17: ;
				}
			}
