...
appendString((*result), ind);
		...
		lvl = nsuRepeatChar(lvltochar_297274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5018), ((NI) 0), ((NI) 2147483647))));
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5020), ((NI) 0), ((NI) 2147483647))));
...
appendString((*result), tmp);
		...
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5033), ((NI) 0), ((NI) 2147483647))));
