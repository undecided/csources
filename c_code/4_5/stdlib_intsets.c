...
N_NIMCALL(void, intsetrawinsert_187249)(Intset187056 t, Ttrunkseq187054** data, Ttrunk187052* desc) {
	...
	nimln(67, "intsets.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2522));
	}
	LA9: ;
...
N_NIMCALL(void, intsetenlarge_187614)(Intset187056* t) {
	...
	n = (Ttrunkseq187054*) newSeq((&NTI187054), ((NI)chckRange((NI)(TMP2526), ((NI) 0), ((NI) 2147483647))));
	{
		NI i_187642;
		NI res_187670;
		i_187642 = 0;
...
{	result = 0;
	...
	nimln(89, "intsets.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP2533));
	}
	LA16: ;
	...
	it = src.head;
	{
		...
		while (1) {
			...
			nimln(153, "intsets.nim");
			{
				...
				failedassertimpl_87217(((NimStringDesc*) &TMP2534));
			}
			LA7: ;
			n = 0;
