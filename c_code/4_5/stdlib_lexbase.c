...
N_NIMCALL(void, fillbuffer_246102)(Baselexer246024* L) {
	...
	nimln(79, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4224));
	}
	LA3: ;
	...
	nimln(81, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4227));
	}
	LA7: ;
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4228)]))), ((NI)chckRange((NI)(TMP4229), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
		...
		s = (NI)(TMP4235);
		{
			...
			while (1) {
				nimln(95, "lexbase.nim");
				{
					...
					failedassertimpl_87217(((NimStringDesc*) &TMP4236));
				}
				LA23: ;
				{
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4239), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(NI, handlelf_246079)(Baselexer246024* L, NI pos) {
	...
	nimln(134, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4251));
	}
	LA3: ;
...
N_NIMCALL(void, open_246040)(Baselexer246024* L, Streamobj138027* input, NI buflen) {
	...
	nimln(145, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4256));
	}
	LA7: ;
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4257), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_246064)(Baselexer246024* L, NI pos) {
	...
	if ((NI)(TMP4259) == (-2147483647 -1)) raiseOverflow();
