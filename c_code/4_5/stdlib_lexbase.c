...
N_NIMCALL(void, fillbuffer_246102)(Baselexer246024* L) {
	...
	nimln(79, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4225));
	}
	LA3: ;
	...
	nimln(81, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4228));
	}
	LA7: ;
		...
		s = (NI)(TMP4236);
		{
			...
			while (1) {
				nimln(95, "lexbase.nim");
				{
					...
					failedassertimpl_87217(((NimStringDesc*) &TMP4237));
				}
				LA23: ;
				{
...
N_NIMCALL(NI, handlelf_246079)(Baselexer246024* L, NI pos) {
	...
	nimln(134, "lexbase.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP4252));
	}
	LA3: ;
