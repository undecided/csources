...
TMP4268[0] = &TMP4222[1];
TMP4222[1].kind = 1;
TMP4222[1].offset = offsetof(Baselexer247024, bufpos);
TMP4222[1].typ = (&NTI108);
TMP4222[1].name = "bufpos";
TMP4268[1] = &TMP4222[2];
TMP4222[2].kind = 1;
TMP4222[2].offset = offsetof(Baselexer247024, buf);
TMP4222[2].typ = (&NTI151);
TMP4222[2].name = "buf";
TMP4268[2] = &TMP4222[3];
TMP4222[3].kind = 1;
TMP4222[3].offset = offsetof(Baselexer247024, buflen);
TMP4222[3].typ = (&NTI108);
TMP4222[3].name = "bufLen";
TMP4268[3] = &TMP4222[4];
TMP4222[4].kind = 1;
TMP4222[4].offset = offsetof(Baselexer247024, input);
TMP4222[4].typ = (&NTI138025);
TMP4222[4].name = "input";
TMP4268[4] = &TMP4222[5];
TMP4222[5].kind = 1;
TMP4222[5].offset = offsetof(Baselexer247024, linenumber);
TMP4222[5].typ = (&NTI108);
TMP4222[5].name = "lineNumber";
TMP4268[5] = &TMP4222[6];
TMP4222[6].kind = 1;
TMP4222[6].offset = offsetof(Baselexer247024, sentinel);
TMP4222[6].typ = (&NTI108);
TMP4222[6].name = "sentinel";
TMP4268[6] = &TMP4222[7];
TMP4222[7].kind = 1;
TMP4222[7].offset = offsetof(Baselexer247024, linestart);
TMP4222[7].typ = (&NTI108);
TMP4222[7].name = "lineStart";
TMP4268[7] = &TMP4222[8];
TMP4222[8].kind = 1;
TMP4222[8].offset = offsetof(Baselexer247024, fileopened);
TMP4222[8].typ = (&NTI138);
TMP4222[8].name = "fileOpened";
TMP4222[0].len = 8; TMP4222[0].kind = 2; TMP4222[0].sons = &TMP4268[0];
NTI247024.node = &TMP4222[0];
}
