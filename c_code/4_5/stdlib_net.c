...
N_NIMCALL(Socketimpl514407*, newsocket_514708)(int fd, NIM_BOOL isbuff) {
	...
	nimln(123, "net.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP10635));
	}
	LA3: ;
	nimln(124, "net.nim");
...
{	nimln(879, "net.nim");
	...
	nimln(885, "net.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_519220).Sup.Sup.message; (*e_519220).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10640));
...
N_NIMCALL(void, acceptaddr_515813)(Socketimpl514407* server, Socketimpl514407** client, NimStringDesc** address, NU8 flags) {
	...
	nimln(369, "net.nim");
	{
		...
		failedassertimpl_87217(((NimStringDesc*) &TMP10643));
	}
	LA3: ;
...
{	result = 0;
	...
	nimln(680, "net.nim");
	{
		if (!(size <= ((NI) 0))) goto LA3;
		{
			...
			failedassertimpl_87217(((NimStringDesc*) &TMP10644));
		}
		LA7: ;
	}
	LA3: ;
...
{	nimln(794, "net.nim");
	...
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		...
		while (1) {
			...
			nimln(799, "net.nim");
			LOC3 = 0;
			LOC3 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10653));
			nimln(800, "net.nim");
			...
			nimln(803, "net.nim");
			{
				...
				nimln(804, "net.nim");
				LOC20 = 0;
				LOC20 = waitfor_517819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10653));
				nimln(805, "net.nim");
