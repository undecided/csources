...
static N_INLINE(NI, rightsize_156407)(NI count) {
	...
	result = nextpoweroftwo_149531(((NI)chckRange((NI)(TMP740), ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_163672)(Table163376* t) {
	...
	n = (Keyvaluepairseq163379*) newSeq((&NTI163379), ((NI)chckRange((NI)(TMP1210), ((NI) 0), ((NI) 2147483647))));
	...
	n = LOC1;
	{
		...
		res_163781 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1213 = addInt(res_163781, ((NI) 1));
				res_163781 = (NI)(TMP1213);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_313185)(Table312052* t) {
	...
	n = (Keyvaluepairseq312055*) newSeq((&NTI312055), ((NI)chckRange((NI)(TMP5908), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_313294 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5911 = addInt(res_313294, ((NI) 1));
				res_313294 = (NI)(TMP5911);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_316109)(Table313409* t) {
	...
	n = (Keyvaluepairseq313412*) newSeq((&NTI313412), ((NI)chckRange((NI)(TMP5995), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_316227 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5998 = addInt(res_316227, ((NI) 1));
				res_316227 = (NI)(TMP5998);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, enlarge_383198)(Table382650* t) {
	...
	n = (Keyvaluepairseq382653*) newSeq((&NTI382653), ((NI)chckRange((NI)(TMP7574), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_383307 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7579 = addInt(res_383307, ((NI) 1));
				res_383307 = (NI)(TMP7579);
			} LA4: ;
		}
	}
	popFrame();
...
TMP1192[0] = &TMP732[5];
TMP732[5].kind = 1;
TMP732[5].offset = offsetof(Table163376, data);
TMP732[5].typ = (&NTI163379);
TMP732[5].name = "data";
TMP1192[1] = &TMP732[6];
TMP732[6].kind = 1;
TMP732[6].offset = offsetof(Table163376, counter);
TMP732[6].typ = (&NTI108);
TMP732[6].name = "counter";
TMP732[4].len = 2; TMP732[4].kind = 2; TMP732[4].sons = &TMP1192[0];
NTI163376.node = &TMP732[4];
...
TMP5993[0] = &TMP732[12];
TMP732[12].kind = 1;
TMP732[12].offset = offsetof(Keyvaluepair313415, Field0);
TMP732[12].typ = (&NTI131021);
TMP732[12].name = "Field0";
TMP5993[1] = &TMP732[13];
TMP732[13].kind = 1;
TMP732[13].offset = offsetof(Keyvaluepair313415, Field1);
TMP732[13].typ = (&NTI313396);
TMP732[13].name = "Field1";
TMP5993[2] = &TMP732[14];
TMP732[14].kind = 1;
TMP732[14].offset = offsetof(Keyvaluepair313415, Field2);
TMP732[14].typ = (&NTI313897);
TMP732[14].name = "Field2";
TMP732[11].len = 3; TMP732[11].kind = 2; TMP732[11].sons = &TMP5993[0];
NTI313415.node = &TMP732[11];
NTI313412.size = sizeof(Keyvaluepairseq313412*);
NTI313412.kind = 24;
NTI313412.base = (&NTI313415);
NTI313412.flags = 2;
NTI313412.marker = TMP5994;
...
TMP6250[0] = &TMP732[16];
TMP732[16].kind = 1;
TMP732[16].offset = offsetof(Table312052, data);
TMP732[16].typ = (&NTI312055);
TMP732[16].name = "data";
TMP6250[1] = &TMP732[17];
TMP732[17].kind = 1;
TMP732[17].offset = offsetof(Table312052, counter);
TMP732[17].typ = (&NTI108);
TMP732[17].name = "counter";
TMP732[15].len = 2; TMP732[15].kind = 2; TMP732[15].sons = &TMP6250[0];
NTI312052.node = &TMP732[15];
