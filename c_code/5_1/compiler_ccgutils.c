...
static NIM_CONST TY192031 TMP8897 = {
	...
	{
		{
			...
			res_455087 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8899 = addInt(res_455087, ((NI) 1));
					res_455087 = (NI)(TMP8899);
				} LA5: ;
			}
		} LA2: ;
	}
	...
	{
		{
			...
			res_455095 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP8900 = addInt(res_455095, ((NI) 1));
					res_455095 = (NI)(TMP8900);
				} LA15: ;
			}
		}
	}
		...
		b = IL64(0);
		{
			...
			res_455235 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8902 = addInt(res_455235, ((NI) 1));
					res_455235 = (NI)(TMP8902);
				} LA7: ;
			}
		}
		...
		a = ((NI32) 0);
		{
			...
			res_455244 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP8904 = addInt(res_455244, ((NI) 1));
					res_455244 = (NI)(TMP8904);
				} LA11: ;
			}
		}
	...
	nimfr("initTypeTables", "ccgutils.nim")
	{
		...
		res_455430 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP8905 = addInt(res_455430, ((NI) 1));
				res_455430 = (NI)(TMP8905);
			} LA3: ;
		}
	}
	popFrame();
	...
	inittypetables_455285();
	{
		...
		res_455464 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP8906 = addInt(res_455464, ((NI) 1));
				res_455464 = (NI)(TMP8906);
			} LA3: ;
		}
	}
	popFrame();
	...
	LA5: ;
	{
		...
		res_455637 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA14: ;
				nimln(1614, "system.nim");
				TMP8907 = addInt(res_455637, ((NI) 1));
				res_455637 = (NI)(TMP8907);
			} LA9: ;
		}
	}
...
{	result = 0;
	...
	case ((NU8) 58):
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP8908));
	}
	break;
	case ((NU8) 13):
	{
			...
			LA46: ;
			{
				...
				res_455785 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA55: ;
						nimln(1614, "system.nim");
						TMP8909 = addInt(res_455785, ((NI) 1));
						res_455785 = (NI)(TMP8909);
					} LA50: ;
				}
			}
		...
		if (!LOC4) goto LA6;
		{
			...
			res_455851 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA13: ;
					nimln(1614, "system.nim");
					TMP8910 = addInt(res_455851, ((NI) 1));
					res_455851 = (NI)(TMP8910);
				} LA10: ;
			}
		}
	}
...
appendString(result, LOC15);
				...
				nimln(1619, "system.nim");
				TMP8917 = addInt(res_455932, ((NI) 1));
				res_455932 = (NI)(TMP8917);
			} LA9: ;
		}
	}
	popFrame();
...
appendString(res, LOC10);
				...
				nimln(1614, "system.nim");
				TMP8922 = addInt(res_455985, ((NI) 1));
				res_455985 = (NI)(TMP8922);
			} LA3: ;
		}
	}
