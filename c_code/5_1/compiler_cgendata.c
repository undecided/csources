...
static N_INLINE(Ropeobj160009**, s_456184)(Tcproc456034* p, NU8 s) {
	...
	TMP8935 = subInt(((*p).blocks ? (*p).blocks->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP8935)) >= (NU)((*p).blocks->Sup.len)) raiseIndexError();
	result = &(*p).blocks->data[(NI)(TMP8935)].sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP8927[29];
static TNimNode* TMP8928[17];
static TNimNode* TMP8929[7];
static TNimNode TMP8925[56];
NTI456038.size = sizeof(Tcgen456038);
NTI456038.kind = 17;
NTI456038.base = (&NTI241005);
TMP8927[0] = &TMP8925[1];
TMP8925[1].kind = 1;
TMP8925[1].offset = offsetof(Tcgen456038, module);
TMP8925[1].typ = (&NTI190811);
TMP8925[1].name = "module";
TMP8927[1] = &TMP8925[2];
TMP8925[2].kind = 1;
TMP8925[2].offset = offsetof(Tcgen456038, filename);
TMP8925[2].typ = (&NTI149);
TMP8925[2].name = "filename";
TMP8927[2] = &TMP8925[3];
...
NTI456022.flags = 2;
TMP8925[3].kind = 1;
TMP8925[3].offset = offsetof(Tcgen456038, s);
TMP8925[3].typ = (&NTI456022);
TMP8925[3].name = "s";
TMP8927[3] = &TMP8925[4];
TMP8925[4].kind = 1;
TMP8925[4].offset = offsetof(Tcgen456038, preventstacktrace);
TMP8925[4].typ = (&NTI138);
TMP8925[4].name = "preventStackTrace";
TMP8927[4] = &TMP8925[5];
TMP8925[5].kind = 1;
TMP8925[5].offset = offsetof(Tcgen456038, usesthreadvars);
TMP8925[5].typ = (&NTI138);
TMP8925[5].name = "usesThreadVars";
TMP8927[5] = &TMP8925[6];
TMP8925[6].kind = 1;
TMP8925[6].offset = offsetof(Tcgen456038, framedeclared);
TMP8925[6].typ = (&NTI138);
TMP8925[6].name = "frameDeclared";
TMP8927[6] = &TMP8925[7];
TMP8925[7].kind = 1;
TMP8925[7].offset = offsetof(Tcgen456038, isheaderfile);
TMP8925[7].typ = (&NTI138);
TMP8925[7].name = "isHeaderFile";
TMP8927[7] = &TMP8925[8];
TMP8925[8].kind = 1;
TMP8925[8].offset = offsetof(Tcgen456038, includesstringh);
TMP8925[8].typ = (&NTI138);
TMP8925[8].name = "includesStringh";
TMP8927[8] = &TMP8925[9];
TMP8925[9].kind = 1;
TMP8925[9].offset = offsetof(Tcgen456038, objhaskidsvalid);
TMP8925[9].typ = (&NTI138);
TMP8925[9].name = "objHasKidsValid";
TMP8927[9] = &TMP8925[10];
TMP8925[10].kind = 1;
TMP8925[10].offset = offsetof(Tcgen456038, cfilename);
TMP8925[10].typ = (&NTI149);
TMP8925[10].name = "cfilename";
TMP8927[10] = &TMP8925[11];
TMP8925[11].kind = 1;
TMP8925[11].offset = offsetof(Tcgen456038, typecache);
TMP8925[11].typ = (&NTI190861);
TMP8925[11].name = "typeCache";
TMP8927[11] = &TMP8925[12];
TMP8925[12].kind = 1;
TMP8925[12].offset = offsetof(Tcgen456038, forwtypecache);
TMP8925[12].typ = (&NTI190861);
TMP8925[12].name = "forwTypeCache";
TMP8927[12] = &TMP8925[13];
TMP8925[13].kind = 1;
TMP8925[13].offset = offsetof(Tcgen456038, declaredthings);
TMP8925[13].typ = (&NTI187056);
TMP8925[13].name = "declaredThings";
TMP8927[13] = &TMP8925[14];
TMP8925[14].kind = 1;
TMP8925[14].offset = offsetof(Tcgen456038, declaredprotos);
TMP8925[14].typ = (&NTI187056);
TMP8925[14].name = "declaredProtos";
TMP8927[14] = &TMP8925[15];
TMP8925[15].kind = 1;
TMP8925[15].offset = offsetof(Tcgen456038, headerfiles);
TMP8925[15].typ = (&NTI130028);
TMP8925[15].name = "headerFiles";
TMP8927[15] = &TMP8925[16];
TMP8925[16].kind = 1;
TMP8925[16].offset = offsetof(Tcgen456038, typeinfomarker);
TMP8925[16].typ = (&NTI187056);
TMP8925[16].name = "typeInfoMarker";
TMP8927[16] = &TMP8925[17];
NTI456034.size = sizeof(Tcproc456034);
NTI456034.kind = 18;
NTI456034.base = 0;
TMP8928[0] = &TMP8925[19];
TMP8925[19].kind = 1;
TMP8925[19].offset = offsetof(Tcproc456034, prc);
TMP8925[19].typ = (&NTI190811);
TMP8925[19].name = "prc";
TMP8928[1] = &TMP8925[20];
TMP8925[20].kind = 1;
TMP8925[20].offset = offsetof(Tcproc456034, beforeretneeded);
TMP8925[20].typ = (&NTI138);
TMP8925[20].name = "beforeRetNeeded";
TMP8928[2] = &TMP8925[21];
TMP8925[21].kind = 1;
TMP8925[21].offset = offsetof(Tcproc456034, threadvaraccessed);
TMP8925[21].typ = (&NTI138);
TMP8925[21].name = "threadVarAccessed";
TMP8928[3] = &TMP8925[22];
TMP8925[22].kind = 1;
TMP8925[22].offset = offsetof(Tcproc456034, lastlineinfo);
TMP8925[22].typ = (&NTI162338);
TMP8925[22].name = "lastLineInfo";
TMP8928[4] = &TMP8925[23];
TMP8925[23].kind = 1;
TMP8925[23].offset = offsetof(Tcproc456034, nestedtrystmts);
TMP8925[23].typ = (&NTI190807);
TMP8925[23].name = "nestedTryStmts";
TMP8928[5] = &TMP8925[24];
TMP8925[24].kind = 1;
TMP8925[24].offset = offsetof(Tcproc456034, inexceptblock);
TMP8925[24].typ = (&NTI108);
TMP8925[24].name = "inExceptBlock";
TMP8928[6] = &TMP8925[25];
TMP8925[25].kind = 1;
TMP8925[25].offset = offsetof(Tcproc456034, finallysafepoints);
TMP8925[25].typ = (&NTI160599);
TMP8925[25].name = "finallySafePoints";
TMP8928[7] = &TMP8925[26];
TMP8925[26].kind = 1;
TMP8925[26].offset = offsetof(Tcproc456034, labels);
TMP8925[26].typ = (&NTI3407);
TMP8925[26].name = "labels";
TMP8928[8] = &TMP8925[27];
NTI456032.size = sizeof(Tblock456032);
NTI456032.kind = 18;
NTI456032.base = 0;
NTI456032.flags = 2;
TMP8929[0] = &TMP8925[29];
TMP8925[29].kind = 1;
TMP8925[29].offset = offsetof(Tblock456032, id);
TMP8925[29].typ = (&NTI108);
TMP8925[29].name = "id";
TMP8929[1] = &TMP8925[30];
TMP8925[30].kind = 1;
TMP8925[30].offset = offsetof(Tblock456032, label);
TMP8925[30].typ = (&NTI160007);
TMP8925[30].name = "label";
TMP8929[2] = &TMP8925[31];
NTI456026.size = sizeof(Tcprocsections456026);
NTI456026.kind = 16;
NTI456026.base = (&NTI160007);
NTI456026.flags = 2;
TMP8925[31].kind = 1;
TMP8925[31].offset = offsetof(Tblock456032, sections);
TMP8925[31].typ = (&NTI456026);
TMP8925[31].name = "sections";
TMP8929[3] = &TMP8925[32];
TMP8925[32].kind = 1;
TMP8925[32].offset = offsetof(Tblock456032, isloop);
TMP8925[32].typ = (&NTI138);
TMP8925[32].name = "isLoop";
TMP8929[4] = &TMP8925[33];
TMP8925[33].kind = 1;
TMP8925[33].offset = offsetof(Tblock456032, nestedtrystmts);
TMP8925[33].typ = (&NTI112);
TMP8925[33].name = "nestedTryStmts";
TMP8929[5] = &TMP8925[34];
TMP8925[34].kind = 1;
TMP8925[34].offset = offsetof(Tblock456032, nestedexceptstmts);
TMP8925[34].typ = (&NTI112);
TMP8925[34].name = "nestedExceptStmts";
TMP8929[6] = &TMP8925[35];
TMP8925[35].kind = 1;
TMP8925[35].offset = offsetof(Tblock456032, framelen);
TMP8925[35].typ = (&NTI112);
TMP8925[35].name = "frameLen";
TMP8925[28].len = 7; TMP8925[28].kind = 2; TMP8925[28].sons = &TMP8929[0];
NTI456032.node = &TMP8925[28];
NTI456106.size = sizeof(TY456106*);
NTI456106.kind = 24;
NTI456106.base = (&NTI456032);
NTI456106.flags = 2;
NTI456106.marker = TMP8930;
TMP8925[27].kind = 1;
TMP8925[27].offset = offsetof(Tcproc456034, blocks);
TMP8925[27].typ = (&NTI456106);
TMP8925[27].name = "blocks";
TMP8928[9] = &TMP8925[36];
TMP8925[36].kind = 1;
TMP8925[36].offset = offsetof(Tcproc456034, breakidx);
TMP8925[36].typ = (&NTI108);
TMP8925[36].name = "breakIdx";
TMP8928[10] = &TMP8925[37];
TMP8925[37].kind = 1;
TMP8925[37].offset = offsetof(Tcproc456034, options);
TMP8925[37].typ = (&NTI153121);
TMP8925[37].name = "options";
TMP8928[11] = &TMP8925[38];
TMP8925[38].kind = 1;
TMP8925[38].offset = offsetof(Tcproc456034, maxframelen);
TMP8925[38].typ = (&NTI108);
TMP8925[38].name = "maxFrameLen";
TMP8928[12] = &TMP8925[39];
TMP8925[39].kind = 1;
TMP8925[39].offset = offsetof(Tcproc456034, module);
TMP8925[39].typ = (&NTI456028);
TMP8925[39].name = "module";
TMP8928[13] = &TMP8925[40];
TMP8925[40].kind = 1;
TMP8925[40].offset = offsetof(Tcproc456034, withinloop);
TMP8925[40].typ = (&NTI108);
TMP8925[40].name = "withinLoop";
TMP8928[14] = &TMP8925[41];
TMP8925[41].kind = 1;
TMP8925[41].offset = offsetof(Tcproc456034, splitdecls);
TMP8925[41].typ = (&NTI108);
TMP8925[41].name = "splitDecls";
TMP8928[15] = &TMP8925[42];
TMP8925[42].kind = 1;
TMP8925[42].offset = offsetof(Tcproc456034, gcframeid);
TMP8925[42].typ = (&NTI3407);
TMP8925[42].name = "gcFrameId";
TMP8928[16] = &TMP8925[43];
TMP8925[43].kind = 1;
TMP8925[43].offset = offsetof(Tcproc456034, gcframetype);
TMP8925[43].typ = (&NTI160007);
TMP8925[43].name = "gcFrameType";
TMP8925[18].len = 17; TMP8925[18].kind = 2; TMP8925[18].sons = &TMP8928[0];
NTI456034.node = &TMP8925[18];
NTI456030.size = sizeof(Tcproc456034*);
NTI456030.kind = 22;
NTI456030.base = (&NTI456034);
NTI456030.marker = TMP8931;
TMP8925[17].kind = 1;
TMP8925[17].offset = offsetof(Tcgen456038, initproc);
TMP8925[17].typ = (&NTI456030);
TMP8925[17].name = "initProc";
TMP8927[17] = &TMP8925[44];
TMP8925[44].kind = 1;
TMP8925[44].offset = offsetof(Tcgen456038, postinitproc);
TMP8925[44].typ = (&NTI456030);
TMP8925[44].name = "postInitProc";
TMP8927[18] = &TMP8925[45];
TMP8925[45].kind = 1;
TMP8925[45].offset = offsetof(Tcgen456038, preinitproc);
TMP8925[45].typ = (&NTI456030);
TMP8925[45].name = "preInitProc";
TMP8927[19] = &TMP8925[46];
TMP8925[46].kind = 1;
TMP8925[46].offset = offsetof(Tcgen456038, typestack);
TMP8925[46].typ = (&NTI190845);
TMP8925[46].name = "typeStack";
TMP8927[20] = &TMP8925[47];
TMP8925[47].kind = 1;
TMP8925[47].offset = offsetof(Tcgen456038, datacache);
TMP8925[47].typ = (&NTI190873);
TMP8925[47].name = "dataCache";
TMP8927[21] = &TMP8925[48];
TMP8925[48].kind = 1;
TMP8925[48].offset = offsetof(Tcgen456038, forwardedprocs);
TMP8925[48].typ = (&NTI190815);
TMP8925[48].name = "forwardedProcs";
TMP8927[22] = &TMP8925[49];
TMP8925[49].kind = 1;
TMP8925[49].offset = offsetof(Tcgen456038, typenodes);
TMP8925[49].typ = (&NTI108);
TMP8925[49].name = "typeNodes";
TMP8927[23] = &TMP8925[50];
TMP8925[50].kind = 1;
TMP8925[50].offset = offsetof(Tcgen456038, nimtypes);
TMP8925[50].typ = (&NTI108);
TMP8925[50].name = "nimTypes";
TMP8927[24] = &TMP8925[51];
TMP8925[51].kind = 1;
TMP8925[51].offset = offsetof(Tcgen456038, typenodesname);
TMP8925[51].typ = (&NTI160007);
TMP8925[51].name = "typeNodesName";
TMP8927[25] = &TMP8925[52];
TMP8925[52].kind = 1;
TMP8925[52].offset = offsetof(Tcgen456038, nimtypesname);
TMP8925[52].typ = (&NTI160007);
TMP8925[52].name = "nimTypesName";
TMP8927[26] = &TMP8925[53];
TMP8925[53].kind = 1;
TMP8925[53].offset = offsetof(Tcgen456038, labels);
TMP8925[53].typ = (&NTI3407);
TMP8925[53].name = "labels";
TMP8927[27] = &TMP8925[54];
NTI456143.size = sizeof(TY456143);
NTI456143.kind = 16;
NTI456143.base = (&NTI160007);
NTI456143.flags = 2;
TMP8925[54].kind = 1;
TMP8925[54].offset = offsetof(Tcgen456038, extensionloaders);
TMP8925[54].typ = (&NTI456143);
TMP8925[54].name = "extensionLoaders";
TMP8927[28] = &TMP8925[55];
TMP8925[55].kind = 1;
TMP8925[55].offset = offsetof(Tcgen456038, injectstmt);
TMP8925[55].typ = (&NTI160007);
TMP8925[55].name = "injectStmt";
TMP8925[0].len = 29; TMP8925[0].kind = 2; TMP8925[0].sons = &TMP8927[0];
NTI456038.node = &TMP8925[0];
NTI456028.size = sizeof(Tcgen456038*);
NTI456028.kind = 22;
NTI456028.base = (&NTI456038);
NTI456028.marker = TMP8933;
NTI456155.size = sizeof(TY456155*);
NTI456155.kind = 24;
NTI456155.base = (&NTI456028);
NTI456155.marker = TMP8934;
}
