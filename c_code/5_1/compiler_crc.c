	...
	result = ((NI32) -1);
	{
		...
		res_169521 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1366 = addInt(res_169521, ((NI) 1));
				res_169521 = (NI)(TMP1366);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = c;
	{
		...
		res_169560 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1368 = addInt(res_169560, ((NI) 1));
				res_169560 = (NI)(TMP1368);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = ((NI32) -1);
	{
		...
		res_169612 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP1370 = addInt(res_169612, ((NI) 1));
				res_169612 = (NI)(TMP1370);
			} LA3: ;
		}
	}
	popFrame();
			...
			readbytes = readbuffer_13515(bin, buf, ((NI) 8000));
			{
				...
				res_169662 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1614, "system.nim");
						TMP1372 = addInt(res_169662, ((NI) 1));
						res_169662 = (NI)(TMP1372);
					} LA10: ;
				}
			}
			nimln(114, "crc.nim");
