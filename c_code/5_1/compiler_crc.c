	...
	result = ((NI32) -1);
	{
		...
		res_168521 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1367 = addInt(res_168521, ((NI) 1));
				res_168521 = (NI)(TMP1367);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = c;
	{
		...
		res_168560 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1369 = addInt(res_168560, ((NI) 1));
				res_168560 = (NI)(TMP1369);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = ((NI32) -1);
	{
		...
		res_168612 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP1371 = addInt(res_168612, ((NI) 1));
				res_168612 = (NI)(TMP1371);
			} LA3: ;
		}
	}
	popFrame();
			...
			readbytes = readbuffer_13515(bin, buf, ((NI) 8000));
			{
				...
				res_168662 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(1614, "system.nim");
						TMP1373 = addInt(res_168662, ((NI) 1));
						res_168662 = (NI)(TMP1373);
					} LA10: ;
				}
			}
			nimln(114, "crc.nim");
