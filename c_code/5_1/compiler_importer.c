...
static NIM_CONST TY191031 TMP4317 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4318, "strVal", 6);
STRING_LITERAL(TMP4319, "", 0);
static NIM_CONST TY191031 TMP4320 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4321, "ident", 5);
static NIM_CONST TY191031 TMP4322 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4323, "sym", 3);
static NIM_CONST TY191031 TMP4324 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4325, "sons", 4);
STRING_LITERAL(TMP4326, "as", 2);
STRING_LITERAL(TMP4327, " ", 1);
STRING_LITERAL(TMP4328, ".", 1);
STRING_LITERAL(TMP4329, "/", 1);
STRING_LITERAL(TMP4330, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP4332, "rawImportSymbol", 15);
STRING_LITERAL(TMP4334, "tab", 3);
STRING_LITERAL(TMP4335, "importSymbol: 2", 15);
STRING_LITERAL(TMP4336, "importSymbol: 3", 15);
STRING_LITERAL(TMP4337, "importAllSymbols: ", 18);
STRING_LITERAL(TMP4338, "a.kind == nkSym ", 16);
STRING_LITERAL(TMP4340, "\'export except\' not implemented", 31);
STRING_LITERAL(TMP4343, "module alias must be an identifier", 34);
STRING_LITERAL(TMP4344, "A module cannot import itself", 29);
...
{	result = 0;
	...
	case ((NU8) 22):
	{
		...
		result = nosunixToNativePath((*n).kindU.S3.strval, ((NimStringDesc*) &TMP4319));
	}
	break;
	case ((NU8) 2):
	{
	...
	case ((NU8) 30):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			if (((TMP4324[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4325));
			if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP4320[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4321));
			LOC9 = 0;
			LOC9 = getident_166463(((NimStringDesc*) &TMP4326));
		...
		result = nsuReplaceStr(LOC13, ((NimStringDesc*) &TMP4327), ((NimStringDesc*) &TMP4319));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC15, ((NimStringDesc*) &TMP4328), ((NimStringDesc*) &TMP4329));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC19 = 0;
		LOC19 = nsuFormatSingleElem(((NimStringDesc*) &TMP4330), LOC18);
		localerror_164155((*n).info, ((NU16) 4), LOC19);
		nimln(46, "importer.nim");
		result = copyString(((NimStringDesc*) &TMP4319));
	}
	break;
	}
	}BeforeRet: ;
...
static N_INLINE(NIM_BOOL, haspattern_195784)(Tsym190843* s) {
	...
	if (!(LOC1)) goto LA2;
	if (((TMP4324[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4325));
	...
	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			if (!LOC17) goto LA19;
			{
				...
				TMP4331 = subInt(LOC22, ((NI) 1));
				HEX3Atmp_251213 = (NI)(TMP4331);
				...
				res_251216 = ((NI) 0);
				{
					...
					while (1) {
						...
						if (((TMP4324[(*(*etyp).n).kind/8] &(1<<((*(*etyp).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4325));
						if ((NU)(j_251157) >= (NU)((*(*etyp).n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP4322[(*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kind/8] &(1<<((*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4323));
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kindU.S4.sym;
						nimln(76, "importer.nim");
						{
							if (!!(((*e).kind == ((NU8) 20)))) goto LA27;
							nimln(77, "importer.nim");
							internalerror_164199((*s).info, ((NimStringDesc*) &TMP4332));
						}
						LA27: ;
						...
						TMP4333 = addInt(res_251216, ((NI) 1));
						res_251216 = (NI)(TMP4333);
					} LA24: ;
				}
			}
		}
...
N_NIMCALL(void, importsymbol_251241)(Tcontext244023* c, Tnode190813* n, Tsym190843* frommod) {
	...
	if (!(((64 &(1<<(((*frommod).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4334));
			...
			e = initidentiter_198147((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				...
				while (1) {
					...
					nimln(111, "importer.nim");
					{
						...
						internalerror_164199((*n).info, ((NimStringDesc*) &TMP4336));
					}
					LA19: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP4337));
...
{	nimln(133, "importer.nim");
				...
				res_251633 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(137, "importer.nim");
						{
							...
							failedassertimpl_87017(((NimStringDesc*) &TMP4338));
						}
						LA13: ;
						nimln(138, "importer.nim");
						if (!(((TMP4322[(*a_251415).kind/8] &(1<<((*a_251415).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4323));
						...
						TMP4339 = addInt(res_251633, ((NI) 1));
						res_251633 = (NI)(TMP4339);
					} LA10: ;
				}
			}
		}
	...
	case ((NU8) 119):
	{
		...
		localerror_164155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4340));
	}
	break;
	default:
	{
		{
			...
			TMP4341 = subInt(LOC28, ((NI) 1));
			HEX3Atmp_251637 = (NI)(TMP4341);
			nimln(1598, "system.nim");
			res_251640 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4342 = addInt(res_251640, ((NI) 1));
					res_251640 = (NI)(TMP4342);
				} LA30: ;
			}
		}
	}
...
N_NIMCALL(Tsym190843*, importmoduleas_251671)(Tnode190813* n, Tsym190843* realmodule) {
	...
	LA9: ;
	{
		...
		if (((TMP4324[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4325));
		if ((NU)(((NI) 1)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP4320[(*(*n).kindU.S6.sons->data[((NI) 1)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 1)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4321));
...
N_NIMCALL(Tsym190843*, myimportmodule_251708)(Tcontext244023* c, Tnode190813* n) {
	...
	nimln(160, "importer.nim");
	{
		...
		nimln(162, "importer.nim");
		{
			...
			localerror_164155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4344));
		}
		LA8: ;
...
N_NIMCALL(Tnode190813*, evalimport_251004)(Tcontext244023* c, Tnode190813* n) {
	...
	memset((void*)(&emptyset), 0, sizeof(emptyset));
	{
		...
		TMP4345 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_251768 = (NI)(TMP4345);
		nimln(1598, "system.nim");
		res_251771 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP4346 = addInt(res_251771, ((NI) 1));
				res_251771 = (NI)(TMP4346);
			} LA4: ;
		}
	}
	popFrame();
		...
		adddecl_249607(c, m);
		{
			...
			res_251838 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP4348 = addInt(res_251838, ((NI) 1));
					res_251838 = (NI)(TMP4348);
				} LA8: ;
			}
		}
	}
		...
		initintset_187927((&exceptset));
		{
			...
			res_251898 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4350 = addInt(res_251898, ((NI) 1));
					res_251898 = (NI)(TMP4350);
				} LA8: ;
			}
		}
