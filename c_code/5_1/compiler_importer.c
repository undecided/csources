...
static NIM_CONST TY191031 TMP4316 = {
...
static NIM_CONST TY191031 TMP4319 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4320, "ident", 5);
static NIM_CONST TY191031 TMP4321 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4322, "sym", 3);
static NIM_CONST TY191031 TMP4323 = {
...
{	result = 0;
	...
	case ((NU8) 30):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			LOC9 = 0;
			LOC9 = getident_166463(((NimStringDesc*) &TMP4325));
			...
			if (!LOC17) goto LA19;
			{
				...
				res_251216 = ((NI) 0);
				{
					...
					while (1) {
						...
						if (!(((TMP4321[(*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kind/8] &(1<<((*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4322));
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_251157]).kindU.S4.sym;
						nimln(76, "importer.nim");
						{
							if (!!(((*e).kind == ((NU8) 20)))) goto LA27;
							nimln(77, "importer.nim");
							internalerror_164199((*s).info, ((NimStringDesc*) &TMP4331));
						}
						LA27: ;
						...
						TMP4332 = addInt(res_251216, ((NI) 1));
						res_251216 = (NI)(TMP4332);
					} LA24: ;
				}
			}
		}
...
N_NIMCALL(void, importsymbol_251241)(Tcontext244023* c, Tnode190813* n, Tsym190843* frommod) {
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_164199((*n).info, ((NimStringDesc*) &TMP4334));
		}
		LA12: ;
			...
			e = initidentiter_198147((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				...
				while (1) {
					...
					nimln(111, "importer.nim");
					{
						...
						internalerror_164199((*n).info, ((NimStringDesc*) &TMP4335));
					}
					LA19: ;
...
{	nimln(133, "importer.nim");
			...
			a_251415 = 0;
			{
				...
				res_251633 = ((NI) 0);
				{
					...
					while (1) {
						...
						if (!(((TMP4321[(*a_251415).kind/8] &(1<<((*a_251415).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4322));
						...
						TMP4338 = addInt(res_251633, ((NI) 1));
						res_251633 = (NI)(TMP4338);
					} LA10: ;
				}
			}
		}
	...
	case ((NU8) 119):
	{
		...
		localerror_164155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4339));
	}
	break;
	default:
	{
		{
			...
			res_251640 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4341 = addInt(res_251640, ((NI) 1));
					res_251640 = (NI)(TMP4341);
				} LA30: ;
			}
		}
	}
...
N_NIMCALL(Tsym190843*, importmoduleas_251671)(Tnode190813* n, Tsym190843* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_164155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4342));
	}
	goto LA1;
	LA9: ;
	{
...
N_NIMCALL(Tsym190843*, myimportmodule_251708)(Tcontext244023* c, Tnode190813* n) {
	...
	nimln(160, "importer.nim");
	{
		...
		nimln(162, "importer.nim");
		{
			...
			localerror_164155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4343));
		}
		LA8: ;
	...
	memset((void*)(&emptyset), 0, sizeof(emptyset));
	{
		...
		res_251771 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP4345 = addInt(res_251771, ((NI) 1));
				res_251771 = (NI)(TMP4345);
			} LA4: ;
		}
	}
	popFrame();
		...
		adddecl_249607(c, m);
		{
			...
			res_251838 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP4347 = addInt(res_251838, ((NI) 1));
					res_251838 = (NI)(TMP4347);
				} LA8: ;
			}
		}
	}
		...
		initintset_187927((&exceptset));
		{
			...
			res_251898 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4349 = addInt(res_251898, ((NI) 1));
					res_251898 = (NI)(TMP4349);
				} LA8: ;
			}
		}
