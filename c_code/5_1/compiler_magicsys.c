...
STRING_LITERAL(TMP4035, "tab", 3);
STRING_LITERAL(TMP4036, "int", 3);
STRING_LITERAL(TMP4037, "int8", 4);
STRING_LITERAL(TMP4038, "int16", 5);
STRING_LITERAL(TMP4039, "int32", 5);
STRING_LITERAL(TMP4040, "int64", 5);
STRING_LITERAL(TMP4041, "uint", 4);
STRING_LITERAL(TMP4042, "uint8", 5);
STRING_LITERAL(TMP4043, "uint16", 6);
STRING_LITERAL(TMP4044, "uint32", 6);
STRING_LITERAL(TMP4045, "uint64", 6);
STRING_LITERAL(TMP4046, "float", 5);
STRING_LITERAL(TMP4047, "float32", 7);
STRING_LITERAL(TMP4048, "float64", 7);
STRING_LITERAL(TMP4049, "float128", 8);
STRING_LITERAL(TMP4050, "bool", 4);
STRING_LITERAL(TMP4051, "char", 4);
STRING_LITERAL(TMP4052, "string", 6);
STRING_LITERAL(TMP4053, "cstring", 7);
STRING_LITERAL(TMP4054, "pointer", 7);
STRING_LITERAL(TMP4055, "request for typekind: ", 22);
STRING_LITERAL(TMP4056, "wanted: ", 8);
STRING_LITERAL(TMP4057, " got: ", 6);
STRING_LITERAL(TMP4058, "type not found: ", 16);
static NIM_CONST TY191031 TMP4061 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4062, "intVal", 6);
STRING_LITERAL(TMP4063, "invalid int size", 16);
...
N_NIMCALL(Tsym190843*, getsyssym_238054)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_238019).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4035));
	LOC1 = 0;
...
{	result = 0;
	...
	nimln(66, "magicsys.nim");
	{
		...
		case ((NU8) 28):
		{
			...
			result = systypefromname_238213(((NimStringDesc*) &TMP4052));
		}
		break;
		case ((NU8) 29):
		{
			nimln(85, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4053));
		}
		break;
		case ((NU8) 26):
		{
			nimln(86, "magicsys.nim");
			result = systypefromname_238213(((NimStringDesc*) &TMP4054));
		}
		break;
		case ((NU8) 5):
		{
...
appendString(LOC26, ((NimStringDesc*) &TMP4055));
...
appendString(LOC36, ((NimStringDesc*) &TMP4058));
	...
	initstrtable_194007((&compilerprocs_238064));
	{
		...
		res_238627 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4059 = addInt(res_238627, ((NI) 1));
				res_238627 = (NI)(TMP4059);
			} LA3: ;
		}
	}
	{
		...
		res_238633 = ((NI) -5);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP4060 = addInt(res_238633, ((NI) 1));
				res_238633 = (NI)(TMP4060);
			} LA6: ;
		}
	}
	popFrame();
...
N_NIMCALL(Ttype190849*, getintlittype_238660)(Tnode190813* literal) {
	...
	if (!(((TMP4061[(*literal).kind/8] &(1<<((*literal).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4062));
...
N_NIMCALL(void, setintlittype_238774)(Tnode190813* result) {
	...
	if (!(((TMP4061[(*result).kind/8] &(1<<((*result).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4062));
	...
	default:
	{
		...
		internalerror_164199((*result).info, ((NimStringDesc*) &TMP4063));
	}
	break;
	}
	popFrame();
