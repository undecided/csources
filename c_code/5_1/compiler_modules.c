	...
	nimfr("resetAllModules", "modules.nim")
	{
		...
		res_522380 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP10691 = addInt(res_522380, ((NI) 1));
				res_522380 = (NI)(TMP10691);
			} LA3: ;
		}
	}
...
N_NIMCALL(Tsym190843*, newmodule_522646)(NI32 fileidx) {
	...
	nimln(807, "rodread.nim");
	{
		...
		gmemcachedata_522071 = (TY522054*) setLengthSeq(&(gmemcachedata_522071)->Sup, sizeof(Tmoduleinmemory522017), ((NI)chckRange((NI32)(TMP10695), ((NI) 0), ((NI) 2147483647))));
	}
	LA14: ;
	{
		NI32 TMP10696;
		...
		gcompiledmodules_522053 = (Tsymseq190815*) setLengthSeq(&(gcompiledmodules_522053)->Sup, sizeof(Tsym190843*), ((NI)chckRange((NI32)(TMP10696), ((NI) 0), ((NI) 2147483647))));
	}
	LA18: ;
...
{	result = 0;
	...
	nimln(137, "modules.nim");
	{
		...
		nimln(807, "rodread.nim");
		{
			...
			gmemcachedata_522071 = (TY522054*) setLengthSeq(&(gmemcachedata_522071)->Sup, sizeof(Tmoduleinmemory522017), ((NI)chckRange((NI32)(TMP10698), ((NI) 0), ((NI) 2147483647))));
		}
		LA7: ;
...
N_NIMCALL(Tnode190813*, includemodule_522851)(Tsym190843* s, NI32 fileidx) {
	...
	nimln(171, "modules.nim");
	{
		...
		nimln(807, "rodread.nim");
		{
			...
			gmemcachedata_522071 = (TY522054*) setLengthSeq(&(gmemcachedata_522071)->Sup, sizeof(Tmoduleinmemory522017), ((NI)chckRange((NI32)(TMP10701), ((NI) 0), ((NI) 2147483647))));
		}
		LA7: ;
...
N_NIMCALL(void, wantmainmodule_522922)(void) {
	...
	nimln(188, "modules.nim");
	{
		...
		fatal_164123(gcmdlineinfo_162922, ((NU16) 186), ((NimStringDesc*) &TMP10704));
	}
	LA3: ;
...
N_NIMCALL(Tsym190843*, makestdinmodule_522999)(void) {
	...
	nimln(207, "modules.nim");
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_162854(((NimStringDesc*) &TMP10706));
