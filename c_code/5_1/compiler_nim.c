...
STRING_LITERAL(TMP10792, "./", 2);
STRING_LITERAL(TMP10793, "", 0);
STRING_LITERAL(TMP10795, "nim.cfg", 7);
STRING_LITERAL(TMP10796, "-", 1);
STRING_LITERAL(TMP10797, "stdinfile", 9);
STRING_LITERAL(TMP10798, "js", 2);
STRING_LITERAL(TMP10799, " ", 1);
...
appendString(LOC7, ((NimStringDesc*) &TMP10792));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_527607)(void) {
	...
	{
		nimln(40, "nim.nim");
		processcmdline_521209(((NU8) 0), ((NimStringDesc*) &TMP10793));
		nimln(41, "nim.nim");
		{
			TSafePoint TMP10794;
			TY119589 p;
			...
			nimln(42, "nim.nim");
			pushSafePoint(&TMP10794);
			TMP10794.status = _setjmp(TMP10794.context);
			if (TMP10794.status == 0) {
				nimln(43, "nim.nim");
			...
			if (TMP10794.status != 0) reraiseException();
		...
		LA7: ;
		nimln(51, "nim.nim");
		loadconfigs_185809(((NimStringDesc*) &TMP10795));
		nimln(54, "nim.nim");
		initvars_169876();
		nimln(55, "nim.nim");
		processcmdline_521209(((NU8) 1), ((NimStringDesc*) &TMP10793));
		nimln(56, "nim.nim");
		maincommand_524628();
		nimln(57, "nim.nim");
		{
		...
		nimln(59, "nim.nim");
		{
			if (!(gerrorcounter_163015 == ((NI) 0))) goto LA25;
			nimln(63, "nim.nim");
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_153234, ((NimStringDesc*) &TMP10796))) goto LA33;
					nimln(65, "nim.nim");
					LOC35 = 0;
					LOC35 = gprojectfull_153236; gprojectfull_153236 = copyStringRC1(((NimStringDesc*) &TMP10797));
				...
				nimln(66, "nim.nim");
				{
					...
					LA42: ;
					{
						...
						nimln(72, "nim.nim");
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP10798));
						LOC47 = 0;
...
appendString(LOC49, ((NimStringDesc*) &TMP10799));
appendString(LOC49, ex);
appendChar(LOC49, 32);
appendString(LOC49, arguments_176721);
					execexternalprogram_169985(LOC49, ((NimStringDesc*) &TMP10793));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						...
						nimln(81, "nim.nim");
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP10793));
...
appendString(LOC58, arguments_176721);
					execexternalprogram_169985(LOC58, ((NimStringDesc*) &TMP10793));
				}
				LA36: ;
			}
			LA29: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit)(void) {
	...
	nimln(95, "nim.nim");
	msgquit_163107(((NI8) ((((NI) 0) < gerrorcounter_163015))));
	popFrame();
}
