...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7993, "sons", 4);
STRING_LITERAL(TMP7996, "ithField", 8);
STRING_LITERAL(TMP8000, "ithField(record case branch)", 28);
static NIM_CONST TY192031 TMP8002 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP8003, "sym", 3);
STRING_LITERAL(TMP8004, "invalid field at index ", 23);
STRING_LITERAL(TMP8007, "() must have an object or tuple type", 36);
STRING_LITERAL(TMP8009, "[] must have some form of array type", 36);
STRING_LITERAL(TMP8011, "{} must have the set type", 25);
STRING_LITERAL(TMP8012, "float literal must have some float type", 39);
STRING_LITERAL(TMP8013, "integer literal must have some int type", 39);
STRING_LITERAL(TMP8014, "string literal must be of some string type", 42);
STRING_LITERAL(TMP8015, "nil literal must be of some pointer type", 40);
...
{	result = 0;
	...
	{
		{
			...
			TMP7991 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_403095 = (NI)(TMP7991);
			...
			res_403098 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7994 = subInt(field, i_403029);
					result = ithfield_403012((*n).kindU.S6.sons->data[i_403029], (NI)(TMP7994));
					...
					TMP7995 = addInt(res_403098, ((NI) 1));
					res_403098 = (NI)(TMP7995);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_165199((*n).info, ((NimStringDesc*) &TMP7996));
		}
		LA13: ;
		...
		result = ithfield_403012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7997));
		...
		LA17: ;
		{
			...
			TMP7998 = subInt(LOC20, ((NI) 1));
			HEX3Atmp_403103 = (NI)(TMP7998);
			nimln(1598, "system.nim");
			res_403106 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_403012(LOC24, (NI)(TMP7999));
					...
					nimln(1614, "system.nim");
					TMP8001 = addInt(res_403106, ((NI) 1));
					res_403106 = (NI)(TMP8001);
				} LA22: ;
			}
		}
	}
	...
	case ((NU8) 3):
	{
		nimln(33, "semmacrosanity.nim");
		{
			...
			if (!(((TMP8002[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP8003));
...
appendString(LOC14, ((NimStringDesc*) &TMP8004));
appendString(LOC14, LOC15);
						...
						TMP8005 = addInt(res_403313, ((NI) 1));
						res_403313 = (NI)(TMP8005);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, ((NimStringDesc*) &TMP8004));
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP8006 = addInt(res_403321, ((NI) 1));
						res_403321 = (NI)(TMP8006);
					} LA23: ;
				}
			}
		}
		...
		LA35: ;
		{
			...
			globalerror_165145((*n).info, ((NimStringDesc*) &TMP8007));
		}
		LA2: ;
	}
	break;
				...
				m_403253 = 0;
				{
					...
					res_403333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8008 = addInt(res_403333, ((NI) 1));
							res_403333 = (NI)(TMP8008);
						} LA47: ;
					}
				}
			}
				...
				m_403265 = 0;
				{
					...
					res_403344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8010 = addInt(res_403344, ((NI) 1));
							res_403344 = (NI)(TMP8010);
						} LA59: ;
					}
				}
			}
