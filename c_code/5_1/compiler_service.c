...
STRING_LITERAL(TMP10630, "", 0);
STRING_LITERAL(TMP10635, " ", 1);
STRING_LITERAL(TMP10636, "-", 1);
STRING_LITERAL(TMP10637, "run", 3);
STRING_LITERAL(TMP10643, "server.type", 11);
STRING_LITERAL(TMP10644, "stdin", 5);
STRING_LITERAL(TMP10645, "tcp", 3);
STRING_LITERAL(TMP10646, "quit", 4);
STRING_LITERAL(TMP10649, "server.port", 11);
STRING_LITERAL(TMP10650, "server.address", 14);
STRING_LITERAL(TMP10653, "\015\012", 2);
STRING_LITERAL(TMP10676, "Invalid server.type:", 20);
...
N_NIMCALL(void, processcmdline_521209)(NU8 pass, NimStringDesc* cmd) {
	...
	argscount = ((NI) 0);
	{
		...
		while (1) {
			...
			case ((NU8) 3):
			{
				...
				{
					if (!eqStrings(p.key, ((NimStringDesc*) &TMP10635))) goto LA7;
					nimln(38, "service.nim");
					p.key = copyString(((NimStringDesc*) &TMP10636));
	...
	nimln(44, "service.nim");
	{
		...
		nimln(45, "service.nim");
		{
			...
			LOC27 = !(eqStrings(LOC31, ((NimStringDesc*) &TMP10637)));
			LA30: ;
			if (!LOC27) goto LA32;
...
appendString(LOC1, ((NimStringDesc*) &TMP10653));
...
N_NIMCALL(void, serve_521254)(TY521256 action) {
	...
	typ = getconfigvar_153334(((NimStringDesc*) &TMP10643));
	nimln(56, "service.nim");
	if (eqStrings(typ, ((NimStringDesc*) &TMP10644))) goto LA1;
	if (eqStrings(typ, ((NimStringDesc*) &TMP10645))) goto LA2;
	...
	{
		{
			...
			while (1) {
				...
				{
					if (!eqStrings(line, ((NimStringDesc*) &TMP10646))) goto LA10;
					exit(((NI) 0));
				}
				LA10: ;
				...
				printf("%s\012", ((NimStringDesc*) &TMP10630)? (((NimStringDesc*) &TMP10630))->data:"nil");
	...
	LA2: ;
	{
		...
		p = getconfigvar_153334(((NimStringDesc*) &TMP10649));
		...
		LOC20 = 0;
		LOC20 = getconfigvar_153334(((NimStringDesc*) &TMP10650));
		bindaddr_514620(server, port, LOC20);
		nimln(71, "service.nim");
		inp = copyString(((NimStringDesc*) &TMP10630));
		...
		writelnhook_163060.ClPrc = LOC21.ClPrc;
		{
			...
			while (1) {
				...
				send_518208((*HEX3Aenv_521447).stdoutsocket521408, ((NimStringDesc*) &TMP10653), 2);
	...
	LA3: ;
	{
		...
		printf("%s%s\012", ((NimStringDesc*) &TMP10676)? (((NimStringDesc*) &TMP10676))->data:"nil", typ? (typ)->data:"nil");
...
NIM_EXTERNC N_NOINLINE(void, compiler_serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_521204; curcaascmd_521204 = copyStringRC1(((NimStringDesc*) &TMP10630));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_521205; lastcaascmd_521205 = copyStringRC1(((NimStringDesc*) &TMP10630));
	if (LOC2) nimGCunrefNoCycle(LOC2);
	popFrame();
}

NIM_EXTERNC N_NOINLINE(void, compiler_serviceDatInit)(void) {
static TNimNode* TMP10638[2];
static TNimNode TMP10609[3];
NTI521426.size = sizeof(TY521426);
NTI521426.kind = 18;
NTI521426.base = 0;
NTI521426.flags = 2;
TMP10638[0] = &TMP10609[1];
TMP10609[1].kind = 1;
TMP10609[1].offset = offsetof(TY521426, HEX3Astate);
TMP10609[1].typ = (&NTI170807);
TMP10609[1].name = ":state";
TMP10638[1] = &TMP10609[2];
TMP10609[2].kind = 1;
TMP10609[2].offset = offsetof(TY521426, stdoutsocket521408);
TMP10609[2].typ = (&NTI513409);
TMP10609[2].name = "stdoutSocket521408";
TMP10609[0].len = 2; TMP10609[0].kind = 2; TMP10609[0].sons = &TMP10638[0];
NTI521426.node = &TMP10609[0];
NTI521448.size = sizeof(TY521426*);
NTI521448.kind = 22;
NTI521448.base = (&NTI521426);
NTI521448.flags = 2;
NTI521448.marker = TMP10642;
}
