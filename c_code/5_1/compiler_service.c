...
N_NIMCALL(void, serve_522254)(TY522256 action) {
	...
	typ = getconfigvar_154334(((NimStringDesc*) &TMP10642));
	...
	LA2: ;
	{
		...
		p = getconfigvar_154334(((NimStringDesc*) &TMP10648));
		...
		LOC20 = 0;
		LOC20 = getconfigvar_154334(((NimStringDesc*) &TMP10649));
		...
		writelnhook_164060.ClPrc = LOC21.ClPrc;
		{
			...
			while (1) {
				...
				send_519208((*HEX3Aenv_522447).stdoutsocket522408, ((NimStringDesc*) &TMP10652), 2);
...
NIM_EXTERNC N_NOINLINE(void, compiler_serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_522204; curcaascmd_522204 = copyStringRC1(((NimStringDesc*) &TMP10629));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_522205; lastcaascmd_522205 = copyStringRC1(((NimStringDesc*) &TMP10629));
...
TMP10608[1].kind = 1;
TMP10608[1].offset = offsetof(TY522426, HEX3Astate);
TMP10608[1].typ = (&NTI171807);
TMP10608[1].name = ":state";
TMP10637[1] = &TMP10608[2];
TMP10608[2].kind = 1;
TMP10608[2].offset = offsetof(TY522426, stdoutsocket522408);
TMP10608[2].typ = (&NTI514409);
TMP10608[2].name = "stdoutSocket522408";
TMP10608[0].len = 2; TMP10608[0].kind = 2; TMP10608[0].sons = &TMP10637[0];
NTI522426.node = &TMP10608[0];
NTI522448.size = sizeof(TY522426*);
NTI522448.kind = 22;
NTI522448.base = (&NTI522426);
NTI522448.flags = 2;
NTI522448.marker = TMP10641;
}
