	...
	{
		{
			...
			res_242092 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4158 = addInt(res_242092, ((NI) 1));
					res_242092 = (NI)(TMP4158);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_242191 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4160 = addInt(res_242191, ((NI) 1));
							res_242191 = (NI)(TMP4160);
						} LA28: ;
					}
				}
...
N_NIMCALL(NI, nodetabletestorset_242698)(Tnodetable190873* t, Tnode190813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq190871*) newSeq((&NTI190871), ((NI)chckRange((NI)(TMP4168), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_242839;
				NI HEX3Atmp_242876;
				NI res_242879;
