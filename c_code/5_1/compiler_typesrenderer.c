...
STRING_LITERAL(TMP6616, "", 0);
static NIM_CONST TY191031 TMP6617 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6618, "sons", 4);
static NIM_CONST TY191031 TMP6620 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6621, "ident", 5);
STRING_LITERAL(TMP6622, "*", 1);
static NIM_CONST TY191031 TMP6623 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6624, "sym", 3);
STRING_LITERAL(TMP6625, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP6626, "not isNil(result) ", 18);
STRING_LITERAL(TMP6627, "len(n) == 1 ", 12);
STRING_LITERAL(TMP6628, "ref.", 4);
STRING_LITERAL(TMP6629, "ptr.", 4);
STRING_LITERAL(TMP6630, "1 < len(n) ", 11);
STRING_LITERAL(TMP6631, "params.kind == nkFormalParams ", 30);
STRING_LITERAL(TMP6632, "0 < len(params) ", 16);
STRING_LITERAL(TMP6633, "proc(", 5);
STRING_LITERAL(TMP6635, "3 <= len(n) ", 12);
STRING_LITERAL(TMP6637, "[](n, i).kind == nkIdent ", 25);
STRING_LITERAL(TMP6639, "tuple[", 6);
STRING_LITERAL(TMP6641, "2 <= len(n) ", 12);
STRING_LITERAL(TMP6645, "0 < typePos ", 12);
STRING_LITERAL(TMP6648, "[](n, i).kind == nkIdent or [](n, i).kind == nkAccQuoted ", 57);
STRING_LITERAL(TMP6650, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	...
	result = copyString(((NimStringDesc*) &TMP6616));
	...
	{
		{
			...
			res_337205 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP6619 = addInt(res_337205, ((NI) 1));
					res_337205 = (NI)(TMP6619);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 2):
	{
		nimln(28, "typesrenderer.nim");
		{
			...
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP6622)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP6625));
...
appendString(LOC16, ((NimStringDesc*) &TMP6628));
...
appendString(LOC25, ((NimStringDesc*) &TMP6629));
appendString(LOC25, LOC27);
	...
	case ((NU8) 147):
	{
		...
		result = copyString(((NimStringDesc*) &TMP6633));
		{
			NI i_338419;
			NI HEX3Atmp_339202;
			NI LOC44;
...
appendString(result, LOC47);
					nimln(1619, "system.nim");
					TMP6634 = addInt(res_339205, ((NI) 1));
					res_339205 = (NI)(TMP6634);
				} LA46: ;
			}
		}
...
appendString(result, LOC66);
					nimln(1619, "system.nim");
					TMP6638 = addInt(res_339213, ((NI) 1));
					res_339213 = (NI)(TMP6638);
				} LA60: ;
			}
		}
	}
...
appendString(result, LOC72);
					nimln(1619, "system.nim");
					TMP6640 = addInt(res_339221, ((NI) 1));
					res_339221 = (NI)(TMP6640);
				} LA71: ;
			}
		}
...
appendString(result, LOC88);
					nimln(1619, "system.nim");
					TMP6642 = addInt(res_339229, ((NI) 1));
					res_339229 = (NI)(TMP6642);
				} LA87: ;
			}
		}
...
{	nimln(89, "typesrenderer.nim");
	...
	{
		{
			...
			res_339622 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6643 = addInt(res_339622, ((NI) 1));
					res_339622 = (NI)(TMP6643);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 35):
	{
		...
		nimln(97, "typesrenderer.nim");
		{
			...
			LOC18 = 0;
			LOC18 = HEX5BHEX5D_191244(n, (NI)(TMP6646));
			...
			LOC21 = 0;
			LOC21 = HEX5BHEX5D_191244(n, (NI)(TMP6647));
			typ = (*LOC21).typ;
		...
		LA19: ;
		{
			...
			res_339630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6649 = addInt(res_339630, ((NI) 1));
					res_339630 = (NI)(TMP6649);
				} LA32: ;
			}
		}
	}
...
appendString(LOC43, ((NimStringDesc*) &TMP6650));
