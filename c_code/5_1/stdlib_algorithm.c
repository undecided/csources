...
typedef N_CLOSURE_PTR(NI, TMP5963) (Tindexentry312396 x_313751, Tindexentry312396 y_313753);
typedef N_CLOSURE_PTR(NI, TMP5967) (Tindexentry312396 x_313751, Tindexentry312396 y_313753);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TMP6012) (NimStringDesc* x_315365, NimStringDesc* y_315367);
typedef struct {
N_NIMCALL_PTR(NI, ClPrc) (Tsym190843* x_351527, Tsym190843* y_351529, void* ClEnv);
void* ClEnv;
} TY351525;
typedef N_CLOSURE_PTR(NI, TMP6969) (Tsym190843* x_351582, Tsym190843* y_351584);
typedef N_CLOSURE_PTR(NI, TMP6972) (Tsym190843* x_351582, Tsym190843* y_351584);
struct  TNimObject  {
TNimType* m_type;
};
struct  Tidobj166015  {
...
N_NIMCALL(void, sort_313687)(Tindexentry312396* a, NI aLen0, TY313694 cmp, NU8 order) {
	...
	b = (TY312897*) newSeq((&NTI312897), ((NI)chckRange((NI)(TMP5957), ((NI) 0), ((NI) 2147483647))));
		...
		while (1) {
			...
			m = (NI)(TMP5961);
			{
				...
				while (1) {
					...
					TMP5975 = addInt(m, s);
					merge_313732(a, aLen0, b->data, b->Sup.len, (((NI)(TMP5974) >= ((NI) 0)) ? (NI)(TMP5974) : ((NI) 0)), m, (NI)(TMP5975), cmp, order);
		...
		while (1) {
			...
			m = (NI)(TMP6007);
			{
				...
				while (1) {
					...
					TMP6020 = addInt(m, s);
					merge_315346(a, aLen0, b->data, b->Sup.len, (((NI)(TMP6019) >= ((NI) 0)) ? (NI)(TMP6019) : ((NI) 0)), m, (NI)(TMP6020), cmp, order);
					nimln(188, "algorithm.nim");
...
N_NIMCALL(void, sort_351518)(Tsym190843** a, NI aLen0, TY351525 cmp, NU8 order) {
	...
	b = (Tsymseq190815*) newSeq((&NTI190815), ((NI)chckRange((NI)(TMP6965), ((NI) 0), ((NI) 2147483647))));
	nimln(183, "algorithm.nim");
	s = ((NI) 1);
	{
		nimln(184, "algorithm.nim");
		while (1) {
			...
			m = (NI)(TMP6967);
			{
				...
				while (1) {
					...
					TMP6980 = addInt(m, s);
					merge_351563(a, aLen0, b->data, b->Sup.len, (((NI)(TMP6979) >= ((NI) 0)) ? (NI)(TMP6979) : ((NI) 0)), m, (NI)(TMP6980), cmp, order);
					nimln(188, "algorithm.nim");
