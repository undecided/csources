...
N_NIMCALL(NI, nospexecProcesses)(NimStringDesc** cmds, NI cmdsLen0, NU8 options_143807, NI n, TY143809 beforerunevent) {
	...
	nimln(261, "osproc.nim");
	{
		...
		q = (TY144201*) newSeq((&NTI144201), ((NI)chckRange(n, ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(NCSTRING*, envtocstringarray_144806)(Stringtableobj134012* t) {
	...
	TMP611 = mulInt((NI)(TMP610), ((NI) 4));
	LOC2 = 0;
	LOC2 = alloc0_6017(((NI)chckRange((NI)(TMP611), ((NI) 0), ((NI) 2147483647))));
...
appendString(LOC11, val_144813);
						...
						LOC12 = 0;
						LOC12 = alloc_6001(((NI)chckRange((NI)(TMP613), ((NI) 0), ((NI) 2147483647))));
						result[(i)- 0] = ((NCSTRING) (LOC12));
						nimln(589, "osproc.nim");
						if ((NU)(i) > (NU)(100000000)) raiseIndexError();
						if ((NU)(((NI) 0)) > (NU)(x->Sup.len)) raiseIndexError();
						TMP614 = addInt((x ? x->Sup.len : 0), ((NI) 1));
						memcpy(((void*) (result[(i)- 0])), ((void*) ((&x->data[((NI) 0)]))), ((NI)chckRange((NI)(TMP614), ((NI) 0), ((NI) 2147483647))));
...
appendString(LOC10, val_144872);
					...
					LOC11 = 0;
					LOC11 = alloc_6001(((NI)chckRange((NI)(TMP625), ((NI) 0), ((NI) 2147483647))));
					result[(i)- 0] = ((NCSTRING) (LOC11));
					nimln(600, "osproc.nim");
					if ((NU)(i) > (NU)(100000000)) raiseIndexError();
					if ((NU)(((NI) 0)) > (NU)(x->Sup.len)) raiseIndexError();
					TMP626 = addInt((x ? x->Sup.len : 0), ((NI) 1));
					memcpy(((void*) (result[(i)- 0])), ((void*) ((&x->data[((NI) 0)]))), ((NI)chckRange((NI)(TMP626), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, pruneprocessset_146044)(TY144201** s, fd_set* fd) {
	...
	(*s) = (TY144201*) setLengthSeq(&((*s))->Sup, sizeof(Processobj143402*), ((NI)chckRange(L, ((NI) 0), ((NI) 2147483647))));
	popFrame();
}
...
N_NIMCALL(NI, select_144608)(TY144201** readfds, NI timeout) {
	...
	nimln(890, "osproc.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int) ((NI)(TMP650))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int) ((NI)(TMP651))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
