...
N_NIMCALL(NIM_BOOL, bitsetin_239077)(Tbitset239012* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP4068)] & ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4069)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_239061)(Tbitset239012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4071)] = (NI8)((*x)->data[(NI64)(TMP4072)] | ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4073))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_239069)(Tbitset239012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4074)] = (NI8)((*x)->data[(NI64)(TMP4075)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4076))))))))));
	popFrame();
}
