...
TMP8926[0] = &TMP8924[1];
TMP8924[1].kind = 1;
TMP8924[1].offset = offsetof(Tcgen456038, module);
TMP8924[1].typ = (&NTI190811);
TMP8924[1].name = "module";
TMP8926[1] = &TMP8924[2];
TMP8924[2].kind = 1;
TMP8924[2].offset = offsetof(Tcgen456038, filename);
...
NTI456022.flags = 2;
TMP8924[3].kind = 1;
TMP8924[3].offset = offsetof(Tcgen456038, s);
TMP8924[3].typ = (&NTI456022);
TMP8924[3].name = "s";
TMP8926[3] = &TMP8924[4];
TMP8924[4].kind = 1;
TMP8924[4].offset = offsetof(Tcgen456038, preventstacktrace);
TMP8924[4].typ = (&NTI138);
TMP8924[4].name = "preventStackTrace";
TMP8926[4] = &TMP8924[5];
TMP8924[5].kind = 1;
TMP8924[5].offset = offsetof(Tcgen456038, usesthreadvars);
TMP8924[5].typ = (&NTI138);
TMP8924[5].name = "usesThreadVars";
TMP8926[5] = &TMP8924[6];
TMP8924[6].kind = 1;
TMP8924[6].offset = offsetof(Tcgen456038, framedeclared);
TMP8924[6].typ = (&NTI138);
TMP8924[6].name = "frameDeclared";
TMP8926[6] = &TMP8924[7];
TMP8924[7].kind = 1;
TMP8924[7].offset = offsetof(Tcgen456038, isheaderfile);
TMP8924[7].typ = (&NTI138);
TMP8924[7].name = "isHeaderFile";
TMP8926[7] = &TMP8924[8];
TMP8924[8].kind = 1;
TMP8924[8].offset = offsetof(Tcgen456038, includesstringh);
TMP8924[8].typ = (&NTI138);
TMP8924[8].name = "includesStringh";
TMP8926[8] = &TMP8924[9];
TMP8924[9].kind = 1;
TMP8924[9].offset = offsetof(Tcgen456038, objhaskidsvalid);
TMP8924[9].typ = (&NTI138);
TMP8924[9].name = "objHasKidsValid";
TMP8926[9] = &TMP8924[10];
TMP8924[10].kind = 1;
TMP8924[10].offset = offsetof(Tcgen456038, cfilename);
TMP8924[10].typ = (&NTI149);
TMP8924[10].name = "cfilename";
TMP8926[10] = &TMP8924[11];
TMP8924[11].kind = 1;
TMP8924[11].offset = offsetof(Tcgen456038, typecache);
TMP8924[11].typ = (&NTI190861);
TMP8924[11].name = "typeCache";
TMP8926[11] = &TMP8924[12];
TMP8924[12].kind = 1;
TMP8924[12].offset = offsetof(Tcgen456038, forwtypecache);
TMP8924[12].typ = (&NTI190861);
TMP8924[12].name = "forwTypeCache";
TMP8926[12] = &TMP8924[13];
TMP8924[13].kind = 1;
TMP8924[13].offset = offsetof(Tcgen456038, declaredthings);
TMP8924[13].typ = (&NTI187056);
TMP8924[13].name = "declaredThings";
TMP8926[13] = &TMP8924[14];
TMP8924[14].kind = 1;
TMP8924[14].offset = offsetof(Tcgen456038, declaredprotos);
TMP8924[14].typ = (&NTI187056);
TMP8924[14].name = "declaredProtos";
TMP8926[14] = &TMP8924[15];
TMP8924[15].kind = 1;
TMP8924[15].offset = offsetof(Tcgen456038, headerfiles);
TMP8924[15].typ = (&NTI130028);
TMP8924[15].name = "headerFiles";
TMP8926[15] = &TMP8924[16];
TMP8924[16].kind = 1;
TMP8924[16].offset = offsetof(Tcgen456038, typeinfomarker);
TMP8924[16].typ = (&NTI187056);
...
TMP8924[19].kind = 1;
TMP8924[19].offset = offsetof(Tcproc456034, prc);
TMP8924[19].typ = (&NTI190811);
TMP8924[19].name = "prc";
TMP8927[1] = &TMP8924[20];
TMP8924[20].kind = 1;
TMP8924[20].offset = offsetof(Tcproc456034, beforeretneeded);
TMP8924[20].typ = (&NTI138);
TMP8924[20].name = "beforeRetNeeded";
TMP8927[2] = &TMP8924[21];
TMP8924[21].kind = 1;
TMP8924[21].offset = offsetof(Tcproc456034, threadvaraccessed);
TMP8924[21].typ = (&NTI138);
TMP8924[21].name = "threadVarAccessed";
TMP8927[3] = &TMP8924[22];
TMP8924[22].kind = 1;
TMP8924[22].offset = offsetof(Tcproc456034, lastlineinfo);
TMP8924[22].typ = (&NTI162338);
TMP8924[22].name = "lastLineInfo";
TMP8927[4] = &TMP8924[23];
TMP8924[23].kind = 1;
TMP8924[23].offset = offsetof(Tcproc456034, nestedtrystmts);
TMP8924[23].typ = (&NTI190807);
TMP8924[23].name = "nestedTryStmts";
TMP8927[5] = &TMP8924[24];
TMP8924[24].kind = 1;
TMP8924[24].offset = offsetof(Tcproc456034, inexceptblock);
TMP8924[24].typ = (&NTI108);
TMP8924[24].name = "inExceptBlock";
TMP8927[6] = &TMP8924[25];
TMP8924[25].kind = 1;
TMP8924[25].offset = offsetof(Tcproc456034, finallysafepoints);
TMP8924[25].typ = (&NTI160599);
TMP8924[25].name = "finallySafePoints";
TMP8927[7] = &TMP8924[26];
TMP8924[26].kind = 1;
TMP8924[26].offset = offsetof(Tcproc456034, labels);
...
TMP8924[29].kind = 1;
TMP8924[29].offset = offsetof(Tblock456032, id);
TMP8924[29].typ = (&NTI108);
TMP8924[29].name = "id";
TMP8928[1] = &TMP8924[30];
TMP8924[30].kind = 1;
TMP8924[30].offset = offsetof(Tblock456032, label);
TMP8924[30].typ = (&NTI160007);
...
NTI456026.flags = 2;
TMP8924[31].kind = 1;
TMP8924[31].offset = offsetof(Tblock456032, sections);
TMP8924[31].typ = (&NTI456026);
TMP8924[31].name = "sections";
TMP8928[3] = &TMP8924[32];
TMP8924[32].kind = 1;
TMP8924[32].offset = offsetof(Tblock456032, isloop);
TMP8924[32].typ = (&NTI138);
TMP8924[32].name = "isLoop";
TMP8928[4] = &TMP8924[33];
TMP8924[33].kind = 1;
TMP8924[33].offset = offsetof(Tblock456032, nestedtrystmts);
TMP8924[33].typ = (&NTI112);
TMP8924[33].name = "nestedTryStmts";
TMP8928[5] = &TMP8924[34];
TMP8924[34].kind = 1;
TMP8924[34].offset = offsetof(Tblock456032, nestedexceptstmts);
TMP8924[34].typ = (&NTI112);
TMP8924[34].name = "nestedExceptStmts";
TMP8928[6] = &TMP8924[35];
TMP8924[35].kind = 1;
TMP8924[35].offset = offsetof(Tblock456032, framelen);
TMP8924[35].typ = (&NTI112);
TMP8924[35].name = "frameLen";
TMP8924[28].len = 7; TMP8924[28].kind = 2; TMP8924[28].sons = &TMP8928[0];
NTI456032.node = &TMP8924[28];
NTI456106.size = sizeof(TY456106*);
NTI456106.kind = 24;
NTI456106.base = (&NTI456032);
NTI456106.flags = 2;
NTI456106.marker = TMP8929;
TMP8924[27].kind = 1;
TMP8924[27].offset = offsetof(Tcproc456034, blocks);
TMP8924[27].typ = (&NTI456106);
TMP8924[27].name = "blocks";
TMP8927[9] = &TMP8924[36];
TMP8924[36].kind = 1;
TMP8924[36].offset = offsetof(Tcproc456034, breakidx);
TMP8924[36].typ = (&NTI108);
TMP8924[36].name = "breakIdx";
TMP8927[10] = &TMP8924[37];
TMP8924[37].kind = 1;
TMP8924[37].offset = offsetof(Tcproc456034, options);
TMP8924[37].typ = (&NTI153121);
TMP8924[37].name = "options";
TMP8927[11] = &TMP8924[38];
TMP8924[38].kind = 1;
TMP8924[38].offset = offsetof(Tcproc456034, maxframelen);
TMP8924[38].typ = (&NTI108);
TMP8924[38].name = "maxFrameLen";
TMP8927[12] = &TMP8924[39];
TMP8924[39].kind = 1;
TMP8924[39].offset = offsetof(Tcproc456034, module);
TMP8924[39].typ = (&NTI456028);
TMP8924[39].name = "module";
TMP8927[13] = &TMP8924[40];
TMP8924[40].kind = 1;
TMP8924[40].offset = offsetof(Tcproc456034, withinloop);
TMP8924[40].typ = (&NTI108);
TMP8924[40].name = "withinLoop";
TMP8927[14] = &TMP8924[41];
TMP8924[41].kind = 1;
TMP8924[41].offset = offsetof(Tcproc456034, splitdecls);
TMP8924[41].typ = (&NTI108);
TMP8924[41].name = "splitDecls";
TMP8927[15] = &TMP8924[42];
TMP8924[42].kind = 1;
TMP8924[42].offset = offsetof(Tcproc456034, gcframeid);
TMP8924[42].typ = (&NTI3407);
TMP8924[42].name = "gcFrameId";
TMP8927[16] = &TMP8924[43];
TMP8924[43].kind = 1;
TMP8924[43].offset = offsetof(Tcproc456034, gcframetype);
TMP8924[43].typ = (&NTI160007);
TMP8924[43].name = "gcFrameType";
TMP8924[18].len = 17; TMP8924[18].kind = 2; TMP8924[18].sons = &TMP8927[0];
NTI456034.node = &TMP8924[18];
NTI456030.size = sizeof(Tcproc456034*);
NTI456030.kind = 22;
NTI456030.base = (&NTI456034);
NTI456030.marker = TMP8930;
TMP8924[17].kind = 1;
TMP8924[17].offset = offsetof(Tcgen456038, initproc);
TMP8924[17].typ = (&NTI456030);
TMP8924[17].name = "initProc";
TMP8926[17] = &TMP8924[44];
TMP8924[44].kind = 1;
TMP8924[44].offset = offsetof(Tcgen456038, postinitproc);
TMP8924[44].typ = (&NTI456030);
TMP8924[44].name = "postInitProc";
TMP8926[18] = &TMP8924[45];
TMP8924[45].kind = 1;
TMP8924[45].offset = offsetof(Tcgen456038, preinitproc);
TMP8924[45].typ = (&NTI456030);
TMP8924[45].name = "preInitProc";
TMP8926[19] = &TMP8924[46];
TMP8924[46].kind = 1;
TMP8924[46].offset = offsetof(Tcgen456038, typestack);
TMP8924[46].typ = (&NTI190845);
TMP8924[46].name = "typeStack";
TMP8926[20] = &TMP8924[47];
TMP8924[47].kind = 1;
TMP8924[47].offset = offsetof(Tcgen456038, datacache);
TMP8924[47].typ = (&NTI190873);
TMP8924[47].name = "dataCache";
TMP8926[21] = &TMP8924[48];
TMP8924[48].kind = 1;
TMP8924[48].offset = offsetof(Tcgen456038, forwardedprocs);
TMP8924[48].typ = (&NTI190815);
TMP8924[48].name = "forwardedProcs";
TMP8926[22] = &TMP8924[49];
TMP8924[49].kind = 1;
TMP8924[49].offset = offsetof(Tcgen456038, typenodes);
TMP8924[49].typ = (&NTI108);
TMP8924[49].name = "typeNodes";
TMP8926[23] = &TMP8924[50];
TMP8924[50].kind = 1;
TMP8924[50].offset = offsetof(Tcgen456038, nimtypes);
TMP8924[50].typ = (&NTI108);
TMP8924[50].name = "nimTypes";
TMP8926[24] = &TMP8924[51];
TMP8924[51].kind = 1;
TMP8924[51].offset = offsetof(Tcgen456038, typenodesname);
TMP8924[51].typ = (&NTI160007);
TMP8924[51].name = "typeNodesName";
TMP8926[25] = &TMP8924[52];
TMP8924[52].kind = 1;
TMP8924[52].offset = offsetof(Tcgen456038, nimtypesname);
TMP8924[52].typ = (&NTI160007);
TMP8924[52].name = "nimTypesName";
TMP8926[26] = &TMP8924[53];
TMP8924[53].kind = 1;
TMP8924[53].offset = offsetof(Tcgen456038, labels);
