...
N_NIMCALL(void, definesymbol_168013)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_168004, symbol, ((NimStringDesc*) &TMP1319));
	popFrame();
}
...
N_NIMCALL(void, undefsymbol_168022)(NimStringDesc* symbol) {
	...
	nstPut(gsymbols_168004, symbol, ((NimStringDesc*) &TMP1320));
	popFrame();
}
			...
			res_168233 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(44, "strtabs.nim");
					{
						...
						{
							NI TMP1345;
							if (!!(eqStrings(val_168215, ((NimStringDesc*) &TMP1320)))) goto LA11;
					...
					TMP1346 = addInt(res_168233, ((NI) 1));
					res_168233 = (NI)(TMP1346);
				} LA4: ;
			}
		}
	}
