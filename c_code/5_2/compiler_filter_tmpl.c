...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP3349, "\012", 1);
STRING_LITERAL(TMP3360, "", 0);
STRING_LITERAL(TMP3363, "end", 3);
STRING_LITERAL(TMP3364, "#end", 4);
static NIM_CONST TY77659 TMP3367 = {
...
STRING_LITERAL(TMP3373, "\\x", 2);
STRING_LITERAL(TMP3375, "\\\\", 2);
STRING_LITERAL(TMP3377, "\\\'", 2);
STRING_LITERAL(TMP3379, "\\\"", 2);
STRING_LITERAL(TMP3383, "}", 1);
STRING_LITERAL(TMP3391, "$", 1);
STRING_LITERAL(TMP3393, "\\n\"", 3);
STRING_LITERAL(TMP3394, "subschar", 8);
STRING_LITERAL(TMP3395, "metachar", 8);
STRING_LITERAL(TMP3396, "emit", 4);
STRING_LITERAL(TMP3397, "result.add", 10);
STRING_LITERAL(TMP3398, "conc", 4);
STRING_LITERAL(TMP3399, " & ", 3);
STRING_LITERAL(TMP3400, "tostring", 8);
...
N_NIMCALL(void, newline_217047)(Ttmplparser217020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3349));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_217149)(Ttmplparser217020* p) {
	...
	LA7: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP3360));
		{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_164155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3363));
			}
			LA20: ;
		...
		case ((NU16) 26):
		{
			...
			TMP3366 = subInt((*p).indent, ((NI) 2));
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3366), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU16) 62):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				NI TMP3368;
				LOC37 = 0;
				LOC37 = contains_99373((*p).x, TMP3367);
				if (!!(LOC37)) goto LA38;
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3369), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU8) 0):
		{
			...
			llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3371));
			nimln(130, "filter_tmpl.nim");
			TMP3372 = addInt((*p).emitpar, ((NI) 1));
			(*p).emitpar = (NI)(TMP3372);
		}
		break;
		}
		...
		(*p).state = ((NU8) 1);
		{
			...
			while (1) {
				...
				case 128 ... 255:
				{
					...
					llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3373));
				...
				case 92:
				{
					...
					llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3375));
				...
				case 39:
				{
					...
					llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3377));
				...
				case 34:
				{
					...
					llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3379));
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_164155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3383));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_164155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3391));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_177665((*p).outp, ((NimStringDesc*) &TMP3393));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream177204*, filtertmpl_217009)(Tllstream177204* stdin_217011, NimStringDesc* filename, Tnode190813* call) {
	...
	p.outp = llstreamopen_177220(((NimStringDesc*) &TMP3360));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_217011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_216020(call, ((NimStringDesc*) &TMP3394), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_216020(call, ((NimStringDesc*) &TMP3395), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_216029(call, ((NimStringDesc*) &TMP3396), ((NI) 3), ((NimStringDesc*) &TMP3397));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_216029(call, ((NimStringDesc*) &TMP3398), ((NI) 4), ((NimStringDesc*) &TMP3399));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_216029(call, ((NimStringDesc*) &TMP3400), ((NI) 5), ((NimStringDesc*) &TMP3391));
	...
	p.x = rawNewString(((NI) 120));
	{
		...
		while (1) {
			...
			TMP3401 = addInt(p.info.line, ((NI16) 1));
			if (TMP3401 < -32768 || TMP3401 > 32767) raiseOverflow();
			p.info.line = (NI16)(TMP3401);
