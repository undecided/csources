...
STRING_LITERAL(TMP4034, "tab", 3);
STRING_LITERAL(TMP4035, "int", 3);
STRING_LITERAL(TMP4036, "int8", 4);
STRING_LITERAL(TMP4037, "int16", 5);
STRING_LITERAL(TMP4038, "int32", 5);
STRING_LITERAL(TMP4039, "int64", 5);
STRING_LITERAL(TMP4040, "uint", 4);
STRING_LITERAL(TMP4041, "uint8", 5);
STRING_LITERAL(TMP4042, "uint16", 6);
STRING_LITERAL(TMP4043, "uint32", 6);
STRING_LITERAL(TMP4044, "uint64", 6);
STRING_LITERAL(TMP4045, "float", 5);
STRING_LITERAL(TMP4046, "float32", 7);
STRING_LITERAL(TMP4047, "float64", 7);
STRING_LITERAL(TMP4048, "float128", 8);
STRING_LITERAL(TMP4049, "bool", 4);
STRING_LITERAL(TMP4050, "char", 4);
STRING_LITERAL(TMP4051, "string", 6);
STRING_LITERAL(TMP4052, "cstring", 7);
STRING_LITERAL(TMP4053, "pointer", 7);
STRING_LITERAL(TMP4054, "request for typekind: ", 22);
STRING_LITERAL(TMP4055, "wanted: ", 8);
STRING_LITERAL(TMP4056, " got: ", 6);
STRING_LITERAL(TMP4057, "type not found: ", 16);
static NIM_CONST TY192031 TMP4060 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4061, "intVal", 6);
STRING_LITERAL(TMP4062, "invalid int size", 16);
...
N_NIMCALL(Tsym191843*, getsyssym_239054)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_239019).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4034));
	LOC1 = 0;
...
appendString(LOC26, ((NimStringDesc*) &TMP4054));
...
appendString(LOC31, ((NimStringDesc*) &TMP4056));
...
appendString(LOC36, ((NimStringDesc*) &TMP4057));
	...
	initstrtable_195007((&compilerprocs_239064));
	{
		...
		res_239627 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4058 = addInt(res_239627, ((NI) 1));
				res_239627 = (NI)(TMP4058);
			} LA3: ;
		}
	}
	{
		...
		res_239633 = ((NI) -5);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP4059 = addInt(res_239633, ((NI) 1));
				res_239633 = (NI)(TMP4059);
			} LA6: ;
		}
	}
	popFrame();
...
N_NIMCALL(Ttype191849*, getintlittype_239660)(Tnode191813* literal) {
	...
	if (!(((TMP4060[(*literal).kind/8] &(1<<((*literal).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4061));
...
N_NIMCALL(void, setintlittype_239776)(Tnode191813* result) {
	...
	if (!(((TMP4060[(*result).kind/8] &(1<<((*result).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4061));
	...
	default:
	{
		...
		internalerror_165199((*result).info, ((NimStringDesc*) &TMP4062));
	}
	break;
	}
	popFrame();
