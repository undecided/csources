				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							NU8 k_173217;
							LOC15 = 0;
							LOC15 = !(eqStrings(y_173213, ((NimStringDesc*) &TMP1814)));
							if (!(LOC15)) goto LA16;
							LOC15 = !(eqStrings(y_173213, ((NimStringDesc*) &TMP1815)));
							LA16: ;
							if (!LOC15) goto LA17;
							...
							nimln(1305, "os.nim");
							{
								...
								nimln(1307, "os.nim");
								{
									...
									TMP1816 = addInt(k_173217, ((NI) 1));
									if (TMP1816 < 0 || TMP1816 > 3) raiseOverflow();
									k_173217 = (NU8)(TMP1816);
								}
								LA29: ;
								nimln(1302, "os.nim");
								...
								nimln(69, "nimblecmd.nim");
								{
									...
									if (!(LOC33)) goto LA34;
									LOC33 = nsuEndsWith(path_173195, ((NimStringDesc*) &TMP1821));
									LA34: ;
									if (!LOC33) goto LA35;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC49) goto LA50;
								TMP1822 = addInt(k_173217, ((NI) 1));
								if (TMP1822 < 0 || TMP1822 > 3) raiseOverflow();
								k_173217 = (NU8)(TMP1822);
							}
							LA50: ;
							nimln(1302, "os.nim");
							kind_173194 = k_173217;
							...
							nimln(69, "nimblecmd.nim");
							{
								...
								if (!(LOC54)) goto LA55;
								LOC54 = nsuEndsWith(path_173195, ((NimStringDesc*) &TMP1821));
								LA55: ;
								if (!LOC54) goto LA56;
								nimln(70, "nimblecmd.nim");
								result = NIM_TRUE;
					...
					while (1) {
						{
							...
							nimln(1299, "os.nim");
							{
								...
								NU8 k_173232;
								LOC21 = 0;
								LOC21 = !(eqStrings(y_173228, ((NimStringDesc*) &TMP1814)));
								if (!(LOC21)) goto LA22;
								LOC21 = !(eqStrings(y_173228, ((NimStringDesc*) &TMP1815)));
								LA22: ;
								if (!LOC21) goto LA23;
								...
								nimln(1305, "os.nim");
								{
									...
									nimln(1307, "os.nim");
									{
										...
										TMP1823 = addInt(k_173232, ((NI) 1));
										if (TMP1823 < 0 || TMP1823 > 3) raiseOverflow();
										k_173232 = (NU8)(TMP1823);
									}
									LA35: ;
									nimln(1302, "os.nim");
								...
								nimln(1313, "os.nim");
								{
									...
									if (!LOC54) goto LA55;
									TMP1824 = addInt(k_173232, ((NI) 1));
									if (TMP1824 < 0 || TMP1824 > 3) raiseOverflow();
									k_173232 = (NU8)(TMP1824);
								}
								LA55: ;
								nimln(1302, "os.nim");
								kind_173218 = k_173232;
				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							NU8 k_173316;
							LOC19 = 0;
							LOC19 = !(eqStrings(y_173312, ((NimStringDesc*) &TMP1814)));
							if (!(LOC19)) goto LA20;
							LOC19 = !(eqStrings(y_173312, ((NimStringDesc*) &TMP1815)));
							LA20: ;
							if (!LOC19) goto LA21;
							...
							nimln(1305, "os.nim");
							{
								...
								nimln(1307, "os.nim");
								{
									...
									TMP1827 = addInt(k_173316, ((NI) 1));
									if (TMP1827 < 0 || TMP1827 > 3) raiseOverflow();
									k_173316 = (NU8)(TMP1827);
								}
								LA33: ;
								nimln(1302, "os.nim");
								k_173292 = k_173316;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC53) goto LA54;
								TMP1828 = addInt(k_173316, ((NI) 1));
								if (TMP1828 < 0 || TMP1828 > 3) raiseOverflow();
								k_173316 = (NU8)(TMP1828);
							}
							LA54: ;
							nimln(1302, "os.nim");
							k_173292 = k_173316;
				...
				res_173330 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(44, "strtabs.nim");
						{
							...
							{
								if (!eqStrings(val_173324, ((NimStringDesc*) &TMP1807))) goto LA74;
...
appendString(LOC77, val_173324);
						...
						TMP1829 = addInt(res_173330, ((NI) 1));
						res_173330 = (NI)(TMP1829);
					} LA67: ;
				}
			}
		}
