...
STRING_LITERAL(TMP2478, "@if", 3);
STRING_LITERAL(TMP2479, "@", 1);
STRING_LITERAL(TMP2482, "@end", 4);
STRING_LITERAL(TMP2484, "putenv", 6);
STRING_LITERAL(TMP2485, "prependenv", 10);
STRING_LITERAL(TMP2486, "appendenv", 9);
STRING_LITERAL(TMP2487, "-", 1);
STRING_LITERAL(TMP2488, "--", 2);
STRING_LITERAL(TMP2489, "", 0);
STRING_LITERAL(TMP2490, "\']\'", 3);
STRING_LITERAL(TMP2491, "%=", 2);
STRING_LITERAL(TMP2492, "&", 1);
STRING_LITERAL(TMP2498, "config", 6);
STRING_LITERAL(TMP2499, "etc", 3);
STRING_LITERAL(TMP2500, "/etc/", 5);
STRING_LITERAL(TMP2501, "/usr", 4);
STRING_LITERAL(TMP2502, "/usr/lib/nim", 12);
STRING_LITERAL(TMP2503, "/usr/local", 10);
STRING_LITERAL(TMP2504, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP2505, "lib", 3);
STRING_LITERAL(TMP2509, "nimcfg", 6);
STRING_LITERAL(TMP2510, "nim.cfg", 7);
STRING_LITERAL(TMP2511, "nimrod.cfg", 10);
...
N_NIMCALL(void, doend_185191)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(61, "nimconf.nim");
	{
		...
		lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2478));
	}
	LA3: ;
	...
	nestedifs = ((NI) 0);
	{
		...
		while (1) {
			nimln(85, "nimconf.nim");
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2479));
				LA6: ;
				if (!LOC5) goto LA7;
...
N_NIMCALL(void, parsedirective_185342)(Tlexer180185* L, Ttoken180181* tok) {
	...
	case ((NU16) 31):
	{
		...
		TMP2483 = addInt((condstack_185186 ? condstack_185186->Sup.len : 0), ((NI) 1));
		condstack_185186 = (TY185169*) setLengthSeq(&(condstack_185186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((NI)(TMP2483), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2484))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2485))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2486))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_185377)(Tlexer180185* L, Ttoken180181* tok) {
	...
	ppgettok_185009(L, tok);
	{
		...
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2479));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_185439)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(159, "nimconf.nim");
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_166463(((NimStringDesc*) &TMP2487));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_166463(((NimStringDesc*) &TMP2488));
	...
	val = copyString(((NimStringDesc*) &TMP2489));
	{
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			...
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2490));
		}
		LA17: ;
	...
	LOC22 = 0;
	LOC22 = getident_166463(((NimStringDesc*) &TMP2491));
...
appendString(val, LOC33);
		...
		conftok_185377(L, tok);
		{
			...
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_166463(((NimStringDesc*) &TMP2492));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_185594)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP2498));
	...
	nimln(225, "nimconf.nim");
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP2499));
...
appendString(LOC13, ((NimStringDesc*) &TMP2500));
...
N_NIMCALL(void, loadconfigs_185809)(NimStringDesc* cfg) {
	...
	nimln(230, "nimconf.nim");
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP2501))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2502));
		...
		LA7: ;
		{
			...
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP2503))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2504));
		...
		LA11: ;
		{
			...
			asgnRefNoCycle((void**) (&libpath_153233), nosjoinPath(prefix, ((NimStringDesc*) &TMP2505)));
		}
		LA5: ;
	}
	LA3: ;
			...
			{
				{
					...
					HEX3Atmp_186055 = 0;
					nimln(643, "os.nim");
					TMP2506 = subInt((pd ? pd->Sup.len : 0), ((NI) 2));
					HEX3Atmp_186055 = (NI)(TMP2506);
					...
					res_186057 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(645, "os.nim");
							{
								...
								LOC60 = (i_186053 == ((NI) 0));
								if (LOC60) goto LA61;
								TMP2507 = subInt(i_186053, ((NI) 1));
								if ((NU)((NI)(TMP2507)) > (NU)(pd->Sup.len)) raiseIndexError();
								LOC60 = !((((NU8)(pd->data[(NI)(TMP2507)])) == ((NU8)(47)) || ((NU8)(pd->data[(NI)(TMP2507)])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
							...
							TMP2508 = addInt(res_186057, ((NI) 1));
							res_186057 = (NI)(TMP2508);
						} LA55: ;
					}
				}
				nimln(649, "os.nim");
