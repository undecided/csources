			...
			current_153888 = copyString(path);
			{
				...
				while (1) {
					...
					parents = (NI)(TMP697);
					{
						...
						HEX3Atmp_153855 = HEX2F_119292(d_153831, ((NimStringDesc*) &TMP698));
						...
						nimln(1241, "os.nim");
						{
							if (!(res_153861 == ((NI) 0))) goto LA18;
							{
								...
								HEX3Atmp_153865 = 0;
								nimln(1242, "os.nim");
								TMP699 = subInt(f_153859.gl_pathc, ((NI) 1));
								HEX3Atmp_153865 = (NI)(TMP699);
								...
								res_153867 = ((NI) 0);
								{
									...
									while (1) {
										...
										TMP701 = addInt(res_153867, ((NI) 1));
										res_153867 = (NI)(TMP701);
									} LA22: ;
								}
							}
						}
					...
					}
					{
						...
						HEX3Atmp_153871 = HEX2F_119292(d_153831, ((NimStringDesc*) &TMP702));
						...
						nimln(1241, "os.nim");
						{
							if (!(res_153877 == ((NI) 0))) goto LA32;
							{
								...
								HEX3Atmp_153881 = 0;
								nimln(1242, "os.nim");
								TMP703 = subInt(f_153875.gl_pathc, ((NI) 1));
								HEX3Atmp_153881 = (NI)(TMP703);
								nimln(1598, "system.nim");
								res_153883 = ((NI) 0);
								{
									nimln(1599, "system.nim");
									while (1) {
										...
										goto LA1;
										nimln(1619, "system.nim");
										TMP704 = addInt(res_153883, ((NI) 1));
										res_153883 = (NI)(TMP704);
									} LA36: ;
								}
							}
						}
...
N_NIMCALL(void, libcandidates_154409)(NimStringDesc* s, TY13606** dest) {
	...
	ri = nsuFindChar(s, 41, ((NI)chckRange((NI)(TMP714), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(357, "options.nim");
	{
		...
		suffix = copyStr(s, (NI)(TMP716));
		{
			...
			HEX3Atmp_154431 = copyStrLast(s, (NI)(TMP717), (NI)(TMP718));
					...
					while (1) {
						...
						first_154437 = last_154435;
						{
							...
							while (1) {
								...
								LA21: ;
								if (!LOC20) goto LA19;
								TMP720 = addInt(last_154435, ((NI) 1));
								last_154435 = (NI)(TMP720);
							} LA19: ;
						}
						nimln(286, "strutils.nim");
						TMP721 = subInt(last_154435, ((NI) 1));
						middle_154419 = copyStrLast(HEX3Atmp_154431, first_154437, (NI)(TMP721));
...
appendString(LOC22, suffix);
						...
						TMP722 = addInt(last_154435, ((NI) 1));
						last_154435 = (NI)(TMP722);
					} LA17: ;
				}
			}
			LA14: ;
...
N_NIMCALL(void, incldynliboverride_154472)(NimStringDesc* lib) {
	...
	nstPut(gdlloverrides_153232, LOC1, ((NimStringDesc*) &TMP726));
	popFrame();
}
...
static TNimNode* TMP2600[22];
NI TMP2602;
static char* NIM_CONST TMP2601[22] = {
"optNone", 
"optObjCheck", 
"optFieldCheck", 
"optRangeCheck", 
...
"optImplicitStatic", 
"optPatterns"};
static TNimNode* TMP3966[30];
NI TMP3968;
static char* NIM_CONST TMP3967[30] = {
"gloptNone", 
"optForceFullMake", 
"optDeadCodeElim", 
"optListCmd", 
...
"optIdeDebug", 
"optIdeTerse"};
static TNimNode* TMP3984[20];
NI TMP3986;
static char* NIM_CONST TMP3985[20] = {
"cmdNone", 
"cmdCompileToC", 
"cmdCompileToCpp", 
"cmdCompileToOC", 
...
NTI153014.base = 0;
NTI153014.flags = 3;
for (TMP2602 = 0; TMP2602 < 22; TMP2602++) {
TMP461[TMP2602+0].kind = 1;
TMP461[TMP2602+0].offset = TMP2602;
TMP461[TMP2602+0].name = TMP2601[TMP2602];
TMP2600[TMP2602] = &TMP461[TMP2602+0];
}
TMP461[22].len = 22; TMP461[22].kind = 2; TMP461[22].sons = &TMP2600[0];
...
NTI153018.base = 0;
NTI153018.flags = 3;
for (TMP3968 = 0; TMP3968 < 30; TMP3968++) {
TMP461[TMP3968+24].kind = 1;
TMP461[TMP3968+24].offset = TMP3968;
TMP461[TMP3968+24].name = TMP3967[TMP3968];
TMP3966[TMP3968] = &TMP461[TMP3968+24];
}
TMP461[54].len = 30; TMP461[54].kind = 2; TMP461[54].sons = &TMP3966[0];
NTI153018.node = &TMP461[54];
NTI153022.size = sizeof(NU8);
NTI153022.kind = 14;
NTI153022.base = 0;
NTI153022.flags = 3;
for (TMP3986 = 0; TMP3986 < 20; TMP3986++) {
TMP461[TMP3986+55].kind = 1;
TMP461[TMP3986+55].offset = TMP3986;
TMP461[TMP3986+55].name = TMP3985[TMP3986];
TMP3984[TMP3986] = &TMP461[TMP3986+55];
}
TMP461[75].len = 20; TMP461[75].kind = 2; TMP461[75].sons = &TMP3984[0];
