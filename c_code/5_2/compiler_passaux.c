...
STRING_LITERAL(TMP10582, "logpass: context is not nil", 27);
...
static NIM_CONST TY191031 TMP10587 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP10588, "sym", 3);
...
N_NIMCALL(Tnode190813*, verboseprocess_505023)(Tpasscontext241005* context, Tnode190813* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		internalerror_164218(((NimStringDesc*) &TMP10582));
	}
	LA3: ;
...
{	result = 0;
	...
	{
		{
			...
			res_505137 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP10586 = addInt(res_505137, ((NI) 1));
					res_505137 = (NI)(TMP10586);
				} LA11: ;
			}
		}
	}
	...
	case ((NU8) 80):
	{
		nimln(39, "passaux.nim");
		{
			...
			if (((TMP10584[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10585));
			if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP10587[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP10588));
			...
			nimln(41, "passaux.nim");
			{
				...
				if (((TMP10584[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP10585));
