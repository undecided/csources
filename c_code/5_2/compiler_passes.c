...
static NIM_CONST TY192031 TMP4114 = {
...
N_NIMCALL(void, registerpass_242190)(Tpass242017* p) {
	...
	nimln(97, "passes.nim");
	TMP4116 = addInt(gpasseslen_242176, ((NI) 1));
	gpasseslen_242176 = (NI)(TMP4116);
	popFrame();
}
	...
	nimfr("openPasses", "passes.nim")
	{
		...
		res_242322 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4119 = addInt(res_242322, ((NI) 1));
				res_242322 = (NI)(TMP4119);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("openPassesCached", "passes.nim")
	{
		...
		res_242384 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA4: ;
				nimln(1614, "system.nim");
				TMP4121 = addInt(res_242384, ((NI) 1));
				res_242384 = (NI)(TMP4121);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = NIM_NIL;
	{
		...
		res_242434 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4123 = addInt(res_242434, ((NI) 1));
				res_242434 = (NI)(TMP4123);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = n;
	{
		...
		res_242493 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4125 = addInt(res_242493, ((NI) 1));
				res_242493 = (NI)(TMP4125);
			} LA3: ;
		}
	}
	...
	m = n;
	{
		...
		res_242543 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4127 = addInt(res_242543, ((NI) 1));
				res_242543 = (NI)(TMP4127);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = NIM_NIL;
	{
		...
		res_242600 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4129 = addInt(res_242600, ((NI) 1));
				res_242600 = (NI)(TMP4129);
			} LA3: ;
		}
	}
	popFrame();
		...
		n = loadinitsection_234077(rd);
		{
			...
			res_242779 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4135 = addInt(res_242779, ((NI) 1));
					res_242779 = (NI)(TMP4135);
				} LA45: ;
			}
		}
...
NTI242005.flags = 1;
TMP4030[0].kind = 1;
TMP4030[0].offset = offsetof(Tpasscontext242005, fromcache);
TMP4030[0].typ = (&NTI138);
TMP4030[0].name = "fromCache";
NTI242005.node = &TMP4030[0];
...
TMP6328[0] = &TMP4030[2];
TMP4030[2].kind = 1;
TMP4030[2].offset = offsetof(Tpassdata242019, Field0);
TMP4030[2].typ = (&NTI191805);
TMP4030[2].name = "Field0";
TMP6328[1] = &TMP4030[3];
TMP4030[3].kind = 1;
TMP4030[3].offset = offsetof(Tpassdata242019, Field1);
TMP4030[3].typ = (&NTI191805);
TMP4030[3].name = "Field1";
TMP4030[1].len = 2; TMP4030[1].kind = 2; TMP4030[1].sons = &TMP6328[0];
NTI242019.node = &TMP4030[1];
}
