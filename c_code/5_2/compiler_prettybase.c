...
STRING_LITERAL(TMP4270, ".nimfix", 7);
STRING_LITERAL(TMP4272, "\015\012", 2);
STRING_LITERAL(TMP4273, "\012", 1);
...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP4290, "discard ", 8);
STRING_LITERAL(TMP4292, "\"", 1);
...
N_NIMCALL(void, loadfile_249041)(Tlineinfo163338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		TMP4269 = addInt(i, ((NI32) 1));
		if (TMP4269 < (-2147483647 -1) || TMP4269 > 2147483647) raiseOverflow();
		gsourcefiles_249036 = (TY249019*) setLengthSeq(&(gsourcefiles_249036)->Sup, sizeof(Tsourcefile249008), ((NI)chckRange((NI32)(TMP4269), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	}
	LA3: ;
	nimln(27, "prettybase.nim");
	{
		...
		gsourcefiles_249036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP4270));
		{
		...
		pos = lex.bufpos;
		{
			...
			while (1) {
				...
				case 13:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
					LOC21 = 0;
					LOC21 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4272));
				...
				case 0:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
					LOC23 = 0;
					LOC23 = gsourcefiles_249036->data[i].newline; gsourcefiles_249036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4273));
...
N_NIMCALL(NI, identlen_249147)(NimStringDesc* line, NI start) {
	...
	result = 0;
	{
		...
		while (1) {
			...
			NI TMP4277;
			LOC3 = 0;
			TMP4275 = addInt(start, result);
			LOC3 = ((NI)(TMP4275) < (line ? line->Sup.len : 0));
			if (!(LOC3)) goto LA4;
			TMP4276 = addInt(start, result);
			if ((NU)((NI)(TMP4276)) > (NU)(line->Sup.len)) raiseIndexError();
			LOC3 = (((NU8)(line->data[(NI)(TMP4276)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4276)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4276)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4276)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4276)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4276)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4276)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4276)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4276)])) == ((NU8)(95)));
			LA4: ;
			if (!LOC3) goto LA2;
			nimln(57, "prettybase.nim");
			TMP4277 = addInt(result, ((NI) 1));
			result = (NI)(TMP4277);
		} LA2: ;
	}
	popFrame();
...
{	nimln(64, "prettybase.nim");
	...
	if ((NU)((NI16)(TMP4278)) >= (NU)(gsourcefiles_249036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(TMP4278)];
	...
	LA3: ;
	{
		...
		while (1) {
			...
			LOC7 = (((NU8)(line->data[(NI)(TMP4279)])) >= ((NU8)(97)) && ((NU8)(line->data[(NI)(TMP4279)])) <= ((NU8)(122)) || ((NU8)(line->data[(NI)(TMP4279)])) >= ((NU8)(65)) && ((NU8)(line->data[(NI)(TMP4279)])) <= ((NU8)(90)) || ((NU8)(line->data[(NI)(TMP4279)])) >= ((NU8)(48)) && ((NU8)(line->data[(NI)(TMP4279)])) <= ((NU8)(57)) || ((NU8)(line->data[(NI)(TMP4279)])) >= ((NU8)(128)) && ((NU8)(line->data[(NI)(TMP4279)])) <= ((NU8)(255)) || ((NU8)(line->data[(NI)(TMP4279)])) == ((NU8)(95)));
			LA8: ;
			if (!LOC7) goto LA6;
	...
	TMP4282 = addInt(first, LOC17);
	TMP4283 = subInt((NI)(TMP4282), ((NI) 1));
	last = (NI)(TMP4283);
	nimln(75, "prettybase.nim");
	{
		...
		LOC21 = 0;
		LOC21 = HEX5BHEX5D_86248(line, LOC20);
		LOC22 = 0;
		...
		LOC26 = 0;
		LOC26 = copyStrLast(line, ((NI) 0), (NI)(TMP4284));
		TMP4285 = addInt(last, ((NI) 1));
		LOC27 = 0;
		LOC27 = copyStr(line, (NI)(TMP4285));
...
appendString(LOC25, LOC27);
		...
		if ((NU)(info.fileindex) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
		TMP4286 = subInt(info.line, ((NI16) 1));
		if (TMP4286 < -32768 || TMP4286 > 32767) raiseOverflow();
		if ((NU)((NI16)(TMP4286)) >= (NU)(gsourcefiles_249036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
		asgnRefNoCycle((void**) (&gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(TMP4286)]), x);
...
N_NIMCALL(void, replacecomment_249286)(Tlineinfo163338 info) {
	...
	if ((NU)(info.fileindex) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
	TMP4287 = subInt(info.line, ((NI16) 1));
	if (TMP4287 < -32768 || TMP4287 > 32767) raiseOverflow();
	if ((NU)((NI16)(TMP4287)) >= (NU)(gsourcefiles_249036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(TMP4287)];
	...
	LOC5 = 0;
	TMP4289 = subInt(first, ((NI) 1));
	LOC6 = 0;
	LOC6 = copyStrLast(line, ((NI) 0), (NI)(TMP4289));
	TMP4291 = addInt(first, ((NI) 1));
	LOC7 = 0;
	LOC7 = copyStr(line, (NI)(TMP4291));
	LOC8 = 0;
	LOC8 = nsuEscape(LOC7, ((NimStringDesc*) &TMP4292), ((NimStringDesc*) &TMP4292));
	LOC5 = rawNewString(LOC6->Sup.len + LOC8->Sup.len + 8);
appendString(LOC5, LOC6);
appendString(LOC5, ((NimStringDesc*) &TMP4290));
appendString(LOC5, LOC8);
	x = LOC5;
	nimln(92, "prettybase.nim");
	if ((NU)(info.fileindex) >= (NU)(gsourcefiles_249036->Sup.len)) raiseIndexError();
	TMP4293 = subInt(info.line, ((NI16) 1));
	if (TMP4293 < -32768 || TMP4293 > 32767) raiseOverflow();
	if ((NU)((NI16)(TMP4293)) >= (NU)(gsourcefiles_249036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	asgnRefNoCycle((void**) (&gsourcefiles_249036->data[info.fileindex].lines->data[(NI16)(TMP4293)]), x);
...
static TNimNode* TMP4267[6];
static TNimNode TMP4223[7];
...
TMP4267[0] = &TMP4223[1];
TMP4223[1].kind = 1;
TMP4223[1].offset = offsetof(Tsourcefile249008, lines);
TMP4223[1].typ = (&NTI13606);
TMP4223[1].name = "lines";
TMP4267[1] = &TMP4223[2];
TMP4223[2].kind = 1;
TMP4223[2].offset = offsetof(Tsourcefile249008, dirty);
TMP4223[2].typ = (&NTI138);
TMP4223[2].name = "dirty";
TMP4267[2] = &TMP4223[3];
TMP4223[3].kind = 1;
TMP4223[3].offset = offsetof(Tsourcefile249008, isnimfixfile);
TMP4223[3].typ = (&NTI138);
TMP4223[3].name = "isNimfixFile";
TMP4267[3] = &TMP4223[4];
TMP4223[4].kind = 1;
TMP4223[4].offset = offsetof(Tsourcefile249008, fullpath);
TMP4223[4].typ = (&NTI149);
TMP4223[4].name = "fullpath";
TMP4267[4] = &TMP4223[5];
TMP4223[5].kind = 1;
TMP4223[5].offset = offsetof(Tsourcefile249008, newline);
TMP4223[5].typ = (&NTI149);
TMP4223[5].name = "newline";
TMP4267[5] = &TMP4223[6];
TMP4223[6].kind = 1;
TMP4223[6].offset = offsetof(Tsourcefile249008, fileidx);
TMP4223[6].typ = (&NTI114);
TMP4223[6].name = "fileIdx";
TMP4223[0].len = 6; TMP4223[0].kind = 2; TMP4223[0].sons = &TMP4267[0];
NTI249008.node = &TMP4223[0];
NTI249019.size = sizeof(TY249019*);
NTI249019.kind = 24;
NTI249019.base = (&NTI249008);
NTI249019.flags = 2;
NTI249019.marker = TMP4268;
}
