...
static NIM_CONST TY191031 TMP8002 = {
...
{	result = 0;
	...
	{
		{
			...
			res_402098 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7994 = subInt(field, i_402029);
					result = ithfield_402012((*n).kindU.S6.sons->data[i_402029], (NI)(TMP7994));
					...
					TMP7995 = addInt(res_402098, ((NI) 1));
					res_402098 = (NI)(TMP7995);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_164199((*n).info, ((NimStringDesc*) &TMP7996));
		}
		LA13: ;
		...
		result = ithfield_402012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7997));
			...
			res_402106 = ((NI) 1);
			{
				...
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_402012(LOC24, (NI)(TMP7999));
					...
					default:
					{
						...
						internalerror_164199((*n).info, ((NimStringDesc*) &TMP8000));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP8001 = addInt(res_402106, ((NI) 1));
					res_402106 = (NI)(TMP8001);
				} LA22: ;
			}
		}
	}
...
appendString(LOC14, LOC15);
						...
						TMP8005 = addInt(res_402313, ((NI) 1));
						res_402313 = (NI)(TMP8005);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP8006 = addInt(res_402321, ((NI) 1));
						res_402321 = (NI)(TMP8006);
					} LA23: ;
				}
			}
		}
	...
	case ((NU8) 41):
	{
				...
				m_402253 = 0;
				{
					...
					res_402333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8008 = addInt(res_402333, ((NI) 1));
							res_402333 = (NI)(TMP8008);
						} LA47: ;
					}
				}
			}
		...
		LA41: ;
		{
			...
			globalerror_164145((*n).info, ((NimStringDesc*) &TMP8009));
		}
		LA39: ;
	}
	break;
	case ((NU8) 39):
	{
				...
				m_402265 = 0;
				{
					...
					res_402344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8010 = addInt(res_402344, ((NI) 1));
							res_402344 = (NI)(TMP8010);
						} LA59: ;
					}
				}
			}
		...
		LA53: ;
		{
			...
			globalerror_164145((*n).info, ((NimStringDesc*) &TMP8011));
		}
		LA51: ;
	}
	break;
