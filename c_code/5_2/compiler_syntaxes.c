...
NIM_CONST TY218020 parsernames_218019 = {((NimStringDesc*) &TMP3401),
...
N_NIMCALL(Tnode190813*, parseall_218063)(Tparsers218035* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_164218(((NimStringDesc*) &TMP3413));
...
{	result = 0;
	{
		...
		res_218429 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP3420 = addInt(res_218429, ((NI) 1));
				res_218429 = (NI)(TMP3420);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_218629 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP3421 = addInt(res_218629, ((NI) 1));
				res_218629 = (NI)(TMP3421);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3424[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3425));
		LOC7 = identeq_166484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP3426));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_218772;
			...
			res_218798 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA16: ;
					nimln(1614, "system.nim");
					TMP3427 = addInt(res_218798, ((NI) 1));
					res_218798 = (NI)(TMP3427);
				} LA15: ;
			}
		}
	}
...
NTI218007.node = &TMP2930[6];
TMP2930[1].kind = 1;
TMP2930[1].offset = offsetof(Tparsers218035, skin);
TMP2930[1].typ = (&NTI218007);
TMP2930[1].name = "skin";
TMP3409[1] = &TMP2930[7];
TMP2930[7].kind = 1;
TMP2930[7].offset = offsetof(Tparsers218035, parser);
TMP2930[7].typ = (&NTI206205);
TMP2930[7].name = "parser";
TMP2930[0].len = 2; TMP2930[0].kind = 2; TMP2930[0].sons = &TMP3409[0];
NTI218035.node = &TMP2930[0];
}
