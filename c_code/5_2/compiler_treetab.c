	...
	{
		{
			...
			res_243093 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4157 = addInt(res_243093, ((NI) 1));
					res_243093 = (NI)(TMP4157);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_243192 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4159 = addInt(res_243192, ((NI) 1));
							res_243192 = (NI)(TMP4159);
						} LA28: ;
					}
				}
