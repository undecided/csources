...
STRING_LITERAL(TMP6617, "", 0);
static NIM_CONST TY191031 TMP6618 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6619, "sons", 4);
static NIM_CONST TY191031 TMP6621 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6622, "ident", 5);
STRING_LITERAL(TMP6623, "*", 1);
static NIM_CONST TY191031 TMP6624 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6625, "sym", 3);
STRING_LITERAL(TMP6626, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP6627, "not isNil(result) ", 18);
STRING_LITERAL(TMP6628, "len(n) == 1 ", 12);
STRING_LITERAL(TMP6629, "ref.", 4);
STRING_LITERAL(TMP6630, "ptr.", 4);
STRING_LITERAL(TMP6631, "1 < len(n) ", 11);
STRING_LITERAL(TMP6632, "params.kind == nkFormalParams ", 30);
STRING_LITERAL(TMP6633, "0 < len(params) ", 16);
STRING_LITERAL(TMP6634, "proc(", 5);
STRING_LITERAL(TMP6636, "3 <= len(n) ", 12);
STRING_LITERAL(TMP6638, "[](n, i).kind == nkIdent ", 25);
STRING_LITERAL(TMP6640, "tuple[", 6);
STRING_LITERAL(TMP6642, "2 <= len(n) ", 12);
STRING_LITERAL(TMP6646, "0 < typePos ", 12);
STRING_LITERAL(TMP6649, "[](n, i).kind == nkIdent or [](n, i).kind == nkAccQuoted ", 57);
STRING_LITERAL(TMP6651, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	...
	{
		{
			...
			res_337205 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP6620 = addInt(res_337205, ((NI) 1));
					res_337205 = (NI)(TMP6620);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 2):
	{
		nimln(28, "typesrenderer.nim");
		{
			...
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP6623)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP6626));
appendString(LOC24, reprEnum((*n).kind, (&NTI190029)));
	...
	nimln(38, "typesrenderer.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP6627));
	}
	LA27: ;
	}BeforeRet: ;
	popFrame();
...
appendString(LOC16, ((NimStringDesc*) &TMP6629));
...
appendString(LOC25, ((NimStringDesc*) &TMP6630));
appendString(LOC25, LOC27);
	...
	case ((NU8) 147):
	{
		...
		result = copyString(((NimStringDesc*) &TMP6634));
		{
			NI i_338419;
			NI HEX3Atmp_339202;
			NI LOC44;
...
appendString(result, LOC47);
					nimln(1619, "system.nim");
					TMP6635 = addInt(res_339205, ((NI) 1));
					res_339205 = (NI)(TMP6635);
				} LA46: ;
			}
		}
...
appendString(result, LOC66);
					nimln(1619, "system.nim");
					TMP6639 = addInt(res_339213, ((NI) 1));
					res_339213 = (NI)(TMP6639);
				} LA60: ;
			}
		}
	}
...
appendString(result, LOC72);
					nimln(1619, "system.nim");
					TMP6641 = addInt(res_339221, ((NI) 1));
					res_339221 = (NI)(TMP6641);
				} LA71: ;
			}
		}
	...
	case ((NU8) 42):
	{
		...
		nimln(75, "typesrenderer.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP6642));
		}
		LA79: ;
...
appendString(result, LOC88);
					nimln(1619, "system.nim");
					TMP6643 = addInt(res_339229, ((NI) 1));
					res_339229 = (NI)(TMP6643);
				} LA87: ;
			}
		}
...
{	nimln(89, "typesrenderer.nim");
	...
	{
		{
			...
			res_339622 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6644 = addInt(res_339622, ((NI) 1));
					res_339622 = (NI)(TMP6644);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 35):
	{
		...
		nimln(97, "typesrenderer.nim");
		{
			...
			if (!(LOC16)) goto LA17;
			TMP6647 = addInt(typepos, ((NI) 1));
			LOC18 = 0;
			LOC18 = HEX5BHEX5D_191244(n, (NI)(TMP6647));
			...
			LOC21 = 0;
			LOC21 = HEX5BHEX5D_191244(n, (NI)(TMP6648));
			typ = (*LOC21).typ;
		...
		LA19: ;
		{
			...
			res_339630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6650 = addInt(res_339630, ((NI) 1));
					res_339630 = (NI)(TMP6650);
				} LA32: ;
			}
		}
	}
...
appendString(LOC43, ((NimStringDesc*) &TMP6651));
