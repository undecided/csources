...
static NIM_CONST TY192031 TMP7509 = {
...
appendString(result, ((NimStringDesc*) &TMP7482));
	...
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7483), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
		...
		res_381133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP7486), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7487 = addInt(res_381133, ((NI) 1));
				res_381133 = (NI)(TMP7487);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP7495), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP7496), t, info);
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		{
			...
			res_381246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7498 = addInt(res_381246, ((NI) 1));
					res_381246 = (NI)(TMP7498);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP7508), t, info);
	...
	case ((NU8) 50):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7533), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 58):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7540), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP7541), t, info);
