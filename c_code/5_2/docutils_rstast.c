...
43}
;
STRING_LITERAL(TMP5019, "\012", 1);
STRING_LITERAL(TMP5021, "", 0);
STRING_LITERAL(TMP5023, "\012\012", 2);
STRING_LITERAL(TMP5026, "* ", 2);
STRING_LITERAL(TMP5029, "(#) ", 4);
STRING_LITERAL(TMP5032, "  ", 2);
STRING_LITERAL(TMP5039, "| ", 2);
STRING_LITERAL(TMP5042, "`", 1);
STRING_LITERAL(TMP5043, "`_", 2);
STRING_LITERAL(TMP5044, " <", 2);
STRING_LITERAL(TMP5045, ">`_", 3);
STRING_LITERAL(TMP5046, "`:", 2);
STRING_LITERAL(TMP5047, "`:sub:", 6);
STRING_LITERAL(TMP5048, "`:sup:", 6);
STRING_LITERAL(TMP5049, "`:idx:", 6);
STRING_LITERAL(TMP5050, "*", 1);
STRING_LITERAL(TMP5051, "**", 2);
STRING_LITERAL(TMP5052, "***", 3);
STRING_LITERAL(TMP5054, "``", 2);
STRING_LITERAL(TMP5056, "\\", 1);
STRING_LITERAL(TMP5057, "\\\\", 2);
STRING_LITERAL(TMP5058, ".. index::\012", 11);
STRING_LITERAL(TMP5061, ".. contents::", 13);
STRING_LITERAL(TMP5062, "Error: cannot render: ", 22);
STRING_LITERAL(TMP5065, "kind", 4);
STRING_LITERAL(TMP5066, "level", 5);
STRING_LITERAL(TMP5067, "text", 4);
STRING_LITERAL(TMP5069, "sons", 4);
...
N_NIMCALL(Trstnode296011*, lastson_296147)(Trstnode296011* n) {
	...
	result = 0;
	nimln(87, "rstast.nim");
	TMP5016 = subInt(((*n).sons ? (*n).sons->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP5016)) >= (NU)((*n).sons->Sup.len)) raiseIndexError();
	result = (*n).sons->data[(NI)(TMP5016)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_296224)(Trendercontext296208* d, Trstnode296011* n, NimStringDesc** result) {
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		LOC2 = 0;
		LOC2 = len_296084(n);
		TMP5017 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_296245 = (NI)(TMP5017);
		...
		res_296248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5018 = addInt(res_296248, ((NI) 1));
				res_296248 = (NI)(TMP5018);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		TMP5020 = subInt(((*result) ? (*result)->Sup.len : 0), oldlen);
		headlinelen = (NI)(TMP5020);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP5021));
		nimln(134, "rstast.nim");
		renderrstsons_296224(d, n, (&headline));
		nimln(136, "rstast.nim");
		if ((NU)((*n).level) > (NU)(8)) raiseIndexError();
		TMP5022 = subInt((headline ? headline->Sup.len : 0), (*d).indent);
		lvl = nsuRepeatChar(lvltochar_296274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5022), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
		...
		TMP5024 = subInt(((NI) 78), (*d).indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5024), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP5021));
...
appendString((*result), ((NimStringDesc*) &TMP5032));
	...
	case ((NU8) 14):
	{
		...
		TMP5034 = addInt((tmp ? tmp->Sup.len : 0), ((NI) 3));
		L = (((NI)(TMP5034) >= ((NI) 30)) ? (NI)(TMP5034) : ((NI) 30));
		nimln(193, "rstast.nim");
		TMP5035 = addInt((*d).indent, L);
		(*d).indent = (NI)(TMP5035);
...
appendString((*result), tmp);
		...
		TMP5036 = subInt(L, (tmp ? tmp->Sup.len : 0));
		TMP5037 = subInt((NI)(TMP5036), ((NI) 2));
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5037), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ((NimStringDesc*) &TMP5039));
	...
	case ((NU8) 28):
	{
		...
		TMP5040 = addInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5040);
		nimln(211, "rstast.nim");
		renderrstsons_296224(d, n, result);
		nimln(212, "rstast.nim");
		TMP5041 = subInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5041);
	}
	break;
	case ((NU8) 39):
...
appendString((*result), ((NimStringDesc*) &TMP5052));
	...
	case ((NU8) 61):
	{
		...
		TMP5053 = addInt((*d).verbatim, ((NI) 1));
...
appendString((*result), ((NimStringDesc*) &TMP5054));
		...
		TMP5055 = subInt((*d).verbatim, ((NI) 1));
		(*d).verbatim = (NI)(TMP5055);
	}
	break;
	case ((NU8) 63):
	{
...
appendString((*result), (*n).text);
	...
	case ((NU8) 64):
	{
		nimln(266, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			LOC48 = eqStrings((*n).text, ((NimStringDesc*) &TMP5056));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP5062));
...
N_NIMCALL(Jsonnodeobj289726*, renderrsttojsonnode_296483)(Trstnode296011* node) {
	...
	LOC1[0].Field0 = copyString(((NimStringDesc*) &TMP5065));
	nimln(293, "rstast.nim");
	LOC1[0].Field1 = HEX25_290130(reprEnum((*node).kind, (&NTI296005)));
	LOC1[1].Field0 = copyString(((NimStringDesc*) &TMP5066));
	...
	nimln(296, "rstast.nim");
	{
		...
		add_292418(result, ((NimStringDesc*) &TMP5067), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_292418(result, ((NimStringDesc*) &TMP5069), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
static TNimNode* TMP5010[4];
static TNimNode* TMP5011[65];
NI TMP5013;
static char* NIM_CONST TMP5012[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI296005.base = 0;
NTI296005.flags = 3;
for (TMP5013 = 0; TMP5013 < 65; TMP5013++) {
TMP4809[TMP5013+2].kind = 1;
TMP4809[TMP5013+2].offset = TMP5013;
TMP4809[TMP5013+2].name = TMP5012[TMP5013];
TMP5011[TMP5013] = &TMP4809[TMP5013+2];
}
TMP4809[67].len = 65; TMP4809[67].kind = 2; TMP4809[67].sons = &TMP5011[0];
NTI296005.node = &TMP4809[67];
TMP4809[1].kind = 1;
TMP4809[1].offset = offsetof(Trstnode296011, kind);
TMP4809[1].typ = (&NTI296005);
TMP4809[1].name = "kind";
TMP5010[1] = &TMP4809[68];
TMP4809[68].kind = 1;
TMP4809[68].offset = offsetof(Trstnode296011, text);
TMP4809[68].typ = (&NTI149);
TMP4809[68].name = "text";
TMP5010[2] = &TMP4809[69];
TMP4809[69].kind = 1;
TMP4809[69].offset = offsetof(Trstnode296011, level);
TMP4809[69].typ = (&NTI108);
TMP4809[69].name = "level";
TMP5010[3] = &TMP4809[70];
NTI296009.size = sizeof(Trstnodeseq296009*);
NTI296009.kind = 24;
NTI296009.base = (&NTI296007);
NTI296009.flags = 2;
NTI296009.marker = TMP5014;
TMP4809[70].kind = 1;
TMP4809[70].offset = offsetof(Trstnode296011, sons);
TMP4809[70].typ = (&NTI296009);
TMP4809[70].name = "sons";
TMP4809[0].len = 4; TMP4809[0].kind = 2; TMP4809[0].sons = &TMP5010[0];
NTI296011.node = &TMP4809[0];
NTI296007.size = sizeof(Trstnode296011*);
NTI296007.kind = 22;
NTI296007.base = (&NTI296011);
NTI296007.flags = 2;
NTI296007.marker = TMP5015;
}
