...
43}
;
STRING_LITERAL(TMP5018, "\012", 1);
STRING_LITERAL(TMP5020, "", 0);
STRING_LITERAL(TMP5022, "\012\012", 2);
STRING_LITERAL(TMP5025, "* ", 2);
STRING_LITERAL(TMP5028, "(#) ", 4);
STRING_LITERAL(TMP5031, "  ", 2);
STRING_LITERAL(TMP5038, "| ", 2);
STRING_LITERAL(TMP5041, "`", 1);
STRING_LITERAL(TMP5042, "`_", 2);
STRING_LITERAL(TMP5043, " <", 2);
STRING_LITERAL(TMP5044, ">`_", 3);
STRING_LITERAL(TMP5045, "`:", 2);
STRING_LITERAL(TMP5046, "`:sub:", 6);
STRING_LITERAL(TMP5047, "`:sup:", 6);
STRING_LITERAL(TMP5048, "`:idx:", 6);
STRING_LITERAL(TMP5049, "*", 1);
STRING_LITERAL(TMP5050, "**", 2);
STRING_LITERAL(TMP5051, "***", 3);
STRING_LITERAL(TMP5053, "``", 2);
STRING_LITERAL(TMP5055, "\\", 1);
STRING_LITERAL(TMP5056, "\\\\", 2);
STRING_LITERAL(TMP5057, ".. index::\012", 11);
STRING_LITERAL(TMP5060, ".. contents::", 13);
STRING_LITERAL(TMP5061, "Error: cannot render: ", 22);
STRING_LITERAL(TMP5064, "kind", 4);
STRING_LITERAL(TMP5065, "level", 5);
...
N_NIMCALL(Trstnode296011*, lastson_296147)(Trstnode296011* n) {
	...
	result = 0;
	nimln(87, "rstast.nim");
	TMP5015 = subInt(((*n).sons ? (*n).sons->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP5015)) >= (NU)((*n).sons->Sup.len)) raiseIndexError();
	result = (*n).sons->data[(NI)(TMP5015)];
	popFrame();
	return result;
}
...
appendString((*result), ind);
		...
		lvl = nsuRepeatChar(lvltochar_296274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5021), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
		...
		TMP5023 = subInt(((NI) 78), (*d).indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5023), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), tmp);
		...
		TMP5035 = subInt(L, (tmp ? tmp->Sup.len : 0));
		TMP5036 = subInt((NI)(TMP5035), ((NI) 2));
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5036), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ((NimStringDesc*) &TMP5051));
	...
	case ((NU8) 61):
	{
		...
		TMP5052 = addInt((*d).verbatim, ((NI) 1));
...
appendString((*result), ((NimStringDesc*) &TMP5053));
		...
		TMP5054 = subInt((*d).verbatim, ((NI) 1));
...
appendString((*result), (*n).text);
	...
	case ((NU8) 64):
	{
		nimln(266, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			LOC48 = eqStrings((*n).text, ((NimStringDesc*) &TMP5055));
			LA49: ;
			if (!LOC48) goto LA50;
...
static TNimNode* TMP5009[4];
static TNimNode* TMP5010[65];
NI TMP5012;
static char* NIM_CONST TMP5011[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
TMP4808[TMP5012+2].name = TMP5011[TMP5012];
