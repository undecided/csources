...
typedef N_CLOSURE_PTR(NI, TMP5968) (Tindexentry312396* x_313751, Tindexentry312396* y_313753);
typedef struct {
...
typedef N_CLOSURE_PTR(NI, TMP6013) (NimStringDesc* x_315365, NimStringDesc* y_315367);
typedef struct {
N_NIMCALL_PTR(NI, ClPrc) (Tsym190843* x_351527, Tsym190843* y_351529, void* ClEnv);
void* ClEnv;
} TY351525;
typedef N_CLOSURE_PTR(NI, TMP6970) (Tsym190843* x_351582, Tsym190843* y_351584);
typedef N_CLOSURE_PTR(NI, TMP6973) (Tsym190843* x_351582, Tsym190843* y_351584);
struct  TNimObject  {
TNimType* m_type;
};
struct  Tidobj166015  {
...
static N_INLINE(NI, HEX2A_310020)(NI x, NU8 order) {
	...
	TMP5847 = subInt(((NI) (order)), ((NI) 1));
	y = (NI)(TMP5847);
	nimln(25, "algorithm.nim");
	TMP5848 = subInt((NI)(x ^ ((NI) (y))), ((NI) (y)));
	result = (NI)(TMP5848);
	popFrame();
	return result;
}
...
{	nimln(119, "algorithm.nim");
	{
		...
		TMP5963 = addInt(m, ((NI) 1));
		if ((NU)((NI)(TMP5963)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc((&a[m]), (&a[(NI)(TMP5963)]), cmp.ClEnv):((TMP5964)(cmp.ClPrc))((&a[m]), (&a[(NI)(TMP5963)]));
		LOC4 = 0;
	...
	{
		if (!!((j <= m))) goto LA9;
		failedassertimpl_87017(((NimStringDesc*) &TMP5965));
	}
	LA9: ;
	...
	k = lo;
	{
		...
		while (1) {
			...
			nimln(136, "algorithm.nim");
			{
				...
				if ((NU)(j) >= (NU)(aLen0)) raiseIndexError();
				LOC19 = 0;
				LOC19 = cmp.ClEnv? cmp.ClPrc((&b[i]), (&a[j]), cmp.ClEnv):((TMP5968)(cmp.ClPrc))((&b[i]), (&a[j]));
				LOC20 = 0;
...
N_NIMCALL(void, sort_313687)(Tindexentry312396* a, NI aLen0, TY313694 cmp, NU8 order) {
	...
	TMP5958 = divInt(n, ((NI) 2));
	b = (TY312897*) newSeq((&NTI312897), ((NI)chckRange((NI)(TMP5958), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	s = ((NI) 1);
	{
		...
		while (1) {
			...
			TMP5961 = subInt(n, ((NI) 1));
			TMP5962 = subInt((NI)(TMP5961), s);
			m = (NI)(TMP5962);
			{
				...
				while (1) {
					...
					TMP5974 = subInt(m, s);
					TMP5975 = addInt((NI)(TMP5974), ((NI) 1));
					TMP5976 = addInt(m, s);
					merge_313732(a, aLen0, b->data, b->Sup.len, (((NI)(TMP5975) >= ((NI) 0)) ? (NI)(TMP5975) : ((NI) 0)), m, (NI)(TMP5976), cmp, order);
					nimln(188, "algorithm.nim");
					TMP5977 = mulInt(s, ((NI) 2));
					TMP5978 = subInt(m, (NI)(TMP5977));
					m = (NI)(TMP5978);
				} LA4: ;
			}
...
{	nimln(119, "algorithm.nim");
	{
		...
		NI LOC4;
		if ((NU)(m) >= (NU)(aLen0)) raiseIndexError();
		TMP6009 = addInt(m, ((NI) 1));
		if ((NU)((NI)(TMP6009)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(TMP6009)], cmp.ClEnv):((TMP6010)(cmp.ClPrc))(a[m], a[(NI)(TMP6009)]);
		LOC4 = 0;
		LOC4 = HEX2A_310020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k = lo;
	{
		...
		while (1) {
			...
			nimln(136, "algorithm.nim");
			{
				...
				if ((NU)(j) >= (NU)(aLen0)) raiseIndexError();
				LOC19 = 0;
				LOC19 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP6013)(cmp.ClPrc))(b[i], a[j]);
				LOC20 = 0;
				LOC20 = HEX2A_310020(LOC19, order);
				if (!(LOC20 <= ((NI) 0))) goto LA21;
				nimln(112, "algorithm.nim");
...
N_NIMCALL(void, sort_315301)(NimStringDesc** a, NI aLen0, TY315308 cmp, NU8 order) {
	...
	b = 0;
	nimln(182, "algorithm.nim");
	TMP6006 = divInt(n, ((NI) 2));
	b = (TY13606*) newSeq((&NTI13606), ((NI)chckRange((NI)(TMP6006), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(183, "algorithm.nim");
	s = ((NI) 1);
	{
		nimln(184, "algorithm.nim");
		while (1) {
			...
			if (!(s < n)) goto LA2;
			nimln(185, "algorithm.nim");
			TMP6007 = subInt(n, ((NI) 1));
			TMP6008 = subInt((NI)(TMP6007), s);
			m = (NI)(TMP6008);
			{
				nimln(186, "algorithm.nim");
				while (1) {
					...
					nimln(187, "algorithm.nim");
					TMP6019 = subInt(m, s);
					TMP6020 = addInt((NI)(TMP6019), ((NI) 1));
					TMP6021 = addInt(m, s);
					merge_315346(a, aLen0, b->data, b->Sup.len, (((NI)(TMP6020) >= ((NI) 0)) ? (NI)(TMP6020) : ((NI) 0)), m, (NI)(TMP6021), cmp, order);
					nimln(188, "algorithm.nim");
					TMP6022 = mulInt(s, ((NI) 2));
					TMP6023 = subInt(m, (NI)(TMP6022));
					m = (NI)(TMP6023);
				} LA4: ;
			}
			nimln(189, "algorithm.nim");
...
{	nimln(119, "algorithm.nim");
	{
		...
		NI LOC4;
		if ((NU)(m) >= (NU)(aLen0)) raiseIndexError();
		TMP6969 = addInt(m, ((NI) 1));
		if ((NU)((NI)(TMP6969)) >= (NU)(aLen0)) raiseIndexError();
		LOC3 = 0;
		LOC3 = cmp.ClEnv? cmp.ClPrc(a[m], a[(NI)(TMP6969)], cmp.ClEnv):((TMP6970)(cmp.ClPrc))(a[m], a[(NI)(TMP6969)]);
		LOC4 = 0;
		LOC4 = HEX2A_310020(LOC3, order);
		if (!(LOC4 <= ((NI) 0))) goto LA5;
		goto BeforeRet;
	...
	k = lo;
	{
		...
		while (1) {
			...
			nimln(136, "algorithm.nim");
			{
				...
				if ((NU)(j) >= (NU)(aLen0)) raiseIndexError();
				LOC19 = 0;
				LOC19 = cmp.ClEnv? cmp.ClPrc(b[i], a[j], cmp.ClEnv):((TMP6973)(cmp.ClPrc))(b[i], a[j]);
				LOC20 = 0;
				LOC20 = HEX2A_310020(LOC19, order);
				if (!(LOC20 <= ((NI) 0))) goto LA21;
				nimln(112, "algorithm.nim");
...
N_NIMCALL(void, sort_351518)(Tsym190843** a, NI aLen0, TY351525 cmp, NU8 order) {
	...
	b = 0;
	nimln(182, "algorithm.nim");
	TMP6966 = divInt(n, ((NI) 2));
	b = (Tsymseq190815*) newSeq((&NTI190815), ((NI)chckRange((NI)(TMP6966), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(183, "algorithm.nim");
	s = ((NI) 1);
	{
		nimln(184, "algorithm.nim");
		while (1) {
			...
			if (!(s < n)) goto LA2;
			nimln(185, "algorithm.nim");
			TMP6967 = subInt(n, ((NI) 1));
			TMP6968 = subInt((NI)(TMP6967), s);
			m = (NI)(TMP6968);
			{
				nimln(186, "algorithm.nim");
				while (1) {
					...
					nimln(187, "algorithm.nim");
					TMP6979 = subInt(m, s);
					TMP6980 = addInt((NI)(TMP6979), ((NI) 1));
					TMP6981 = addInt(m, s);
					merge_351563(a, aLen0, b->data, b->Sup.len, (((NI)(TMP6980) >= ((NI) 0)) ? (NI)(TMP6980) : ((NI) 0)), m, (NI)(TMP6981), cmp, order);
					nimln(188, "algorithm.nim");
					TMP6982 = mulInt(s, ((NI) 2));
					TMP6983 = subInt(m, (NI)(TMP6982));
					m = (NI)(TMP6983);
				} LA4: ;
			}
			nimln(189, "algorithm.nim");
