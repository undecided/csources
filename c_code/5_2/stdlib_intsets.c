...
N_NIMCALL(void, intsetenlarge_188614)(Intset188056* t) {
	...
	n = (Ttrunkseq188054*) newSeq((&NTI188054), ((NI)chckRange((NI)(TMP2529), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_188642;
		NI res_188670;
		i_188642 = 0;
		...
		res_188670 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP2533 = addInt(res_188670, ((NI) 1));
				res_188670 = (NI)(TMP2533);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(85, "intsets.nim");
	{
		...
		LOC9 = 0;
		LOC9 = mustrehash_188073((NI)(TMP2534), (*t).counter);
		if (!LOC9) goto LA10;
...
TMP2530[0] = &TMP2516[1];
TMP2516[1].kind = 1;
TMP2516[1].offset = offsetof(Ttrunk188052, next);
TMP2516[1].typ = (&NTI188050);
TMP2516[1].name = "next";
TMP2530[1] = &TMP2516[2];
TMP2516[2].kind = 1;
TMP2516[2].offset = offsetof(Ttrunk188052, key);
TMP2516[2].typ = (&NTI108);
TMP2516[2].name = "key";
TMP2530[2] = &TMP2516[3];
TMP2516[3].kind = 1;
TMP2516[3].offset = offsetof(Ttrunk188052, bits);
TMP2516[3].typ = (&NTI27820);
TMP2516[3].name = "bits";
TMP2516[0].len = 3; TMP2516[0].kind = 2; TMP2516[0].sons = &TMP2530[0];
NTI188052.node = &TMP2516[0];
NTI188050.size = sizeof(Ttrunk188052*);
NTI188050.kind = 22;
NTI188050.base = (&NTI188052);
NTI188050.marker = TMP2531;
NTI188054.size = sizeof(Ttrunkseq188054*);
NTI188054.kind = 24;
NTI188054.base = (&NTI188050);
NTI188054.flags = 2;
NTI188054.marker = TMP2532;
...
TMP4205[0] = &TMP2516[5];
TMP2516[5].kind = 1;
TMP2516[5].offset = offsetof(Intset188056, counter);
TMP2516[5].typ = (&NTI108);
TMP2516[5].name = "counter";
TMP4205[1] = &TMP2516[6];
TMP2516[6].kind = 1;
TMP2516[6].offset = offsetof(Intset188056, max);
TMP2516[6].typ = (&NTI108);
TMP2516[6].name = "max";
TMP4205[2] = &TMP2516[7];
TMP2516[7].kind = 1;
TMP2516[7].offset = offsetof(Intset188056, head);
TMP2516[7].typ = (&NTI188050);
TMP2516[7].name = "head";
TMP4205[3] = &TMP2516[8];
TMP2516[8].kind = 1;
TMP2516[8].offset = offsetof(Intset188056, data);
TMP2516[8].typ = (&NTI188054);
TMP2516[8].name = "data";
TMP2516[4].len = 4; TMP2516[4].kind = 2; TMP2516[4].sons = &TMP4205[0];
NTI188056.node = &TMP2516[4];
}
