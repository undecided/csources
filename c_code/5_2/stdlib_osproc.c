...
N_NIMCALL(void, createfdset_146604)(fd_set* fd, TY144201* s, NI* m);
N_NIMCALL(void, pruneprocessset_146844)(TY144201** s, fd_set* fd);
N_NIMCALL(TGenericSeq*, setLengthSeq)(TGenericSeq* seq, NI elemsize, NI newlen);
N_NIMCALL(NI, select_144608)(TY144201** readfds, NI timeout);
N_NIMCALL(void, execcmdex_147005)(NimStringDesc* command, NU8 options, TY147011* Result);
...
NIM_CONST TY147011 TMP651 = {((NimStringDesc*) &TMP607),
((NI) -1)}
;
...
{	result = 0;
	nimln(906, "osproc.nim");
	{
		...
		createstream_146443(&(*p).errstream, (&(*p).errhandle), ((NU8) 0));
	}
	LA3: ;
...
N_NIMCALL(void, createfdset_146604)(fd_set* fd, TY144201* s, NI* m) {
	...
	FD_ZERO(fd);
	{
		...
		L_146831 = (s ? s->Sup.len : 0);
		{
			nimln(3086, "system.nim");
			while (1) {
				NI TMP643;
				if (!(i_146829 < L_146831)) goto LA3;
				nimln(3087, "system.nim");
				if ((NU)(i_146829) >= (NU)(s->Sup.len)) raiseIndexError();
				i_146811 = s->data[i_146829];
				nimln(922, "osproc.nim");
				(*m) = (((*m) >= ((NI) ((*i_146811).outhandle))) ? (*m) : ((NI) ((*i_146811).outhandle)));
				nimln(923, "osproc.nim");
				FD_SET((*i_146811).outhandle, fd);
				nimln(3088, "system.nim");
				TMP643 = addInt(i_146829, ((NI) 1));
				i_146829 = (NI)(TMP643);
				nimln(3089, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L_146831))) goto LA6;
...
N_NIMCALL(NI, select_144608)(TY144201** readfds, NI timeout) {
	...
	createfdset_146604((&rd), (*readfds), (&m));
	...
	pruneprocessset_146844(readfds, (&rd));
	popFrame();
	return result;
}
