...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77659 TMP1850 = {
...
N_NIMCALL(void, initoptparser_174030)(NimStringDesc* cmdline, Optparser174011* Result) {
	...
	LA3: ;
	{
		...
		unsureAsgnRef((void**) (&(*Result).cmd), copyString(((NimStringDesc*) &TMP1833)));
		{
			NI i_174046;
			NI HEX3Atmp_174049;
			NI res_174052;
...
appendChar(LOC9, 32);
					...
					TMP1836 = addInt(res_174052, ((NI) 1));
					res_174052 = (NI)(TMP1836);
				} LA8: ;
			}
		}
	}
...
N_NIMCALL(void, handleshortoption_174291)(Optparser174011* p) {
	...
	nimln(87, "parseopt.nim");
	{
		...
		i = parseword_174204((*p).cmd, i, (&(*p).val), TMP1846);
	}
	LA5: ;
...
{	nimln(98, "parseopt.nim");
	...
	case 45:
	{
		...
		nimln(111, "parseopt.nim");
		{
			...
			i = parseword_174204((*p).cmd, i, (&(*p).key), TMP1850);
			{
			...
			nimln(116, "parseopt.nim");
			{
				...
				(*p).pos = parseword_174204((*p).cmd, i, (&(*p).val), TMP1846);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p).pos = parseword_174204((*p).cmd, i, (&(*p).key), TMP1846);
	}
	break;
	}
	}BeforeRet: ;
...
N_NIMCALL(NimStringDesc*, npocmdLineRest)(Optparser174011* p) {
	...
	TMP1857 = subInt(((*p).cmd ? (*p).cmd->Sup.len : 0), ((NI) 1));
	LOC1 = 0;
	LOC1 = copyStrLast((*p).cmd, (*p).pos, (NI)(TMP1857));
...
static TNimNode* TMP10631[6];
static TNimNode* TMP10632[4];
NI TMP10634;
static char* NIM_CONST TMP10633[4] = {
"cmdEnd", 
"cmdArgument", 
"cmdLongOption", 
"cmdShortOption"};
static TNimNode TMP1831[12];
NTI174011.size = sizeof(Optparser174011);
NTI174011.kind = 17;
NTI174011.base = (&NTI3411);
TMP10631[0] = &TMP1831[1];
TMP1831[1].kind = 1;
TMP1831[1].offset = offsetof(Optparser174011, cmd);
TMP1831[1].typ = (&NTI149);
TMP1831[1].name = "cmd";
TMP10631[1] = &TMP1831[2];
TMP1831[2].kind = 1;
TMP1831[2].offset = offsetof(Optparser174011, pos);
TMP1831[2].typ = (&NTI108);
TMP1831[2].name = "pos";
TMP10631[2] = &TMP1831[3];
TMP1831[3].kind = 1;
TMP1831[3].offset = offsetof(Optparser174011, inshortstate);
TMP1831[3].typ = (&NTI138);
TMP1831[3].name = "inShortState";
TMP10631[3] = &TMP1831[4];
NTI174009.size = sizeof(NU8);
NTI174009.kind = 14;
NTI174009.base = 0;
NTI174009.flags = 3;
for (TMP10634 = 0; TMP10634 < 4; TMP10634++) {
TMP1831[TMP10634+5].kind = 1;
TMP1831[TMP10634+5].offset = TMP10634;
TMP1831[TMP10634+5].name = TMP10633[TMP10634];
TMP10632[TMP10634] = &TMP1831[TMP10634+5];
}
TMP1831[9].len = 4; TMP1831[9].kind = 2; TMP1831[9].sons = &TMP10632[0];
NTI174009.node = &TMP1831[9];
TMP1831[4].kind = 1;
TMP1831[4].offset = offsetof(Optparser174011, kind);
TMP1831[4].typ = (&NTI174009);
TMP1831[4].name = "kind";
TMP10631[4] = &TMP1831[10];
TMP1831[10].kind = 1;
TMP1831[10].offset = offsetof(Optparser174011, key);
TMP1831[10].typ = (&NTI149);
TMP1831[10].name = "key";
TMP10631[5] = &TMP1831[11];
TMP1831[11].kind = 1;
TMP1831[11].offset = offsetof(Optparser174011, val);
TMP1831[11].typ = (&NTI149);
TMP1831[11].name = "val";
TMP1831[0].len = 6; TMP1831[0].kind = 2; TMP1831[0].sons = &TMP10631[0];
NTI174011.node = &TMP1831[0];
}
