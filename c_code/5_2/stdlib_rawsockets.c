...
N_NIMCALL(void, getservbyname_511027)(NimStringDesc* name, NimStringDesc* proto, Servent509610* Result) {
	...
	nimln(246, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_511216).Sup.Sup.message; (*e_511216).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10614));
...
N_NIMCALL(void, getservbyport_511233)(NU16 port, NimStringDesc* proto, Servent509610* Result) {
	...
	nimln(262, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_511416).Sup.Sup.message; (*e_511416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10614));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		nimln(262, "rawsockets.nim");
...
N_NIMCALL(void, gethostbyaddr_511433)(NimStringDesc* ip, Hostent509612* Result) {
	...
	LA11: ;
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_511803).Sup.Sup.message; (*e_511803).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10615));
...
N_NIMCALL(void, gethostbyname_511824)(NimStringDesc* name, Hostent509612* Result) {
	...
	LA11: ;
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_512203).Sup.Sup.message; (*e_512203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10615));
		if (LOC14) nimGCunrefNoCycle(LOC14);
...
N_NIMCALL(struct timeval, timevalfrommilliseconds_512628)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		result.tv_usec = ((NI) (((NI32)chckRange((NI)(TMP10619), ((NI32) (-2147483647 -1)), ((NI32) 2147483647)))));
	}
	LA3: ;
	popFrame();
	return result;
	...
	FD_ZERO(fd);
	{
		...
		L_512830 = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP10620 = addInt(i_512828, ((NI) 1));
				i_512828 = (NI)(TMP10620);
...
N_NIMCALL(NI, select_512913)(TY512647** readfds, NI timeout) {
	...
	nimln(405, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI)(TMP10625), ((int) (-2147483647 -1)), ((int) 2147483647))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI)(TMP10626), ((int) (-2147483647 -1)), ((int) 2147483647))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_512970)(TY512647** writefds, NI timeout) {
	...
	nimln(427, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI)(TMP10627), ((int) (-2147483647 -1)), ((int) 2147483647))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI)(TMP10628), ((int) (-2147483647 -1)), ((int) 2147483647))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
