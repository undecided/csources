...
static N_INLINE(NI, rightsize_155407)(NI count) {
	...
	TMP740 = divInt(((NI) ((NI)(TMP739))), ((NI) 2));
	TMP741 = addInt(((NI) ((NI)(TMP740))), ((NI) 4));
	result = nextpoweroftwo_148531(((NI) ((NI)(TMP741))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_162672)(Table162376* t) {
	...
	n = (Keyvaluepairseq162379*) newSeq((&NTI162379), ((NI)chckRange((NI)(TMP1211), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, enlarge_312185)(Table311052* t) {
	...
	n = (Keyvaluepairseq311055*) newSeq((&NTI311055), ((NI)chckRange((NI)(TMP5912), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
...
N_NIMCALL(void, enlarge_315109)(Table312409* t) {
	...
	n = (Keyvaluepairseq312412*) newSeq((&NTI312412), ((NI)chckRange((NI)(TMP5999), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
...
N_NIMCALL(void, enlarge_382198)(Table381650* t) {
	...
	n = (Keyvaluepairseq381653*) newSeq((&NTI381653), ((NI)chckRange((NI)(TMP7586), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
