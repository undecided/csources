...
static NIM_CONST TY191031 TMP8896 = {
	...
	{
		{
			...
			res_454087 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8898 = addInt(res_454087, ((NI) 1));
					res_454087 = (NI)(TMP8898);
				} LA5: ;
			}
		} LA2: ;
	}
	...
	{
		{
			...
			res_454095 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP8899 = addInt(res_454095, ((NI) 1));
					res_454095 = (NI)(TMP8899);
				} LA15: ;
			}
		}
	}
		...
		b = IL64(0);
		{
			...
			res_454235 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP8901 = addInt(res_454235, ((NI) 1));
					res_454235 = (NI)(TMP8901);
				} LA7: ;
			}
		}
		...
		a = ((NI32) 0);
		{
			...
			res_454244 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP8903 = addInt(res_454244, ((NI) 1));
					res_454244 = (NI)(TMP8903);
				} LA11: ;
			}
		}
	...
	nimfr("initTypeTables", "ccgutils.nim")
	{
		...
		res_454430 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP8904 = addInt(res_454430, ((NI) 1));
				res_454430 = (NI)(TMP8904);
			} LA3: ;
		}
	}
	popFrame();
	...
	inittypetables_454285();
	{
		...
		res_454464 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP8905 = addInt(res_454464, ((NI) 1));
				res_454464 = (NI)(TMP8905);
			} LA3: ;
		}
	}
	popFrame();
	...
	LA5: ;
	{
		...
		res_454637 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA14: ;
				nimln(1614, "system.nim");
				TMP8906 = addInt(res_454637, ((NI) 1));
				res_454637 = (NI)(TMP8906);
			} LA9: ;
		}
	}
...
{	result = 0;
	...
	case ((NU8) 58):
	{
		...
		internalerror_164218(((NimStringDesc*) &TMP8907));
	}
	break;
	case ((NU8) 13):
	{
			...
			LA46: ;
			{
				...
				res_454785 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA55: ;
						nimln(1614, "system.nim");
						TMP8908 = addInt(res_454785, ((NI) 1));
						res_454785 = (NI)(TMP8908);
					} LA50: ;
				}
			}
		...
		if (!LOC4) goto LA6;
		{
			...
			res_454851 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA13: ;
					nimln(1614, "system.nim");
					TMP8909 = addInt(res_454851, ((NI) 1));
					res_454851 = (NI)(TMP8909);
				} LA10: ;
			}
		}
	}
...
appendString(result, LOC15);
				...
				nimln(1619, "system.nim");
				TMP8916 = addInt(res_454932, ((NI) 1));
				res_454932 = (NI)(TMP8916);
			} LA9: ;
		}
	}
	popFrame();
...
appendString(res, LOC10);
				...
				nimln(1614, "system.nim");
				TMP8921 = addInt(res_454985, ((NI) 1));
				res_454985 = (NI)(TMP8921);
			} LA3: ;
		}
	}
