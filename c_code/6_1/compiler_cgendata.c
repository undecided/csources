...
TMP8925[0] = &TMP8923[1];
TMP8923[1].kind = 1;
TMP8923[1].offset = offsetof(Tcgen456038, module);
TMP8923[1].typ = (&NTI190811);
TMP8923[1].name = "module";
TMP8925[1] = &TMP8923[2];
TMP8923[2].kind = 1;
TMP8923[2].offset = offsetof(Tcgen456038, filename);
...
NTI456022.flags = 2;
TMP8923[3].kind = 1;
TMP8923[3].offset = offsetof(Tcgen456038, s);
TMP8923[3].typ = (&NTI456022);
TMP8923[3].name = "s";
TMP8925[3] = &TMP8923[4];
TMP8923[4].kind = 1;
TMP8923[4].offset = offsetof(Tcgen456038, preventstacktrace);
TMP8923[4].typ = (&NTI138);
TMP8923[4].name = "preventStackTrace";
TMP8925[4] = &TMP8923[5];
TMP8923[5].kind = 1;
TMP8923[5].offset = offsetof(Tcgen456038, usesthreadvars);
TMP8923[5].typ = (&NTI138);
TMP8923[5].name = "usesThreadVars";
TMP8925[5] = &TMP8923[6];
TMP8923[6].kind = 1;
TMP8923[6].offset = offsetof(Tcgen456038, framedeclared);
TMP8923[6].typ = (&NTI138);
TMP8923[6].name = "frameDeclared";
TMP8925[6] = &TMP8923[7];
TMP8923[7].kind = 1;
TMP8923[7].offset = offsetof(Tcgen456038, isheaderfile);
TMP8923[7].typ = (&NTI138);
TMP8923[7].name = "isHeaderFile";
TMP8925[7] = &TMP8923[8];
TMP8923[8].kind = 1;
TMP8923[8].offset = offsetof(Tcgen456038, includesstringh);
TMP8923[8].typ = (&NTI138);
TMP8923[8].name = "includesStringh";
TMP8925[8] = &TMP8923[9];
TMP8923[9].kind = 1;
TMP8923[9].offset = offsetof(Tcgen456038, objhaskidsvalid);
TMP8923[9].typ = (&NTI138);
TMP8923[9].name = "objHasKidsValid";
TMP8925[9] = &TMP8923[10];
TMP8923[10].kind = 1;
TMP8923[10].offset = offsetof(Tcgen456038, cfilename);
TMP8923[10].typ = (&NTI149);
TMP8923[10].name = "cfilename";
TMP8925[10] = &TMP8923[11];
TMP8923[11].kind = 1;
TMP8923[11].offset = offsetof(Tcgen456038, typecache);
TMP8923[11].typ = (&NTI190861);
TMP8923[11].name = "typeCache";
TMP8925[11] = &TMP8923[12];
TMP8923[12].kind = 1;
TMP8923[12].offset = offsetof(Tcgen456038, forwtypecache);
TMP8923[12].typ = (&NTI190861);
TMP8923[12].name = "forwTypeCache";
TMP8925[12] = &TMP8923[13];
TMP8923[13].kind = 1;
TMP8923[13].offset = offsetof(Tcgen456038, declaredthings);
TMP8923[13].typ = (&NTI187056);
TMP8923[13].name = "declaredThings";
TMP8925[13] = &TMP8923[14];
TMP8923[14].kind = 1;
TMP8923[14].offset = offsetof(Tcgen456038, declaredprotos);
TMP8923[14].typ = (&NTI187056);
TMP8923[14].name = "declaredProtos";
TMP8925[14] = &TMP8923[15];
TMP8923[15].kind = 1;
TMP8923[15].offset = offsetof(Tcgen456038, headerfiles);
TMP8923[15].typ = (&NTI130028);
TMP8923[15].name = "headerFiles";
TMP8925[15] = &TMP8923[16];
TMP8923[16].kind = 1;
TMP8923[16].offset = offsetof(Tcgen456038, typeinfomarker);
TMP8923[16].typ = (&NTI187056);
...
TMP8923[19].kind = 1;
TMP8923[19].offset = offsetof(Tcproc456034, prc);
TMP8923[19].typ = (&NTI190811);
TMP8923[19].name = "prc";
TMP8926[1] = &TMP8923[20];
TMP8923[20].kind = 1;
TMP8923[20].offset = offsetof(Tcproc456034, beforeretneeded);
TMP8923[20].typ = (&NTI138);
TMP8923[20].name = "beforeRetNeeded";
TMP8926[2] = &TMP8923[21];
TMP8923[21].kind = 1;
TMP8923[21].offset = offsetof(Tcproc456034, threadvaraccessed);
TMP8923[21].typ = (&NTI138);
TMP8923[21].name = "threadVarAccessed";
TMP8926[3] = &TMP8923[22];
TMP8923[22].kind = 1;
TMP8923[22].offset = offsetof(Tcproc456034, lastlineinfo);
TMP8923[22].typ = (&NTI162338);
TMP8923[22].name = "lastLineInfo";
TMP8926[4] = &TMP8923[23];
TMP8923[23].kind = 1;
TMP8923[23].offset = offsetof(Tcproc456034, nestedtrystmts);
TMP8923[23].typ = (&NTI190807);
TMP8923[23].name = "nestedTryStmts";
TMP8926[5] = &TMP8923[24];
TMP8923[24].kind = 1;
TMP8923[24].offset = offsetof(Tcproc456034, inexceptblock);
TMP8923[24].typ = (&NTI108);
TMP8923[24].name = "inExceptBlock";
TMP8926[6] = &TMP8923[25];
TMP8923[25].kind = 1;
TMP8923[25].offset = offsetof(Tcproc456034, finallysafepoints);
TMP8923[25].typ = (&NTI160599);
TMP8923[25].name = "finallySafePoints";
TMP8926[7] = &TMP8923[26];
TMP8923[26].kind = 1;
TMP8923[26].offset = offsetof(Tcproc456034, labels);
...
TMP8923[29].kind = 1;
TMP8923[29].offset = offsetof(Tblock456032, id);
TMP8923[29].typ = (&NTI108);
TMP8923[29].name = "id";
TMP8927[1] = &TMP8923[30];
TMP8923[30].kind = 1;
TMP8923[30].offset = offsetof(Tblock456032, label);
TMP8923[30].typ = (&NTI160007);
...
NTI456026.flags = 2;
TMP8923[31].kind = 1;
TMP8923[31].offset = offsetof(Tblock456032, sections);
TMP8923[31].typ = (&NTI456026);
TMP8923[31].name = "sections";
TMP8927[3] = &TMP8923[32];
TMP8923[32].kind = 1;
TMP8923[32].offset = offsetof(Tblock456032, isloop);
TMP8923[32].typ = (&NTI138);
TMP8923[32].name = "isLoop";
TMP8927[4] = &TMP8923[33];
TMP8923[33].kind = 1;
TMP8923[33].offset = offsetof(Tblock456032, nestedtrystmts);
TMP8923[33].typ = (&NTI112);
TMP8923[33].name = "nestedTryStmts";
TMP8927[5] = &TMP8923[34];
TMP8923[34].kind = 1;
TMP8923[34].offset = offsetof(Tblock456032, nestedexceptstmts);
TMP8923[34].typ = (&NTI112);
TMP8923[34].name = "nestedExceptStmts";
TMP8927[6] = &TMP8923[35];
TMP8923[35].kind = 1;
TMP8923[35].offset = offsetof(Tblock456032, framelen);
TMP8923[35].typ = (&NTI112);
TMP8923[35].name = "frameLen";
TMP8923[28].len = 7; TMP8923[28].kind = 2; TMP8923[28].sons = &TMP8927[0];
NTI456032.node = &TMP8923[28];
NTI456106.size = sizeof(TY456106*);
NTI456106.kind = 24;
NTI456106.base = (&NTI456032);
NTI456106.flags = 2;
NTI456106.marker = TMP8928;
TMP8923[27].kind = 1;
TMP8923[27].offset = offsetof(Tcproc456034, blocks);
TMP8923[27].typ = (&NTI456106);
TMP8923[27].name = "blocks";
TMP8926[9] = &TMP8923[36];
TMP8923[36].kind = 1;
TMP8923[36].offset = offsetof(Tcproc456034, breakidx);
TMP8923[36].typ = (&NTI108);
TMP8923[36].name = "breakIdx";
TMP8926[10] = &TMP8923[37];
TMP8923[37].kind = 1;
TMP8923[37].offset = offsetof(Tcproc456034, options);
TMP8923[37].typ = (&NTI153121);
TMP8923[37].name = "options";
TMP8926[11] = &TMP8923[38];
TMP8923[38].kind = 1;
TMP8923[38].offset = offsetof(Tcproc456034, maxframelen);
TMP8923[38].typ = (&NTI108);
TMP8923[38].name = "maxFrameLen";
TMP8926[12] = &TMP8923[39];
TMP8923[39].kind = 1;
TMP8923[39].offset = offsetof(Tcproc456034, module);
TMP8923[39].typ = (&NTI456028);
TMP8923[39].name = "module";
TMP8926[13] = &TMP8923[40];
TMP8923[40].kind = 1;
TMP8923[40].offset = offsetof(Tcproc456034, withinloop);
TMP8923[40].typ = (&NTI108);
TMP8923[40].name = "withinLoop";
TMP8926[14] = &TMP8923[41];
TMP8923[41].kind = 1;
TMP8923[41].offset = offsetof(Tcproc456034, splitdecls);
TMP8923[41].typ = (&NTI108);
TMP8923[41].name = "splitDecls";
TMP8926[15] = &TMP8923[42];
TMP8923[42].kind = 1;
TMP8923[42].offset = offsetof(Tcproc456034, gcframeid);
TMP8923[42].typ = (&NTI3407);
TMP8923[42].name = "gcFrameId";
TMP8926[16] = &TMP8923[43];
TMP8923[43].kind = 1;
TMP8923[43].offset = offsetof(Tcproc456034, gcframetype);
TMP8923[43].typ = (&NTI160007);
TMP8923[43].name = "gcFrameType";
TMP8923[18].len = 17; TMP8923[18].kind = 2; TMP8923[18].sons = &TMP8926[0];
NTI456034.node = &TMP8923[18];
NTI456030.size = sizeof(Tcproc456034*);
NTI456030.kind = 22;
NTI456030.base = (&NTI456034);
NTI456030.marker = TMP8929;
TMP8923[17].kind = 1;
TMP8923[17].offset = offsetof(Tcgen456038, initproc);
TMP8923[17].typ = (&NTI456030);
TMP8923[17].name = "initProc";
TMP8925[17] = &TMP8923[44];
TMP8923[44].kind = 1;
TMP8923[44].offset = offsetof(Tcgen456038, postinitproc);
TMP8923[44].typ = (&NTI456030);
TMP8923[44].name = "postInitProc";
TMP8925[18] = &TMP8923[45];
TMP8923[45].kind = 1;
TMP8923[45].offset = offsetof(Tcgen456038, preinitproc);
TMP8923[45].typ = (&NTI456030);
TMP8923[45].name = "preInitProc";
TMP8925[19] = &TMP8923[46];
TMP8923[46].kind = 1;
TMP8923[46].offset = offsetof(Tcgen456038, typestack);
TMP8923[46].typ = (&NTI190845);
TMP8923[46].name = "typeStack";
TMP8925[20] = &TMP8923[47];
TMP8923[47].kind = 1;
TMP8923[47].offset = offsetof(Tcgen456038, datacache);
TMP8923[47].typ = (&NTI190873);
TMP8923[47].name = "dataCache";
TMP8925[21] = &TMP8923[48];
TMP8923[48].kind = 1;
TMP8923[48].offset = offsetof(Tcgen456038, forwardedprocs);
TMP8923[48].typ = (&NTI190815);
TMP8923[48].name = "forwardedProcs";
TMP8925[22] = &TMP8923[49];
TMP8923[49].kind = 1;
TMP8923[49].offset = offsetof(Tcgen456038, typenodes);
TMP8923[49].typ = (&NTI108);
TMP8923[49].name = "typeNodes";
TMP8925[23] = &TMP8923[50];
TMP8923[50].kind = 1;
TMP8923[50].offset = offsetof(Tcgen456038, nimtypes);
TMP8923[50].typ = (&NTI108);
TMP8923[50].name = "nimTypes";
TMP8925[24] = &TMP8923[51];
TMP8923[51].kind = 1;
TMP8923[51].offset = offsetof(Tcgen456038, typenodesname);
TMP8923[51].typ = (&NTI160007);
TMP8923[51].name = "typeNodesName";
TMP8925[25] = &TMP8923[52];
TMP8923[52].kind = 1;
TMP8923[52].offset = offsetof(Tcgen456038, nimtypesname);
TMP8923[52].typ = (&NTI160007);
TMP8923[52].name = "nimTypesName";
TMP8925[26] = &TMP8923[53];
TMP8923[53].kind = 1;
TMP8923[53].offset = offsetof(Tcgen456038, labels);
