...
static NIM_CONST TY191031 TMP4059 = {
...
N_NIMCALL(Tsym190843*, getsyssym_238054)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_238019).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4033));
	LOC1 = 0;
	...
	initstrtable_194007((&compilerprocs_238064));
	{
		...
		res_238627 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4057 = addInt(res_238627, ((NI) 1));
				res_238627 = (NI)(TMP4057);
			} LA3: ;
		}
	}
	{
		...
		res_238633 = ((NI) -5);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP4058 = addInt(res_238633, ((NI) 1));
				res_238633 = (NI)(TMP4058);
			} LA6: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, setintlittype_238774)(Tnode190813* result) {
	...
	default:
	{
		...
		internalerror_164199((*result).info, ((NimStringDesc*) &TMP4061));
	}
	break;
	}
	popFrame();
