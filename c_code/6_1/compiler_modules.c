	...
	nimfr("resetAllModules", "modules.nim")
	{
		...
		res_522380 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP10689 = addInt(res_522380, ((NI) 1));
				res_522380 = (NI)(TMP10689);
			} LA3: ;
		}
	}
...
N_NIMCALL(Tsym190843*, newmodule_522646)(NI32 fileidx) {
	...
	LA14: ;
	{
		...
		gcompiledmodules_522053 = (Tsymseq190815*) setLengthSeq(&(gcompiledmodules_522053)->Sup, sizeof(Tsym190843*), ((NI)chckRange((NI32)(TMP10694), ((NI) 0), ((NI) 2147483647))));
	}
	LA18: ;
...
N_NIMCALL(void, wantmainmodule_522922)(void) {
	...
	nimln(188, "modules.nim");
	{
		...
		fatal_164123(gcmdlineinfo_162922, ((NU16) 186), ((NimStringDesc*) &TMP10702));
	}
	LA3: ;
...
N_NIMCALL(Tsym190843*, makestdinmodule_522999)(void) {
	...
	nimln(207, "modules.nim");
	{
		...
		LOC5 = 0;
		LOC5 = fileinfoidx_162854(((NimStringDesc*) &TMP10704));
