				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							NU8 k_172217;
							LOC15 = 0;
							LOC15 = !(eqStrings(y_172213, ((NimStringDesc*) &TMP1813)));
							if (!(LOC15)) goto LA16;
							...
							nimln(1305, "os.nim");
							{
								...
								nimln(1307, "os.nim");
								{
									...
									TMP1815 = addInt(k_172217, ((NI) 1));
									if (TMP1815 < 0 || TMP1815 > 3) raiseOverflow();
									k_172217 = (NU8)(TMP1815);
								}
								LA29: ;
								nimln(1302, "os.nim");
								...
								nimln(69, "nimblecmd.nim");
								{
									...
									if (!(LOC33)) goto LA34;
									LOC33 = nsuEndsWith(path_172195, ((NimStringDesc*) &TMP1820));
									LA34: ;
									if (!LOC33) goto LA35;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC49) goto LA50;
								TMP1821 = addInt(k_172217, ((NI) 1));
								if (TMP1821 < 0 || TMP1821 > 3) raiseOverflow();
								k_172217 = (NU8)(TMP1821);
							}
							LA50: ;
							nimln(1302, "os.nim");
							kind_172194 = k_172217;
							...
							nimln(69, "nimblecmd.nim");
							{
								...
								if (!(LOC54)) goto LA55;
								LOC54 = nsuEndsWith(path_172195, ((NimStringDesc*) &TMP1820));
								LA55: ;
								if (!LOC54) goto LA56;
								nimln(70, "nimblecmd.nim");
								result = NIM_TRUE;
					...
					while (1) {
						{
							...
							nimln(1299, "os.nim");
							{
								...
								NU8 k_172232;
								LOC21 = 0;
								LOC21 = !(eqStrings(y_172228, ((NimStringDesc*) &TMP1813)));
								if (!(LOC21)) goto LA22;
								...
								nimln(1305, "os.nim");
								{
									...
									nimln(1307, "os.nim");
									{
										...
										TMP1822 = addInt(k_172232, ((NI) 1));
										if (TMP1822 < 0 || TMP1822 > 3) raiseOverflow();
										k_172232 = (NU8)(TMP1822);
									}
									LA35: ;
									nimln(1302, "os.nim");
...
N_NIMCALL(void, addpathrec_172266)(NimStringDesc* dir, Tlineinfo162338 info) {
	...
	TMP1824 = subInt((dir ? dir->Sup.len : 0), ((NI) 1));
	pos = (NI)(TMP1824);
				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							NU8 k_172316;
							LOC19 = 0;
							LOC19 = !(eqStrings(y_172312, ((NimStringDesc*) &TMP1813)));
							if (!(LOC19)) goto LA20;
							...
							nimln(1305, "os.nim");
							{
								...
								nimln(1307, "os.nim");
								{
									...
									TMP1826 = addInt(k_172316, ((NI) 1));
									if (TMP1826 < 0 || TMP1826 > 3) raiseOverflow();
									k_172316 = (NU8)(TMP1826);
								}
								LA33: ;
								nimln(1302, "os.nim");
								k_172292 = k_172316;
				...
				res_172330 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(44, "strtabs.nim");
						{
							...
							{
								if (!eqStrings(val_172324, ((NimStringDesc*) &TMP1806))) goto LA74;
...
appendString(LOC77, val_172324);
						...
						TMP1828 = addInt(res_172330, ((NI) 1));
						res_172330 = (NI)(TMP1828);
					} LA67: ;
				}
			}
		}
