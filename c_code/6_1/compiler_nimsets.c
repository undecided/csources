...
N_NIMCALL(Tnode191813*, totreeset_241353)(Tbitset240012* s, Ttype191849* settype, Tlineinfo163338 info);
...
static NIM_CONST TY192031 TMP4083 = {
...
{	result = 0;
	nimln(34, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4081));
			...
			while (1) {
				...
				nimln(38, "nimsets.nim");
				{
					...
					nimln(39, "nimsets.nim");
					{
						...
						if (((TMP4083[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
						if ((NU)(i_241121) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4083[(*(*s).kindU.S6.sons->data[i_241121]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241121]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
				...
				TMP4085 = addInt(res_241141, ((NI) 1));
				res_241141 = (NI)(TMP4085);
			} LA8: ;
		}
	}
...
{	result = 0;
	nimln(63, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4086));
			...
			while (1) {
				...
				nimln(67, "nimsets.nim");
				{
					...
					nimln(68, "nimsets.nim");
					{
						...
						if (((TMP4083[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
						if ((NU)(i_241233) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP4083[(*(*s).kindU.S6.sons->data[i_241233]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241233]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
				...
				LA9: ;
				nimln(1614, "system.nim");
				TMP4088 = addInt(res_241258, ((NI) 1));
				res_241258 = (NI)(TMP4088);
			} LA8: ;
		}
	}
...
N_NIMCALL(void, tobitset_241004)(Tnode191813* s, Tbitset240012** b) {
	...
	bitsetinit_240021(b, ((NI)chckRange64(LOC1, ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	{
		NI i_241296;
		NI HEX3Atmp_241325;
		NI LOC3;
		...
		res_241328 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(82, "nimsets.nim");
				{
					...
					if (((TMP4083[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					if ((NU)(i_241296) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4083[(*(*s).kindU.S6.sons->data[i_241296]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241296]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					...
					j = getordvalue_221178((*(*s).kindU.S6.sons->data[i_241296]).kindU.S6.sons->data[((NI) 0)]);
					{
						...
						while (1) {
							...
							bitsetincl_240061(b, (NI64)(TMP4090));
				...
				LA8: ;
				{
					...
					bitsetincl_240061(b, (NI64)(TMP4092));
				}
				LA6: ;
				nimln(1614, "system.nim");
				TMP4093 = addInt(res_241328, ((NI) 1));
				res_241328 = (NI)(TMP4093);
			} LA5: ;
		}
	}
	popFrame();
		...
		while (1) {
			...
			nimln(102, "nimsets.nim");
			{
				...
				nimln(109, "nimsets.nim");
				{
					...
					LOC21 = 0;
					LOC21 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4098), elemtype);
				...
				LA19: ;
				{
					...
					LOC23 = 0;
					LOC23 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4099), elemtype);
					addson_193819(n, LOC23);
					nimln(115, "nimsets.nim");
					TMP4100 = addInt64(b, first);
					LOC24 = 0;
					LOC24 = newinttypenode_192620(((NU8) 6), (NI64)(TMP4100), elemtype);
	...
	tobitset_241004(a, (&x));
	{
		...
		res_241573 = ((NI) 0);
		{
			...
			while (1) {
				...
				i_241567 = res_241573;
				nimln(147, "nimsets.nim");
				if ((NU)(i_241567) >= (NU)(x->Sup.len)) raiseIndexError();
				if ((NU)(i_241567) >= (NU)(x->Sup.len)) raiseIndexError();
				x->data[i_241567] = (NI8)((NU8) ~(x->data[i_241567]));
				nimln(1614, "system.nim");
				TMP4102 = addInt(res_241573, ((NI) 1));
				res_241573 = (NI)(TMP4102);
			} LA3: ;
		}
	}
		...
		res_241636 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(155, "nimsets.nim");
				{
					...
					NI64 TMP4106;
					if (((TMP4083[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					if ((NU)(i_241608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					...
					if (((TMP4083[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					if ((NU)(i_241608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4083[(*(*s).kindU.S6.sons->data[i_241608]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241608]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					if ((NU)(((NI) 1)) >= (NU)((*(*s).kindU.S6.sons->data[i_241608]).kindU.S6.sons->Sup.len)) raiseIndexError();
					LOC9 = 0;
					...
					if ((NU)(i_241608) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (((TMP4083[(*(*s).kindU.S6.sons->data[i_241608]).kind/8] &(1<<((*(*s).kindU.S6.sons->data[i_241608]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					if ((NU)(((NI) 0)) >= (NU)((*(*s).kindU.S6.sons->data[i_241608]).kindU.S6.sons->Sup.len)) raiseIndexError();
					LOC10 = 0;
				...
				LA5: ;
				nimln(1614, "system.nim");
				TMP4108 = addInt(res_241636, ((NI) 1));
				res_241636 = (NI)(TMP4108);
			} LA4: ;
		}
	}
	popFrame();
...
{	result = 0;
	nimln(162, "nimsets.nim");
	{
		...
		internalerror_165199((*s).info, ((NimStringDesc*) &TMP4109));
	...
	LA3: ;
	{
		...
		res_241695 = ((NI) 0);
		{
			...
			while (1) {
				NI TMP4111;
				if (!(res_241695 <= HEX3Atmp_241692)) goto LA8;
				nimln(1600, "system.nim");
				i_241680 = res_241695;
				nimln(166, "nimsets.nim");
				{
					if (((TMP4083[(*s).kind/8] &(1<<((*s).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4084));
					if ((NU)(i_241680) >= (NU)((*s).kindU.S6.sons->Sup.len)) raiseIndexError();
					if (!((*(*s).kindU.S6.sons->data[i_241680]).kind == ((NU8) 44))) goto LA11;
				...
				LA11: ;
				nimln(1614, "system.nim");
				TMP4111 = addInt(res_241695, ((NI) 1));
				res_241695 = (NI)(TMP4111);
			} LA8: ;
		}
	}
