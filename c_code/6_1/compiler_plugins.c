...
TMP8085[0] = &TMP8083[1];
TMP8083[1].kind = 1;
TMP8083[1].offset = offsetof(PluginHEX3Aobjecttype407019, fn);
TMP8083[1].typ = (&NTI167019);
TMP8083[1].name = "fn";
TMP8085[1] = &TMP8083[2];
TMP8083[2].kind = 1;
TMP8083[2].offset = offsetof(PluginHEX3Aobjecttype407019, module);
TMP8083[2].typ = (&NTI167019);
TMP8083[2].name = "module";
TMP8085[2] = &TMP8083[3];
TMP8083[3].kind = 1;
TMP8083[3].offset = offsetof(PluginHEX3Aobjecttype407019, package);
TMP8083[3].typ = (&NTI167019);
...
NTI407013.flags = 3;
TMP8083[4].kind = 1;
TMP8083[4].offset = offsetof(PluginHEX3Aobjecttype407019, t);
TMP8083[4].typ = (&NTI407013);
TMP8083[4].name = "t";
TMP8085[4] = &TMP8083[5];
TMP8083[5].kind = 1;
TMP8083[5].offset = offsetof(PluginHEX3Aobjecttype407019, next);
TMP8083[5].typ = (&NTI407015);
TMP8083[5].name = "next";
TMP8083[0].len = 5; TMP8083[0].kind = 2; TMP8083[0].sons = &TMP8085[0];
NTI407019.node = &TMP8083[0];
NTI407015.size = sizeof(PluginHEX3Aobjecttype407019*);
NTI407015.kind = 22;
NTI407015.base = (&NTI407019);
NTI407015.marker = TMP8086;
}
