...
static NIM_CONST TY191031 TMP8001 = {
...
{	result = 0;
	...
	{
		{
			...
			res_402098 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7993 = subInt(field, i_402029);
					result = ithfield_402012((*n).kindU.S6.sons->data[i_402029], (NI)(TMP7993));
					...
					TMP7994 = addInt(res_402098, ((NI) 1));
					res_402098 = (NI)(TMP7994);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		...
		nimln(23, "semmacrosanity.nim");
		{
			...
			internalerror_164199((*n).info, ((NimStringDesc*) &TMP7995));
		}
		LA13: ;
		...
		result = ithfield_402012((*n).kindU.S6.sons->data[((NI) 0)], (NI)(TMP7996));
			...
			res_402106 = ((NI) 1);
			{
				...
				while (1) {
					...
					case ((NU8) 88):
					{
						...
						result = ithfield_402012(LOC24, (NI)(TMP7998));
					...
					default:
					{
						...
						internalerror_164199((*n).info, ((NimStringDesc*) &TMP7999));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP8000 = addInt(res_402106, ((NI) 1));
					res_402106 = (NI)(TMP8000);
				} LA22: ;
			}
		}
	}
...
appendString(LOC14, LOC15);
						...
						TMP8004 = addInt(res_402313, ((NI) 1));
						res_402313 = (NI)(TMP8004);
					} LA9: ;
				}
			}
		}
...
appendString(LOC29, LOC30);
						...
						LA24: ;
						nimln(1619, "system.nim");
						TMP8005 = addInt(res_402321, ((NI) 1));
						res_402321 = (NI)(TMP8005);
					} LA23: ;
				}
			}
		}
				...
				m_402253 = 0;
				{
					...
					res_402333 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8007 = addInt(res_402333, ((NI) 1));
							res_402333 = (NI)(TMP8007);
						} LA47: ;
					}
				}
			}
				...
				m_402265 = 0;
				{
					...
					res_402344 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(1619, "system.nim");
							TMP8009 = addInt(res_402344, ((NI) 1));
							res_402344 = (NI)(TMP8009);
						} LA59: ;
					}
				}
			}
