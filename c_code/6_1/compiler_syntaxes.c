...
NIM_CONST TY219020 parsernames_219019 = {((NimStringDesc*) &TMP3399),
...
N_NIMCALL(Tnode191813*, parseall_219063)(Tparsers219035* p) {
	...
	case ((NU8) 3):
	{
		...
		internalerror_165218(((NimStringDesc*) &TMP3411));
...
{	result = 0;
	{
		...
		res_219429 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP3418 = addInt(res_219429, ((NI) 1));
				res_219429 = (NI)(TMP3418);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_219629 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP3419 = addInt(res_219629, ((NI) 1));
				res_219629 = (NI)(TMP3419);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(151, "syntaxes.nim");
	{
		...
		if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP3422[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3423));
		LOC7 = identeq_167484((*(*n).kindU.S6.sons->data[((NI) 0)]).kindU.S5.ident, ((NimStringDesc*) &TMP3424));
		LA10: ;
		if (!LOC7) goto LA11;
		{
			NI i_219772;
			...
			res_219798 = ((NI) 1);
			{
				...
				while (1) {
					...
					LA16: ;
					nimln(1614, "system.nim");
					TMP3425 = addInt(res_219798, ((NI) 1));
					res_219798 = (NI)(TMP3425);
				} LA15: ;
			}
		}
	}
...
NTI219007.node = &TMP2928[6];
TMP2928[1].kind = 1;
TMP2928[1].offset = offsetof(Tparsers219035, skin);
TMP2928[1].typ = (&NTI219007);
TMP2928[1].name = "skin";
TMP3407[1] = &TMP2928[7];
TMP2928[7].kind = 1;
TMP2928[7].offset = offsetof(Tparsers219035, parser);
TMP2928[7].typ = (&NTI207205);
TMP2928[7].name = "parser";
TMP2928[0].len = 2; TMP2928[0].kind = 2; TMP2928[0].sons = &TMP3407[0];
NTI219035.node = &TMP2928[0];
}
