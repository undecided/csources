...
static NIM_CONST TY192031 TMP7507 = {
...
appendString(result, ((NimStringDesc*) &TMP7480));
	...
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7481), ((NI) 0), ((NI) 2147483647))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
		...
		res_381133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP7484), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7485 = addInt(res_381133, ((NI) 1));
				res_381133 = (NI)(TMP7485);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	{
		nimln(68, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7488), t, info);
	}
	break;
	case ((NU8) 5):
	{
		nimln(69, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7489), t, info);
	}
	break;
	case ((NU8) 6):
	{
	...
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP7493), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP7494), t, info);
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		{
			...
			res_381246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7496 = addInt(res_381246, ((NI) 1));
					res_381246 = (NI)(TMP7496);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 18):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7498), t, info);
	}
	break;
	case ((NU8) 19):
	{
		nimln(111, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7499), t, info);
	}
	break;
	case ((NU8) 21):
	{
		nimln(112, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7500), t, info);
	}
	break;
	case ((NU8) 22):
	{
	...
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP7506), t, info);
	...
	case ((NU8) 49):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7530), t, info);
	}
	break;
	case ((NU8) 50):
	{
	...
	case ((NU8) 58):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7538), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP7539), t, info);
