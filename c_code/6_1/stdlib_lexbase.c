...
TMP4269[0] = &TMP4223[1];
TMP4223[1].kind = 1;
TMP4223[1].offset = offsetof(Baselexer247024, bufpos);
TMP4223[1].typ = (&NTI108);
TMP4223[1].name = "bufpos";
TMP4269[1] = &TMP4223[2];
TMP4223[2].kind = 1;
TMP4223[2].offset = offsetof(Baselexer247024, buf);
TMP4223[2].typ = (&NTI151);
TMP4223[2].name = "buf";
TMP4269[2] = &TMP4223[3];
TMP4223[3].kind = 1;
TMP4223[3].offset = offsetof(Baselexer247024, buflen);
TMP4223[3].typ = (&NTI108);
TMP4223[3].name = "bufLen";
TMP4269[3] = &TMP4223[4];
TMP4223[4].kind = 1;
TMP4223[4].offset = offsetof(Baselexer247024, input);
TMP4223[4].typ = (&NTI138025);
TMP4223[4].name = "input";
TMP4269[4] = &TMP4223[5];
TMP4223[5].kind = 1;
TMP4223[5].offset = offsetof(Baselexer247024, linenumber);
TMP4223[5].typ = (&NTI108);
TMP4223[5].name = "lineNumber";
TMP4269[5] = &TMP4223[6];
TMP4223[6].kind = 1;
TMP4223[6].offset = offsetof(Baselexer247024, sentinel);
TMP4223[6].typ = (&NTI108);
TMP4223[6].name = "sentinel";
TMP4269[6] = &TMP4223[7];
TMP4223[7].kind = 1;
TMP4223[7].offset = offsetof(Baselexer247024, linestart);
TMP4223[7].typ = (&NTI108);
TMP4223[7].name = "lineStart";
TMP4269[7] = &TMP4223[8];
TMP4223[8].kind = 1;
TMP4223[8].offset = offsetof(Baselexer247024, fileopened);
TMP4223[8].typ = (&NTI138);
TMP4223[8].name = "fileOpened";
TMP4223[0].len = 8; TMP4223[0].kind = 2; TMP4223[0].sons = &TMP4269[0];
NTI247024.node = &TMP4223[0];
}
