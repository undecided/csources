...
N_NIMCALL(NI32, getsocketerror_514001)(Socketimpl513407* socket) {
	...
	nimln(258, "net.nim");
	{
		...
		LOC9 = 0;
		LOC9 = (*e_514008).Sup.Sup.message; (*e_514008).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10649));
...
{	nimln(879, "net.nim");
	...
	nimln(885, "net.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_518219).Sup.Sup.message; (*e_518219).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10650));
...
appendString(LOC26, ((NimStringDesc*) &TMP10660));
		...
		selret = select_516207(socket, (NI)(TMP10662));
		nimln(700, "net.nim");
		{
			NI32 LOC31;
...
{	nimln(794, "net.nim");
	...
	(*line) = setLengthStr((*line), ((NI) 0));
	{
		...
		while (1) {
			...
			nimln(799, "net.nim");
			LOC3 = 0;
			LOC3 = waitfor_516819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10663));
			nimln(800, "net.nim");
			...
			nimln(803, "net.nim");
			{
				...
				nimln(804, "net.nim");
				LOC20 = 0;
				LOC20 = waitfor_516819(socket, (&waited), timeout, ((NI) 1), ((NimStringDesc*) &TMP10663));
				nimln(805, "net.nim");
...
TMP10609[1].kind = 1;
TMP10609[1].offset = offsetof(Socketimpl513407, fd);
TMP10609[1].typ = (&NTI5811);
TMP10609[1].name = "fd";
TMP10637[1] = &TMP10609[2];
TMP10609[2].kind = 3;
TMP10609[2].offset = offsetof(Socketimpl513407, isbuffered);
TMP10609[2].typ = (&NTI138);
TMP10609[2].name = "isBuffered";
TMP10609[2].sons = &NimDT_513407_isbuffered[0];
TMP10609[2].len = 2;
