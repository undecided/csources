...
N_NIMCALL(void, getservbyname_510027)(NimStringDesc* name, NimStringDesc* proto, Servent508610* Result) {
	...
	nimln(246, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_510216).Sup.Sup.message; (*e_510216).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10612));
...
N_NIMCALL(void, getservbyport_510233)(NU16 port, NimStringDesc* proto, Servent508610* Result) {
	...
	nimln(262, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_510416).Sup.Sup.message; (*e_510416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10612));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		nimln(262, "rawsockets.nim");
...
N_NIMCALL(void, gethostbyaddr_510434)(NimStringDesc* ip, Hostent508612* Result) {
	...
	LA11: ;
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_510803).Sup.Sup.message; (*e_510803).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10613));
...
N_NIMCALL(void, gethostbyname_510824)(NimStringDesc* name, Hostent508612* Result) {
	...
	LA11: ;
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_511203).Sup.Sup.message; (*e_511203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10613));
		if (LOC14) nimGCunrefNoCycle(LOC14);
	...
	FD_ZERO(fd);
	{
		...
		L_511830 = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP10618 = addInt(i_511828, ((NI) 1));
				i_511828 = (NI)(TMP10618);
