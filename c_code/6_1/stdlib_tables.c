...
static N_INLINE(NI, rightsize_155407)(NI count) {
	...
	TMP738 = divInt(((NI)chckRange((NI)(TMP737), ((NI) (-2147483647 -1)), ((NI) 2147483647))), ((NI) 2));
	TMP739 = addInt(((NI)chckRange((NI)(TMP738), ((NI) (-2147483647 -1)), ((NI) 2147483647))), ((NI) 4));
	result = nextpoweroftwo_148531(((NI)chckRange((NI)(TMP739), ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, enlarge_162672)(Table162376* t) {
	...
	n = (Keyvaluepairseq162379*) newSeq((&NTI162379), ((NI)chckRange((NI)(TMP1209), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, enlarge_382198)(Table381650* t) {
	...
	n = (Keyvaluepairseq381653*) newSeq((&NTI381653), ((NI)chckRange((NI)(TMP7584), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_382307 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7589 = addInt(res_382307, ((NI) 1));
				res_382307 = (NI)(TMP7589);
			} LA4: ;
		}
	}
	popFrame();
