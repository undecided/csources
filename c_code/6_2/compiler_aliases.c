...
{	result = 0;
	...
	{
		{
			...
			res_399241 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7914 = addInt(res_399241, ((NI) 1));
					res_399241 = (NI)(TMP7914);
				} LA5: ;
			}
		}
	}
			...
			res_399249 = ((NI) 1);
			{
				...
				while (1) {
					...
					default:
					{
						...
						internalerror_164218(((NimStringDesc*) &TMP7917));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7918 = addInt(res_399249, ((NI) 1));
					res_399249 = (NI)(TMP7918);
				} LA22: ;
			}
		}
	}
	...
	default:
	{
		...
		internalerror_164199((*n).info, ((NimStringDesc*) &TMP7921));
	}
	break;
	}
	}BeforeRet: ;
	...
	{
		{
			...
			res_399343 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA31: ;
					nimln(1614, "system.nim");
					TMP7923 = addInt(res_399343, ((NI) 1));
					res_399343 = (NI)(TMP7923);
				} LA28: ;
			}
		}
	}
