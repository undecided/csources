...
{	result = 0;
	...
	{
		{
			...
			res_399241 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7915 = addInt(res_399241, ((NI) 1));
					res_399241 = (NI)(TMP7915);
				} LA5: ;
			}
		}
	}
			...
			res_399249 = ((NI) 1);
			{
				...
				while (1) {
					...
					default:
					{
						...
						internalerror_164218(((NimStringDesc*) &TMP7918));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7919 = addInt(res_399249, ((NI) 1));
					res_399249 = (NI)(TMP7919);
				} LA22: ;
			}
		}
	}
	...
	default:
	{
		...
		internalerror_164199((*n).info, ((NimStringDesc*) &TMP7922));
	}
	break;
	}
	}BeforeRet: ;
	...
	{
		{
			...
			res_399343 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA31: ;
					nimln(1614, "system.nim");
					TMP7924 = addInt(res_399343, ((NI) 1));
					res_399343 = (NI)(TMP7924);
				} LA28: ;
			}
		}
	}
