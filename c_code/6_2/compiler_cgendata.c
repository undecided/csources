...
TMP8924[0] = &TMP8922[1];
TMP8922[1].kind = 1;
TMP8922[1].offset = offsetof(Tcgen456038, module);
TMP8922[1].typ = (&NTI190811);
TMP8922[1].name = "module";
TMP8924[1] = &TMP8922[2];
TMP8922[2].kind = 1;
TMP8922[2].offset = offsetof(Tcgen456038, filename);
...
NTI456022.flags = 2;
TMP8922[3].kind = 1;
TMP8922[3].offset = offsetof(Tcgen456038, s);
TMP8922[3].typ = (&NTI456022);
TMP8922[3].name = "s";
TMP8924[3] = &TMP8922[4];
TMP8922[4].kind = 1;
TMP8922[4].offset = offsetof(Tcgen456038, preventstacktrace);
TMP8922[4].typ = (&NTI138);
TMP8922[4].name = "preventStackTrace";
TMP8924[4] = &TMP8922[5];
TMP8922[5].kind = 1;
TMP8922[5].offset = offsetof(Tcgen456038, usesthreadvars);
TMP8922[5].typ = (&NTI138);
TMP8922[5].name = "usesThreadVars";
TMP8924[5] = &TMP8922[6];
TMP8922[6].kind = 1;
TMP8922[6].offset = offsetof(Tcgen456038, framedeclared);
TMP8922[6].typ = (&NTI138);
TMP8922[6].name = "frameDeclared";
TMP8924[6] = &TMP8922[7];
TMP8922[7].kind = 1;
TMP8922[7].offset = offsetof(Tcgen456038, isheaderfile);
TMP8922[7].typ = (&NTI138);
TMP8922[7].name = "isHeaderFile";
TMP8924[7] = &TMP8922[8];
TMP8922[8].kind = 1;
TMP8922[8].offset = offsetof(Tcgen456038, includesstringh);
TMP8922[8].typ = (&NTI138);
TMP8922[8].name = "includesStringh";
TMP8924[8] = &TMP8922[9];
TMP8922[9].kind = 1;
TMP8922[9].offset = offsetof(Tcgen456038, objhaskidsvalid);
TMP8922[9].typ = (&NTI138);
TMP8922[9].name = "objHasKidsValid";
TMP8924[9] = &TMP8922[10];
TMP8922[10].kind = 1;
TMP8922[10].offset = offsetof(Tcgen456038, cfilename);
TMP8922[10].typ = (&NTI149);
TMP8922[10].name = "cfilename";
TMP8924[10] = &TMP8922[11];
TMP8922[11].kind = 1;
TMP8922[11].offset = offsetof(Tcgen456038, typecache);
TMP8922[11].typ = (&NTI190861);
TMP8922[11].name = "typeCache";
TMP8924[11] = &TMP8922[12];
TMP8922[12].kind = 1;
TMP8922[12].offset = offsetof(Tcgen456038, forwtypecache);
TMP8922[12].typ = (&NTI190861);
TMP8922[12].name = "forwTypeCache";
TMP8924[12] = &TMP8922[13];
TMP8922[13].kind = 1;
TMP8922[13].offset = offsetof(Tcgen456038, declaredthings);
TMP8922[13].typ = (&NTI187056);
TMP8922[13].name = "declaredThings";
TMP8924[13] = &TMP8922[14];
TMP8922[14].kind = 1;
TMP8922[14].offset = offsetof(Tcgen456038, declaredprotos);
TMP8922[14].typ = (&NTI187056);
TMP8922[14].name = "declaredProtos";
TMP8924[14] = &TMP8922[15];
TMP8922[15].kind = 1;
TMP8922[15].offset = offsetof(Tcgen456038, headerfiles);
TMP8922[15].typ = (&NTI130028);
TMP8922[15].name = "headerFiles";
TMP8924[15] = &TMP8922[16];
TMP8922[16].kind = 1;
TMP8922[16].offset = offsetof(Tcgen456038, typeinfomarker);
TMP8922[16].typ = (&NTI187056);
...
TMP8922[19].kind = 1;
TMP8922[19].offset = offsetof(Tcproc456034, prc);
TMP8922[19].typ = (&NTI190811);
TMP8922[19].name = "prc";
TMP8925[1] = &TMP8922[20];
TMP8922[20].kind = 1;
TMP8922[20].offset = offsetof(Tcproc456034, beforeretneeded);
TMP8922[20].typ = (&NTI138);
TMP8922[20].name = "beforeRetNeeded";
TMP8925[2] = &TMP8922[21];
TMP8922[21].kind = 1;
TMP8922[21].offset = offsetof(Tcproc456034, threadvaraccessed);
TMP8922[21].typ = (&NTI138);
TMP8922[21].name = "threadVarAccessed";
TMP8925[3] = &TMP8922[22];
TMP8922[22].kind = 1;
TMP8922[22].offset = offsetof(Tcproc456034, lastlineinfo);
TMP8922[22].typ = (&NTI162338);
TMP8922[22].name = "lastLineInfo";
TMP8925[4] = &TMP8922[23];
TMP8922[23].kind = 1;
TMP8922[23].offset = offsetof(Tcproc456034, nestedtrystmts);
TMP8922[23].typ = (&NTI190807);
TMP8922[23].name = "nestedTryStmts";
TMP8925[5] = &TMP8922[24];
TMP8922[24].kind = 1;
TMP8922[24].offset = offsetof(Tcproc456034, inexceptblock);
TMP8922[24].typ = (&NTI108);
TMP8922[24].name = "inExceptBlock";
TMP8925[6] = &TMP8922[25];
TMP8922[25].kind = 1;
TMP8922[25].offset = offsetof(Tcproc456034, finallysafepoints);
TMP8922[25].typ = (&NTI160599);
TMP8922[25].name = "finallySafePoints";
TMP8925[7] = &TMP8922[26];
TMP8922[26].kind = 1;
TMP8922[26].offset = offsetof(Tcproc456034, labels);
...
TMP8922[29].kind = 1;
TMP8922[29].offset = offsetof(Tblock456032, id);
TMP8922[29].typ = (&NTI108);
TMP8922[29].name = "id";
TMP8926[1] = &TMP8922[30];
TMP8922[30].kind = 1;
TMP8922[30].offset = offsetof(Tblock456032, label);
TMP8922[30].typ = (&NTI160007);
...
NTI456026.flags = 2;
TMP8922[31].kind = 1;
TMP8922[31].offset = offsetof(Tblock456032, sections);
TMP8922[31].typ = (&NTI456026);
TMP8922[31].name = "sections";
TMP8926[3] = &TMP8922[32];
TMP8922[32].kind = 1;
TMP8922[32].offset = offsetof(Tblock456032, isloop);
TMP8922[32].typ = (&NTI138);
TMP8922[32].name = "isLoop";
TMP8926[4] = &TMP8922[33];
TMP8922[33].kind = 1;
TMP8922[33].offset = offsetof(Tblock456032, nestedtrystmts);
TMP8922[33].typ = (&NTI112);
TMP8922[33].name = "nestedTryStmts";
TMP8926[5] = &TMP8922[34];
TMP8922[34].kind = 1;
TMP8922[34].offset = offsetof(Tblock456032, nestedexceptstmts);
TMP8922[34].typ = (&NTI112);
TMP8922[34].name = "nestedExceptStmts";
TMP8926[6] = &TMP8922[35];
TMP8922[35].kind = 1;
TMP8922[35].offset = offsetof(Tblock456032, framelen);
TMP8922[35].typ = (&NTI112);
TMP8922[35].name = "frameLen";
TMP8922[28].len = 7; TMP8922[28].kind = 2; TMP8922[28].sons = &TMP8926[0];
NTI456032.node = &TMP8922[28];
NTI456106.size = sizeof(TY456106*);
NTI456106.kind = 24;
NTI456106.base = (&NTI456032);
NTI456106.flags = 2;
NTI456106.marker = TMP8927;
TMP8922[27].kind = 1;
TMP8922[27].offset = offsetof(Tcproc456034, blocks);
TMP8922[27].typ = (&NTI456106);
TMP8922[27].name = "blocks";
TMP8925[9] = &TMP8922[36];
TMP8922[36].kind = 1;
TMP8922[36].offset = offsetof(Tcproc456034, breakidx);
TMP8922[36].typ = (&NTI108);
TMP8922[36].name = "breakIdx";
TMP8925[10] = &TMP8922[37];
TMP8922[37].kind = 1;
TMP8922[37].offset = offsetof(Tcproc456034, options);
TMP8922[37].typ = (&NTI153121);
TMP8922[37].name = "options";
TMP8925[11] = &TMP8922[38];
TMP8922[38].kind = 1;
TMP8922[38].offset = offsetof(Tcproc456034, maxframelen);
TMP8922[38].typ = (&NTI108);
TMP8922[38].name = "maxFrameLen";
TMP8925[12] = &TMP8922[39];
TMP8922[39].kind = 1;
TMP8922[39].offset = offsetof(Tcproc456034, module);
TMP8922[39].typ = (&NTI456028);
TMP8922[39].name = "module";
TMP8925[13] = &TMP8922[40];
TMP8922[40].kind = 1;
TMP8922[40].offset = offsetof(Tcproc456034, withinloop);
TMP8922[40].typ = (&NTI108);
TMP8922[40].name = "withinLoop";
TMP8925[14] = &TMP8922[41];
TMP8922[41].kind = 1;
TMP8922[41].offset = offsetof(Tcproc456034, splitdecls);
TMP8922[41].typ = (&NTI108);
TMP8922[41].name = "splitDecls";
TMP8925[15] = &TMP8922[42];
TMP8922[42].kind = 1;
TMP8922[42].offset = offsetof(Tcproc456034, gcframeid);
TMP8922[42].typ = (&NTI3407);
TMP8922[42].name = "gcFrameId";
TMP8925[16] = &TMP8922[43];
TMP8922[43].kind = 1;
TMP8922[43].offset = offsetof(Tcproc456034, gcframetype);
TMP8922[43].typ = (&NTI160007);
TMP8922[43].name = "gcFrameType";
TMP8922[18].len = 17; TMP8922[18].kind = 2; TMP8922[18].sons = &TMP8925[0];
NTI456034.node = &TMP8922[18];
NTI456030.size = sizeof(Tcproc456034*);
NTI456030.kind = 22;
NTI456030.base = (&NTI456034);
NTI456030.marker = TMP8928;
TMP8922[17].kind = 1;
TMP8922[17].offset = offsetof(Tcgen456038, initproc);
TMP8922[17].typ = (&NTI456030);
TMP8922[17].name = "initProc";
TMP8924[17] = &TMP8922[44];
TMP8922[44].kind = 1;
TMP8922[44].offset = offsetof(Tcgen456038, postinitproc);
TMP8922[44].typ = (&NTI456030);
TMP8922[44].name = "postInitProc";
TMP8924[18] = &TMP8922[45];
TMP8922[45].kind = 1;
TMP8922[45].offset = offsetof(Tcgen456038, preinitproc);
TMP8922[45].typ = (&NTI456030);
TMP8922[45].name = "preInitProc";
TMP8924[19] = &TMP8922[46];
TMP8922[46].kind = 1;
TMP8922[46].offset = offsetof(Tcgen456038, typestack);
TMP8922[46].typ = (&NTI190845);
TMP8922[46].name = "typeStack";
TMP8924[20] = &TMP8922[47];
TMP8922[47].kind = 1;
TMP8922[47].offset = offsetof(Tcgen456038, datacache);
TMP8922[47].typ = (&NTI190873);
TMP8922[47].name = "dataCache";
TMP8924[21] = &TMP8922[48];
TMP8922[48].kind = 1;
TMP8922[48].offset = offsetof(Tcgen456038, forwardedprocs);
TMP8922[48].typ = (&NTI190815);
TMP8922[48].name = "forwardedProcs";
TMP8924[22] = &TMP8922[49];
TMP8922[49].kind = 1;
TMP8922[49].offset = offsetof(Tcgen456038, typenodes);
TMP8922[49].typ = (&NTI108);
TMP8922[49].name = "typeNodes";
TMP8924[23] = &TMP8922[50];
TMP8922[50].kind = 1;
TMP8922[50].offset = offsetof(Tcgen456038, nimtypes);
TMP8922[50].typ = (&NTI108);
TMP8922[50].name = "nimTypes";
TMP8924[24] = &TMP8922[51];
TMP8922[51].kind = 1;
TMP8922[51].offset = offsetof(Tcgen456038, typenodesname);
TMP8922[51].typ = (&NTI160007);
TMP8922[51].name = "typeNodesName";
TMP8924[25] = &TMP8922[52];
TMP8922[52].kind = 1;
TMP8922[52].offset = offsetof(Tcgen456038, nimtypesname);
TMP8922[52].typ = (&NTI160007);
TMP8922[52].name = "nimTypesName";
TMP8924[26] = &TMP8922[53];
TMP8922[53].kind = 1;
TMP8922[53].offset = offsetof(Tcgen456038, labels);
