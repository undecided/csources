...
NIM_CONST TY163302 TMP1872 = {((NimStringDesc*) &TMP1873),
...
NIM_CONST TY163297 TMP1892 = {((NimStringDesc*) &TMP1893),
...
N_NIMCALL(void, writeversioninfo_176107)(NU8 pass) {
	...
	nimln(78, "commands.nim");
	{
		...
		msgwriteln_164536(((NimStringDesc*) &TMP1860));
...
N_NIMCALL(void, invalidcmdlineoption_176230)(NU8 pass, NimStringDesc* switch_176233, Tlineinfo163338 info) {
	...
	{
		if (!eqStrings(switch_176233, ((NimStringDesc*) &TMP1863))) goto LA3;
		localerror_165155(info, ((NU16) 44), ((NimStringDesc*) &TMP1861));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, splitswitch_176241)(NimStringDesc* switch_176243, NimStringDesc** cmd, NimStringDesc** arg, NU8 pass, Tlineinfo163338 info) {
	...
	LA19: ;
	{
		...
		unsureAsgnRef((void**) (&(*arg)), copyStr(switch_176243, (NI)(TMP1868)));
	}
	goto LA17;
	LA22: ;
	{
...
N_NIMCALL(void, processspecificnote_176397)(NimStringDesc* arg, NU16 state, NU8 pass, Tlineinfo163338 info, NimStringDesc* orig) {
	...
	nimln(155, "commands.nim");
	{
		...
		x = findstr_172344(TMP1872, 17, id);
...
appendString(LOC28, id);
	...
	LA21: ;
	{
		...
		x = findstr_172344(TMP1892, 31, id);
...
N_NIMCALL(void, track_177030)(NimStringDesc* arg, Tlineinfo163338 info) {
	...
	nimln(263, "commands.nim");
	{
		...
		localerror_165155(info, ((NU16) 23), ((NimStringDesc*) &TMP1985));
	}
	LA3: ;
	line = 0;
	column = 0;
...
break;
	...
	LA30: ;
	{
		...
		LA164: ;
		{
			...
			undefsymbol_168022(((NimStringDesc*) &TMP2057));
		}
		goto LA167;
		LA165: ;
		{
...
appendString(LOC172, arg);
	...
	LA31: ;
	{
		...
		nimln(393, "commands.nim");
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP1949));
		}
		goto LA174;
		LA176: ;
		{
			nimln(394, "commands.nim");
			undefsymbol_168022(((NimStringDesc*) &TMP1949));
		}
		LA174: ;
	}
	goto LA92;
...
N_NIMCALL(NIM_BOOL, processargument_177738)(NU8 pass, Optparser175011* p, NI* argscount) {
	...
	LA3: ;
	{
		...
		nimln(614, "commands.nim");
		{
			...
			asgnRefNoCycle((void**) (&gprojectname_154234), nosunixToNativePath((*p).key, ((NimStringDesc*) &TMP1864)));
...
NIM_EXTERNC N_NOINLINE(void, compiler_commandsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = arguments_177721; arguments_177721 = copyStringRC1(((NimStringDesc*) &TMP1864));
