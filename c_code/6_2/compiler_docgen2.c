...
N_NIMCALL(Tnode190813*, close_507018)(Tpasscontext241005* p, Tnode190813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_343337((*g).doc, LOC7, ((NimStringDesc*) &TMP10604), usewarning);
...
TMP10601[1].kind = 1;
TMP10601[1].offset = offsetof(Tgen507010, doc);
TMP10601[1].typ = (&NTI340009);
TMP10601[1].name = "doc";
TMP10603[1] = &TMP10601[2];
TMP10601[2].kind = 1;
TMP10601[2].offset = offsetof(Tgen507010, module);
TMP10601[2].typ = (&NTI190811);
TMP10601[2].name = "module";
TMP10601[0].len = 2; TMP10601[0].kind = 2; TMP10601[0].sons = &TMP10603[0];
NTI507010.node = &TMP10601[0];
NTI507012.size = sizeof(Tgen507010*);
NTI507012.kind = 22;
NTI507012.base = (&NTI507010);
NTI507012.marker = TMP10606;
}
