...
static NIM_CONST TY191031 TMP7621 = {
...
NIM_CONST TY146211 TMP7626 = {((NimStringDesc*) &TMP7627),
((NI) 39)}
;
						...
						y_383083 = 0;
						{
							...
							res_383146 = ((NI) 0);
							{
								...
								while (1) {
									...
									TMP7625 = addInt(res_383146, ((NI) 1));
									res_383146 = (NI)(TMP7625);
								} LA20: ;
							}
						}
					}
		...
		res = copynode_383027((&(*c)), templ, actual);
		{
			...
			res_383153 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7629 = addInt(res_383153, ((NI) 1));
					res_383153 = (NI)(TMP7629);
				} LA52: ;
			}
		}
...
N_NIMCALL(Tnode190813*, evaltemplateargs_383184)(Tnode190813* n, Tsym190843* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_164134((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7630));
	}
	LA5: ;
		...
		res_383237 = ((NI) 1);
		{
			...
			while (1) {
				...
				LA12: ;
				{
					...
					if (!(((TMP7621[(*(*(*(*s).typ).n).kindU.S6.sons->data[i_383204]).kind/8] &(1<<((*(*(*(*s).typ).n).kindU.S6.sons->data[i_383204]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7622));
				...
				nimln(70, "evaltempl.nim");
				{
					...
					localerror_164155((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7630));
				}
				LA19: ;
				nimln(72, "evaltempl.nim");
				addson_192819(result, arg);
				nimln(1614, "system.nim");
				TMP7632 = addInt(res_383237, ((NI) 1));
				res_383237 = (NI)(TMP7632);
			} LA9: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode190813*, evaltemplate_383260)(Tnode190813* n, Tsym190843* tmpl, Tsym190843* gensymowner) {
	...
	TMP7633 = addInt(evaltemplatecounter_383256, ((NI) 1));
	evaltemplatecounter_383256 = (NI)(TMP7633);
	nimln(79, "evaltempl.nim");
	{
		if (!(((NI) 100) < evaltemplatecounter_383256)) goto LA3;
		nimln(80, "evaltempl.nim");
		globalerror_164134((*n).info, ((NU16) 183), ((NimStringDesc*) &TMP7630));
		...
		LA20: ;
		{
			...
			res_383325 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP7635 = addInt(res_383325, ((NI) 1));
					res_383325 = (NI)(TMP7635);
				} LA25: ;
			}
		}
	}
	...
	TMP7636 = subInt(evaltemplatecounter_383256, ((NI) 1));
