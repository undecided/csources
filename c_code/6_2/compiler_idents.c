...
{	result = 0;
	...
	asgnRefNoCycle((void**) (&(*result).s), mnewString(((NI)chckRange(length, ((NI) 0), ((NI) IL64(9223372036854775807))))));
	{
		...
		res_166438 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP1313 = addInt(res_166438, ((NI) 1));
				res_166438 = (NI)(TMP1313);
			} LA24: ;
		}
	}
	nimln(90, "idents.nim");
	...
	nimln(92, "idents.nim");
	{
		...
		nimln(93, "idents.nim");
		TMP1314 = addInt(wordcounter_166244, ((NI) 1));
		wordcounter_166244 = (NI)(TMP1314);
		nimln(94, "idents.nim");
...
NIM_EXTERNC N_NOINLINE(void, compiler_identsInit)(void) {
	...
	asgnRefNoCycle((void**) (&idanon_166495), getident_166463(((NimStringDesc*) &TMP1315)));
	nimln(109, "idents.nim");
	asgnRefNoCycle((void**) (&iddelegator_166550), getident_166463(((NimStringDesc*) &TMP1316)));
	popFrame();
}
...
NTI166015.flags = 1;
TMP1297[0].kind = 1;
TMP1297[0].offset = offsetof(Tidobj166015, id);
TMP1297[0].typ = (&NTI108);
TMP1297[0].name = "id";
NTI166015.node = &TMP1297[0];
...
TMP1310[0] = &TMP1297[2];
TMP1297[2].kind = 1;
TMP1297[2].offset = offsetof(Tident166021, s);
TMP1297[2].typ = (&NTI149);
TMP1297[2].name = "s";
TMP1310[1] = &TMP1297[3];
TMP1297[3].kind = 1;
TMP1297[3].offset = offsetof(Tident166021, next);
TMP1297[3].typ = (&NTI166019);
TMP1297[3].name = "next";
TMP1310[2] = &TMP1297[4];
TMP1297[4].kind = 1;
TMP1297[4].offset = offsetof(Tident166021, h);
TMP1297[4].typ = (&NTI131021);
TMP1297[4].name = "h";
TMP1297[1].len = 3; TMP1297[1].kind = 2; TMP1297[1].sons = &TMP1310[0];
NTI166021.node = &TMP1297[1];
NTI166019.size = sizeof(Tident166021*);
NTI166019.kind = 22;
NTI166019.base = (&NTI166021);
NTI166019.flags = 2;
NTI166019.marker = TMP1311;
