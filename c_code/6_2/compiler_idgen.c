...
STRING_LITERAL(TMP2551, "nimrod.gid", 10);
STRING_LITERAL(TMP2552, "\012", 1);
...
static N_INLINE(NI, getid_189404)(void) {
	...
	nimln(31, "idgen.nim");
	TMP2544 = addInt(gfrontendid_189012, ((NI) 1));
	gfrontendid_189012 = (NI)(TMP2544);
	popFrame();
	return result;
}
...
static N_INLINE(NI, backendid_189422)(void) {
	...
	nimln(35, "idgen.nim");
	TMP2545 = addInt(gbackendid_189013, ((NI) 1));
	gbackendid_189013 = (NI)(TMP2545);
	popFrame();
	return result;
}
...
static N_INLINE(void, setid_189440)(NI id) {
	...
	nimln(38, "idgen.nim");
	TMP2546 = addInt(id, ((NI) 1));
	gfrontendid_189012 = ((gfrontendid_189012 >= (NI)(TMP2546)) ? gfrontendid_189012 : (NI)(TMP2546));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_189453)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	TMP2547 = divInt(gfrontendid_189012, idrange);
	TMP2548 = addInt((NI)(TMP2547), ((NI) 1));
	TMP2549 = mulInt((NI)(TMP2548), idrange);
	TMP2550 = addInt((NI)(TMP2549), ((NI) 1));
	gfrontendid_189012 = (NI)(TMP2550);
	popFrame();
}
...
N_NIMCALL(NimStringDesc*, togid_189462)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_154001(((NimStringDesc*) &TMP2551), NIM_TRUE);
	popFrame();
	return result;
}
...
static N_INLINE(void, writeln_154205)(FILE* f, NimStringDesc** x, NI xLen0) {
	...
	nimln(213, "sysio.nim");
	write_13457(f, ((NimStringDesc*) &TMP2552));
	popFrame();
}
