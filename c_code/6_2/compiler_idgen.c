...
static N_INLINE(NI, getid_190404)(void) {
	...
	nimln(31, "idgen.nim");
	TMP2543 = addInt(gfrontendid_190012, ((NI) 1));
	gfrontendid_190012 = (NI)(TMP2543);
	popFrame();
	return result;
}
...
static N_INLINE(NI, backendid_190422)(void) {
	...
	nimln(35, "idgen.nim");
	TMP2544 = addInt(gbackendid_190013, ((NI) 1));
	gbackendid_190013 = (NI)(TMP2544);
	popFrame();
	return result;
}
...
static N_INLINE(void, setid_190440)(NI id) {
	...
	gfrontendid_190012 = ((gfrontendid_190012 >= (NI)(TMP2545)) ? gfrontendid_190012 : (NI)(TMP2545));
	popFrame();
}
...
N_NIMCALL(void, idsynchronizationpoint_190453)(NI idrange) {
	...
	nimln(41, "idgen.nim");
	TMP2546 = divInt(gfrontendid_190012, idrange);
...
N_NIMCALL(NimStringDesc*, togid_190462)(NimStringDesc* f) {
	...
	result = 0;
	nimln(47, "idgen.nim");
	result = completegeneratedfilepath_155001(((NimStringDesc*) &TMP2550), NIM_TRUE);
	popFrame();
	return result;
}
