...
N_NIMCALL(NIM_BOOL, endswithopr_177450)(NimStringDesc* x) {
	...
	result = endswith_177404(x, TMP2090);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_177460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_177404(line, TMP2091);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_177686)(Tllstream177204* s, NimStringDesc* data) {
	...
	llstreamwrite_177665(s, ((NimStringDesc*) &TMP2087));
	popFrame();
}
...
NTI177202.node = &TMP2079[6];
TMP2079[1].kind = 1;
TMP2079[1].offset = offsetof(Tllstream177204, kind);
TMP2079[1].typ = (&NTI177202);
TMP2079[1].name = "kind";
TMP2081[1] = &TMP2079[7];
TMP2079[7].kind = 1;
TMP2079[7].offset = offsetof(Tllstream177204, f);
TMP2079[7].typ = (&NTI13004);
TMP2079[7].name = "f";
TMP2081[2] = &TMP2079[8];
TMP2079[8].kind = 1;
TMP2079[8].offset = offsetof(Tllstream177204, s);
TMP2079[8].typ = (&NTI149);
TMP2079[8].name = "s";
TMP2081[3] = &TMP2079[9];
TMP2079[9].kind = 1;
TMP2079[9].offset = offsetof(Tllstream177204, rd);
TMP2079[9].typ = (&NTI108);
TMP2079[9].name = "rd";
TMP2081[4] = &TMP2079[10];
TMP2079[10].kind = 1;
TMP2079[10].offset = offsetof(Tllstream177204, wr);
TMP2079[10].typ = (&NTI108);
TMP2079[10].name = "wr";
TMP2081[5] = &TMP2079[11];
TMP2079[11].kind = 1;
TMP2079[11].offset = offsetof(Tllstream177204, lineoffset);
TMP2079[11].typ = (&NTI108);
TMP2079[11].name = "lineOffset";
TMP2079[0].len = 6; TMP2079[0].kind = 2; TMP2079[0].sons = &TMP2081[0];
NTI177204.node = &TMP2079[0];
NTI177206.size = sizeof(Tllstream177204*);
NTI177206.kind = 22;
NTI177206.base = (&NTI177204);
NTI177206.marker = TMP2085;
}
