...
N_NIMCALL(NIM_BOOL, parseatom_185048)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(26, "nimconf.nim");
	{
		...
		LA7: ;
		{
			...
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2474));
		}
		LA5: ;
	}
	goto LA1;
...
N_NIMCALL(NIM_BOOL, evalppif_185147)(Tlexer180185* L, Ttoken180181* tok) {
	...
	LA3: ;
	{
		...
		lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2475));
	}
	LA1: ;
	popFrame();
	return result;
...
N_NIMCALL(void, doend_185191)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(61, "nimconf.nim");
	{
		...
		lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2477));
	}
	LA3: ;
...
N_NIMCALL(void, parsedirective_185342)(Tlexer180185* L, Ttoken180181* tok) {
	...
	case ((NU16) 31):
	{
		...
		TMP2482 = addInt((condstack_185186 ? condstack_185186->Sup.len : 0), ((NI) 1));
		condstack_185186 = (TY185169*) setLengthSeq(&(condstack_185186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((NI)(TMP2482), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(void, parseassignment_185439)(Tlexer180185* L, Ttoken180181* tok) {
	...
	nimln(159, "nimconf.nim");
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_166463(((NimStringDesc*) &TMP2486));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_166463(((NimStringDesc*) &TMP2487));
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			...
			lexmessage_180483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2489));
		}
		LA17: ;
	...
	LOC22 = 0;
	LOC22 = getident_166463(((NimStringDesc*) &TMP2490));
...
appendString(val, LOC33);
		...
		conftok_185377(L, tok);
		{
			...
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_166463(((NimStringDesc*) &TMP2491));
...
N_NIMCALL(void, loadconfigs_185809)(NimStringDesc* cfg) {
	...
	nimln(230, "nimconf.nim");
	{
		...
		nimln(234, "nimconf.nim");
		{
			...
			LOC9 = 0;
			LOC9 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2501));
		...
		LA7: ;
		{
			...
			LOC13 = 0;
			LOC13 = libpath_153233; libpath_153233 = copyStringRC1(((NimStringDesc*) &TMP2503));
		...
		LA11: ;
		{
			...
			asgnRefNoCycle((void**) (&libpath_153233), nosjoinPath(prefix, ((NimStringDesc*) &TMP2504)));
		}
		LA5: ;
	}
	LA3: ;
		...
		if (!!(((gglobaloptions_153128 &(1<<((((NU8) 19))&31)))!=0))) goto LA32;
		{
			...
			nimln(635, "os.nim");
			{
				...
				nimln(637, "os.nim");
				{
					...
					LOC43 = 0;
					LOC43 = HEX2F_119292(dir_186034, cfg);
				...
				LA41: ;
				{
					...
					while (1) {
						...
						nimln(248, "nimconf.nim");
						LOC51 = 0;
						LOC51 = HEX2F_119292(dir_186034, cfg);
			...
			LA37: ;
			{
					...
					res_186057 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(645, "os.nim");
							{
								...
								nimln(248, "nimconf.nim");
								LOC64 = 0;
								LOC64 = HEX2F_119292(dir_186034, cfg);
								readconfigfile_185520(LOC64);
							}
							LA62: ;
							nimln(1614, "system.nim");
							TMP2507 = addInt(res_186057, ((NI) 1));
							res_186057 = (NI)(TMP2507);
						} LA55: ;
					}
				}
				nimln(649, "os.nim");
				{
					...
					nimln(248, "nimconf.nim");
					LOC69 = 0;
					LOC69 = HEX2F_119292(dir_186034, cfg);
	...
	nimln(250, "nimconf.nim");
	{
		...
		nimln(253, "nimconf.nim");
		{
			...
			projectconfig = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP2508));
			nimln(256, "nimconf.nim");
			{
				...
				projectconfig = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP2509));
			}
			LA82: ;
			nimln(258, "nimconf.nim");
			{
				...
				projectconfig = noschangeFileExt(gprojectfull_153236, ((NimStringDesc*) &TMP2510));
