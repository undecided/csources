...
static NIM_CONST TY191031 TMP4686 = {
...
NIM_CONST TY146211 TMP4706 = {((NimStringDesc*) &TMP4707),
((NI) 100)}
;
NIM_CONST TY146211 TMP4709 = {((NimStringDesc*) &TMP4707),
((NI) 107)}
;
STRING_LITERAL(TMP4711, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP4713, "parameter pattern too complex", 29);
static NIM_CONST TY191031 TMP4714 = {
			...
			LA67: ;
			{
				...
				res_268644 = ((NI) 0);
				{
					...
					while (1) {
						...
						TMP4708 = addInt(res_268644, ((NI) 1));
						res_268644 = (NI)(TMP4708);
					} LA72: ;
				}
			}
			nimln(854, "msgs.nim");
			...
			LA81: ;
			{
				...
				res_268652 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA90: ;
						nimln(1619, "system.nim");
						TMP4710 = addInt(res_268652, ((NI) 1));
						res_268652 = (NI)(TMP4710);
					} LA86: ;
				}
			}
...
N_NIMCALL(Tnode190813*, semnodekindconstraints_268679)(Tnode190813* p) {
	...
	nimln(124, "parampatterns.nim");
	{
		...
		if (!(((NI) 2) <= LOC7)) goto LA8;
		{
			...
			res_268842 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4712 = addInt(res_268842, ((NI) 1));
					res_268842 = (NI)(TMP4712);
				} LA13: ;
			}
		}
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_164199((*p).info, ((NimStringDesc*) &TMP4713));
		}
		LA16: ;
	}
	goto LA5;
		...
		LA2: ;
		{
			...
			res_269010 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP4716 = addInt(res_269010, ((NI) 1));
					res_269010 = (NI)(TMP4716);
				} LA19: ;
			}
		}
	}
		...
		result = ((NU8) 2);
		{
			...
			res_269018 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA35: ;
					nimln(1619, "system.nim");
					TMP4717 = addInt(res_269018, ((NI) 1));
					res_269018 = (NI)(TMP4717);
				} LA34: ;
			}
		}
	}
