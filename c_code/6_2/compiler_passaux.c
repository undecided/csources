...
static NIM_CONST TY191031 TMP10586 = {
...
N_NIMCALL(Tnode190813*, verboseprocess_505023)(Tpasscontext241005* context, Tnode190813* n) {
	...
	nimln(22, "passaux.nim");
	{
		...
		internalerror_164218(((NimStringDesc*) &TMP10581));
	}
	LA3: ;
	...
	{
		{
			...
			res_505137 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP10585 = addInt(res_505137, ((NI) 1));
					res_505137 = (NI)(TMP10585);
				} LA11: ;
			}
		}
	}
