...
static NIM_CONST TY191031 TMP4113 = {
...
N_NIMCALL(void, registerpass_241190)(Tpass241017* p) {
	...
	nimln(97, "passes.nim");
	TMP4115 = addInt(gpasseslen_241176, ((NI) 1));
	gpasseslen_241176 = (NI)(TMP4115);
	popFrame();
}
	...
	nimfr("openPasses", "passes.nim")
	{
		...
		res_241322 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4118 = addInt(res_241322, ((NI) 1));
				res_241322 = (NI)(TMP4118);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("openPassesCached", "passes.nim")
	{
		...
		res_241384 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA4: ;
				nimln(1614, "system.nim");
				TMP4120 = addInt(res_241384, ((NI) 1));
				res_241384 = (NI)(TMP4120);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = NIM_NIL;
	{
		...
		res_241434 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4122 = addInt(res_241434, ((NI) 1));
				res_241434 = (NI)(TMP4122);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = n;
	{
		...
		res_241493 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4124 = addInt(res_241493, ((NI) 1));
				res_241493 = (NI)(TMP4124);
			} LA3: ;
		}
	}
	...
	m = n;
	{
		...
		res_241543 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4126 = addInt(res_241543, ((NI) 1));
				res_241543 = (NI)(TMP4126);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = NIM_NIL;
	{
		...
		res_241600 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4128 = addInt(res_241600, ((NI) 1));
				res_241600 = (NI)(TMP4128);
			} LA3: ;
		}
	}
	popFrame();
		...
		n = loadinitsection_233077(rd);
		{
			...
			res_241779 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4134 = addInt(res_241779, ((NI) 1));
					res_241779 = (NI)(TMP4134);
				} LA45: ;
			}
		}
...
NTI241005.flags = 1;
TMP4029[0].kind = 1;
TMP4029[0].offset = offsetof(Tpasscontext241005, fromcache);
TMP4029[0].typ = (&NTI138);
TMP4029[0].name = "fromCache";
NTI241005.node = &TMP4029[0];
...
TMP6327[0] = &TMP4029[2];
TMP4029[2].kind = 1;
TMP4029[2].offset = offsetof(Tpassdata241019, Field0);
TMP4029[2].typ = (&NTI190805);
TMP4029[2].name = "Field0";
TMP6327[1] = &TMP4029[3];
TMP4029[3].kind = 1;
TMP4029[3].offset = offsetof(Tpassdata241019, Field1);
TMP4029[3].typ = (&NTI190805);
TMP4029[3].name = "Field1";
TMP4029[1].len = 2; TMP4029[1].kind = 2; TMP4029[1].sons = &TMP6327[0];
NTI241019.node = &TMP4029[1];
}
