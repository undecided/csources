...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4144, "ident", 5);
static NIM_CONST TY191031 TMP4145 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4146, "sym", 3);
static NIM_CONST TY191031 TMP4147 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4148, "intVal", 6);
static NIM_CONST TY191031 TMP4149 = {
0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4150, "floatVal", 8);
static NIM_CONST TY191031 TMP4151 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4152, "strVal", 6);
static NIM_CONST TY191031 TMP4154 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4155, "sons", 4);
STRING_LITERAL(TMP4161, "data[h].key == nil ", 19);
STRING_LITERAL(TMP4162, "not (t.data[index].key == nil) ", 31);
	...
	{
		{
			...
			TMP4153 = subInt(LOC30, ((NI) 1));
			HEX3Atmp_242090 = (NI)(TMP4153);
			...
			res_242093 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4156 = addInt(res_242093, ((NI) 1));
					res_242093 = (NI)(TMP4156);
				} LA32: ;
			}
		}
	}
		...
		default:
		{
			nimln(50, "treetab.nim");
			{
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					TMP4157 = subInt(LOC26, ((NI) 1));
					HEX3Atmp_242189 = (NI)(TMP4157);
					nimln(1598, "system.nim");
					res_242192 = ((NI) 0);
					{
						nimln(1599, "system.nim");
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4158 = addInt(res_242192, ((NI) 1));
							res_242192 = (NI)(TMP4158);
						} LA28: ;
					}
				}
...
static N_INLINE(NI, nexttry_198256)(NI h, NI maxhash) {
	...
	TMP4159 = mulInt(((NI) 5), h);
	TMP4160 = addInt((NI)(TMP4159), ((NI) 1));
	result = (NI)((NI)(TMP4160) & maxhash);
	popFrame();
	return result;
}
...
N_NIMCALL(void, nodetableput_242415)(Tnodetable190873* t, Tnode190813* key, NI val) {
	...
	nimln(82, "treetab.nim");
	{
		...
		nimln(83, "treetab.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP4162));
		}
		LA7: ;
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			TMP4163 = mulInt(((*t).data ? (*t).data->Sup.len : 0), ((NI) 2));
			n = (Tnodepairseq190871*) newSeq((&NTI190871), ((NI)chckRange((NI)(TMP4163), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_242639;
				NI HEX3Atmp_242676;
				NI res_242679;
				...
				res_242679 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA20: ;
						nimln(1614, "system.nim");
						TMP4164 = addInt(res_242679, ((NI) 1));
						res_242679 = (NI)(TMP4164);
					} LA17: ;
				}
			}
		...
		TMP4165 = addInt((*t).counter, ((NI) 1));
		(*t).counter = (NI)(TMP4165);
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(NI, nodetabletestorset_242698)(Tnodetable190873* t, Tnode190813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq190871*) newSeq((&NTI190871), ((NI)chckRange((NI)(TMP4166), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_242839;
				NI HEX3Atmp_242876;
				NI res_242879;
				...
				res_242879 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA20: ;
						nimln(1614, "system.nim");
						TMP4167 = addInt(res_242879, ((NI) 1));
						res_242879 = (NI)(TMP4167);
					} LA17: ;
				}
			}
