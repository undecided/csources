...
static NIM_CONST TY192031 TMP6615 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6616, "sons", 4);
static NIM_CONST TY192031 TMP6618 = {
	...
	{
		{
			...
			res_338205 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP6617 = addInt(res_338205, ((NI) 1));
					res_338205 = (NI)(TMP6617);
				} LA5: ;
			}
		}
	}
...
appendString(result, LOC47);
					nimln(1619, "system.nim");
					TMP6632 = addInt(res_340205, ((NI) 1));
					res_340205 = (NI)(TMP6632);
				} LA46: ;
			}
		}
...
appendString(result, LOC66);
					nimln(1619, "system.nim");
					TMP6636 = addInt(res_340213, ((NI) 1));
					res_340213 = (NI)(TMP6636);
				} LA60: ;
			}
		}
	}
...
appendString(result, LOC72);
					nimln(1619, "system.nim");
					TMP6638 = addInt(res_340221, ((NI) 1));
					res_340221 = (NI)(TMP6638);
				} LA71: ;
			}
		}
...
appendString(result, LOC88);
					nimln(1619, "system.nim");
					TMP6640 = addInt(res_340229, ((NI) 1));
					res_340229 = (NI)(TMP6640);
				} LA87: ;
			}
		}
...
{	nimln(89, "typesrenderer.nim");
	...
	{
		{
			...
			res_340622 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6641 = addInt(res_340622, ((NI) 1));
					res_340622 = (NI)(TMP6641);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 35):
	{
		...
		nimln(97, "typesrenderer.nim");
		{
			...
			LOC18 = 0;
			LOC18 = HEX5BHEX5D_192244(n, (NI)(TMP6644));
			...
			LOC21 = 0;
			LOC21 = HEX5BHEX5D_192244(n, (NI)(TMP6645));
			typ = (*LOC21).typ;
		...
		LA19: ;
		{
			...
			res_340630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6647 = addInt(res_340630, ((NI) 1));
					res_340630 = (NI)(TMP6647);
				} LA32: ;
			}
		}
	}
