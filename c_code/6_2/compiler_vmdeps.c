...
static NIM_CONST TY191031 TMP7507 = {
		...
		res_380133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_380126 = atomictypex_380066(((NimStringDesc*) &TMP7484), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7485 = addInt(res_380133, ((NI) 1));
				res_380133 = (NI)(TMP7485);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode190813*, maptypetoast_380080)(Ttype190849* t, Tlineinfo162338 info, NIM_BOOL allowrecursion) {
	...
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_380066(((NimStringDesc*) &TMP7493), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_380066(((NimStringDesc*) &TMP7494), t, info);
		...
		result = newnodeit_192807(((NU8) 42), info, t);
		{
			...
			res_380246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7496 = addInt(res_380246, ((NI) 1));
					res_380246 = (NI)(TMP7496);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_380066(((NimStringDesc*) &TMP7506), t, info);
	...
	case ((NU8) 58):
	{
		...
		result = atomictypex_380066(((NimStringDesc*) &TMP7538), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_380066(((NimStringDesc*) &TMP7539), t, info);
