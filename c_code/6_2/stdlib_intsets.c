...
N_NIMCALL(void, intsetenlarge_187614)(Intset187056* t) {
	...
	n = (Ttrunkseq187054*) newSeq((&NTI187054), ((NI)chckRange((NI)(TMP2528), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_187642;
		NI res_187670;
		i_187642 = 0;
		...
		res_187670 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP2532 = addInt(res_187670, ((NI) 1));
				res_187670 = (NI)(TMP2532);
			} LA3: ;
		}
	}
...
{	result = 0;
	...
	nimln(85, "intsets.nim");
	{
		...
		LOC9 = 0;
		LOC9 = mustrehash_187073((NI)(TMP2533), (*t).counter);
		if (!LOC9) goto LA10;
...
TMP2529[0] = &TMP2515[1];
TMP2515[1].kind = 1;
TMP2515[1].offset = offsetof(Ttrunk187052, next);
TMP2515[1].typ = (&NTI187050);
TMP2515[1].name = "next";
TMP2529[1] = &TMP2515[2];
TMP2515[2].kind = 1;
TMP2515[2].offset = offsetof(Ttrunk187052, key);
TMP2515[2].typ = (&NTI108);
TMP2515[2].name = "key";
TMP2529[2] = &TMP2515[3];
TMP2515[3].kind = 1;
TMP2515[3].offset = offsetof(Ttrunk187052, bits);
TMP2515[3].typ = (&NTI27820);
TMP2515[3].name = "bits";
TMP2515[0].len = 3; TMP2515[0].kind = 2; TMP2515[0].sons = &TMP2529[0];
NTI187052.node = &TMP2515[0];
NTI187050.size = sizeof(Ttrunk187052*);
NTI187050.kind = 22;
NTI187050.base = (&NTI187052);
NTI187050.marker = TMP2530;
NTI187054.size = sizeof(Ttrunkseq187054*);
NTI187054.kind = 24;
NTI187054.base = (&NTI187050);
NTI187054.flags = 2;
NTI187054.marker = TMP2531;
...
TMP4204[0] = &TMP2515[5];
TMP2515[5].kind = 1;
TMP2515[5].offset = offsetof(Intset187056, counter);
TMP2515[5].typ = (&NTI108);
TMP2515[5].name = "counter";
TMP4204[1] = &TMP2515[6];
TMP2515[6].kind = 1;
TMP2515[6].offset = offsetof(Intset187056, max);
TMP2515[6].typ = (&NTI108);
TMP2515[6].name = "max";
TMP4204[2] = &TMP2515[7];
TMP2515[7].kind = 1;
TMP2515[7].offset = offsetof(Intset187056, head);
TMP2515[7].typ = (&NTI187050);
TMP2515[7].name = "head";
TMP4204[3] = &TMP2515[8];
TMP2515[8].kind = 1;
TMP2515[8].offset = offsetof(Intset187056, data);
TMP2515[8].typ = (&NTI187054);
TMP2515[8].name = "data";
TMP2515[4].len = 4; TMP2515[4].kind = 2; TMP2515[4].sons = &TMP4204[0];
NTI187056.node = &TMP2515[4];
}
