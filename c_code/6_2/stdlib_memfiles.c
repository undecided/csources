...
STRING_LITERAL(TMP3732, "0 < mappedSize ", 15);
STRING_LITERAL(TMP3733, "newFileSize == -1 or not (mode == fmRead) ", 42);
...
TMP3907[0] = &TMP3730[1];
TMP3730[1].kind = 1;
TMP3730[1].offset = offsetof(Memfile231208, mem);
TMP3730[1].typ = (&NTI153);
TMP3730[1].name = "mem";
TMP3907[1] = &TMP3730[2];
TMP3730[2].kind = 1;
TMP3730[2].offset = offsetof(Memfile231208, size);
TMP3730[2].typ = (&NTI108);
TMP3730[2].name = "size";
TMP3907[2] = &TMP3730[3];
TMP3730[3].kind = 1;
TMP3730[3].offset = offsetof(Memfile231208, handle);
TMP3730[3].typ = (&NTI5811);
TMP3730[3].name = "handle";
TMP3730[0].len = 3; TMP3730[0].kind = 2; TMP3730[0].sons = &TMP3907[0];
NTI231208.node = &TMP3730[0];
}
