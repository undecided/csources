...
static N_INLINE(Ropeobj159009**, s_455184)(Tcproc455034* p, NU8 s) {
	...
	TMP8933 = subInt(((*p).blocks ? (*p).blocks->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP8933)) >= (NU)((*p).blocks->Sup.len)) raiseIndexError();
	result = &(*p).blocks->data[(NI)(TMP8933)].sections[(s)- 0];
	popFrame();
	return result;
}
...
static TNimNode* TMP8925[29];
static TNimNode* TMP8926[17];
static TNimNode* TMP8927[7];
static TNimNode TMP8923[56];
NTI455038.size = sizeof(Tcgen455038);
NTI455038.kind = 17;
NTI455038.base = (&NTI240005);
TMP8925[0] = &TMP8923[1];
TMP8923[1].kind = 1;
TMP8923[1].offset = offsetof(Tcgen455038, module);
TMP8923[1].typ = (&NTI189811);
TMP8923[1].name = "module";
TMP8925[1] = &TMP8923[2];
TMP8923[2].kind = 1;
TMP8923[2].offset = offsetof(Tcgen455038, filename);
TMP8923[2].typ = (&NTI149);
TMP8923[2].name = "filename";
TMP8925[2] = &TMP8923[3];
...
NTI455022.flags = 2;
TMP8923[3].kind = 1;
TMP8923[3].offset = offsetof(Tcgen455038, s);
TMP8923[3].typ = (&NTI455022);
TMP8923[3].name = "s";
TMP8925[3] = &TMP8923[4];
TMP8923[4].kind = 1;
TMP8923[4].offset = offsetof(Tcgen455038, preventstacktrace);
TMP8923[4].typ = (&NTI138);
TMP8923[4].name = "preventStackTrace";
TMP8925[4] = &TMP8923[5];
TMP8923[5].kind = 1;
TMP8923[5].offset = offsetof(Tcgen455038, usesthreadvars);
TMP8923[5].typ = (&NTI138);
TMP8923[5].name = "usesThreadVars";
TMP8925[5] = &TMP8923[6];
TMP8923[6].kind = 1;
TMP8923[6].offset = offsetof(Tcgen455038, framedeclared);
TMP8923[6].typ = (&NTI138);
TMP8923[6].name = "frameDeclared";
TMP8925[6] = &TMP8923[7];
TMP8923[7].kind = 1;
TMP8923[7].offset = offsetof(Tcgen455038, isheaderfile);
TMP8923[7].typ = (&NTI138);
TMP8923[7].name = "isHeaderFile";
TMP8925[7] = &TMP8923[8];
TMP8923[8].kind = 1;
TMP8923[8].offset = offsetof(Tcgen455038, includesstringh);
TMP8923[8].typ = (&NTI138);
TMP8923[8].name = "includesStringh";
TMP8925[8] = &TMP8923[9];
TMP8923[9].kind = 1;
TMP8923[9].offset = offsetof(Tcgen455038, objhaskidsvalid);
TMP8923[9].typ = (&NTI138);
TMP8923[9].name = "objHasKidsValid";
TMP8925[9] = &TMP8923[10];
TMP8923[10].kind = 1;
TMP8923[10].offset = offsetof(Tcgen455038, cfilename);
TMP8923[10].typ = (&NTI149);
TMP8923[10].name = "cfilename";
TMP8925[10] = &TMP8923[11];
TMP8923[11].kind = 1;
TMP8923[11].offset = offsetof(Tcgen455038, typecache);
TMP8923[11].typ = (&NTI189861);
TMP8923[11].name = "typeCache";
TMP8925[11] = &TMP8923[12];
TMP8923[12].kind = 1;
TMP8923[12].offset = offsetof(Tcgen455038, forwtypecache);
TMP8923[12].typ = (&NTI189861);
TMP8923[12].name = "forwTypeCache";
TMP8925[12] = &TMP8923[13];
TMP8923[13].kind = 1;
TMP8923[13].offset = offsetof(Tcgen455038, declaredthings);
TMP8923[13].typ = (&NTI186056);
TMP8923[13].name = "declaredThings";
TMP8925[13] = &TMP8923[14];
TMP8923[14].kind = 1;
TMP8923[14].offset = offsetof(Tcgen455038, declaredprotos);
TMP8923[14].typ = (&NTI186056);
TMP8923[14].name = "declaredProtos";
TMP8925[14] = &TMP8923[15];
TMP8923[15].kind = 1;
TMP8923[15].offset = offsetof(Tcgen455038, headerfiles);
TMP8923[15].typ = (&NTI129028);
TMP8923[15].name = "headerFiles";
TMP8925[15] = &TMP8923[16];
TMP8923[16].kind = 1;
TMP8923[16].offset = offsetof(Tcgen455038, typeinfomarker);
TMP8923[16].typ = (&NTI186056);
TMP8923[16].name = "typeInfoMarker";
TMP8925[16] = &TMP8923[17];
NTI455034.size = sizeof(Tcproc455034);
NTI455034.kind = 18;
NTI455034.base = 0;
TMP8926[0] = &TMP8923[19];
TMP8923[19].kind = 1;
TMP8923[19].offset = offsetof(Tcproc455034, prc);
TMP8923[19].typ = (&NTI189811);
TMP8923[19].name = "prc";
TMP8926[1] = &TMP8923[20];
TMP8923[20].kind = 1;
TMP8923[20].offset = offsetof(Tcproc455034, beforeretneeded);
TMP8923[20].typ = (&NTI138);
TMP8923[20].name = "beforeRetNeeded";
TMP8926[2] = &TMP8923[21];
TMP8923[21].kind = 1;
TMP8923[21].offset = offsetof(Tcproc455034, threadvaraccessed);
TMP8923[21].typ = (&NTI138);
TMP8923[21].name = "threadVarAccessed";
TMP8926[3] = &TMP8923[22];
TMP8923[22].kind = 1;
TMP8923[22].offset = offsetof(Tcproc455034, lastlineinfo);
TMP8923[22].typ = (&NTI161338);
TMP8923[22].name = "lastLineInfo";
TMP8926[4] = &TMP8923[23];
TMP8923[23].kind = 1;
TMP8923[23].offset = offsetof(Tcproc455034, nestedtrystmts);
TMP8923[23].typ = (&NTI189807);
TMP8923[23].name = "nestedTryStmts";
TMP8926[5] = &TMP8923[24];
TMP8923[24].kind = 1;
TMP8923[24].offset = offsetof(Tcproc455034, inexceptblock);
TMP8923[24].typ = (&NTI108);
TMP8923[24].name = "inExceptBlock";
TMP8926[6] = &TMP8923[25];
TMP8923[25].kind = 1;
TMP8923[25].offset = offsetof(Tcproc455034, finallysafepoints);
TMP8923[25].typ = (&NTI159599);
TMP8923[25].name = "finallySafePoints";
TMP8926[7] = &TMP8923[26];
TMP8923[26].kind = 1;
TMP8923[26].offset = offsetof(Tcproc455034, labels);
TMP8923[26].typ = (&NTI3407);
TMP8923[26].name = "labels";
TMP8926[8] = &TMP8923[27];
NTI455032.size = sizeof(Tblock455032);
NTI455032.kind = 18;
NTI455032.base = 0;
NTI455032.flags = 2;
TMP8927[0] = &TMP8923[29];
TMP8923[29].kind = 1;
TMP8923[29].offset = offsetof(Tblock455032, id);
TMP8923[29].typ = (&NTI108);
TMP8923[29].name = "id";
TMP8927[1] = &TMP8923[30];
TMP8923[30].kind = 1;
TMP8923[30].offset = offsetof(Tblock455032, label);
TMP8923[30].typ = (&NTI159007);
TMP8923[30].name = "label";
TMP8927[2] = &TMP8923[31];
NTI455026.size = sizeof(Tcprocsections455026);
NTI455026.kind = 16;
NTI455026.base = (&NTI159007);
NTI455026.flags = 2;
TMP8923[31].kind = 1;
TMP8923[31].offset = offsetof(Tblock455032, sections);
TMP8923[31].typ = (&NTI455026);
TMP8923[31].name = "sections";
TMP8927[3] = &TMP8923[32];
TMP8923[32].kind = 1;
TMP8923[32].offset = offsetof(Tblock455032, isloop);
TMP8923[32].typ = (&NTI138);
TMP8923[32].name = "isLoop";
TMP8927[4] = &TMP8923[33];
TMP8923[33].kind = 1;
TMP8923[33].offset = offsetof(Tblock455032, nestedtrystmts);
TMP8923[33].typ = (&NTI112);
TMP8923[33].name = "nestedTryStmts";
TMP8927[5] = &TMP8923[34];
TMP8923[34].kind = 1;
TMP8923[34].offset = offsetof(Tblock455032, nestedexceptstmts);
TMP8923[34].typ = (&NTI112);
TMP8923[34].name = "nestedExceptStmts";
TMP8927[6] = &TMP8923[35];
TMP8923[35].kind = 1;
TMP8923[35].offset = offsetof(Tblock455032, framelen);
TMP8923[35].typ = (&NTI112);
TMP8923[35].name = "frameLen";
TMP8923[28].len = 7; TMP8923[28].kind = 2; TMP8923[28].sons = &TMP8927[0];
NTI455032.node = &TMP8923[28];
NTI455106.size = sizeof(TY455106*);
NTI455106.kind = 24;
NTI455106.base = (&NTI455032);
NTI455106.flags = 2;
NTI455106.marker = TMP8928;
TMP8923[27].kind = 1;
TMP8923[27].offset = offsetof(Tcproc455034, blocks);
TMP8923[27].typ = (&NTI455106);
TMP8923[27].name = "blocks";
TMP8926[9] = &TMP8923[36];
TMP8923[36].kind = 1;
TMP8923[36].offset = offsetof(Tcproc455034, breakidx);
TMP8923[36].typ = (&NTI108);
TMP8923[36].name = "breakIdx";
TMP8926[10] = &TMP8923[37];
TMP8923[37].kind = 1;
TMP8923[37].offset = offsetof(Tcproc455034, options);
TMP8923[37].typ = (&NTI152121);
TMP8923[37].name = "options";
TMP8926[11] = &TMP8923[38];
TMP8923[38].kind = 1;
TMP8923[38].offset = offsetof(Tcproc455034, maxframelen);
TMP8923[38].typ = (&NTI108);
TMP8923[38].name = "maxFrameLen";
TMP8926[12] = &TMP8923[39];
TMP8923[39].kind = 1;
TMP8923[39].offset = offsetof(Tcproc455034, module);
TMP8923[39].typ = (&NTI455028);
TMP8923[39].name = "module";
TMP8926[13] = &TMP8923[40];
TMP8923[40].kind = 1;
TMP8923[40].offset = offsetof(Tcproc455034, withinloop);
TMP8923[40].typ = (&NTI108);
TMP8923[40].name = "withinLoop";
TMP8926[14] = &TMP8923[41];
TMP8923[41].kind = 1;
TMP8923[41].offset = offsetof(Tcproc455034, splitdecls);
TMP8923[41].typ = (&NTI108);
TMP8923[41].name = "splitDecls";
TMP8926[15] = &TMP8923[42];
TMP8923[42].kind = 1;
TMP8923[42].offset = offsetof(Tcproc455034, gcframeid);
TMP8923[42].typ = (&NTI3407);
TMP8923[42].name = "gcFrameId";
TMP8926[16] = &TMP8923[43];
TMP8923[43].kind = 1;
TMP8923[43].offset = offsetof(Tcproc455034, gcframetype);
TMP8923[43].typ = (&NTI159007);
TMP8923[43].name = "gcFrameType";
TMP8923[18].len = 17; TMP8923[18].kind = 2; TMP8923[18].sons = &TMP8926[0];
NTI455034.node = &TMP8923[18];
NTI455030.size = sizeof(Tcproc455034*);
NTI455030.kind = 22;
NTI455030.base = (&NTI455034);
NTI455030.marker = TMP8929;
TMP8923[17].kind = 1;
TMP8923[17].offset = offsetof(Tcgen455038, initproc);
TMP8923[17].typ = (&NTI455030);
TMP8923[17].name = "initProc";
TMP8925[17] = &TMP8923[44];
TMP8923[44].kind = 1;
TMP8923[44].offset = offsetof(Tcgen455038, postinitproc);
TMP8923[44].typ = (&NTI455030);
TMP8923[44].name = "postInitProc";
TMP8925[18] = &TMP8923[45];
TMP8923[45].kind = 1;
TMP8923[45].offset = offsetof(Tcgen455038, preinitproc);
TMP8923[45].typ = (&NTI455030);
TMP8923[45].name = "preInitProc";
TMP8925[19] = &TMP8923[46];
TMP8923[46].kind = 1;
TMP8923[46].offset = offsetof(Tcgen455038, typestack);
TMP8923[46].typ = (&NTI189845);
TMP8923[46].name = "typeStack";
TMP8925[20] = &TMP8923[47];
TMP8923[47].kind = 1;
TMP8923[47].offset = offsetof(Tcgen455038, datacache);
TMP8923[47].typ = (&NTI189873);
TMP8923[47].name = "dataCache";
TMP8925[21] = &TMP8923[48];
TMP8923[48].kind = 1;
TMP8923[48].offset = offsetof(Tcgen455038, forwardedprocs);
TMP8923[48].typ = (&NTI189815);
TMP8923[48].name = "forwardedProcs";
TMP8925[22] = &TMP8923[49];
TMP8923[49].kind = 1;
TMP8923[49].offset = offsetof(Tcgen455038, typenodes);
TMP8923[49].typ = (&NTI108);
TMP8923[49].name = "typeNodes";
TMP8925[23] = &TMP8923[50];
TMP8923[50].kind = 1;
TMP8923[50].offset = offsetof(Tcgen455038, nimtypes);
TMP8923[50].typ = (&NTI108);
TMP8923[50].name = "nimTypes";
TMP8925[24] = &TMP8923[51];
TMP8923[51].kind = 1;
TMP8923[51].offset = offsetof(Tcgen455038, typenodesname);
TMP8923[51].typ = (&NTI159007);
TMP8923[51].name = "typeNodesName";
TMP8925[25] = &TMP8923[52];
TMP8923[52].kind = 1;
TMP8923[52].offset = offsetof(Tcgen455038, nimtypesname);
TMP8923[52].typ = (&NTI159007);
TMP8923[52].name = "nimTypesName";
TMP8925[26] = &TMP8923[53];
TMP8923[53].kind = 1;
TMP8923[53].offset = offsetof(Tcgen455038, labels);
TMP8923[53].typ = (&NTI3407);
TMP8923[53].name = "labels";
TMP8925[27] = &TMP8923[54];
NTI455143.size = sizeof(TY455143);
NTI455143.kind = 16;
NTI455143.base = (&NTI159007);
NTI455143.flags = 2;
TMP8923[54].kind = 1;
TMP8923[54].offset = offsetof(Tcgen455038, extensionloaders);
TMP8923[54].typ = (&NTI455143);
TMP8923[54].name = "extensionLoaders";
TMP8925[28] = &TMP8923[55];
TMP8923[55].kind = 1;
TMP8923[55].offset = offsetof(Tcgen455038, injectstmt);
TMP8923[55].typ = (&NTI159007);
TMP8923[55].name = "injectStmt";
TMP8923[0].len = 29; TMP8923[0].kind = 2; TMP8923[0].sons = &TMP8925[0];
NTI455038.node = &TMP8923[0];
NTI455028.size = sizeof(Tcgen455038*);
NTI455028.kind = 22;
NTI455028.base = (&NTI455038);
NTI455028.marker = TMP8931;
NTI455155.size = sizeof(TY455155*);
NTI455155.kind = 24;
NTI455155.base = (&NTI455028);
NTI455155.marker = TMP8932;
}
