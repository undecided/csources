...
static NIM_CONST TY192031 TMP7621 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7622, "sym", 3);
static NIM_CONST TY192031 TMP7623 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7624, "sons", 4);
STRING_LITERAL(TMP7627, "evaltempl.nim", 13);
NIM_CONST TY147210 TMP7626 = {((NimStringDesc*) &TMP7627),
((NI) 39)}
;
						...
						y_384083 = 0;
						{
							...
							res_384146 = ((NI) 0);
							{
								...
								while (1) {
									...
									TMP7625 = addInt(res_384146, ((NI) 1));
									res_384146 = (NI)(TMP7625);
								} LA20: ;
							}
						}
					}
		...
		res = copynode_384027((&(*c)), templ, actual);
		{
			...
			res_384153 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7629 = addInt(res_384153, ((NI) 1));
					res_384153 = (NI)(TMP7629);
				} LA52: ;
			}
		}
...
N_NIMCALL(Tnode191813*, evaltemplateargs_384184)(Tnode191813* n, Tsym191843* s) {
	...
	{
		if (!(f < a)) goto LA5;
		globalerror_165134((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7630));
	}
	LA5: ;
		...
		res_384237 = ((NI) 1);
		{
			...
			while (1) {
				...
				LA12: ;
				{
					...
					if (!(((TMP7621[(*(*(*(*s).typ).n).kindU.S6.sons->data[i_384204]).kind/8] &(1<<((*(*(*(*s).typ).n).kindU.S6.sons->data[i_384204]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7622));
				...
				nimln(70, "evaltempl.nim");
				{
					...
					localerror_165155((*n).info, ((NU16) 133), ((NimStringDesc*) &TMP7630));
				}
				LA19: ;
				nimln(72, "evaltempl.nim");
				addson_193819(result, arg);
				nimln(1614, "system.nim");
				TMP7632 = addInt(res_384237, ((NI) 1));
				res_384237 = (NI)(TMP7632);
			} LA9: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, evaltemplate_384260)(Tnode191813* n, Tsym191843* tmpl, Tsym191843* gensymowner) {
	...
	TMP7633 = addInt(evaltemplatecounter_384256, ((NI) 1));
	evaltemplatecounter_384256 = (NI)(TMP7633);
	nimln(79, "evaltempl.nim");
	{
		if (!(((NI) 100) < evaltemplatecounter_384256)) goto LA3;
		nimln(80, "evaltempl.nim");
		globalerror_165134((*n).info, ((NU16) 183), ((NimStringDesc*) &TMP7630));
		...
		LA20: ;
		{
			...
			res_384325 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP7635 = addInt(res_384325, ((NI) 1));
					res_384325 = (NI)(TMP7635);
				} LA25: ;
			}
		}
	}
	...
	TMP7636 = subInt(evaltemplatecounter_384256, ((NI) 1));
	evaltemplatecounter_384256 = (NI)(TMP7636);
	popFrame();
	return result;
}
