...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP3347, "\012", 1);
STRING_LITERAL(TMP3358, "", 0);
STRING_LITERAL(TMP3361, "end", 3);
STRING_LITERAL(TMP3362, "#end", 4);
static NIM_CONST TY77659 TMP3365 = {
...
STRING_LITERAL(TMP3371, "\\x", 2);
STRING_LITERAL(TMP3373, "\\\\", 2);
STRING_LITERAL(TMP3375, "\\\'", 2);
STRING_LITERAL(TMP3377, "\\\"", 2);
STRING_LITERAL(TMP3381, "}", 1);
STRING_LITERAL(TMP3389, "$", 1);
STRING_LITERAL(TMP3391, "\\n\"", 3);
STRING_LITERAL(TMP3392, "subschar", 8);
STRING_LITERAL(TMP3393, "metachar", 8);
STRING_LITERAL(TMP3394, "emit", 4);
STRING_LITERAL(TMP3395, "result.add", 10);
STRING_LITERAL(TMP3396, "conc", 4);
STRING_LITERAL(TMP3397, " & ", 3);
STRING_LITERAL(TMP3398, "tostring", 8);
...
N_NIMCALL(void, parseline_216149)(Ttmplparser216020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 26):
		{
			...
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3364), ((NI) 0), ((NI) 2147483647))));
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3367), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(Tllstream176204*, filtertmpl_216009)(Tllstream176204* stdin_216011, NimStringDesc* filename, Tnode189813* call) {
	...
	p.outp = llstreamopen_176220(((NimStringDesc*) &TMP3358));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_216011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_215020(call, ((NimStringDesc*) &TMP3392), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_215020(call, ((NimStringDesc*) &TMP3393), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_215029(call, ((NimStringDesc*) &TMP3394), ((NI) 3), ((NimStringDesc*) &TMP3395));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_215029(call, ((NimStringDesc*) &TMP3396), ((NI) 4), ((NimStringDesc*) &TMP3397));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_215029(call, ((NimStringDesc*) &TMP3398), ((NI) 5), ((NimStringDesc*) &TMP3389));
	...
	p.x = rawNewString(((NI) 120));
	{
		...
		while (1) {
			...
			TMP3399 = addInt(p.info.line, ((NI16) 1));
			if (TMP3399 < -32768 || TMP3399 > 32767) raiseOverflow();
			p.info.line = (NI16)(TMP3399);
