					...
					s_406099 = inittabiter_197124((&it_406097), HEX3Atmp_406094);
					{
						...
						while (1) {
							...
							nimln(26, "locals.nim");
							{
								...
								field = newsym_190656(((NU8) 19), (*it_406039).name, LOC18, (*n).info);
								nimln(31, "locals.nim");
...
NIM_EXTERNC N_NOINLINE(void, compiler_localsInit)(void) {
	...
	nimln(42, "locals.nim");
	registerplugin_405124(((NimStringDesc*) &TMP8092), ((NimStringDesc*) &TMP8093), ((NimStringDesc*) &TMP8094), semlocals_406020);
	popFrame();
}
