				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							if (!(LOC15)) goto LA16;
							LOC15 = !(eqStrings(y_171213, ((NimStringDesc*) &TMP1814)));
							LA16: ;
							if (!LOC15) goto LA17;
							...
							nimln(1305, "os.nim");
							{
								...
								nimln(1307, "os.nim");
								{
									...
									TMP1815 = addInt(k_171217, ((NI) 1));
									if (TMP1815 < 0 || TMP1815 > 3) raiseOverflow();
									k_171217 = (NU8)(TMP1815);
								}
								LA29: ;
								nimln(1302, "os.nim");
								...
								nimln(69, "nimblecmd.nim");
								{
									...
									if (!(LOC33)) goto LA34;
									LOC33 = nsuEndsWith(path_171195, ((NimStringDesc*) &TMP1820));
									LA34: ;
									if (!LOC33) goto LA35;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC49) goto LA50;
								TMP1821 = addInt(k_171217, ((NI) 1));
								if (TMP1821 < 0 || TMP1821 > 3) raiseOverflow();
								k_171217 = (NU8)(TMP1821);
							}
							LA50: ;
							nimln(1302, "os.nim");
							kind_171194 = k_171217;
							...
							nimln(69, "nimblecmd.nim");
							{
								...
								if (!(LOC54)) goto LA55;
								LOC54 = nsuEndsWith(path_171195, ((NimStringDesc*) &TMP1820));
								LA55: ;
								if (!LOC54) goto LA56;
								nimln(70, "nimblecmd.nim");
								result = NIM_TRUE;
					...
					while (1) {
						{
							...
							nimln(1299, "os.nim");
							{
								...
								if (!(LOC21)) goto LA22;
								LOC21 = !(eqStrings(y_171228, ((NimStringDesc*) &TMP1814)));
								LA22: ;
								if (!LOC21) goto LA23;
								...
								nimln(1313, "os.nim");
								{
									...
									if (!LOC54) goto LA55;
									TMP1823 = addInt(k_171232, ((NI) 1));
									if (TMP1823 < 0 || TMP1823 > 3) raiseOverflow();
									k_171232 = (NU8)(TMP1823);
								}
								LA55: ;
								nimln(1302, "os.nim");
								kind_171218 = k_171232;
				...
				while (1) {
					{
						...
						nimln(1299, "os.nim");
						{
							...
							if (!(LOC19)) goto LA20;
							LOC19 = !(eqStrings(y_171312, ((NimStringDesc*) &TMP1814)));
							LA20: ;
							if (!LOC19) goto LA21;
							...
							nimln(1313, "os.nim");
							{
								...
								if (!LOC53) goto LA54;
								TMP1827 = addInt(k_171316, ((NI) 1));
								if (TMP1827 < 0 || TMP1827 > 3) raiseOverflow();
								k_171316 = (NU8)(TMP1827);
							}
							LA54: ;
							nimln(1302, "os.nim");
							k_171292 = k_171316;
				...
				res_171330 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(44, "strtabs.nim");
						{
							...
							{
								if (!eqStrings(val_171324, ((NimStringDesc*) &TMP1806))) goto LA74;
...
appendString(LOC77, val_171324);
						...
						TMP1828 = addInt(res_171330, ((NI) 1));
						res_171330 = (NI)(TMP1828);
					} LA67: ;
				}
			}
		}
