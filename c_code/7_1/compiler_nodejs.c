...
STRING_LITERAL(TMP10788, "nodejs", 6);
STRING_LITERAL(TMP10789, "node", 4);
...
N_NIMCALL(NimStringDesc*, findnodejs_525009)(void) {
	...
	result = 0;
	nimln(4, "nodejs.nim");
	result = findexe_126616(((NimStringDesc*) &TMP10788));
	nimln(5, "nodejs.nim");
	{
		if (!((result) && (result)->Sup.len == 0)) goto LA3;
		nimln(6, "nodejs.nim");
		result = findexe_126616(((NimStringDesc*) &TMP10789));
	}
	LA3: ;
	popFrame();
	return result;
