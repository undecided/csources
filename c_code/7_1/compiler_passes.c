...
static NIM_CONST TY190031 TMP4113 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4114, "sons", 4);
STRING_LITERAL(TMP4130, "len(a) == L seq modified while iterating over it", 48);
STRING_LITERAL(TMP4131, "-", 1);
STRING_LITERAL(TMP4132, "stdinfile", 9);
...
N_NIMCALL(NIM_BOOL, astneeded_240093)(Tsym189843* s) {
	...
	nimln(73, "passes.nim");
	{
		...
		if (!(LOC3)) goto LA8;
		nimln(76, "passes.nim");
		if (((TMP4113[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4114));
...
N_NIMCALL(void, registerpass_240190)(Tpass240017 p) {
	...
	nimln(97, "passes.nim");
	TMP4115 = addInt(gpasseslen_240176, ((NI) 1));
	gpasseslen_240176 = (NI)(TMP4115);
	popFrame();
}
...
N_NIMCALL(void, openpasses_240293)(Tpasscontext240005** a, Tsym189843* module) {
	nimfr("openPasses", "passes.nim")
	{
		...
		TMP4117 = subInt(gpasseslen_240176, ((NI) 1));
		HEX3Atmp_240319 = (NI)(TMP4117);
		...
		res_240322 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4118 = addInt(res_240322, ((NI) 1));
				res_240322 = (NI)(TMP4118);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, openpassescached_240342)(Tpasscontext240005** a, Tsym189843* module, Trodreader232030* rd) {
	nimfr("openPassesCached", "passes.nim")
	{
		...
		TMP4119 = subInt(gpasseslen_240176, ((NI) 1));
		HEX3Atmp_240381 = (NI)(TMP4119);
		nimln(1598, "system.nim");
		res_240384 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA4: ;
				nimln(1614, "system.nim");
				TMP4120 = addInt(res_240384, ((NI) 1));
				res_240384 = (NI)(TMP4120);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, closepasses_240404)(Tpasscontext240005** a) {
	...
	m = NIM_NIL;
	{
		...
		TMP4121 = subInt(gpasseslen_240176, ((NI) 1));
		HEX3Atmp_240431 = (NI)(TMP4121);
		nimln(1598, "system.nim");
		res_240434 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4122 = addInt(res_240434, ((NI) 1));
				res_240434 = (NI)(TMP4122);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	...
	m = n;
	{
		...
		TMP4123 = subInt(gpasseslen_240176, ((NI) 1));
		HEX3Atmp_240490 = (NI)(TMP4123);
		nimln(1598, "system.nim");
		res_240493 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4124 = addInt(res_240493, ((NI) 1));
				res_240493 = (NI)(TMP4124);
			} LA3: ;
		}
	}
...
N_NIMCALL(void, processtoplevelstmtcached_240513)(Tnode189813* n, Tpasscontext240005** a) {
	...
	m = n;
	{
		...
		TMP4125 = subInt(gpasseslen_240176, ((NI) 1));
		HEX3Atmp_240540 = (NI)(TMP4125);
		nimln(1598, "system.nim");
		res_240543 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4126 = addInt(res_240543, ((NI) 1));
				res_240543 = (NI)(TMP4126);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, closepassescached_240563)(Tpasscontext240005** a) {
	...
	m = NIM_NIL;
	{
		...
		TMP4127 = subInt(gpasseslen_240176, ((NI) 1));
		HEX3Atmp_240597 = (NI)(TMP4127);
		nimln(1598, "system.nim");
		res_240600 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4128 = addInt(res_240600, ((NI) 1));
				res_240600 = (NI)(TMP4128);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("processImplicits", "passes.nim")
	{
		...
		L_240646 = (implicits ? implicits->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP4129 = addInt(i_240644, ((NI) 1));
				i_240644 = (NI)(TMP4129);
				nimln(3089, "system.nim");
				{
					if (!!(((implicits ? implicits->Sup.len : 0) == L_240646))) goto LA11;
					failedassertimpl_87017(((NimStringDesc*) &TMP4130));
				}
				LA11: ;
			} LA3: ;
		}
...
{	memset((void*)(&p), 0, sizeof(p));
	...
	nimln(169, "passes.nim");
	{
		...
		nimln(171, "passes.nim");
		{
			...
			{
				NimStringDesc* LOC13;
				if (!eqStrings((*(*module).name).s, ((NimStringDesc*) &TMP4131))) goto LA11;
				nimln(174, "passes.nim");
				LOC13 = 0;
				LOC13 = (*(*module).name).s; (*(*module).name).s = copyStringRC1(((NimStringDesc*) &TMP4132));
	...
	LA3: ;
	{
		...
		n = loadinitsection_232077(rd);
		{
			...
			TMP4133 = subInt(LOC43, ((NI) 1));
			HEX3Atmp_240777 = (NI)(TMP4133);
			nimln(1598, "system.nim");
			res_240780 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					i_240766 = res_240780;
					nimln(207, "passes.nim");
					if (((TMP4113[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4114));
					...
					nimln(1614, "system.nim");
					TMP4134 = addInt(res_240780, ((NI) 1));
					res_240780 = (NI)(TMP4134);
				} LA45: ;
			}
		}
...
static TNimNode* TMP6327[2];
static TNimNode TMP4029[4];
NTI240005.size = sizeof(Tpasscontext240005);
NTI240005.kind = 17;
NTI240005.base = (&NTI3411);
NTI240005.flags = 1;
TMP4029[0].kind = 1;
TMP4029[0].offset = offsetof(Tpasscontext240005, fromcache);
TMP4029[0].typ = (&NTI138);
TMP4029[0].name = "fromCache";
NTI240005.node = &TMP4029[0];
...
TMP6327[0] = &TMP4029[2];
TMP4029[2].kind = 1;
TMP4029[2].offset = offsetof(Tpassdata240019, Field0);
TMP4029[2].typ = (&NTI189805);
TMP4029[2].name = "Field0";
TMP6327[1] = &TMP4029[3];
TMP4029[3].kind = 1;
TMP4029[3].offset = offsetof(Tpassdata240019, Field1);
TMP4029[3].typ = (&NTI189805);
TMP4029[3].name = "Field1";
TMP4029[1].len = 2; TMP4029[1].kind = 2; TMP4029[1].sons = &TMP6327[0];
NTI240019.node = &TMP4029[1];
}
