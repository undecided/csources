...
N_NIMCALL(void, loadfile_247041)(Tlineinfo161338 info) {
	...
	nimln(25, "prettybase.nim");
	{
		...
		gsourcefiles_247036 = (TY247019*) setLengthSeq(&(gsourcefiles_247036)->Sup, sizeof(Tsourcefile247008), ((NI)chckRange((NI32)(TMP4268), ((NI) 0), ((NI) 2147483647))));
	}
	LA3: ;
	nimln(27, "prettybase.nim");
	{
		...
		gsourcefiles_247036->data[i].isnimfixfile = eqStrings(LOC10.Field2, ((NimStringDesc*) &TMP4269));
		{
		...
		pos = lex.bufpos;
		{
			...
			while (1) {
				...
				case 13:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_247036->Sup.len)) raiseIndexError();
					LOC21 = 0;
					LOC21 = gsourcefiles_247036->data[i].newline; gsourcefiles_247036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4271));
				...
				case 0:
				{
					...
					if ((NU)(i) >= (NU)(gsourcefiles_247036->Sup.len)) raiseIndexError();
					LOC23 = 0;
					LOC23 = gsourcefiles_247036->data[i].newline; gsourcefiles_247036->data[i].newline = copyStringRC1(((NimStringDesc*) &TMP4272));
...
{	nimln(64, "prettybase.nim");
	...
	if ((NU)((NI16)(TMP4277)) >= (NU)(gsourcefiles_247036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_247036->data[info.fileindex].lines->data[(NI16)(TMP4277)];
...
appendString(LOC25, LOC27);
		...
		asgnRefNoCycle((void**) (&gsourcefiles_247036->data[info.fileindex].lines->data[(NI16)(TMP4285)]), x);
...
N_NIMCALL(void, replacecomment_247286)(Tlineinfo161338 info) {
	...
	if ((NU)((NI16)(TMP4286)) >= (NU)(gsourcefiles_247036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	line = gsourcefiles_247036->data[info.fileindex].lines->data[(NI16)(TMP4286)];
...
appendString(LOC5, LOC8);
	...
	if ((NU)((NI16)(TMP4292)) >= (NU)(gsourcefiles_247036->data[info.fileindex].lines->Sup.len)) raiseIndexError();
	asgnRefNoCycle((void**) (&gsourcefiles_247036->data[info.fileindex].lines->data[(NI16)(TMP4292)]), x);
