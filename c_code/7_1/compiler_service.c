...
N_NIMCALL(void, serve_520254)(TY520256 action) {
	...
	typ = getconfigvar_152334(((NimStringDesc*) &TMP10640));
	...
	LA2: ;
	{
		...
		p = getconfigvar_152334(((NimStringDesc*) &TMP10646));
		...
		LOC20 = 0;
		LOC20 = getconfigvar_152334(((NimStringDesc*) &TMP10647));
		...
		writelnhook_162060.ClPrc = LOC21.ClPrc;
		{
			...
			while (1) {
				...
				send_517208((*HEX3Aenv_520447).stdoutsocket520408, ((NimStringDesc*) &TMP10650), 2);
...
NIM_EXTERNC N_NOINLINE(void, compiler_serviceInit)(void) {
	...
	LOC1 = 0;
	LOC1 = curcaascmd_520204; curcaascmd_520204 = copyStringRC1(((NimStringDesc*) &TMP10627));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	nimln(25, "service.nim");
	LOC2 = 0;
	LOC2 = lastcaascmd_520205; lastcaascmd_520205 = copyStringRC1(((NimStringDesc*) &TMP10627));
...
TMP10606[1].kind = 1;
TMP10606[1].offset = offsetof(TY520426, HEX3Astate);
TMP10606[1].typ = (&NTI169807);
TMP10606[1].name = ":state";
TMP10635[1] = &TMP10606[2];
TMP10606[2].kind = 1;
TMP10606[2].offset = offsetof(TY520426, stdoutsocket520408);
TMP10606[2].typ = (&NTI512409);
TMP10606[2].name = "stdoutSocket520408";
TMP10606[0].len = 2; TMP10606[0].kind = 2; TMP10606[0].sons = &TMP10635[0];
NTI520426.node = &TMP10606[0];
NTI520448.size = sizeof(TY520426*);
NTI520448.kind = 22;
NTI520448.base = (&NTI520426);
NTI520448.flags = 2;
NTI520448.marker = TMP10639;
}
