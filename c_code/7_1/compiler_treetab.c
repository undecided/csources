	...
	{
		{
			...
			res_241092 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4156 = addInt(res_241092, ((NI) 1));
					res_241092 = (NI)(TMP4156);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_241191 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4158 = addInt(res_241191, ((NI) 1));
							res_241191 = (NI)(TMP4158);
						} LA28: ;
					}
				}
...
N_NIMCALL(void, nodetableput_241415)(Tnodetable189873* t, Tnode189813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			n = (Tnodepairseq189871*) newSeq((&NTI189871), ((NI)chckRange((NI)(TMP4163), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_241639;
				NI HEX3Atmp_241676;
				NI res_241679;
...
N_NIMCALL(NI, nodetabletestorset_241698)(Tnodetable189873* t, Tnode189813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq189871*) newSeq((&NTI189871), ((NI)chckRange((NI)(TMP4166), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_241839;
				NI HEX3Atmp_241876;
				NI res_241879;
