...
STRING_LITERAL(TMP7480, "", 0);
STRING_LITERAL(TMP7481, "\012", 1);
STRING_LITERAL(TMP7485, "void", 4);
STRING_LITERAL(TMP7487, "none", 4);
STRING_LITERAL(TMP7488, "bool", 4);
STRING_LITERAL(TMP7489, "char", 4);
STRING_LITERAL(TMP7490, "nil", 3);
STRING_LITERAL(TMP7491, "expr", 4);
STRING_LITERAL(TMP7492, "stmt", 4);
STRING_LITERAL(TMP7493, "void", 4);
STRING_LITERAL(TMP7494, "array", 5);
STRING_LITERAL(TMP7495, "typeDesc", 8);
STRING_LITERAL(TMP7496, "typeDesc", 8);
STRING_LITERAL(TMP7498, "distinct", 8);
STRING_LITERAL(TMP7499, "tuple", 5);
STRING_LITERAL(TMP7500, "set", 3);
STRING_LITERAL(TMP7501, "ptr", 3);
STRING_LITERAL(TMP7502, "ref", 3);
STRING_LITERAL(TMP7503, "var", 3);
STRING_LITERAL(TMP7504, "seq", 3);
STRING_LITERAL(TMP7505, "proc", 4);
STRING_LITERAL(TMP7506, "openArray", 9);
STRING_LITERAL(TMP7507, "range", 5);
static NIM_CONST TY190031 TMP7508 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7509, "sons", 4);
STRING_LITERAL(TMP7510, "pointer", 7);
STRING_LITERAL(TMP7511, "string", 6);
STRING_LITERAL(TMP7512, "cstring", 7);
STRING_LITERAL(TMP7513, "int", 3);
STRING_LITERAL(TMP7514, "int8", 4);
STRING_LITERAL(TMP7515, "int16", 5);
STRING_LITERAL(TMP7516, "int32", 5);
STRING_LITERAL(TMP7517, "int64", 5);
STRING_LITERAL(TMP7518, "float", 5);
STRING_LITERAL(TMP7519, "float32", 7);
STRING_LITERAL(TMP7520, "float64", 7);
STRING_LITERAL(TMP7521, "float128", 8);
STRING_LITERAL(TMP7522, "uint", 4);
STRING_LITERAL(TMP7523, "uint8", 5);
STRING_LITERAL(TMP7524, "uint16", 6);
STRING_LITERAL(TMP7525, "uint32", 6);
STRING_LITERAL(TMP7526, "uint64", 6);
STRING_LITERAL(TMP7527, "bignum", 6);
STRING_LITERAL(TMP7528, "const", 5);
STRING_LITERAL(TMP7529, "mutable", 7);
STRING_LITERAL(TMP7530, "varargs", 7);
STRING_LITERAL(TMP7531, "iter", 4);
STRING_LITERAL(TMP7532, "error", 5);
STRING_LITERAL(TMP7533, "builtinTypeClass", 16);
STRING_LITERAL(TMP7534, "concept", 7);
STRING_LITERAL(TMP7535, "compositeTypeClass", 18);
STRING_LITERAL(TMP7536, "and", 3);
STRING_LITERAL(TMP7537, "or", 2);
STRING_LITERAL(TMP7538, "not", 3);
STRING_LITERAL(TMP7539, "anything", 8);
STRING_LITERAL(TMP7540, "static", 6);
...
N_NIMCALL(NimStringDesc*, readoutput_379009)(Processobj142402* p) {
	...
	result = 0;
	nimln(13, "vmdeps.nim");
	result = copyString(((NimStringDesc*) &TMP7480));
	nimln(14, "vmdeps.nim");
...
appendString(result, ((NimStringDesc*) &TMP7481));
		} LA2: ;
	}
	nimln(18, "vmdeps.nim");
	TMP7482 = subInt((result ? result->Sup.len : 0), ((NI) 1));
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7482), ((NI) 0), ((NI) 2147483647))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
...
N_NIMCALL(NimStringDesc*, opgorge_379027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	if (TMP7483.status == 0) {
		...
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP7480), LOC2, 0, NIM_NIL, 4);
		nimln(24, "vmdeps.nim");
		{
		...
		res_379133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_379126 = atomictypex_379066(((NimStringDesc*) &TMP7485), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7486 = addInt(res_379133, ((NI) 1));
				res_379133 = (NI)(TMP7486);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode189813*, maptypetoast_379080)(Ttype189849* t, Tlineinfo161338 info, NIM_BOOL allowrecursion) {
	...
	{
		nimln(72, "vmdeps.nim");
		result = atomictypex_379066(((NimStringDesc*) &TMP7493), t, info);
	}
	break;
	case ((NU8) 4):
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_379066(((NimStringDesc*) &TMP7494), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_379066(((NimStringDesc*) &TMP7495), t, info);
		...
		{
			nimln(84, "vmdeps.nim");
			result = atomictypex_379066(((NimStringDesc*) &TMP7496), t, info);
		}
		LA13: ;
	}
	break;
		...
		result = newnodeit_191807(((NU8) 42), info, t);
		{
			...
			res_379246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7497 = addInt(res_379246, ((NI) 1));
					res_379246 = (NI)(TMP7497);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 27):
	{
		...
		result = maptypetobracket_379088(((NimStringDesc*) &TMP7506), t, info);
	}
	break;
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_379066(((NimStringDesc*) &TMP7507), t, info);
		add_190164(result, LOC61);
		nimln(121, "vmdeps.nim");
		if (((TMP7508[(*(*t).n).kind/8] &(1<<((*(*t).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7509));
	...
	case ((NU8) 49):
	{
		...
		result = maptypetobracket_379088(((NimStringDesc*) &TMP7531), t, info);
	}
	break;
	case ((NU8) 50):
	{
		nimln(145, "vmdeps.nim");
		result = atomictypex_379066(((NimStringDesc*) &TMP7532), t, info);
	}
	break;
	case ((NU8) 51):
	{
	...
	case ((NU8) 57):
	{
		...
		result = maptypetobracket_379088(((NimStringDesc*) &TMP7538), t, info);
	}
	break;
	case ((NU8) 58):
	{
		nimln(154, "vmdeps.nim");
		result = atomictypex_379066(((NimStringDesc*) &TMP7539), t, info);
	}
	break;
	case ((NU8) 59):
	case ((NU8) 60):
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_379066(((NimStringDesc*) &TMP7540), t, info);
