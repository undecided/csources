...
appendString((*result), ind);
		...
		lvl = nsuRepeatChar(lvltochar_295274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5019), ((NI) 0), ((NI) 2147483647))));
...
appendString((*result), ind);
		...
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5021), ((NI) 0), ((NI) 2147483647))));
...
appendString((*result), tmp);
		...
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5034), ((NI) 0), ((NI) 2147483647))));
