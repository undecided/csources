...
N_NIMCALL(void, fillbuffer_245102)(Baselexer245024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4229)]))), ((NI)chckRange((NI)(TMP4230), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
	...
	LOC13 = 0;
	LOC13 = readdata_137174((*L).input, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP4232));
		...
		s = (NI)(TMP4236);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4240), ((NI) 0), ((NI) 2147483647))));
					...
					LOC39 = 0;
					LOC39 = readdata_137174((*L).input, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP4243));
...
N_NIMCALL(void, open_245040)(Baselexer245024* L, Streamobj137027* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4258), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_245064)(Baselexer245024* L, NI pos) {
	...
	if ((NI)(TMP4260) == (-2147483647 -1)) raiseOverflow();
...
TMP4269[0] = &TMP4223[1];
TMP4223[1].kind = 1;
TMP4223[1].offset = offsetof(Baselexer245024, bufpos);
TMP4223[1].typ = (&NTI108);
TMP4223[1].name = "bufpos";
TMP4269[1] = &TMP4223[2];
TMP4223[2].kind = 1;
TMP4223[2].offset = offsetof(Baselexer245024, buf);
TMP4223[2].typ = (&NTI151);
TMP4223[2].name = "buf";
TMP4269[2] = &TMP4223[3];
TMP4223[3].kind = 1;
TMP4223[3].offset = offsetof(Baselexer245024, buflen);
TMP4223[3].typ = (&NTI108);
TMP4223[3].name = "bufLen";
TMP4269[3] = &TMP4223[4];
TMP4223[4].kind = 1;
TMP4223[4].offset = offsetof(Baselexer245024, input);
TMP4223[4].typ = (&NTI137025);
TMP4223[4].name = "input";
TMP4269[4] = &TMP4223[5];
TMP4223[5].kind = 1;
TMP4223[5].offset = offsetof(Baselexer245024, linenumber);
TMP4223[5].typ = (&NTI108);
TMP4223[5].name = "lineNumber";
TMP4269[5] = &TMP4223[6];
TMP4223[6].kind = 1;
TMP4223[6].offset = offsetof(Baselexer245024, sentinel);
TMP4223[6].typ = (&NTI108);
TMP4223[6].name = "sentinel";
TMP4269[6] = &TMP4223[7];
TMP4223[7].kind = 1;
TMP4223[7].offset = offsetof(Baselexer245024, linestart);
TMP4223[7].typ = (&NTI108);
TMP4223[7].name = "lineStart";
TMP4269[7] = &TMP4223[8];
TMP4223[8].kind = 1;
TMP4223[8].offset = offsetof(Baselexer245024, fileopened);
TMP4223[8].typ = (&NTI138);
TMP4223[8].name = "fileOpened";
TMP4223[0].len = 8; TMP4223[0].kind = 2; TMP4223[0].sons = &TMP4269[0];
NTI245024.node = &TMP4223[0];
}
