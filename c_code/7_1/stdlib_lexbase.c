...
N_NIMCALL(void, fillbuffer_245102)(Baselexer245024* L) {
	...
	nimln(82, "lexbase.nim");
	{
		...
		memmove(((void*) ((*L).buf)), ((void*) ((&(*L).buf[(NI)(TMP4230)]))), ((NI)chckRange((NI)(TMP4231), ((NI) 0), ((NI) 2147483647))));
	}
	LA11: ;
		...
		s = (NI)(TMP4237);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC34 = 0;
					LOC34 = realloc_6033(((void*) ((*L).buf)), ((NI)chckRange((NI)(TMP4241), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, open_245040)(Baselexer245024* L, Streamobj137027* input, NI buflen) {
	...
	LOC9 = 0;
	LOC9 = alloc_6001(((NI)chckRange((NI)(TMP4259), ((NI) 0), ((NI) 2147483647))));
	(*L).buf = ((NCSTRING) (LOC9));
...
N_NIMCALL(NI, getcolnumber_245064)(Baselexer245024* L, NI pos) {
	...
	if ((NI)(TMP4261) == (-2147483647 -1)) raiseOverflow();
