...
N_NIMCALL(void, TMP5995)(void* p, NI op);
...
N_NIMCALL(void, TMP7585)(void* p, NI op);
...
static N_INLINE(NI, rightsize_154407)(NI count) {
	...
	result = nextpoweroftwo_147531(((NI)chckRange((NI)(TMP738), ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, inittable_161368)(NI initialsize, Table161376* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).data), (Keyvaluepairseq161379*) newSeq((&NTI161379), ((NI)chckRange(initialsize, ((NI) 0), ((NI) 2147483647)))));
	popFrame();
}
...
N_NIMCALL(void, enlarge_161672)(Table161376* t) {
	...
	n = (Keyvaluepairseq161379*) newSeq((&NTI161379), ((NI)chckRange((NI)(TMP1208), ((NI) 0), ((NI) 2147483647))));
...
N_NIMCALL(void, inittable_310116)(NI initialsize, Table310052* Result) {
	...
	(*Result).counter = ((NI) 0);
	nimln(315, "tables.nim");
	unsureAsgnRef((void**) (&(*Result).data), (Keyvaluepairseq310055*) newSeq((&NTI310055), ((NI)chckRange(initialsize, ((NI) 0), ((NI) 2147483647)))));
	popFrame();
}
...
N_NIMCALL(void, enlarge_311185)(Table310052* t) {
	...
	n = 0;
	nimln(224, "tables.nim");
	TMP5909 = mulInt(((*t).data ? (*t).data->Sup.len : 0), ((NI) 2));
	n = (Keyvaluepairseq310055*) newSeq((&NTI310055), ((NI)chckRange((NI)(TMP5909), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_311294 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5912 = addInt(res_311294, ((NI) 1));
				res_311294 = (NI)(TMP5912);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, HEX5BHEX5DHEX3D_311148)(Table310052* t, NimStringDesc* key, NI val) {
	...
	LA3: ;
	{
		...
		LA9: ;
		nimln(242, "tables.nim");
		TMP5913 = subInt(((NI) -1), index);
		index = (NI)(TMP5913);
		nimln(243, "tables.nim");
		rawinsert_311265(t, (&(*t).data), key, val, hc, index);
		nimln(244, "tables.nim");
		TMP5914 = addInt((*t).counter, ((NI) 1));
		(*t).counter = (NI)(TMP5914);
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(void, inittable_313724)(NI initialsize, Table311409* Result) {
	...
	(*Result).counter = ((NI) 0);
	nimln(315, "tables.nim");
	unsureAsgnRef((void**) (&(*Result).data), (Keyvaluepairseq311412*) newSeq((&NTI311412), ((NI)chckRange(initialsize, ((NI) 0), ((NI) 2147483647)))));
	popFrame();
}
...
N_NIMCALL(void, enlarge_314109)(Table311409* t) {
	...
	n = 0;
	nimln(224, "tables.nim");
	TMP5996 = mulInt(((*t).data ? (*t).data->Sup.len : 0), ((NI) 2));
	n = (Keyvaluepairseq311412*) newSeq((&NTI311412), ((NI)chckRange((NI)(TMP5996), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_314227 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP5999 = addInt(res_314227, ((NI) 1));
				res_314227 = (NI)(TMP5999);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, HEX5BHEX5DHEX3D_314072)(Table311409* t, Tindexentry311396 key, TY311897* val) {
	...
	LA3: ;
	{
		...
		LA9: ;
		nimln(242, "tables.nim");
		TMP6000 = subInt(((NI) -1), index);
		index = (NI)(TMP6000);
		nimln(243, "tables.nim");
		rawinsert_314198(t, (&(*t).data), key, val, hc, index);
		nimln(244, "tables.nim");
		TMP6001 = addInt((*t).counter, ((NI) 1));
		(*t).counter = (NI)(TMP6001);
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(void, enlarge_381198)(Table380650* t) {
	...
	n = 0;
	nimln(224, "tables.nim");
	TMP7583 = mulInt(((*t).data ? (*t).data->Sup.len : 0), ((NI) 2));
	n = (Keyvaluepairseq380653*) newSeq((&NTI380653), ((NI)chckRange((NI)(TMP7583), ((NI) 0), ((NI) 2147483647))));
	nimln(225, "tables.nim");
	LOC1 = 0;
	LOC1 = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = LOC1;
	{
		...
		res_381307 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA8: ;
				nimln(1614, "system.nim");
				TMP7588 = addInt(res_381307, ((NI) 1));
				res_381307 = (NI)(TMP7588);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, HEX5BHEX5DHEX3D_381161)(Table380650* t, NI64 key, Tnode189813* val) {
	...
	LA3: ;
	{
		...
		LA9: ;
		nimln(242, "tables.nim");
		TMP7589 = subInt(((NI) -1), index);
		index = (NI)(TMP7589);
		nimln(243, "tables.nim");
		rawinsert_381278(t, (&(*t).data), key, val, hc, index);
		nimln(244, "tables.nim");
		TMP7590 = addInt((*t).counter, ((NI) 1));
		(*t).counter = (NI)(TMP7590);
	}
	LA1: ;
	popFrame();
}
...
N_NIMCALL(void, inittable_381469)(NI initialsize, Table380650* Result) {
	...
	(*Result).counter = ((NI) 0);
	nimln(315, "tables.nim");
	unsureAsgnRef((void**) (&(*Result).data), (Keyvaluepairseq380653*) newSeq((&NTI380653), ((NI)chckRange(initialsize, ((NI) 0), ((NI) 2147483647)))));
	popFrame();
}
...
static TNimNode* TMP5994[3];
static TNimNode* TMP6259[2];
static TNimNode* TMP7584[3];
...
TMP730[15].len = 2; TMP730[15].kind = 2; TMP730[15].sons = &TMP6259[0];
