	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_238265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4076 = addInt(res_238265, ((NI) 1));
				res_238265 = (NI)(TMP4076);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_238306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4077 = addInt(res_238306, ((NI) 1));
				res_238306 = (NI)(TMP4077);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_238347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4078 = addInt(res_238347, ((NI) 1));
				res_238347 = (NI)(TMP4078);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_238388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4079 = addInt(res_238388, ((NI) 1));
				res_238388 = (NI)(TMP4079);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_238429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4080 = addInt(res_238429, ((NI) 1));
				res_238429 = (NI)(TMP4080);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_238470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4081 = addInt(res_238470, ((NI) 1));
				res_238470 = (NI)(TMP4081);
			} LA3: ;
		}
	}
