	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_240265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4075 = addInt(res_240265, ((NI) 1));
				res_240265 = (NI)(TMP4075);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_240306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4076 = addInt(res_240306, ((NI) 1));
				res_240306 = (NI)(TMP4076);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_240347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4077 = addInt(res_240347, ((NI) 1));
				res_240347 = (NI)(TMP4077);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_240388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4078 = addInt(res_240388, ((NI) 1));
				res_240388 = (NI)(TMP4078);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_240429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4079 = addInt(res_240429, ((NI) 1));
				res_240429 = (NI)(TMP4079);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_240470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4080 = addInt(res_240470, ((NI) 1));
				res_240470 = (NI)(TMP4080);
			} LA3: ;
		}
	}
