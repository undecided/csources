...
N_NIMCALL(void, newline_216047)(Ttmplparser216020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3346));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_216149)(Ttmplparser216020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_163155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3360));
			}
			LA20: ;
			...
			llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3361));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
		...
		case ((NU16) 26):
		{
			...
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3363), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3366), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		(*p).state = ((NU8) 1);
		{
			...
			while (1) {
				...
				case 128 ... 255:
				{
					...
					llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3370));
				...
				case 92:
				{
					...
					llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3372));
				...
				case 39:
				{
					...
					llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3374));
				...
				case 34:
				{
					...
					llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3376));
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_163155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3380));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_163155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3388));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3390));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream176204*, filtertmpl_216009)(Tllstream176204* stdin_216011, NimStringDesc* filename, Tnode189813* call) {
	...
	p.outp = llstreamopen_176220(((NimStringDesc*) &TMP3357));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_216011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_215020(call, ((NimStringDesc*) &TMP3391), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_215020(call, ((NimStringDesc*) &TMP3392), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_215029(call, ((NimStringDesc*) &TMP3393), ((NI) 3), ((NimStringDesc*) &TMP3394));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_215029(call, ((NimStringDesc*) &TMP3395), ((NI) 4), ((NimStringDesc*) &TMP3396));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_215029(call, ((NimStringDesc*) &TMP3397), ((NI) 5), ((NimStringDesc*) &TMP3388));
