...
N_NIMCALL(NIM_BOOL, endswithopr_178450)(NimStringDesc* x) {
	...
	result = endswith_178404(x, TMP2090);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_178460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_178404(line, TMP2091);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_178686)(Tllstream178204* s, NimStringDesc* data) {
	...
	llstreamwrite_178665(s, ((NimStringDesc*) &TMP2087));
	popFrame();
}
...
NTI178202.node = &TMP2079[6];
TMP2079[1].kind = 1;
TMP2079[1].offset = offsetof(Tllstream178204, kind);
TMP2079[1].typ = (&NTI178202);
TMP2079[1].name = "kind";
TMP2081[1] = &TMP2079[7];
TMP2079[7].kind = 1;
TMP2079[7].offset = offsetof(Tllstream178204, f);
TMP2079[7].typ = (&NTI13004);
TMP2079[7].name = "f";
TMP2081[2] = &TMP2079[8];
TMP2079[8].kind = 1;
TMP2079[8].offset = offsetof(Tllstream178204, s);
TMP2079[8].typ = (&NTI149);
TMP2079[8].name = "s";
TMP2081[3] = &TMP2079[9];
TMP2079[9].kind = 1;
TMP2079[9].offset = offsetof(Tllstream178204, rd);
TMP2079[9].typ = (&NTI108);
TMP2079[9].name = "rd";
TMP2081[4] = &TMP2079[10];
TMP2079[10].kind = 1;
TMP2079[10].offset = offsetof(Tllstream178204, wr);
TMP2079[10].typ = (&NTI108);
TMP2079[10].name = "wr";
TMP2081[5] = &TMP2079[11];
TMP2079[11].kind = 1;
TMP2079[11].offset = offsetof(Tllstream178204, lineoffset);
TMP2079[11].typ = (&NTI108);
TMP2079[11].name = "lineOffset";
TMP2079[0].len = 6; TMP2079[0].kind = 2; TMP2079[0].sons = &TMP2081[0];
NTI178204.node = &TMP2079[0];
NTI178206.size = sizeof(Tllstream178204*);
NTI178206.kind = 22;
NTI178206.base = (&NTI178204);
NTI178206.marker = TMP2085;
}
