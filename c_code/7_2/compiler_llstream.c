...
N_NIMCALL(NIM_BOOL, endswithopr_176450)(NimStringDesc* x) {
	...
	result = endswith_176404(x, TMP2091);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_176460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_176404(line, TMP2092);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_176686)(Tllstream176204* s, NimStringDesc* data) {
	...
	llstreamwrite_176665(s, ((NimStringDesc*) &TMP2088));
	popFrame();
}
...
NTI176202.node = &TMP2080[6];
TMP2080[1].kind = 1;
TMP2080[1].offset = offsetof(Tllstream176204, kind);
TMP2080[1].typ = (&NTI176202);
TMP2080[1].name = "kind";
TMP2082[1] = &TMP2080[7];
TMP2080[7].kind = 1;
TMP2080[7].offset = offsetof(Tllstream176204, f);
TMP2080[7].typ = (&NTI13004);
TMP2080[7].name = "f";
TMP2082[2] = &TMP2080[8];
TMP2080[8].kind = 1;
TMP2080[8].offset = offsetof(Tllstream176204, s);
TMP2080[8].typ = (&NTI149);
TMP2080[8].name = "s";
TMP2082[3] = &TMP2080[9];
TMP2080[9].kind = 1;
TMP2080[9].offset = offsetof(Tllstream176204, rd);
TMP2080[9].typ = (&NTI108);
TMP2080[9].name = "rd";
TMP2082[4] = &TMP2080[10];
TMP2080[10].kind = 1;
TMP2080[10].offset = offsetof(Tllstream176204, wr);
TMP2080[10].typ = (&NTI108);
TMP2080[10].name = "wr";
TMP2082[5] = &TMP2080[11];
TMP2080[11].kind = 1;
TMP2080[11].offset = offsetof(Tllstream176204, lineoffset);
TMP2080[11].typ = (&NTI108);
TMP2080[11].name = "lineOffset";
TMP2080[0].len = 6; TMP2080[0].kind = 2; TMP2080[0].sons = &TMP2082[0];
NTI176204.node = &TMP2080[0];
NTI176206.size = sizeof(Tllstream176204*);
NTI176206.kind = 22;
NTI176206.base = (&NTI176204);
NTI176206.marker = TMP2086;
}
