...
N_NIMCALL(Tllstream176204*, llstreamopen_176276)(void);
N_NIMCALL(Tllstream176204*, llstreamopenstdin_176293)(void);
N_NIMCALL(void, llstreamclose_176310)(Tllstream176204* s);
N_NIMCALL(NIM_BOOL, readlinefromstdin_176319)(NimStringDesc* prompt, NimStringDesc** line);
...
static N_INLINE(NIM_BOOL, continueline_176460)(NimStringDesc* line, NIM_BOOL intriplestring);
N_NIMCALL(NI, counttriples_176483)(NimStringDesc* s);
static N_INLINE(NI, addInt)(NI a, NI b);
N_NIMCALL(NI, llreadfromstdin_176528)(Tllstream176204* s, void* buf, NI buflen);
...
N_NIMCALL(void, llstreamwrite_176718)(Tllstream176204* s, void* buf, NI buflen);
N_NIMCALL(NimStringDesc*, llstreamreadall_176739)(Tllstream176204* s);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
NIM_CONST TY77659 Additionallinecontinuationoprs_176445 = {
0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
static NIM_CONST TY77659 TMP2090 = {
0x00, 0x00, 0x00, 0x00, 0x72, 0xBC, 0x00, 0xD0,
0x01, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x50,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
N_NIMCALL(Tllstream176204*, llstreamopen_176220)(NimStringDesc* data) {
	...
	result = (Tllstream176204*) newObj((&NTI176206), sizeof(Tllstream176204));
	(*result).Sup.m_type = (&NTI176204);
...
N_NIMCALL(Tllstream176204*, llstreamopenstdin_176293)(void) {
	...
	LOC1 = 0;
	LOC1 = (*result).s; (*result).s = copyStringRC1(((NimStringDesc*) &TMP2086));
	if (LOC1) nimGCunrefNoCycle(LOC1);
...
N_NIMCALL(NIM_BOOL, readlinefromstdin_176319)(NimStringDesc* prompt, NimStringDesc** line) {
	...
	nimln(70, "llstream.nim");
	{
		...
		write_13457(stdout, ((NimStringDesc*) &TMP2087));
...
N_NIMCALL(NIM_BOOL, endswith_176404)(NimStringDesc* x, TY77659 s) {
	...
	TMP2088 = subInt((x ? x->Sup.len : 0), ((NI) 1));
	i = (NI)(TMP2088);
	{
...
N_NIMCALL(NIM_BOOL, endswithopr_176450)(NimStringDesc* x) {
	...
	result = endswith_176404(x, TMP2090);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_176460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_176404(line, TMP2091);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
	...
	i = ((NI) 0);
	{
		...
		while (1) {
			...
			nimln(97, "llstream.nim");
			{
				...
				if (!(LOC6)) goto LA7;
				TMP2092 = addInt(i, ((NI) 1));
				if ((NU)((NI)(TMP2092)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC6 = ((NU8)(s->data[(NI)(TMP2092)]) == (NU8)(34));
				LA7: ;
				LOC5 = LOC6;
				if (!(LOC5)) goto LA8;
				TMP2093 = addInt(i, ((NI) 2));
				if ((NU)((NI)(TMP2093)) > (NU)(s->Sup.len)) raiseIndexError();
				LOC5 = ((NU8)(s->data[(NI)(TMP2093)]) == (NU8)(34));
				LA8: ;
				if (!LOC5) goto LA9;
				nimln(98, "llstream.nim");
				TMP2094 = addInt(result, ((NI) 1));
				result = (NI)(TMP2094);
...
N_NIMCALL(NI, llreadfromstdin_176528)(Tllstream176204* s, void* buf, NI buflen) {
	...
	LOC1 = 0;
	LOC1 = (*s).s; (*s).s = copyStringRC1(((NimStringDesc*) &TMP2086));
	if (LOC1) nimGCunrefNoCycle(LOC1);
	...
	triples = ((NI) 0);
	{
		...
		while (1) {
			...
			LOC4 = 0;
			{
				...
				LOC4 = copyString(((NimStringDesc*) &TMP2097));
			}
			goto LA5;
			LA7: ;
			{
			...
			LA5: ;
			LOC10 = 0;
			LOC10 = readlinefromstdin_176319(LOC4, (&line));
			if (!LOC10) goto LA3;
...
appendString((*s).s, ((NimStringDesc*) &TMP2087));
			nimln(110, "llstream.nim");
			LOC11 = 0;
			LOC11 = counttriples_176483(line);
			TMP2099 = addInt(triples, LOC11);
			triples = (NI)(TMP2099);
			nimln(111, "llstream.nim");
			{
				NIM_BOOL LOC14;
				LOC14 = 0;
				LOC14 = continueline_176460(line, (((NI) ((NI)(triples & ((NI) 1)))) == ((NI) 1)));
				if (!!(LOC14)) goto LA15;
				goto LA2;
			}
			LA15: ;
	...
	TMP2100 = addInt((*s).lineoffset, ((NI) 1));
	(*s).lineoffset = (NI)(TMP2100);
...
N_NIMCALL(NI, llstreamread_176584)(Tllstream176204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		...
		nimln(124, "llstream.nim");
		{
			...
			TMP2104 = addInt(((NI) 0), (*s).rd);
			if ((NU)((NI)(TMP2104)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(buf, ((void*) ((&(*s).s->data[(NI)(TMP2104)]))), ((NI)chckRange(result, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(126, "llstream.nim");
			TMP2105 = addInt((*s).rd, result);
			(*s).rd = (NI)(TMP2105);
		}
		LA5: ;
	}
	...
	case ((NU8) 3):
	{
		...
		result = llreadfromstdin_176528(s, buf, buflen);
	}
	break;
	}
	popFrame();
...
appendString((*s).s, data);
		...
		TMP2110 = addInt((*s).wr, (data ? data->Sup.len : 0));
		(*s).wr = (NI)(TMP2110);
	}
	break;
	case ((NU8) 2):
...
N_NIMCALL(void, llstreamwriteln_176686)(Tllstream176204* s, NimStringDesc* data) {
	...
	llstreamwrite_176665(s, ((NimStringDesc*) &TMP2087));
	popFrame();
}
...
N_NIMCALL(void, llstreamwrite_176718)(Tllstream176204* s, void* buf, NI buflen) {
	...
	case ((NU8) 1):
	{
		nimln(187, "llstream.nim");
		{
			...
			TMP2112 = addInt(((*s).s ? (*s).s->Sup.len : 0), buflen);
			(*s).s = setLengthStr((*s).s, ((NI)chckRange((NI)(TMP2112), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(189, "llstream.nim");
			TMP2113 = addInt(((NI) 0), (*s).wr);
			if ((NU)((NI)(TMP2113)) > (NU)((*s).s->Sup.len)) raiseIndexError();
			memcpy(((void*) ((&(*s).s->data[(NI)(TMP2113)]))), buf, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
			nimln(190, "llstream.nim");
			TMP2114 = addInt((*s).wr, buflen);
			(*s).wr = (NI)(TMP2114);
		}
		LA5: ;
	}
	...
	case ((NU8) 2):
	{
		...
		i = bytes;
		{
			...
			while (1) {
				...
				TMP2115 = addInt(i, ((NI) 2048));
				result = setLengthStr(result, ((NI)chckRange((NI)(TMP2115), ((NI) 0), ((NI) IL64(9223372036854775807)))));
				nimln(210, "llstream.nim");
				TMP2116 = addInt(i, ((NI) 0));
				if ((NU)((NI)(TMP2116)) > (NU)(result->Sup.len)) raiseIndexError();
				bytes = readbuffer_13515((*s).f, ((void*) ((&result->data[(NI)(TMP2116)]))), ((NI) 2048));
				nimln(211, "llstream.nim");
				TMP2117 = addInt(i, bytes);
				i = (NI)(TMP2117);
			} LA10: ;
		}
...
static TNimNode* TMP2081[6];
static TNimNode* TMP2082[4];
NI TMP2084;
static char* NIM_CONST TMP2083[4] = {
"llsNone", 
"llsString", 
"llsFile", 
"llsStdIn"};
static TNimNode TMP2079[12];
...
NTI176202.base = 0;
NTI176202.flags = 3;
for (TMP2084 = 0; TMP2084 < 4; TMP2084++) {
TMP2079[TMP2084+2].kind = 1;
TMP2079[TMP2084+2].offset = TMP2084;
TMP2079[TMP2084+2].name = TMP2083[TMP2084];
TMP2082[TMP2084] = &TMP2079[TMP2084+2];
}
TMP2079[6].len = 4; TMP2079[6].kind = 2; TMP2079[6].sons = &TMP2082[0];
NTI176202.node = &TMP2079[6];
TMP2079[1].kind = 1;
TMP2079[1].offset = offsetof(Tllstream176204, kind);
TMP2079[1].typ = (&NTI176202);
TMP2079[1].name = "kind";
TMP2081[1] = &TMP2079[7];
TMP2079[7].kind = 1;
TMP2079[7].offset = offsetof(Tllstream176204, f);
TMP2079[7].typ = (&NTI13004);
TMP2079[7].name = "f";
TMP2081[2] = &TMP2079[8];
TMP2079[8].kind = 1;
TMP2079[8].offset = offsetof(Tllstream176204, s);
TMP2079[8].typ = (&NTI149);
TMP2079[8].name = "s";
TMP2081[3] = &TMP2079[9];
TMP2079[9].kind = 1;
TMP2079[9].offset = offsetof(Tllstream176204, rd);
TMP2079[9].typ = (&NTI108);
TMP2079[9].name = "rd";
TMP2081[4] = &TMP2079[10];
TMP2079[10].kind = 1;
TMP2079[10].offset = offsetof(Tllstream176204, wr);
TMP2079[10].typ = (&NTI108);
TMP2079[10].name = "wr";
TMP2081[5] = &TMP2079[11];
TMP2079[11].kind = 1;
TMP2079[11].offset = offsetof(Tllstream176204, lineoffset);
TMP2079[11].typ = (&NTI108);
TMP2079[11].name = "lineOffset";
TMP2079[0].len = 6; TMP2079[0].kind = 2; TMP2079[0].sons = &TMP2081[0];
NTI176204.node = &TMP2079[0];
NTI176206.size = sizeof(Tllstream176204*);
NTI176206.kind = 22;
NTI176206.base = (&NTI176204);
NTI176206.marker = TMP2085;
}
