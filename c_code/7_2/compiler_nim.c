...
STRING_LITERAL(TMP10790, "./", 2);
STRING_LITERAL(TMP10791, "", 0);
STRING_LITERAL(TMP10793, "nim.cfg", 7);
STRING_LITERAL(TMP10794, "-", 1);
STRING_LITERAL(TMP10795, "stdinfile", 9);
STRING_LITERAL(TMP10796, "js", 2);
...
appendString(LOC7, ((NimStringDesc*) &TMP10790));
appendString(LOC7, f);
		result = LOC7;
	}
	LA1: ;
...
N_NIMCALL(void, handlecmdline_526607)(void) {
	...
	{
		nimln(40, "nim.nim");
		processcmdline_520209(((NU8) 0), ((NimStringDesc*) &TMP10791));
		nimln(41, "nim.nim");
		{
			TSafePoint TMP10792;
			TY118589 p;
			...
			nimln(42, "nim.nim");
			pushSafePoint(&TMP10792);
			TMP10792.status = _setjmp(TMP10792.context);
			if (TMP10792.status == 0) {
				nimln(43, "nim.nim");
			...
			if (TMP10792.status != 0) reraiseException();
		...
		LA7: ;
		nimln(51, "nim.nim");
		loadconfigs_184809(((NimStringDesc*) &TMP10793));
		nimln(54, "nim.nim");
		initvars_168876();
		nimln(55, "nim.nim");
		processcmdline_520209(((NU8) 1), ((NimStringDesc*) &TMP10791));
		nimln(56, "nim.nim");
		maincommand_523628();
		nimln(57, "nim.nim");
		{
		...
		nimln(59, "nim.nim");
		{
			if (!(gerrorcounter_162012 == ((NI) 0))) goto LA25;
			nimln(63, "nim.nim");
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_152234, ((NimStringDesc*) &TMP10794))) goto LA33;
					nimln(65, "nim.nim");
					LOC35 = 0;
					LOC35 = gprojectfull_152236; gprojectfull_152236 = copyStringRC1(((NimStringDesc*) &TMP10795));
				...
				nimln(66, "nim.nim");
				{
					...
					LA42: ;
					{
						...
						nimln(72, "nim.nim");
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_152236, ((NimStringDesc*) &TMP10796));
						LOC47 = 0;
...
appendString(LOC49, ((NimStringDesc*) &TMP10797));
appendString(LOC49, ex);
appendChar(LOC49, 32);
appendString(LOC49, arguments_175721);
					execexternalprogram_168985(LOC49, ((NimStringDesc*) &TMP10791));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						...
						nimln(81, "nim.nim");
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_152236, ((NimStringDesc*) &TMP10791));
...
appendString(LOC58, arguments_175721);
					execexternalprogram_168985(LOC58, ((NimStringDesc*) &TMP10791));
				}
				LA36: ;
			}
			LA29: ;
...
NIM_EXTERNC N_NOINLINE(void, nimInit)(void) {
	...
	nimln(95, "nim.nim");
	msgquit_162104(((NI8) ((((NI) 0) < gerrorcounter_162012))));
	popFrame();
}
