...
STRING_LITERAL(TMP2476, "@if", 3);
STRING_LITERAL(TMP2477, "@", 1);
STRING_LITERAL(TMP2480, "@end", 4);
STRING_LITERAL(TMP2482, "putenv", 6);
STRING_LITERAL(TMP2483, "prependenv", 10);
STRING_LITERAL(TMP2484, "appendenv", 9);
STRING_LITERAL(TMP2485, "-", 1);
STRING_LITERAL(TMP2486, "--", 2);
STRING_LITERAL(TMP2487, "", 0);
STRING_LITERAL(TMP2488, "\']\'", 3);
STRING_LITERAL(TMP2489, "%=", 2);
STRING_LITERAL(TMP2490, "&", 1);
STRING_LITERAL(TMP2496, "config", 6);
STRING_LITERAL(TMP2497, "etc", 3);
STRING_LITERAL(TMP2498, "/etc/", 5);
STRING_LITERAL(TMP2499, "/usr", 4);
STRING_LITERAL(TMP2500, "/usr/lib/nim", 12);
STRING_LITERAL(TMP2501, "/usr/local", 10);
STRING_LITERAL(TMP2502, "/usr/local/lib/nim", 18);
STRING_LITERAL(TMP2503, "lib", 3);
STRING_LITERAL(TMP2507, "nimcfg", 6);
STRING_LITERAL(TMP2508, "nim.cfg", 7);
STRING_LITERAL(TMP2509, "nimrod.cfg", 10);
...
N_NIMCALL(void, doend_184191)(Tlexer179185* L, Ttoken179181* tok) {
	...
	nimln(61, "nimconf.nim");
	{
		...
		lexmessage_179483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2476));
	}
	LA3: ;
	...
	nestedifs = ((NI) 0);
	{
		...
		while (1) {
			nimln(85, "nimconf.nim");
			{
				...
				if (!(LOC5)) goto LA6;
				LOC5 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2477));
				LA6: ;
				if (!LOC5) goto LA7;
				...
				case ((NU16) 31):
				{
					...
					TMP2478 = addInt(nestedifs, ((NI) 1));
					nestedifs = (NI)(TMP2478);
				}
				break;
				case ((NU16) 21):
				{
			...
			LA7: ;
			{
				...
				lexmessage_179483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2480));
			}
			goto LA3;
			LA36: ;
			{
...
N_NIMCALL(void, parsedirective_184342)(Tlexer179185* L, Ttoken179181* tok) {
	...
	case ((NU16) 31):
	{
		...
		TMP2481 = addInt((condstack_184186 ? condstack_184186->Sup.len : 0), ((NI) 1));
		condstack_184186 = (TY184169*) setLengthSeq(&(condstack_184186)->Sup, sizeof(NIM_BOOL), ((NI)chckRange((NI)(TMP2481), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	...
	default:
	{
		...
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2482))) goto LA15;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2483))) goto LA16;
		if (eqStrings(LOC14, ((NimStringDesc*) &TMP2484))) goto LA17;
		goto LA18;
		LA15: ;
		{
			NimStringDesc* key;
...
N_NIMCALL(void, conftok_184377)(Tlexer179185* L, Ttoken179181* tok) {
	...
	ppgettok_184009(L, tok);
	{
		...
		while (1) {
			...
			if (!(LOC3)) goto LA4;
			LOC3 = eqStrings((*(*tok).ident).s, ((NimStringDesc*) &TMP2477));
			LA4: ;
			if (!LOC3) goto LA2;
...
N_NIMCALL(void, parseassignment_184439)(Tlexer179185* L, Ttoken179181* tok) {
	...
	nimln(159, "nimconf.nim");
	{
		...
		LOC3 = 0;
		LOC4 = 0;
		LOC4 = getident_165463(((NimStringDesc*) &TMP2485));
		LOC3 = ((*(*tok).ident).Sup.id == (*LOC4).Sup.id);
		if (LOC3) goto LA5;
		LOC6 = 0;
		LOC6 = getident_165463(((NimStringDesc*) &TMP2486));
	...
	val = copyString(((NimStringDesc*) &TMP2487));
	{
...
appendString(val, LOC16);
		...
		LA19: ;
		{
			...
			lexmessage_179483((&(*L)), ((NU16) 23), ((NimStringDesc*) &TMP2488));
		}
		LA17: ;
	...
	LOC22 = 0;
	LOC22 = getident_165463(((NimStringDesc*) &TMP2489));
...
appendString(val, LOC33);
		...
		conftok_184377(L, tok);
		{
			...
			while (1) {
				...
				if (!(LOC36)) goto LA37;
				LOC38 = 0;
				LOC38 = getident_165463(((NimStringDesc*) &TMP2490));
...
N_NIMCALL(NimStringDesc*, getsystemconfigpath_184594)(NimStringDesc* filename) {
	...
	LOC1[0] = copyString(p);
	LOC1[1] = copyString(((NimStringDesc*) &TMP2496));
	...
	nimln(225, "nimconf.nim");
	{
		...
		LOC7[0] = copyString(p);
		LOC7[1] = copyString(((NimStringDesc*) &TMP2497));
...
appendString(LOC13, ((NimStringDesc*) &TMP2498));
...
N_NIMCALL(void, loadconfigs_184809)(NimStringDesc* cfg) {
	...
	nimln(230, "nimconf.nim");
	{
		...
		{
			NimStringDesc* LOC9;
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP2499))) goto LA7;
			LOC9 = 0;
			LOC9 = libpath_152233; libpath_152233 = copyStringRC1(((NimStringDesc*) &TMP2500));
		...
		LA7: ;
		{
			...
			if (!eqStrings(prefix, ((NimStringDesc*) &TMP2501))) goto LA11;
			LOC13 = 0;
			LOC13 = libpath_152233; libpath_152233 = copyStringRC1(((NimStringDesc*) &TMP2502));
		...
		LA11: ;
		{
			...
			asgnRefNoCycle((void**) (&libpath_152233), nosjoinPath(prefix, ((NimStringDesc*) &TMP2503)));
		}
		LA5: ;
	}
	LA3: ;
			...
			{
				{
					...
					HEX3Atmp_185055 = 0;
					nimln(643, "os.nim");
					TMP2504 = subInt((pd ? pd->Sup.len : 0), ((NI) 2));
					HEX3Atmp_185055 = (NI)(TMP2504);
					...
					res_185057 = ((NI) 0);
					{
						...
						while (1) {
							...
							nimln(645, "os.nim");
							{
								...
								LOC60 = (i_185053 == ((NI) 0));
								if (LOC60) goto LA61;
								TMP2505 = subInt(i_185053, ((NI) 1));
								if ((NU)((NI)(TMP2505)) > (NU)(pd->Sup.len)) raiseIndexError();
								LOC60 = !((((NU8)(pd->data[(NI)(TMP2505)])) == ((NU8)(47)) || ((NU8)(pd->data[(NI)(TMP2505)])) == ((NU8)(47))));
								LA61: ;
								LOC58 = LOC60;
								LA59: ;
								if (!LOC58) goto LA62;
							...
							TMP2506 = addInt(res_185057, ((NI) 1));
							res_185057 = (NI)(TMP2506);
						} LA55: ;
					}
				}
				nimln(649, "os.nim");
