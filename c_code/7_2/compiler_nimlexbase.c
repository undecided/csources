...
N_NIMCALL(void, fillbuffer_179097)(Tbaselexer179024* L) {
	...
	LOC13 = 0;
	LOC13 = llstreamread_178584((*L).stream, ((void*) ((&(*L).buf[tocopy]))), (NI)(TMP2125));
		...
		s = (NI)(TMP2129);
		{
			...
			while (1) {
				...
				LA31: ;
				{
					...
					LOC39 = 0;
					LOC39 = llstreamread_178584((*L).stream, ((void*) ((&(*L).buf[oldbuflen]))), (NI)(TMP2136));
...
TMP2491[0] = &TMP2077[1];
TMP2077[1].kind = 1;
TMP2077[1].offset = offsetof(Tbaselexer179024, bufpos);
TMP2077[1].typ = (&NTI108);
TMP2077[1].name = "bufpos";
TMP2491[1] = &TMP2077[2];
TMP2077[2].kind = 1;
TMP2077[2].offset = offsetof(Tbaselexer179024, buf);
TMP2077[2].typ = (&NTI151);
TMP2077[2].name = "buf";
TMP2491[2] = &TMP2077[3];
TMP2077[3].kind = 1;
TMP2077[3].offset = offsetof(Tbaselexer179024, buflen);
TMP2077[3].typ = (&NTI108);
TMP2077[3].name = "bufLen";
TMP2491[3] = &TMP2077[4];
TMP2077[4].kind = 1;
TMP2077[4].offset = offsetof(Tbaselexer179024, stream);
TMP2077[4].typ = (&NTI178206);
TMP2077[4].name = "stream";
TMP2491[4] = &TMP2077[5];
TMP2077[5].kind = 1;
TMP2077[5].offset = offsetof(Tbaselexer179024, linenumber);
TMP2077[5].typ = (&NTI108);
TMP2077[5].name = "lineNumber";
TMP2491[5] = &TMP2077[6];
TMP2077[6].kind = 1;
TMP2077[6].offset = offsetof(Tbaselexer179024, sentinel);
TMP2077[6].typ = (&NTI108);
TMP2077[6].name = "sentinel";
TMP2491[6] = &TMP2077[7];
TMP2077[7].kind = 1;
TMP2077[7].offset = offsetof(Tbaselexer179024, linestart);
TMP2077[7].typ = (&NTI108);
TMP2077[7].name = "lineStart";
TMP2077[0].len = 7; TMP2077[0].kind = 2; TMP2077[0].sons = &TMP2491[0];
NTI179024.node = &TMP2077[0];
}
