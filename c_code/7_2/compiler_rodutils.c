...
STRING_LITERAL(TMP2697, "NAN", 3);
STRING_LITERAL(TMP2698, "0.0", 3);
STRING_LITERAL(TMP2699, "INF", 3);
STRING_LITERAL(TMP2700, "-INF", 4);
STRING_LITERAL(TMP2708, "", 0);
STRING_LITERAL(TMP2716, "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 62);
STRING_LITERAL(TMP2724, "contains({\'a\'..\'z\', \'A\'..\'Z\', \'0\'..\'9\', \'-\', \'\\x80\'..\'\\xFF\'}, s"
"[i]) ", 68);
...
N_NIMCALL(void, encodestr_196042)(NimStringDesc* s, NimStringDesc** result) {
	nimfr("encodeStr", "rodutils.nim")
	{
		...
		TMP2701 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		HEX3Atmp_196069 = (NI)(TMP2701);
...
appendString((*result), LOC6);
				...
				TMP2702 = addInt(res_196072, ((NI) 1));
				res_196072 = (NI)(TMP2702);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, hexchar_196091)(NIM_CHAR c, NI* xi) {
	...
	case 48 ... 57:
	{
		...
		TMP2703 = subInt(((NI) (((NU8)(c)))), ((NI) 48));
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2703))));
	}
	break;
	case 97 ... 102:
	{
		...
		TMP2704 = subInt(((NI) (((NU8)(c)))), ((NI) 97));
		TMP2705 = addInt(((NI) ((NI)(TMP2704))), ((NI) 10));
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2705))));
	}
	break;
	case 65 ... 70:
	{
		...
		TMP2706 = subInt(((NI) (((NU8)(c)))), ((NI) 65));
		TMP2707 = addInt(((NI) ((NI)(TMP2706))), ((NI) 10));
		(*xi) = (NI)((NI)((NU64)((*xi)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP2707))));
	}
	break;
	default:
	{
...
N_NIMCALL(NimStringDesc*, decodestr_196157)(NCSTRING s, NI* pos) {
	...
	result = copyString(((NimStringDesc*) &TMP2708));
	{
		...
		while (1) {
			...
			case 92:
			{
				...
				TMP2709 = addInt(i, ((NI) 3));
				i = (NI)(TMP2709);
				nimln(48, "rodutils.nim");
				xi = ((NI) 0);
				nimln(49, "rodutils.nim");
				TMP2710 = subInt(i, ((NI) 2));
				hexchar_196091(s[(NI)(TMP2710)], (&xi));
				nimln(50, "rodutils.nim");
				TMP2711 = subInt(i, ((NI) 1));
				hexchar_196091(s[(NI)(TMP2711)], (&xi));
...
N_NIMCALL(void, encodevbiggestintaux_196230)(NI64 x, NimStringDesc** result) {
	...
	TMP2713 = modInt64(v_196238, IL64(190));
	rem_196240 = (NI64)(TMP2713);
	nimln(71, "rodutils.nim");
	{
		...
		TMP2714 = divInt64(v_196238, IL64(190));
		if ((NI64)(TMP2714) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_196238 = -((NI64)(TMP2714));
	...
	LA3: ;
	{
		...
		TMP2715 = divInt64(v_196238, IL64(190));
		v_196238 = (NI64)(TMP2715);
	}
	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_196242) > (NU)(((NimStringDesc*) &TMP2716)->Sup.len)) raiseIndexError();
		d_196236 = ((NimStringDesc*) &TMP2716)->data[idx_196242];
	}
	goto LA6;
	LA8: ;
	{
		...
		TMP2717 = subInt(idx_196242, ((NI) 62));
		TMP2718 = addInt((NI)(TMP2717), ((NI) 128));
		d_196236 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2718), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_196269)(NI x, NimStringDesc** result) {
	...
	v_196277 = x;
	nimln(70, "rodutils.nim");
	TMP2719 = modInt(v_196277, ((NI) 190));
	rem_196279 = (NI)(TMP2719);
	nimln(71, "rodutils.nim");
	{
		NI TMP2720;
		...
		(*result) = addChar((*result), 45);
		nimln(73, "rodutils.nim");
		TMP2720 = divInt(v_196277, ((NI) 190));
		if ((NI)(TMP2720) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_196277 = ((NI64)-((NI)(TMP2720)));
		nimln(74, "rodutils.nim");
		if (((NI) (rem_196279)) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		rem_196279 = ((NI64)-(((NI) (rem_196279))));
	}
	goto LA1;
	LA3: ;
	{
		NI TMP2721;
		nimln(76, "rodutils.nim");
		TMP2721 = divInt(v_196277, ((NI) 190));
		v_196277 = (NI)(TMP2721);
	}
	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_196281) > (NU)(((NimStringDesc*) &TMP2716)->Sup.len)) raiseIndexError();
		d_196275 = ((NimStringDesc*) &TMP2716)->data[idx_196281];
	}
	goto LA6;
	LA8: ;
	{
		...
		NI TMP2723;
		nimln(79, "rodutils.nim");
		TMP2722 = subInt(idx_196281, ((NI) 62));
		TMP2723 = addInt((NI)(TMP2722), ((NI) 128));
		d_196275 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2723), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
...
N_NIMCALL(void, encodevint_196296)(NI x, NimStringDesc** result) {
	...
	encodevintaux_196269((NI)((NU64)(x) + (NU64)(((NI) 5))), result);
	popFrame();
}
...
N_NIMCALL(NI, decodevint_196351)(NCSTRING s, NI* pos) {
	...
	nimln(103, "rodutils.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP2724));
	}
	LA3: ;
	...
	result = ((NI) 0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2727 = subInt(((NI) (((NU8)(s[i_196358])))), ((NI) 48));
				TMP2728 = subInt((NI)(TMP2726), ((NI) ((NI)(TMP2727))));
				result = (NI)(TMP2728);
			}
			break;
			case 97 ... 122:
			{
				...
				TMP2730 = subInt(((NI) (((NU8)(s[i_196358])))), ((NI) 97));
				TMP2731 = addInt(((NI) ((NI)(TMP2730))), ((NI) 10));
			...
			case 65 ... 90:
			{
				...
				TMP2734 = subInt(((NI) (((NU8)(s[i_196358])))), ((NI) 65));
				TMP2735 = addInt(((NI) ((NI)(TMP2734))), ((NI) 36));
			...
			case 128 ... 255:
			{
				...
				TMP2738 = subInt(((NI) (((NU8)(s[i_196358])))), ((NI) 128));
				TMP2739 = addInt(((NI) ((NI)(TMP2738))), ((NI) 62));
			...
			TMP2741 = addInt(i_196358, ((NI) 1));
			i_196358 = (NI)(TMP2741);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2742 = mulInt(result, sign_196360);
	result = (NI)((NU64)((NI)(TMP2742)) - (NU64)(((NI) 5)));
	...
	result = IL64(0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2745 = subInt(((NI) (((NU8)(s[i_196519])))), ((NI) 48));
				TMP2746 = subInt64((NI64)(TMP2744), ((NI64) ((NI)(TMP2745))));
				result = (NI64)(TMP2746);
			}
			break;
			case 97 ... 122:
			{
				...
				TMP2748 = subInt(((NI) (((NU8)(s[i_196519])))), ((NI) 97));
				TMP2749 = addInt(((NI) ((NI)(TMP2748))), ((NI) 10));
			...
			case 65 ... 90:
			{
				...
				TMP2752 = subInt(((NI) (((NU8)(s[i_196519])))), ((NI) 65));
				TMP2753 = addInt(((NI) ((NI)(TMP2752))), ((NI) 36));
			...
			case 128 ... 255:
			{
				...
				TMP2756 = subInt(((NI) (((NU8)(s[i_196519])))), ((NI) 128));
				TMP2757 = addInt(((NI) ((NI)(TMP2756))), ((NI) 62));
			...
			nimln(115, "rodutils.nim");
			TMP2759 = addInt(i_196519, ((NI) 1));
			i_196519 = (NI)(TMP2759);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2760 = mulInt64(result, ((NI64) (sign_196521)));
	result = (NI64)((NU64)((NI64)(TMP2760)) - (NU64)(IL64(5)));
	nimln(117, "rodutils.nim");
	(*pos) = i_196519;
	popFrame();
	return result;
