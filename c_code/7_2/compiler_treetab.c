...
static NIM_CONST TY190031 TMP4149 = {
0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4150, "floatVal", 8);
static NIM_CONST TY190031 TMP4151 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4152, "strVal", 6);
static NIM_CONST TY190031 TMP4154 = {
	...
	{
		{
			...
			res_241093 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4156 = addInt(res_241093, ((NI) 1));
					res_241093 = (NI)(TMP4156);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_241192 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4158 = addInt(res_241192, ((NI) 1));
							res_241192 = (NI)(TMP4158);
						} LA28: ;
					}
				}
...
N_NIMCALL(void, nodetableput_241415)(Tnodetable189873* t, Tnode189813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			n = (Tnodepairseq189871*) newSeq((&NTI189871), ((NI)chckRange((NI)(TMP4163), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_241639;
				NI HEX3Atmp_241676;
				NI res_241679;
				...
				res_241679 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA20: ;
						nimln(1614, "system.nim");
						TMP4164 = addInt(res_241679, ((NI) 1));
						res_241679 = (NI)(TMP4164);
					} LA17: ;
				}
			}
...
N_NIMCALL(NI, nodetabletestorset_241698)(Tnodetable189873* t, Tnode189813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(103, "treetab.nim");
		{
			...
			n = (Tnodepairseq189871*) newSeq((&NTI189871), ((NI)chckRange((NI)(TMP4166), ((NI) 0), ((NI) IL64(9223372036854775807)))));
			{
				NI i_241839;
				NI HEX3Atmp_241876;
				NI res_241879;
				...
				res_241879 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA20: ;
						nimln(1614, "system.nim");
						TMP4167 = addInt(res_241879, ((NI) 1));
						res_241879 = (NI)(TMP4167);
					} LA17: ;
				}
			}
