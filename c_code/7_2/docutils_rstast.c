...
N_NIMCALL(void, TMP5011)(void* p, NI op);
...
43}
;
STRING_LITERAL(TMP5016, "\012", 1);
STRING_LITERAL(TMP5018, "", 0);
STRING_LITERAL(TMP5020, "\012\012", 2);
STRING_LITERAL(TMP5023, "* ", 2);
STRING_LITERAL(TMP5026, "(#) ", 4);
STRING_LITERAL(TMP5029, "  ", 2);
STRING_LITERAL(TMP5036, "| ", 2);
STRING_LITERAL(TMP5039, "`", 1);
STRING_LITERAL(TMP5040, "`_", 2);
STRING_LITERAL(TMP5041, " <", 2);
STRING_LITERAL(TMP5042, ">`_", 3);
STRING_LITERAL(TMP5043, "`:", 2);
STRING_LITERAL(TMP5044, "`:sub:", 6);
STRING_LITERAL(TMP5045, "`:sup:", 6);
STRING_LITERAL(TMP5046, "`:idx:", 6);
STRING_LITERAL(TMP5047, "*", 1);
STRING_LITERAL(TMP5048, "**", 2);
STRING_LITERAL(TMP5049, "***", 3);
STRING_LITERAL(TMP5051, "``", 2);
STRING_LITERAL(TMP5053, "\\", 1);
STRING_LITERAL(TMP5054, "\\\\", 2);
STRING_LITERAL(TMP5055, ".. index::\012", 11);
STRING_LITERAL(TMP5058, ".. contents::", 13);
STRING_LITERAL(TMP5059, "Error: cannot render: ", 22);
STRING_LITERAL(TMP5062, "kind", 4);
STRING_LITERAL(TMP5063, "level", 5);
STRING_LITERAL(TMP5064, "text", 4);
STRING_LITERAL(TMP5066, "sons", 4);
...
N_NIMCALL(Trstnode295011*, lastson_295147)(Trstnode295011* n) {
	...
	result = 0;
	nimln(87, "rstast.nim");
	TMP5013 = subInt(((*n).sons ? (*n).sons->Sup.len : 0), ((NI) 1));
	if ((NU)((NI)(TMP5013)) >= (NU)((*n).sons->Sup.len)) raiseIndexError();
	result = (*n).sons->data[(NI)(TMP5013)];
	popFrame();
	return result;
}
...
N_NIMCALL(void, renderrstsons_295224)(Trendercontext295208* d, Trstnode295011* n, NimStringDesc** result) {
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		LOC2 = 0;
		LOC2 = len_295084(n);
		TMP5014 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_295245 = (NI)(TMP5014);
		...
		res_295248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5015 = addInt(res_295248, ((NI) 1));
				res_295248 = (NI)(TMP5015);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		TMP5017 = subInt(((*result) ? (*result)->Sup.len : 0), oldlen);
		headlinelen = (NI)(TMP5017);
...
appendString((*result), ind);
		...
		headline = copyString(((NimStringDesc*) &TMP5018));
		nimln(134, "rstast.nim");
		renderrstsons_295224(d, n, (&headline));
		nimln(136, "rstast.nim");
		if ((NU)((*n).level) > (NU)(8)) raiseIndexError();
		TMP5019 = subInt((headline ? headline->Sup.len : 0), (*d).indent);
		lvl = nsuRepeatChar(lvltochar_295274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5019), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
		...
		TMP5021 = subInt(((NI) 78), (*d).indent);
		LOC10 = 0;
		LOC10 = nsuRepeatChar(45, ((NI)chckRange((NI)(TMP5021), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ind);
	...
	case ((NU8) 6):
	{
		...
		tmp = copyString(((NimStringDesc*) &TMP5018));
...
appendString((*result), ((NimStringDesc*) &TMP5029));
	...
	case ((NU8) 14):
	{
		...
		TMP5031 = addInt((tmp ? tmp->Sup.len : 0), ((NI) 3));
		L = (((NI)(TMP5031) >= ((NI) 30)) ? (NI)(TMP5031) : ((NI) 30));
		nimln(193, "rstast.nim");
		TMP5032 = addInt((*d).indent, L);
		(*d).indent = (NI)(TMP5032);
...
appendString((*result), tmp);
		...
		TMP5033 = subInt(L, (tmp ? tmp->Sup.len : 0));
		TMP5034 = subInt((NI)(TMP5033), ((NI) 2));
		LOC30 = 0;
		LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP5034), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
appendString((*result), ((NimStringDesc*) &TMP5036));
	...
	case ((NU8) 28):
	{
		...
		TMP5037 = addInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5037);
		nimln(211, "rstast.nim");
		renderrstsons_295224(d, n, result);
		nimln(212, "rstast.nim");
		TMP5038 = subInt((*d).indent, ((NI) 2));
		(*d).indent = (NI)(TMP5038);
	}
	break;
	case ((NU8) 39):
...
appendString((*result), ((NimStringDesc*) &TMP5049));
	...
	case ((NU8) 61):
	{
		...
		TMP5050 = addInt((*d).verbatim, ((NI) 1));
		(*d).verbatim = (NI)(TMP5050);
...
appendString((*result), ((NimStringDesc*) &TMP5051));
		...
		TMP5052 = subInt((*d).verbatim, ((NI) 1));
		(*d).verbatim = (NI)(TMP5052);
	}
	break;
	case ((NU8) 63):
	{
...
appendString((*result), (*n).text);
	...
	case ((NU8) 64):
	{
		nimln(266, "rstast.nim");
		{
			...
			if (!(LOC48)) goto LA49;
			LOC48 = eqStrings((*n).text, ((NimStringDesc*) &TMP5053));
			LA49: ;
			if (!LOC48) goto LA50;
...
appendString(LOC60, ((NimStringDesc*) &TMP5059));
...
N_NIMCALL(Jsonnodeobj288726*, renderrsttojsonnode_295483)(Trstnode295011* node) {
	...
	LOC1[0].Field0 = copyString(((NimStringDesc*) &TMP5062));
	nimln(293, "rstast.nim");
	LOC1[0].Field1 = HEX25_289130(reprEnum((*node).kind, (&NTI295005)));
	LOC1[1].Field0 = copyString(((NimStringDesc*) &TMP5063));
	...
	nimln(296, "rstast.nim");
	{
		...
		add_291418(result, ((NimStringDesc*) &TMP5064), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_291418(result, ((NimStringDesc*) &TMP5066), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
static TNimNode* TMP5007[4];
static TNimNode* TMP5008[65];
NI TMP5010;
static char* NIM_CONST TMP5009[65] = {
"rnInner", 
"rnHeadline", 
"rnOverline", 
"rnTransition", 
...
NTI295005.base = 0;
NTI295005.flags = 3;
for (TMP5010 = 0; TMP5010 < 65; TMP5010++) {
TMP4806[TMP5010+2].kind = 1;
TMP4806[TMP5010+2].offset = TMP5010;
TMP4806[TMP5010+2].name = TMP5009[TMP5010];
TMP5008[TMP5010] = &TMP4806[TMP5010+2];
}
TMP4806[67].len = 65; TMP4806[67].kind = 2; TMP4806[67].sons = &TMP5008[0];
NTI295005.node = &TMP4806[67];
TMP4806[1].kind = 1;
TMP4806[1].offset = offsetof(Trstnode295011, kind);
TMP4806[1].typ = (&NTI295005);
TMP4806[1].name = "kind";
TMP5007[1] = &TMP4806[68];
TMP4806[68].kind = 1;
TMP4806[68].offset = offsetof(Trstnode295011, text);
TMP4806[68].typ = (&NTI149);
TMP4806[68].name = "text";
TMP5007[2] = &TMP4806[69];
TMP4806[69].kind = 1;
TMP4806[69].offset = offsetof(Trstnode295011, level);
TMP4806[69].typ = (&NTI108);
TMP4806[69].name = "level";
TMP5007[3] = &TMP4806[70];
NTI295009.size = sizeof(Trstnodeseq295009*);
NTI295009.kind = 24;
NTI295009.base = (&NTI295007);
NTI295009.flags = 2;
NTI295009.marker = TMP5011;
TMP4806[70].kind = 1;
TMP4806[70].offset = offsetof(Trstnode295011, sons);
TMP4806[70].typ = (&NTI295009);
TMP4806[70].name = "sons";
TMP4806[0].len = 4; TMP4806[0].kind = 2; TMP4806[0].sons = &TMP5007[0];
NTI295011.node = &TMP4806[0];
NTI295007.size = sizeof(Trstnode295011*);
NTI295007.kind = 22;
NTI295007.base = (&NTI295011);
NTI295007.flags = 2;
NTI295007.marker = TMP5012;
}
