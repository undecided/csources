	...
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		res_297248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5015 = addInt(res_297248, ((NI) 1));
				res_297248 = (NI)(TMP5015);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		lvl = nsuRepeatChar(lvltochar_297274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5019), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(Jsonnodeobj290726*, renderrsttojsonnode_297483)(Trstnode297011* node) {
	...
	nimln(296, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5064), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5066), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
NTI297005.node = &TMP4806[67];
TMP4806[1].kind = 1;
TMP4806[1].offset = offsetof(Trstnode297011, kind);
TMP4806[1].typ = (&NTI297005);
TMP4806[1].name = "kind";
TMP5007[1] = &TMP4806[68];
TMP4806[68].kind = 1;
TMP4806[68].offset = offsetof(Trstnode297011, text);
TMP4806[68].typ = (&NTI149);
TMP4806[68].name = "text";
TMP5007[2] = &TMP4806[69];
TMP4806[69].kind = 1;
TMP4806[69].offset = offsetof(Trstnode297011, level);
...
NTI297009.flags = 2;
NTI297009.marker = TMP5011;
TMP4806[70].kind = 1;
TMP4806[70].offset = offsetof(Trstnode297011, sons);
TMP4806[70].typ = (&NTI297009);
TMP4806[70].name = "sons";
TMP4806[0].len = 4; TMP4806[0].kind = 2; TMP4806[0].sons = &TMP5007[0];
NTI297011.node = &TMP4806[0];
NTI297007.size = sizeof(Trstnode297011*);
NTI297007.kind = 22;
NTI297007.base = (&NTI297011);
NTI297007.flags = 2;
NTI297007.marker = TMP5012;
}
