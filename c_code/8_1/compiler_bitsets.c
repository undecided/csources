...
N_NIMCALL(NIM_BOOL, bitsetin_238077)(Tbitset238012* x, NI64 e) {
	...
	result = !(((NI8)(x->data[(NI64)(TMP4063)] & ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4064)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_238061)(Tbitset238012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4066)] = (NI8)((*x)->data[(NI64)(TMP4067)] | ((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4068))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_238069)(Tbitset238012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4069)] = (NI8)((*x)->data[(NI64)(TMP4070)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU32)(((NI) 1)) << (NU32)(((NI) ((NI64)(TMP4071))))))))));
	popFrame();
}
