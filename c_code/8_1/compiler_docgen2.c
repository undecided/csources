...
N_NIMCALL(Tnode191813*, close_508018)(Tpasscontext242005* p, Tnode191813* n) {
	...
	nimln(25, "docgen2.nim");
	{
		...
		writeoutput_344337((*g).doc, LOC7, ((NimStringDesc*) &TMP10592), usewarning);
...
TMP10589[1].kind = 1;
TMP10589[1].offset = offsetof(Tgen508010, doc);
TMP10589[1].typ = (&NTI341009);
TMP10589[1].name = "doc";
TMP10591[1] = &TMP10589[2];
TMP10589[2].kind = 1;
TMP10589[2].offset = offsetof(Tgen508010, module);
TMP10589[2].typ = (&NTI191811);
TMP10589[2].name = "module";
TMP10589[0].len = 2; TMP10589[0].kind = 2; TMP10589[0].sons = &TMP10591[0];
NTI508010.node = &TMP10589[0];
NTI508012.size = sizeof(Tgen508010*);
NTI508012.kind = 22;
NTI508012.base = (&NTI508010);
NTI508012.marker = TMP10594;
}
