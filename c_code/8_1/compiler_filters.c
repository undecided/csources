...
static NIM_CONST TY192031 TMP3324 = {
			...
			while (1) {
				...
				nimln(31, "filters.nim");
				{
					...
					nimln(32, "filters.nim");
					{
						if (((TMP3324[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3325));
						if ((NU)(i_217086) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP3324[(*(*n).kindU.S6.sons->data[i_217086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_217086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3325));
					...
					nimln(33, "filters.nim");
					{
						...
						if (((TMP3324[(*(*n).kindU.S6.sons->data[i_217086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_217086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3325));
						if ((NU)(((NI) 0)) >= (NU)((*(*n).kindU.S6.sons->data[i_217086]).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP3326[(*(*(*n).kindU.S6.sons->data[i_217086]).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*(*n).kindU.S6.sons->data[i_217086]).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3327));
						LOC19 = 0;
				...
				TMP3328 = addInt(res_217118, ((NI) 1));
				res_217118 = (NI)(TMP3328);
			} LA8: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(NIM_BOOL, boolarg_217038)(Tnode191813* n, NimStringDesc* name, NI pos, NIM_BOOL default_217043) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_167484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3333));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		if (!(LOC11)) goto LA12;
		if (!(((TMP3326[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3327));
		LOC11 = identeq_167484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3334));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream178204*, filterstrip_217012)(Tllstream178204* stdin_217014, NimStringDesc* filename, Tnode191813* call) {
	...
	pattern = strarg_217029(call, ((NimStringDesc*) &TMP3335), ((NI) 1), ((NimStringDesc*) &TMP3336));
	nimln(59, "filters.nim");
	leading = boolarg_217038(call, ((NimStringDesc*) &TMP3337), ((NI) 2), NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_217038(call, ((NimStringDesc*) &TMP3338), ((NI) 3), NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_178220(((NimStringDesc*) &TMP3336));
...
N_NIMCALL(Tllstream178204*, filterreplace_217004)(Tllstream178204* stdin_217006, NimStringDesc* filename, Tnode191813* call) {
	...
	sub = strarg_217029(call, ((NimStringDesc*) &TMP3339), ((NI) 1), ((NimStringDesc*) &TMP3336));
	...
	by = strarg_217029(call, ((NimStringDesc*) &TMP3340), ((NI) 2), ((NimStringDesc*) &TMP3336));
