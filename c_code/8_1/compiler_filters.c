...
static NIM_CONST TY190031 TMP3325 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3326, "sons", 4);
static NIM_CONST TY190031 TMP3327 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3328, "ident", 5);
static NIM_CONST TY190031 TMP3330 = {
0xE0, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3331, "intVal", 6);
static NIM_CONST TY190031 TMP3332 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3333, "strVal", 6);
STRING_LITERAL(TMP3334, "true", 4);
STRING_LITERAL(TMP3335, "false", 5);
STRING_LITERAL(TMP3336, "startswith", 10);
STRING_LITERAL(TMP3337, "", 0);
STRING_LITERAL(TMP3338, "leading", 7);
STRING_LITERAL(TMP3339, "trailing", 8);
STRING_LITERAL(TMP3340, "sub", 3);
STRING_LITERAL(TMP3341, "by", 2);
...
{	result = 0;
	...
	LA3: ;
	{
		...
		TMP3324 = subInt(LOC6, ((NI) 1));
		HEX3Atmp_215115 = (NI)(TMP3324);
			...
			while (1) {
				...
				nimln(31, "filters.nim");
				{
					...
					nimln(32, "filters.nim");
					{
						if (((TMP3325[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3326));
						if ((NU)(i_215086) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (((TMP3325[(*(*n).kindU.S6.sons->data[i_215086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_215086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3326));
					...
					nimln(33, "filters.nim");
					{
						...
						if (((TMP3325[(*(*n).kindU.S6.sons->data[i_215086]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[i_215086]).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP3326));
						if ((NU)(((NI) 0)) >= (NU)((*(*n).kindU.S6.sons->data[i_215086]).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP3327[(*(*(*n).kindU.S6.sons->data[i_215086]).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*(*n).kindU.S6.sons->data[i_215086]).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3328));
						LOC19 = 0;
				...
				TMP3329 = addInt(res_215118, ((NI) 1));
				res_215118 = (NI)(TMP3329);
			} LA8: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(NIM_BOOL, boolarg_215038)(Tnode189813* n, NimStringDesc* name, NI pos, NIM_BOOL default_215043) {
	...
	LA3: ;
	{
		...
		LOC6 = identeq_165484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3334));
		LA7: ;
		if (!LOC6) goto LA8;
		result = NIM_TRUE;
	}
	...
	LA8: ;
	{
		...
		if (!(LOC11)) goto LA12;
		if (!(((TMP3327[(*x).kind/8] &(1<<((*x).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP3328));
		LOC11 = identeq_165484((*x).kindU.S5.ident, ((NimStringDesc*) &TMP3335));
		LA12: ;
		if (!LOC11) goto LA13;
		result = NIM_FALSE;
	}
...
N_NIMCALL(Tllstream176204*, filterstrip_215012)(Tllstream176204* stdin_215014, NimStringDesc* filename, Tnode189813* call) {
	...
	pattern = strarg_215029(call, ((NimStringDesc*) &TMP3336), ((NI) 1), ((NimStringDesc*) &TMP3337));
	nimln(59, "filters.nim");
	leading = boolarg_215038(call, ((NimStringDesc*) &TMP3338), ((NI) 2), NIM_TRUE);
	nimln(60, "filters.nim");
	trailing = boolarg_215038(call, ((NimStringDesc*) &TMP3339), ((NI) 3), NIM_TRUE);
	nimln(61, "filters.nim");
	result = llstreamopen_176220(((NimStringDesc*) &TMP3337));
...
N_NIMCALL(Tllstream176204*, filterreplace_215004)(Tllstream176204* stdin_215006, NimStringDesc* filename, Tnode189813* call) {
	...
	sub = strarg_215029(call, ((NimStringDesc*) &TMP3340), ((NI) 1), ((NimStringDesc*) &TMP3337));
	...
	by = strarg_215029(call, ((NimStringDesc*) &TMP3341), ((NI) 2), ((NimStringDesc*) &TMP3337));
