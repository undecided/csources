...
N_NIMCALL(NIM_BOOL, endswithopr_178450)(NimStringDesc* x) {
	...
	result = endswith_178404(x, TMP2087);
	popFrame();
	return result;
}
...
static N_INLINE(NIM_BOOL, continueline_178460)(NimStringDesc* line, NIM_BOOL intriplestring) {
	...
	LOC1 = endswith_178404(line, TMP2088);
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
...
N_NIMCALL(void, llstreamwriteln_178686)(Tllstream178204* s, NimStringDesc* data) {
	...
	llstreamwrite_178665(s, ((NimStringDesc*) &TMP2084));
	popFrame();
}
...
NTI178202.node = &TMP2076[6];
TMP2076[1].kind = 1;
TMP2076[1].offset = offsetof(Tllstream178204, kind);
TMP2076[1].typ = (&NTI178202);
TMP2076[1].name = "kind";
TMP2078[1] = &TMP2076[7];
TMP2076[7].kind = 1;
TMP2076[7].offset = offsetof(Tllstream178204, f);
TMP2076[7].typ = (&NTI13004);
TMP2076[7].name = "f";
TMP2078[2] = &TMP2076[8];
TMP2076[8].kind = 1;
TMP2076[8].offset = offsetof(Tllstream178204, s);
TMP2076[8].typ = (&NTI149);
TMP2076[8].name = "s";
TMP2078[3] = &TMP2076[9];
TMP2076[9].kind = 1;
TMP2076[9].offset = offsetof(Tllstream178204, rd);
TMP2076[9].typ = (&NTI108);
TMP2076[9].name = "rd";
TMP2078[4] = &TMP2076[10];
TMP2076[10].kind = 1;
TMP2076[10].offset = offsetof(Tllstream178204, wr);
TMP2076[10].typ = (&NTI108);
TMP2076[10].name = "wr";
TMP2078[5] = &TMP2076[11];
TMP2076[11].kind = 1;
TMP2076[11].offset = offsetof(Tllstream178204, lineoffset);
TMP2076[11].typ = (&NTI108);
TMP2076[11].name = "lineOffset";
TMP2076[0].len = 6; TMP2076[0].kind = 2; TMP2076[0].sons = &TMP2078[0];
NTI178204.node = &TMP2076[0];
NTI178206.size = sizeof(Tllstream178204*);
NTI178206.kind = 22;
NTI178206.base = (&NTI178204);
NTI178206.marker = TMP2082;
}
