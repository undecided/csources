...
static NIM_CONST TY190031 TMP4683 = {
0x00, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4684, "strVal", 6);
static NIM_CONST TY190031 TMP4685 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4686, "sons", 4);
static NIM_CONST TY190031 TMP4687 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4688, "ident", 5);
STRING_LITERAL(TMP4689, "|", 1);
STRING_LITERAL(TMP4690, "&", 1);
STRING_LITERAL(TMP4691, "~", 1);
STRING_LITERAL(TMP4692, "atom", 4);
STRING_LITERAL(TMP4693, "lit", 3);
STRING_LITERAL(TMP4694, "sym", 3);
STRING_LITERAL(TMP4695, "ident", 5);
STRING_LITERAL(TMP4696, "call", 4);
STRING_LITERAL(TMP4697, "alias", 5);
STRING_LITERAL(TMP4698, "noalias", 7);
STRING_LITERAL(TMP4699, "lvalue", 6);
STRING_LITERAL(TMP4700, "local", 5);
STRING_LITERAL(TMP4701, "sideeffect", 10);
STRING_LITERAL(TMP4702, "nosideeffect", 12);
STRING_LITERAL(TMP4704, "compiler/parampatterns.nim", 26);
NIM_CONST TY145211 TMP4703 = {((NimStringDesc*) &TMP4704),
((NI) 100)}
;
NIM_CONST TY145211 TMP4706 = {((NimStringDesc*) &TMP4704),
((NI) 107)}
;
STRING_LITERAL(TMP4708, "p.kind == nkCurlyExpr ", 22);
STRING_LITERAL(TMP4710, "parameter pattern too complex", 29);
static NIM_CONST TY190031 TMP4711 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4712, "sym", 3);
...
N_NIMCALL(NU8, whichalias_267080)(Tsym189843* p) {
	...
	nimln(51, "parampatterns.nim");
	{
		...
		if (!(((TMP4683[(*(*p).constraint).kind/8] &(1<<((*(*p).constraint).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4684));
...
static N_INLINE(NI, len_190097)(Tnode189813* n) {
	...
	nimln(934, "ast.nim");
	{
		if (((TMP4685[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4686));
...
{	nimln(57, "parampatterns.nim");
	...
	case ((NU8) 32):
	{
		...
		{
			if (((TMP4685[(*p).kind/8] &(1<<((*p).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4686));
		...
		if (((TMP4685[(*p).kind/8] &(1<<((*p).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4686));
		if ((NU)(((NI) 0)) >= (NU)((*p).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP4687[(*(*p).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*p).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4688));
		...
		nimln(63, "parampatterns.nim");
		{
			...
			nimln(64, "parampatterns.nim");
			{
				NIM_BOOL LOC13;
				LOC13 = 0;
				LOC13 = eqStrings((*op).s, ((NimStringDesc*) &TMP4689));
				if (LOC13) goto LA14;
			...
			LA15: ;
			{
				...
				LOC18 = 0;
				LOC18 = eqStrings((*op).s, ((NimStringDesc*) &TMP4690));
				if (LOC18) goto LA19;
		...
		LA9: ;
		{
			...
			if (!(LOC24)) goto LA26;
			LOC27 = 0;
			LOC27 = eqStrings((*op).s, ((NimStringDesc*) &TMP4691));
			if (LOC27) goto LA28;
	...
	case ((NU8) 2):
	{
		...
		case 1: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4702))) goto LA50;
break;
		case 3: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4698))) goto LA46;
if (eqStrings(spec, ((NimStringDesc*) &TMP4699))) goto LA47;
if (eqStrings(spec, ((NimStringDesc*) &TMP4701))) goto LA49;
break;
		case 4: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4694))) goto LA42;
break;
		case 6: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4695))) goto LA43;
if (eqStrings(spec, ((NimStringDesc*) &TMP4700))) goto LA48;
break;
		case 11: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4692))) goto LA40;
break;
		case 12: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4693))) goto LA41;
break;
		case 13: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4696))) goto LA44;
break;
		case 14: 
if (eqStrings(spec, ((NimStringDesc*) &TMP4697))) goto LA45;
break;
		}
		goto LA51;
		LA40: ;
			...
			LA67: ;
			{
				...
				res_267644 = ((NI) 0);
				{
					...
					while (1) {
						...
						TMP4705 = addInt(res_267644, ((NI) 1));
						res_267644 = (NI)(TMP4705);
					} LA72: ;
				}
			}
			nimln(854, "msgs.nim");
			...
			LA81: ;
			{
				...
				res_267652 = ((NI) 0);
				{
					...
					while (1) {
						...
						LA90: ;
						nimln(1619, "system.nim");
						TMP4707 = addInt(res_267652, ((NI) 1));
						res_267652 = (NI)(TMP4707);
					} LA86: ;
				}
			}
...
N_NIMCALL(Tnode189813*, semnodekindconstraints_267679)(Tnode189813* p) {
	...
	nimln(120, "parampatterns.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP4708));
	}
	LA3: ;
	nimln(121, "parampatterns.nim");
	result = newnodei_191351(((NU8) 20), (*p).info);
	nimln(122, "parampatterns.nim");
	if (!(((TMP4683[(*result).kind/8] &(1<<((*result).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4684));
	...
	nimln(124, "parampatterns.nim");
	{
		...
		if (!(((NI) 2) <= LOC7)) goto LA8;
		{
			...
			res_267842 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4709 = addInt(res_267842, ((NI) 1));
					res_267842 = (NI)(TMP4709);
				} LA13: ;
			}
		}
		nimln(127, "parampatterns.nim");
		{
			...
			internalerror_163199((*p).info, ((NimStringDesc*) &TMP4710));
		}
		LA16: ;
	}
	goto LA5;
		...
		LA2: ;
		{
			...
			res_268010 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA20: ;
					nimln(1619, "system.nim");
					TMP4713 = addInt(res_268010, ((NI) 1));
					res_268010 = (NI)(TMP4713);
				} LA19: ;
			}
		}
	}
		...
		result = ((NU8) 2);
		{
			...
			res_268018 = ((NI) 0);
			{
				...
				while (1) {
					...
					LA35: ;
					nimln(1619, "system.nim");
					TMP4714 = addInt(res_268018, ((NI) 1));
					res_268018 = (NI)(TMP4714);
				} LA34: ;
			}
		}
	}
...
N_NIMCALL(NU8, isassignable_268056)(Tsym189843* owner, Tnode189813* n) {
	...
	case ((NU8) 3):
	{
		...
		{
			if (!(((TMP4711[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4712));
	...
	case ((NU8) 45):
	{
		...
		nimln(204, "parampatterns.nim");
		{
			...
			if (!(((TMP4711[(*(*n).kindU.S6.sons->data[((NI) 1)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 1)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4712));
...
N_NIMCALL(NIM_BOOL, matchnodekinds_268284)(Tnode189813* p, Tnode189813* n) {
	...
	if (!(((TMP4683[(*p).kind/8] &(1<<((*p).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4684));
	...
	pc = ((NI) 1);
	{
		...
		while (1) {
			...
			case ((NU8) 2):
			{
				...
				TMP4715 = subInt(sp, ((NI) 2));
				if ((NU)((NI)(TMP4715)) > (NU)(64)) raiseIndexError();
				LOC5 = 0;
				TMP4716 = subInt(sp, ((NI) 1));
				if ((NU)((NI)(TMP4716)) > (NU)(64)) raiseIndexError();
				LOC5 = stack[((NI)(TMP4716))- 0];
				if (LOC5) goto LA6;
				TMP4717 = subInt(sp, ((NI) 2));
				if ((NU)((NI)(TMP4717)) > (NU)(64)) raiseIndexError();
				LOC5 = stack[((NI)(TMP4717))- 0];
				LA6: ;
				stack[((NI)(TMP4715))- 0] = LOC5;
				nimln(253, "parampatterns.nim");
				TMP4718 = subInt(sp, ((NI) 1));
				sp = (NI)(TMP4718);
			}
			break;
			case ((NU8) 3):
			...
			case ((NU8) 4):
			{
				...
				stack[((NI)(TMP4723))- 0] = !(stack[((NI)(TMP4724))- 0]);
			}
			break;
			case ((NU8) 5):
			{
			...
			case ((NU8) 10):
			{
				...
				kind = ((NU8)chckRange(((NU8)(code->data[(NI)(TMP4730)])), ((NU8) 0), ((NU8) 25)));
				nimln(243, "parampatterns.nim");
				if ((NU)(sp) > (NU)(64)) raiseIndexError();
			...
			case ((NU8) 11):
			{
				...
				if ((NU)((NI)(TMP4733)) > (NU)(code->Sup.len)) raiseIndexError();
				kind = ((NU8)chckRange(((NU8)(code->data[(NI)(TMP4733)])), ((NU8) 0), ((NU8) 158)));
				nimln(243, "parampatterns.nim");
				if ((NU)(sp) > (NU)(64)) raiseIndexError();
	...
	TMP4741 = subInt(sp, ((NI) 1));
	if ((NU)((NI)(TMP4741)) > (NU)(64)) raiseIndexError();
	result = stack[((NI)(TMP4741))- 0];
	popFrame();
	return result;
}
