	...
	{
		{
			...
			res_241092 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP4153 = addInt(res_241092, ((NI) 1));
					res_241092 = (NI)(TMP4153);
				} LA32: ;
			}
		}
	}
				...
				if (!(LOC21 == LOC22)) goto LA23;
				{
					...
					res_241191 = ((NI) 0);
					{
						...
						while (1) {
							...
							LA32: ;
							nimln(1614, "system.nim");
							TMP4155 = addInt(res_241191, ((NI) 1));
							res_241191 = (NI)(TMP4155);
						} LA28: ;
					}
				}
...
N_NIMCALL(void, nodetableput_241415)(Tnodetable189873* t, Tnode189813* key, NI val) {
	...
	LA3: ;
	{
		...
		nimln(86, "treetab.nim");
		{
			...
			n = (Tnodepairseq189871*) newSeq((&NTI189871), ((NI)chckRange((NI)(TMP4160), ((NI) 0), ((NI) 2147483647))));
			{
				NI i_241639;
				NI HEX3Atmp_241676;
				NI res_241679;
