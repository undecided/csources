...
STRING_LITERAL(TMP6604, "", 0);
static NIM_CONST TY190031 TMP6605 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6606, "sons", 4);
static NIM_CONST TY190031 TMP6608 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6609, "ident", 5);
STRING_LITERAL(TMP6610, "*", 1);
static NIM_CONST TY190031 TMP6611 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP6612, "sym", 3);
STRING_LITERAL(TMP6613, "renderPlainSymbolName() with ", 29);
STRING_LITERAL(TMP6614, "not isNil(result) ", 18);
STRING_LITERAL(TMP6615, "len(n) == 1 ", 12);
STRING_LITERAL(TMP6616, "ref.", 4);
STRING_LITERAL(TMP6617, "ptr.", 4);
STRING_LITERAL(TMP6618, "1 < len(n) ", 11);
STRING_LITERAL(TMP6619, "params.kind == nkFormalParams ", 30);
STRING_LITERAL(TMP6620, "0 < len(params) ", 16);
STRING_LITERAL(TMP6621, "proc(", 5);
STRING_LITERAL(TMP6623, "3 <= len(n) ", 12);
STRING_LITERAL(TMP6625, "[](n, i).kind == nkIdent ", 25);
STRING_LITERAL(TMP6627, "tuple[", 6);
STRING_LITERAL(TMP6629, "2 <= len(n) ", 12);
STRING_LITERAL(TMP6633, "0 < typePos ", 12);
STRING_LITERAL(TMP6636, "[](n, i).kind == nkIdent or [](n, i).kind == nkAccQuoted ", 57);
STRING_LITERAL(TMP6638, "renderParamTypes(found,n) with ", 31);
...
{	result = 0;
	...
	result = copyString(((NimStringDesc*) &TMP6604));
	...
	{
		{
			...
			res_336205 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP6607 = addInt(res_336205, ((NI) 1));
					res_336205 = (NI)(TMP6607);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 2):
	{
		nimln(28, "typesrenderer.nim");
		{
			...
			if (!!(eqStrings((*(*n).kindU.S5.ident).s, ((NimStringDesc*) &TMP6610)))) goto LA15;
...
appendString(LOC24, ((NimStringDesc*) &TMP6613));
...
appendString(LOC16, ((NimStringDesc*) &TMP6616));
...
appendString(LOC25, ((NimStringDesc*) &TMP6617));
appendString(LOC25, LOC27);
	...
	case ((NU8) 147):
	{
		...
		result = copyString(((NimStringDesc*) &TMP6621));
		{
			NI i_337419;
			NI HEX3Atmp_338202;
			NI LOC44;
...
appendString(result, LOC66);
					nimln(1619, "system.nim");
					TMP6626 = addInt(res_338213, ((NI) 1));
					res_338213 = (NI)(TMP6626);
				} LA60: ;
			}
		}
	}
	...
	case ((NU8) 134):
	{
		...
		result = copyString(((NimStringDesc*) &TMP6627));
		{
			NI i_337819;
			NI HEX3Atmp_338218;
			NI LOC69;
...
appendString(result, LOC72);
					nimln(1619, "system.nim");
					TMP6628 = addInt(res_338221, ((NI) 1));
					res_338221 = (NI)(TMP6628);
				} LA71: ;
			}
		}
...
appendString(result, LOC88);
					nimln(1619, "system.nim");
					TMP6630 = addInt(res_338229, ((NI) 1));
					res_338229 = (NI)(TMP6630);
				} LA87: ;
			}
		}
...
{	nimln(89, "typesrenderer.nim");
	...
	{
		{
			...
			res_338622 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6631 = addInt(res_338622, ((NI) 1));
					res_338622 = (NI)(TMP6631);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 35):
	{
		...
		nimln(97, "typesrenderer.nim");
		{
			...
			LOC18 = 0;
			LOC18 = HEX5BHEX5D_190244(n, (NI)(TMP6634));
			...
			LOC21 = 0;
			LOC21 = HEX5BHEX5D_190244(n, (NI)(TMP6635));
			typ = (*LOC21).typ;
		...
		LA19: ;
		{
			...
			res_338630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6637 = addInt(res_338630, ((NI) 1));
					res_338630 = (NI)(TMP6637);
				} LA32: ;
			}
		}
	}
...
appendString(LOC43, ((NimStringDesc*) &TMP6638));
