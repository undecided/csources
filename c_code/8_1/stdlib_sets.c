...
static N_INLINE(NIM_BOOL, isempty_150234)(NI hcode);
static N_INLINE(void, nimFrame)(TFrame* s);
N_NOINLINE(void, stackoverflow_20001)(void);
static N_INLINE(void, popFrame)(void);
static N_INLINE(NIM_BOOL, isfilled_150244)(NI hcode);
static N_INLINE(NIM_BOOL, mustrehash_150303)(NI length, NI counter);
N_NIMCALL(void, failedassertimpl_87017)(NimStringDesc* msg);
N_NIMCALL(NI, mulInt)(NI a, NI b);
static N_INLINE(NI, subInt)(NI a, NI b);
N_NOINLINE(void, raiseOverflow)(void);
static N_INLINE(NI, rightsize_150407)(NI count);
...
static N_INLINE(NI, nexttry_150420)(NI h, NI maxhash);
...
static N_INLINE(NI, rightsize_150407)(NI count) {
	...
	result = nextpoweroftwo_147531(((NI)chckRange((NI)(TMP662), ((NI) (-2147483647 -1)), ((NI) 2147483647))));
	popFrame();
	return result;
}
