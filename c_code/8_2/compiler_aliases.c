...
static NIM_CONST TY192031 TMP7901 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7902, "sons", 4);
STRING_LITERAL(TMP7904, "n.sons[0].kind == nkSym ", 24);
STRING_LITERAL(TMP7906, "isPartOfAux(record case branch)", 31);
static NIM_CONST TY192031 TMP7908 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7909, "sym", 3);
STRING_LITERAL(TMP7910, "isPartOfAux()", 13);
...
{	result = 0;
	...
	{
		{
			...
			TMP7900 = subInt(LOC3, ((NI) 1));
			HEX3Atmp_400238 = (NI)(TMP7900);
			...
			res_400241 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP7903 = addInt(res_400241, ((NI) 1));
					res_400241 = (NI)(TMP7903);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 139):
	{
		nimln(29, "aliases.nim");
		{
			...
			failedassertimpl_87017(((NimStringDesc*) &TMP7904));
		}
		LA13: ;
		...
		LA17: ;
		{
			...
			TMP7905 = subInt(LOC20, ((NI) 1));
			HEX3Atmp_400246 = (NI)(TMP7905);
			nimln(1598, "system.nim");
			res_400249 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					default:
					{
						...
						internalerror_165218(((NimStringDesc*) &TMP7906));
					}
					break;
					}
					nimln(1614, "system.nim");
					TMP7907 = addInt(res_400249, ((NI) 1));
					res_400249 = (NI)(TMP7907);
				} LA22: ;
			}
		}
	}
	...
	case ((NU8) 3):
	{
		...
		if (!(((TMP7908[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7909));
	...
	default:
	{
		...
		internalerror_165199((*n).info, ((NimStringDesc*) &TMP7910));
	}
	break;
	}
	}BeforeRet: ;
	...
	{
		{
			...
			TMP7911 = subInt(LOC26, ((NI) 1));
			HEX3Atmp_400340 = (NI)(TMP7911);
			nimln(1598, "system.nim");
			res_400343 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					LA31: ;
					nimln(1614, "system.nim");
					TMP7912 = addInt(res_400343, ((NI) 1));
					res_400343 = (NI)(TMP7912);
				} LA28: ;
			}
		}
	}
		...
		case ((NU8) 45):
		{
			...
			nimln(128, "aliases.nim");
			{
				...
				nimln(130, "aliases.nim");
				{
					...
					if (!(((TMP7908[(*LOC81).kind/8] &(1<<((*LOC81).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7909));
					LOC82 = 0;
					LOC82 = HEX5BHEX5D_192244(b, ((NI) 1));
					if (!(((TMP7908[(*LOC82).kind/8] &(1<<((*LOC82).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP7909));
