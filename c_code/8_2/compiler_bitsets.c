...
N_NIMCALL(void, TMP4072)(void* p, NI op);
...
STRING_LITERAL(TMP4065, "0 <= elem ", 10);
...
N_NIMCALL(NIM_BOOL, bitsetin_238077)(Tbitset238012* x, NI64 e) {
	...
	TMP4063 = divInt64(e, IL64(8));
	if ((NU)((NI64)(TMP4063)) >= (NU)(x->Sup.len)) raiseIndexError();
	TMP4064 = modInt64(e, IL64(8));
	result = !(((NI8)(x->data[(NI64)(TMP4063)] & ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4064)))))))) == ((NI8) 0)));
	popFrame();
	return result;
}
...
N_NIMCALL(void, bitsetincl_238061)(Tbitset238012** x, NI64 elem) {
	...
	nimln(38, "bitsets.nim");
	{
		...
		failedassertimpl_87017(((NimStringDesc*) &TMP4065));
	}
	LA3: ;
	...
	TMP4068 = modInt64(elem, IL64(8));
	(*x)->data[(NI64)(TMP4066)] = (NI8)((*x)->data[(NI64)(TMP4067)] | ((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4068))))))));
	popFrame();
}
...
N_NIMCALL(void, bitsetexcl_238069)(Tbitset238012** x, NI64 elem) {
	...
	(*x)->data[(NI64)(TMP4069)] = (NI8)((*x)->data[(NI64)(TMP4070)] & (NI8)((NU8) ~(((NI8)(NU8)(NU)((NI)((NU64)(((NI) 1)) << (NU64)(((NI) ((NI64)(TMP4071))))))))));
	popFrame();
}
	...
	nimfr("bitSetUnion", "bitsets.nim")
	{
		...
		res_238265 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4073 = addInt(res_238265, ((NI) 1));
				res_238265 = (NI)(TMP4073);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetDiff", "bitsets.nim")
	{
		...
		res_238306 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4074 = addInt(res_238306, ((NI) 1));
				res_238306 = (NI)(TMP4074);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetSymDiff", "bitsets.nim")
	{
		...
		res_238347 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4075 = addInt(res_238347, ((NI) 1));
				res_238347 = (NI)(TMP4075);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("bitSetIntersect", "bitsets.nim")
	{
		...
		res_238388 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4076 = addInt(res_238388, ((NI) 1));
				res_238388 = (NI)(TMP4076);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = 0;
	{
		...
		res_238429 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4077 = addInt(res_238429, ((NI) 1));
				res_238429 = (NI)(TMP4077);
			} LA3: ;
		}
	}
...
{	result = 0;
	{
		...
		res_238470 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4078 = addInt(res_238470, ((NI) 1));
				res_238470 = (NI)(TMP4078);
			} LA3: ;
		}
	}
