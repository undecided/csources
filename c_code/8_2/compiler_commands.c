...
STRING_LITERAL(TMP1856, "git hash: 8dedfdb236cc50a811ec3423de492368d4ed6329", 50);
...
NIM_CONST TY163302 TMP1869 = {((NimStringDesc*) &TMP1870),
...
NIM_CONST TY163297 TMP1889 = {((NimStringDesc*) &TMP1890),
...
N_NIMCALL(void, invalidcmdlineoption_176230)(NU8 pass, NimStringDesc* switch_176233, Tlineinfo163338 info) {
	...
	{
		if (!eqStrings(switch_176233, ((NimStringDesc*) &TMP1860))) goto LA3;
		localerror_165155(info, ((NU16) 44), ((NimStringDesc*) &TMP1858));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, splitswitch_176241)(NimStringDesc* switch_176243, NimStringDesc** cmd, NimStringDesc** arg, NU8 pass, Tlineinfo163338 info) {
	...
	LA19: ;
	{
		...
		unsureAsgnRef((void**) (&(*arg)), copyStr(switch_176243, (NI)(TMP1865)));
	}
	goto LA17;
	LA22: ;
	{
...
N_NIMCALL(void, processspecificnote_176397)(NimStringDesc* arg, NU16 state, NU8 pass, Tlineinfo163338 info, NimStringDesc* orig) {
	...
	nimln(155, "commands.nim");
	{
		...
		x = findstr_172344(TMP1869, 17, id);
...
appendString(LOC28, id);
	...
	LA21: ;
	{
		...
		x = findstr_172344(TMP1889, 31, id);
...
N_NIMCALL(void, trackdirty_177004)(NimStringDesc* arg, Tlineinfo163338 info) {
	...
	nimln(247, "commands.nim");
	{
		...
		localerror_165155(info, ((NU16) 23), ((NimStringDesc*) &TMP1981));
	}
	LA3: ;
	line = 0;
	column = 0;
...
N_NIMCALL(void, track_177030)(NimStringDesc* arg, Tlineinfo163338 info) {
	...
	nimln(263, "commands.nim");
	{
		...
		localerror_165155(info, ((NU16) 23), ((NimStringDesc*) &TMP1982));
	}
	LA3: ;
	line = 0;
	column = 0;
...
break;
	...
	LA22: ;
	{
		...
		LA142: ;
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP2050));
		}
		goto LA146;
		LA143: ;
		{
	...
	LA30: ;
	{
		...
		LA164: ;
		{
			...
			undefsymbol_168022(((NimStringDesc*) &TMP2054));
		}
		goto LA167;
		LA165: ;
		{
...
appendString(LOC172, arg);
	...
	LA31: ;
	{
		...
		nimln(393, "commands.nim");
		{
			...
			definesymbol_168013(((NimStringDesc*) &TMP1946));
		}
		goto LA174;
		LA176: ;
		{
			nimln(394, "commands.nim");
			undefsymbol_168022(((NimStringDesc*) &TMP1946));
		}
		LA174: ;
	}
	goto LA92;
...
N_NIMCALL(NIM_BOOL, processargument_177738)(NU8 pass, Optparser175011* p, NI* argscount) {
	...
	LA3: ;
	{
		...
		nimln(614, "commands.nim");
		{
			...
			asgnRefNoCycle((void**) (&gprojectname_154234), nosunixToNativePath((*p).key, ((NimStringDesc*) &TMP1861)));
...
NIM_EXTERNC N_NOINLINE(void, compiler_commandsInit)(void) {
	...
	LOC1 = 0;
	LOC1 = arguments_177721; arguments_177721 = copyStringRC1(((NimStringDesc*) &TMP1861));
