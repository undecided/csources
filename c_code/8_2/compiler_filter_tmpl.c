...
N_NIMCALL(void, newline_218047)(Ttmplparser218020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3343));
	}
	LA4: ;
...
N_NIMCALL(void, parseline_218149)(Ttmplparser218020* p) {
	...
	LA7: ;
	{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_165155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3357));
			}
			LA20: ;
			...
			llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3358));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3364));
		}
		break;
		case ((NU8) 0):
		{
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_165155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3377));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_165155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3385));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_178665((*p).outp, ((NimStringDesc*) &TMP3387));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream178204*, filtertmpl_218009)(Tllstream178204* stdin_218011, NimStringDesc* filename, Tnode191813* call) {
	...
	p.outp = llstreamopen_178220(((NimStringDesc*) &TMP3354));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_218011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_217020(call, ((NimStringDesc*) &TMP3388), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_217020(call, ((NimStringDesc*) &TMP3389), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_217029(call, ((NimStringDesc*) &TMP3390), ((NI) 3), ((NimStringDesc*) &TMP3391));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_217029(call, ((NimStringDesc*) &TMP3392), ((NI) 4), ((NimStringDesc*) &TMP3393));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_217029(call, ((NimStringDesc*) &TMP3394), ((NI) 5), ((NimStringDesc*) &TMP3385));
