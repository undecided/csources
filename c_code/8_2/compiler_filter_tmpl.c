...
0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}
;
STRING_LITERAL(TMP3344, "\012", 1);
STRING_LITERAL(TMP3355, "", 0);
STRING_LITERAL(TMP3358, "end", 3);
STRING_LITERAL(TMP3359, "#end", 4);
static NIM_CONST TY77659 TMP3362 = {
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP3365, "\"", 1);
STRING_LITERAL(TMP3366, "(\"", 2);
STRING_LITERAL(TMP3368, "\\x", 2);
STRING_LITERAL(TMP3370, "\\\\", 2);
STRING_LITERAL(TMP3372, "\\\'", 2);
STRING_LITERAL(TMP3374, "\\\"", 2);
STRING_LITERAL(TMP3378, "}", 1);
STRING_LITERAL(TMP3386, "$", 1);
STRING_LITERAL(TMP3388, "\\n\"", 3);
STRING_LITERAL(TMP3389, "subschar", 8);
STRING_LITERAL(TMP3390, "metachar", 8);
STRING_LITERAL(TMP3391, "emit", 4);
STRING_LITERAL(TMP3392, "result.add", 10);
STRING_LITERAL(TMP3393, "conc", 4);
STRING_LITERAL(TMP3394, " & ", 3);
STRING_LITERAL(TMP3395, "tostring", 8);
...
N_NIMCALL(void, newline_216047)(Ttmplparser216020* p) {
	...
	nimln(42, "filter_tmpl.nim");
	{
		...
		llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3344));
	}
	LA4: ;
	...
	i = d;
	{
		...
		while (1) {
			...
			case 93:
			{
				...
				TMP3348 = subInt((*p).bracket, ((NI) 1));
				(*p).bracket = (NI)(TMP3348);
			}
			break;
			case 123:
			{
...
N_NIMCALL(void, parseline_216149)(Ttmplparser216020* p) {
	...
	LA7: ;
	{
		...
		keyw = copyString(((NimStringDesc*) &TMP3355));
		{
		...
		case ((NU16) 22):
		{
			...
			LA22: ;
			{
				...
				localerror_163155((*p).info, ((NU16) 163), ((NimStringDesc*) &TMP3358));
			}
			LA20: ;
			...
			llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3359));
		}
		break;
		case ((NU16) 31):
		case ((NU16) 65):
		...
		case ((NU16) 26):
		{
			...
			TMP3361 = subInt((*p).indent, ((NI) 2));
			LOC30 = 0;
			LOC30 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3361), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU16) 62):
		{
			...
			nimln(104, "filter_tmpl.nim");
			{
				...
				NI TMP3363;
				LOC37 = 0;
				LOC37 = contains_99373((*p).x, TMP3362);
				if (!!(LOC37)) goto LA38;
	...
	LA10: ;
	{
		...
		case ((NU8) 1):
		{
			...
			TMP3364 = addInt((*p).indent, ((NI) 2));
			LOC45 = 0;
			LOC45 = nsuRepeatChar(32, ((NI)chckRange((NI)(TMP3364), ((NI) 0), ((NI) IL64(9223372036854775807)))));
		...
		case ((NU8) 0):
		{
			...
			llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3366));
			nimln(130, "filter_tmpl.nim");
			TMP3367 = addInt((*p).emitpar, ((NI) 1));
			(*p).emitpar = (NI)(TMP3367);
		}
		break;
		}
					...
					nimln(150, "filter_tmpl.nim");
					{
							...
							curly = ((NI) 0);
							{
								...
								while (1) {
									...
									case 0:
									{
										...
										localerror_163155((*p).info, ((NU16) 188), ((NimStringDesc*) &TMP3378));
						...
						default:
						{
							...
							LA82: ;
							{
								...
								localerror_163155((*p).info, ((NU16) 167), ((NimStringDesc*) &TMP3386));
							}
							LA80: ;
						}
						break;
		...
		llstreamwrite_176665((*p).outp, ((NimStringDesc*) &TMP3388));
	}
	LA3: ;
	popFrame();
}
...
N_NIMCALL(Tllstream176204*, filtertmpl_216009)(Tllstream176204* stdin_216011, NimStringDesc* filename, Tnode189813* call) {
	...
	p.outp = llstreamopen_176220(((NimStringDesc*) &TMP3355));
	nimln(209, "filter_tmpl.nim");
	p.inp = stdin_216011;
	nimln(210, "filter_tmpl.nim");
	p.subschar = chararg_215020(call, ((NimStringDesc*) &TMP3389), ((NI) 1), 36);
	nimln(211, "filter_tmpl.nim");
	p.nimdirective = chararg_215020(call, ((NimStringDesc*) &TMP3390), ((NI) 2), 35);
	nimln(212, "filter_tmpl.nim");
	p.emit = strarg_215029(call, ((NimStringDesc*) &TMP3391), ((NI) 3), ((NimStringDesc*) &TMP3392));
	nimln(213, "filter_tmpl.nim");
	p.conc = strarg_215029(call, ((NimStringDesc*) &TMP3393), ((NI) 4), ((NimStringDesc*) &TMP3394));
	nimln(214, "filter_tmpl.nim");
	p.tostr = strarg_215029(call, ((NimStringDesc*) &TMP3395), ((NI) 5), ((NimStringDesc*) &TMP3386));
	...
	p.x = rawNewString(((NI) 120));
	{
		...
		while (1) {
			...
			TMP3396 = addInt(p.info.line, ((NI16) 1));
			if (TMP3396 < -32768 || TMP3396 > 32767) raiseOverflow();
			p.info.line = (NI16)(TMP3396);
