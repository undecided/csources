...
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4312, "strVal", 6);
STRING_LITERAL(TMP4313, "", 0);
static NIM_CONST TY192031 TMP4314 = {
0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4315, "ident", 5);
static NIM_CONST TY192031 TMP4316 = {
0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4317, "sym", 3);
static NIM_CONST TY192031 TMP4318 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP4319, "sons", 4);
STRING_LITERAL(TMP4320, "as", 2);
STRING_LITERAL(TMP4321, " ", 1);
STRING_LITERAL(TMP4322, ".", 1);
STRING_LITERAL(TMP4323, "/", 1);
STRING_LITERAL(TMP4324, "invalid module name: \'$1\'", 25);
STRING_LITERAL(TMP4326, "rawImportSymbol", 15);
STRING_LITERAL(TMP4328, "tab", 3);
STRING_LITERAL(TMP4329, "importSymbol: 2", 15);
STRING_LITERAL(TMP4330, "importSymbol: 3", 15);
STRING_LITERAL(TMP4331, "importAllSymbols: ", 18);
STRING_LITERAL(TMP4332, "a.kind == nkSym ", 16);
STRING_LITERAL(TMP4334, "\'export except\' not implemented", 31);
STRING_LITERAL(TMP4337, "module alias must be an identifier", 34);
STRING_LITERAL(TMP4338, "A module cannot import itself", 29);
...
{	result = 0;
	...
	case ((NU8) 22):
	{
		...
		result = nosunixToNativePath((*n).kindU.S3.strval, ((NimStringDesc*) &TMP4313));
	}
	break;
	case ((NU8) 2):
	{
		nimln(27, "importer.nim");
		if (!(((TMP4314[(*n).kind/8] &(1<<((*n).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4315));
	...
	case ((NU8) 30):
	{
		...
		nimln(31, "importer.nim");
		{
			...
			if (((TMP4318[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4319));
			if ((NU)(((NI) 0)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
			if (!(((TMP4314[(*(*n).kindU.S6.sons->data[((NI) 0)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 0)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4315));
			LOC9 = 0;
			LOC9 = getident_167463(((NimStringDesc*) &TMP4320));
		...
		result = nsuReplaceStr(LOC13, ((NimStringDesc*) &TMP4321), ((NimStringDesc*) &TMP4313));
	}
	break;
	case ((NU8) 45):
	{
		...
		result = nsuReplaceStr(LOC15, ((NimStringDesc*) &TMP4322), ((NimStringDesc*) &TMP4323));
	}
	break;
	case ((NU8) 78):
	{
	...
	default:
	{
		...
		LOC19 = 0;
		LOC19 = nsuFormatSingleElem(((NimStringDesc*) &TMP4324), LOC18);
		localerror_165155((*n).info, ((NU16) 4), LOC19);
		nimln(46, "importer.nim");
		result = copyString(((NimStringDesc*) &TMP4313));
	}
	break;
	}
	}BeforeRet: ;
...
static N_INLINE(NIM_BOOL, haspattern_196785)(Tsym191843* s) {
	...
	if (!(LOC1)) goto LA2;
	if (((TMP4318[(*(*s).ast).kind/8] &(1<<((*(*s).ast).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4319));
	...
	nimln(71, "importer.nim");
	{
		...
		nimln(73, "importer.nim");
		{
			...
			if (!LOC17) goto LA19;
			{
				...
				TMP4325 = subInt(LOC22, ((NI) 1));
				HEX3Atmp_252213 = (NI)(TMP4325);
				...
				res_252216 = ((NI) 0);
				{
					...
					while (1) {
						...
						if (((TMP4318[(*(*etyp).n).kind/8] &(1<<((*(*etyp).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4319));
						if ((NU)(j_252157) >= (NU)((*(*etyp).n).kindU.S6.sons->Sup.len)) raiseIndexError();
						if (!(((TMP4316[(*(*(*etyp).n).kindU.S6.sons->data[j_252157]).kind/8] &(1<<((*(*(*etyp).n).kindU.S6.sons->data[j_252157]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4317));
						e = (*(*(*etyp).n).kindU.S6.sons->data[j_252157]).kindU.S4.sym;
						nimln(76, "importer.nim");
						{
							if (!!(((*e).kind == ((NU8) 20)))) goto LA27;
							nimln(77, "importer.nim");
							internalerror_165199((*s).info, ((NimStringDesc*) &TMP4326));
						}
						LA27: ;
						...
						TMP4327 = addInt(res_252216, ((NI) 1));
						res_252216 = (NI)(TMP4327);
					} LA24: ;
				}
			}
		}
...
N_NIMCALL(void, importsymbol_252241)(Tcontext245023* c, Tnode191813* n, Tsym191843* frommod) {
	...
	if (!(((64 &(1<<(((*frommod).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4328));
	...
	LA3: ;
	{
		...
		nimln(102, "importer.nim");
		{
			...
			internalerror_165199((*n).info, ((NimStringDesc*) &TMP4329));
		}
		LA12: ;
			...
			e = initidentiter_199147((&it), (*frommod).kindU.S3.tab, (*s).name);
			{
				...
				while (1) {
					...
					nimln(111, "importer.nim");
					{
						...
						internalerror_165199((*n).info, ((NimStringDesc*) &TMP4330));
					}
					LA19: ;
...
appendString(LOC15, ((NimStringDesc*) &TMP4331));
...
{	nimln(133, "importer.nim");
				...
				res_252633 = ((NI) 0);
				{
					...
					while (1) {
						...
						nimln(137, "importer.nim");
						{
							...
							failedassertimpl_87017(((NimStringDesc*) &TMP4332));
						}
						LA13: ;
						nimln(138, "importer.nim");
						if (!(((TMP4316[(*a_252415).kind/8] &(1<<((*a_252415).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4317));
						...
						TMP4333 = addInt(res_252633, ((NI) 1));
						res_252633 = (NI)(TMP4333);
					} LA10: ;
				}
			}
		}
	...
	case ((NU8) 119):
	{
		...
		localerror_165155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4334));
	}
	break;
	default:
	{
		{
			...
			TMP4335 = subInt(LOC28, ((NI) 1));
			HEX3Atmp_252637 = (NI)(TMP4335);
			nimln(1598, "system.nim");
			res_252640 = ((NI) 0);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP4336 = addInt(res_252640, ((NI) 1));
					res_252640 = (NI)(TMP4336);
				} LA30: ;
			}
		}
	}
...
N_NIMCALL(Tsym191843*, importmoduleas_252671)(Tnode191813* n, Tsym191843* realmodule) {
	...
	LA3: ;
	{
		...
		localerror_165155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4337));
	}
	goto LA1;
	LA9: ;
	{
		...
		if (((TMP4318[(*n).kind/8] &(1<<((*n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP4319));
		if ((NU)(((NI) 1)) >= (NU)((*n).kindU.S6.sons->Sup.len)) raiseIndexError();
		if (!(((TMP4314[(*(*n).kindU.S6.sons->data[((NI) 1)]).kind/8] &(1<<((*(*n).kindU.S6.sons->data[((NI) 1)]).kind%8)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4315));
...
N_NIMCALL(Tsym191843*, myimportmodule_252708)(Tcontext245023* c, Tnode191813* n) {
	...
	nimln(160, "importer.nim");
	{
		...
		nimln(162, "importer.nim");
		{
			...
			localerror_165155((*n).info, ((NU16) 4), ((NimStringDesc*) &TMP4338));
		}
		LA8: ;
...
N_NIMCALL(Tnode191813*, evalimport_252004)(Tcontext245023* c, Tnode191813* n) {
	...
	memset((void*)(&emptyset), 0, sizeof(emptyset));
	{
		...
		TMP4339 = subInt(LOC2, ((NI) 1));
		HEX3Atmp_252768 = (NI)(TMP4339);
		nimln(1598, "system.nim");
		res_252771 = ((NI) 0);
		{
			nimln(1599, "system.nim");
			while (1) {
				...
				LA7: ;
				nimln(1614, "system.nim");
				TMP4340 = addInt(res_252771, ((NI) 1));
				res_252771 = (NI)(TMP4340);
			} LA4: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, evalfrom_252011)(Tcontext245023* c, Tnode191813* n) {
	...
	nimln(182, "importer.nim");
	{
		...
		adddecl_250607(c, m);
		{
			...
			TMP4341 = subInt(LOC6, ((NI) 1));
			HEX3Atmp_252835 = (NI)(TMP4341);
			nimln(1598, "system.nim");
			res_252838 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					LA11: ;
					nimln(1614, "system.nim");
					TMP4342 = addInt(res_252838, ((NI) 1));
					res_252838 = (NI)(TMP4342);
				} LA8: ;
			}
		}
	}
...
N_NIMCALL(Tnode191813*, evalimportexcept_252857)(Tcontext245023* c, Tnode191813* n) {
	...
	nimln(193, "importer.nim");
	{
		...
		initintset_188927((&exceptset));
		{
			...
			LOC6 = 0;
			LOC6 = sonslen_194403(n);
			TMP4343 = subInt(LOC6, ((NI) 1));
			HEX3Atmp_252895 = (NI)(TMP4343);
			nimln(1598, "system.nim");
			res_252898 = ((NI) 1);
			{
				nimln(1599, "system.nim");
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4344 = addInt(res_252898, ((NI) 1));
					res_252898 = (NI)(TMP4344);
				} LA8: ;
			}
		}
