...
N_NIMCALL(void, setintlittype_237776)(Tnode189813* result);
...
static NIM_CONST TY190031 TMP4055 = {
...
N_NIMCALL(Tsym189843*, getsyssym_237054)(NimStringDesc* name) {
	...
	if (!(((64 &(1<<(((*systemmodule_237019).kind)&31)))!=0))) raiseFieldError(((NimStringDesc*) &TMP4029));
	LOC1 = 0;
	...
	nimln(42, "magicsys.nim");
	{
		...
		result = newsym_190655(((NU8) 0), LOC6, systemmodule_237019, (*systemmodule_237019).info);
...
{	result = 0;
	...
	result = newsym_190655(((NU8) 0), id, systemmodule_237019, (*systemmodule_237019).info);
...
{	result = 0;
	...
	nimln(66, "magicsys.nim");
	{
		...
		case ((NU8) 31):
		{
			...
			result = systypefromname_237213(((NimStringDesc*) &TMP4030));
		}
		break;
		case ((NU8) 32):
		{
	...
	initstrtable_193007((&compilerprocs_237064));
	{
		...
		res_237627 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4053 = addInt(res_237627, ((NI) 1));
				res_237627 = (NI)(TMP4053);
			} LA3: ;
		}
	}
	{
		...
		res_237633 = ((NI) -5);
		{
			...
			while (1) {
				...
				nimln(1619, "system.nim");
				TMP4054 = addInt(res_237633, ((NI) 1));
				res_237633 = (NI)(TMP4054);
			} LA6: ;
		}
	}
	popFrame();
...
N_NIMCALL(void, setintlittype_237776)(Tnode189813* result) {
	...
	default:
	{
		...
		internalerror_163199((*result).info, ((NimStringDesc*) &TMP4057));
	}
	break;
	}
	popFrame();
