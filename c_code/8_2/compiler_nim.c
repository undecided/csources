...
N_NIMCALL(void, handlecmdline_528607)(void) {
	...
	{
		nimln(40, "nim.nim");
		processcmdline_522209(((NU8) 0), ((NimStringDesc*) &TMP10779));
		nimln(41, "nim.nim");
		{
			TSafePoint TMP10780;
			TY119589 p;
		...
		LA7: ;
		nimln(51, "nim.nim");
		loadconfigs_186809(((NimStringDesc*) &TMP10781));
		nimln(54, "nim.nim");
		initvars_170876();
		nimln(55, "nim.nim");
		processcmdline_522209(((NU8) 1), ((NimStringDesc*) &TMP10779));
		nimln(56, "nim.nim");
		maincommand_525628();
		nimln(57, "nim.nim");
		{
		...
		nimln(59, "nim.nim");
		{
			...
			nimln(63, "nim.nim");
			{
				...
				{
					NimStringDesc* LOC35;
					if (!eqStrings(gprojectname_154234, ((NimStringDesc*) &TMP10782))) goto LA33;
					nimln(65, "nim.nim");
					LOC35 = 0;
					LOC35 = gprojectfull_154236; gprojectfull_154236 = copyStringRC1(((NimStringDesc*) &TMP10783));
				...
				nimln(66, "nim.nim");
				{
					...
					LA42: ;
					{
						...
						nimln(72, "nim.nim");
						LOC46 = 0;
						LOC46 = noschangeFileExt(gprojectfull_154236, ((NimStringDesc*) &TMP10784));
						LOC47 = 0;
...
appendString(LOC49, arguments_177721);
					execexternalprogram_170985(LOC49, ((NimStringDesc*) &TMP10779));
				}
				goto LA36;
				LA38: ;
				{
					...
					LA54: ;
					{
						...
						nimln(81, "nim.nim");
						LOC57 = 0;
						LOC57 = noschangeFileExt(gprojectfull_154236, ((NimStringDesc*) &TMP10779));
...
appendString(LOC58, arguments_177721);
					execexternalprogram_170985(LOC58, ((NimStringDesc*) &TMP10779));
				}
				LA36: ;
			}
			LA29: ;
