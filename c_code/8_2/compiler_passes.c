...
static NIM_CONST TY192031 TMP4109 = {
...
N_NIMCALL(void, registerpass_242190)(Tpass242017* p) {
	...
	nimln(97, "passes.nim");
	TMP4111 = addInt(gpasseslen_242176, ((NI) 1));
	gpasseslen_242176 = (NI)(TMP4111);
	popFrame();
}
...
N_NIMCALL(void, openpasses_242293)(Tpasscontext242005** a, Tsym191843* module) {
	nimfr("openPasses", "passes.nim")
	{
		...
		TMP4113 = subInt(gpasseslen_242176, ((NI) 1));
		HEX3Atmp_242319 = (NI)(TMP4113);
		...
		res_242322 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP4114 = addInt(res_242322, ((NI) 1));
				res_242322 = (NI)(TMP4114);
			} LA3: ;
		}
	}
	popFrame();
	...
	nimfr("openPassesCached", "passes.nim")
	{
		...
		res_242384 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA4: ;
				nimln(1614, "system.nim");
				TMP4116 = addInt(res_242384, ((NI) 1));
				res_242384 = (NI)(TMP4116);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = NIM_NIL;
	{
		...
		res_242434 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4118 = addInt(res_242434, ((NI) 1));
				res_242434 = (NI)(TMP4118);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = n;
	{
		...
		res_242493 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4120 = addInt(res_242493, ((NI) 1));
				res_242493 = (NI)(TMP4120);
			} LA3: ;
		}
	}
	...
	m = n;
	{
		...
		res_242543 = ((NI) 0);
		{
			...
			while (1) {
				...
				LA6: ;
				nimln(1614, "system.nim");
				TMP4122 = addInt(res_242543, ((NI) 1));
				res_242543 = (NI)(TMP4122);
			} LA3: ;
		}
	}
	popFrame();
	...
	m = NIM_NIL;
	{
		...
		res_242600 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(1614, "system.nim");
				TMP4124 = addInt(res_242600, ((NI) 1));
				res_242600 = (NI)(TMP4124);
			} LA3: ;
		}
	}
	popFrame();
		...
		n = loadinitsection_234077(rd);
		{
			...
			res_242779 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1614, "system.nim");
					TMP4130 = addInt(res_242779, ((NI) 1));
					res_242779 = (NI)(TMP4130);
				} LA45: ;
			}
		}
...
NTI242005.flags = 1;
TMP4025[0].kind = 1;
TMP4025[0].offset = offsetof(Tpasscontext242005, fromcache);
TMP4025[0].typ = (&NTI138);
TMP4025[0].name = "fromCache";
NTI242005.node = &TMP4025[0];
...
TMP6315[0] = &TMP4025[2];
TMP4025[2].kind = 1;
TMP4025[2].offset = offsetof(Tpassdata242019, Field0);
TMP4025[2].typ = (&NTI191805);
TMP4025[2].name = "Field0";
TMP6315[1] = &TMP4025[3];
TMP4025[3].kind = 1;
TMP4025[3].offset = offsetof(Tpassdata242019, Field1);
TMP4025[3].typ = (&NTI191805);
TMP4025[3].name = "Field1";
TMP4025[1].len = 2; TMP4025[1].kind = 2; TMP4025[1].sons = &TMP6315[0];
NTI242019.node = &TMP4025[1];
}
