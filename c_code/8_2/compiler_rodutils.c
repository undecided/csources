...
appendString((*result), LOC6);
				...
				TMP2698 = addInt(res_198072, ((NI) 1));
				res_198072 = (NI)(TMP2698);
			} LA3: ;
		}
	}
	popFrame();
	...
	result = copyString(((NimStringDesc*) &TMP2704));
	{
		...
		while (1) {
			...
			case 92:
			{
				...
				hexchar_198091(s[(NI)(TMP2706)], (&xi));
				nimln(50, "rodutils.nim");
				TMP2707 = subInt(i, ((NI) 1));
				hexchar_198091(s[(NI)(TMP2707)], (&xi));
...
N_NIMCALL(void, encodevbiggestintaux_198230)(NI64 x, NimStringDesc** result) {
	...
	TMP2709 = modInt64(v_198238, IL64(190));
	rem_198240 = (NI64)(TMP2709);
	...
	LA3: ;
	{
		...
		TMP2711 = divInt64(v_198238, IL64(190));
		v_198238 = (NI64)(TMP2711);
	}
	LA1: ;
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_198242) > (NU)(((NimStringDesc*) &TMP2712)->Sup.len)) raiseIndexError();
		d_198236 = ((NimStringDesc*) &TMP2712)->data[idx_198242];
	}
	goto LA6;
	LA8: ;
	{
		...
		TMP2713 = subInt(idx_198242, ((NI) 62));
		TMP2714 = addInt((NI)(TMP2713), ((NI) 128));
		d_198236 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2714), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
...
N_NIMCALL(void, encodevintaux_198269)(NI x, NimStringDesc** result) {
	...
	v_198277 = x;
	nimln(70, "rodutils.nim");
	TMP2715 = modInt(v_198277, ((NI) 190));
	rem_198279 = (NI)(TMP2715);
	nimln(71, "rodutils.nim");
	{
		NI TMP2716;
		...
		(*result) = addChar((*result), 45);
		nimln(73, "rodutils.nim");
		TMP2716 = divInt(v_198277, ((NI) 190));
		if ((NI)(TMP2716) == (IL64(-9223372036854775807) - IL64(1))) raiseOverflow();
		v_198277 = ((NI64)-((NI)(TMP2716)));
		nimln(74, "rodutils.nim");
	...
	LA3: ;
	{
		NI TMP2717;
		nimln(76, "rodutils.nim");
		TMP2717 = divInt(v_198277, ((NI) 190));
		v_198277 = (NI)(TMP2717);
	}
	LA1: ;
	nimln(77, "rodutils.nim");
	...
	nimln(78, "rodutils.nim");
	{
		...
		if ((NU)(idx_198281) > (NU)(((NimStringDesc*) &TMP2712)->Sup.len)) raiseIndexError();
		d_198275 = ((NimStringDesc*) &TMP2712)->data[idx_198281];
	}
	goto LA6;
	LA8: ;
	{
		...
		NI TMP2719;
		nimln(79, "rodutils.nim");
		TMP2718 = subInt(idx_198281, ((NI) 62));
		TMP2719 = addInt((NI)(TMP2718), ((NI) 128));
		d_198275 = ((NIM_CHAR) (((NI)chckRange((NI)(TMP2719), ((NI) 0), ((NI) 255)))));
	}
	LA6: ;
	nimln(80, "rodutils.nim");
	{
	...
	result = ((NI) 0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2723 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 48));
			...
			case 97 ... 122:
			{
				...
				TMP2726 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 97));
			...
			case 65 ... 90:
			{
				...
				TMP2730 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 65));
			...
			case 128 ... 255:
			{
				...
				TMP2734 = subInt(((NI) (((NU8)(s[i_198358])))), ((NI) 128));
			...
			TMP2737 = addInt(i_198358, ((NI) 1));
			i_198358 = (NI)(TMP2737);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2738 = mulInt(result, sign_198360);
	result = (NI)((NU64)((NI)(TMP2738)) - (NU64)(((NI) 5)));
	...
	result = IL64(0);
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				TMP2741 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 48));
			...
			case 97 ... 122:
			{
				...
				TMP2744 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 97));
			...
			case 65 ... 90:
			{
				...
				TMP2748 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 65));
			...
			case 128 ... 255:
			{
				...
				TMP2752 = subInt(((NI) (((NU8)(s[i_198519])))), ((NI) 128));
			...
			nimln(115, "rodutils.nim");
			TMP2755 = addInt(i_198519, ((NI) 1));
			i_198519 = (NI)(TMP2755);
		}
	} LA9: ;
	nimln(116, "rodutils.nim");
	TMP2756 = mulInt64(result, ((NI64) (sign_198521)));
