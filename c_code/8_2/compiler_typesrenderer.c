...
static NIM_CONST TY192031 TMP6604 = {
	...
	{
		{
			...
			res_338205 = ((NI) 0);
			{
				...
				while (1) {
					...
					TMP6606 = addInt(res_338205, ((NI) 1));
					res_338205 = (NI)(TMP6606);
				} LA5: ;
			}
		}
	}
...
appendString(result, LOC47);
					nimln(1619, "system.nim");
					TMP6621 = addInt(res_340205, ((NI) 1));
					res_340205 = (NI)(TMP6621);
				} LA46: ;
			}
		}
...
appendString(result, LOC66);
					nimln(1619, "system.nim");
					TMP6625 = addInt(res_340213, ((NI) 1));
					res_340213 = (NI)(TMP6625);
				} LA60: ;
			}
		}
	}
...
appendString(result, LOC72);
					nimln(1619, "system.nim");
					TMP6627 = addInt(res_340221, ((NI) 1));
					res_340221 = (NI)(TMP6627);
				} LA71: ;
			}
		}
...
appendString(result, LOC88);
					nimln(1619, "system.nim");
					TMP6629 = addInt(res_340229, ((NI) 1));
					res_340229 = (NI)(TMP6629);
				} LA87: ;
			}
		}
...
{	nimln(89, "typesrenderer.nim");
	...
	{
		{
			...
			res_340622 = ((NI) 1);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6630 = addInt(res_340622, ((NI) 1));
					res_340622 = (NI)(TMP6630);
				} LA5: ;
			}
		}
	}
	...
	case ((NU8) 35):
	{
		...
		nimln(97, "typesrenderer.nim");
		{
			...
			LOC18 = 0;
			LOC18 = HEX5BHEX5D_192244(n, (NI)(TMP6633));
			...
			LOC21 = 0;
			LOC21 = HEX5BHEX5D_192244(n, (NI)(TMP6634));
			typ = (*LOC21).typ;
		...
		LA19: ;
		{
			...
			res_340630 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP6636 = addInt(res_340630, ((NI) 1));
					res_340630 = (NI)(TMP6636);
				} LA32: ;
			}
		}
	}
