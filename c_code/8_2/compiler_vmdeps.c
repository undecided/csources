...
N_NIMCALL(NimStringDesc*, readoutput_381009)(Processobj143402* p);
...
STRING_LITERAL(TMP7468, "", 0);
STRING_LITERAL(TMP7469, "\012", 1);
STRING_LITERAL(TMP7473, "void", 4);
STRING_LITERAL(TMP7475, "none", 4);
STRING_LITERAL(TMP7476, "bool", 4);
STRING_LITERAL(TMP7477, "char", 4);
STRING_LITERAL(TMP7478, "nil", 3);
STRING_LITERAL(TMP7479, "expr", 4);
STRING_LITERAL(TMP7480, "stmt", 4);
STRING_LITERAL(TMP7481, "void", 4);
STRING_LITERAL(TMP7482, "array", 5);
STRING_LITERAL(TMP7483, "typeDesc", 8);
STRING_LITERAL(TMP7484, "typeDesc", 8);
STRING_LITERAL(TMP7486, "distinct", 8);
STRING_LITERAL(TMP7487, "tuple", 5);
STRING_LITERAL(TMP7488, "set", 3);
STRING_LITERAL(TMP7489, "ptr", 3);
STRING_LITERAL(TMP7490, "ref", 3);
STRING_LITERAL(TMP7491, "var", 3);
STRING_LITERAL(TMP7492, "seq", 3);
STRING_LITERAL(TMP7493, "proc", 4);
STRING_LITERAL(TMP7494, "openArray", 9);
STRING_LITERAL(TMP7495, "range", 5);
static NIM_CONST TY192031 TMP7496 = {
0xEC, 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00}
;
STRING_LITERAL(TMP7497, "sons", 4);
STRING_LITERAL(TMP7498, "pointer", 7);
STRING_LITERAL(TMP7499, "string", 6);
STRING_LITERAL(TMP7500, "cstring", 7);
STRING_LITERAL(TMP7501, "int", 3);
STRING_LITERAL(TMP7502, "int8", 4);
STRING_LITERAL(TMP7503, "int16", 5);
STRING_LITERAL(TMP7504, "int32", 5);
STRING_LITERAL(TMP7505, "int64", 5);
STRING_LITERAL(TMP7506, "float", 5);
STRING_LITERAL(TMP7507, "float32", 7);
STRING_LITERAL(TMP7508, "float64", 7);
STRING_LITERAL(TMP7509, "float128", 8);
STRING_LITERAL(TMP7510, "uint", 4);
STRING_LITERAL(TMP7511, "uint8", 5);
STRING_LITERAL(TMP7512, "uint16", 6);
STRING_LITERAL(TMP7513, "uint32", 6);
STRING_LITERAL(TMP7514, "uint64", 6);
STRING_LITERAL(TMP7515, "bignum", 6);
STRING_LITERAL(TMP7516, "const", 5);
STRING_LITERAL(TMP7517, "mutable", 7);
STRING_LITERAL(TMP7518, "varargs", 7);
STRING_LITERAL(TMP7519, "iter", 4);
STRING_LITERAL(TMP7520, "error", 5);
STRING_LITERAL(TMP7521, "builtinTypeClass", 16);
STRING_LITERAL(TMP7522, "concept", 7);
STRING_LITERAL(TMP7523, "compositeTypeClass", 18);
STRING_LITERAL(TMP7524, "and", 3);
STRING_LITERAL(TMP7525, "or", 2);
STRING_LITERAL(TMP7526, "not", 3);
STRING_LITERAL(TMP7527, "anything", 8);
STRING_LITERAL(TMP7528, "static", 6);
...
N_NIMCALL(NimStringDesc*, readoutput_381009)(Processobj143402* p) {
	...
	result = 0;
	nimln(13, "vmdeps.nim");
	result = copyString(((NimStringDesc*) &TMP7468));
	nimln(14, "vmdeps.nim");
...
appendString(result, ((NimStringDesc*) &TMP7469));
		} LA2: ;
	}
	nimln(18, "vmdeps.nim");
	TMP7470 = subInt((result ? result->Sup.len : 0), ((NI) 1));
	result = setLengthStr(result, ((NI)chckRange((NI)(TMP7470), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln(19, "vmdeps.nim");
	LOC5 = 0;
...
N_NIMCALL(NimStringDesc*, opgorge_381027)(NimStringDesc* cmd, NimStringDesc* input) {
	...
	result = 0;
	nimln(22, "vmdeps.nim");
	pushSafePoint(&TMP7471);
	TMP7471.status = setjmp(TMP7471.context);
	if (TMP7471.status == 0) {
		Processobj143402* p;
		TY143637 LOC2;
		nimln(23, "vmdeps.nim");
		memset((void*)LOC2, 0, sizeof(LOC2));
		p = nospstartProcess(cmd, ((NimStringDesc*) &TMP7468), LOC2, 0, NIM_NIL, 4);
		nimln(24, "vmdeps.nim");
		{
	...
	if (TMP7471.status != 0) reraiseException();
	popFrame();
	return result;
}
		...
		res_381133 = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln(55, "vmdeps.nim");
				{
					...
					nimln(56, "vmdeps.nim");
					void_381126 = atomictypex_381066(((NimStringDesc*) &TMP7473), t, info);
					nimln(57, "vmdeps.nim");
				...
				TMP7474 = addInt(res_381133, ((NI) 1));
				res_381133 = (NI)(TMP7474);
			} LA5: ;
		}
	}
	popFrame();
...
N_NIMCALL(Tnode191813*, maptypetoast_381080)(Ttype191849* t, Tlineinfo163338 info, NIM_BOOL allowrecursion) {
	...
	{
		nimln(66, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7475), t, info);
	}
	break;
	case ((NU8) 1):
	{
		nimln(67, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7476), t, info);
	}
	break;
	case ((NU8) 2):
	{
		nimln(68, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7477), t, info);
	}
	break;
	case ((NU8) 5):
	{
		nimln(69, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7478), t, info);
	}
	break;
	case ((NU8) 6):
	{
		nimln(70, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7479), t, info);
	}
	break;
	case ((NU8) 7):
	{
		nimln(71, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7480), t, info);
	}
	break;
	case ((NU8) 3):
	{
		nimln(72, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7481), t, info);
	}
	break;
	case ((NU8) 4):
	case ((NU8) 16):
	{
		...
		nimln(75, "vmdeps.nim");
		LOC9 = 0;
		LOC9 = atomictypex_381066(((NimStringDesc*) &TMP7482), t, info);
	...
	case ((NU8) 8):
	{
		nimln(79, "vmdeps.nim");
		{
			...
			nimln(81, "vmdeps.nim");
			LOC18 = 0;
			LOC18 = atomictypex_381066(((NimStringDesc*) &TMP7483), t, info);
		...
		{
			nimln(84, "vmdeps.nim");
			result = atomictypex_381066(((NimStringDesc*) &TMP7484), t, info);
		}
		LA13: ;
	}
	break;
		...
		result = newnodeit_193807(((NU8) 42), info, t);
		{
			...
			res_381246 = ((NI) 0);
			{
				...
				while (1) {
					...
					nimln(1619, "system.nim");
					TMP7485 = addInt(res_381246, ((NI) 1));
					res_381246 = (NI)(TMP7485);
				} LA26: ;
			}
		}
	}
	...
	case ((NU8) 13):
	{
		nimln(92, "vmdeps.nim");
		{
			...
			nimln(93, "vmdeps.nim");
			result = maptypetobracket_381088(((NimStringDesc*) &TMP7486), t, info);
		}
		goto LA31;
		LA33: ;
		{
	...
	case ((NU8) 18):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7487), t, info);
	}
	break;
	case ((NU8) 19):
	{
		nimln(111, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7488), t, info);
	}
	break;
	case ((NU8) 21):
	{
		nimln(112, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7489), t, info);
	}
	break;
	case ((NU8) 22):
	{
		nimln(113, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7490), t, info);
	}
	break;
	case ((NU8) 23):
	{
		nimln(114, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7491), t, info);
	}
	break;
	case ((NU8) 24):
	{
		nimln(115, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7492), t, info);
	}
	break;
	case ((NU8) 25):
	{
		nimln(116, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7493), t, info);
	}
	break;
	case ((NU8) 27):
	{
		nimln(117, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7494), t, info);
	}
	break;
	case ((NU8) 20):
	{
		...
		LOC61 = 0;
		LOC61 = atomictypex_381066(((NimStringDesc*) &TMP7495), t, info);
		add_192164(result, LOC61);
		nimln(121, "vmdeps.nim");
		if (((TMP7496[(*(*t).n).kind/8] &(1<<((*(*t).n).kind%8)))!=0)) raiseFieldError(((NimStringDesc*) &TMP7497));
	...
	case ((NU8) 26):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7498), t, info);
	}
	break;
	case ((NU8) 28):
	{
	...
	case ((NU8) 31):
	{
		...
		result = atomictypex_381066(((NimStringDesc*) &TMP7501), t, info);
	}
	break;
	case ((NU8) 32):
	{
		nimln(127, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7502), t, info);
	}
	break;
	case ((NU8) 33):
	{
		nimln(128, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7503), t, info);
	}
	break;
	case ((NU8) 34):
	{
		nimln(129, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7504), t, info);
	}
	break;
	case ((NU8) 35):
	{
		nimln(130, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7505), t, info);
	}
	break;
	case ((NU8) 36):
	{
		nimln(131, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7506), t, info);
	}
	break;
	case ((NU8) 37):
	{
		nimln(132, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7507), t, info);
	}
	break;
	case ((NU8) 38):
	{
		nimln(133, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7508), t, info);
	}
	break;
	case ((NU8) 39):
	{
		nimln(134, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7509), t, info);
	}
	break;
	case ((NU8) 40):
	{
		nimln(135, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7510), t, info);
	}
	break;
	case ((NU8) 41):
	{
		nimln(136, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7511), t, info);
	}
	break;
	case ((NU8) 42):
	{
		nimln(137, "vmdeps.nim");
		result = atomictypex_381066(((NimStringDesc*) &TMP7512), t, info);
	}
	break;
	case ((NU8) 43):
	{
	...
	case ((NU8) 46):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7516), t, info);
	}
	break;
	case ((NU8) 47):
	{
		nimln(142, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7517), t, info);
	}
	break;
	case ((NU8) 48):
	{
		nimln(143, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7518), t, info);
	}
	break;
	case ((NU8) 49):
	{
		nimln(144, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7519), t, info);
	}
	break;
	case ((NU8) 50):
	{
	...
	case ((NU8) 51):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7521), t, info);
	}
	break;
	case ((NU8) 52):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7522), t, info);
	...
	case ((NU8) 54):
	{
		...
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7523), t, info);
	}
	break;
	case ((NU8) 55):
	{
		nimln(151, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7524), t, info);
	}
	break;
	case ((NU8) 56):
	{
		nimln(152, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7525), t, info);
	}
	break;
	case ((NU8) 57):
	{
		nimln(153, "vmdeps.nim");
		result = maptypetobracket_381088(((NimStringDesc*) &TMP7526), t, info);
	}
	break;
	case ((NU8) 58):
	{
	...
	case ((NU8) 61):
	{
		...
		LOC96 = 0;
		LOC96 = atomictypex_381066(((NimStringDesc*) &TMP7528), t, info);
