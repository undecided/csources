	...
	nimfr("renderRstSons", "rstast.nim")
	{
		...
		res_297248 = ((NI) 0);
		{
			...
			while (1) {
				...
				TMP5012 = addInt(res_297248, ((NI) 1));
				res_297248 = (NI)(TMP5012);
			} LA4: ;
		}
	}
	popFrame();
...
appendString((*result), ind);
		...
		lvl = nsuRepeatChar(lvltochar_297274[((*n).level)- 0], ((NI)chckRange((NI)(TMP5016), ((NI) 0), ((NI) IL64(9223372036854775807)))));
...
N_NIMCALL(Jsonnodeobj290726*, renderrsttojsonnode_297483)(Trstnode297011* node) {
	...
	nimln(296, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5061), LOC6);
	}
	LA4: ;
	nimln(298, "rstast.nim");
	{
		...
		add_293418(result, ((NimStringDesc*) &TMP5063), LOC17);
	}
	LA12: ;
	popFrame();
	return result;
...
NTI297005.node = &TMP4803[67];
TMP4803[1].kind = 1;
TMP4803[1].offset = offsetof(Trstnode297011, kind);
TMP4803[1].typ = (&NTI297005);
TMP4803[1].name = "kind";
TMP5004[1] = &TMP4803[68];
TMP4803[68].kind = 1;
TMP4803[68].offset = offsetof(Trstnode297011, text);
TMP4803[68].typ = (&NTI149);
TMP4803[68].name = "text";
TMP5004[2] = &TMP4803[69];
TMP4803[69].kind = 1;
TMP4803[69].offset = offsetof(Trstnode297011, level);
...
NTI297009.flags = 2;
NTI297009.marker = TMP5008;
TMP4803[70].kind = 1;
TMP4803[70].offset = offsetof(Trstnode297011, sons);
TMP4803[70].typ = (&NTI297009);
TMP4803[70].name = "sons";
TMP4803[0].len = 4; TMP4803[0].kind = 2; TMP4803[0].sons = &TMP5004[0];
NTI297011.node = &TMP4803[0];
NTI297007.size = sizeof(Trstnode297011*);
NTI297007.kind = 22;
NTI297007.base = (&NTI297011);
NTI297007.flags = 2;
NTI297007.marker = TMP5009;
}
