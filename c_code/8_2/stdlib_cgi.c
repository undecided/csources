...
N_NIMCALL(NimStringDesc*, encodeurl_334004)(NimStringDesc* s) {
	...
	result = 0;
	nimln(39, "cgi.nim");
	TMP6517 = addInt((s ? s->Sup.len : 0), (NI)((NU64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 2))));
	result = rawNewString(((NI)chckRange((NI)(TMP6517), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_334018;
		NI HEX3Atmp_334028;
		NI TMP6518;
...
static N_INLINE(void, handlehexchar_334050)(NIM_CHAR c, NI* x) {
	...
	case 48 ... 57:
	{
		...
		(*x) = (NI)((NI)((NU64)((*x)) << (NU64)(((NI) 4))) | ((NI) ((NI)(TMP6520))));
	}
	break;
	case 97 ... 102:
	{
...
N_NIMCALL(NimStringDesc*, xmlencode_334272)(NimStringDesc* s) {
	...
	result = 0;
	nimln(94, "cgi.nim");
	TMP6535 = addInt((s ? s->Sup.len : 0), (NI)((NU64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 2))));
	result = rawNewString(((NI)chckRange((NI)(TMP6535), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_334286;
		NI HEX3Atmp_334289;
		NI TMP6536;
