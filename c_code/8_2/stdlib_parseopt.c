...
appendChar(LOC9, 32);
					...
					TMP1830 = addInt(res_175052, ((NI) 1));
					res_175052 = (NI)(TMP1830);
				} LA8: ;
			}
		}
	}
...
N_NIMCALL(void, handleshortoption_175291)(Optparser175011* p) {
	...
	nimln(87, "parseopt.nim");
	{
		...
		i = parseword_175204((*p).cmd, i, (&(*p).val), TMP1840);
	}
	LA5: ;
...
{	nimln(98, "parseopt.nim");
	...
	case 45:
	{
		...
		nimln(111, "parseopt.nim");
		{
			...
			i = parseword_175204((*p).cmd, i, (&(*p).key), TMP1844);
			{
			...
			nimln(116, "parseopt.nim");
			{
				...
				(*p).pos = parseword_175204((*p).cmd, i, (&(*p).val), TMP1840);
			}
			goto LA15;
			LA17: ;
			{
	...
	default:
	{
		...
		(*p).pos = parseword_175204((*p).cmd, i, (&(*p).key), TMP1840);
	}
	break;
	}
	}BeforeRet: ;
...
TMP1825[1].kind = 1;
TMP1825[1].offset = offsetof(Optparser175011, cmd);
TMP1825[1].typ = (&NTI149);
TMP1825[1].name = "cmd";
TMP10617[1] = &TMP1825[2];
TMP1825[2].kind = 1;
TMP1825[2].offset = offsetof(Optparser175011, pos);
TMP1825[2].typ = (&NTI108);
TMP1825[2].name = "pos";
TMP10617[2] = &TMP1825[3];
TMP1825[3].kind = 1;
TMP1825[3].offset = offsetof(Optparser175011, inshortstate);
...
NTI175009.node = &TMP1825[9];
TMP1825[4].kind = 1;
TMP1825[4].offset = offsetof(Optparser175011, kind);
TMP1825[4].typ = (&NTI175009);
TMP1825[4].name = "kind";
TMP10617[4] = &TMP1825[10];
TMP1825[10].kind = 1;
TMP1825[10].offset = offsetof(Optparser175011, key);
TMP1825[10].typ = (&NTI149);
TMP1825[10].name = "key";
TMP10617[5] = &TMP1825[11];
TMP1825[11].kind = 1;
TMP1825[11].offset = offsetof(Optparser175011, val);
TMP1825[11].typ = (&NTI149);
TMP1825[11].name = "val";
TMP1825[0].len = 6; TMP1825[0].kind = 2; TMP1825[0].sons = &TMP10617[0];
NTI175011.node = &TMP1825[0];
}
