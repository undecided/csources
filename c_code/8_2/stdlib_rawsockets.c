...
STRING_LITERAL(TMP10601, "Service not found.", 18);
STRING_LITERAL(TMP10602, "unknown h_addrtype", 18);
STRING_LITERAL(TMP10608, "len(a) == L seq modified while iterating over it", 48);
...
N_NIMCALL(void, getservbyname_509027)(NimStringDesc* name, NimStringDesc* proto, Servent507610* Result) {
	...
	nimln(246, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_509216).Sup.Sup.message; (*e_509216).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10601));
...
N_NIMCALL(void, getservbyport_509233)(NU16 port, NimStringDesc* proto, Servent507610* Result) {
	...
	nimln(262, "rawsockets.nim");
	{
		...
		nimln(2266, "system.nim");
		LOC5 = 0;
		LOC5 = (*e_509416).Sup.Sup.message; (*e_509416).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10601));
		if (LOC5) nimGCunrefNoCycle(LOC5);
		nimln(262, "rawsockets.nim");
...
N_NIMCALL(void, gethostbyaddr_509433)(NimStringDesc* ip, Hostent507612* Result) {
	...
	LA11: ;
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_509803).Sup.Sup.message; (*e_509803).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10602));
...
N_NIMCALL(void, gethostbyname_509824)(NimStringDesc* name, Hostent507612* Result) {
	...
	LA11: ;
	{
		...
		nimln(2266, "system.nim");
		LOC14 = 0;
		LOC14 = (*e_510203).Sup.Sup.message; (*e_510203).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP10602));
		if (LOC14) nimGCunrefNoCycle(LOC14);
...
N_NIMCALL(struct timeval, timevalfrommilliseconds_510628)(NI timeout) {
	...
	nimln(369, "rawsockets.nim");
	{
		...
		TMP10603 = divInt(timeout, ((NI) 1000));
		seconds = (NI)(TMP10603);
		...
		TMP10604 = mulInt(seconds, ((NI) 1000));
		TMP10605 = subInt(timeout, (NI)(TMP10604));
		TMP10606 = mulInt((NI)(TMP10605), ((NI) 1000));
		result.tv_usec = ((NI) (((NI32)chckRange((NI)(TMP10606), ((NI32) (-2147483647 -1)), ((NI32) 2147483647)))));
	}
	LA3: ;
	popFrame();
	return result;
	...
	FD_ZERO(fd);
	{
		...
		L_510830 = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				TMP10607 = addInt(i_510828, ((NI) 1));
				i_510828 = (NI)(TMP10607);
				nimln(3089, "system.nim");
				{
					if (!!(((s ? s->Sup.len : 0) == L_510830))) goto LA6;
					failedassertimpl_87017(((NimStringDesc*) &TMP10608));
				}
				LA6: ;
			} LA3: ;
		}
	...
	L = ((*s) ? (*s)->Sup.len : 0);
	{
		...
		while (1) {
			...
			nimln(384, "rawsockets.nim");
			{
				...
				if ((NU)((NI)(TMP10609)) >= (NU)((*s)->Sup.len)) raiseIndexError();
				(*s)->data[i] = (*s)->data[(NI)(TMP10609)];
...
N_NIMCALL(NI, select_510913)(TY510647** readfds, NI timeout) {
	...
	nimln(405, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI)(TMP10612), ((int) (-2147483647 -1)), ((int) 2147483647))), (&rd), NIM_NIL, NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI)(TMP10613), ((int) (-2147483647 -1)), ((int) 2147483647))), (&rd), NIM_NIL, NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
...
N_NIMCALL(NI, selectwrite_510970)(TY510647** writefds, NI timeout) {
	...
	nimln(427, "rawsockets.nim");
	{
		...
		LOC5 = 0;
		LOC5 = select(((int)chckRange((NI)(TMP10614), ((int) (-2147483647 -1)), ((int) 2147483647))), NIM_NIL, (&wr), NIM_NIL, (&tv));
		result = ((NI) (LOC5));
	}
	goto LA1;
	LA3: ;
	{
		...
		LOC7 = 0;
		LOC7 = select(((int)chckRange((NI)(TMP10615), ((int) (-2147483647 -1)), ((int) 2147483647))), NIM_NIL, (&wr), NIM_NIL, NIM_NIL);
		result = ((NI) (LOC7));
	}
	LA1: ;
