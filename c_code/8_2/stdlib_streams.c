...
N_NIMCALL(NI, fsreaddata_137742)(Streamobj137027* s, void* buffer, NI buflen) {
	...
	if (s) chckObj((*s).Sup.m_type, (&NTI137692));
	result = readbuffer_13515((*((Filestreamobj137692*) (s))).f, buffer, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	popFrame();
	return result;
}
...
N_NIMCALL(void, fswritedata_137751)(Streamobj137027* s, void* buffer, NI buflen) {
	...
	nimln(271, "streams.nim");
	{
		...
		if (s) chckObj((*s).Sup.m_type, (&NTI137692));
		LOC3 = 0;
		LOC3 = writebuffer_13537((*((Filestreamobj137692*) (s))).f, buffer, ((NI)chckRange(buflen, ((NI) 0), ((NI) IL64(9223372036854775807)))));
