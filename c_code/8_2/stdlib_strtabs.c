...
extern TNimType NTI103553; /* tuple[nonDST: string, DST: string] */
...
N_NIMCALL(void, enlarge_133510)(Stringtableobj133012* t) {
	...
	n = (Keyvaluepairseq133010*) newSeq((&NTI133010), ((NI)chckRange((NI)(TMP498), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		NI i_133544;
		NI HEX3Atmp_133558;
		NI res_133561;
...
N_NIMCALL(void, clear_133702)(Stringtableobj133012* s, NU8 mode) {
	...
	(*s).data = (Keyvaluepairseq133010*) setLengthSeq(&((*s).data)->Sup, sizeof(TY103553), ((NI) 64));
	popFrame();
}
